...
{
    do { PyGC_Head *g = ((PyGC_Head *)(descr)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "descrobject.c", 9, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
    do { if ((descr->d_type) == ((void *)0)) ; else do { if ( --((PyObject*)(descr->d_type))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(descr->d_type)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(descr->d_type)))); } while (0); } while (0);
    do { if ((descr->d_name) == ((void *)0)) ; else do { if ( --((PyObject*)(descr->d_name))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(descr->d_name)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(descr->d_name)))); } while (0); } while (0);
    do { if ((descr->d_qualname) == ((void *)0)) ; else do { if ( --((PyObject*)(descr->d_qualname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(descr->d_qualname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(descr->d_qualname)))); } while (0); } while (0);
...
{
    if (descr->d_name != ((void *)0) && ((((((PyObject*)(descr->d_name))->ob_type))->tp_flags & ((1L<<28))) != 0))
        return descr->d_name;
    return ((void *)0);
}
...
descr_check(PyDescrObject *descr, PyObject *obj, PyObject **pres)
{
    ...
    if (!((((PyObject*)(obj))->ob_type) == (descr->d_type) || PyType_IsSubtype((((PyObject*)(obj))->ob_type), (descr->d_type)))) {
...
classmethod_get(PyMethodDescrObject *descr, PyObject *obj, PyObject *type)
{
    ...
    if (!PyType_IsSubtype((PyTypeObject *)type, (((PyDescrObject *)(descr))->d_type))) {
        PyErr_Format(PyExc_TypeError,
                     "descriptor '%V' for type '%s' "
    ...
    return PyCFunction_NewEx((descr->d_method), (type), ((void *)0));
}
...
method_get(PyMethodDescrObject *descr, PyObject *obj, PyObject *type)
{
    ...
    if (descr_check((PyDescrObject *)descr, obj, &res))
        return res;
    return PyCFunction_NewEx((descr->d_method), (obj), ((void *)0));
}
...
descr_setcheck(PyDescrObject *descr, PyObject *obj, PyObject *value,
               int *pres)
{
    (__builtin_expect(!(obj != ((void *)0)), 0) ? __assert_rtn(__func__, "descrobject.c", 171, "obj != NULL") : (void)0);
    if (!((((PyObject*)(obj))->ob_type) == (descr->d_type) || PyType_IsSubtype((((PyObject*)(obj))->ob_type), (descr->d_type)))) {
        PyErr_Format(PyExc_TypeError,
...
methoddescr_call(PyMethodDescrObject *descr, PyObject *args, PyObject *kwds)
{
    ...
    (__builtin_expect(!(((((((PyObject*)(args))->ob_type))->tp_flags & ((1L<<26))) != 0)), 0) ? __assert_rtn(__func__, "descrobject.c", 219, "PyTuple_Check(args)") : (void)0);
    argc = (((PyVarObject*)(args))->ob_size);
    if (argc < 1) {
        PyErr_Format(PyExc_TypeError,
    ...
    self = (((PyTupleObject *)(args))->ob_item[0]);
    if (!_PyObject_RealIsSubclass((PyObject *)(((PyObject*)(self))->ob_type),
                                  (PyObject *)(((PyDescrObject *)(descr))->d_type))) {
        PyErr_Format(PyExc_TypeError,
                     "descriptor '%V' "
    ...
    func = PyCFunction_NewEx((descr->d_method), (self), ((void *)0));
    if (func == ((void *)0))
        return ((void *)0);
                      ...
                      PyObject *kwds)
{
    ...
    (__builtin_expect(!(((((((PyObject*)(args))->ob_type))->tp_flags & ((1L<<26))) != 0)), 0) ? __assert_rtn(__func__, "descrobject.c", 264, "PyTuple_Check(args)") : (void)0);
    argc = (((PyVarObject*)(args))->ob_size);
    if (argc < 1) {
        PyErr_Format(PyExc_TypeError,
                     "descriptor '%V' of '%.100s' "
    ...
    self = (((PyTupleObject *)(args))->ob_item[0]);
    if (!((((((PyObject*)(self))->ob_type))->tp_flags & ((1L<<31))) != 0)) {
        PyErr_Format(PyExc_TypeError,
    ...
    if (!PyType_IsSubtype((PyTypeObject *)self, (((PyDescrObject *)(descr))->d_type))) {
        PyErr_Format(PyExc_TypeError,
                     "descriptor '%V' "
...
wrapperdescr_call(PyWrapperDescrObject *descr, PyObject *args, PyObject *kwds)
{
    ...
    (__builtin_expect(!(((((((PyObject*)(args))->ob_type))->tp_flags & ((1L<<26))) != 0)), 0) ? __assert_rtn(__func__, "descrobject.c", 316, "PyTuple_Check(args)") : (void)0);
    argc = (((PyVarObject*)(args))->ob_size);
    if (argc < 1) {
        PyErr_Format(PyExc_TypeError,
                     "descriptor '%V' of '%.100s' "
...
{
    if (descr->d_method->ml_doc == ((void *)0)) {
...
calculate_qualname(PyDescrObject *descr)
{
    ...
    type_qualname = _PyObject_GetAttrId((PyObject *)descr->d_type,
                                        &PyId___qualname__);
    if (type_qualname == ((void *)0))
        return ((void *)0);

    if (!((((((PyObject*)(type_qualname))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        PyErr_SetString(PyExc_TypeError, "<descriptor>.__objclass__."
                        "__qualname__ is not a unicode object");
        do { if ((type_qualname) == ((void *)0)) ; else do { if ( --((PyObject*)(type_qualname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(type_qualname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(type_qualname)))); } while (0); } while (0);
        return ((void *)0);
    }

    res = PyUnicode_FromFormat("%S.%S", type_qualname, descr->d_name);
    do { if ( --((PyObject*)(type_qualname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(type_qualname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(type_qualname)))); } while (0);
    return res;
}
...
{
    if (descr->d_qualname == ((void *)0))
        descr->d_qualname = calculate_qualname(descr);
    do { if ((descr->d_qualname) == ((void *)0)) ; else ( ((PyObject*)(descr->d_qualname))->ob_refcnt++); } while (0);
    return descr->d_qualname;
}

static PyMemberDef descr_members[] = {
    {"__objclass__", 6, __builtin_offsetof (PyDescrObject, d_type), 1},
    {"__name__", 6, __builtin_offsetof (PyDescrObject, d_name), 1},
    {0}
};
...
descr_traverse(PyObject *self, visitproc visit, void *arg)
{
    ...
    do { if (descr->d_type) { int vret = visit((PyObject *)(descr->d_type), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
static PyMappingMethods mappingproxy_as_mapping = {
    (lenfunc)mappingproxy_len,
    (binaryfunc)mappingproxy_getitem,
    0,
};
...
{
    if (((((PyObject*)(pp->mapping))->ob_type) == &PyDict_Type))
...
static PySequenceMethods mappingproxy_as_sequence = {
    ...
    0,
    0,
    (objobjproc)mappingproxy_contains,
    0,
    0,
};
...
{
    PyObject *key, *def = (&_Py_NoneStruct);
    static _Py_Identifier PyId_get = { 0, "get", 0 };
...
mappingproxy_keys(mappingproxyobject *pp)
{
    ...
    return _PyObject_CallMethodId(pp->mapping, &PyId_keys, ((void *)0));
}
...
mappingproxy_values(mappingproxyobject *pp)
{
    ...
    return _PyObject_CallMethodId(pp->mapping, &PyId_values, ((void *)0));
}
...
mappingproxy_items(mappingproxyobject *pp)
{
    ...
    return _PyObject_CallMethodId(pp->mapping, &PyId_items, ((void *)0));
}

static PyObject *
mappingproxy_copy(mappingproxyobject *pp)
{
    static _Py_Identifier PyId_copy = { 0, "copy", 0 };
    return _PyObject_CallMethodId(pp->mapping, &PyId_copy, ((void *)0));
}
...
static PyMethodDef mappingproxy_methods[] = {
    {"get", (PyCFunction)mappingproxy_get, 0x0001,
     "D.get(k[,d]) -> D[k] if k in D, else d." "  d defaults to None."},

    {"keys", (PyCFunction)mappingproxy_keys, 0x0004,
     "D.keys() -> list of D's keys"},
    {"values", (PyCFunction)mappingproxy_values, 0x0004,
     "D.values() -> list of D's values"},
    {"items", (PyCFunction)mappingproxy_items, 0x0004,
     "D.items() -> list of D's (key, value) pairs, as 2-tuples"},
    {"copy", (PyCFunction)mappingproxy_copy, 0x0004,
...
{
    do { PyGC_Head *g = ((PyGC_Head *)(pp)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "descrobject.c", 849, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
    do { if ( --((PyObject*)(pp->mapping))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pp->mapping)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pp->mapping)))); } while (0);
    PyObject_GC_Del(pp);
}
...
mappingproxy_traverse(PyObject *self, visitproc visit, void *arg)
{
    ...
    do { if (pp->mapping) { int vret = visit((PyObject *)(pp->mapping), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
mappingproxy_check_mapping(PyObject *mapping)
{
    if (!PyMapping_Check(mapping)
        || ((((((PyObject*)(mapping))->ob_type))->tp_flags & ((1L<<25))) != 0)
        || ((((((PyObject*)(mapping))->ob_type))->tp_flags & ((1L<<26))) != 0)) {
        PyErr_Format(PyExc_TypeError,
                    "mappingproxy() argument must be a mapping, not %s",
                    (((PyObject*)(mapping))->ob_type)->tp_name);
        return -1;
    }
    return 0;
}
...
{
    static char *kwlist[] = {"mapping", ((void *)0)};
    PyObject *mapping;
    ...
    mappingproxy = ( (mappingproxyobject *) _PyObject_GC_New(&PyDictProxy_Type) );
    if (mappingproxy == ((void *)0))
        return ((void *)0);
    ( ((PyObject*)(mapping))->ob_refcnt++);
    mappingproxy->mapping = mapping;
    do { PyGC_Head *g = ((PyGC_Head *)(mappingproxy)-1); if (g->gc.gc_refs != (-2)) Py_FatalError("GC object already tracked"); g->gc.gc_refs = (-3); g->gc.gc_next = _PyGC_generation0; g->gc.gc_prev = _PyGC_generation0->gc.gc_prev; g->gc.gc_prev->gc.gc_next = g; _PyGC_generation0->gc.gc_prev = g; } while (0);;
...
PyTypeObject PyDictProxy_Type = {
    { { 1, &PyType_Type }, 0 },
    "mappingproxy",
    sizeof(mappingproxyobject),
    0,

    (destructor)mappingproxy_dealloc,
    0,
    0,
    0,
    0,
    (reprfunc)mappingproxy_repr,
    0,
    &mappingproxy_as_sequence,
    &mappingproxy_as_mapping,
    0,
    0,
    (reprfunc)mappingproxy_str,
    PyObject_GenericGetAttr,
    0,
    0,
    ( 0 | (1L<<18) | 0) | (1L<<14),
    ...
    0,
    (richcmpfunc)mappingproxy_richcompare,
    0,
    (getiterfunc)mappingproxy_getiter,
    0,
...
PyDictProxy_New(PyObject *mapping)
{
    ...
    pp = ( (mappingproxyobject *) _PyObject_GC_New(&PyDictProxy_Type) );
    if (pp != ((void *)0)) {
        ( ((PyObject*)(mapping))->ob_refcnt++);
        pp->mapping = mapping;
        do { PyGC_Head *g = ((PyGC_Head *)(pp)-1); if (g->gc.gc_refs != (-2)) Py_FatalError("GC object already tracked"); g->gc.gc_refs = (-3); g->gc.gc_next = _PyGC_generation0; g->gc.gc_prev = _PyGC_generation0->gc.gc_prev; g->gc.gc_prev->gc.gc_next = g; _PyGC_generation0->gc.gc_prev = g; } while (0);;
    }
    return (PyObject *)pp;
}
...
wrapper_dealloc(wrapperobject *wp)
{
    ...
    do { if ((wp->descr) == ((void *)0)) ; else do { if ( --((PyObject*)(wp->descr))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(wp->descr)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(wp->descr)))); } while (0); } while (0);
    do { if ((wp->self) == ((void *)0)) ; else do { if ( --((PyObject*)(wp->self))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(wp->self)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(wp->self)))); } while (0); } while (0);
    PyObject_GC_Del(wp);
    --_tstate->trash_delete_nesting; if (_tstate->trash_delete_later && _tstate->trash_delete_nesting <= 0) _PyTrash_thread_destroy_chain(); } else _PyTrash_thread_deposit_object((PyObject*)wp); } while (0);
}
...
wrapper_richcompare(PyObject *a, PyObject *b, int op)
{
    ...
    (__builtin_expect(!(a != ((void *)0) && b != ((void *)0)), 0) ? __assert_rtn(__func__, "descrobject.c", 1016, "a != NULL && b != NULL") : (void)0);


    if (!((((PyObject*)(a))->ob_type) == &_PyMethodWrapper_Type) || !((((PyObject*)(b))->ob_type) == &_PyMethodWrapper_Type)) {
...
static PyMemberDef wrapper_members[] = {
    {"__self__", 6, __builtin_offsetof (wrapperobject, self), 1},
    {0}
};
...
{
    PyObject *c = (PyObject *)(((PyDescrObject *)(wp->descr))->d_type);

    ( ((PyObject*)(c))->ob_refcnt++);
    return c;
}
...
wrapper_traverse(PyObject *self, visitproc visit, void *arg)
{
    ...
    do { if (wp->descr) { int vret = visit((PyObject *)(wp->descr), arg); if (vret) return vret; } } while (0);
    do { if (wp->self) { int vret = visit((PyObject *)(wp->self), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
PyWrapper_New(PyObject *d, PyObject *self)
{
    ...
    (__builtin_expect(!(((((PyObject*)(d))->ob_type) == (&PyWrapperDescr_Type) || PyType_IsSubtype((((PyObject*)(d))->ob_type), (&PyWrapperDescr_Type)))), 0) ? __assert_rtn(__func__, "descrobject.c", 1211, "PyObject_TypeCheck(d, &PyWrapperDescr_Type)") : (void)0);
    descr = (PyWrapperDescrObject *)d;
    (__builtin_expect(!(_PyObject_RealIsSubclass((PyObject *)(((PyObject*)(self))->ob_type), (PyObject *)(((PyDescrObject *)(descr))->d_type))), 0) ? __assert_rtn(__func__, "descrobject.c", 1214, "_PyObject_RealIsSubclass((PyObject *)Py_TYPE(self), (PyObject *)PyDescr_TYPE(descr))") : (void)0);


    wp = ( (wrapperobject *) _PyObject_GC_New(&_PyMethodWrapper_Type) );
    if (wp != ((void *)0)) {
        ( ((PyObject*)(descr))->ob_refcnt++);
        wp->descr = descr;
        ( ((PyObject*)(self))->ob_refcnt++);
        wp->self = self;
        do { PyGC_Head *g = ((PyGC_Head *)(wp)-1); if (g->gc.gc_refs != (-2)) Py_FatalError("GC object already tracked"); g->gc.gc_refs = (-3); g->gc.gc_next = _PyGC_generation0; g->gc.gc_prev = _PyGC_generation0->gc.gc_prev; g->gc.gc_prev->gc.gc_next = g; _PyGC_generation0->gc.gc_prev = g; } while (0);;
    }
    return (PyObject *)wp;
}
# 1260 "descrobject.c"
...
static PyMemberDef property_members[] = {
    {"fget", 6, __builtin_offsetof (propertyobject, prop_get), 1},
    {"fset", 6, __builtin_offsetof (propertyobject, prop_set), 1},
    {"fdel", 6, __builtin_offsetof (propertyobject, prop_del), 1},
    {"__doc__", 6, __builtin_offsetof (propertyobject, prop_doc), 1},
    {0}
};


static char getter_doc[] = "Descriptor to change the getter on a property.";


static PyObject *
property_getter(PyObject *self, PyObject *getter)
{
    return property_copy(self, getter, ((void *)0), ((void *)0));
}


static char setter_doc[] = "Descriptor to change the setter on a property.";


static PyObject *
property_setter(PyObject *self, PyObject *setter)
{
    return property_copy(self, ((void *)0), setter, ((void *)0));
}


static char deleter_doc[] = "Descriptor to change the deleter on a property.";


static PyObject *
property_deleter(PyObject *self, PyObject *deleter)
{
    return property_copy(self, ((void *)0), ((void *)0), deleter);
}


static PyMethodDef property_methods[] = {
    {"getter", property_getter, 0x0008, getter_doc},
    {"setter", property_setter, 0x0008, setter_doc},
    {"deleter", property_deleter, 0x0008, deleter_doc},
    {0}
};
...
property_dealloc(PyObject *self)
{
    ...
    do { PyGC_Head *g = ((PyGC_Head *)(self)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "descrobject.c", 1324, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
    do { if ((gs->prop_get) == ((void *)0)) ; else do { if ( --((PyObject*)(gs->prop_get))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(gs->prop_get)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(gs->prop_get)))); } while (0); } while (0);
    do { if ((gs->prop_set) == ((void *)0)) ; else do { if ( --((PyObject*)(gs->prop_set))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(gs->prop_set)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(gs->prop_set)))); } while (0); } while (0);
    do { if ((gs->prop_del) == ((void *)0)) ; else do { if ( --((PyObject*)(gs->prop_del))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(gs->prop_del)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(gs->prop_del)))); } while (0); } while (0);
    do { if ((gs->prop_doc) == ((void *)0)) ; else do { if ( --((PyObject*)(gs->prop_doc))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(gs->prop_doc)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(gs->prop_doc)))); } while (0); } while (0);
...
property_descr_get(PyObject *self, PyObject *obj, PyObject *type)
{
    ...
    if (obj == ((void *)0) || obj == (&_Py_NoneStruct)) {
        ( ((PyObject*)(self))->ob_refcnt++);
        return self;
    }
    if (gs->prop_get == ((void *)0)) {
        PyErr_SetString(PyExc_AttributeError, "unreadable attribute");
        return ((void *)0);
    }
    return PyObject_CallFunctionObjArgs(gs->prop_get, obj, ((void *)0));
}
...
property_descr_set(PyObject *self, PyObject *obj, PyObject *value)
{
    ...
    if (value == ((void *)0))
        res = PyObject_CallFunctionObjArgs(func, obj, ((void *)0));
    else
        res = PyObject_CallFunctionObjArgs(func, obj, value, ((void *)0));
    if (res == ((void *)0))
        return -1;
...
property_copy(PyObject *old, PyObject *get, PyObject *set, PyObject *del)
{
    ...
    if (get == ((void *)0) || get == (&_Py_NoneStruct)) {
        do { if ((get) == ((void *)0)) ; else do { if ( --((PyObject*)(get))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(get)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(get)))); } while (0); } while (0);
        get = pold->prop_get ? pold->prop_get : (&_Py_NoneStruct);
    }
    if (set == ((void *)0) || set == (&_Py_NoneStruct)) {
        do { if ((set) == ((void *)0)) ; else do { if ( --((PyObject*)(set))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(set)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(set)))); } while (0); } while (0);
        set = pold->prop_set ? pold->prop_set : (&_Py_NoneStruct);
    }
    if (del == ((void *)0) || del == (&_Py_NoneStruct)) {
        do { if ((del) == ((void *)0)) ; else do { if ( --((PyObject*)(del))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(del)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(del)))); } while (0); } while (0);
        del = pold->prop_del ? pold->prop_del : (&_Py_NoneStruct);
    }
    if (pold->getter_doc && get != (&_Py_NoneStruct)) {

        doc = (&_Py_NoneStruct);
    }
    else {
        doc = pold->prop_doc ? pold->prop_doc : (&_Py_NoneStruct);
    }
...
{
    PyObject *get = ((void *)0), *set = ((void *)0), *del = ((void *)0), *doc = ((void *)0);
    ...
    if (get == (&_Py_NoneStruct))
        get = ((void *)0);
    if (set == (&_Py_NoneStruct))
        set = ((void *)0);
    if (del == (&_Py_NoneStruct))
        del = ((void *)0);

    do { if ((get) == ((void *)0)) ; else ( ((PyObject*)(get))->ob_refcnt++); } while (0);
    do { if ((set) == ((void *)0)) ; else ( ((PyObject*)(set))->ob_refcnt++); } while (0);
    do { if ((del) == ((void *)0)) ; else ( ((PyObject*)(del))->ob_refcnt++); } while (0);
    do { if ((doc) == ((void *)0)) ; else ( ((PyObject*)(doc))->ob_refcnt++); } while (0);
    ...
    if ((doc == ((void *)0) || doc == (&_Py_NoneStruct)) && get != ((void *)0)) {
        static _Py_Identifier PyId___doc__ = { 0, "__doc__", 0 };
        PyObject *get_doc = _PyObject_GetAttrId(get, &PyId___doc__);
        if (get_doc) {
            if ((((PyObject*)(self))->ob_type) == &PyProperty_Type) {
                do { if ((prop->prop_doc) == ((void *)0)) ; else do { if ( --((PyObject*)(prop->prop_doc))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(prop->prop_doc)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(prop->prop_doc)))); } while (0); } while (0);
                ...
                do { if ( --((PyObject*)(get_doc))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(get_doc)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(get_doc)))); } while (0);
                if (err < 0)
                    return -1;
            }
            prop->getter_doc = 1;
...
static PyGetSetDef property_getsetlist[] = {
    {"__isabstractmethod__",
     (getter)property_get___isabstractmethod__, ((void *)0),
     ((void *)0),
     ((void *)0)},
    {((void *)0)}
};

static char property_doc[] = "property(fget=None, fset=None, fdel=None, doc=None) -> property attribute\n" "\n" "fget is a function to be used for getting an attribute value, and likewise\n" "fset is a function for setting, and fdel a function for del'ing, an\n" "attribute.  Typical use is to define a managed attribute x:\n" "class C(object):\n" "    def getx(self): return self._x\n" "    def setx(self, value): self._x = value\n" "    def delx(self): del self._x\n" "    x = property(getx, setx, delx, \"I'm the 'x' property.\")\n" "\n" "Decorators make defining new properties or modifying existing ones easy:\n" "class C(object):\n" "    @property\n" "    def x(self): return self._x\n" "    @x.setter\n" "    def x(self, value): self._x = value\n" "    @x.deleter\n" "    def x(self): del self._x\n";
# 1532 "descrobject.c"
static int
property_traverse(PyObject *self, visitproc visit, void *arg)
{
    propertyobject *pp = (propertyobject *)self;
    do { if (pp->prop_get) { int vret = visit((PyObject *)(pp->prop_get), arg); if (vret) return vret; } } while (0);
    do { if (pp->prop_set) { int vret = visit((PyObject *)(pp->prop_set), arg); if (vret) return vret; } } while (0);
    do { if (pp->prop_del) { int vret = visit((PyObject *)(pp->prop_del), arg); if (vret) return vret; } } while (0);
    do { if (pp->prop_doc) { int vret = visit((PyObject *)(pp->prop_doc), arg); if (vret) return vret; } } while (0);
    return 0;
}
