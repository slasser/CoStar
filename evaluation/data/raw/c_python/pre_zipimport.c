...
# 4 "zipimport.c" 2
# 1 "/Users/parrt/tmp/Python-3.3.1/Include/marshal.h" 1
# 12 "/Users/parrt/tmp/Python-3.3.1/Include/marshal.h"
...
static struct st_zip_searchorder zip_searchorder[] = {
    {"/__init__.pyc", 0x2 | 0x1},
    {"/__init__.pyo", 0x2 | 0x1},
    {"/__init__.py", 0x2 | 0x0},
    {".pyc", 0x1},
    {".pyo", 0x1},
    {".py", 0x0},
...
static PyObject *zip_directory_cache = ((void *)0);
...
zipimporter_init(ZipImporter *self, PyObject *args, PyObject *kwds)
{
    ...
    if (((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 80, "PyUnicode_Check(path)") : (void)0), ((((PyASCIIObject*)path)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(path)))) == -1)
        return -1;

    len = ((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 83, "PyUnicode_Check(path)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)path)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 83, "PyUnicode_IS_READY(path)") : (void)0), ((PyASCIIObject *)(path))->length);
    if (len == 0) {
...
# 97 "zipimport.c"
    ...
    for (;;) {
        ...
        if (rv == 0) {
            ...
            if (!(((statbuf.st_mode) & 0170000) == 0100000))
                ...
                do { if (filename) { PyObject *_py_tmp = (PyObject *)(filename); (filename) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
            break;
        }
        do { if (filename) { PyObject *_py_tmp = (PyObject *)(filename); (filename) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);

        flen = PyUnicode_FindChar(path, L'/', 0, flen, -1);
        if (flen == -1)
            break;
    ...
    if (((__builtin_expect(!(((((((PyObject*)(filename))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 126, "PyUnicode_Check(filename)") : (void)0), ((((PyASCIIObject*)filename)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(filename)))) < 0)
        goto error;
    ...
    if (flen != len) {
        tmp = PyUnicode_Substring(path, flen+1,
                                  ((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 148, "PyUnicode_Check(path)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)path)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 148, "PyUnicode_IS_READY(path)") : (void)0), ((PyASCIIObject *)(path))->length));
        if (tmp == ((void *)0))
            goto error;
        self->prefix = tmp;
        if (((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_Check(path)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)path)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_IS_READY(path)") : (void)0), (Py_UCS4) (((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_Check((path))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(path))->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_IS_READY((path))") : (void)0), ((PyASCIIObject *)((path)))->state.kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_Check((path))") : (void)0), (((PyASCIIObject*)((path)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_Check((path))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(path))->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_IS_READY((path))") : (void)0), ((PyASCIIObject*)(path))->state.ascii) ? ((void*)((PyASCIIObject*)((path)) + 1)) : ((void*)((PyCompactUnicodeObject*)((path)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((path)))->data.any), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "((PyUnicodeObject*)((path)))->data.any") : (void)0), ((((PyUnicodeObject *)((path)))->data.any))))))[(len-1)] : (((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_Check((path))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(path))->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_IS_READY((path))") : (void)0), ((PyASCIIObject *)((path)))->state.kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_Check((path))") : (void)0), (((PyASCIIObject*)((path)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_Check((path))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(path))->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_IS_READY((path))") : (void)0), ((PyASCIIObject*)(path))->state.ascii) ? ((void*)((PyASCIIObject*)((path)) + 1)) : ((void*)((PyCompactUnicodeObject*)((path)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((path)))->data.any), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "((PyUnicodeObject*)((path)))->data.any") : (void)0), ((((PyUnicodeObject *)((path)))->data.any))))))[(len-1)] : ((const Py_UCS4 *)(((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_Check((path))") : (void)0), (((PyASCIIObject*)((path)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_Check((path))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(path))->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "PyUnicode_IS_READY((path))") : (void)0), ((PyASCIIObject*)(path))->state.ascii) ? ((void*)((PyASCIIObject*)((path)) + 1)) : ((void*)((PyCompactUnicodeObject*)((path)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((path)))->data.any), 0) ? __assert_rtn(__func__, "zipimport.c", 152, "((PyUnicodeObject*)((path)))->data.any") : (void)0), ((((PyUnicodeObject *)((path)))->data.any))))))[(len-1)] ) )) != L'/') {

            tmp = PyUnicode_FromFormat("%U%c", self->prefix, L'/');
            if (tmp == ((void *)0))
                goto error;
            do { if ( --((PyObject*)(self->prefix))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(self->prefix)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(self->prefix)))); } while (0);
            self->prefix = tmp;
        }
    }
    else
...
zipimporter_traverse(PyObject *obj, visitproc visit, void *arg)
{
    ...
    do { if (self->files) { int vret = visit((PyObject *)(self->files), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
zipimporter_dealloc(ZipImporter *self)
{
    ...
    do { if ((self->archive) == ((void *)0)) ; else do { if ( --((PyObject*)(self->archive))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(self->archive)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(self->archive)))); } while (0); } while (0);
    do { if ((self->prefix) == ((void *)0)) ; else do { if ( --((PyObject*)(self->prefix))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(self->prefix)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(self->prefix)))); } while (0); } while (0);
    do { if ((self->files) == ((void *)0)) ; else do { if ( --((PyObject*)(self->files))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(self->files)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(self->files)))); } while (0); } while (0);
...
{
    if (self->archive == ((void *)0))
        return PyUnicode_FromString("<zipimporter object \"???\">");
    else if (self->prefix != ((void *)0) && ((__builtin_expect(!(((((((PyObject*)(self->prefix))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 196, "PyUnicode_Check(self->prefix)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)self->prefix)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 196, "PyUnicode_IS_READY(self->prefix)") : (void)0), ((PyASCIIObject *)(self->prefix))->length) != 0)
        return PyUnicode_FromFormat("<zipimporter object \"%U%c%U\">",
                                    self->archive, L'/', self->prefix);
    else
...
{
    Py_ssize_t len, dot;
    if (((__builtin_expect(!(((((((PyObject*)(fullname))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 209, "PyUnicode_Check(fullname)") : (void)0), ((((PyASCIIObject*)fullname)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(fullname)))) < 0)
        return ((void *)0);
    len = ((__builtin_expect(!(((((((PyObject*)(fullname))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 211, "PyUnicode_Check(fullname)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)fullname)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 211, "PyUnicode_IS_READY(fullname)") : (void)0), ((PyASCIIObject *)(fullname))->length);
    dot = PyUnicode_FindChar(fullname, '.', 0, len, -1);
    if (dot == -1) {
        ( ((PyObject*)(fullname))->ob_refcnt++);
        return fullname;
    } else
...
make_filename(PyObject *prefix, PyObject *name)
{
    ...
    len = ((__builtin_expect(!(((((((PyObject*)(prefix))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 232, "PyUnicode_Check(prefix)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)prefix)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 232, "PyUnicode_IS_READY(prefix)") : (void)0), ((PyASCIIObject *)(prefix))->length) + ((__builtin_expect(!(((((((PyObject*)(name))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 232, "PyUnicode_Check(name)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)name)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 232, "PyUnicode_IS_READY(name)") : (void)0), ((PyASCIIObject *)(name))->length) + 1;
    ...
    p += ((__builtin_expect(!(((((((PyObject*)(prefix))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 243, "PyUnicode_Check(prefix)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)prefix)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 243, "PyUnicode_IS_READY(prefix)") : (void)0), ((PyASCIIObject *)(prefix))->length);
    len -= ((__builtin_expect(!(((((((PyObject*)(prefix))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 244, "PyUnicode_Check(prefix)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)prefix)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 244, "PyUnicode_IS_READY(prefix)") : (void)0), ((PyASCIIObject *)(prefix))->length);
...
check_is_directory(ZipImporter *self, PyObject* prefix, PyObject *path)
{
    ...
    dirpath = PyUnicode_FromFormat("%U%U%c", prefix, path, L'/');
    if (dirpath == ((void *)0))
        return -1;

    res = PyDict_Contains(self->files, dirpath);
    do { if ( --((PyObject*)(dirpath))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(dirpath)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(dirpath)))); } while (0);
    return res;
}
...
get_module_info(ZipImporter *self, PyObject *fullname)
{
    ...
    do { if ( --((PyObject*)(subname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(subname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(subname)))); } while (0);
    if (path == ((void *)0))
        return MI_ERROR;
    ...
    for (zso = zip_searchorder; *zso->suffix; zso++) {
        ...
        do { if ( --((PyObject*)(fullpath))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(fullpath)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(fullpath)))); } while (0);
        if (item != ((void *)0)) {
            do { if ( --((PyObject*)(path))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(path)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(path)))); } while (0);
            if (zso->type & 0x2)
                return MI_PACKAGE;
...
zipimporter_find_module(PyObject *obj, PyObject *args)
{
    ...
    PyObject *fullname;
    PyObject *namespace_portion = ((void *)0);
    ...
    case FL_NS_FOUND:
        ...
        do { if ( --((PyObject*)(namespace_portion))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(namespace_portion)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(namespace_portion)))); } while (0);
...
zipimporter_find_loader(PyObject *obj, PyObject *args)
{
    ...
    case FL_ERROR:
        return ((void *)0);
    case FL_NOT_FOUND:
        result = Py_BuildValue("O[]", (&_Py_NoneStruct));
        break;
    case FL_MODULE_FOUND:
        result = Py_BuildValue("O[]", self);
        break;
    case FL_NS_FOUND:
        result = Py_BuildValue("O[O]", (&_Py_NoneStruct), namespace_portion);
        do { if ( --((PyObject*)(namespace_portion))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(namespace_portion)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(namespace_portion)))); } while (0);
        return result;
    }
    return result;
...
{
    ZipImporter *self = (ZipImporter *)obj;
    PyObject *code = ((void *)0), *mod, *dict;
    PyObject *fullname;
    PyObject *modpath = ((void *)0);
    int ispackage;

    if (!PyArg_ParseTuple(args, "U:zipimporter.load_module",
                          &fullname))
        return ((void *)0);
    if (((__builtin_expect(!(((((((PyObject*)(fullname))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 453, "PyUnicode_Check(fullname)") : (void)0), ((((PyASCIIObject*)fullname)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(fullname)))) == -1)
        return ((void *)0);
    ...
    if (ispackage) {
        ...
        do { if ( --((PyObject*)(pkgpath))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pkgpath)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pkgpath)))); } while (0);
        if (err != 0)
            goto error;
    }
    mod = PyImport_ExecCodeModuleObject(fullname, code, modpath, ((void *)0));
    do { if (code) { PyObject *_py_tmp = (PyObject *)(code); (code) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    if (mod == ((void *)0))
        goto error;
    ...
    if (Py_VerboseFlag)
        PySys_FormatStderr("import %U # loaded from Zip %U\n",
                           fullname, modpath);
    do { if ( --((PyObject*)(modpath))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(modpath)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(modpath)))); } while (0);
    return mod;
error:
    do { if ((code) == ((void *)0)) ; else do { if ( --((PyObject*)(code))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(code)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(code)))); } while (0); } while (0);
    do { if ((modpath) == ((void *)0)) ; else do { if ( --((PyObject*)(modpath))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(modpath)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(modpath)))); } while (0); } while (0);
    return ((void *)0);
}
...
zipimporter_get_data(PyObject *obj, PyObject *args)
{
    ...
    ( ((PyObject*)(path))->ob_refcnt++);

    if (((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 573, "PyUnicode_Check(path)") : (void)0), ((((PyASCIIObject*)path)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(path)))) == -1)
        goto error;

    path_len = ((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 576, "PyUnicode_Check(path)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)path)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 576, "PyUnicode_IS_READY(path)") : (void)0), ((PyASCIIObject *)(path))->length);

    len = ((__builtin_expect(!(((((((PyObject*)(self->archive))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 578, "PyUnicode_Check(self->archive)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)self->archive)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 578, "PyUnicode_IS_READY(self->archive)") : (void)0), ((PyASCIIObject *)(self->archive))->length);
    path_start = 0;
    if (PyUnicode_Tailmatch(path, self->archive, 0, len, -1)
        && ((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_Check(path)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)path)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_IS_READY(path)") : (void)0), (Py_UCS4) (((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_Check((path))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(path))->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_IS_READY((path))") : (void)0), ((PyASCIIObject *)((path)))->state.kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_Check((path))") : (void)0), (((PyASCIIObject*)((path)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_Check((path))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(path))->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_IS_READY((path))") : (void)0), ((PyASCIIObject*)(path))->state.ascii) ? ((void*)((PyASCIIObject*)((path)) + 1)) : ((void*)((PyCompactUnicodeObject*)((path)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((path)))->data.any), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "((PyUnicodeObject*)((path)))->data.any") : (void)0), ((((PyUnicodeObject *)((path)))->data.any))))))[(len)] : (((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_Check((path))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(path))->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_IS_READY((path))") : (void)0), ((PyASCIIObject *)((path)))->state.kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_Check((path))") : (void)0), (((PyASCIIObject*)((path)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_Check((path))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(path))->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_IS_READY((path))") : (void)0), ((PyASCIIObject*)(path))->state.ascii) ? ((void*)((PyASCIIObject*)((path)) + 1)) : ((void*)((PyCompactUnicodeObject*)((path)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((path)))->data.any), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "((PyUnicodeObject*)((path)))->data.any") : (void)0), ((((PyUnicodeObject *)((path)))->data.any))))))[(len)] : ((const Py_UCS4 *)(((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_Check((path))") : (void)0), (((PyASCIIObject*)((path)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((path)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_Check((path))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(path))->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "PyUnicode_IS_READY((path))") : (void)0), ((PyASCIIObject*)(path))->state.ascii) ? ((void*)((PyASCIIObject*)((path)) + 1)) : ((void*)((PyCompactUnicodeObject*)((path)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((path)))->data.any), 0) ? __assert_rtn(__func__, "zipimport.c", 581, "((PyUnicodeObject*)((path)))->data.any") : (void)0), ((((PyUnicodeObject *)((path)))->data.any))))))[(len)] ) )) == L'/') {
        path_start = len + 1;
    }
...
zipimporter_get_code(PyObject *obj, PyObject *args)
{
    ...
    return get_module_code(self, fullname, ((void *)0), ((void *)0));
}
...
zipimporter_get_source(PyObject *obj, PyObject *args)
{
    ...
    if (mi == MI_PACKAGE)
        fullpath = PyUnicode_FromFormat("%U%c__init__.py", path, L'/');
    else
    ...
    if (toc_entry != ((void *)0)) {
        ...
        if (bytes == ((void *)0))
            return ((void *)0);
        res = PyUnicode_FromStringAndSize(((__builtin_expect(!(((((((PyObject*)(bytes))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 657, "PyBytes_Check(bytes)") : (void)0), (((PyBytesObject *)(bytes))->ob_sval)),
                                          ((__builtin_expect(!(((((((PyObject*)(bytes))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 658, "PyBytes_Check(bytes)") : (void)0),(((PyVarObject*)(bytes))->ob_size)));
...
static char doc_find_module[] = "find_module(fullname, path=None) -> self or None.\n\nSearch for a module specified by 'fullname'. 'fullname' must be the\nfully qualified (dotted) module name. It returns the zipimporter\ninstance itself if the module was found, or None if it wasn't.\nThe optional 'path' argument is ignored -- it's there for compatibility\nwith the importer protocol.";
# 677 "zipimport.c"
static char doc_find_loader[] = "find_loader(fullname, path=None) -> self, str or None.\n\nSearch for a module specified by 'fullname'. 'fullname' must be the\nfully qualified (dotted) module name. It returns the zipimporter\ninstance itself if the module was found, a string containing the\nfull path name if it's possibly a portion of a namespace package,\nor None otherwise. The optional 'path' argument is ignored -- it's\n there for compatibility with the importer protocol.";
# 687 "zipimport.c"
static char doc_load_module[] = "load_module(fullname) -> module.\n\nLoad the module specified by 'fullname'. 'fullname' must be the\nfully qualified (dotted) module name. It returns the imported\nmodule, or raises ZipImportError if it wasn't found.";
...
static char doc_get_data[] = "get_data(pathname) -> string with file data.\n\nReturn the data associated with 'pathname'. Raise IOError if\nthe file wasn't found.";





static char doc_is_package[] = "is_package(fullname) -> bool.\n\nReturn True if the module specified by fullname is a package.\nRaise ZipImportError if the module couldn't be found.";





static char doc_get_code[] = "get_code(fullname) -> code object.\n\nReturn the code object for the specified module. Raise ZipImportError\nif the module couldn't be found.";





static char doc_get_source[] = "get_source(fullname) -> source string.\n\nReturn the source code for the specified module. Raise ZipImportError\nif the module couldn't be found, return None if the archive does\ncontain the module, but has no source for it.";
...
static char doc_get_filename[] = "get_filename(fullname) -> filename string.\n\nReturn the filename for the specified module.";




static PyMethodDef zipimporter_methods[] = {
    {"find_module", zipimporter_find_module, 0x0001,
     doc_find_module},
    {"find_loader", zipimporter_find_loader, 0x0001,
     doc_find_loader},
    {"load_module", zipimporter_load_module, 0x0001,
     doc_load_module},
    {"get_data", zipimporter_get_data, 0x0001,
     doc_get_data},
    {"get_code", zipimporter_get_code, 0x0001,
     doc_get_code},
    {"get_source", zipimporter_get_source, 0x0001,
     doc_get_source},
    {"get_filename", zipimporter_get_filename, 0x0001,
     doc_get_filename},
    {"is_package", zipimporter_is_package, 0x0001,
     doc_is_package},
    {((void *)0), ((void *)0)}
};

static PyMemberDef zipimporter_members[] = {
    {"archive", 6, __builtin_offsetof (ZipImporter, archive), 1},
    {"prefix", 6, __builtin_offsetof (ZipImporter, prefix), 1},
    {"_files", 6, __builtin_offsetof (ZipImporter, files), 1},
    {((void *)0)}
};

static char zipimporter_doc[] = "zipimporter(archivepath) -> zipimporter object\n\nCreate a new zipimporter instance. 'archivepath' must be a path to\na zipfile, or to a specific path inside a zipfile. For example, it can be\n'/tmp/myimport.zip', or '/tmp/myimport.zip/mydirectory', if mydirectory is a\nvalid directory inside the archive.\n\n'ZipImportError is raised if 'archivepath' doesn't point to a valid Zip\narchive.\n\nThe 'archive' attribute of zipimporter objects contains the name of the\nzipfile targeted.";
# 768 "zipimport.c"
static PyTypeObject ZipImporter_Type = {
    ...
    sizeof(ZipImporter),
    0,
    (destructor)zipimporter_dealloc,
    0,
    0,
    0,
    0,
    (reprfunc)zipimporter_repr,
    0,
    0,
    0,
    0,
...
read_directory(PyObject *archive)
{
    ...
    Py_ssize_t i;
    char name[1024 + 5];
    PyObject *nameobj = ((void *)0);
    char *p, endof_central_dir[22];
    Py_ssize_t arc_offset;
    PyObject *path;
    const char *charset;
    int bootstrap;
    ...
    for (;;) {
        ...
        *p = 0;
        ...
        if (flags & 0x0800)
            charset = "utf-8";
        else if (!((PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; }))->interp->codecs_initialized) {
            ...
            charset = "cp437";
        nameobj = PyUnicode_Decode(name, name_size, charset, ((void *)0));
        if (nameobj == ((void *)0)) {
            if (bootstrap)
        ...
        if (((__builtin_expect(!(((((((PyObject*)(nameobj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 970, "PyUnicode_Check(nameobj)") : (void)0), ((((PyASCIIObject*)nameobj)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(nameobj)))) == -1)
            goto error;
        path = PyUnicode_FromFormat("%U%c%U", archive, L'/', nameobj);
        if (path == ((void *)0))
            goto error;
        ...
        do { if (nameobj) { PyObject *_py_tmp = (PyObject *)(nameobj); (nameobj) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
...
fseek_error:
    fclose(fp);
    do { if ((files) == ((void *)0)) ; else do { if ( --((PyObject*)(files))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(files)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(files)))); } while (0); } while (0);
    do { if ((nameobj) == ((void *)0)) ; else do { if ( --((PyObject*)(nameobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(nameobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(nameobj)))); } while (0); } while (0);
    PyErr_Format(ZipImportError, "can't read Zip file: %R", archive);
    return ((void *)0);
error:
    fclose(fp);
...
get_decompress_func(void)
{
    ...
    PyObject *zlib;
    PyObject *decompress;
    static _Py_Identifier PyId_decompress = { 0, "decompress", 0 };
    ...
    if (zlib != ((void *)0)) {
        decompress = _PyObject_GetAttrId(zlib,
                                         &PyId_decompress);
        do { if ( --((PyObject*)(zlib))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(zlib)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(zlib)))); } while (0);
    }
    else {
        PyErr_Clear();
        decompress = ((void *)0);
    ...
    if (Py_VerboseFlag)
        PySys_WriteStderr("# zipimport: zlib %s\n",
            zlib != ((void *)0) ? "available": "UNAVAILABLE");
    return decompress;
}
...
{
    PyObject *raw_data, *data = ((void *)0), *decompress;
    char *buf;
    FILE *fp;
    int err;
    ...
    if (bytes_size == 0)
        bytes_size++;
    raw_data = PyBytes_FromStringAndSize((char *)((void *)0), bytes_size);
    ...
    if (err || bytes_read != data_size) {
        ...
        do { if ( --((PyObject*)(raw_data))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(raw_data)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(raw_data)))); } while (0);
        return ((void *)0);
    }
    ...
    do { if ( --((PyObject*)(decompress))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(decompress)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(decompress)))); } while (0);
error:
    do { if ( --((PyObject*)(raw_data))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(raw_data)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(raw_data)))); } while (0);
    return data;
}
...
unmarshal_code(PyObject *pathname, PyObject *data, time_t mtime)
{
    ...
    if (code == ((void *)0))
        return ((void *)0);
    if (!((((PyObject*)(code))->ob_type) == &PyCode_Type)) {
        do { if ( --((PyObject*)(code))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(code)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(code)))); } while (0);
...
compile_source(PyObject *pathname, PyObject *source)
{
    ...
    if (fixed_source == ((void *)0)) {
        do { if ( --((PyObject*)(pathbytes))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pathbytes)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pathbytes)))); } while (0);
        return ((void *)0);
    }

    code = Py_CompileStringExFlags(PyBytes_AsString(fixed_source), PyBytes_AsString(pathbytes), 257, ((void *)0), -1);


    do { if ( --((PyObject*)(pathbytes))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pathbytes)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pathbytes)))); } while (0);
    do { if ( --((PyObject*)(fixed_source))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(fixed_source)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(fixed_source)))); } while (0);
    return code;
}
...
parse_dostime(int dostime, int dosdate)
{
    ...
    ((__builtin_object_size ((void *) &stm, 0) != (size_t) -1) ? __builtin___memset_chk ((void *) &stm, '\0', sizeof(stm), __builtin_object_size ((void *) &stm, 0)) : __inline_memset_chk ((void *) &stm, '\0', sizeof(stm)));
...
get_mtime_of_source(ZipImporter *self, PyObject *path)
{
    ...
    if (((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 1306, "PyUnicode_Check(path)") : (void)0), ((((PyASCIIObject*)path)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(path)))) == -1)
        return (time_t)-1;
    stripped = PyUnicode_FromKindAndData(((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 1308, "PyUnicode_Check(path)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)path)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 1308, "PyUnicode_IS_READY(path)") : (void)0), ((PyASCIIObject *)(path))->state.kind),
                                         ((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 1309, "PyUnicode_Check(path)") : (void)0), (((PyASCIIObject*)(path))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 1309, "PyUnicode_Check(path)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)path)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 1309, "PyUnicode_IS_READY(path)") : (void)0), ((PyASCIIObject*)path)->state.ascii) ? ((void*)((PyASCIIObject*)(path) + 1)) : ((void*)((PyCompactUnicodeObject*)(path) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)(path))->data.any), 0) ? __assert_rtn(__func__, "zipimport.c", 1309, "((PyUnicodeObject*)(path))->data.any") : (void)0), ((((PyUnicodeObject *)(path))->data.any)))),
                                         ((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "zipimport.c", 1310, "PyUnicode_Check(path)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)path)->state.ready)), 0) ? __assert_rtn(__func__, "zipimport.c", 1310, "PyUnicode_IS_READY(path)") : (void)0), ((PyASCIIObject *)(path))->length) - 1);
    if (stripped == ((void *)0))
        return (time_t)-1;

    toc_entry = PyDict_GetItem(self->files, stripped);
    do { if ( --((PyObject*)(stripped))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(stripped)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(stripped)))); } while (0);
    if (toc_entry != ((void *)0) && ((((((PyObject*)(toc_entry))->ob_type))->tp_flags & ((1L<<26))) != 0) &&
...
get_module_code(ZipImporter *self, PyObject *fullname,
                int *p_ispackage, PyObject **p_modpath)
{
    PyObject *code = ((void *)0), *toc_entry, *subname;
    PyObject *path, *fullpath = ((void *)0);
    struct st_zip_searchorder *zso;
    ...
    for (zso = zip_searchorder; *zso->suffix; zso++) {
        ...
        if (Py_VerboseFlag > 1)
            PySys_FormatStderr("# trying %U%c%U\n",
                               self->archive, (int)L'/', fullpath);
        toc_entry = PyDict_GetItem(self->files, fullpath);
        if (toc_entry != ((void *)0)) {
            time_t mtime = 0;
            int ispackage = zso->type & 0x2;
            int isbytecode = zso->type & 0x1;
            ...
            do { if (fullpath) { PyObject *_py_tmp = (PyObject *)(fullpath); (fullpath) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
            if (p_ispackage != ((void *)0))
                *p_ispackage = ispackage;
            code = get_code_from_data(self, ispackage,
                                      isbytecode, mtime,
                                      toc_entry);
            if (code == (&_Py_NoneStruct)) {


                do { if ( --((PyObject*)(code))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(code)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(code)))); } while (0);
                continue;
            }
            if (code != ((void *)0) && p_modpath != ((void *)0)) {
                *p_modpath = PyTuple_GetItem(toc_entry, 0);
                ( ((PyObject*)(*p_modpath))->ob_refcnt++);
            }
            goto exit;
        }
        else
...
exit:
    do { if ( --((PyObject*)(path))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(path)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(path)))); } while (0);
    do { if ((fullpath) == ((void *)0)) ; else do { if ( --((PyObject*)(fullpath))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(fullpath)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(fullpath)))); } while (0); } while (0);
    return code;
}
...
static char zipimport_doc[] = "zipimport provides support for importing Python modules from Zip archives.\n\nThis module exports three objects:\n- zipimporter: a class; its constructor takes a path to a Zip archive.\n- ZipImportError: exception raised by zipimporter objects. It's a\n  subclass of ImportError, so it can be caught as ImportError, too.\n- _zip_directory_cache: a dict, mapping archive paths to zip directory\n  info dicts, as used in zipimporter._files.\n\nIt is usually not needed to use the zipimport module explicitly; it is\nused by the builtin import mechanism for sys.path items that are paths\nto Zip archives.";
# 1436 "zipimport.c"
...
PyInit_zipimport(void)
{
    ...
    zip_searchorder[0].suffix[0] = L'/';
    zip_searchorder[1].suffix[0] = L'/';
    zip_searchorder[2].suffix[0] = L'/';
    if (Py_OptimizeFlag) {
    ...
    mod = PyModule_Create2(&zipimportmodule, 1013);
    if (mod == ((void *)0))
        return ((void *)0);

    ZipImportError = PyErr_NewException("zipimport.ZipImportError",
                                        PyExc_ImportError, ((void *)0));
    if (ZipImportError == ((void *)0))
        return ((void *)0);

    ( ((PyObject*)(ZipImportError))->ob_refcnt++);
    if (PyModule_AddObject(mod, "ZipImportError",
                           ZipImportError) < 0)
        return ((void *)0);

    ( ((PyObject*)(&ZipImporter_Type))->ob_refcnt++);
    if (PyModule_AddObject(mod, "zipimporter",
                           (PyObject *)&ZipImporter_Type) < 0)
        return ((void *)0);

    zip_directory_cache = PyDict_New();
    if (zip_directory_cache == ((void *)0))
        return ((void *)0);
    ( ((PyObject*)(zip_directory_cache))->ob_refcnt++);
