...
static PyMemberDef frame_memberlist[] = {
    {"f_back", 6, __builtin_offsetof (PyFrameObject, f_back), 1},
    {"f_code", 6, __builtin_offsetof (PyFrameObject, f_code), 1},
    {"f_builtins", 6, __builtin_offsetof (PyFrameObject, f_builtins), 1},
    {"f_globals", 6, __builtin_offsetof (PyFrameObject, f_globals), 1},
    {"f_lasti", 1, __builtin_offsetof (PyFrameObject, f_lasti), 1},
    {((void *)0)}
};
...
frame_setlineno(PyFrameObject *f, PyObject* p_new_lineno)
{
    ...
    int new_lasti = 0;
    int new_iblock = 0;
    unsigned char *code = ((void *)0);
    Py_ssize_t code_len = 0;
    unsigned char *lnotab = ((void *)0);
    ...
    if (!((((PyObject*)(p_new_lineno))->ob_type) == &PyLong_Type)) {
    ...
    if (overflow
        ...
        || l_new_lineno > 2147483647
        || l_new_lineno < (-2147483647 - 1)
    ...
    min_addr = ((new_lasti) < (f->f_lasti) ? (new_lasti) : (f->f_lasti));
    max_addr = ((new_lasti) > (f->f_lasti) ? (new_lasti) : (f->f_lasti));
# 176 "frameobject.c"
    if (code[new_lasti] == 4 || code[new_lasti] == 1) {
        PyErr_SetString(PyExc_ValueError,
...
# 191 "frameobject.c"
    ...
    ((__builtin_object_size (blockstack, 0) != (size_t) -1) ? __builtin___memset_chk (blockstack, '\0', sizeof(blockstack), __builtin_object_size (blockstack, 0)) : __inline_memset_chk (blockstack, '\0', sizeof(blockstack)));
    ((__builtin_object_size (in_finally, 0) != (size_t) -1) ? __builtin___memset_chk (in_finally, '\0', sizeof(in_finally), __builtin_object_size (in_finally, 0)) : __inline_memset_chk (in_finally, '\0', sizeof(in_finally)));
    blockstack_top = 0;
    for (addr = 0; addr < code_len; addr++) {
        ...
        case 87:
            (__builtin_expect(!(blockstack_top > 0), 0) ? __assert_rtn(__func__, "frameobject.c", 208, "blockstack_top > 0") : (void)0);
            setup_op = code[blockstack[blockstack_top-1]];
            if (setup_op == 122 || setup_op == 143) {
    ...
    (__builtin_expect(!(blockstack_top == 0), 0) ? __assert_rtn(__func__, "frameobject.c", 262, "blockstack_top == 0") : (void)0);
...
# 280 "frameobject.c"
    ...
    for (addr = min_addr; addr < max_addr; addr++) {
        ...
        min_delta_iblock = ((min_delta_iblock) < (delta_iblock) ? (min_delta_iblock) : (delta_iblock));
...
frame_gettrace(PyFrameObject *f, void *closure)
{
    ...
    if (trace == ((void *)0))
        trace = (&_Py_NoneStruct);

    ( ((PyObject*)(trace))->ob_refcnt++);
...
frame_settrace(PyFrameObject *f, PyObject* v, void *closure)
{
    ...
    f->f_trace = v;
    do { if ((old_value) == ((void *)0)) ; else do { if ( --((PyObject*)(old_value))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(old_value)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(old_value)))); } while (0); } while (0);
...
static PyGetSetDef frame_getsetlist[] = {
    {"f_locals", (getter)frame_getlocals, ((void *)0), ((void *)0)},
    {"f_lineno", (getter)frame_getlineno,
                    (setter)frame_setlineno, ((void *)0)},
    {"f_trace", (getter)frame_gettrace, (setter)frame_settrace, ((void *)0)},
    {0}
};
# 417 "frameobject.c"
static PyFrameObject *free_list = ((void *)0);
...
frame_dealloc(PyFrameObject *f)
{
    ...
    for (p = f->f_localsplus; p < valuestack; p++)
        do { if (*p) { PyObject *_py_tmp = (PyObject *)(*p); (*p) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);


    if (f->f_stacktop != ((void *)0)) {
        for (p = valuestack; p < f->f_stacktop; p++)
            do { if ((*p) == ((void *)0)) ; else do { if ( --((PyObject*)(*p))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(*p)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(*p)))); } while (0); } while (0);
    }
    ...
    do { if ( --((PyObject*)(f->f_builtins))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(f->f_builtins)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(f->f_builtins)))); } while (0);
    do { if ( --((PyObject*)(f->f_globals))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(f->f_globals)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(f->f_globals)))); } while (0);
    do { if (f->f_locals) { PyObject *_py_tmp = (PyObject *)(f->f_locals); (f->f_locals) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (f->f_trace) { PyObject *_py_tmp = (PyObject *)(f->f_trace); (f->f_trace) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (f->f_exc_type) { PyObject *_py_tmp = (PyObject *)(f->f_exc_type); (f->f_exc_type) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (f->f_exc_value) { PyObject *_py_tmp = (PyObject *)(f->f_exc_value); (f->f_exc_value) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (f->f_exc_traceback) { PyObject *_py_tmp = (PyObject *)(f->f_exc_traceback); (f->f_exc_traceback) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    ...
    --_tstate->trash_delete_nesting; if (_tstate->trash_delete_later && _tstate->trash_delete_nesting <= 0) _PyTrash_thread_destroy_chain(); } else _PyTrash_thread_deposit_object((PyObject*)f); } while (0);
}
...
frame_traverse(PyFrameObject *f, visitproc visit, void *arg)
{
    ...
    do { if (f->f_back) { int vret = visit((PyObject *)(f->f_back), arg); if (vret) return vret; } } while (0);
    do { if (f->f_code) { int vret = visit((PyObject *)(f->f_code), arg); if (vret) return vret; } } while (0);
    do { if (f->f_builtins) { int vret = visit((PyObject *)(f->f_builtins), arg); if (vret) return vret; } } while (0);
    do { if (f->f_globals) { int vret = visit((PyObject *)(f->f_globals), arg); if (vret) return vret; } } while (0);
    do { if (f->f_locals) { int vret = visit((PyObject *)(f->f_locals), arg); if (vret) return vret; } } while (0);
    do { if (f->f_trace) { int vret = visit((PyObject *)(f->f_trace), arg); if (vret) return vret; } } while (0);
    do { if (f->f_exc_type) { int vret = visit((PyObject *)(f->f_exc_type), arg); if (vret) return vret; } } while (0);
    do { if (f->f_exc_value) { int vret = visit((PyObject *)(f->f_exc_value), arg); if (vret) return vret; } } while (0);
    do { if (f->f_exc_traceback) { int vret = visit((PyObject *)(f->f_exc_traceback), arg); if (vret) return vret; } } while (0);


    slots = f->f_code->co_nlocals + (((PyVarObject*)(f->f_code->co_cellvars))->ob_size) + (((PyVarObject*)(f->f_code->co_freevars))->ob_size);
    fastlocals = f->f_localsplus;
    for (i = slots; --i >= 0; ++fastlocals)
        do { if (*fastlocals) { int vret = visit((PyObject *)(*fastlocals), arg); if (vret) return vret; } } while (0);


    if (f->f_stacktop != ((void *)0)) {
        for (p = f->f_valuestack; p < f->f_stacktop; p++)
            do { if (*p) { int vret = visit((PyObject *)(*p), arg); if (vret) return vret; } } while (0);
    }
    return 0;
}
...
frame_clear(PyFrameObject *f)
{
    ...
    fastlocals = f->f_localsplus;
    for (i = slots; --i >= 0; ++fastlocals)
        do { if (*fastlocals) { PyObject *_py_tmp = (PyObject *)(*fastlocals); (*fastlocals) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
...
frame_sizeof(PyFrameObject *f)
{
    ...
    ncells = (((PyVarObject*)(f->f_code->co_cellvars))->ob_size);
    nfrees = (((PyVarObject*)(f->f_code->co_freevars))->ob_size);
...
static char sizeof__doc__[] = "F.__sizeof__() -> size of F in memory, in bytes";


static PyMethodDef frame_methods[] = {
    {"__sizeof__", (PyCFunction)frame_sizeof, 0x0004,
     sizeof__doc__},
    {((void *)0), ((void *)0)}
};
            ...
            PyObject *locals)
{
    ...
    Py_ssize_t i;
# 612 "frameobject.c"
    if (back == ((void *)0) || back->f_globals != globals) {
        builtins = PyDict_GetItem(globals, builtin_object);
        if (builtins) {
            if (((((PyObject*)(builtins))->ob_type) == (&PyModule_Type) || PyType_IsSubtype((((PyObject*)(builtins))->ob_type), (&PyModule_Type)))) {
                builtins = PyModule_GetDict(builtins);
                (__builtin_expect(!(builtins != ((void *)0)), 0) ? __assert_rtn(__func__, "frameobject.c", 617, "builtins != NULL") : (void)0);
            }
        }
        if (builtins == ((void *)0)) {
            ...
            if (builtins == ((void *)0) ||
                PyDict_SetItemString(
                    builtins, "None", (&_Py_NoneStruct)) < 0)
                return ((void *)0);
        }
        else
            ( ((PyObject*)(builtins))->ob_refcnt++);
        ...
        (__builtin_expect(!(builtins != ((void *)0)), 0) ? __assert_rtn(__func__, "frameobject.c", 637, "builtins != NULL") : (void)0);
        ( ((PyObject*)(builtins))->ob_refcnt++);
    }
    if (code->co_zombieframe != ((void *)0)) {
        f = code->co_zombieframe;
        code->co_zombieframe = ((void *)0);
        ( (((PyObject*)((PyObject *)f))->ob_refcnt) = 1);
        (__builtin_expect(!(f->f_code == code), 0) ? __assert_rtn(__func__, "frameobject.c", 644, "f->f_code == code") : (void)0);
    }
    else {
        Py_ssize_t extras, ncells, nfrees;
        ncells = (((PyVarObject*)(code->co_cellvars))->ob_size);
        nfrees = (((PyVarObject*)(code->co_freevars))->ob_size);
        extras = code->co_stacksize + code->co_nlocals + ncells +
            nfrees;
        if (free_list == ((void *)0)) {
            f = ( (PyFrameObject *) _PyObject_GC_NewVar((&PyFrame_Type), (extras)) );

            if (f == ((void *)0)) {
                do { if ( --((PyObject*)(builtins))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(builtins)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(builtins)))); } while (0);
                return ((void *)0);
            }
        }
        else {
            (__builtin_expect(!(numfree > 0), 0) ? __assert_rtn(__func__, "frameobject.c", 661, "numfree > 0") : (void)0);
            --numfree;
            f = free_list;
            free_list = free_list->f_back;
            if ((((PyVarObject*)(f))->ob_size) < extras) {
                PyFrameObject *new_f = ( (PyFrameObject *) _PyObject_GC_Resize((PyVarObject *)(f), (extras)) );
                if (new_f == ((void *)0)) {
                    PyObject_GC_Del(f);
                    do { if ( --((PyObject*)(builtins))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(builtins)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(builtins)))); } while (0);
                    return ((void *)0);
        ...
        for (i=0; i<extras; i++)
            f->f_localsplus[i] = ((void *)0);
        f->f_locals = ((void *)0);
        f->f_trace = ((void *)0);
        f->f_exc_type = f->f_exc_value = f->f_exc_traceback = ((void *)0);
    }
    f->f_stacktop = f->f_valuestack;
    f->f_builtins = builtins;
    do { if ((back) == ((void *)0)) ; else ( ((PyObject*)(back))->ob_refcnt++); } while (0);
    f->f_back = back;
    ( ((PyObject*)(code))->ob_refcnt++);
    ( ((PyObject*)(globals))->ob_refcnt++);
    f->f_globals = globals;

    if ((code->co_flags & (0x0002 | 0x0001)) ==
        (0x0002 | 0x0001))
        ;
    else if (code->co_flags & 0x0002) {
        locals = PyDict_New();
        if (locals == ((void *)0)) {
    ...
    do { PyGC_Head *g = ((PyGC_Head *)(f)-1); if (g->gc.gc_refs != (-2)) Py_FatalError("GC object already tracked"); g->gc.gc_refs = (-3); g->gc.gc_next = _PyGC_generation0; g->gc.gc_prev = _PyGC_generation0->gc.gc_prev; g->gc.gc_prev->gc.gc_next = g; _PyGC_generation0->gc.gc_prev = g; } while (0);;
    return f;
}
...
{
    Py_ssize_t j;
    (__builtin_expect(!(((((((PyObject*)(map))->ob_type))->tp_flags & ((1L<<26))) != 0)), 0) ? __assert_rtn(__func__, "frameobject.c", 766, "PyTuple_Check(map)") : (void)0);
    (__builtin_expect(!(((((((PyObject*)(dict))->ob_type))->tp_flags & ((1L<<29))) != 0)), 0) ? __assert_rtn(__func__, "frameobject.c", 767, "PyDict_Check(dict)") : (void)0);
    (__builtin_expect(!(PyTuple_Size(map) >= nmap), 0) ? __assert_rtn(__func__, "frameobject.c", 768, "PyTuple_Size(map) >= nmap") : (void)0);
    for (j = nmap; --j >= 0; ) {
        PyObject *key = (((PyTupleObject *)(map))->ob_item[j]);
        PyObject *value = values[j];
        (__builtin_expect(!(((((((PyObject*)(key))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "frameobject.c", 772, "PyUnicode_Check(key)") : (void)0);
        if (deref) {
            (__builtin_expect(!(((((PyObject*)(value))->ob_type) == &PyCell_Type)), 0) ? __assert_rtn(__func__, "frameobject.c", 774, "PyCell_Check(value)") : (void)0);
            value = (((PyCellObject *)(value))->ob_ref);
        }
        if (value == ((void *)0)) {
...
{
    Py_ssize_t j;
    (__builtin_expect(!(((((((PyObject*)(map))->ob_type))->tp_flags & ((1L<<26))) != 0)), 0) ? __assert_rtn(__func__, "frameobject.c", 814, "PyTuple_Check(map)") : (void)0);
    (__builtin_expect(!(((((((PyObject*)(dict))->ob_type))->tp_flags & ((1L<<29))) != 0)), 0) ? __assert_rtn(__func__, "frameobject.c", 815, "PyDict_Check(dict)") : (void)0);
    (__builtin_expect(!(PyTuple_Size(map) >= nmap), 0) ? __assert_rtn(__func__, "frameobject.c", 816, "PyTuple_Size(map) >= nmap") : (void)0);
    for (j = nmap; --j >= 0; ) {
        PyObject *key = (((PyTupleObject *)(map))->ob_item[j]);
        PyObject *value = PyObject_GetItem(dict, key);
        (__builtin_expect(!(((((((PyObject*)(key))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "frameobject.c", 820, "PyUnicode_Check(key)") : (void)0);
        ...
        if (deref) {
            (__builtin_expect(!(((((PyObject*)(values[j]))->ob_type) == &PyCell_Type)), 0) ? __assert_rtn(__func__, "frameobject.c", 828, "PyCell_Check(values[j])") : (void)0);
            if ((((PyCellObject *)(values[j]))->ob_ref) != value) {
                if (PyCell_Set(values[j], value) < 0)
                    PyErr_Clear();
            }
        } else if (values[j] != value) {
            do { if ((value) == ((void *)0)) ; else ( ((PyObject*)(value))->ob_refcnt++); } while (0);
            do { if ((values[j]) == ((void *)0)) ; else do { if ( --((PyObject*)(values[j]))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(values[j])))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(values[j])))); } while (0); } while (0);
            values[j] = value;
        }
...
PyFrame_FastToLocals(PyFrameObject *f)
{
    ...
    co = f->f_code;
    map = co->co_varnames;
    if (!((((((PyObject*)(map))->ob_type))->tp_flags & ((1L<<26))) != 0))
        return;
    PyErr_Fetch(&error_type, &error_value, &error_traceback);
    fast = f->f_localsplus;
    j = (((PyVarObject*)(map))->ob_size);
    if (j > co->co_nlocals)
        j = co->co_nlocals;
    if (co->co_nlocals)
        map_to_dict(map, j, locals, fast, 0);
    ncells = (((PyVarObject*)(co->co_cellvars))->ob_size);
    nfreevars = (((PyVarObject*)(co->co_freevars))->ob_size);
    if (ncells || nfreevars) {
        map_to_dict(co->co_cellvars, ncells,
                    locals, fast + co->co_nlocals, 1);
# 886 "frameobject.c"
        if (co->co_flags & 0x0001) {
...
PyFrame_ClearFreeList(void)
{
    ...
    while (free_list != ((void *)0)) {
        PyFrameObject *f = free_list;
        free_list = free_list->f_back;
        PyObject_GC_Del(f);
        --numfree;
    }
    (__builtin_expect(!(numfree == 0), 0) ? __assert_rtn(__func__, "frameobject.c", 947, "numfree == 0") : (void)0);
...
PyFrame_Fini(void)
{
    ...
    do { if ((builtin_object) == ((void *)0)) ; else do { if ( --((PyObject*)(builtin_object))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(builtin_object)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(builtin_object)))); } while (0); } while (0);
    builtin_object = ((void *)0);
}
