...
static PyMethodDef tb_methods[] = {
   {"__dir__", (PyCFunction)tb_dir, 0x0004},
   {((void *)0), ((void *)0), 0, ((void *)0)},
};

static PyMemberDef tb_memberlist[] = {
    {"tb_next", 6, __builtin_offsetof (PyTracebackObject, tb_next), 1},
    {"tb_frame", 6, __builtin_offsetof (PyTracebackObject, tb_frame), 1},
    {"tb_lasti", 1, __builtin_offsetof (PyTracebackObject, tb_lasti), 1},
    {"tb_lineno", 1, __builtin_offsetof (PyTracebackObject, tb_lineno), 1},
    {((void *)0)}
};
...
tb_dealloc(PyTracebackObject *tb)
{
    ...
    do { if ((tb->tb_next) == ((void *)0)) ; else do { if ( --((PyObject*)(tb->tb_next))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tb->tb_next)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tb->tb_next)))); } while (0); } while (0);
    do { if ((tb->tb_frame) == ((void *)0)) ; else do { if ( --((PyObject*)(tb->tb_frame))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tb->tb_frame)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tb->tb_frame)))); } while (0); } while (0);
    PyObject_GC_Del(tb);
    --_tstate->trash_delete_nesting; if (_tstate->trash_delete_later && _tstate->trash_delete_nesting <= 0) _PyTrash_thread_destroy_chain(); } else _PyTrash_thread_deposit_object((PyObject*)tb); } while (0);
}

static int
tb_traverse(PyTracebackObject *tb, visitproc visit, void *arg)
{
    do { if (tb->tb_next) { int vret = visit((PyObject *)(tb->tb_next), arg); if (vret) return vret; } } while (0);
    do { if (tb->tb_frame) { int vret = visit((PyObject *)(tb->tb_frame), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
{
    do { if (tb->tb_next) { PyObject *_py_tmp = (PyObject *)(tb->tb_next); (tb->tb_next) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (tb->tb_frame) { PyObject *_py_tmp = (PyObject *)(tb->tb_frame); (tb->tb_frame) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
}
...
newtracebackobject(PyTracebackObject *next, PyFrameObject *frame)
{
    ...
    if ((next != ((void *)0) && !((((PyObject*)(next))->ob_type) == &PyTraceBack_Type)) ||
                    frame == ((void *)0) || !((((PyObject*)(frame))->ob_type) == &PyFrame_Type)) {
        _PyErr_BadInternalCall("traceback.c", 111);
        return ((void *)0);
    }
    tb = ( (PyTracebackObject *) _PyObject_GC_New(&PyTraceBack_Type) );
    if (tb != ((void *)0)) {
        do { if ((next) == ((void *)0)) ; else ( ((PyObject*)(next))->ob_refcnt++); } while (0);
        tb->tb_next = next;
        do { if ((frame) == ((void *)0)) ; else ( ((PyObject*)(frame))->ob_refcnt++); } while (0);
        tb->tb_frame = frame;
...
PyTraceBack_Here(PyFrameObject *frame)
{
    ...
    do { if ((oldtb) == ((void *)0)) ; else do { if ( --((PyObject*)(oldtb))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(oldtb)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(oldtb)))); } while (0); } while (0);
    return 0;
}
...
_Py_FindSourceFile(PyObject *filename, char* namebuf, size_t namelen, PyObject *io)
{
    ...
    filepath = ((__builtin_expect(!(((((((PyObject*)(filebytes))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "traceback.c", 162, "PyBytes_Check(filebytes)") : (void)0), (((PyBytesObject *)(filebytes))->ob_sval));


    tail = strrchr(filepath, L'/');
    if (tail == ((void *)0))
        tail = filepath;
    else
        tail++;
    ...
    if (syspath == ((void *)0) || !((((((PyObject*)(syspath))->ob_type))->tp_flags & ((1L<<25))) != 0))
        goto error;
    ...
    for (i = 0; i < npath; i++) {
        ...
        len = ((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "traceback.c", 190, "PyBytes_Check(path)") : (void)0),(((PyVarObject*)(path))->ob_size));
        if (len + 1 + (Py_ssize_t)taillen >= (Py_ssize_t)namelen - 1) {
            do { if ( --((PyObject*)(path))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(path)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(path)))); } while (0);
            continue;
        }
        ((__builtin_object_size (namebuf, 0) != (size_t) -1) ? __builtin___strcpy_chk (namebuf, ((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "traceback.c", 195, "PyBytes_Check(path)") : (void)0), (((PyBytesObject *)(path))->ob_sval)), __builtin_object_size (namebuf, 2 > 1)) : __inline_strcpy_chk (namebuf, ((__builtin_expect(!(((((((PyObject*)(path))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "traceback.c", 195, "PyBytes_Check(path)") : (void)0), (((PyBytesObject *)(path))->ob_sval))));
        do { if ( --((PyObject*)(path))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(path)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(path)))); } while (0);
        if (strlen(namebuf) != len)
            continue;
        if (len > 0 && namebuf[len-1] != L'/')
            namebuf[len++] = L'/';
        ((__builtin_object_size (namebuf+len, 0) != (size_t) -1) ? __builtin___strcpy_chk (namebuf+len, tail, __builtin_object_size (namebuf+len, 2 > 1)) : __inline_strcpy_chk (namebuf+len, tail));
...
error:
    ...
    do { if ( --((PyObject*)(filebytes))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(filebytes)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(filebytes)))); } while (0);
    return result;
}
...
_Py_DisplaySourceLine(PyObject *f, PyObject *filename, int lineno, int indent)
{
    ...
    encoding = (found_encoding != ((void *)0)) ? found_encoding : "utf-8";
    lseek(fd, 0, 0);
    fob = _PyObject_CallMethodId(io, &PyId_TextIOWrapper, "Os", binary, encoding);
    do { if ( --((PyObject*)(io))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(io)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(io)))); } while (0);
    do { if ( --((PyObject*)(binary))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(binary)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(binary)))); } while (0);
    free(found_encoding);
    ...
    for (i = 0; i < lineno; i++) {
        do { if ((lineobj) == ((void *)0)) ; else do { if ( --((PyObject*)(lineobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(lineobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(lineobj)))); } while (0); } while (0);
    ...
    if (res)
        ...
        PyErr_Clear();
    do { if ( --((PyObject*)(fob))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(fob)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(fob)))); } while (0);
    if (!lineobj || !((((((PyObject*)(lineobj))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        do { if ((lineobj) == ((void *)0)) ; else do { if ( --((PyObject*)(lineobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(lineobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(lineobj)))); } while (0); } while (0);
        return err;
    }


    kind = ((__builtin_expect(!(((((((PyObject*)(lineobj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "traceback.c", 292, "PyUnicode_Check(lineobj)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)lineobj)->state.ready)), 0) ? __assert_rtn(__func__, "traceback.c", 292, "PyUnicode_IS_READY(lineobj)") : (void)0), ((PyASCIIObject *)(lineobj))->state.kind);
    data = ((__builtin_expect(!(((((((PyObject*)(lineobj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "traceback.c", 293, "PyUnicode_Check(lineobj)") : (void)0), (((PyASCIIObject*)(lineobj))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)(lineobj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "traceback.c", 293, "PyUnicode_Check(lineobj)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)lineobj)->state.ready)), 0) ? __assert_rtn(__func__, "traceback.c", 293, "PyUnicode_IS_READY(lineobj)") : (void)0), ((PyASCIIObject*)lineobj)->state.ascii) ? ((void*)((PyASCIIObject*)(lineobj) + 1)) : ((void*)((PyCompactUnicodeObject*)(lineobj) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)(lineobj))->data.any), 0) ? __assert_rtn(__func__, "traceback.c", 293, "((PyUnicodeObject*)(lineobj))->data.any") : (void)0), ((((PyUnicodeObject *)(lineobj))->data.any))));
    for (i=0; i < ((__builtin_expect(!(((((((PyObject*)(lineobj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "traceback.c", 294, "PyUnicode_Check(lineobj)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)lineobj)->state.ready)), 0) ? __assert_rtn(__func__, "traceback.c", 294, "PyUnicode_IS_READY(lineobj)") : (void)0), ((PyASCIIObject *)(lineobj))->length); i++) {
    ...
    if (i) {
        PyObject *truncated;
        truncated = PyUnicode_Substring(lineobj, i, ((__builtin_expect(!(((((((PyObject*)(lineobj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "traceback.c", 301, "PyUnicode_Check(lineobj)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)lineobj)->state.ready)), 0) ? __assert_rtn(__func__, "traceback.c", 301, "PyUnicode_IS_READY(lineobj)") : (void)0), ((PyASCIIObject *)(lineobj))->length));
        if (truncated) {
    ...
    ((__builtin_object_size (buf, 0) != (size_t) -1) ? __builtin___strcpy_chk (buf, "          ", __builtin_object_size (buf, 2 > 1)) : __inline_strcpy_chk (buf, "          "));
    (__builtin_expect(!(strlen(buf) == 10), 0) ? __assert_rtn(__func__, "traceback.c", 312, "strlen(buf) == 10") : (void)0);
    while (indent > 0) {
        if(indent < 10)
            buf[indent] = '\0';
    ...
    if (err == 0)
        err = PyFile_WriteObject(lineobj, f, 1);
    do { if ( --((PyObject*)(lineobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(lineobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(lineobj)))); } while (0);
    if (err == 0)
...
tb_displayline(PyObject *f, PyObject *filename, int lineno, PyObject *name)
{
    ...
    if (filename == ((void *)0) || name == ((void *)0))
        return -1;
    line = PyUnicode_FromFormat("  File \"%U\", line %d, in %U\n",
                                filename, lineno, name);
    if (line == ((void *)0))
        return -1;
    err = PyFile_WriteObject(line, f, 1);
...
PyTraceBack_Print(PyObject *v, PyObject *f)
{
    ...
    if (v == ((void *)0))
        return 0;
    if (!((((PyObject*)(v))->ob_type) == &PyTraceBack_Type)) {
        _PyErr_BadInternalCall("traceback.c", 390);
        return -1;
    }
    ...
    if (limitv) {
        ...
        if (limit == -1 && PyErr_Occurred()) {
            if (PyErr_ExceptionMatches(PyExc_OverflowError)) {
                ...
                do { if ((exc_type) == ((void *)0)) ; else do { if ( --((PyObject*)(exc_type))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(exc_type)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(exc_type)))); } while (0); } while (0);
...
dump_frame(int fd, PyFrameObject *frame)
{
    ...
    if (code != ((void *)0) && code->co_filename != ((void *)0)
        && ((((((PyObject*)(code->co_filename))->ob_type))->tp_flags & ((1L<<28))) != 0))
    {
        write(fd, "\"", 1);
    ...
    if (code != ((void *)0) && code->co_name != ((void *)0)
        && ((((((PyObject*)(code->co_name))->ob_type))->tp_flags & ((1L<<28))) != 0))
...
dump_traceback(int fd, PyThreadState *tstate, int write_header)
{
    ...
    if (write_header)
        write(fd, "Traceback (most recent call first):\n", strlen("Traceback (most recent call first):\n"));
...
{
    if (is_current)
        write(fd, "Current thread 0x", strlen("Current thread 0x"));
    else
        write(fd, "Thread 0x", strlen("Thread 0x"));
