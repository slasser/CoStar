...
{
    static _Py_Identifier PyId___length_hint__ = { 0, "__length_hint__", 0 };
    ...
    ro = PyObject_CallFunctionObjArgs(hintmeth, ((void *)0));
    do { if ( --((PyObject*)(hintmeth))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(hintmeth)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(hintmeth)))); } while (0);
    if (ro == ((void *)0)) {
        if (!PyErr_ExceptionMatches(PyExc_TypeError))
            return -1;
        PyErr_Clear();
    ...
    rv = ((((((PyObject*)(ro))->ob_type))->tp_flags & ((1L<<24))) != 0) ? PyLong_AsSsize_t(ro) : defaultvalue;
    do { if ( --((PyObject*)(ro))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ro)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ro)))); } while (0);
    return rv;
}
...
PyObject_SetItem(PyObject *o, PyObject *key, PyObject *value)
{
    ...
    if (o == ((void *)0) || key == ((void *)0) || value == ((void *)0)) {
        null_error();
        return -1;
    }
    m = o->ob_type->tp_as_mapping;
...
PyObject_DelItem(PyObject *o, PyObject *key)
{
    ...
    m = o->ob_type->tp_as_mapping;
    if (m && m->mp_ass_subscript)
        return m->mp_ass_subscript(o, key, (PyObject*)((void *)0));
...
PyObject_DelItemString(PyObject *o, char *key)
{
    ...
    do { if ( --((PyObject*)(okey))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(okey)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(okey)))); } while (0);
    return ret;
}
                      ...
                      Py_ssize_t *buffer_len)
{
    ...
    if (obj == ((void *)0) || buffer == ((void *)0) || buffer_len == ((void *)0)) {
        null_error();
        return -1;
    }
    ...
    if ((*pb->bf_getbuffer)(obj, &view, 0)) return -1;

    *buffer = view.buf;
    *buffer_len = view.len;
    if (pb->bf_releasebuffer != ((void *)0))
        (*pb->bf_releasebuffer)(obj, &view);
    do { if ((view.obj) == ((void *)0)) ; else do { if ( --((PyObject*)(view.obj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(view.obj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(view.obj)))); } while (0); } while (0);
    return 0;
}
...
PyObject_CheckReadBuffer(PyObject *obj)
{
    ...
    if (pb == ((void *)0) ||
        pb->bf_getbuffer == ((void *)0))
        return 0;
    if ((*pb->bf_getbuffer)(obj, &view, 0) == -1) {
        PyErr_Clear();
        return 0;
    }
                           ...
                           Py_ssize_t *buffer_len)
{
    ...
    if (pb == ((void *)0) ||
        pb->bf_getbuffer == ((void *)0) ||
        ((*pb->bf_getbuffer)(obj, &view, 0x0001) != 0)) {
        PyErr_SetString(PyExc_TypeError,
...
{
    if (!(((obj)->ob_type->tp_as_buffer != ((void *)0)) && ((obj)->ob_type->tp_as_buffer->bf_getbuffer != ((void *)0)))) {
...
_IsFortranContiguous(const Py_buffer *view)
{
    ...
    if (view->strides == ((void *)0)) return (view->ndim == 1);
...
_IsCContiguous(const Py_buffer *view)
{
    ...
    if (view->ndim == 0) return 1;
    if (view->strides == ((void *)0)) return 1;
...
PyBuffer_IsContiguous(const Py_buffer *view, char order)
{
    ...
    if (view->suboffsets != ((void *)0)) return 0;
...
PyBuffer_GetPointer(Py_buffer *view, Py_ssize_t *indices)
{
    ...
    for (i = 0; i < view->ndim; i++) {
        ...
        if ((view->suboffsets != ((void *)0)) && (view->suboffsets[i] >= 0)) {
...
PyBuffer_FromContiguous(Py_buffer *view, void *buf, Py_ssize_t len, char fort)
{
    ...
    if (PyBuffer_IsContiguous(view, fort)) {
        ...
        ((__builtin_object_size (view->buf, 0) != (size_t) -1) ? __builtin___memcpy_chk (view->buf, buf, len, __builtin_object_size (view->buf, 0)) : __inline_memcpy_chk (view->buf, buf, len));
        return 0;
    }
    ...
    while (elements--) {
        ...
        ((__builtin_object_size (ptr, 0) != (size_t) -1) ? __builtin___memcpy_chk (ptr, src, view->itemsize, __builtin_object_size (ptr, 0)) : __inline_memcpy_chk (ptr, src, view->itemsize));
        src += view->itemsize;
    }
...
int PyObject_CopyData(PyObject *dest, PyObject *src)
{
    ...
    if (!(((dest)->ob_type->tp_as_buffer != ((void *)0)) && ((dest)->ob_type->tp_as_buffer->bf_getbuffer != ((void *)0))) ||
        !(((src)->ob_type->tp_as_buffer != ((void *)0)) && ((src)->ob_type->tp_as_buffer->bf_getbuffer != ((void *)0)))) {
        PyErr_SetString(PyExc_TypeError,
    ...
    if (PyObject_GetBuffer(dest, &view_dest, ((0x0100 | (0x0010 | 0x0008)) | 0x0001 | 0x0004)) != 0) return -1;
    if (PyObject_GetBuffer(src, &view_src, ((0x0100 | (0x0010 | 0x0008)) | 0x0004)) != 0) {
    ...
    if ((PyBuffer_IsContiguous(&view_dest, 'C') &&
        ...
        ((__builtin_object_size (view_dest.buf, 0) != (size_t) -1) ? __builtin___memcpy_chk (view_dest.buf, view_src.buf, view_src.len, __builtin_object_size (view_dest.buf, 0)) : __inline_memcpy_chk (view_dest.buf, view_src.buf, view_src.len));
        PyBuffer_Release(&view_dest);
        PyBuffer_Release(&view_src);
        return 0;
    }
    ...
    while (elements--) {
        ...
        ((__builtin_object_size (dptr, 0) != (size_t) -1) ? __builtin___memcpy_chk (dptr, sptr, view_src.itemsize, __builtin_object_size (dptr, 0)) : __inline_memcpy_chk (dptr, sptr, view_src.itemsize));
    }
    PyMem_Free(indices);
    PyBuffer_Release(&view_dest);
    PyBuffer_Release(&view_src);
...
PyBuffer_Release(Py_buffer *view)
{
    ...
    if (obj && (((PyObject*)(obj))->ob_type)->tp_as_buffer && (((PyObject*)(obj))->ob_type)->tp_as_buffer->bf_releasebuffer)
        (((PyObject*)(obj))->ob_type)->tp_as_buffer->bf_releasebuffer(obj, view);
...
{
    PyObject *meth;
    PyObject *empty = ((void *)0);
    PyObject *result = ((void *)0);
    static _Py_Identifier PyId___format__ = { 0, "__format__", 0 };
    ...
    result = PyObject_CallFunctionObjArgs(meth, format_spec, ((void *)0));
    do { if ( --((PyObject*)(meth))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(meth)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(meth)))); } while (0);

    if (result && !((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        PyErr_SetString(PyExc_TypeError,
    ...
    do { if ((empty) == ((void *)0)) ; else do { if ( --((PyObject*)(empty))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(empty)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(empty)))); } while (0); } while (0);
    return result;
}
...
{
    PyObject *x;
    binaryfunc slotv = ((void *)0);
    binaryfunc slotw = ((void *)0);

    if (v->ob_type->tp_as_number != ((void *)0))
        slotv = (*(binaryfunc*)(& ((char*)v->ob_type->tp_as_number)[op_slot]));
    if (w->ob_type != v->ob_type &&
        w->ob_type->tp_as_number != ((void *)0)) {
        slotw = (*(binaryfunc*)(& ((char*)w->ob_type->tp_as_number)[op_slot]));
        if (slotw == slotv)
            slotw = ((void *)0);
    }
    if (slotv) {
           ...
           const char *op_name)
{
    ...
    PyObject *x = ((void *)0);
    ternaryfunc slotv = ((void *)0);
    ternaryfunc slotw = ((void *)0);
    ternaryfunc slotz = ((void *)0);

    mv = v->ob_type->tp_as_number;
    mw = w->ob_type->tp_as_number;
    if (mv != ((void *)0))
        slotv = (*(ternaryfunc*)(& ((char*)mv)[op_slot]));
    if (w->ob_type != v->ob_type &&
        mw != ((void *)0)) {
        slotw = (*(ternaryfunc*)(& ((char*)mw)[op_slot]));
        if (slotw == slotv)
            slotw = ((void *)0);
    }
    if (slotv) {
    ...
    if (mz != ((void *)0)) {
        slotz = (*(ternaryfunc*)(& ((char*)mz)[op_slot]));
...
PyObject * PyNumber_Or(PyObject *v, PyObject *w) { return binary_op(v, w, __builtin_offsetof (PyNumberMethods, nb_or), "|"); }
PyObject * PyNumber_Xor(PyObject *v, PyObject *w) { return binary_op(v, w, __builtin_offsetof (PyNumberMethods, nb_xor), "^"); }
PyObject * PyNumber_And(PyObject *v, PyObject *w) { return binary_op(v, w, __builtin_offsetof (PyNumberMethods, nb_and), "&"); }
PyObject * PyNumber_Lshift(PyObject *v, PyObject *w) { return binary_op(v, w, __builtin_offsetof (PyNumberMethods, nb_lshift), "<<"); }
PyObject * PyNumber_Rshift(PyObject *v, PyObject *w) { return binary_op(v, w, __builtin_offsetof (PyNumberMethods, nb_rshift), ">>"); }
PyObject * PyNumber_Subtract(PyObject *v, PyObject *w) { return binary_op(v, w, __builtin_offsetof (PyNumberMethods, nb_subtract), "-"); }
PyObject * PyNumber_Divmod(PyObject *v, PyObject *w) { return binary_op(v, w, __builtin_offsetof (PyNumberMethods, nb_divmod), "divmod()"); }

PyObject *
PyNumber_Add(PyObject *v, PyObject *w)
{
    PyObject *result = binary_op1(v, w, __builtin_offsetof (PyNumberMethods, nb_add));
    if (result == (&_Py_NotImplementedStruct)) {
...
{
    Py_ssize_t count;
    if (((n)->ob_type->tp_as_number != ((void *)0) && (n)->ob_type->tp_as_number->nb_index != ((void *)0))) {
...
{
    PyObject *result = binary_op1(v, w, __builtin_offsetof (PyNumberMethods, nb_multiply));
    if (result == (&_Py_NotImplementedStruct)) {
...
{
    return binary_op(v, w, __builtin_offsetof (PyNumberMethods, nb_floor_divide), "//");
}

PyObject *
PyNumber_TrueDivide(PyObject *v, PyObject *w)
{
    return binary_op(v, w, __builtin_offsetof (PyNumberMethods, nb_true_divide), "/");
}

PyObject *
PyNumber_Remainder(PyObject *v, PyObject *w)
{
    return binary_op(v, w, __builtin_offsetof (PyNumberMethods, nb_remainder), "%");
}

PyObject *
PyNumber_Power(PyObject *v, PyObject *w, PyObject *z)
{
    return ternary_op(v, w, z, __builtin_offsetof (PyNumberMethods, nb_power), "** or pow()");
}
# 951 "abstract.c"
static PyObject *
binary_iop1(PyObject *v, PyObject *w, const int iop_slot, const int op_slot)
{
    ...
    if (mv != ((void *)0)) {
        binaryfunc slot = (*(binaryfunc*)(& ((char*)mv)[iop_slot]));
        if (slot) {
            PyObject *x = (slot)(v, w);
            if (x != (&_Py_NotImplementedStruct)) {
                return x;
...
PyObject * PyNumber_InPlaceOr(PyObject *v, PyObject *w) { return binary_iop(v, w, __builtin_offsetof (PyNumberMethods, nb_inplace_or), __builtin_offsetof (PyNumberMethods, nb_or), "|="); }
PyObject * PyNumber_InPlaceXor(PyObject *v, PyObject *w) { return binary_iop(v, w, __builtin_offsetof (PyNumberMethods, nb_inplace_xor), __builtin_offsetof (PyNumberMethods, nb_xor), "^="); }
PyObject * PyNumber_InPlaceAnd(PyObject *v, PyObject *w) { return binary_iop(v, w, __builtin_offsetof (PyNumberMethods, nb_inplace_and), __builtin_offsetof (PyNumberMethods, nb_and), "&="); }
PyObject * PyNumber_InPlaceLshift(PyObject *v, PyObject *w) { return binary_iop(v, w, __builtin_offsetof (PyNumberMethods, nb_inplace_lshift), __builtin_offsetof (PyNumberMethods, nb_lshift), "<<="); }
PyObject * PyNumber_InPlaceRshift(PyObject *v, PyObject *w) { return binary_iop(v, w, __builtin_offsetof (PyNumberMethods, nb_inplace_rshift), __builtin_offsetof (PyNumberMethods, nb_rshift), ">>="); }
PyObject * PyNumber_InPlaceSubtract(PyObject *v, PyObject *w) { return binary_iop(v, w, __builtin_offsetof (PyNumberMethods, nb_inplace_subtract), __builtin_offsetof (PyNumberMethods, nb_subtract), "-="); }

PyObject *
PyNumber_InPlaceFloorDivide(PyObject *v, PyObject *w)
{
    return binary_iop(v, w, __builtin_offsetof (PyNumberMethods, nb_inplace_floor_divide),
                      __builtin_offsetof (PyNumberMethods, nb_floor_divide), "//=");
}

PyObject *
PyNumber_InPlaceTrueDivide(PyObject *v, PyObject *w)
{
    return binary_iop(v, w, __builtin_offsetof (PyNumberMethods, nb_inplace_true_divide),
                      __builtin_offsetof (PyNumberMethods, nb_true_divide), "/=");
}

PyObject *
PyNumber_InPlaceAdd(PyObject *v, PyObject *w)
{
    PyObject *result = binary_iop1(v, w, __builtin_offsetof (PyNumberMethods, nb_inplace_add),
                                   __builtin_offsetof (PyNumberMethods, nb_add));
    if (result == (&_Py_NotImplementedStruct)) {
        PySequenceMethods *m = v->ob_type->tp_as_sequence;
        do { if ( --((PyObject*)(result))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(result)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(result)))); } while (0);
        if (m != ((void *)0)) {
...
{
    PyObject *result = binary_iop1(v, w, __builtin_offsetof (PyNumberMethods, nb_inplace_multiply),
                                   __builtin_offsetof (PyNumberMethods, nb_multiply));
    if (result == (&_Py_NotImplementedStruct)) {
        ssizeargfunc f = ((void *)0);
        PySequenceMethods *mv = v->ob_type->tp_as_sequence;
        PySequenceMethods *mw = w->ob_type->tp_as_sequence;
        do { if ( --((PyObject*)(result))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(result)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(result)))); } while (0);
        if (mv != ((void *)0)) {
...
{
    return binary_iop(v, w, __builtin_offsetof (PyNumberMethods, nb_inplace_remainder),
                            __builtin_offsetof (PyNumberMethods, nb_remainder), "%=");
}
...
PyNumber_InPlacePower(PyObject *v, PyObject *w, PyObject *z)
{
    if (v->ob_type->tp_as_number &&
        v->ob_type->tp_as_number->nb_inplace_power != ((void *)0)) {
        return ternary_op(v, w, z, __builtin_offsetof (PyNumberMethods, nb_inplace_power), "**=");
    }
    else {
        return ternary_op(v, w, z, __builtin_offsetof (PyNumberMethods, nb_power), "**=");
    }
}
...
PyNumber_AsSsize_t(PyObject *item, PyObject *err)
{
    ...
    if (!err) {
        (__builtin_expect(!(((((((PyObject*)(value))->ob_type))->tp_flags & ((1L<<24))) != 0)), 0) ? __assert_rtn(__func__, "abstract.c", 1193, "PyLong_Check(value)") : (void)0);



        if (_PyLong_Sign(value) < 0)
            result = (-((Py_ssize_t)(((size_t)-1)>>1))-1);
        else
            result = ((Py_ssize_t)(((size_t)-1)>>1));
    }
    else {
...
{
    PyNumberMethods *nb;
    if (((((((PyObject*)(integral))->ob_type))->tp_flags & ((1L<<24))) != 0))
        return integral;
    nb = (((PyObject*)(integral))->ob_type)->tp_as_number;
    if (nb->nb_int) {
        PyObject *as_int = nb->nb_int(integral);
        if (!as_int || ((((((PyObject*)(as_int))->ob_type))->tp_flags & ((1L<<24))) != 0)) {
            do { if ( --((PyObject*)(integral))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(integral)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(integral)))); } while (0);
            return as_int;
        }
        do { if ( --((PyObject*)(as_int))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(as_int)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(as_int)))); } while (0);
    }
    PyErr_Format(PyExc_TypeError, error_format, (((PyObject*)(integral))->ob_type)->tp_name);
    do { if ( --((PyObject*)(integral))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(integral)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(integral)))); } while (0);
    return ((void *)0);
}
...
PyNumber_Long(PyObject *o)
{
    ...
    if (o == ((void *)0))
        return null_error();
    if (((((PyObject*)(o))->ob_type) == &PyLong_Type)) {
    ...
    if (m && m->nb_int) {
        ...
        if (res && !((((((PyObject*)(res))->ob_type))->tp_flags & ((1L<<24))) != 0)) {
            PyErr_Format(PyExc_TypeError,
    ...
    if (trunc_func) {
        PyObject *truncated = PyEval_CallObjectWithKeywords(trunc_func, ((void *)0), (PyObject *)((void *)0));
        PyObject *int_instance;
        do { if ( --((PyObject*)(trunc_func))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(trunc_func)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(trunc_func)))); } while (0);
    ...
    if (((((((PyObject*)(o))->ob_type))->tp_flags & ((1L<<27))) != 0))




        return long_from_string(((__builtin_expect(!(((((((PyObject*)(o))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "abstract.c", 1310, "PyBytes_Check(o)") : (void)0), (((PyBytesObject *)(o))->ob_sval)),
                                ((__builtin_expect(!(((((((PyObject*)(o))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "abstract.c", 1311, "PyBytes_Check(o)") : (void)0),(((PyVarObject*)(o))->ob_size)));
    if (((((((PyObject*)(o))->ob_type))->tp_flags & ((1L<<28))) != 0))
...
PyNumber_Float(PyObject *o)
{
    ...
    if (m && m->nb_float) {
        ...
        if (res && !((((PyObject*)(res))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(res))->ob_type), (&PyFloat_Type)))) {
            PyErr_Format(PyExc_TypeError,
...
{
    if (((((((PyObject*)(s))->ob_type))->tp_flags & ((1L<<29))) != 0))
        return 0;
    return s != ((void *)0) && s->ob_type->tp_as_sequence &&
        s->ob_type->tp_as_sequence->sq_item != ((void *)0);
}
...
PySequence_Concat(PyObject *s, PyObject *o)
{
    ...
    if (PySequence_Check(s) && PySequence_Check(o)) {
        PyObject *result = binary_op1(s, o, __builtin_offsetof (PyNumberMethods, nb_add));
        if (result != (&_Py_NotImplementedStruct))
            return result;
        do { if ( --((PyObject*)(result))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(result)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(result)))); } while (0);
    }
...
PySequence_Repeat(PyObject *o, Py_ssize_t count)
{
    ...
    if (PySequence_Check(o)) {
        ...
        if (n == ((void *)0))
            return ((void *)0);
        result = binary_op1(o, n, __builtin_offsetof (PyNumberMethods, nb_multiply));
...
PySequence_InPlaceConcat(PyObject *s, PyObject *o)
{
    ...
    if (PySequence_Check(s) && PySequence_Check(o)) {
        PyObject *result = binary_iop1(s, o, __builtin_offsetof (PyNumberMethods, nb_inplace_add),
                                       __builtin_offsetof (PyNumberMethods, nb_add));
        if (result != (&_Py_NotImplementedStruct))
            return result;
        do { if ( --((PyObject*)(result))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(result)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(result)))); } while (0);
...
PySequence_InPlaceRepeat(PyObject *o, Py_ssize_t count)
{
    ...
    if (PySequence_Check(o)) {
        ...
        if (n == ((void *)0))
            return ((void *)0);
        result = binary_iop1(o, n, __builtin_offsetof (PyNumberMethods, nb_inplace_multiply),
                             __builtin_offsetof (PyNumberMethods, nb_multiply));
        do { if ( --((PyObject*)(n))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(n)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(n)))); } while (0);
        if (result != (&_Py_NotImplementedStruct))
            return result;
...
PySequence_DelItem(PyObject *s, Py_ssize_t i)
{
    ...
    if (m && m->sq_ass_item) {
        ...
        return m->sq_ass_item(s, i, (PyObject *)((void *)0));
    }
...
PySequence_DelSlice(PyObject *s, Py_ssize_t i1, Py_ssize_t i2)
{
    ...
    if (mp && mp->mp_ass_subscript) {
        ...
        if (!slice)
            return -1;
        res = mp->mp_ass_subscript(s, slice, ((void *)0));
        do { if ( --((PyObject*)(slice))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(slice)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(slice)))); } while (0);
        return res;
    }
...
PySequence_Tuple(PyObject *v)
{
    ...
    if (((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<25))) != 0))
    ...
    for (j = 0; ; ++j) {
        ...
        (((PyTupleObject *)(result))->ob_item[j] = item);
    }
...
PySequence_Fast(PyObject *v, const char *m)
{
    ...
    if (((((PyObject*)(v))->ob_type) == &PyList_Type) || ((((PyObject*)(v))->ob_type) == &PyTuple_Type)) {
        ( ((PyObject*)(v))->ob_refcnt++);
        return v;
    }
...
_PySequence_IterSearch(PyObject *seq, PyObject *obj, int operation)
{
    ...
    for (;;) {
        ...
        cmp = PyObject_RichCompareBool(obj, item, 2);
        do { if ( --((PyObject*)(item))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(item)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(item)))); } while (0);
        if (cmp < 0)
            goto Fail;
        if (cmp > 0) {
            ...
            default:
                (__builtin_expect(!(!"unknown operation"), 0) ? __assert_rtn(__func__, "abstract.c", 1853, "!\"unknown operation\"") : (void)0);
            }
        }
...
{
    return _PySequence_IterSearch(s, o, 1);
}
...
PySequence_Contains(PyObject *seq, PyObject *ob)
{
    ...
    if (sqm != ((void *)0) && sqm->sq_contains != ((void *)0))
        return (*sqm->sq_contains)(seq, ob);
    result = _PySequence_IterSearch(seq, ob, 3);
    return (int)(result);
}
...
{
    return _PySequence_IterSearch(s, o, 2);
}
...
PyMapping_Keys(PyObject *o)
{
    ...
    if (((((PyObject*)(o))->ob_type) == &PyDict_Type))
        return PyDict_Keys(o);
    keys = _PyObject_CallMethodId(o, &PyId_keys, ((void *)0));
    if (keys == ((void *)0))
        return ((void *)0);
...
PyMapping_Items(PyObject *o)
{
    ...
    items = _PyObject_CallMethodId(o, &PyId_items, ((void *)0));
    if (items == ((void *)0))
        return ((void *)0);
...
PyMapping_Values(PyObject *o)
{
    ...
    values = _PyObject_CallMethodId(o, &PyId_values, ((void *)0));
    if (values == ((void *)0))
        return ((void *)0);
...
{
    return PyEval_CallObjectWithKeywords(o, a, ((void *)0));
}
...
PyObject_Call(PyObject *func, PyObject *arg, PyObject *kw)
{
    ...
    if ((call = func->ob_type->tp_call) != ((void *)0)) {
        ...
        if (result == ((void *)0) && !PyErr_Occurred())
            PyErr_SetString(
                PyExc_SystemError,
...
call_function_tail(PyObject *callable, PyObject *args)
{
    ...
    if (!((((((PyObject*)(args))->ob_type))->tp_flags & ((1L<<26))) != 0)) {
        ...
        (((PyTupleObject *)(a))->ob_item[0] = args);
        args = a;
    }
    retval = PyObject_Call(callable, args, ((void *)0));
...
objargs_mktuple(va_list va)
{
    ...
    PyObject *result, *tmp;
        ...
        ((__builtin_object_size ((countva), 0) != (size_t) -1) ? __builtin___memcpy_chk ((countva), (va), sizeof(va_list), __builtin_object_size ((countva), 0)) : __inline_memcpy_chk ((countva), (va), sizeof(va_list)));

    while (((PyObject *)__builtin_va_arg(countva,PyObject *)) != ((void *)0))
        ++n;
    result = PyTuple_New(n);
    if (result != ((void *)0) && n > 0) {
        for (i = 0; i < n; ++i) {
            tmp = (PyObject *)__builtin_va_arg(va,PyObject *);
            (((PyTupleObject *)(result))->ob_item[i] = tmp);
...
PyObject_CallMethodObjArgs(PyObject *callable, PyObject *name, ...)
{
    ...
    if (callable == ((void *)0) || name == ((void *)0))
        return null_error();
    ...
    tmp = PyObject_Call(callable, args, ((void *)0));
    do { if ( --((PyObject*)(args))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(args)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(args)))); } while (0);
    do { if ( --((PyObject*)(callable))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(callable)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(callable)))); } while (0);
...
PyObject_CallFunctionObjArgs(PyObject *callable, ...)
{
    ...
    __builtin_va_start(vargs,callable);
    args = objargs_mktuple(vargs);
    __builtin_va_end(vargs);
    if (args == ((void *)0))
        return ((void *)0);
...
abstract_get_bases(PyObject *cls)
{
    ...
    if (!((((((PyObject*)(bases))->ob_type))->tp_flags & ((1L<<26))) != 0)) {
...
abstract_issubclass(PyObject *derived, PyObject *cls)
{
    ...
    while (1) {
        ...
        if (n == 1) {
            derived = (((PyTupleObject *)(bases))->ob_item[0]);
            do { if ( --((PyObject*)(bases))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(bases)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(bases)))); } while (0);
            continue;
        }
        for (i = 0; i < n; i++) {
            r = abstract_issubclass((((PyTupleObject *)(bases))->ob_item[i]), cls);
            if (r != 0)
                break;
        }
        do { if ( --((PyObject*)(bases))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(bases)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(bases)))); } while (0);
...
recursive_isinstance(PyObject *inst, PyObject *cls)
{
    ...
    if (((((((PyObject*)(cls))->ob_type))->tp_flags & ((1L<<31))) != 0)) {
        retval = ((((PyObject*)(inst))->ob_type) == ((PyTypeObject *)cls) || PyType_IsSubtype((((PyObject*)(inst))->ob_type), ((PyTypeObject *)cls)));
        if (retval == 0) {
            ...
            if (c == ((void *)0)) {
                ...
                if (c != (PyObject *)(inst->ob_type) &&
                    ((((((PyObject*)(c))->ob_type))->tp_flags & ((1L<<31))) != 0))
        ...
        if (icls == ((void *)0)) {
            ...
            do { if ( --((PyObject*)(icls))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(icls)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(icls)))); } while (0);
        }
    }
...
{
    static _Py_Identifier PyId___instancecheck__ = { 0, "__instancecheck__", 0 };
    PyObject *checker;


    if ((((PyObject*)(inst))->ob_type) == (PyTypeObject *)cls)
        return 1;

    if (((((((PyObject*)(cls))->ob_type))->tp_flags & ((1L<<26))) != 0)) {
        Py_ssize_t i;
        Py_ssize_t n;
        int r = 0;

        if (((++(((PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; }))->recursion_depth) > _Py_CheckRecursionLimit) && _Py_CheckRecursiveCall(" in __instancecheck__")))
            return -1;
        n = (((PyVarObject*)(cls))->ob_size);
        for (i = 0; i < n; ++i) {
            PyObject *item = (((PyTupleObject *)(cls))->ob_item[i]);
    ...
    if (checker != ((void *)0)) {
        ...
        int ok = -1;
        if (((++(((PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; }))->recursion_depth) > _Py_CheckRecursionLimit) && _Py_CheckRecursiveCall(" in __instancecheck__"))) {
            do { if ( --((PyObject*)(checker))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(checker)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(checker)))); } while (0);
            return ok;
        }
        res = PyObject_CallFunctionObjArgs(checker, inst, ((void *)0));
        do{ if((--(((PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; }))->recursion_depth) < ((_Py_CheckRecursionLimit > 100) ? (_Py_CheckRecursionLimit - 50) : (3 * (_Py_CheckRecursionLimit >> 2))))) ((PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; }))->overflowed = 0; } while(0);
        do { if ( --((PyObject*)(checker))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(checker)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(checker)))); } while (0);
        if (res != ((void *)0)) {
...
{
    if (((((((PyObject*)(cls))->ob_type))->tp_flags & ((1L<<31))) != 0) && ((((((PyObject*)(derived))->ob_type))->tp_flags & ((1L<<31))) != 0)) {
...
{
    static _Py_Identifier PyId___subclasscheck__ = { 0, "__subclasscheck__", 0 };
    PyObject *checker;
    ...
    if (((((((PyObject*)(cls))->ob_type))->tp_flags & ((1L<<26))) != 0)) {
        ...
        if (((++(((PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; }))->recursion_depth) > _Py_CheckRecursionLimit) && _Py_CheckRecursiveCall(" in __subclasscheck__")))
            return -1;
        n = (((PyVarObject*)(cls))->ob_size);
        for (i = 0; i < n; ++i) {
            PyObject *item = (((PyTupleObject *)(cls))->ob_item[i]);
    ...
    if (checker != ((void *)0)) {
        ...
        res = PyObject_CallFunctionObjArgs(checker, derived, ((void *)0));
        do{ if((--(((PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; }))->recursion_depth) < ((_Py_CheckRecursionLimit > 100) ? (_Py_CheckRecursionLimit - 50) : (3 * (_Py_CheckRecursionLimit >> 2))))) ((PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; }))->overflowed = 0; } while(0);
        do { if ( --((PyObject*)(checker))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(checker)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(checker)))); } while (0);
        if (res != ((void *)0)) {
            ok = PyObject_IsTrue(res);
...
PyObject_GetIter(PyObject *o)
{
    ...
    if (f == ((void *)0)) {
        ...
        PyObject *res = (*f)(o);
        if (res != ((void *)0) && !((res)->ob_type->tp_iternext != ((void *)0) && (res)->ob_type->tp_iternext != &_PyObject_NextNotImplemented)) {
            PyErr_Format(PyExc_TypeError,
...
_PySequence_BytesToCharpArray(PyObject* self)
{
    ...
    (__builtin_expect(!(argc >= 0), 0) ? __assert_rtn(__func__, "abstract.c", 2712, "argc >= 0") : (void)0);

    if ((size_t)argc > (((Py_ssize_t)(((size_t)-1)>>1))-sizeof(char *)) / sizeof(char *)) {
        PyErr_NoMemory();
        return ((void *)0);
    }
