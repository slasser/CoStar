...
{
    if (!((im)->ob_type == &PyMethod_Type)) {
        _PyErr_BadInternalCall("classobject.c", 23);
        return ((void *)0);
    }
...
{
    if (!((im)->ob_type == &PyMethod_Type)) {
        _PyErr_BadInternalCall("classobject.c", 33);
        return ((void *)0);
    }
...
PyMethod_New(PyObject *func, PyObject *self)
{
    ...
    if (self == ((void *)0)) {
        _PyErr_BadInternalCall("classobject.c", 49);
        return ((void *)0);
    }
    im = free_list;
    if (im != ((void *)0)) {
        free_list = (PyMethodObject *)(im->im_self);
        ( (((PyObject*)(im))->ob_type) = (&PyMethod_Type), ( (((PyObject*)((PyObject *)(im)))->ob_refcnt) = 1), (im) );
        numfree--;
    }
    else {
        im = ( (PyMethodObject *) _PyObject_GC_New(&PyMethod_Type) );
        if (im == ((void *)0))
            return ((void *)0);
    }
    im->im_weakreflist = ((void *)0);
    ( ((PyObject*)(func))->ob_refcnt++);
    im->im_func = func;
    do { if ((self) == ((void *)0)) ; else ( ((PyObject*)(self))->ob_refcnt++); } while (0);
    im->im_self = self;
    do { PyGC_Head *g = ((PyGC_Head *)(im)-1); if (g->gc.gc_refs != (-2)) Py_FatalError("GC object already tracked"); g->gc.gc_refs = (-3); g->gc.gc_next = _PyGC_generation0; g->gc.gc_prev = _PyGC_generation0->gc.gc_prev; g->gc.gc_prev->gc.gc_next = g; _PyGC_generation0->gc.gc_prev = g; } while (0);;
    return (PyObject *)im;
}
...
static PyMemberDef method_memberlist[] = {
    {"__func__", 6, __builtin_offsetof (PyMethodObject, im_func), 1|(2 | 4),
     "the function (or other callable) implementing a method"},
    {"__self__", 6, __builtin_offsetof (PyMethodObject, im_self), 1|(2 | 4),
...
static PyGetSetDef method_getset[] = {
    {"__doc__", (getter)method_get_doc, ((void *)0), ((void *)0)},
    {0}
};
...
static char method_doc[] = "method(function, instance)\n\nCreate a bound instance method object.";
...
method_new(PyTypeObject* type, PyObject* args, PyObject *kw)
{
    ...
    if (self == ((void *)0) || self == (&_Py_NoneStruct)) {
        PyErr_SetString(PyExc_TypeError,
...
{
    do { PyGC_Head *g = ((PyGC_Head *)(im)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "classobject.c", 169, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
    if (im->im_weakreflist != ((void *)0))
        PyObject_ClearWeakRefs((PyObject *)im);
    do { if ( --((PyObject*)(im->im_func))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(im->im_func)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(im->im_func)))); } while (0);
    do { if ((im->im_self) == ((void *)0)) ; else do { if ( --((PyObject*)(im->im_self))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(im->im_self)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(im->im_self)))); } while (0); } while (0);
    if (numfree < 256) {
...
method_richcompare(PyObject *self, PyObject *other, int op)
{
    ...
    if ((op != 2 && op != 3) ||
        !((self)->ob_type == &PyMethod_Type) ||
        !((other)->ob_type == &PyMethod_Type))
    {
        return ( ((PyObject*)((&_Py_NotImplementedStruct)))->ob_refcnt++), (&_Py_NotImplementedStruct);
    }
    a = (PyMethodObject *)self;
    b = (PyMethodObject *)other;
    eq = PyObject_RichCompareBool(a->im_func, b->im_func, 2);
    if (eq == 1) {
        if (a->im_self == ((void *)0) || b->im_self == ((void *)0))
    ...
    if (eq < 0)
        return ((void *)0);
    if (op == 2)
        res = eq ? ((PyObject *) &_Py_TrueStruct) : ((PyObject *) &_Py_FalseStruct);
    else
        res = eq ? ((PyObject *) &_Py_FalseStruct) : ((PyObject *) &_Py_TrueStruct);
...
method_repr(PyMethodObject *a)
{
    ...
    PyObject *klass;
    PyObject *funcname = ((void *)0) ,*klassname = ((void *)0), *result = ((void *)0);
    char *defname = "?";

    if (self == ((void *)0)) {
        _PyErr_BadInternalCall("classobject.c", 227);
        return ((void *)0);
    }
    klass = (PyObject*)(((PyObject*)(self))->ob_type);
    ...
    else if (!((((((PyObject*)(funcname))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        do { if ( --((PyObject*)(funcname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(funcname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(funcname)))); } while (0);
        funcname = ((void *)0);
    }
    ...
    if (klass == ((void *)0))
        ...
        if (klassname == ((void *)0)) {
            if (!PyErr_ExceptionMatches(PyExc_AttributeError)) {
                do { if ((funcname) == ((void *)0)) ; else do { if ( --((PyObject*)(funcname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(funcname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(funcname)))); } while (0); } while (0);
                return ((void *)0);
            }
            PyErr_Clear();
        }
        else if (!((((((PyObject*)(klassname))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
            do { if ( --((PyObject*)(klassname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(klassname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(klassname)))); } while (0);
            klassname = ((void *)0);
        }
    }
    ...
    do { if ((funcname) == ((void *)0)) ; else do { if ( --((PyObject*)(funcname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(funcname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(funcname)))); } while (0); } while (0);
    do { if ((klassname) == ((void *)0)) ; else do { if ( --((PyObject*)(klassname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(klassname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(klassname)))); } while (0); } while (0);
    return result;
}
...
method_hash(PyMethodObject *a)
{
    Py_hash_t x, y;
    if (a->im_self == ((void *)0))
        x = PyObject_Hash((&_Py_NoneStruct));
    else
...
{
    do { if (im->im_func) { int vret = visit((PyObject *)(im->im_func), arg); if (vret) return vret; } } while (0);
    do { if (im->im_self) { int vret = visit((PyObject *)(im->im_self), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
method_call(PyObject *func, PyObject *arg, PyObject *kw)
{
    ...
    if (self == ((void *)0)) {
        _PyErr_BadInternalCall("classobject.c", 305);
        return ((void *)0);
    }
    else {
        ...
        (((PyTupleObject *)(newarg))->ob_item[0] = self);
        for (i = 0; i < argcount; i++) {
            PyObject *v = (((PyTupleObject *)(arg))->ob_item[i]);
            do { if ((v) == ((void *)0)) ; else ( ((PyObject*)(v))->ob_refcnt++); } while (0);
            (((PyTupleObject *)(newarg))->ob_item[i+1] = v);
        }
        arg = newarg;
    }
...
method_descr_get(PyObject *meth, PyObject *obj, PyObject *cls)
{
    ...
    if ((((PyMethodObject *)meth) -> im_self) != ((void *)0)) {

        ( ((PyObject*)(meth))->ob_refcnt++);
        return meth;
    }

    return PyMethod_New((((PyMethodObject *)meth) -> im_func), obj);
}
...
PyTypeObject PyMethod_Type = {
    ...
    ( 0 | (1L<<18) | 0) | (1L<<14),
    method_doc,
    (traverseproc)method_traverse,
    0,
    method_richcompare,
    __builtin_offsetof (PyMethodObject, im_weakreflist),
    0,
    0,
    0,
    method_memberlist,
...
PyMethod_ClearFreeList(void)
{
    ...
    (__builtin_expect(!(numfree == 0), 0) ? __assert_rtn(__func__, "classobject.c", 396, "numfree == 0") : (void)0);
...
PyInstanceMethod_New(PyObject *func) {
    ...
    method = ( (PyInstanceMethodObject *) _PyObject_GC_New(&PyInstanceMethod_Type) );

    if (method == ((void *)0)) return ((void *)0);
    ( ((PyObject*)(func))->ob_refcnt++);
    method->func = func;
    do { PyGC_Head *g = ((PyGC_Head *)(method)-1); if (g->gc.gc_refs != (-2)) Py_FatalError("GC object already tracked"); g->gc.gc_refs = (-3); g->gc.gc_next = _PyGC_generation0; g->gc.gc_prev = _PyGC_generation0->gc.gc_prev; g->gc.gc_prev->gc.gc_next = g; _PyGC_generation0->gc.gc_prev = g; } while (0);;
...
{
    if (!((im)->ob_type == &PyInstanceMethod_Type)) {
        _PyErr_BadInternalCall("classobject.c", 435);
        return ((void *)0);
    }
    return (((PyInstanceMethodObject *)im) -> func);
}



static PyMemberDef instancemethod_memberlist[] = {
    {"__func__", 6, __builtin_offsetof (PyInstanceMethodObject, func), 1|(2 | 4),
     "the function (or other callable) implementing a method"},
    {((void *)0)}
};
...
instancemethod_get_doc(PyObject *self, void *context)
{
    ...
    return PyObject_GetAttr((((PyInstanceMethodObject *)self) -> func), docstr);
}

static PyGetSetDef instancemethod_getset[] = {
    {"__doc__", (getter)instancemethod_get_doc, ((void *)0), ((void *)0)},
    {0}
};
...
instancemethod_getattro(PyObject *self, PyObject *name)
{
    ...
    return PyObject_GetAttr((((PyInstanceMethodObject *)self) -> func), name);
}

static void
instancemethod_dealloc(PyObject *self) {
    do { PyGC_Head *g = ((PyGC_Head *)(self)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "classobject.c", 493, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
    do { if ( --((PyObject*)((((PyInstanceMethodObject *)self) -> func)))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)((((PyInstanceMethodObject *)self) -> func))))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)((((PyInstanceMethodObject *)self) -> func))))); } while (0);
    PyObject_GC_Del(self);
}

static int
instancemethod_traverse(PyObject *self, visitproc visit, void *arg) {
    do { if ((((PyInstanceMethodObject *)self) -> func)) { int vret = visit((PyObject *)((((PyInstanceMethodObject *)self) -> func)), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
{
    return PyObject_Call((((PyMethodObject *)self) -> im_func), arg, kw);
}

static PyObject *
instancemethod_descr_get(PyObject *descr, PyObject *obj, PyObject *type) {
    register PyObject *func = (((PyInstanceMethodObject *)descr) -> func);
    if (obj == ((void *)0)) {
        ( ((PyObject*)(func))->ob_refcnt++);
        return func;
    }
...
instancemethod_richcompare(PyObject *self, PyObject *other, int op)
{
    ...
    if ((op != 2 && op != 3) ||
        !((self)->ob_type == &PyInstanceMethod_Type) ||
        !((other)->ob_type == &PyInstanceMethod_Type))
    {
        return ( ((PyObject*)((&_Py_NotImplementedStruct)))->ob_refcnt++), (&_Py_NotImplementedStruct);
    }
    a = (PyInstanceMethodObject *)self;
    b = (PyInstanceMethodObject *)other;
    eq = PyObject_RichCompareBool(a->func, b->func, 2);
    if (eq < 0)
        return ((void *)0);
    if (op == 2)
        res = eq ? ((PyObject *) &_Py_TrueStruct) : ((PyObject *) &_Py_FalseStruct);
...
instancemethod_repr(PyObject *self)
{
    ...
    PyObject *funcname = ((void *)0) , *result = ((void *)0);
    char *defname = "?";

    if (func == ((void *)0)) {
        _PyErr_BadInternalCall("classobject.c", 555);
        return ((void *)0);
    }
...
# 593 "classobject.c"
static char instancemethod_doc[] = "instancemethod(function)\n\nBind a function to a class.";
