...
join_list_unicode(PyObject *lst)
{
    ...
    do { if ( --((PyObject*)(sep))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sep)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sep)))); } while (0);
    return ret;
}
...
{
    Py_ssize_t nsmall = (((PyVarObject*)(acc->small))->ob_size);
    if (nsmall) {
        int ret;
        PyObject *joined;
        if (acc->large == ((void *)0)) {
        ...
        if (joined == ((void *)0))
            return -1;
        if (PyList_SetSlice(acc->small, 0, nsmall, ((void *)0))) {
...
{
    Py_ssize_t nsmall;
    (__builtin_expect(!(((((((PyObject*)(unicode))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "accu.c", 58, "PyUnicode_Check(unicode)") : (void)0);

    if (PyList_Append(acc->small, unicode))
        return -1;
    nsmall = (((PyVarObject*)(acc->small))->ob_size);
...
_PyAccu_FinishAsList(_PyAccu *acc)
{
    ...
    do { if (acc->small) { PyObject *_py_tmp = (PyObject *)(acc->small); (acc->small) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    if (ret) {
        do { if (acc->large) { PyObject *_py_tmp = (PyObject *)(acc->large); (acc->large) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
        return ((void *)0);
    }
    res = acc->large;
    acc->large = ((void *)0);
