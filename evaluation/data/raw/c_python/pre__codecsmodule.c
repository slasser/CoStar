...
static char register__doc__[] = "register(search_function)\n\nRegister a codec search function. Search functions are expected to take\none argument, the encoding name in all lower case letters, and return\na tuple of functions (encoder, decoder, stream_reader, stream_writer)\n(or a CodecInfo object).";
...
static char lookup__doc__[] = "lookup(encoding) -> CodecInfo\n\nLooks up a codec tuple in the Python codec registry and returns\na CodecInfo object.";
...
PyObject *codec_lookup(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "s:lookup", &encoding))
        return ((void *)0);

    return _PyCodec_Lookup(encoding);
}

static char encode__doc__[] = "encode(obj, [encoding[,errors]]) -> object\n\nEncodes obj using the codec registered for encoding. encoding defaults\nto the default encoding. errors may be given to set a different error\nhandling scheme. Default is 'strict' meaning that encoding errors raise\na ValueError. Other possible values are 'ignore', 'replace' and\n'xmlcharrefreplace' as well as any other name registered with\ncodecs.register_error that can handle ValueErrors.";
# 91 "_codecsmodule.c"
static PyObject *
codec_encode(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|ss:encode", &v, &encoding, &errors))
        return ((void *)0);
...
static char decode__doc__[] = "decode(obj, [encoding[,errors]]) -> object\n\nDecodes obj using the codec registered for encoding. encoding defaults\nto the default encoding. errors may be given to set a different error\nhandling scheme. Default is 'strict' meaning that encoding errors raise\na ValueError. Other possible values are 'ignore' and 'replace'\nas well as any other name registered with codecs.register_error that is\nable to handle ValueErrors.";
# 118 "_codecsmodule.c"
static PyObject *
codec_decode(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|ss:decode", &v, &encoding, &errors))
        return ((void *)0);
                      ...
                      Py_ssize_t len)
{
    ...
    if (unicode == ((void *)0))
        return ((void *)0);
    v = _Py_BuildValue_SizeT("On", unicode, len);
              ...
              PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "s#|z:escape_decode",
                          &data, &size, &errors))
        return ((void *)0);
    return codec_tuple(PyBytes_DecodeEscape(data, size, errors, 0, ((void *)0)),
                       size);
}
              ...
              PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O!|z:escape_encode",
                          &PyBytes_Type, &str, &errors))
        return ((void *)0);

    size = ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 179, "PyBytes_Check(str)") : (void)0),(((PyVarObject*)(str))->ob_size));
    if (size > ((Py_ssize_t)(((size_t)-1)>>1)) / 4) {
        PyErr_SetString(PyExc_OverflowError,
            "string is too large to encode");
            return ((void *)0);
    }
    newsize = 4*size;
    v = PyBytes_FromStringAndSize(((void *)0), newsize);
    ...
    if (v == ((void *)0)) {
        ...
        register char c;
        register char *p = ((__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 194, "PyBytes_Check(v)") : (void)0), (((PyBytesObject *)(v))->ob_sval));

        for (i = 0; i < size; i++) {

            (__builtin_expect(!(newsize - (p - ((__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 198, "PyBytes_Check(v)") : (void)0), (((PyBytesObject *)(v))->ob_sval))) >= 4), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 198, "newsize - (p - PyBytes_AS_STRING(v)) >= 4") : (void)0);
            c = ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 199, "PyBytes_Check(str)") : (void)0), (((PyBytesObject *)(str))->ob_sval))[i];
            if (c == '\'' || c == '\\')
                *p++ = '\\', *p++ = c;
            else if (c == '\t')
                *p++ = '\\', *p++ = 't';
        ...
        *p = '\0';
        if (_PyBytes_Resize(&v, (p - ((__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 218, "PyBytes_Check(v)") : (void)0), (((PyBytesObject *)(v))->ob_sval))))) {
            return ((void *)0);
        }
    }
                        ...
                        PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|z:unicode_internal_decode",
                          &obj, &errors))
        return ((void *)0);

    if (((((((PyObject*)(obj))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        if (((__builtin_expect(!(((((((PyObject*)(obj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 242, "PyUnicode_Check(obj)") : (void)0), ((((PyASCIIObject*)obj)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(obj)))) < 0)
            return ((void *)0);
        ( ((PyObject*)(obj))->ob_refcnt++);
        return codec_tuple(obj, ((__builtin_expect(!(((((((PyObject*)(obj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 245, "PyUnicode_Check(obj)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)obj)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 245, "PyUnicode_IS_READY(obj)") : (void)0), ((PyASCIIObject *)(obj))->length));
    }
    else {
             ...
             PyObject *args)
{
    ...
    int final = 0;
    Py_ssize_t consumed;
    PyObject *decoded = ((void *)0);

    if (!_PyArg_ParseTuple_SizeT(args, "y*|zi:utf_7_decode",
                          &pbuf, &errors, &final))
        return ((void *)0);
    consumed = pbuf.len;

    decoded = PyUnicode_DecodeUTF7Stateful(pbuf.buf, pbuf.len, errors,
                                           final ? ((void *)0) : &consumed);
            ...
            PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "y*|zi:utf_8_decode",
                          &pbuf, &errors, &final))
        return ((void *)0);
    consumed = pbuf.len;
            ...
            PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "y*|zi:utf_16_decode",
                          &pbuf, &errors, &final))
        return ((void *)0);
    consumed = pbuf.len;
    decoded = PyUnicode_DecodeUTF16Stateful(pbuf.buf, pbuf.len, errors,
                                        &byteorder, final ? ((void *)0) : &consumed);
    PyBuffer_Release(&pbuf);
    if (decoded == ((void *)0))
        return ((void *)0);
    return codec_tuple(decoded, consumed);
                 ...
                 PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "y*|zi:utf_16_le_decode",
                          &pbuf, &errors, &final))
        return ((void *)0);
                 ...
                 PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "y*|zi:utf_16_be_decode",
                          &pbuf, &errors, &final))
        return ((void *)0);
                 ...
                 PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "y*|zii:utf_16_ex_decode",
    ...
    if (unicode == ((void *)0))
        return ((void *)0);
    tuple = _Py_BuildValue_SizeT("Oni", unicode, consumed, byteorder);
    do { if ( --((PyObject*)(unicode))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(unicode)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(unicode)))); } while (0);
    return tuple;
}
            ...
            PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "y*|zi:utf_32_decode",
                          &pbuf, &errors, &final))
        return ((void *)0);
    consumed = pbuf.len;
                 ...
                 PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "y*|zi:utf_32_le_decode",
                          &pbuf, &errors, &final))
        return ((void *)0);
    consumed = pbuf.len;
    decoded = PyUnicode_DecodeUTF32Stateful(pbuf.buf, pbuf.len, errors,
                 ...
                 PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "y*|zi:utf_32_be_decode",
                          &pbuf, &errors, &final))
        return ((void *)0);
    consumed = pbuf.len;
    decoded = PyUnicode_DecodeUTF32Stateful(pbuf.buf, pbuf.len, errors,
                 ...
                 PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "y*|zii:utf_32_ex_decode",
                          &pbuf, &errors, &byteorder, &final))
        return ((void *)0);
    consumed = pbuf.len;
                     ...
                     PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "s*|z:unicode_escape_decode",
                          &pbuf, &errors))
        return ((void *)0);
                        ...
                        PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "s*|z:raw_unicode_escape_decode",
                          &pbuf, &errors))
        return ((void *)0);
               ...
               PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "y*|z:latin_1_decode",
                          &pbuf, &errors))
        return ((void *)0);
             ...
             PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "y*|z:ascii_decode",
                          &pbuf, &errors))
        return ((void *)0);
               ...
               PyObject *args)
{
    ...
    PyObject *unicode;
    const char *errors = ((void *)0);
    PyObject *mapping = ((void *)0);

    if (!_PyArg_ParseTuple_SizeT(args, "y*|zO:charmap_decode",
                          &pbuf, &errors, &mapping))
        return ((void *)0);
    if (mapping == (&_Py_NoneStruct))
        mapping = ((void *)0);
                  ...
                  PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "s*|z:readbuffer_encode",
                          &pdata, &errors))
        return ((void *)0);
    data = pdata.buf;
    size = pdata.len;
                        ...
                        PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|z:unicode_internal_encode",
                          &obj, &errors))
        return ((void *)0);
    ...
    if (((((((PyObject*)(obj))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        ...
        if (((__builtin_expect(!(((((((PyObject*)(obj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 692, "PyUnicode_Check(obj)") : (void)0), ((((PyASCIIObject*)obj)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(obj)))) < 0)
            return ((void *)0);

        u = PyUnicode_AsUnicodeAndSize(obj, &len);
        if (u == ((void *)0))
            return ((void *)0);
        if (len > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(Py_UNICODE))
            return PyErr_NoMemory();
        size = len * sizeof(Py_UNICODE);
        return codec_tuple(PyBytes_FromStringAndSize((const char*)u, size),
                           ((__builtin_expect(!(((((((PyObject*)(obj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 702, "PyUnicode_Check(obj)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)obj)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 702, "PyUnicode_IS_READY(obj)") : (void)0), ((PyASCIIObject *)(obj))->length));
    }
    else {
        if (PyObject_AsReadBuffer(obj, (const void **)&data, &size))
            return ((void *)0);
            ...
            PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|z:utf_7_encode",
                          &str, &errors))
        return ((void *)0);

    str = PyUnicode_FromObject(str);
    if (str == ((void *)0) || ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 723, "PyUnicode_Check(str)") : (void)0), ((((PyASCIIObject*)str)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(str)))) < 0) {
    ...
    v = codec_tuple(_PyUnicode_EncodeUTF7(str, 0, 0, errors),
                    ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 728, "PyUnicode_Check(str)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)str)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 728, "PyUnicode_IS_READY(str)") : (void)0), ((PyASCIIObject *)(str))->length));
            ...
            PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|z:utf_8_encode",
                          &str, &errors))
        return ((void *)0);

    str = PyUnicode_FromObject(str);
    if (str == ((void *)0) || ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 745, "PyUnicode_Check(str)") : (void)0), ((((PyASCIIObject*)str)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(str)))) < 0) {
        do { if ((str) == ((void *)0)) ; else do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0); } while (0);
        return ((void *)0);
    }
    v = codec_tuple(PyUnicode_AsEncodedString(str, "utf-8", errors),
                    ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 750, "PyUnicode_Check(str)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)str)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 750, "PyUnicode_IS_READY(str)") : (void)0), ((PyASCIIObject *)(str))->length));
    do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0);
    return v;
}
# 762 "_codecsmodule.c"
            ...
            PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|zi:utf_16_encode",
                          &str, &errors, &byteorder))
        return ((void *)0);

    str = PyUnicode_FromObject(str);
    if (str == ((void *)0) || ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 775, "PyUnicode_Check(str)") : (void)0), ((((PyASCIIObject*)str)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(str)))) < 0) {
        do { if ((str) == ((void *)0)) ; else do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0); } while (0);
        return ((void *)0);
    }
    v = codec_tuple(_PyUnicode_EncodeUTF16(str, errors, byteorder),
                    ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 780, "PyUnicode_Check(str)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)str)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 780, "PyUnicode_IS_READY(str)") : (void)0), ((PyASCIIObject *)(str))->length));
    do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0);
    return v;
}
                 ...
                 PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|z:utf_16_le_encode",
                          &str, &errors))
        return ((void *)0);

    str = PyUnicode_FromObject(str);
    if (str == ((void *)0) || ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 797, "PyUnicode_Check(str)") : (void)0), ((((PyASCIIObject*)str)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(str)))) < 0) {
        do { if ((str) == ((void *)0)) ; else do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0); } while (0);
        return ((void *)0);
    }
    v = codec_tuple(_PyUnicode_EncodeUTF16(str, errors, -1),
                    ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 802, "PyUnicode_Check(str)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)str)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 802, "PyUnicode_IS_READY(str)") : (void)0), ((PyASCIIObject *)(str))->length));
    do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0);
    return v;
}
                 ...
                 PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|z:utf_16_be_encode",
                          &str, &errors))
        return ((void *)0);

    str = PyUnicode_FromObject(str);
    if (str == ((void *)0) || ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 819, "PyUnicode_Check(str)") : (void)0), ((((PyASCIIObject*)str)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(str)))) < 0) {
        do { if ((str) == ((void *)0)) ; else do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0); } while (0);
        return ((void *)0);
    }
    v = codec_tuple(_PyUnicode_EncodeUTF16(str, errors, +1),
                    ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 824, "PyUnicode_Check(str)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)str)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 824, "PyUnicode_IS_READY(str)") : (void)0), ((PyASCIIObject *)(str))->length));
    do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0);
    return v;
}
# 836 "_codecsmodule.c"
            ...
            PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|zi:utf_32_encode",
                          &str, &errors, &byteorder))
        return ((void *)0);

    str = PyUnicode_FromObject(str);
    if (str == ((void *)0) || ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 849, "PyUnicode_Check(str)") : (void)0), ((((PyASCIIObject*)str)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(str)))) < 0) {
        do { if ((str) == ((void *)0)) ; else do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0); } while (0);
        return ((void *)0);
    }
    v = codec_tuple(_PyUnicode_EncodeUTF32(str, errors, byteorder),
                    ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 854, "PyUnicode_Check(str)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)str)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 854, "PyUnicode_IS_READY(str)") : (void)0), ((PyASCIIObject *)(str))->length));
    do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0);
    return v;
}
                 ...
                 PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|z:utf_32_le_encode",
                          &str, &errors))
        return ((void *)0);

    str = PyUnicode_FromObject(str);
    if (str == ((void *)0) || ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 871, "PyUnicode_Check(str)") : (void)0), ((((PyASCIIObject*)str)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(str)))) < 0) {
        do { if ((str) == ((void *)0)) ; else do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0); } while (0);
        return ((void *)0);
    }
    v = codec_tuple(_PyUnicode_EncodeUTF32(str, errors, -1),
                    ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 876, "PyUnicode_Check(str)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)str)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 876, "PyUnicode_IS_READY(str)") : (void)0), ((PyASCIIObject *)(str))->length));
    do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0);
    return v;
}
                 ...
                 PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|z:utf_32_be_encode",
                          &str, &errors))
        return ((void *)0);

    str = PyUnicode_FromObject(str);
    if (str == ((void *)0) || ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 893, "PyUnicode_Check(str)") : (void)0), ((((PyASCIIObject*)str)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(str)))) < 0) {
        do { if ((str) == ((void *)0)) ; else do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0); } while (0);
        return ((void *)0);
    }
    v = codec_tuple(_PyUnicode_EncodeUTF32(str, errors, +1),
                    ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 898, "PyUnicode_Check(str)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)str)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 898, "PyUnicode_IS_READY(str)") : (void)0), ((PyASCIIObject *)(str))->length));
    do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0);
    return v;
}
                     ...
                     PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|z:unicode_escape_encode",
                          &str, &errors))
        return ((void *)0);

    str = PyUnicode_FromObject(str);
    if (str == ((void *)0) || ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 915, "PyUnicode_Check(str)") : (void)0), ((((PyASCIIObject*)str)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(str)))) < 0) {
        do { if ((str) == ((void *)0)) ; else do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0); } while (0);
        return ((void *)0);
    }
    v = codec_tuple(PyUnicode_AsUnicodeEscapeString(str),
                    ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 920, "PyUnicode_Check(str)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)str)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 920, "PyUnicode_IS_READY(str)") : (void)0), ((PyASCIIObject *)(str))->length));
    do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0);
    return v;
}
                        ...
                        PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|z:raw_unicode_escape_encode",
                          &str, &errors))
        return ((void *)0);

    str = PyUnicode_FromObject(str);
    if (str == ((void *)0) || ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 937, "PyUnicode_Check(str)") : (void)0), ((((PyASCIIObject*)str)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(str)))) < 0) {
        do { if ((str) == ((void *)0)) ; else do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0); } while (0);
        return ((void *)0);
    }
    v = codec_tuple(PyUnicode_AsRawUnicodeEscapeString(str),
                    ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 942, "PyUnicode_Check(str)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)str)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 942, "PyUnicode_IS_READY(str)") : (void)0), ((PyASCIIObject *)(str))->length));
    do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0);
    return v;
}
               ...
               PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|z:latin_1_encode",
                          &str, &errors))
        return ((void *)0);

    str = PyUnicode_FromObject(str);
    if (str == ((void *)0) || ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 959, "PyUnicode_Check(str)") : (void)0), ((((PyASCIIObject*)str)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(str)))) < 0) {
        do { if ((str) == ((void *)0)) ; else do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0); } while (0);
        return ((void *)0);
    }
    v = codec_tuple(_PyUnicode_AsLatin1String(str, errors),
                    ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 964, "PyUnicode_Check(str)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)str)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 964, "PyUnicode_IS_READY(str)") : (void)0), ((PyASCIIObject *)(str))->length));
    do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0);
    return v;
}
             ...
             PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|z:ascii_encode",
                          &str, &errors))
        return ((void *)0);

    str = PyUnicode_FromObject(str);
    if (str == ((void *)0) || ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 981, "PyUnicode_Check(str)") : (void)0), ((((PyASCIIObject*)str)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(str)))) < 0) {
        do { if ((str) == ((void *)0)) ; else do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0); } while (0);
        return ((void *)0);
    }
    v = codec_tuple(_PyUnicode_AsASCIIString(str, errors),
                    ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 986, "PyUnicode_Check(str)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)str)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 986, "PyUnicode_IS_READY(str)") : (void)0), ((PyASCIIObject *)(str))->length));
    do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0);
    return v;
}
             ...
             PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O|zO:charmap_encode",
                          &str, &errors, &mapping))
        return ((void *)0);
    if (mapping == (&_Py_NoneStruct))
        mapping = ((void *)0);
    ...
    str = PyUnicode_FromObject(str);
    if (str == ((void *)0) || ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 1006, "PyUnicode_Check(str)") : (void)0), ((((PyASCIIObject*)str)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(str)))) < 0) {
        do { if ((str) == ((void *)0)) ; else do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0); } while (0);
        return ((void *)0);
    }
    v = codec_tuple(_PyUnicode_EncodeCharmap(str, mapping, errors),
                    ((__builtin_expect(!(((((((PyObject*)(str))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 1011, "PyUnicode_Check(str)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)str)->state.ready)), 0) ? __assert_rtn(__func__, "_codecsmodule.c", 1011, "PyUnicode_IS_READY(str)") : (void)0), ((PyASCIIObject *)(str))->length));
    do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0);
    return v;
}
...
{
    PyObject *map;
    if (!_PyArg_ParseTuple_SizeT(args, "U:charmap_build", &map))
        return ((void *)0);
    return PyUnicode_BuildEncodingMap(map);
}
# 1078 "_codecsmodule.c"
static char register_error__doc__[] = "register_error(errors, handler)\n\nRegister the specified error handler under the name\nerrors. handler must be a callable object, that\nwill be called with an exception instance containing\ninformation about the location of the encoding/decoding\nerror and must return a (replacement, new position) tuple.";
# 1087 "_codecsmodule.c"
static PyObject *register_error(PyObject *self, PyObject *args)
{
    const char *name;
    PyObject *handler;

    if (!_PyArg_ParseTuple_SizeT(args, "sO:register_error",
                          &name, &handler))
        return ((void *)0);
...
static char lookup_error__doc__[] = "lookup_error(errors) -> handler\n\nReturn the error handler for the specified error handling name\nor raise a LookupError, if no handler exists under this name.";
...
static PyObject *lookup_error(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "s:lookup_error",
                          &name))
        return ((void *)0);
...
static PyMethodDef _codecs_functions[] = {
    {"register", codec_register, 0x0008,
        register__doc__},
    {"lookup", codec_lookup, 0x0001,
        lookup__doc__},
    {"encode", codec_encode, 0x0001,
        encode__doc__},
    {"decode", codec_decode, 0x0001,
        decode__doc__},
    {"escape_encode", escape_encode, 0x0001},
    {"escape_decode", escape_decode, 0x0001},
    {"utf_8_encode", utf_8_encode, 0x0001},
    {"utf_8_decode", utf_8_decode, 0x0001},
    {"utf_7_encode", utf_7_encode, 0x0001},
    {"utf_7_decode", utf_7_decode, 0x0001},
    {"utf_16_encode", utf_16_encode, 0x0001},
    {"utf_16_le_encode", utf_16_le_encode, 0x0001},
    {"utf_16_be_encode", utf_16_be_encode, 0x0001},
    {"utf_16_decode", utf_16_decode, 0x0001},
    {"utf_16_le_decode", utf_16_le_decode, 0x0001},
    {"utf_16_be_decode", utf_16_be_decode, 0x0001},
    {"utf_16_ex_decode", utf_16_ex_decode, 0x0001},
    {"utf_32_encode", utf_32_encode, 0x0001},
    {"utf_32_le_encode", utf_32_le_encode, 0x0001},
    {"utf_32_be_encode", utf_32_be_encode, 0x0001},
    {"utf_32_decode", utf_32_decode, 0x0001},
    {"utf_32_le_decode", utf_32_le_decode, 0x0001},
    {"utf_32_be_decode", utf_32_be_decode, 0x0001},
    {"utf_32_ex_decode", utf_32_ex_decode, 0x0001},
    {"unicode_escape_encode", unicode_escape_encode, 0x0001},
    {"unicode_escape_decode", unicode_escape_decode, 0x0001},
    {"unicode_internal_encode", unicode_internal_encode, 0x0001},
    {"unicode_internal_decode", unicode_internal_decode, 0x0001},
    {"raw_unicode_escape_encode", raw_unicode_escape_encode, 0x0001},
    {"raw_unicode_escape_decode", raw_unicode_escape_decode, 0x0001},
    {"latin_1_encode", latin_1_encode, 0x0001},
    {"latin_1_decode", latin_1_decode, 0x0001},
    {"ascii_encode", ascii_encode, 0x0001},
    {"ascii_decode", ascii_decode, 0x0001},
    {"charmap_encode", charmap_encode, 0x0001},
    {"charmap_decode", charmap_decode, 0x0001},
    {"charmap_build", charmap_build, 0x0001},
    {"readbuffer_encode", readbuffer_encode, 0x0001},
    ...
    {"register_error", register_error, 0x0001,
        register_error__doc__},
    {"lookup_error", lookup_error, 0x0001,
        lookup_error__doc__},
    {((void *)0), ((void *)0)}
};
...
PyInit__codecs(void)
{
        return PyModule_Create2(&codecsmodule, 1013);
}
