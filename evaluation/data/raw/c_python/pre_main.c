...
# 7 "main.c" 2
# 35 "main.c"
# 1 "/Users/parrt/tmp/Python-3.3.1/Include/pygetopt.h" 1
# 9 "/Users/parrt/tmp/Python-3.3.1/Include/pygetopt.h"
...
static char *usage_1 = "Options and arguments (and corresponding environment variables):\n-b     : issue warnings about str(bytes_instance), str(bytearray_instance)\n         and comparing bytes/bytearray with str. (-bb: issue errors)\n-B     : don't write .py[co] files on import; also PYTHONDONTWRITEBYTECODE=x\n-c cmd : program passed in as string (terminates option list)\n-d     : debug output from parser; also PYTHONDEBUG=x\n-E     : ignore PYTHON* environment variables (such as PYTHONPATH)\n-h     : print this help message and exit (also --help)\n";
# 69 "main.c"
...
{
    FILE *f = exitcode ? __stderrp : __stdoutp;
    ...
    if (exitcode)
        ...
        fputs(usage_3, f);
        fprintf(f, usage_4, L':');
        fprintf(f, usage_5, L':', "<prefix>/pythonX.X");
        fputs(usage_6, f);
    }
# 139 "main.c"
    return exitcode;
...
{
    char *startup = (Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONSTARTUP"));
    if (startup != ((void *)0) && startup[0] != '\0') {
...
static int RunModule(wchar_t *modname, int set_argv0)
{
    ...
    if (runpy == ((void *)0)) {
        fprintf(__stderrp, "Could not import runpy module\n");
        return -1;
    }
    runmodule = PyObject_GetAttrString(runpy, "_run_module_as_main");
    if (runmodule == ((void *)0)) {
        fprintf(__stderrp, "Could not access runpy._run_module_as_main\n");
        do { if ( --((PyObject*)(runpy))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(runpy)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(runpy)))); } while (0);
        return -1;
    }
    module = PyUnicode_FromWideChar(modname, wcslen(modname));
    if (module == ((void *)0)) {
        fprintf(__stderrp, "Could not convert module name to unicode\n");
        do { if ( --((PyObject*)(runpy))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(runpy)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(runpy)))); } while (0);
        do { if ( --((PyObject*)(runmodule))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(runmodule)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(runmodule)))); } while (0);
        return -1;
    }
    ...
    result = PyObject_Call(runmodule, runargs, ((void *)0));
    if (result == ((void *)0)) {
        PyErr_Print();
    }
    do { if ( --((PyObject*)(runpy))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(runpy)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(runpy)))); } while (0);
    do { if ( --((PyObject*)(runmodule))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(runmodule)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(runmodule)))); } while (0);
    do { if ( --((PyObject*)(module))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(module)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(module)))); } while (0);
    do { if ( --((PyObject*)(runargs))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(runargs)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(runargs)))); } while (0);
    if (result == ((void *)0)) {
        return -1;
    }
...
{
    PyObject *argv0 = ((void *)0), *importer, *sys_path;
    int sts;
    ...
    if (importer == (&_Py_NoneStruct)) {
        do { if ( --((PyObject*)(argv0))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(argv0)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(argv0)))); } while (0);
    ...
    ( ((PyObject*)(argv0))->ob_refcnt++);

    sts = RunModule(L"__main__", 0);
    return sts != 0;

error:
    do { if ((argv0) == ((void *)0)) ; else do { if ( --((PyObject*)(argv0))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(argv0)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(argv0)))); } while (0); } while (0);
    PyErr_Print();
    return 1;
}
...
run_file(FILE *fp, const wchar_t *filename, PyCompilerFlags *p_cf)
{
    ...
    run = PyRun_AnyFileExFlags(fp, filename_str, filename != ((void *)0), p_cf);
...
Py_Main(int argc, wchar_t **argv)
{
    int c;
    int sts;
    wchar_t *command = ((void *)0);
    wchar_t *filename = ((void *)0);
    wchar_t *module = ((void *)0);
    FILE *fp = __stdinp;
    char *p;
    ...
    _PyOS_opterr = 0;
    while ((c = _PyOS_GetOpt(argc, argv, L"bBc:dEhiJm:OqRsStuvVW:xX:?")) != (-1)) {
        if (c == 'm' || c == 'c') {
    ...
    if (version) {
        fprintf(__stderrp, "Python %s\n", "3.3.1");
        return 0;
    }

    if (!Py_InspectFlag &&
        (p = (Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONINSPECT"))) && *p != '\0')
        Py_InspectFlag = 1;
    if (!saw_unbuffered_flag &&
        (p = (Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONUNBUFFERED"))) && *p != '\0')
        Py_UnbufferedStdioFlag = 1;

    if (!Py_NoUserSiteDirectory &&
        (p = (Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONNOUSERSITE"))) && *p != '\0')
        Py_NoUserSiteDirectory = 1;
# 510 "main.c"
    if ((p = (Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONWARNINGS"))) && *p != '\0') {
        char *buf, *oldloc;
        PyObject *unicode;
        ...
        ((__builtin_object_size (buf, 0) != (size_t) -1) ? __builtin___strcpy_chk (buf, p, __builtin_object_size (buf, 2 > 1)) : __inline_strcpy_chk (buf, p));
        oldloc = strdup(setlocale(0, ((void *)0)));
        setlocale(0, "");
        for (p = strtok(buf, ","); p != ((void *)0); p = strtok(((void *)0), ",")) {
    ...
    if (command == ((void *)0) && module == ((void *)0) && _PyOS_optind < argc &&
    ...
    stdin_is_interactive = Py_FdIsInteractive(__stdinp, (char *)0);
# 566 "main.c"
    if (Py_UnbufferedStdioFlag) {

        setvbuf(__stdinp, (char *)((void *)0), 2, 1024);
        setvbuf(__stdoutp, (char *)((void *)0), 2, 1024);
        setvbuf(__stderrp, (char *)((void *)0), 2, 1024);
        ...
        setvbuf(__stdinp, (char *)((void *)0), 1, 1024);
        setvbuf(__stdoutp, (char *)((void *)0), 1, 1024);



    }
# 606 "main.c"
    if ((p = (Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONEXECUTABLE"))) && *p != '\0') {
        wchar_t* buffer;
...
# 641 "main.c"
    ...
    if (!Py_QuietFlag && (Py_VerboseFlag ||
                        (command == ((void *)0) && filename == ((void *)0) &&
                         module == ((void *)0) && stdin_is_interactive))) {
        fprintf(__stderrp, "Python %s on %s\n",
    ...
    if ((Py_InspectFlag || (command == ((void *)0) && filename == ((void *)0) && module == ((void *)0))) &&
    ...
    if (command) {
        ...
        if (filename == ((void *)0) && stdin_is_interactive) {
            Py_InspectFlag = 0;
            RunStartupFile(&cf);
        }
        ...
        if (sts==-1 && filename!=((void *)0)) {
            fp = _Py_wfopen(filename, L"r");
            if (fp == ((void *)0)) {
                char *cfilename_buffer;
                const char *cfilename;
                int err = (*__error());
                cfilename_buffer = _Py_wchar2char(filename, ((void *)0));
                if (cfilename_buffer != ((void *)0))
                    cfilename = cfilename_buffer;
                else
                    cfilename = "<unprintable file name>";
                fprintf(__stderrp, "%ls: can't open file '%s': [Errno %d] %s\n",
            ...
            }
            {
                ...
                if (fstat(fileno(fp), &sb) == 0 &&
                    ...
                    fprintf(__stderrp, "%ls: '%ls' is a directory, cannot continue\n", argv[0], filename);
                    fclose(fp);
                    return 1;
                }
            }
    ...
    if (Py_InspectFlag && stdin_is_interactive &&
        (filename != ((void *)0) || command != ((void *)0) || module != ((void *)0))) {
        Py_InspectFlag = 0;

        sts = PyRun_AnyFileExFlags(__stdinp, "<stdin>", 0, &cf) != 0;
    }
