...
# 13 "termios.c" 2
# 26 "termios.c"
static char termios__doc__[] = "This module provides an interface to the Posix calls for tty I/O control.\nFor a complete description of these calls, see the Posix or Unix manual\npages. It is only available for those Unix versions that support Posix\ntermios style tty I/O control.\n\nAll functions in this module take a file descriptor fd as their first\nargument. This can be an integer file descriptor, such as returned by\nsys.stdin.fileno(), or a file object, such as sys.stdin itself.";
# 36 "termios.c"
...
termios_tcgetattr(PyObject *self, PyObject *args)
{
    ...
    if ((mode.c_lflag & 0x00000100) == 0) {
        v = PyLong_FromLong((long)mode.c_cc[16]);
        if (v == ((void *)0))
            goto err;
        PyList_SetItem(cc, 16, v);
        v = PyLong_FromLong((long)mode.c_cc[17]);
        if (v == ((void *)0))
            goto err;
        PyList_SetItem(cc, 17, v);
    }
    ...
    return v;
  err:
    do { if ( --((PyObject*)(cc))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(cc)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(cc)))); } while (0);
    return ((void *)0);
}

static char termios_tcsetattr__doc__[] = "tcsetattr(fd, when, attributes) -> None\n\nSet the tty attributes for file descriptor fd.\nThe attributes to be set are taken from the attributes argument, which\nis a list like the one returned by tcgetattr(). The when argument\ndetermines when the attributes are changed: termios.TCSANOW to\nchange immediately, termios.TCSADRAIN to change after transmitting all\nqueued output, or termios.TCSAFLUSH to change after transmitting all\nqueued output and discarding all queued input. ";
# 138 "termios.c"
static PyObject *
termios_tcsetattr(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O&iO:tcsetattr",
                          fdconv, &fd, &when, &term))
        return ((void *)0);
    if (!((((((PyObject*)(term))->ob_type))->tp_flags & ((1L<<25))) != 0) || PyList_Size(term) != 7) {
    ...
    if (!((((((PyObject*)(cc))->ob_type))->tp_flags & ((1L<<25))) != 0) || PyList_Size(cc) != 20) {
    ...
    for (i = 0; i < 20; i++) {
        ...
        else if (((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<24))) != 0))
...
static char termios_tcsendbreak__doc__[] = "tcsendbreak(fd, duration) -> None\n\nSend a break on file descriptor fd.\nA zero duration sends a break for 0.25-0.5 seconds; a nonzero duration\nhas a system dependent meaning.";
...
static char termios_tcdrain__doc__[] = "tcdrain(fd) -> None\n\nWait until all output written to file descriptor fd has been transmitted.";
...
static PyMethodDef termios_methods[] =
{
    {"tcgetattr", termios_tcgetattr,
     0x0001, termios_tcgetattr__doc__},
    {"tcsetattr", termios_tcsetattr,
     0x0001, termios_tcsetattr__doc__},
    {"tcsendbreak", termios_tcsendbreak,
     0x0001, termios_tcsendbreak__doc__},
    {"tcdrain", termios_tcdrain,
     0x0001, termios_tcdrain__doc__},
    {"tcflush", termios_tcflush,
     0x0001, termios_tcflush__doc__},
    {"tcflow", termios_tcflow,
     0x0001, termios_tcflow__doc__},
    {((void *)0), ((void *)0)}
};
# 315 "termios.c"
...
# 387 "termios.c"
    ...
    {"CRTSCTS", (long)(0x00010000 | 0x00020000)},
...
# 654 "termios.c"
    ...
    {"FIOASYNC", ((__uint32_t)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((125)))},


    {"FIOCLEX", ((__uint32_t)0x20000000 | ((0 & 0x1fff) << 16) | ((('f')) << 8) | ((1)))},


    {"FIONBIO", ((__uint32_t)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((126)))},


    {"FIONCLEX", ((__uint32_t)0x20000000 | ((0 & 0x1fff) << 16) | ((('f')) << 8) | ((2)))},


    {"FIONREAD", ((__uint32_t)0x40000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((127)))},
# 711 "termios.c"
    {"NCCS", 20},
# 768 "termios.c"
    {"TIOCCONS", ((__uint32_t)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((98)))},


    {"TIOCEXCL", ((__uint32_t)0x20000000 | ((0 & 0x1fff) << 16) | ((('t')) << 8) | ((13)))},


    {"TIOCGETD", ((__uint32_t)0x40000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((26)))},
# 783 "termios.c"
    {"TIOCGPGRP", ((__uint32_t)0x40000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((119)))},
# 792 "termios.c"
    {"TIOCGWINSZ", ((__uint32_t)0x40000000 | ((sizeof(struct winsize) & 0x1fff) << 16) | ((('t')) << 8) | ((104)))},
# 801 "termios.c"
    {"TIOCMBIC", ((__uint32_t)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((107)))},


    {"TIOCMBIS", ((__uint32_t)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((108)))},


    {"TIOCMGET", ((__uint32_t)0x40000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((106)))},





    {"TIOCMSET", ((__uint32_t)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((109)))},
    ...
    {"TIOCNOTTY", ((__uint32_t)0x20000000 | ((0 & 0x1fff) << 16) | ((('t')) << 8) | ((113)))},


    {"TIOCNXCL", ((__uint32_t)0x20000000 | ((0 & 0x1fff) << 16) | ((('t')) << 8) | ((14)))},


    {"TIOCOUTQ", ((__uint32_t)0x40000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((115)))},


    {"TIOCPKT", ((__uint32_t)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((112)))},
    ...
    {"TIOCSCTTY", ((__uint32_t)0x20000000 | ((0 & 0x1fff) << 16) | ((('t')) << 8) | ((97)))},
# 909 "termios.c"
    {"TIOCSETD", ((__uint32_t)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((27)))},





    {"TIOCSPGRP", ((__uint32_t)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((118)))},
# 924 "termios.c"
    {"TIOCSTI", ((__uint32_t)0x80000000 | ((sizeof(char) & 0x1fff) << 16) | ((('t')) << 8) | ((114)))},


    {"TIOCSWINSZ", ((__uint32_t)0x80000000 | ((sizeof(struct winsize) & 0x1fff) << 16) | ((('t')) << 8) | ((103)))},
...
PyInit_termios(void)
{
    ...
    m = PyModule_Create2(&termiosmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);

    if (TermiosError == ((void *)0)) {
        TermiosError = PyErr_NewException("termios.error", ((void *)0), ((void *)0));
    }
    ( ((PyObject*)(TermiosError))->ob_refcnt++);
    PyModule_AddObject(m, "error", TermiosError);

    while (constant->name != ((void *)0)) {
