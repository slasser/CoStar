...
# 130 "mmapmodule.c"
    if (m_obj->fd >= 0)
        (void) close(m_obj->fd);
    if (m_obj->data!=((void *)0)) {
        munmap(m_obj->data, m_obj->size);
    }


    (((PyObject*)(m_obj))->ob_type)->tp_free((PyObject*)m_obj);
}
...
{
    if (self->exports > 0) {
        PyErr_SetString(PyExc_BufferError, "cannot close " "exported pointers exist");
...
mmap_read_byte_method(mmap_object *self,
                      PyObject *unused)
{
    do { if (self->data == ((void *)0)) { PyErr_SetString(PyExc_ValueError, "mmap closed or invalid"); return ((void *)0); } } while (0);
    if (self->pos < self->size) {
        char value = self->data[self->pos];
        self->pos += 1;
        return _Py_BuildValue_SizeT("B", (unsigned char)value);
    } else {
                 ...
                 PyObject *args)
{
    ...
    do { if (self->data == ((void *)0)) { PyErr_SetString(PyExc_ValueError, "mmap closed or invalid"); return ((void *)0); } } while (0);
    if (!_PyArg_ParseTuple_SizeT(args, "|O&:read", mmap_convert_ssize_t, &num_bytes))
        return(((void *)0));


    (__builtin_expect(!(self->size >= self->pos), 0) ? __assert_rtn(__func__, "mmapmodule.c", 275, "self->size >= self->pos") : (void)0);
           ...
           int reverse)
{
    ...
    do { if (self->data == ((void *)0)) { PyErr_SetString(PyExc_ValueError, "mmap closed or invalid"); return ((void *)0); } } while (0);
    if (!_PyArg_ParseTuple_SizeT(args, reverse ? "y#|nn:rfind" : "y#|nn:find",
                  ...
                  PyObject *args)
{
    ...
    do { if (self->data == ((void *)0)) { PyErr_SetString(PyExc_ValueError, "mmap closed or invalid"); return ((void *)0); } } while (0);
    if (!_PyArg_ParseTuple_SizeT(args, "y#:write", &data, &length))
        return(((void *)0));
    ...
    ((__builtin_object_size (self->data+self->pos, 0) != (size_t) -1) ? __builtin___memcpy_chk (self->data+self->pos, data, length, __builtin_object_size (self->data+self->pos, 0)) : __inline_memcpy_chk (self->data+self->pos, data, length));
                       ...
                       PyObject *args)
{
    ...
    do { if (self->data == ((void *)0)) { PyErr_SetString(PyExc_ValueError, "mmap closed or invalid"); return ((void *)0); } } while (0);
    if (!_PyArg_ParseTuple_SizeT(args, "b:write_byte", &value))
        return(((void *)0));
                   ...
                   PyObject *args)
{
    Py_ssize_t new_size;
    do { if (self->data == ((void *)0)) { PyErr_SetString(PyExc_ValueError, "mmap closed or invalid"); return ((void *)0); } } while (0);
    if (!_PyArg_ParseTuple_SizeT(args, "n:resize", &new_size) ||
        !is_resizeable(self)) {
        return ((void *)0);
# 541 "mmapmodule.c"
    } else {
...
mmap_flush_method(mmap_object *self, PyObject *args)
{
    ...
    do { if (self->data == ((void *)0)) { PyErr_SetString(PyExc_ValueError, "mmap closed or invalid"); return ((void *)0); } } while (0);
    if (!_PyArg_ParseTuple_SizeT(args, "|nn:flush", &offset, &size))
        return ((void *)0);
    ...
    if (-1 == msync(self->data + offset, size, 0x0010)) {
        PyErr_SetFromErrno(PyExc_OSError);
        return ((void *)0);
    }
    return PyLong_FromLong(0);
...
mmap_seek_method(mmap_object *self, PyObject *args)
{
    ...
    int how=0;
    do { if (self->data == ((void *)0)) { PyErr_SetString(PyExc_ValueError, "mmap closed or invalid"); return ((void *)0); } } while (0);
    if (!_PyArg_ParseTuple_SizeT(args, "n|i:seek", &dist, &how))
        return ((void *)0);
    else {
        size_t where;
        switch (how) {
...
mmap_move_method(mmap_object *self, PyObject *args)
{
    ...
    do { if (self->data == ((void *)0)) { PyErr_SetString(PyExc_ValueError, "mmap closed or invalid"); return ((void *)0); } } while (0);
    if (!_PyArg_ParseTuple_SizeT(args, "kkk:move", &dest, &src, &cnt) ||
        !is_writable(self)) {
        return ((void *)0);
    } else {
        ...
        ((__builtin_object_size (self->data+dest, 0) != (size_t) -1) ? __builtin___memmove_chk (self->data+dest, self->data+src, cnt, __builtin_object_size (self->data+dest, 0)) : __inline_memmove_chk (self->data+dest, self->data+src, cnt));
        ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++);
        return (&_Py_NoneStruct);
    }
}
...
mmap_closed_get(mmap_object *self)
{
    ...
    return PyBool_FromLong(self->data == ((void *)0) ? 1 : 0);
...
mmap__exit__method(PyObject *self, PyObject *args)
{
    ...
    return _PyObject_CallMethodId_SizeT(self, &PyId_close, ((void *)0));
}

static struct PyMethodDef mmap_object_methods[] = {
    {"close", (PyCFunction) mmap_close_method, 0x0004},
    {"find", (PyCFunction) mmap_find_method, 0x0001},
    {"rfind", (PyCFunction) mmap_rfind_method, 0x0001},
    {"flush", (PyCFunction) mmap_flush_method, 0x0001},
    {"move", (PyCFunction) mmap_move_method, 0x0001},
    {"read", (PyCFunction) mmap_read_method, 0x0001},
    {"read_byte", (PyCFunction) mmap_read_byte_method, 0x0004},
    {"readline", (PyCFunction) mmap_read_line_method, 0x0004},
    {"resize", (PyCFunction) mmap_resize_method, 0x0001},
    {"seek", (PyCFunction) mmap_seek_method, 0x0001},
    {"size", (PyCFunction) mmap_size_method, 0x0004},
    {"tell", (PyCFunction) mmap_tell_method, 0x0004},
    {"write", (PyCFunction) mmap_write_method, 0x0001},
    {"write_byte", (PyCFunction) mmap_write_byte_method, 0x0001},
    {"__enter__", (PyCFunction) mmap__enter__method, 0x0004},
    {"__exit__", (PyCFunction) mmap__exit__method, 0x0001},
    {((void *)0), ((void *)0)}
};

static PyGetSetDef mmap_object_getset[] = {
    {"closed", (getter) mmap_closed_get, ((void *)0), ((void *)0)},
    {((void *)0)}
};
...
{
    do { if (self->data == ((void *)0)) { PyErr_SetString(PyExc_ValueError, "mmap closed or invalid"); return -1; } } while (0);
...
mmap_subscript(mmap_object *self, PyObject *item)
{
    ...
    if (((item)->ob_type->tp_as_number != ((void *)0) && (item)->ob_type->tp_as_number->nb_index != ((void *)0))) {
        ...
        return PyLong_FromLong(((unsigned char)((self->data[i]) & 0xff)));
    }
...
mmap_ass_subscript(mmap_object *self, PyObject *item, PyObject *value)
{
    ...
    if (((item)->ob_type->tp_as_number != ((void *)0) && (item)->ob_type->tp_as_number->nb_index != ((void *)0))) {
        ...
        if (!((value)->ob_type->tp_as_number != ((void *)0) && (value)->ob_type->tp_as_number->nb_index != ((void *)0))) {
            PyErr_SetString(PyExc_TypeError,
        ...
        if (PyObject_GetBuffer(value, &vbuf, 0) < 0)
            return -1;
        ...
        if (slicelen == 0) {
            ...
            ((__builtin_object_size (self->data + start, 0) != (size_t) -1) ? __builtin___memcpy_chk (self->data + start, vbuf.buf, slicelen, __builtin_object_size (self->data + start, 0)) : __inline_memcpy_chk (self->data + start, vbuf.buf, slicelen));
        }
        else {
            Py_ssize_t cur, i;
...
_GetMapSize(PyObject *o, const char* param)
{
    if (o == ((void *)0))
        return 0;
    if (((o)->ob_type->tp_as_number != ((void *)0) && (o)->ob_type->tp_as_number->nb_index != ((void *)0))) {
...
new_mmap_object(PyTypeObject *type, PyObject *args, PyObject *kwdict)
{
    ...
    mmap_object *m_obj;
    PyObject *map_size_obj = ((void *)0);
    Py_ssize_t map_size;
    off_t offset = 0;
    int fd, flags = 0x0001, prot = 0x02 | 0x01;
    int devzero = -1;
    int access = (int)ACCESS_DEFAULT;
    static char *keywords[] = {"fileno", "length",
                               "flags", "prot",
                               "access", "offset", ((void *)0)};

    if (!_PyArg_ParseTupleAndKeywords_SizeT(args, kwdict, "iO|iii" "l", keywords,
    ...
    if (fd != -1)
        (void)fcntl(fd, 51);
# 1163 "mmapmodule.c"
    if (fd != -1 && fstat(fd, &st) == 0 && (((st.st_mode) & 0170000) == 0100000)) {
        if (map_size == 0) {
            if (st.st_size == 0) {
                PyErr_SetString(PyExc_ValueError,
            ...
            if (st.st_size - offset > ((Py_ssize_t)(((size_t)-1)>>1))) {
                PyErr_SetString(PyExc_ValueError,
...
# 1213 "mmapmodule.c"
        ...
        m_obj->fd = dup(fd);
        if (m_obj->fd == -1) {
            do { if ( --((PyObject*)(m_obj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(m_obj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(m_obj)))); } while (0);
            PyErr_SetFromErrno(PyExc_OSError);
            return ((void *)0);
        }
    }

    m_obj->data = mmap(((void *)0), map_size,
                       prot, flags,
                       fd, offset);
...
PyInit_mmap(void)
{
    ...
    module = PyModule_Create2(&mmapmodule, 1013);
    if (module == ((void *)0))
        return ((void *)0);
    ...
    setint(dict, "PROT_EXEC", 0x04);


    setint(dict, "PROT_READ", 0x01);


    setint(dict, "PROT_WRITE", 0x02);



    setint(dict, "MAP_SHARED", 0x0001);


    setint(dict, "MAP_PRIVATE", 0x0002);
# 1506 "mmapmodule.c"
    setint(dict, "MAP_ANON", 0x1000);
    setint(dict, "MAP_ANONYMOUS", 0x1000);
