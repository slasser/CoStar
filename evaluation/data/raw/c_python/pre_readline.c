...
# 34 "/usr/include/readline/readline.h" 3 4
...
# 35 "/usr/include/readline/readline.h" 2 3 4
...
parse_and_bind(PyObject *self, PyObject *args)
{
    ...
    ((__builtin_object_size (copy, 0) != (size_t) -1) ? __builtin___strcpy_chk (copy, s, __builtin_object_size (copy, 2 > 1)) : __inline_strcpy_chk (copy, s));
    rl_parse_and_bind(copy);
    free(copy);
    return ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++), (&_Py_NoneStruct);
}

static char doc_parse_and_bind[] = "parse_and_bind(string) -> None\nParse and execute single line of a readline init file.";
...
{
    PyObject *filename_obj = (&_Py_NoneStruct), *filename_bytes;
    if (!PyArg_ParseTuple(args, "|O:read_init_file", &filename_obj))
        return ((void *)0);
    if (filename_obj != (&_Py_NoneStruct)) {
        if (!PyUnicode_FSConverter(filename_obj, &filename_bytes))
            return ((void *)0);
        (*__error()) = rl_read_init_file(PyBytes_AsString(filename_bytes));
        do { if ( --((PyObject*)(filename_bytes))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(filename_bytes)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(filename_bytes)))); } while (0);
    } else
        (*__error()) = rl_read_init_file(((void *)0));
    if ((*__error()))
        return PyErr_SetFromErrno(PyExc_IOError);
    return ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++), (&_Py_NoneStruct);
}

static char doc_read_init_file[] = "read_init_file([filename]) -> None\nParse a readline initialization file.\nThe default filename is the last filename used.";
...
read_history_file(PyObject *self, PyObject *args)
{
    ...
    if (filename_obj != (&_Py_NoneStruct)) {
        if (!PyUnicode_FSConverter(filename_obj, &filename_bytes))
            return ((void *)0);
        (*__error()) = read_history(PyBytes_AsString(filename_bytes));
        do { if ( --((PyObject*)(filename_bytes))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(filename_bytes)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(filename_bytes)))); } while (0);
    } else
        (*__error()) = read_history(((void *)0));
    if ((*__error()))
        return PyErr_SetFromErrno(PyExc_IOError);
    return ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++), (&_Py_NoneStruct);
}
...
static char doc_read_history_file[] = "read_history_file([filename]) -> None\nLoad a readline history file.\nThe default filename is ~/.history.";
...
write_history_file(PyObject *self, PyObject *args)
{
    ...
    if (filename_obj != (&_Py_NoneStruct)) {
        ...
        filename_bytes = ((void *)0);
        filename = ((void *)0);
    }
    (*__error()) = err = write_history(filename);
    if (!err && _history_length >= 0)
        history_truncate_file(filename, _history_length);
    do { if ((filename_bytes) == ((void *)0)) ; else do { if ( --((PyObject*)(filename_bytes))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(filename_bytes)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(filename_bytes)))); } while (0); } while (0);
    (*__error()) = err;
    if ((*__error()))
        return PyErr_SetFromErrno(PyExc_IOError);
    return ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++), (&_Py_NoneStruct);
...
static char doc_write_history_file[] = "write_history_file([filename]) -> None\nSave a readline history file.\nThe default filename is ~/.history.";
...
static char set_history_length_doc[] = "set_history_length(length) -> None\nset the maximal number of items which will be written to\nthe history file. A negative length is used to inhibit\nhistory truncation.";
# 205 "readline.c"
static PyObject*
...
static char get_history_length_doc[] = "get_history_length() -> int\nreturn the maximum number of items that will be written to\nthe history file.";
...
{
    PyObject *function = (&_Py_NoneStruct);
    char buf[80];
    PyOS_snprintf(buf, sizeof(buf), "|O:set_%.50s", funcname);
    if (!PyArg_ParseTuple(args, buf, &function))
        return ((void *)0);
    if (function == (&_Py_NoneStruct)) {
        do { if ((*hook_var) == ((void *)0)) ; else do { if ( --((PyObject*)(*hook_var))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(*hook_var)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(*hook_var)))); } while (0); } while (0);
        *hook_var = ((void *)0);
    }
...
static PyObject *completion_display_matches_hook = ((void *)0);
static PyObject *startup_hook = ((void *)0);


static PyObject *pre_input_hook = ((void *)0);
...
static char doc_set_completion_display_matches_hook[] = "set_completion_display_matches_hook([function]) -> None\nSet or remove the completion display function.\nThe function is called as\n  function(substitution, [matches], longest_match_length)\nonce each time matches need to be displayed.";
...
static char doc_set_startup_hook[] = "set_startup_hook([function]) -> None\nSet or remove the startup_hook function.\nThe function is called with no arguments just\nbefore readline prints the first prompt.";
# 300 "readline.c"
static PyObject *
...
static char doc_set_pre_input_hook[] = "set_pre_input_hook([function]) -> None\nSet or remove the pre_input_hook function.\nThe function is called with no arguments after the first prompt\nhas been printed and just before readline starts reading input\ncharacters.";
# 318 "readline.c"
static PyObject *completer = ((void *)0);

static PyObject *begidx = ((void *)0);
static PyObject *endidx = ((void *)0);
...
static char doc_get_completion_type[] = "get_completion_type() -> int\nGet the type of completion being attempted.";
...
{
    ( ((PyObject*)(begidx))->ob_refcnt++);
    return begidx;
}

static char doc_get_begidx[] = "get_begidx() -> int\nget the beginning index of the readline tab-completion scope";
...
{
    ( ((PyObject*)(endidx))->ob_refcnt++);
    return endidx;
}

static char doc_get_endidx[] = "get_endidx() -> int\nget the ending index of the readline tab-completion scope";
...
static char doc_set_completer_delims[] = "set_completer_delims(string) -> None\nset the readline word delimiters for tab-completion";
# 403 "readline.c"
static void
...
static char doc_remove_history[] = "remove_history_item(pos) -> None\nremove history item given by its position";
...
py_replace_history(PyObject *self, PyObject *args)
{
    ...
    old_entry = replace_history_entry(entry_number, line, (void *)((void *)0));
    if (!old_entry) {
        PyErr_Format(PyExc_ValueError,
                     "No history item at position %d",
                     entry_number);
...
static char doc_replace_history[] = "replace_history_item(pos, line) -> None\nreplaces history item given by its position with contents of line";
...
static char doc_add_history[] = "add_history(string) -> None\nadd a line to the history buffer";
...
static char doc_set_completer[] = "set_completer([function]) -> None\nSet or remove the completer function.\nThe function is called as function(text, state),\nfor state in 0, 1, 2, ..., until it returns a non-string.\nIt should return the next possible completion starting with 'text'.";
...
get_completer(PyObject *self, PyObject *noargs)
{
    ...
    ( ((PyObject*)(completer))->ob_refcnt++);
    return completer;
}

static char doc_get_completer[] = "get_completer() -> function\n\nReturns current completer function.";
# 544 "readline.c"
static int
...
static char doc_get_history_item[] = "get_history_item() -> string\nreturn the current contents of history item at index.";
...
static char doc_get_current_history_length[] = "get_current_history_length() -> integer\nreturn the current (not the maximum) length of history.";
...
static char doc_get_line_buffer[] = "get_line_buffer() -> string\nreturn the current contents of the line buffer.";
# 631 "readline.c"
static PyObject *
...
static char doc_clear_history[] = "clear_history() -> None\nClear the current readline history.";
...
static char doc_insert_text[] = "insert_text(string) -> None\nInsert text into the command line.";
...
static char doc_redisplay[] = "redisplay() -> None\nChange what's displayed on the screen to reflect the current\ncontents of the line buffer.";
...
{
    {"parse_and_bind", parse_and_bind, 0x0001, doc_parse_and_bind},
    {"get_line_buffer", get_line_buffer, 0x0004, doc_get_line_buffer},
    {"insert_text", insert_text, 0x0001, doc_insert_text},
    {"redisplay", redisplay, 0x0004, doc_redisplay},
    {"read_init_file", read_init_file, 0x0001, doc_read_init_file},
    {"read_history_file", read_history_file,
     0x0001, doc_read_history_file},
    {"write_history_file", write_history_file,
     0x0001, doc_write_history_file},
    {"get_history_item", get_history_item,
     0x0001, doc_get_history_item},
    {"get_current_history_length", (PyCFunction)get_current_history_length,
     0x0004, doc_get_current_history_length},
    {"set_history_length", set_history_length,
     0x0001, set_history_length_doc},
    {"get_history_length", get_history_length,
     0x0004, get_history_length_doc},
    {"set_completer", set_completer, 0x0001, doc_set_completer},
    {"get_completer", get_completer, 0x0004, doc_get_completer},
    {"get_completion_type", get_completion_type,
     0x0004, doc_get_completion_type},
    {"get_begidx", get_begidx, 0x0004, doc_get_begidx},
    {"get_endidx", get_endidx, 0x0004, doc_get_endidx},

    {"set_completer_delims", set_completer_delims,
     0x0001, doc_set_completer_delims},
    {"add_history", py_add_history, 0x0001, doc_add_history},
    {"remove_history_item", py_remove_history, 0x0001, doc_remove_history},
    {"replace_history_item", py_replace_history, 0x0001, doc_replace_history},
    {"get_completer_delims", get_completer_delims,
     0x0004, doc_get_completer_delims},

    {"set_completion_display_matches_hook", set_completion_display_matches_hook,
     0x0001, doc_set_completion_display_matches_hook},
    {"set_startup_hook", set_startup_hook,
     0x0001, doc_set_startup_hook},

    {"set_pre_input_hook", set_pre_input_hook,
     0x0001, doc_set_pre_input_hook},


    {"clear_history", py_clear_history, 0x0004, doc_clear_history},
...
on_hook(PyObject *func)
{
    ...
    if (func != ((void *)0)) {
        ...
        r = PyObject_CallFunction(func, ((void *)0));
        if (r == ((void *)0))
            goto error;
        if (r == (&_Py_NoneStruct))
            result = 0;
...
{
    int i;
    PyObject *m=((void *)0), *s=((void *)0), *r=((void *)0);
    ...
    do { if ( --((PyObject*)(m))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(m)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(m)))); } while (0); m=((void *)0);

    if (r == ((void *)0) ||
        (r != (&_Py_NoneStruct) && PyLong_AsLong(r) == -1 && PyErr_Occurred())) {
        goto error;
    }
    do { if ((r) == ((void *)0)) ; else do { if ( --((PyObject*)(r))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(r)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(r)))); } while (0); } while (0); r=((void *)0);
...
flex_complete(char *text, int start, int end)
{
    ...
    do { if ((begidx) == ((void *)0)) ; else do { if ( --((PyObject*)(begidx))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(begidx)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(begidx)))); } while (0); } while (0);
    do { if ((endidx) == ((void *)0)) ; else do { if ( --((PyObject*)(endidx))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(endidx)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(endidx)))); } while (0); } while (0);
    begidx = PyLong_FromLong((long) start);
    endidx = PyLong_FromLong((long) end);
    return rl_completion_matches((text), ((rl_compentry_func_t *)(*on_completion)));
}
...
setup_readline(void)
{
    ...
    char *saved_locale = strdup(setlocale(2, ((void *)0)));
    if (!saved_locale)
    ...
    if (using_libedit_emulation)
        rl_read_init_file(((void *)0));
    else

        rl_initialize();

    { setlocale(2, saved_locale); free(saved_locale); }
}
...
readline_until_enter_or_signal(char *prompt, int *signal)
{
    ...
    *signal = 0;
    ...
    __builtin_bzero(&selectset, sizeof(*(&selectset)));
    ...
    while (completed_input_string == not_done_reading) {
        ...
        { struct timeval timeout = {0, 100000};
            ...
            struct timeval *timeoutp = ((void *)0);
            if (PyOS_InputHook)
                timeoutp = &timeout;
            do { int __fd = (fileno(rl_instream)); ((&selectset)->fds_bits[__fd/(sizeof(__int32_t) * 8)] |= (1<<(__fd % (sizeof(__int32_t) * 8)))); } while(0);

            has_input = select(fileno(rl_instream) + 1, &selectset,
                               ((void *)0), ((void *)0), timeoutp);
            err = (*__error());
...
call_readline(FILE *sys_stdin, FILE *sys_stdout, char *prompt)
{
    ...
    p = PyMem_Malloc(n+2);
    if (p != ((void *)0)) {
        ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___strncpy_chk (p, q, n, __builtin_object_size (p, 2 > 1)) : __inline_strncpy_chk (p, q, n));
        p[n] = '\n';
        p[n+1] = '\0';
    }
    free(q);
...
static char doc_module[] = "Importing this module enables command line editing using GNU readline.";



static char doc_module_le[] = "Importing this module enables command line editing using libedit readline.";
...
PyInit_readline(void)
{
    ...
    m = PyModule_Create2(&readlinemodule, 1013);
