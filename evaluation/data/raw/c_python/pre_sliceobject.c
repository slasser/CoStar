...
static PySliceObject *slice_cache = ((void *)0);
void PySlice_Fini(void)
{
...
{
    PySliceObject *obj;
    if (slice_cache != ((void *)0)) {
        obj = slice_cache;
        slice_cache = ((void *)0);
        ( (((PyObject*)((PyObject *)obj))->ob_refcnt) = 1);
    } else {
        obj = ( (PySliceObject *) _PyObject_New(&PySlice_Type) );
        if (obj == ((void *)0))
            return ((void *)0);
    }

    if (step == ((void *)0)) step = (&_Py_NoneStruct);
    ( ((PyObject*)(step))->ob_refcnt++);
    if (start == ((void *)0)) start = (&_Py_NoneStruct);
    ( ((PyObject*)(start))->ob_refcnt++);
    if (stop == ((void *)0)) stop = (&_Py_NoneStruct);
...
_PySlice_FromIndices(Py_ssize_t istart, Py_ssize_t istop)
{
    ...
    slice = PySlice_New(start, end, ((void *)0));
    do { if ( --((PyObject*)(start))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(start)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(start)))); } while (0);
    do { if ( --((PyObject*)(end))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(end)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(end)))); } while (0);
    return slice;
}
                   ...
                   Py_ssize_t *start, Py_ssize_t *stop, Py_ssize_t *step)
{
    ...
    if (r->step == (&_Py_NoneStruct)) {
        *step = 1;
        ...
        if (!((((((PyObject*)(r->step))->ob_type))->tp_flags & ((1L<<24))) != 0)) return -1;
        *step = PyLong_AsSsize_t(r->step);
    }
    if (r->start == (&_Py_NoneStruct)) {
        *start = *step < 0 ? length-1 : 0;
    } else {
        if (!((((((PyObject*)(r->start))->ob_type))->tp_flags & ((1L<<24))) != 0)) return -1;
    ...
    if (r->stop == (&_Py_NoneStruct)) {
        *stop = *step < 0 ? -1 : length;
        ...
        if (!((((((PyObject*)(r->stop))->ob_type))->tp_flags & ((1L<<24))) != 0)) return -1;
                     ...
                     Py_ssize_t *slicelength)
{
    ...
    if (r->step == (&_Py_NoneStruct)) {
        *step = 1;
        ...
        if (*step < -((Py_ssize_t)(((size_t)-1)>>1)))
            *step = -((Py_ssize_t)(((size_t)-1)>>1));
    }
...
static PyMemberDef slice_members[] = {
    {"start", 6, __builtin_offsetof (PySliceObject, start), 1},
    {"stop", 6, __builtin_offsetof (PySliceObject, stop), 1},
    {"step", 6, __builtin_offsetof (PySliceObject, step), 1},
    {0}
};
...
static char slice_indices_doc[] = "S.indices(len) -> (start, stop, stride)\n\nAssuming a sequence of length len, calculate the start and stop\nindices, and the stride length of the extended slice described by\nS. Out of bounds indices are clipped in a manner consistent with the\nhandling of normal slices.";
...
{
    return Py_BuildValue("O(OOO)", (((PyObject*)(self))->ob_type), self->start, self->stop, self->step);
}
...
slice_richcompare(PyObject *v, PyObject *w, int op)
{
    ...
    if (!((((PyObject*)(v))->ob_type) == &PySlice_Type) || !((((PyObject*)(w))->ob_type) == &PySlice_Type))
    ...
    (((PyTupleObject *)(t1))->ob_item[0] = ((PySliceObject *)v)->start);
    (((PyTupleObject *)(t1))->ob_item[1] = ((PySliceObject *)v)->stop);
    (((PyTupleObject *)(t1))->ob_item[2] = ((PySliceObject *)v)->step);
    (((PyTupleObject *)(t2))->ob_item[0] = ((PySliceObject *)w)->start);
    (((PyTupleObject *)(t2))->ob_item[1] = ((PySliceObject *)w)->stop);
    (((PyTupleObject *)(t2))->ob_item[2] = ((PySliceObject *)w)->step);

    res = PyObject_RichCompare(t1, t2, op);

    (((PyTupleObject *)(t1))->ob_item[0] = ((void *)0));
    (((PyTupleObject *)(t1))->ob_item[1] = ((void *)0));
    (((PyTupleObject *)(t1))->ob_item[2] = ((void *)0));
    (((PyTupleObject *)(t2))->ob_item[0] = ((void *)0));
    (((PyTupleObject *)(t2))->ob_item[1] = ((void *)0));
    (((PyTupleObject *)(t2))->ob_item[2] = ((void *)0));
