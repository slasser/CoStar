...
dbm_subscript(dbmobject *dp, register PyObject *key)
{
    ...
    if (!_PyArg_Parse_SizeT(key, "s#", &krec.dptr, &tmp_size) )
        return ((void *)0);

    krec.dsize = tmp_size;
    if ((dp)->di_dbm == ((void *)0)) { PyErr_SetString(DbmError, "DBM object has already been closed"); return ((void *)0); };
...
dbm_ass_sub(dbmobject *dp, PyObject *v, PyObject *w)
{
    ...
    if ( !_PyArg_Parse_SizeT(v, "s#", &krec.dptr, &tmp_size) ) {
    ...
    if (w == ((void *)0)) {
        ...
        if ( !_PyArg_Parse_SizeT(w, "s#", &drec.dptr, &tmp_size) ) {
            PyErr_SetString(PyExc_TypeError,
...
dbm_contains(PyObject *self, PyObject *arg)
{
    ...
    if (!((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<27))) != 0)) {
        ...
        key.dptr = ((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_dbmmodule.c", 235, "PyBytes_Check(arg)") : (void)0), (((PyBytesObject *)(arg))->ob_sval));
        key.dsize = ((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_dbmmodule.c", 236, "PyBytes_Check(arg)") : (void)0),(((PyVarObject*)(arg))->ob_size));
    }
    val = dbm_fetch(dp->di_dbm, key);
    return val.dptr != ((void *)0);
}
...
{
    datum key, val;
    PyObject *defvalue = (&_Py_NoneStruct);
    char *tmp_ptr;
    Py_ssize_t tmp_size;

    if (!_PyArg_ParseTuple_SizeT(args, "s#|O:get",
...
{
    datum key, val;
    PyObject *defvalue = ((void *)0);
    char *tmp_ptr;
    Py_ssize_t tmp_size;

    if (!_PyArg_ParseTuple_SizeT(args, "s#|O:setdefault",
                          &tmp_ptr, &tmp_size, &defvalue))
        return ((void *)0);
    key.dptr = tmp_ptr;
    key.dsize = tmp_size;
    ...
    if (val.dptr != ((void *)0))
        return PyBytes_FromStringAndSize(val.dptr, val.dsize);
    if (defvalue == ((void *)0)) {
        defvalue = PyBytes_FromStringAndSize(((void *)0), 0);
        if (defvalue == ((void *)0))
            return ((void *)0);
        val.dptr = ((void *)0);
        val.dsize = 0;
        ...
        if ( !_PyArg_Parse_SizeT(defvalue, "s#", &val.dptr, &tmp_size) ) {
            PyErr_SetString(PyExc_TypeError,
    ...
    if (dbm_store(dp->di_dbm, key, val, DBM_INSERT) < 0) {
        ...
        do { if ( --((PyObject*)(defvalue))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(defvalue)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(defvalue)))); } while (0);
        return ((void *)0);
    }
    return defvalue;
}
...
static PyMethodDef dbm_methods[] = {
    {"close", (PyCFunction)dbm__close, 0x0004,
     "close()\nClose the database."},
    {"keys", (PyCFunction)dbm_keys, 0x0004,
     "keys() -> list\nReturn a list of all keys in the database."},
    {"get", (PyCFunction)dbm_get, 0x0001,
     "get(key[, default]) -> value\n"
     "Return the value for key if present, otherwise default."},
    {"setdefault", (PyCFunction)dbm_setdefault, 0x0001,
...
dbmopen(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s|si:open", &name, &flags, &mode) )
        return ((void *)0);
    if ( strcmp(flags, "r") == 0 )
        iflags = 0x0000;
        ...
        iflags = 0x0002|0x0200;
    else if ( strcmp(flags, "c") == 0 )
        iflags = 0x0002|0x0200;
    else if ( strcmp(flags, "n") == 0 )
        iflags = 0x0002|0x0200|0x0400;
    else {
        PyErr_SetString(DbmError,
...
static PyMethodDef dbmmodule_methods[] = {
    { "open", (PyCFunction)dbmopen, 0x0001,
...
PyInit__dbm(void) {
    ...
    if (PyType_Ready(&Dbmtype) < 0)
        return ((void *)0);
    m = PyModule_Create2(&_dbmmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
