...
# 60 "pytime.c"
    ...
    err = gettimeofday(tp, (struct timezone *)((void *)0));
...
_PyTime_ObjectToDenominator(PyObject *obj, time_t *sec, long *numerator,
                            double denominator)
{
    (__builtin_expect(!(denominator <= 9223372036854775807L), 0) ? __assert_rtn(__func__, "pytime.c", 157, "denominator <= LONG_MAX") : (void)0);
