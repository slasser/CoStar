...
{
    if (self->in_weakreflist != ((void *)0))
        PyObject_ClearWeakRefs((PyObject *) self);
    if (self->lock_lock != ((void *)0)) {
...
static PyLockStatus
acquire_timed(PyThread_type_lock lock, long long microseconds)
{
    PyLockStatus r;
...
{
    char *kwlist[] = {"blocking", "timeout", ((void *)0)};
    int blocking = 1;
    double timeout = -1;
    long long microseconds;
    PyLockStatus r;
    ...
    if (!blocking)
        ...
        timeout *= 1e6;
        if (timeout >= (double) 0x7fffffffffffffffLL) {
            PyErr_SetString(PyExc_OverflowError,
                            "timeout value is too large");
            return ((void *)0);
        }
        microseconds = (long long) timeout;
    }
...
static char locked_doc[] = "locked() -> bool\n(locked_lock() is an obsolete synonym)\n\nReturn whether the lock is in the locked state.";
...
static PyTypeObject Locktype = {
    ...
    0,
    0,
    __builtin_offsetof (lockobject, in_weakreflist),
    0,
    0,
    lock_methods,
};
...
{
    (__builtin_expect(!(self->rlock_lock), 0) ? __assert_rtn(__func__, "_threadmodule.c", 258, "self->rlock_lock") : (void)0);
    if (self->in_weakreflist != ((void *)0))
        PyObject_ClearWeakRefs((PyObject *) self);
...
rlock_acquire(rlockobject *self, PyObject *args, PyObject *kwds)
{
    ...
    if (r == PY_LOCK_ACQUIRED) {
        (__builtin_expect(!(self->rlock_count == 0), 0) ? __assert_rtn(__func__, "_threadmodule.c", 320, "self->rlock_count == 0") : (void)0);
...
rlock_acquire_restore(rlockobject *self, PyObject *arg)
{
    ...
    (__builtin_expect(!(self->rlock_count == 0), 0) ? __assert_rtn(__func__, "_threadmodule.c", 395, "self->rlock_count == 0") : (void)0);
    self->rlock_owner = owner;
    self->rlock_count = count;
    return ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++), (&_Py_NoneStruct);
}

static char rlock_acquire_restore_doc[] = "_acquire_restore(state) -> None\n\nFor internal use by `threading.Condition`.";
...
static char rlock_release_save_doc[] = "_release_save() -> tuple\n\nFor internal use by `threading.Condition`.";
...
static char rlock_is_owned_doc[] = "_is_owned() -> bool\n\nFor internal use by `threading.Condition`.";
...
rlock_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    if (self != ((void *)0)) {
        ...
        if (self->rlock_lock == ((void *)0)) {
            type->tp_free(self);
            PyErr_SetString(ThreadError, "can't allocate lock");
            return ((void *)0);
        }
        self->in_weakreflist = ((void *)0);
        self->rlock_owner = 0;
        self->rlock_count = 0;
    }
...
static PyTypeObject RLocktype = {
    ...
    0,
    0,
    __builtin_offsetof (rlockobject, in_weakreflist),
    0,
    0,
    rlock_methods,
    0,
...
{
    lockobject *self;
    self = ( (lockobject *) _PyObject_New(&Locktype) );
    if (self == ((void *)0))
        return ((void *)0);
...
static PyTypeObject localdummytype = {
    { { 1, ((void *)0) }, 0 },
                            ...
                            0,
                            0,
                            __builtin_offsetof (localdummyobject, weakreflist)
};
...
{
    PyObject *tdict, *ldict = ((void *)0), *wr = ((void *)0);
    localdummyobject *dummy = ((void *)0);
    int r;
    ...
    if (r < 0)
        goto err;
    do { if (wr) { PyObject *_py_tmp = (PyObject *)(wr); (wr) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    ...
    do { if ( --((PyObject*)(ldict))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ldict)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ldict)))); } while (0);
    return ldict;

err:
    do { if ((ldict) == ((void *)0)) ; else do { if ( --((PyObject*)(ldict))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ldict)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ldict)))); } while (0); } while (0);
    do { if ((wr) == ((void *)0)) ; else do { if ( --((PyObject*)(wr))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(wr)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(wr)))); } while (0); } while (0);
    do { if ((dummy) == ((void *)0)) ; else do { if ( --((PyObject*)(dummy))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(dummy)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(dummy)))); } while (0); } while (0);
    return ((void *)0);
}
...
local_new(PyTypeObject *type, PyObject *args, PyObject *kw)
{
    ...
    static PyMethodDef wr_callback_def = {
        "_localdummy_destroyed", (PyCFunction) _localdummy_destroyed, 0x0008
    };
    ...
    do { if ((args) == ((void *)0)) ; else ( ((PyObject*)(args))->ob_refcnt++); } while (0);
    self->args = args;
    do { if ((kw) == ((void *)0)) ; else ( ((PyObject*)(kw))->ob_refcnt++); } while (0);
    self->kw = kw;
    ...
    if (self->dummies == ((void *)0))
        goto err;



    wr = PyWeakref_NewRef((PyObject *) self, ((void *)0));
    if (wr == ((void *)0))
        goto err;
    self->wr_callback = PyCFunction_NewEx((&wr_callback_def), (wr), ((void *)0));
    do { if ( --((PyObject*)(wr))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(wr)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(wr)))); } while (0);
    if (self->wr_callback == ((void *)0))
        goto err;

    if (_local_create_dummy(self) == ((void *)0))
        goto err;
...
local_traverse(localobject *self, visitproc visit, void *arg)
{
    ...
    do { if (self->kw) { int vret = visit((PyObject *)(self->kw), arg); if (vret) return vret; } } while (0);
    do { if (self->dummies) { int vret = visit((PyObject *)(self->dummies), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
local_clear(localobject *self)
{
    ...
    do { if (self->kw) { PyObject *_py_tmp = (PyObject *)(self->kw); (self->kw) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (self->dummies) { PyObject *_py_tmp = (PyObject *)(self->dummies); (self->dummies) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (self->wr_callback) { PyObject *_py_tmp = (PyObject *)(self->wr_callback); (self->wr_callback) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
...
local_dealloc(localobject *self)
{
    ...
    local_clear(self);
    do { if ((self->key) == ((void *)0)) ; else do { if ( --((PyObject*)(self->key))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(self->key)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(self->key)))); } while (0); } while (0);
    (((PyObject*)(self))->ob_type)->tp_free((PyObject*)self);
}
...
_ldict(localobject *self)
{
    ...
    if (dummy == ((void *)0)) {
        ...
        if ((((PyObject*)(self))->ob_type)->tp_init != PyBaseObject_Type.tp_init &&
            (((PyObject*)(self))->ob_type)->tp_init((PyObject*)self,
                                   self->args, self->kw) < 0) {
        ...
        (__builtin_expect(!((((PyObject*)(dummy))->ob_type) == &localdummytype), 0) ? __assert_rtn(__func__, "_threadmodule.c", 835, "Py_TYPE(dummy) == &localdummytype") : (void)0);
...
local_setattro(localobject *self, PyObject *name, PyObject *v)
{
    ...
    r = PyObject_RichCompareBool(name, str_dict, 2);
    if (r == 1) {
        PyErr_Format(PyExc_AttributeError,
                     "'%.50s' object attribute '%U' is read-only",
                     (((PyObject*)(self))->ob_type)->tp_name, name);
        return -1;
    }
    if (r == -1)
        return -1;
...
static PyTypeObject localtype = {
    { { 1, ((void *)0) }, 0 },
                            ...
                            0,
                            0,
                            (getattrofunc)local_getattro,
                            (setattrofunc)local_setattro,
                            0,
                            ( 0 | (1L<<18) | 0) | (1L<<10)
                                               | (1L<<14),
                            "Thread-local data",
                            (traverseproc)local_traverse,
                            (inquiry)local_clear,
                            0,
                            __builtin_offsetof (localobject, weakreflist),
                            0,
                            0,
                            0,
                            0,
...
local_getattro(localobject *self, PyObject *name)
{
    ...
    r = PyObject_RichCompareBool(name, str_dict, 2);
    if (r == 1) {
        ( ((PyObject*)(ldict))->ob_refcnt++);
        return ldict;
    }
    if (r == -1)
        return ((void *)0);

    if ((((PyObject*)(self))->ob_type) != &localtype)
...
_localdummy_destroyed(PyObject *localweakref, PyObject *dummyweakref)
{
    PyObject *obj;
    localobject *self;
    (__builtin_expect(!(((((PyObject*)(localweakref))->ob_type) == (&_PyWeakref_RefType) || PyType_IsSubtype((((PyObject*)(localweakref))->ob_type), (&_PyWeakref_RefType)))), 0) ? __assert_rtn(__func__, "_threadmodule.c", 949, "PyWeakref_CheckRef(localweakref)") : (void)0);
    obj = ((((PyObject*)(((PyWeakReference *)(localweakref))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(localweakref))->wr_object : (&_Py_NoneStruct));
    if (obj == (&_Py_NoneStruct))
        return ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++), (&_Py_NoneStruct);
    ( ((PyObject*)(obj))->ob_refcnt++);
    (__builtin_expect(!(((((PyObject*)(obj))->ob_type) == (&localtype) || PyType_IsSubtype((((PyObject*)(obj))->ob_type), (&localtype)))), 0) ? __assert_rtn(__func__, "_threadmodule.c", 954, "PyObject_TypeCheck(obj, &localtype)") : (void)0);
...
t_bootstrap(void *boot_raw)
{
    ...
    if (res == ((void *)0)) {
        if (PyErr_ExceptionMatches(PyExc_SystemExit))
            ...
            if (file != ((void *)0) && file != (&_Py_NoneStruct))
                ...
                PyObject_Print(boot->func, __stderrp, 0);
            PySys_WriteStderr("\n");
    ...
    do { if ( --((PyObject*)(boot->func))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(boot->func)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(boot->func)))); } while (0);
    do { if ( --((PyObject*)(boot->args))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(boot->args)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(boot->args)))); } while (0);
    do { if ((boot->keyw) == ((void *)0)) ; else do { if ( --((PyObject*)(boot->keyw))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(boot->keyw)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(boot->keyw)))); } while (0); } while (0);
    free(boot_raw);
    nb_threads--;
...
{
    PyObject *func, *args, *keyw = ((void *)0);
    ...
    if (keyw != ((void *)0) && !((((((PyObject*)(keyw))->ob_type))->tp_flags & ((1L<<29))) != 0)) {
        PyErr_SetString(PyExc_TypeError,
                        "optional 3rd arg must be a dictionary");
        return ((void *)0);
    }
    boot = ( ((size_t)(1) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(struct bootstate)) ? ((void *)0) : ( (struct bootstate *) ((size_t)((1) * sizeof(struct bootstate)) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc(((1) * sizeof(struct bootstate)) ? ((1) * sizeof(struct bootstate)) : 1)) ) );
    if (boot == ((void *)0))
    ...
    if (boot->tstate == ((void *)0)) {
        free(boot);
        return PyErr_NoMemory();
    }
    ( ((PyObject*)(func))->ob_refcnt++);
    ( ((PyObject*)(args))->ob_refcnt++);
    do { if ((keyw) == ((void *)0)) ; else ( ((PyObject*)(keyw))->ob_refcnt++); } while (0);
    PyEval_InitThreads();
    ...
    if (ident == -1) {
        ...
        do { if ((keyw) == ((void *)0)) ; else do { if ( --((PyObject*)(keyw))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(keyw)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(keyw)))); } while (0); } while (0);
...
static char interrupt_doc[] = "interrupt_main()\n\nRaise a KeyboardInterrupt in the main thread.\nA subthread can use this function to interrupt the main thread.";
...
static char allocate_doc[] = "allocate_lock() -> lock object\n(allocate() is an obsolete synonym)\n\nCreate a new lock object.  See help(LockType) for information about locks.";
...
static PyMethodDef thread_methods[] = {
    ...
    {"interrupt_main", (PyCFunction)thread_PyThread_interrupt_main,
     0x0004, interrupt_doc},
    {"get_ident", (PyCFunction)thread_get_ident,
     0x0004, get_ident_doc},
    {"_count", (PyCFunction)thread__count,
     0x0004, _count_doc},
    {"stack_size", (PyCFunction)thread_stack_size,
     0x0001, stack_size_doc},
    {((void *)0), ((void *)0)}
};
...
static char thread_doc[] = "This module provides primitive operations to write multi-threaded programs.\nThe 'threading' module provides a more convenient interface.";



static char lock_doc[] = "A lock object is a synchronization primitive.  To create a lock,\ncall the PyThread_allocate_lock() function.  Methods are:\n\nacquire() -- lock the lock, possibly blocking until it can be obtained\nrelease() -- unlock of the lock\nlocked() -- test whether the lock is currently locked\n\nA lock is not owned by the thread that locked it; another thread may\nunlock it.  A thread attempting to lock a lock that it has already locked\nwill block until another thread unlocks it.  Deadlocks may ensue.";
# 1272 "_threadmodule.c"
...
PyInit__thread(void)
{
    ...
    m = PyModule_Create2(&threadmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);

    timeout_max = PyFloat_FromDouble(0x7fffffffffffffffLL / 1000000);
    if (!timeout_max)
        return ((void *)0);
    ...
    ( ((PyObject*)(ThreadError))->ob_refcnt++);

    PyDict_SetItemString(d, "error", ThreadError);
    Locktype.tp_doc = lock_doc;
    ( ((PyObject*)(&Locktype))->ob_refcnt++);
    PyDict_SetItemString(d, "LockType", (PyObject *)&Locktype);

    ( ((PyObject*)(&RLocktype))->ob_refcnt++);
    if (PyModule_AddObject(m, "RLock", (PyObject *)&RLocktype) < 0)
        return ((void *)0);

    ( ((PyObject*)(&localtype))->ob_refcnt++);
