...
{
    (__builtin_expect(!(v != ((void *)0)), 0) ? __assert_rtn(__func__, "_struct.c", 99, "v != NULL") : (void)0);
    ...
    (__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<24))) != 0)), 0) ? __assert_rtn(__func__, "_struct.c", 116, "PyLong_Check(v)") : (void)0);
    return v;
}
...
get_long(PyObject *v, long *p)
{
    ...
    if (v == ((void *)0))
        return -1;
    (__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<24))) != 0)), 0) ? __assert_rtn(__func__, "_struct.c", 131, "PyLong_Check(v)") : (void)0);
    x = PyLong_AsLong(v);
...
get_ulong(PyObject *v, unsigned long *p)
{
    ...
    if (v == ((void *)0))
        return -1;
    (__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<24))) != 0)), 0) ? __assert_rtn(__func__, "_struct.c", 155, "PyLong_Check(v)") : (void)0);
...
get_longlong(PyObject *v, long long *p)
{
    ...
    if (v == ((void *)0))
        return -1;
    (__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<24))) != 0)), 0) ? __assert_rtn(__func__, "_struct.c", 180, "PyLong_Check(v)") : (void)0);
...
get_ulonglong(PyObject *v, unsigned long long *p)
{
    ...
    if (v == ((void *)0))
        return -1;
    (__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<24))) != 0)), 0) ? __assert_rtn(__func__, "_struct.c", 203, "PyLong_Check(v)") : (void)0);
...
get_ssize_t(PyObject *v, Py_ssize_t *p)
{
    ...
    if (v == ((void *)0))
        return -1;
    (__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<24))) != 0)), 0) ? __assert_rtn(__func__, "_struct.c", 228, "PyLong_Check(v)") : (void)0);
...
get_size_t(PyObject *v, size_t *p)
{
    ...
    if (v == ((void *)0))
        return -1;
    (__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<24))) != 0)), 0) ? __assert_rtn(__func__, "_struct.c", 251, "PyLong_Check(v)") : (void)0);
    x = PyLong_AsSize_t(v);
    do { if ( --((PyObject*)(v))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(v)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(v)))); } while (0);
...
{
# 306 "_struct.c"
    const size_t ulargest = (size_t)-1 >> ((8 - f->size)*8);
    (__builtin_expect(!(f->size >= 1 && f->size <= 8), 0) ? __assert_rtn(__func__, "_struct.c", 307, "f->size >= 1 && f->size <= SIZEOF_SIZE_T") : (void)0);
    if (is_unsigned)
...
{
    short x;
    ((__builtin_object_size ((char *)&x, 0) != (size_t) -1) ? __builtin___memcpy_chk ((char *)&x, p, sizeof x, __builtin_object_size ((char *)&x, 0)) : __inline_memcpy_chk ((char *)&x, p, sizeof x));
...
nu_longlong(const char *p, const formatdef *f)
{
    long long x;
    ((__builtin_object_size ((char *)&x, 0) != (size_t) -1) ? __builtin___memcpy_chk ((char *)&x, p, sizeof x, __builtin_object_size ((char *)&x, 0)) : __inline_memcpy_chk ((char *)&x, p, sizeof x));
    if (x >= (-9223372036854775807L - 1L) && x <= 9223372036854775807L)
        return PyLong_FromLong((long)(x));
...
{
    if (!((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<27))) != 0) || PyBytes_Size(v) != 1) {
        PyErr_SetString(StructError,
...
np_short(char *p, PyObject *v, const formatdef *f)
{
    ...
    if (get_long(v, &x) < 0)
        return -1;
    if (x < (-32767 - 1) || x > 32767){
        PyErr_SetString(StructError,
                        "short format requires " "SHRT_MIN"
                        " <= number <= " "SHRT_MAX");
        return -1;
    }
    y = (short)x;
    ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___memcpy_chk (p, (char *)&y, sizeof y, __builtin_object_size (p, 0)) : __inline_memcpy_chk (p, (char *)&y, sizeof y));
    return 0;
}
...
np_int(char *p, PyObject *v, const formatdef *f)
{
    ...
    if ((x < ((long)(-2147483647 - 1))) || (x > ((long)2147483647)))
...
np_uint(char *p, PyObject *v, const formatdef *f)
{
    ...
    if (x > ((unsigned long)(2147483647 * 2U + 1U)))
...
np_long(char *p, PyObject *v, const formatdef *f)
{
    ...
    if (get_long(v, &x) < 0)
        return -1;
    ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___memcpy_chk (p, (char *)&x, sizeof x, __builtin_object_size (p, 0)) : __inline_memcpy_chk (p, (char *)&x, sizeof x));
    return 0;
}
...
np_double(char *p, PyObject *v, const formatdef *f)
{
    ...
    ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___memcpy_chk (p, (char *)&x, sizeof(double), __builtin_object_size (p, 0)) : __inline_memcpy_chk (p, (char *)&x, sizeof(double)));
    return 0;
}
...
np_void_p(char *p, PyObject *v, const formatdef *f)
{
    ...
    if (v == ((void *)0))
        return -1;
    (__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<24))) != 0)), 0) ? __assert_rtn(__func__, "_struct.c", 717, "PyLong_Check(v)") : (void)0);
...
static formatdef native_table[] = {
    {'x', sizeof(char), 0, ((void *)0)},
    {'b', sizeof(char), 0, nu_byte, np_byte},
    {'B', sizeof(char), 0, nu_ubyte, np_ubyte},
    {'c', sizeof(char), 0, nu_char, np_char},
    {'s', sizeof(char), 0, ((void *)0)},
    {'p', sizeof(char), 0, ((void *)0)},
    {'h', sizeof(short), (sizeof(st_short) - sizeof(short)), nu_short, np_short},
    {'H', sizeof(short), (sizeof(st_short) - sizeof(short)), nu_ushort, np_ushort},
    {'i', sizeof(int), (sizeof(st_int) - sizeof(int)), nu_int, np_int},
    {'I', sizeof(int), (sizeof(st_int) - sizeof(int)), nu_uint, np_uint},
    {'l', sizeof(long), (sizeof(st_long) - sizeof(long)), nu_long, np_long},
    {'L', sizeof(long), (sizeof(st_long) - sizeof(long)), nu_ulong, np_ulong},
    {'n', sizeof(size_t), (sizeof(st_size_t) - sizeof(size_t)), nu_ssize_t, np_ssize_t},
    {'N', sizeof(size_t), (sizeof(st_size_t) - sizeof(size_t)), nu_size_t, np_size_t},

    {'q', sizeof(long long), (sizeof(s_long_long) - sizeof(long long)), nu_longlong, np_longlong},
    {'Q', sizeof(long long), (sizeof(s_long_long) - sizeof(long long)), nu_ulonglong,np_ulonglong},

    {'?', sizeof(_Bool), (sizeof(s_bool) - sizeof(_Bool)), nu_bool, np_bool},
    {'f', sizeof(float), (sizeof(st_float) - sizeof(float)), nu_float, np_float},
    {'d', sizeof(double), (sizeof(st_double) - sizeof(double)), nu_double, np_double},
    {'P', sizeof(void *), (sizeof(st_void_p) - sizeof(void *)), nu_void_p, np_void_p},
    {0}
};
...
align(Py_ssize_t size, char c, const formatdef *e)
{
    ...
    if (e->format == c) {
        if (e->alignment && size > 0) {
            ...
            if (extra > ((Py_ssize_t)(((size_t)-1)>>1)) - size)
                return -1;
            size += extra;
        }
    }
...
prepare_s(PyStructObject *self)
{
    ...
    fmt = ((__builtin_expect(!(((((((PyObject*)(self->s_format))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_struct.c", 1266, "PyBytes_Check(self->s_format)") : (void)0), (((PyBytesObject *)(self->s_format))->ob_sval));
    ...
    len = 0;
    while ((c = *s++) != '\0') {
        if ((_Py_ctype_table[((unsigned char)((((unsigned char)((c) & 0xff))) & 0xff))] & 0x08))
            continue;
        if ('0' <= c && c <= '9') {
            num = c - '0';
            while ('0' <= (c = *s++) && c <= '9') {
                ...
                if (num >= ((Py_ssize_t)(((size_t)-1)>>1)) / 10 && (
                        num > ((Py_ssize_t)(((size_t)-1)>>1)) / 10 ||
                        (c - '0') > ((Py_ssize_t)(((size_t)-1)>>1)) % 10))
                    goto overflow;
                num = num*10 + (c - '0');
            }
            if (c == '\0') {
        ...
        if (num > (((Py_ssize_t)(((size_t)-1)>>1)) - size) / itemsize)
            goto overflow;
        size += num * itemsize;
    }


    if ((len + 1) > (((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(formatcode))) {
        PyErr_NoMemory();
        return -1;
    }
    ...
    self->s_size = size;
    self->s_len = len;
    codes = ((size_t)((len + 1) * sizeof(formatcode)) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc(((len + 1) * sizeof(formatcode)) ? ((len + 1) * sizeof(formatcode)) : 1));
    if (codes == ((void *)0)) {
        PyErr_NoMemory();
        return -1;
    }

    if (self->s_codes != ((void *)0))
        free(self->s_codes);
    self->s_codes = codes;
...
s_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    (__builtin_expect(!(type != ((void *)0) && type->tp_alloc != ((void *)0)), 0) ? __assert_rtn(__func__, "_struct.c", 1389, "type != NULL && type->tp_alloc != NULL") : (void)0);

    self = type->tp_alloc(type, 0);
    if (self != ((void *)0)) {
        PyStructObject *s = (PyStructObject*)self;
        ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++);
        s->s_format = (&_Py_NoneStruct);
        s->s_codes = ((void *)0);
        s->s_size = -1;
        s->s_len = -1;
    }
...
s_init(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *o_format = ((void *)0);
    int ret = 0;
    static char *kwlist[] = {"format", 0};

    (__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyStructType) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyStructType)))), 0) ? __assert_rtn(__func__, "_struct.c", 1411, "PyStruct_Check(self)") : (void)0);

    if (!_PyArg_ParseTupleAndKeywords_SizeT(args, kwds, "O:Struct", kwlist,
                                     &o_format))
        return -1;

    if (((((((PyObject*)(o_format))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        ...
        ( ((PyObject*)(o_format))->ob_refcnt++);
    }

    if (!((((((PyObject*)(o_format))->ob_type))->tp_flags & ((1L<<27))) != 0)) {
        do { if ( --((PyObject*)(o_format))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(o_format)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(o_format)))); } while (0);
        PyErr_Format(PyExc_TypeError,
                     "Struct() argument 1 must be a bytes object, not %.200s",
                     (((PyObject*)(o_format))->ob_type)->tp_name);
        return -1;
    }

    do { if (soself->s_format) { PyObject *_py_tmp = (PyObject *)(soself->s_format); (soself->s_format) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
...
{
    if (s->weakreflist != ((void *)0))
        PyObject_ClearWeakRefs((PyObject *)s);
    if (s->s_codes != ((void *)0)) {
        free(s->s_codes);
    }
    do { if ((s->s_format) == ((void *)0)) ; else do { if ( --((PyObject*)(s->s_format))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(s->s_format)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(s->s_format)))); } while (0); } while (0);
...
s_unpack_internal(PyStructObject *soself, char *startfrom) {
    ...
    for (code = soself->s_codes; code->fmtdef != ((void *)0); code++) {
        PyObject *v;
        ...
        if (v == ((void *)0))
            goto fail;
        (((PyTupleObject *)(result))->ob_item[i++] = v);
    }
...
s_unpack(PyObject *self, PyObject *input)
{
    ...
    (__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyStructType) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyStructType)))), 0) ? __assert_rtn(__func__, "_struct.c", 1502, "PyStruct_Check(self)") : (void)0);
    (__builtin_expect(!(soself->s_codes != ((void *)0)), 0) ? __assert_rtn(__func__, "_struct.c", 1503, "soself->s_codes != NULL") : (void)0);
    if (PyObject_GetBuffer(input, &vbuf, 0) < 0)
        return ((void *)0);
...
static char s_unpack_from__doc__[] = "S.unpack_from(buffer, offset=0) -> (v1, v2, ...)\n\nReturn a tuple containing values unpacked according to the format\nstring S.format.  Requires len(buffer[offset:]) >= S.size.  See\nhelp(struct) for more on format strings.";
...
s_unpack_from(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    (__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyStructType) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyStructType)))), 0) ? __assert_rtn(__func__, "_struct.c", 1536, "PyStruct_Check(self)") : (void)0);
    (__builtin_expect(!(soself->s_codes != ((void *)0)), 0) ? __assert_rtn(__func__, "_struct.c", 1537, "soself->s_codes != NULL") : (void)0);
...
s_pack_internal(PyStructObject *soself, PyObject *args, int offset, char* buf)
{
    ...
    ((__builtin_object_size (buf, 0) != (size_t) -1) ? __builtin___memset_chk (buf, '\0', soself->s_size, __builtin_object_size (buf, 0)) : __inline_memset_chk (buf, '\0', soself->s_size));
    i = offset;
    for (code = soself->s_codes; code->fmtdef != ((void *)0); code++) {
        Py_ssize_t n;
        ...
        if (e->format == 's') {
            int isstring;
            void *p;
            isstring = ((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<27))) != 0);
            if (!isstring && !((((PyObject*)(v))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PyByteArray_Type)))) {
                PyErr_SetString(StructError,
                                "argument for 's' must be a bytes object");
                return -1;
            }
            if (isstring) {
                n = ((__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_struct.c", 1595, "PyBytes_Check(v)") : (void)0),(((PyVarObject*)(v))->ob_size));
                p = ((__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_struct.c", 1596, "PyBytes_Check(v)") : (void)0), (((PyBytesObject *)(v))->ob_sval));
            }
            else {
                n = ((__builtin_expect(!(((((PyObject*)(v))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "_struct.c", 1599, "PyByteArray_Check(v)") : (void)0),(((PyVarObject*)(v))->ob_size));
                p = ((__builtin_expect(!(((((PyObject*)(v))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "_struct.c", 1600, "PyByteArray_Check(v)") : (void)0), (((PyVarObject*)(v))->ob_size) ? ((PyByteArrayObject *)(v))->ob_bytes : _PyByteArray_empty_string);
            }
            if (n > code->size)
                n = code->size;
            if (n > 0)
                ((__builtin_object_size (res, 0) != (size_t) -1) ? __builtin___memcpy_chk (res, p, n, __builtin_object_size (res, 0)) : __inline_memcpy_chk (res, p, n));
        } else if (e->format == 'p') {
            int isstring;
            void *p;
            isstring = ((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<27))) != 0);
            ...
            if (isstring) {
                n = ((__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_struct.c", 1616, "PyBytes_Check(v)") : (void)0),(((PyVarObject*)(v))->ob_size));
                p = ((__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_struct.c", 1617, "PyBytes_Check(v)") : (void)0), (((PyBytesObject *)(v))->ob_sval));
            }
            else {
                n = ((__builtin_expect(!(((((PyObject*)(v))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "_struct.c", 1620, "PyByteArray_Check(v)") : (void)0),(((PyVarObject*)(v))->ob_size));
                p = ((__builtin_expect(!(((((PyObject*)(v))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "_struct.c", 1621, "PyByteArray_Check(v)") : (void)0), (((PyVarObject*)(v))->ob_size) ? ((PyByteArrayObject *)(v))->ob_bytes : _PyByteArray_empty_string);
            }
            if (n > (code->size - 1))
                n = code->size - 1;
            if (n > 0)
                ((__builtin_object_size (res + 1, 0) != (size_t) -1) ? __builtin___memcpy_chk (res + 1, p, n, __builtin_object_size (res + 1, 0)) : __inline_memcpy_chk (res + 1, p, n));
            if (n > 255)
                n = 255;
            *res = (unsigned char)(n);
        } else {
            if (e->pack(res, v, e) < 0) {
                if (((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<24))) != 0) && PyErr_ExceptionMatches(PyExc_OverflowError))
                    PyErr_SetString(StructError,
...
static char s_pack__doc__[] = "S.pack(v1, v2, ...) -> bytes\n\nReturn a bytes object containing values v1, v2, ... packed according\nto the format string S.format.  See help(struct) for more on format\nstrings.";
...
s_pack(PyObject *self, PyObject *args)
{
    ...
    (__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyStructType) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyStructType)))), 0) ? __assert_rtn(__func__, "_struct.c", 1660, "PyStruct_Check(self)") : (void)0);
    (__builtin_expect(!(soself->s_codes != ((void *)0)), 0) ? __assert_rtn(__func__, "_struct.c", 1661, "soself->s_codes != NULL") : (void)0);
    if ((((PyVarObject*)(args))->ob_size) != soself->s_len)
    {
        PyErr_Format(StructError,
            "pack expected %zd items for packing (got %zd)", soself->s_len, (((PyVarObject*)(args))->ob_size));
        return ((void *)0);
    }


    result = PyBytes_FromStringAndSize((char *)((void *)0), soself->s_size);
    if (result == ((void *)0))
        return ((void *)0);


    if ( s_pack_internal(soself, args, 0, ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_struct.c", 1675, "PyBytes_Check(result)") : (void)0), (((PyBytesObject *)(result))->ob_sval))) != 0 ) {
        do { if ( --((PyObject*)(result))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(result)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(result)))); } while (0);
        return ((void *)0);
    }
...
static char s_pack_into__doc__[] = "S.pack_into(buffer, offset, v1, v2, ...)\n\nPack the values v1, v2, ... according to the format string S.format\nand write the packed bytes into the writable buffer buf starting at\noffset.  Note that the offset is a required argument.  See\nhelp(struct) for more on format strings.";
...
s_pack_into(PyObject *self, PyObject *args)
{
    ...
    soself = (PyStructObject *)self;
    (__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyStructType) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyStructType)))), 0) ? __assert_rtn(__func__, "_struct.c", 1700, "PyStruct_Check(self)") : (void)0);
    (__builtin_expect(!(soself->s_codes != ((void *)0)), 0) ? __assert_rtn(__func__, "_struct.c", 1701, "soself->s_codes != NULL") : (void)0);
    if ((((PyVarObject*)(args))->ob_size) != (soself->s_len + 2))
    {
        if ((((PyVarObject*)(args))->ob_size) == 0) {
            PyErr_Format(StructError,
                        "pack_into expected buffer argument");
        }
        else if ((((PyVarObject*)(args))->ob_size) == 1) {
            PyErr_Format(StructError,
            ...
            PyErr_Format(StructError,
                        ...
                        soself->s_len, ((((PyVarObject*)(args))->ob_size) - 2));
        }
        return ((void *)0);
    }


    if ( PyObject_AsWriteBuffer((((PyTupleObject *)(args))->ob_item[0]),
                                                            (void**)&buffer, &buffer_len) == -1 ) {
        return ((void *)0);
    }
    (__builtin_expect(!(buffer_len >= 0), 0) ? __assert_rtn(__func__, "_struct.c", 1725, "buffer_len >= 0") : (void)0);


    offset = PyNumber_AsSsize_t((((PyTupleObject *)(args))->ob_item[1]), PyExc_IndexError);
...
{
    ( ((PyObject*)(self->s_format))->ob_refcnt++);
...
static char s_sizeof__doc__[] = "S.__sizeof__() -> size of S in memory, in bytes";
...
static struct PyMethodDef s_methods[] = {
    {"pack", s_pack, 0x0001, s_pack__doc__},
    {"pack_into", s_pack_into, 0x0001, s_pack_into__doc__},
    {"unpack", s_unpack, 0x0008, s_unpack__doc__},
    {"unpack_from", (PyCFunction)s_unpack_from, 0x0001|0x0002,
                    s_unpack_from__doc__},
    {"__sizeof__", (PyCFunction)s_sizeof, 0x0004, s_sizeof__doc__},
    {((void *)0), ((void *)0)}
};

static char s__doc__[] = "Struct(fmt) --> compiled struct object\n" "\n" "Return a new Struct object which writes and reads binary data according to\n" "the format string fmt.  See help(struct) for more on format strings.";
...
static PyGetSetDef s_getsetlist[] = {
    {"format", (getter)s_get_format, (setter)((void *)0), "struct format string", ((void *)0)},
    {"size", (getter)s_get_size, (setter)((void *)0), "struct size in bytes", ((void *)0)},
    {((void *)0)}
};
...
PyTypeObject PyStructType = {
    ...
    0,
    0,
    __builtin_offsetof (PyStructObject, weakreflist),
    0,
    0,
    s_methods,
    ((void *)0),
...
cache_struct(PyObject *fmt)
{
    ...
    if (s_object != ((void *)0)) {
        ( ((PyObject*)(s_object))->ob_refcnt++);
        return s_object;
    }

    s_object = PyObject_CallFunctionObjArgs((PyObject *)(&PyStructType), fmt, ((void *)0));
    if (s_object != ((void *)0)) {
        if (PyDict_Size(cache) >= 100)
            PyDict_Clear(cache);
...
static char clearcache_doc[] = "Clear the internal cache.";


static PyObject *
clearcache(PyObject *self)
{
    do { if (cache) { PyObject *_py_tmp = (PyObject *)(cache); (cache) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    return ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++), (&_Py_NoneStruct);
}

static char calcsize_doc[] = "calcsize(fmt) -> integer\n\nReturn size in bytes of the struct described by the format string fmt.";
...
calcsize(PyObject *self, PyObject *fmt)
{
    ...
    do { if ( --((PyObject*)(s_object))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(s_object)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(s_object)))); } while (0);
    return PyLong_FromSsize_t(n);
}

static char pack_doc[] = "pack(fmt, v1, v2, ...) -> bytes\n\nReturn a bytes object containing the values v1, v2, ... packed according\nto the format string fmt.  See help(struct) for more on format strings.";
...
pack(PyObject *self, PyObject *args)
{
    ...
    fmt = (((PyTupleObject *)(args))->ob_item[0]);
...
static char pack_into_doc[] = "pack_into(fmt, buffer, offset, v1, v2, ...)\n\nPack the values v1, v2, ... according to the format string fmt and write\nthe packed bytes into the writable buffer buf starting at offset.  Note\nthat the offset is a required argument.  See help(struct) for more\non format strings.";
...
static char unpack_doc[] = "unpack(fmt, buffer) -> (v1, v2, ...)\n\nReturn a tuple containing values unpacked according to the format string\nfmt.  Requires len(buffer) == calcsize(fmt). See help(struct) for more\non format strings.";
...
static char unpack_from_doc[] = "unpack_from(fmt, buffer, offset=0) -> (v1, v2, ...)\n\nReturn a tuple containing values unpacked according to the format string\nfmt.  Requires len(buffer[offset:]) >= calcsize(fmt).  See help(struct)\nfor more on format strings.";
...
static struct PyMethodDef module_functions[] = {
    {"_clearcache", (PyCFunction)clearcache, 0x0004, clearcache_doc},
    {"calcsize", calcsize, 0x0008, calcsize_doc},
    {"pack", pack, 0x0001, pack_doc},
    {"pack_into", pack_into, 0x0001, pack_into_doc},
    {"unpack", unpack, 0x0001, unpack_doc},
    {"unpack_from", (PyCFunction)unpack_from,
                    0x0001|0x0002, unpack_from_doc},
    {((void *)0), ((void *)0)}
};
...
PyInit__struct(void)
{
    ...
    m = PyModule_Create2(&_structmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);

    (((PyObject*)(&PyStructType))->ob_type) = &PyType_Type;
    ...
    if (StructError == ((void *)0)) {
        StructError = PyErr_NewException("struct.error", ((void *)0), ((void *)0));
        if (StructError == ((void *)0))
            return ((void *)0);
    }

    ( ((PyObject*)(StructError))->ob_refcnt++);
    PyModule_AddObject(m, "error", StructError);

    ( ((PyObject*)((PyObject*)&PyStructType))->ob_refcnt++);
