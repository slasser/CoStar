                                    ...
                                    const char *pathname, FILE *fp)
{
    ...
    dlopenflags = ((PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; }))->interp->dlopenflags;
# 129 "dynload_shlib.c"
    handle = dlopen(pathname, dlopenflags);

    if (handle == ((void *)0)) {
        PyObject *mod_name = ((void *)0);
        PyObject *path = ((void *)0);
        PyObject *error_ob = ((void *)0);
        ...
        do { if ((error_ob) == ((void *)0)) ; else do { if ( --((PyObject*)(error_ob))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(error_ob)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(error_ob)))); } while (0); } while (0);
        do { if ((path) == ((void *)0)) ; else do { if ( --((PyObject*)(path))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(path)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(path)))); } while (0); } while (0);
        do { if ((mod_name) == ((void *)0)) ; else do { if ( --((PyObject*)(mod_name))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(mod_name)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(mod_name)))); } while (0); } while (0);
        return ((void *)0);
    }
    if (fp != ((void *)0) && nhandles < 128)
