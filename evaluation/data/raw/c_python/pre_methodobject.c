...
static PyCFunctionObject *free_list = ((void *)0);
...
PyCFunction_NewEx(PyMethodDef *ml, PyObject *self, PyObject *module)
{
    ...
    if (op != ((void *)0)) {
        ...
        ( (((PyObject*)(op))->ob_type) = (&PyCFunction_Type), ( (((PyObject*)((PyObject *)(op)))->ob_refcnt) = 1), (op) );
        numfree--;
    }
    else {
        op = ( (PyCFunctionObject *) _PyObject_GC_New(&PyCFunction_Type) );
        if (op == ((void *)0))
            return ((void *)0);
    }
    op->m_ml = ml;
...
{
    if (!((((PyObject*)(op))->ob_type) == &PyCFunction_Type)) {
        _PyErr_BadInternalCall("methodobject.c", 44);
        return ((void *)0);
    }
...
{
    if (!((((PyObject*)(op))->ob_type) == &PyCFunction_Type)) {
        _PyErr_BadInternalCall("methodobject.c", 54);
        return ((void *)0);
    }
    return (((PyCFunctionObject *)op) -> m_ml -> ml_flags & 0x0020 ? ((void *)0) : ((PyCFunctionObject *)op) -> m_self);
}
...
{
    if (!((((PyObject*)(op))->ob_type) == &PyCFunction_Type)) {
        _PyErr_BadInternalCall("methodobject.c", 64);
        return -1;
    }
...
PyCFunction_Call(PyObject *func, PyObject *arg, PyObject *kw)
{
    ...
    switch ((((PyCFunctionObject *)func) -> m_ml -> ml_flags) & ~(0x0010 | 0x0020 | 0x0040)) {
    case 0x0001:
        if (kw == ((void *)0) || PyDict_Size(kw) == 0)
    ...
    case 0x0004:
        if (kw == ((void *)0) || PyDict_Size(kw) == 0) {
            size = (((PyVarObject*)(arg))->ob_size);
            if (size == 0)
                return (*meth)(self, ((void *)0));
    ...
    case 0x0008:
        if (kw == ((void *)0) || PyDict_Size(kw) == 0) {
            size = (((PyVarObject*)(arg))->ob_size);
            if (size == 1)
                return (*meth)(self, (((PyTupleObject *)(arg))->ob_item[0]));
            PyErr_Format(PyExc_TypeError,
...
{
    do { PyGC_Head *g = ((PyGC_Head *)(m)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "methodobject.c", 124, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
    do { if ((m->m_self) == ((void *)0)) ; else do { if ( --((PyObject*)(m->m_self))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(m->m_self)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(m->m_self)))); } while (0); } while (0);
    do { if ((m->m_module) == ((void *)0)) ; else do { if ( --((PyObject*)(m->m_module))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(m->m_module)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(m->m_module)))); } while (0); } while (0);
    if (numfree < 256) {
...
# 165 "methodobject.c"
    ...
    if (m->m_self == ((void *)0) || ((((PyObject*)(m->m_self))->ob_type) == (&PyModule_Type) || PyType_IsSubtype((((PyObject*)(m->m_self))->ob_type), (&PyModule_Type))))
        return PyUnicode_FromString(m->m_ml->ml_name);

    type = ((((((PyObject*)(m->m_self))->ob_type))->tp_flags & ((1L<<31))) != 0) ? m->m_self : (PyObject*)(((PyObject*)(m->m_self))->ob_type);
...
{
    do { if (m->m_self) { int vret = visit((PyObject *)(m->m_self), arg); if (vret) return vret; } } while (0);
    do { if (m->m_module) { int vret = visit((PyObject *)(m->m_module), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
meth_get__self__(PyCFunctionObject *m, void *closure)
{
    ...
    self = (((PyCFunctionObject *)m) -> m_ml -> ml_flags & 0x0020 ? ((void *)0) : ((PyCFunctionObject *)m) -> m_self);
    if (self == ((void *)0))
        self = (&_Py_NoneStruct);
...
static PyGetSetDef meth_getsets [] = {
    {"__doc__", (getter)meth_get__doc__, ((void *)0), ((void *)0)},
    {"__name__", (getter)meth_get__name__, ((void *)0), ((void *)0)},
    {"__qualname__", (getter)meth_get__qualname__, ((void *)0), ((void *)0)},
    {"__self__", (getter)meth_get__self__, ((void *)0), ((void *)0)},
    {0}
};
...
static PyMemberDef meth_members[] = {
    {"__module__", 6, __builtin_offsetof (PyCFunctionObject, m_module), 4},
    {((void *)0)}
};
...
meth_richcompare(PyObject *self, PyObject *other, int op)
{
    ...
    if ((op != 2 && op != 3) ||
        !((((PyObject*)(self))->ob_type) == &PyCFunction_Type) ||
        !((((PyObject*)(other))->ob_type) == &PyCFunction_Type))
    {
...
PyCFunction_ClearFreeList(void)
{
    ...
    (__builtin_expect(!(numfree == 0), 0) ? __assert_rtn(__func__, "methodobject.c", 331, "numfree == 0") : (void)0);
...
{
    return PyCFunction_NewEx(ml, self, ((void *)0));
}
