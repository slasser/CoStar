              ...
              char *errors, char *newline, int closefd)
{
    ...
    if (io == ((void *)0))
        return ((void *)0);
    stream = _PyObject_CallMethodId_SizeT(io, &PyId_open, "isisssi", fd, mode,
...
PyFile_GetLine(PyObject *f, int n)
{
    ...
    if (f == ((void *)0)) {
        _PyErr_BadInternalCall("fileobject.c", 55);
        return ((void *)0);
    }
    ...
    if (n < 0 && result != ((void *)0) && ((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)) {
        char *s = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "fileobject.c", 88, "PyBytes_Check(result)") : (void)0), (((PyBytesObject *)(result))->ob_sval));
        Py_ssize_t len = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "fileobject.c", 89, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size));
        if (len == 0) {
            do { if ( --((PyObject*)(result))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(result)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(result)))); } while (0);
            result = ((void *)0);
    ...
    if (n < 0 && result != ((void *)0) && ((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        Py_ssize_t len = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "fileobject.c", 108, "PyUnicode_Check(result)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)result)->state.ready)), 0) ? __assert_rtn(__func__, "fileobject.c", 108, "PyUnicode_IS_READY(result)") : (void)0), ((PyASCIIObject *)(result))->length);
        if (len == 0) {
            do { if ( --((PyObject*)(result))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(result)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(result)))); } while (0);
            result = ((void *)0);
            PyErr_SetString(PyExc_EOFError,
        ...
        else if (((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_Check(result)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)result)->state.ready)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_IS_READY(result)") : (void)0), (Py_UCS4) (((__builtin_expect(!(((((((PyObject*)((result)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_Check((result))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(result))->state.ready)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_IS_READY((result))") : (void)0), ((PyASCIIObject *)((result)))->state.kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(((__builtin_expect(!(((((((PyObject*)((result)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_Check((result))") : (void)0), (((PyASCIIObject*)((result)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((result)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_Check((result))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(result))->state.ready)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_IS_READY((result))") : (void)0), ((PyASCIIObject*)(result))->state.ascii) ? ((void*)((PyASCIIObject*)((result)) + 1)) : ((void*)((PyCompactUnicodeObject*)((result)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((result)))->data.any), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "((PyUnicodeObject*)((result)))->data.any") : (void)0), ((((PyUnicodeObject *)((result)))->data.any))))))[(len-1)] : (((__builtin_expect(!(((((((PyObject*)((result)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_Check((result))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(result))->state.ready)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_IS_READY((result))") : (void)0), ((PyASCIIObject *)((result)))->state.kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(((__builtin_expect(!(((((((PyObject*)((result)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_Check((result))") : (void)0), (((PyASCIIObject*)((result)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((result)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_Check((result))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(result))->state.ready)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_IS_READY((result))") : (void)0), ((PyASCIIObject*)(result))->state.ascii) ? ((void*)((PyASCIIObject*)((result)) + 1)) : ((void*)((PyCompactUnicodeObject*)((result)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((result)))->data.any), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "((PyUnicodeObject*)((result)))->data.any") : (void)0), ((((PyUnicodeObject *)((result)))->data.any))))))[(len-1)] : ((const Py_UCS4 *)(((__builtin_expect(!(((((((PyObject*)((result)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_Check((result))") : (void)0), (((PyASCIIObject*)((result)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((result)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_Check((result))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(result))->state.ready)), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "PyUnicode_IS_READY((result))") : (void)0), ((PyASCIIObject*)(result))->state.ascii) ? ((void*)((PyASCIIObject*)((result)) + 1)) : ((void*)((PyCompactUnicodeObject*)((result)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((result)))->data.any), 0) ? __assert_rtn(__func__, "fileobject.c", 115, "((PyUnicodeObject*)((result)))->data.any") : (void)0), ((((PyUnicodeObject *)((result)))->data.any))))))[(len-1)] ) )) == '\n') {
            PyObject *v;
...
PyFile_WriteObject(PyObject *v, PyObject *f, int flags)
{
    ...
    if (value == ((void *)0)) {
        do { if ( --((PyObject*)(writer))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(writer)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(writer)))); } while (0);
        return -1;
    }
...
PyObject_AsFileDescriptor(PyObject *o)
{
    ...
    else if ((meth = _PyObject_GetAttrId(o, &PyId_fileno)) != ((void *)0))
    {
        PyObject *fno = PyEval_CallObjectWithKeywords(meth, ((void *)0), (PyObject *)((void *)0));
        do { if ( --((PyObject*)(meth))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(meth)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(meth)))); } while (0);
        if (fno == ((void *)0))
            return -1;

        if (((((((PyObject*)(fno))->ob_type))->tp_flags & ((1L<<24))) != 0)) {
            fd = _PyLong_AsInt(fno);
            do { if ( --((PyObject*)(fno))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(fno)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(fno)))); } while (0);
        }
        else {
            PyErr_SetString(PyExc_TypeError,
...
Py_UniversalNewlineFgets(char *buf, int n, FILE *stream, PyObject *fobj)
{
    ...
    flockfile(stream);
    c = 'x';
    while (--n > 0 && (c = (--(stream)->_r < 0 ? __srget(stream) : (int)(*(stream)->_p++))) != (-1) ) {
        if (skipnextlf ) {
            skipnextlf = 0;
            if (c == '\n') {
                ...
                newlinetypes |= 4;
                c = (--(stream)->_r < 0 ? __srget(stream) : (int)(*(stream)->_p++));
                if (c == (-1)) break;
            } else {
...
stdprinter_new(PyTypeObject *type, PyObject *args, PyObject *kews)
{
    ...
    (__builtin_expect(!(type != ((void *)0) && type->tp_alloc != ((void *)0)), 0) ? __assert_rtn(__func__, "fileobject.c", 336, "type != NULL && type->tp_alloc != NULL") : (void)0);
...
PyFile_NewStdPrinter(int fd)
{
    ...
    if (fd != fileno(__stdoutp) && fd != fileno(__stderrp)) {

        return ((void *)0);
    }

    self = ( (PyStdPrinter_Object *) _PyObject_New(&PyStdPrinter_Type) );
...
stdprinter_write(PyStdPrinter_Object *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "s", &c)) {
        return ((void *)0);
    }
    n = strlen(c);
...
static PyMethodDef stdprinter_methods[] = {
    {"close", (PyCFunction)stdprinter_noop, 0x0004, ""},
    {"flush", (PyCFunction)stdprinter_noop, 0x0004, ""},
    {"fileno", (PyCFunction)stdprinter_fileno, 0x0004, ""},
    {"isatty", (PyCFunction)stdprinter_isatty, 0x0004, ""},
    {"write", (PyCFunction)stdprinter_write, 0x0001, ""},
    {((void *)0), ((void *)0)}
};
...
static PyGetSetDef stdprinter_getsetlist[] = {
    {"closed", (getter)get_closed, ((void *)0), "True if the file is closed"},
    {"encoding", (getter)get_encoding, ((void *)0), "Encoding of the file"},
    {"mode", (getter)get_mode, ((void *)0), "String giving the file mode"},
    {0},
};
