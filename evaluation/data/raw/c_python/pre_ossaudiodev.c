...
newossobject(PyObject *arg)
{
    ...
    if ((fd = open(devicename, imode|0x0004)) == -1) {
    ...
    if ((self = ( (oss_audio_t *) _PyObject_New(&OSSAudioType) )) == ((void *)0)) {
        close(fd);
        return ((void *)0);
    }
...
newossmixerobject(PyObject *arg)
{
    ...
    if ((fd = open(devicename, 0x0002)) == -1) {
        PyErr_SetFromErrnoWithFilename(PyExc_IOError, devicename);
        return ((void *)0);
    }

    if ((self = ( (oss_mixer_t *) _PyObject_New(&OSSMixerType) )) == ((void *)0)) {
        close(fd);
        return ((void *)0);
    }
...
_do_ioctl_1(int fd, PyObject *args, char *fname, int cmd)
{
    ...
    (__builtin_expect(!(strlen(fname) <= 30), 0) ? __assert_rtn(__func__, "ossaudiodev.c", 247, "strlen(fname) <= 30") : (void)0);
    ((__builtin_object_size (argfmt, 0) != (size_t) -1) ? __builtin___strcat_chk (argfmt, fname, __builtin_object_size (argfmt, 2 > 1)) : __inline_strcat_chk (argfmt, fname));
...
_do_ioctl_1_internal(int fd, PyObject *args, char *fname, int cmd)
{
    ...
    (__builtin_expect(!(strlen(fname) <= 30), 0) ? __assert_rtn(__func__, "ossaudiodev.c", 272, "strlen(fname) <= 30") : (void)0);
    ((__builtin_object_size (argfmt, 0) != (size_t) -1) ? __builtin___strcat_chk (argfmt, fname, __builtin_object_size (argfmt, 2 > 1)) : __inline_strcat_chk (argfmt, fname));
    if (!PyArg_ParseTuple(args, argfmt, &arg))
        return ((void *)0);
...
_do_ioctl_0(int fd, PyObject *args, char *fname, int cmd)
{
    ...
    (__builtin_expect(!(strlen(fname) <= 30), 0) ? __assert_rtn(__func__, "ossaudiodev.c", 292, "strlen(fname) <= 30") : (void)0);
    ((__builtin_object_size (argfmt, 0) != (size_t) -1) ? __builtin___strcat_chk (argfmt, fname, __builtin_object_size (argfmt, 2 > 1)) : __inline_strcat_chk (argfmt, fname));
...
oss_nonblock(oss_audio_t *self, PyObject *unused)
{
    ...
    if (ioctl(self->fd, SNDCTL_DSP_NONBLOCK, ((void *)0)) == -1)
        return PyErr_SetFromErrno(PyExc_IOError);
    ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++);
    return (&_Py_NoneStruct);
}
...
oss_read(oss_audio_t *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "i:read", &size))
        return ((void *)0);
    rv = PyBytes_FromStringAndSize(((void *)0), size);
    if (rv == ((void *)0))
        return ((void *)0);
    cp = ((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "ossaudiodev.c", 416, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval));
...
# 472 "ossaudiodev.c"
    ...
    __builtin_bzero(&write_set_fds, sizeof(*(&write_set_fds)));
    do { int __fd = (self->fd); ((&write_set_fds)->fds_bits[__fd/(sizeof(__int32_t) * 8)] |= (1<<(__fd % (sizeof(__int32_t) * 8)))); } while(0);

    while (size > 0) {
        { PyThreadState *_save; _save = PyEval_SaveThread();
        select_rv = select(self->fd+1, ((void *)0), &write_set_fds, ((void *)0), ((void *)0));
        PyEval_RestoreThread(_save); }
        (__builtin_expect(!(select_rv != 0), 0) ? __assert_rtn(__func__, "ossaudiodev.c", 491, "select_rv != 0") : (void)0);
        if (select_rv == -1)
            return PyErr_SetFromErrno(PyExc_IOError);
...
{
    static _Py_Identifier PyId_close = { 0, "close", 0 };

    PyObject *ret = _PyObject_CallMethodId(self, &PyId_close, ((void *)0));
    if (!ret)
        return ((void *)0);
...
oss_setparameters(oss_audio_t *self, PyObject *args)
{
    ...
    if (rv == ((void *)0))
        return ((void *)0);
    (((PyTupleObject *)(rv))->ob_item[0] = PyLong_FromLong(fmt));
    (((PyTupleObject *)(rv))->ob_item[1] = PyLong_FromLong(channels));
    (((PyTupleObject *)(rv))->ob_item[2] = PyLong_FromLong(rate));
    return rv;
}
...
static PyMethodDef oss_methods[] = {
    ...
    { "read", (PyCFunction)oss_read, 0x0001 },
    { "write", (PyCFunction)oss_write, 0x0001 },
    { "writeall", (PyCFunction)oss_writeall, 0x0001 },
    { "close", (PyCFunction)oss_close, 0x0004 },
    { "fileno", (PyCFunction)oss_fileno, 0x0004 },


    { "nonblock", (PyCFunction)oss_nonblock, 0x0004 },
    { "setfmt", (PyCFunction)oss_setfmt, 0x0001 },
    { "getfmts", (PyCFunction)oss_getfmts, 0x0004 },
    { "channels", (PyCFunction)oss_channels, 0x0001 },
    { "speed", (PyCFunction)oss_speed, 0x0001 },
    { "sync", (PyCFunction)oss_sync, 0x0001 },
    { "reset", (PyCFunction)oss_reset, 0x0001 },
    { "post", (PyCFunction)oss_post, 0x0001 },


    { "setparameters", (PyCFunction)oss_setparameters, 0x0001 },
    { "bufsize", (PyCFunction)oss_bufsize, 0x0004 },
    { "obufcount", (PyCFunction)oss_obufcount, 0x0004 },
    { "obuffree", (PyCFunction)oss_obuffree, 0x0004 },
    { "getptr", (PyCFunction)oss_getptr, 0x0004 },


    { "flush", (PyCFunction)oss_sync, 0x0001 },


    { "__enter__", oss_self, 0x0004 },
    { "__exit__", oss_exit, 0x0001 },
...
static PyMethodDef oss_mixer_methods[] = {
    ...
    { "close", (PyCFunction)oss_mixer_close, 0x0004 },
    { "fileno", (PyCFunction)oss_mixer_fileno, 0x0004 },
    ...
    { "controls", (PyCFunction)oss_mixer_controls, 0x0001 },
    { "stereocontrols", (PyCFunction)oss_mixer_stereocontrols, 0x0001},
    { "reccontrols", (PyCFunction)oss_mixer_reccontrols, 0x0001},
    { "get", (PyCFunction)oss_mixer_get, 0x0001 },
    { "set", (PyCFunction)oss_mixer_set, 0x0001 },
    { "get_recsrc", (PyCFunction)oss_mixer_get_recsrc, 0x0001 },
    { "set_recsrc", (PyCFunction)oss_mixer_set_recsrc, 0x0001 },
...
oss_getattro(oss_audio_t *self, PyObject *nameobj)
{
    ...
    if (strcmp(name, "closed") == 0) {
        rval = (self->fd == -1) ? ((PyObject *) &_Py_TrueStruct) : ((PyObject *) &_Py_FalseStruct);
        ( ((PyObject*)(rval))->ob_refcnt++);
    }
...
build_namelists (PyObject *module)
{
    ...
    num_controls = (sizeof(control_labels) / sizeof((control_labels)[0]) + (sizeof(char [1 - 2*!(!__builtin_types_compatible_p(typeof(control_labels), typeof(&(control_labels)[0])))]) - 1));
    (__builtin_expect(!(num_controls == (sizeof(control_names) / sizeof((control_names)[0]) + (sizeof(char [1 - 2*!(!__builtin_types_compatible_p(typeof(control_names), typeof(&(control_names)[0])))]) - 1))), 0) ? __assert_rtn(__func__, "ossaudiodev.c", 1068, "num_controls == Py_ARRAY_LENGTH(control_names)") : (void)0);

    labels = PyList_New(num_controls);
    names = PyList_New(num_controls);
    if (labels == ((void *)0) || names == ((void *)0))
        goto error2;
    for (i = 0; i < num_controls; i++) {
        s = PyUnicode_FromString(control_labels[i]);
        if (s == ((void *)0))
            goto error2;
        (((PyListObject *)(labels))->ob_item[i] = (s));

        s = PyUnicode_FromString(control_names[i]);
        if (s == ((void *)0))
            goto error2;
        (((PyListObject *)(names))->ob_item[i] = (s));
    }
...
error2:
    do { if ((labels) == ((void *)0)) ; else do { if ( --((PyObject*)(labels))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(labels)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(labels)))); } while (0); } while (0);
error1:
...
PyInit_ossaudiodev(void)
{
    ...
    m = PyModule_Create2(&ossaudiodevmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    ...
    if (OSSAudioError) {
        ...
        ( ((PyObject*)(OSSAudioError))->ob_refcnt++);
        ( ((PyObject*)(OSSAudioError))->ob_refcnt++);
    ...
    if (PyModule_AddIntConstant(m, "AFMT_QUERY", (long) (AFMT_QUERY)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "AFMT_MU_LAW", (long) (AFMT_MU_LAW)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "AFMT_A_LAW", (long) (AFMT_A_LAW)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "AFMT_IMA_ADPCM", (long) (AFMT_IMA_ADPCM)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "AFMT_U8", (long) (AFMT_U8)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "AFMT_S16_LE", (long) (AFMT_S16_LE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "AFMT_S16_BE", (long) (AFMT_S16_BE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "AFMT_S8", (long) (AFMT_S8)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "AFMT_U16_LE", (long) (AFMT_U16_LE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "AFMT_U16_BE", (long) (AFMT_U16_BE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "AFMT_MPEG", (long) (AFMT_MPEG)) == -1) return ((void *)0);;
# 1175 "ossaudiodev.c"
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_NRDEVICES", (long) (SOUND_MIXER_NRDEVICES)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_VOLUME", (long) (SOUND_MIXER_VOLUME)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_BASS", (long) (SOUND_MIXER_BASS)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_TREBLE", (long) (SOUND_MIXER_TREBLE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_SYNTH", (long) (SOUND_MIXER_SYNTH)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_PCM", (long) (SOUND_MIXER_PCM)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_SPEAKER", (long) (SOUND_MIXER_SPEAKER)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_LINE", (long) (SOUND_MIXER_LINE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_MIC", (long) (SOUND_MIXER_MIC)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_CD", (long) (SOUND_MIXER_CD)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_IMIX", (long) (SOUND_MIXER_IMIX)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_ALTPCM", (long) (SOUND_MIXER_ALTPCM)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_RECLEV", (long) (SOUND_MIXER_RECLEV)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_IGAIN", (long) (SOUND_MIXER_IGAIN)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_OGAIN", (long) (SOUND_MIXER_OGAIN)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_LINE1", (long) (SOUND_MIXER_LINE1)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_LINE2", (long) (SOUND_MIXER_LINE2)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SOUND_MIXER_LINE3", (long) (SOUND_MIXER_LINE3)) == -1) return ((void *)0);;
# 1220 "ossaudiodev.c"
    if (PyModule_AddIntConstant(m, "SNDCTL_COPR_HALT", (long) (SNDCTL_COPR_HALT)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_COPR_LOAD", (long) (SNDCTL_COPR_LOAD)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_COPR_RCODE", (long) (SNDCTL_COPR_RCODE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_COPR_RCVMSG", (long) (SNDCTL_COPR_RCVMSG)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_COPR_RDATA", (long) (SNDCTL_COPR_RDATA)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_COPR_RESET", (long) (SNDCTL_COPR_RESET)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_COPR_RUN", (long) (SNDCTL_COPR_RUN)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_COPR_SENDMSG", (long) (SNDCTL_COPR_SENDMSG)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_COPR_WCODE", (long) (SNDCTL_COPR_WCODE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_COPR_WDATA", (long) (SNDCTL_COPR_WDATA)) == -1) return ((void *)0);;



    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_CHANNELS", (long) (SNDCTL_DSP_CHANNELS)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_GETBLKSIZE", (long) (SNDCTL_DSP_GETBLKSIZE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_GETCAPS", (long) (SNDCTL_DSP_GETCAPS)) == -1) return ((void *)0);;



    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_GETFMTS", (long) (SNDCTL_DSP_GETFMTS)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_GETIPTR", (long) (SNDCTL_DSP_GETIPTR)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_GETISPACE", (long) (SNDCTL_DSP_GETISPACE)) == -1) return ((void *)0);;



    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_GETOPTR", (long) (SNDCTL_DSP_GETOPTR)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_GETOSPACE", (long) (SNDCTL_DSP_GETOSPACE)) == -1) return ((void *)0);;



    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_GETTRIGGER", (long) (SNDCTL_DSP_GETTRIGGER)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_MAPINBUF", (long) (SNDCTL_DSP_MAPINBUF)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_MAPOUTBUF", (long) (SNDCTL_DSP_MAPOUTBUF)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_NONBLOCK", (long) (SNDCTL_DSP_NONBLOCK)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_POST", (long) (SNDCTL_DSP_POST)) == -1) return ((void *)0);;



    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_RESET", (long) (SNDCTL_DSP_RESET)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_SAMPLESIZE", (long) (SNDCTL_DSP_SAMPLESIZE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_SETDUPLEX", (long) (SNDCTL_DSP_SETDUPLEX)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_SETFMT", (long) (SNDCTL_DSP_SETFMT)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_SETFRAGMENT", (long) (SNDCTL_DSP_SETFRAGMENT)) == -1) return ((void *)0);;



    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_SETSYNCRO", (long) (SNDCTL_DSP_SETSYNCRO)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_SETTRIGGER", (long) (SNDCTL_DSP_SETTRIGGER)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_SPEED", (long) (SNDCTL_DSP_SPEED)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_STEREO", (long) (SNDCTL_DSP_STEREO)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_SUBDIVIDE", (long) (SNDCTL_DSP_SUBDIVIDE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_DSP_SYNC", (long) (SNDCTL_DSP_SYNC)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_FM_4OP_ENABLE", (long) (SNDCTL_FM_4OP_ENABLE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_FM_LOAD_INSTR", (long) (SNDCTL_FM_LOAD_INSTR)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_MIDI_INFO", (long) (SNDCTL_MIDI_INFO)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_MIDI_MPUCMD", (long) (SNDCTL_MIDI_MPUCMD)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_MIDI_MPUMODE", (long) (SNDCTL_MIDI_MPUMODE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_MIDI_PRETIME", (long) (SNDCTL_MIDI_PRETIME)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_SEQ_CTRLRATE", (long) (SNDCTL_SEQ_CTRLRATE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_SEQ_GETINCOUNT", (long) (SNDCTL_SEQ_GETINCOUNT)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_SEQ_GETOUTCOUNT", (long) (SNDCTL_SEQ_GETOUTCOUNT)) == -1) return ((void *)0);;



    if (PyModule_AddIntConstant(m, "SNDCTL_SEQ_NRMIDIS", (long) (SNDCTL_SEQ_NRMIDIS)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_SEQ_NRSYNTHS", (long) (SNDCTL_SEQ_NRSYNTHS)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_SEQ_OUTOFBAND", (long) (SNDCTL_SEQ_OUTOFBAND)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_SEQ_PANIC", (long) (SNDCTL_SEQ_PANIC)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_SEQ_PERCMODE", (long) (SNDCTL_SEQ_PERCMODE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_SEQ_RESET", (long) (SNDCTL_SEQ_RESET)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_SEQ_RESETSAMPLES", (long) (SNDCTL_SEQ_RESETSAMPLES)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_SEQ_SYNC", (long) (SNDCTL_SEQ_SYNC)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_SEQ_TESTMIDI", (long) (SNDCTL_SEQ_TESTMIDI)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_SEQ_THRESHOLD", (long) (SNDCTL_SEQ_THRESHOLD)) == -1) return ((void *)0);;
    ...
    if (PyModule_AddIntConstant(m, "SNDCTL_SYNTH_INFO", (long) (SNDCTL_SYNTH_INFO)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_SYNTH_MEMAVL", (long) (SNDCTL_SYNTH_MEMAVL)) == -1) return ((void *)0);;



    if (PyModule_AddIntConstant(m, "SNDCTL_TMR_CONTINUE", (long) (SNDCTL_TMR_CONTINUE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_TMR_METRONOME", (long) (SNDCTL_TMR_METRONOME)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_TMR_SELECT", (long) (SNDCTL_TMR_SELECT)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_TMR_SOURCE", (long) (SNDCTL_TMR_SOURCE)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_TMR_START", (long) (SNDCTL_TMR_START)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_TMR_STOP", (long) (SNDCTL_TMR_STOP)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_TMR_TEMPO", (long) (SNDCTL_TMR_TEMPO)) == -1) return ((void *)0);;
    if (PyModule_AddIntConstant(m, "SNDCTL_TMR_TIMEBASE", (long) (SNDCTL_TMR_TIMEBASE)) == -1) return ((void *)0);;
    return m;
}
