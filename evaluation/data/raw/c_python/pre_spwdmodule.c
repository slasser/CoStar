...
{
    PyObject *m;
    m=PyModule_Create2(&spwdmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    if (!initialized)
        PyStructSequence_InitType(&StructSpwdType,
                                  &struct_spwd_type_desc);
    ( ((PyObject*)((PyObject *) &StructSpwdType))->ob_refcnt++);
