...
enum_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    if (start != ((void *)0)) {
        ...
        if (start == ((void *)0)) {
            do { if ( --((PyObject*)(en))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(en)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(en)))); } while (0);
            return ((void *)0);
        }
        (__builtin_expect(!(((((((PyObject*)(start))->ob_type))->tp_flags & ((1L<<24))) != 0)), 0) ? __assert_rtn(__func__, "enumobject.c", 34, "PyLong_Check(start)") : (void)0);
        en->en_index = PyLong_AsSsize_t(start);
        if (en->en_index == -1 && PyErr_Occurred()) {
            PyErr_Clear();
            en->en_index = ((Py_ssize_t)(((size_t)-1)>>1));
            en->en_longindex = start;
        } else {
            en->en_longindex = ((void *)0);
    ...
    en->en_result = PyTuple_Pack(2, (&_Py_NoneStruct), (&_Py_NoneStruct));
    if (en->en_result == ((void *)0)) {
        do { if ( --((PyObject*)(en))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(en)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(en)))); } while (0);
        return ((void *)0);
    }
    return (PyObject *)en;
...
enum_dealloc(enumobject *en)
{
    ...
    do { if ((en->en_sit) == ((void *)0)) ; else do { if ( --((PyObject*)(en->en_sit))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(en->en_sit)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(en->en_sit)))); } while (0); } while (0);
    do { if ((en->en_result) == ((void *)0)) ; else do { if ( --((PyObject*)(en->en_result))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(en->en_result)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(en->en_result)))); } while (0); } while (0);
    do { if ((en->en_longindex) == ((void *)0)) ; else do { if ( --((PyObject*)(en->en_longindex))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(en->en_longindex)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(en->en_longindex)))); } while (0); } while (0);
    (((PyObject*)(en))->ob_type)->tp_free(en);
}

static int
enum_traverse(enumobject *en, visitproc visit, void *arg)
{
    do { if (en->en_sit) { int vret = visit((PyObject *)(en->en_sit), arg); if (vret) return vret; } } while (0);
    do { if (en->en_result) { int vret = visit((PyObject *)(en->en_result), arg); if (vret) return vret; } } while (0);
    do { if (en->en_longindex) { int vret = visit((PyObject *)(en->en_longindex), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
{
    static PyObject *one = ((void *)0);
    PyObject *result = en->en_result;
    PyObject *next_index;
    PyObject *stepped_up;

    if (en->en_longindex == ((void *)0)) {
        en->en_longindex = PyLong_FromSsize_t(((Py_ssize_t)(((size_t)-1)>>1)));
        if (en->en_longindex == ((void *)0))
            return ((void *)0);
    }
    if (one == ((void *)0)) {
    ...
    (__builtin_expect(!(next_index != ((void *)0)), 0) ? __assert_rtn(__func__, "enumobject.c", 99, "next_index != NULL") : (void)0);
    ...
    if (result->ob_refcnt == 1) {
        ...
        if (result == ((void *)0)) {
            do { if ( --((PyObject*)(next_index))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(next_index)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(next_index)))); } while (0);
            do { if ( --((PyObject*)(next_item))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(next_item)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(next_item)))); } while (0);
            return ((void *)0);
        }
    }
    (((PyTupleObject *)(result))->ob_item[0] = next_index);
    (((PyTupleObject *)(result))->ob_item[1] = next_item);
    return result;
}
...
enum_next(enumobject *en)
{
    ...
    next_item = (*(((PyObject*)(it))->ob_type)->tp_iternext)(it);
    if (next_item == ((void *)0))
        return ((void *)0);

    if (en->en_index == ((Py_ssize_t)(((size_t)-1)>>1)))
...
{
    if (en->en_longindex != ((void *)0))
        return Py_BuildValue("O(OO)", (((PyObject*)(en))->ob_type), en->en_sit, en->en_longindex);
    else
        return Py_BuildValue("O(On)", (((PyObject*)(en))->ob_type), en->en_sit, en->en_index);
}

static char reduce_doc[] = "Return state information for pickling.";

static PyMethodDef enum_methods[] = {
    {"__reduce__", (PyCFunction)enum_reduce, 0x0004, reduce_doc},
    {((void *)0), ((void *)0)}
};

static char enum_doc[] = "enumerate(iterable[, start]) -> iterator for index, value of iterable\n" "\n" "Return an enumerate object.  iterable must be another object that supports\n" "iteration.  The enumerate object yields pairs containing a count (from\n" "start, which defaults to zero) and a value yielded by the iterable argument.\n" "enumerate is useful for obtaining an indexed list:\n" "    (0, seq[0]), (1, seq[1]), (2, seq[2]), ...";
# 186 "enumobject.c"
...
reversed_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    reversedobject *ro;
    static _Py_Identifier PyId___reversed__ = { 0, "__reversed__", 0 };
    ...
    if (reversed_meth != ((void *)0)) {
        PyObject *res = PyObject_CallFunctionObjArgs(reversed_meth, ((void *)0));
        do { if ( --((PyObject*)(reversed_meth))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(reversed_meth)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(reversed_meth)))); } while (0);
        return res;
    }
...
reversed_dealloc(reversedobject *ro)
{
    ...
    do { if ((ro->seq) == ((void *)0)) ; else do { if ( --((PyObject*)(ro->seq))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ro->seq)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ro->seq)))); } while (0); } while (0);
...
{
    do { if (ro->seq) { int vret = visit((PyObject *)(ro->seq), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
reversed_next(reversedobject *ro)
{
    ...
    ro->index = -1;
    do { if (ro->seq) { PyObject *_py_tmp = (PyObject *)(ro->seq); (ro->seq) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    return ((void *)0);
}

static char reversed_doc[] = "reversed(sequence) -> reverse iterator over values of the sequence\n" "\n" "Return a reverse iterator";
...
{
    if (ro->seq)
        return Py_BuildValue("O(O)n", (((PyObject*)(ro))->ob_type), ro->seq, ro->index);
    else
        return Py_BuildValue("O(())", (((PyObject*)(ro))->ob_type));
}
...
static PyMethodDef reversediter_methods[] = {
    {"__length_hint__", (PyCFunction)reversed_len, 0x0004, length_hint_doc},
    {"__reduce__", (PyCFunction)reversed_reduce, 0x0004, reduce_doc},
    {"__setstate__", (PyCFunction)reversed_setstate, 0x0008, setstate_doc},
    {((void *)0), ((void *)0)}
};
