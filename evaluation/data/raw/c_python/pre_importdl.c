...
_PyImport_LoadDynamicModule(PyObject *name, PyObject *path, FILE *fp)
{
    ...
    nameascii = PyUnicode_AsEncodedString(name, "ascii", ((void *)0));
    if (nameascii == ((void *)0))
        return ((void *)0);

    namestr = ((__builtin_expect(!(((((((PyObject*)(nameascii))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "importdl.c", 49, "PyBytes_Check(nameascii)") : (void)0), (((PyBytesObject *)(nameascii))->ob_sval));
    if (namestr == ((void *)0))
        goto error;

    lastdot = strrchr(namestr, '.');
    if (lastdot == ((void *)0)) {
        packagecontext = ((void *)0);
        shortname = namestr;
    }
    else {
    ...
    p0 = _PyImport_GetDynLoadFunc(shortname,
                                  ((__builtin_expect(!(((((((PyObject*)(pathbytes))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "importdl.c", 70, "PyBytes_Check(pathbytes)") : (void)0), (((PyBytesObject *)(pathbytes))->ob_sval)), fp);
    ...
    if (_PyImport_FixupExtensionObject(m, name, path) < 0)
        goto error;
    do { if ( --((PyObject*)(nameascii))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(nameascii)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(nameascii)))); } while (0);
    return m;
