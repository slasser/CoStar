...
# 7 "resource.c" 2
# 21 "resource.c"
static char struct_rusage__doc__[] = "struct_rusage: Result from getrusage.\n\n" "This object may be accessed either as a tuple of\n" "    (utime,stime,maxrss,ixrss,idrss,isrss,minflt,majflt,\n" "    nswap,inblock,oublock,msgsnd,msgrcv,nsignals,nvcsw,nivcsw)\n" "or via the attributes ru_utime, ru_stime, ru_maxrss, and so on.";
...
resource_setrlimit(PyObject *self, PyObject *args)
{
    ...
    if ((((PyVarObject*)(limits))->ob_size) != 2) {
        PyErr_SetString(PyExc_ValueError,
                        "expected a tuple of 2 integers");
        goto error;
    }
    curobj = (((PyTupleObject *)(limits))->ob_item[0]);
    maxobj = (((PyTupleObject *)(limits))->ob_item[1]);
    ...
    if (rl.rlim_max == (rlim_t)-1 && PyErr_Occurred())
        goto error;
# 186 "resource.c"
    rl.rlim_cur = rl.rlim_cur & (((__uint64_t)1 << 63) - 1);
    rl.rlim_max = rl.rlim_max & (((__uint64_t)1 << 63) - 1);
    ...
    do { if ( --((PyObject*)(limits))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(limits)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(limits)))); } while (0);
...
resource_methods[] = {
    {"getrusage", resource_getrusage, 0x0001},
    {"getrlimit", resource_getrlimit, 0x0001},
    {"setrlimit", resource_setrlimit, 0x0001},
    {"getpagesize", resource_getpagesize, 0x0004},
    {((void *)0), ((void *)0)}
};
...
PyInit_resource(void)
{
    ...
    m = PyModule_Create2(&resourcemodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    ...
    if (!initialized)
        PyStructSequence_InitType(&StructRUsageType,
                                  &struct_rusage_desc);
    ( ((PyObject*)(&StructRUsageType))->ob_refcnt++);
    PyModule_AddObject(m, "struct_rusage",
                       (PyObject*) &StructRUsageType);



    PyModule_AddIntConstant(m, "RLIMIT_CPU", 0);



    PyModule_AddIntConstant(m, "RLIMIT_FSIZE", 1);



    PyModule_AddIntConstant(m, "RLIMIT_DATA", 2);



    PyModule_AddIntConstant(m, "RLIMIT_STACK", 3);



    PyModule_AddIntConstant(m, "RLIMIT_CORE", 4);



    PyModule_AddIntConstant(m, "RLIMIT_NOFILE", 8);
# 307 "resource.c"
    PyModule_AddIntConstant(m, "RLIMIT_AS", 5);



    PyModule_AddIntConstant(m, "RLIMIT_RSS", 5);



    PyModule_AddIntConstant(m, "RLIMIT_NPROC", 7);



    PyModule_AddIntConstant(m, "RLIMIT_MEMLOCK", 6);
    ...
    PyModule_AddIntConstant(m, "RUSAGE_SELF", 0);



    PyModule_AddIntConstant(m, "RUSAGE_CHILDREN", -1);
# 343 "resource.c"
    if (sizeof((((__uint64_t)1 << 63) - 1)) > sizeof(long)) {
        v = PyLong_FromLongLong((long long) (((__uint64_t)1 << 63) - 1));
    } else

    {
        v = PyLong_FromLong((long) (((__uint64_t)1 << 63) - 1));
    }
    if (v) {
