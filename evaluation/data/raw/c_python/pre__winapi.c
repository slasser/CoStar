...
check_CancelIoEx()
{
    if (has_CancelIoEx == -1)
    {
        ...
        * (FARPROC *) &Py_CancelIoEx = GetProcAddress(hKernel32,
                                                      "CancelIoEx");
        has_CancelIoEx = (Py_CancelIoEx != ((void *)0));
    }
...
overlapped_dealloc(OverlappedObject *self)
{
    ...
    do { if (self->read_buffer) { PyObject *_py_tmp = (PyObject *)(self->read_buffer); (self->read_buffer) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    PyObject_Free(self);
}
...
overlapped_GetOverlappedResult(OverlappedObject *self, PyObject *waitobj)
{
    ...
    if (self->completed && self->read_buffer != ((void *)0)) {
        (__builtin_expect(!(((((PyObject*)(self->read_buffer))->ob_type) == &PyBytes_Type)), 0) ? __assert_rtn(__func__, "_winapi.c", 158, "PyBytes_CheckExact(self->read_buffer)") : (void)0);
        if (transferred != ((__builtin_expect(!(((((((PyObject*)(self->read_buffer))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_winapi.c", 159, "PyBytes_Check(self->read_buffer)") : (void)0),(((PyVarObject*)(self->read_buffer))->ob_size)) &&
...
overlapped_getbuffer(OverlappedObject *self)
{
    ...
    res = self->read_buffer ? self->read_buffer : (&_Py_NoneStruct);
...
static PyMethodDef overlapped_methods[] = {
    {"GetOverlappedResult", (PyCFunction) overlapped_GetOverlappedResult,
                            0x0008, ((void *)0)},
    {"getbuffer", (PyCFunction) overlapped_getbuffer, 0x0004, ((void *)0)},
    {"cancel", (PyCFunction) overlapped_cancel, 0x0004, ((void *)0)},
    {((void *)0)}
};

static PyMemberDef overlapped_members[] = {
    {"event", 18,
     __builtin_offsetof (OverlappedObject, overlapped) + __builtin_offsetof (OVERLAPPED, hEvent),
     1, "overlapped event handle"},
    {((void *)0)}
};
...
PyTypeObject OverlappedType = {
    { { 1, ((void *)0) }, 0 },
                            "_winapi.Overlapped",
                            sizeof(OverlappedObject),
                            0,
                            (destructor) overlapped_dealloc,
                            0,
                            0,
                            0,
                            0,
...
new_overlapped(HANDLE handle)
{
    ...
    self = ( (OverlappedObject *) _PyObject_New(&OverlappedType) );
    if (!self)
        return ((void *)0);
    self->handle = handle;
    self->read_buffer = ((void *)0);
    self->pending = 0;
    self->completed = 0;
    ((__builtin_object_size (&self->overlapped, 0) != (size_t) -1) ? __builtin___memset_chk (&self->overlapped, 0, sizeof(OVERLAPPED), __builtin_object_size (&self->overlapped, 0)) : __inline_memset_chk (&self->overlapped, 0, sizeof(OVERLAPPED)));
    ((__builtin_object_size (&self->write_buffer, 0) != (size_t) -1) ? __builtin___memset_chk (&self->write_buffer, 0, sizeof(Py_buffer), __builtin_object_size (&self->write_buffer, 0)) : __inline_memset_chk (&self->write_buffer, 0, sizeof(Py_buffer)));

    self->overlapped.hEvent = CreateEvent(((void *)0), TRUE, FALSE, ((void *)0));
    return self;
}
...
static char CloseHandle_doc[] = "CloseHandle(handle) -> None\n\nClose handle.";
...
winapi_CloseHandle(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "K" ":CloseHandle", &hObject))
        return ((void *)0);
...
winapi_ConnectNamedPipe(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    BOOL success;
    OverlappedObject *overlapped = ((void *)0);
    static char *kwlist[] = {"handle", "overlapped", ((void *)0)};
    ...
    success = ConnectNamedPipe(hNamedPipe,
                               overlapped ? &overlapped->overlapped : ((void *)0));
    PyEval_RestoreThread(_save); }

    if (overlapped) {
        int err = GetLastError();

        (__builtin_expect(!(success == 0), 0) ? __assert_rtn(__func__, "_winapi.c", 332, "success == 0") : (void)0);
        if (err == ERROR_IO_PENDING)
            overlapped->pending = 1;
        else if (err == ERROR_PIPE_CONNECTED)
            SetEvent(overlapped->overlapped.hEvent);
        else {
            do { if ( --((PyObject*)(overlapped))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(overlapped)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(overlapped)))); } while (0);
...
winapi_CreateFile(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "s" "k" "k" "K"
                          "k" "k" "K",
...
static char CreatePipe_doc[] = "CreatePipe(pipe_attrs, size) -> (read_handle, write_handle)\n\nCreate an anonymous pipe, and return handles to the read and\nwrite ends of the pipe.\n\npipe_attrs is ignored internally and can be None.";
...
winapi_CreatePipe(PyObject* self, PyObject* args)
{
    ...
    if (! PyArg_ParseTuple(args, "O" "k" ":CreatePipe",
                           &pipe_attributes, &size))
        return ((void *)0);

    { PyThreadState *_save; _save = PyEval_SaveThread();
    result = CreatePipe(&read_pipe, &write_pipe, ((void *)0), size);
    PyEval_RestoreThread(_save); }
    ...
    return Py_BuildValue(
        "NN", PyLong_FromUnsignedLongLong((unsigned long long) read_pipe), PyLong_FromUnsignedLongLong((unsigned long long) write_pipe));
}
...
gethandle(PyObject* obj, char* name)
{
    ...
    if (value == (&_Py_NoneStruct))
        ...
        ret = ((HANDLE)PyLong_AsUnsignedLongLong(value));
    do { if ( --((PyObject*)(value))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(value)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(value)))); } while (0);
    return ret;
}
...
getenvironment(PyObject* environment)
{
    ...
    envsize = PyMapping_Size(environment);
    ...
    totalsize = 1;
    for (i = 0; i < envsize; i++) {
        PyObject* key = (((PyListObject *)(keys))->ob_item[i]);
        PyObject* value = (((PyListObject *)(values))->ob_item[i]);

        if (! ((((((PyObject*)(key))->ob_type))->tp_flags & ((1L<<28))) != 0) || ! ((((((PyObject*)(value))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
            PyErr_SetString(PyExc_TypeError,
                "environment can only contain strings");
            goto error;
        }
        totalsize += ((__builtin_expect(!(((((((PyObject*)(key))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_winapi.c", 516, "PyUnicode_Check(key)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)key)->state.ready)), 0) ? __assert_rtn(__func__, "_winapi.c", 516, "PyUnicode_IS_READY(key)") : (void)0), ((PyASCIIObject *)(key))->length) + 1;
        totalsize += ((__builtin_expect(!(((((((PyObject*)(value))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_winapi.c", 517, "PyUnicode_Check(value)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)value)->state.ready)), 0) ? __assert_rtn(__func__, "_winapi.c", 517, "PyUnicode_IS_READY(value)") : (void)0), ((PyASCIIObject *)(value))->length) + 1;
    }
    ...
    for (i = 0; i < envsize; i++) {
        ...
        if (!PyUnicode_AsUCS4(key, p, end - p, 0))
            goto error;
        p += ((__builtin_expect(!(((((((PyObject*)(key))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_winapi.c", 531, "PyUnicode_Check(key)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)key)->state.ready)), 0) ? __assert_rtn(__func__, "_winapi.c", 531, "PyUnicode_IS_READY(key)") : (void)0), ((PyASCIIObject *)(key))->length);
        *p++ = '=';
        if (!PyUnicode_AsUCS4(value, p, end - p, 0))
            goto error;
        p += ((__builtin_expect(!(((((((PyObject*)(value))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_winapi.c", 535, "PyUnicode_Check(value)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)value)->state.ready)), 0) ? __assert_rtn(__func__, "_winapi.c", 535, "PyUnicode_IS_READY(value)") : (void)0), ((PyASCIIObject *)(value))->length);
        *p++ = '\0';
    }


    *p++ = '\0';
    (__builtin_expect(!(p == end), 0) ? __assert_rtn(__func__, "_winapi.c", 541, "p == end") : (void)0);
...
winapi_CreateProcess(PyObject* self, PyObject* args)
{
    ...
    if (! PyArg_ParseTuple(args, "ZZOO" "i" "k" "OZO:CreateProcess",
                           &application_name,
                           &command_line,
                           &process_attributes,
                           &thread_attributes,
    ...
    if (env_mapping != (&_Py_NoneStruct)) {
        environment = getenvironment(env_mapping);
        if (! environment)
            return ((void *)0);
        wenvironment = PyUnicode_AsUnicode(environment);
        if (wenvironment == ((void *)0))
        {
            do { if ((environment) == ((void *)0)) ; else do { if ( --((PyObject*)(environment))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(environment)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(environment)))); } while (0); } while (0);
            return ((void *)0);
        }
    }
    else {
    ...
    return Py_BuildValue("NNkk",
                         PyLong_FromUnsignedLongLong((unsigned long long) pi.hProcess),
                         PyLong_FromUnsignedLongLong((unsigned long long) pi.hThread),
                         pi.dwProcessId,
                         pi.dwThreadId);
}

static char DuplicateHandle_doc[] = "DuplicateHandle(source_proc_handle, source_handle,\n                 target_proc_handle, target_handle, access,\n                 inherit[, options]) -> handle\n\nReturn a duplicate handle object.\n\nThe duplicate handle refers to the same object as the original\nhandle. Therefore, any changes to the object are reflected\nthrough both handles.";
# 664 "_winapi.c"
static PyObject *
winapi_DuplicateHandle(PyObject* self, PyObject* args)
{
    ...
    return PyLong_FromUnsignedLongLong((unsigned long long) target_handle);
}
...
static char GetCurrentProcess_doc[] = "GetCurrentProcess() -> handle\n\nReturn a handle object for the current process.";
...
winapi_GetCurrentProcess(PyObject* self, PyObject* args)
{
    ...
    return PyLong_FromUnsignedLongLong((unsigned long long) GetCurrentProcess());
}

static char GetExitCodeProcess_doc[] = "GetExitCodeProcess(handle) -> Exit code\n\nReturn the termination status of the specified process.";
...
winapi_GetExitCodeProcess(PyObject* self, PyObject* args)
{
    ...
    HANDLE process;
    if (! PyArg_ParseTuple(args, "K" ":GetExitCodeProcess", &process))
        return ((void *)0);
...
{
    return Py_BuildValue("k", GetLastError());
}

static char GetModuleFileName_doc[] = "GetModuleFileName(module) -> path\n\nReturn the fully-qualified path for the file that contains\nthe specified module. The module must have been loaded by the\ncurrent process.\n\nThe module parameter should be a handle to the loaded module\nwhose path is being requested. If this parameter is 0, \nGetModuleFileName retrieves the path of the executable file\nof the current process.";
# 780 "_winapi.c"
static PyObject *
winapi_GetModuleFileName(PyObject* self, PyObject* args)
{
    ...
    if (! PyArg_ParseTuple(args, "K" ":GetModuleFileName",
                           &module))
        return ((void *)0);
...
static char GetStdHandle_doc[] = "GetStdHandle(handle) -> integer\n\nReturn a handle to the specified standard device\n(STD_INPUT_HANDLE, STD_OUTPUT_HANDLE, STD_ERROR_HANDLE).\nThe integer associated with the handle object is returned.";
...
winapi_GetStdHandle(PyObject* self, PyObject* args)
{
    ...
    if (! PyArg_ParseTuple(args, "k" ":GetStdHandle", &std_handle))
        return ((void *)0);
...
static char GetVersion_doc[] = "GetVersion() -> version\n\nReturn the version number of the current operating system.";
...
winapi_OpenProcess(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "k" "i" "k",
...
winapi_PeekNamedPipe(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "K" "|i:PeekNamedPipe" , &handle, &size))
        return ((void *)0);
    ...
    if (size) {
        buf = PyBytes_FromStringAndSize(((void *)0), size);
        if (!buf)
            return ((void *)0);
        { PyThreadState *_save; _save = PyEval_SaveThread();
        ret = PeekNamedPipe(handle, ((__builtin_expect(!(((((((PyObject*)(buf))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_winapi.c", 887, "PyBytes_Check(buf)") : (void)0), (((PyBytesObject *)(buf))->ob_sval)), size, &nread,
                            &navail, &nleft);
        PyEval_RestoreThread(_save); }
        if (!ret) {
        ...
        { PyThreadState *_save; _save = PyEval_SaveThread();
        ret = PeekNamedPipe(handle, ((void *)0), 0, ((void *)0), &navail, &nleft);
        PyEval_RestoreThread(_save); }
        if (!ret) {
            return PyErr_SetExcFromWindowsErr(PyExc_IOError, 0);
        }
...
winapi_ReadFile(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    DWORD err;
    OverlappedObject *overlapped = ((void *)0);
    static char *kwlist[] = {"handle", "size", "overlapped", ((void *)0)};

    if (!PyArg_ParseTupleAndKeywords(args, kwds,
                                     "K" "i|i:ReadFile", kwlist,
    ...
    { PyThreadState *_save; _save = PyEval_SaveThread();
    ret = ReadFile(handle, ((__builtin_expect(!(((((((PyObject*)(buf))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_winapi.c", 941, "PyBytes_Check(buf)") : (void)0), (((PyBytesObject *)(buf))->ob_sval)), size, &nread,
                   overlapped ? &overlapped->overlapped : ((void *)0));
    PyEval_RestoreThread(_save); }
...
winapi_SetNamedPipeHandleState(PyObject *self, PyObject *args)
{
    HANDLE hNamedPipe;
    PyObject *oArgs[3];
    DWORD dwArgs[3], *pArgs[3] = {((void *)0), ((void *)0), ((void *)0)};
    int i;

    if (!PyArg_ParseTuple(args, "K" "OOO",
...
static char TerminateProcess_doc[] = "TerminateProcess(handle, exit_code) -> None\n\nTerminate the specified process and all of its threads.";
...
winapi_TerminateProcess(PyObject* self, PyObject* args)
{
    ...
    HANDLE process;
    UINT exit_code;
    if (! PyArg_ParseTuple(args, "K" "I" ":TerminateProcess",
                           &process, &exit_code))
        return ((void *)0);
...
winapi_WaitNamedPipe(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "s" "k", &lpNamedPipeName, &nTimeOut))
        return ((void *)0);
...
winapi_WaitForMultipleObjects(PyObject* self, PyObject* args)
{
    ...
    if (!PySequence_Check(handle_seq)) {
        PyErr_Format(PyExc_TypeError,
                     ...
                     (((PyObject*)(handle_seq))->ob_type)->tp_name);
        return ((void *)0);
    }
    nhandles = PySequence_Size(handle_seq);
    if (nhandles == -1)
        return ((void *)0);
    ...
    if (!wait_flag && _PyOS_IsMainThread()) {
        ...
        (__builtin_expect(!(sigint_event != ((void *)0)), 0) ? __assert_rtn(__func__, "_winapi.c", 1089, "sigint_event != NULL") : (void)0);
        handles[nhandles++] = sigint_event;
    }

    { PyThreadState *_save; _save = PyEval_SaveThread();
    if (sigint_event != ((void *)0))
    ...
    if (result == WAIT_FAILED)
        return PyErr_SetExcFromWindowsErr(PyExc_IOError, 0);
    else if (sigint_event != ((void *)0) && result == WAIT_OBJECT_0 + nhandles - 1) {
        (*__error()) = 4;
...
static char WaitForSingleObject_doc[] = "WaitForSingleObject(handle, timeout) -> result\n\nWait until the specified object is in the signaled state or\nthe time-out interval elapses. The timeout value is specified\nin milliseconds.";
...
winapi_WaitForSingleObject(PyObject* self, PyObject* args)
{
    ...
    HANDLE handle;
    DWORD milliseconds;
    if (! PyArg_ParseTuple(args, "K" "k" ":WaitForSingleObject",
                                 &handle,
                                 &milliseconds))
        return ((void *)0);
...
winapi_WriteFile(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    DWORD err;
    OverlappedObject *overlapped = ((void *)0);
    static char *kwlist[] = {"handle", "buffer", "overlapped", ((void *)0)};


    if (!PyArg_ParseTupleAndKeywords(args, kwds,
                                     "K" "O|i:WriteFile", kwlist,
    ...
    if (!PyArg_Parse(bufobj, "y*", buf)) {
        do { if ((overlapped) == ((void *)0)) ; else do { if ( --((PyObject*)(overlapped))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(overlapped)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(overlapped)))); } while (0); } while (0);
        return ((void *)0);
    }
...
static PyMethodDef winapi_functions[] = {
    {"CloseHandle", winapi_CloseHandle, 0x0001,
     CloseHandle_doc},
    {"ConnectNamedPipe", (PyCFunction)winapi_ConnectNamedPipe,
     0x0001 | 0x0002, ""},
    {"CreateFile", winapi_CreateFile, 0x0001,
     ""},
    {"CreateNamedPipe", winapi_CreateNamedPipe, 0x0001,
     ""},
    {"CreatePipe", winapi_CreatePipe, 0x0001,
     CreatePipe_doc},
    {"CreateProcess", winapi_CreateProcess, 0x0001,
     CreateProcess_doc},
    {"DuplicateHandle", winapi_DuplicateHandle, 0x0001,
     DuplicateHandle_doc},
    {"ExitProcess", winapi_ExitProcess, 0x0001,
     ""},
    {"GetCurrentProcess", winapi_GetCurrentProcess, 0x0001,
     GetCurrentProcess_doc},
    {"GetExitCodeProcess", winapi_GetExitCodeProcess, 0x0001,
     GetExitCodeProcess_doc},
    {"GetLastError", winapi_GetLastError, 0x0004,
     GetCurrentProcess_doc},
    {"GetModuleFileName", winapi_GetModuleFileName, 0x0001,
     GetModuleFileName_doc},
    {"GetStdHandle", winapi_GetStdHandle, 0x0001,
     GetStdHandle_doc},
    {"GetVersion", winapi_GetVersion, 0x0001,
     GetVersion_doc},
    {"OpenProcess", winapi_OpenProcess, 0x0001,
     ""},
    {"PeekNamedPipe", winapi_PeekNamedPipe, 0x0001,
     ""},
    {"ReadFile", (PyCFunction)winapi_ReadFile, 0x0001 | 0x0002,
     ""},
    {"SetNamedPipeHandleState", winapi_SetNamedPipeHandleState, 0x0001,
     ""},
    {"TerminateProcess", winapi_TerminateProcess, 0x0001,
     TerminateProcess_doc},
    {"WaitNamedPipe", winapi_WaitNamedPipe, 0x0001,
     ""},
    {"WaitForMultipleObjects", winapi_WaitForMultipleObjects, 0x0001,
     ""},
    {"WaitForSingleObject", winapi_WaitForSingleObject, 0x0001,
     WaitForSingleObject_doc},
    {"WriteFile", (PyCFunction)winapi_WriteFile, 0x0001 | 0x0002,
     ""},
    {((void *)0), ((void *)0)}
};
...
PyInit__winapi(void)
{
    ...
    m = PyModule_Create2(&winapi_module, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    ...
    PyDict_SetItemString(d, "CREATE_NEW_CONSOLE", Py_BuildValue("k", CREATE_NEW_CONSOLE));
    PyDict_SetItemString(d, "CREATE_NEW_PROCESS_GROUP", Py_BuildValue("k", CREATE_NEW_PROCESS_GROUP));
    PyDict_SetItemString(d, "DUPLICATE_SAME_ACCESS", Py_BuildValue("k", DUPLICATE_SAME_ACCESS));
    PyDict_SetItemString(d, "DUPLICATE_CLOSE_SOURCE", Py_BuildValue("k", DUPLICATE_CLOSE_SOURCE));
    PyDict_SetItemString(d, "ERROR_ALREADY_EXISTS", Py_BuildValue("k", ERROR_ALREADY_EXISTS));
    PyDict_SetItemString(d, "ERROR_BROKEN_PIPE", Py_BuildValue("k", ERROR_BROKEN_PIPE));
    PyDict_SetItemString(d, "ERROR_IO_PENDING", Py_BuildValue("k", ERROR_IO_PENDING));
    PyDict_SetItemString(d, "ERROR_MORE_DATA", Py_BuildValue("k", ERROR_MORE_DATA));
    PyDict_SetItemString(d, "ERROR_NETNAME_DELETED", Py_BuildValue("k", ERROR_NETNAME_DELETED));
    PyDict_SetItemString(d, "ERROR_NO_SYSTEM_RESOURCES", Py_BuildValue("k", ERROR_NO_SYSTEM_RESOURCES));
    PyDict_SetItemString(d, "ERROR_MORE_DATA", Py_BuildValue("k", ERROR_MORE_DATA));
    PyDict_SetItemString(d, "ERROR_NETNAME_DELETED", Py_BuildValue("k", ERROR_NETNAME_DELETED));
    PyDict_SetItemString(d, "ERROR_NO_DATA", Py_BuildValue("k", ERROR_NO_DATA));
    PyDict_SetItemString(d, "ERROR_NO_SYSTEM_RESOURCES", Py_BuildValue("k", ERROR_NO_SYSTEM_RESOURCES));
    PyDict_SetItemString(d, "ERROR_OPERATION_ABORTED", Py_BuildValue("k", ERROR_OPERATION_ABORTED));
    PyDict_SetItemString(d, "ERROR_PIPE_BUSY", Py_BuildValue("k", ERROR_PIPE_BUSY));
    PyDict_SetItemString(d, "ERROR_PIPE_CONNECTED", Py_BuildValue("k", ERROR_PIPE_CONNECTED));
    PyDict_SetItemString(d, "ERROR_SEM_TIMEOUT", Py_BuildValue("k", ERROR_SEM_TIMEOUT));
    PyDict_SetItemString(d, "FILE_FLAG_FIRST_PIPE_INSTANCE", Py_BuildValue("k", FILE_FLAG_FIRST_PIPE_INSTANCE));
    PyDict_SetItemString(d, "FILE_FLAG_OVERLAPPED", Py_BuildValue("k", FILE_FLAG_OVERLAPPED));
    PyDict_SetItemString(d, "FILE_GENERIC_READ", Py_BuildValue("k", FILE_GENERIC_READ));
    PyDict_SetItemString(d, "FILE_GENERIC_WRITE", Py_BuildValue("k", FILE_GENERIC_WRITE));
    PyDict_SetItemString(d, "GENERIC_READ", Py_BuildValue("k", GENERIC_READ));
    PyDict_SetItemString(d, "GENERIC_WRITE", Py_BuildValue("k", GENERIC_WRITE));
    PyDict_SetItemString(d, "INFINITE", Py_BuildValue("k", INFINITE));
    PyDict_SetItemString(d, "NMPWAIT_WAIT_FOREVER", Py_BuildValue("k", NMPWAIT_WAIT_FOREVER));
    PyDict_SetItemString(d, "OPEN_EXISTING", Py_BuildValue("k", OPEN_EXISTING));
    PyDict_SetItemString(d, "PIPE_ACCESS_DUPLEX", Py_BuildValue("k", PIPE_ACCESS_DUPLEX));
    PyDict_SetItemString(d, "PIPE_ACCESS_INBOUND", Py_BuildValue("k", PIPE_ACCESS_INBOUND));
    PyDict_SetItemString(d, "PIPE_READMODE_MESSAGE", Py_BuildValue("k", PIPE_READMODE_MESSAGE));
    PyDict_SetItemString(d, "PIPE_TYPE_MESSAGE", Py_BuildValue("k", PIPE_TYPE_MESSAGE));
    PyDict_SetItemString(d, "PIPE_UNLIMITED_INSTANCES", Py_BuildValue("k", PIPE_UNLIMITED_INSTANCES));
    PyDict_SetItemString(d, "PIPE_WAIT", Py_BuildValue("k", PIPE_WAIT));
    PyDict_SetItemString(d, "PROCESS_ALL_ACCESS", Py_BuildValue("k", PROCESS_ALL_ACCESS));
    PyDict_SetItemString(d, "PROCESS_DUP_HANDLE", Py_BuildValue("k", PROCESS_DUP_HANDLE));
    PyDict_SetItemString(d, "STARTF_USESHOWWINDOW", Py_BuildValue("k", STARTF_USESHOWWINDOW));
    PyDict_SetItemString(d, "STARTF_USESTDHANDLES", Py_BuildValue("k", STARTF_USESTDHANDLES));
    PyDict_SetItemString(d, "STD_INPUT_HANDLE", Py_BuildValue("k", STD_INPUT_HANDLE));
    PyDict_SetItemString(d, "STD_OUTPUT_HANDLE", Py_BuildValue("k", STD_OUTPUT_HANDLE));
    PyDict_SetItemString(d, "STD_ERROR_HANDLE", Py_BuildValue("k", STD_ERROR_HANDLE));
    PyDict_SetItemString(d, "STILL_ACTIVE", Py_BuildValue("k", STILL_ACTIVE));
    PyDict_SetItemString(d, "SW_HIDE", Py_BuildValue("k", SW_HIDE));
    PyDict_SetItemString(d, "WAIT_OBJECT_0", Py_BuildValue("k", WAIT_OBJECT_0));
    PyDict_SetItemString(d, "WAIT_TIMEOUT", Py_BuildValue("k", WAIT_TIMEOUT));

    PyDict_SetItemString(d, "NULL", Py_BuildValue("i", ((void *)0)));
