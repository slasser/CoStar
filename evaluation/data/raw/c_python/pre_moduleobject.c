...
static PyMemberDef module_members[] = {
    {"__dict__", 6, __builtin_offsetof (PyModuleObject, md_dict), 1},
    {0}
};
...
{
    PyModuleObject *m;
    m = ( (PyModuleObject *) _PyObject_GC_New(&PyModule_Type) );
    if (m == ((void *)0))
        return ((void *)0);
    m->md_def = ((void *)0);
    m->md_state = ((void *)0);
    ...
    if (PyDict_SetItemString(m->md_dict, "__name__", name) != 0)
        goto fail;
    if (PyDict_SetItemString(m->md_dict, "__doc__", (&_Py_NoneStruct)) != 0)
        goto fail;
    if (PyDict_SetItemString(m->md_dict, "__package__", (&_Py_NoneStruct)) != 0)
        goto fail;
    PyObject_GC_Track(m);
    return (PyObject *)m;
...
PyModule_Create2(struct PyModuleDef* module, int module_api_version)
{
    ...
    if (module->m_base.m_index == 0) {
        max_module_number++;
        (((PyObject*)(module))->ob_refcnt) = 1;
        (((PyObject*)(module))->ob_type) = &moduledef_type;
        module->m_base.m_index = max_module_number;
    }
    name = module->m_name;
    if (module_api_version != 1013 && module_api_version != 3) {
        int err;
        err = PyErr_WarnFormat(PyExc_RuntimeWarning, 1,
            "Python C API version mismatch for module %.100s: "
            "This Python has API version %d, module %.100s has version %d.",
             name,
             1013, name, module_api_version);
        if (err)
            return ((void *)0);
    }
# 106 "moduleobject.c"
    if (_Py_PackageContext != ((void *)0)) {
        char *p = strrchr(_Py_PackageContext, '.');
        if (p != ((void *)0) && strcmp(module->m_name, p+1) == 0) {
            name = _Py_PackageContext;
            _Py_PackageContext = ((void *)0);
        }
    }
    if ((m = (PyModuleObject*)PyModule_New(name)) == ((void *)0))
        return ((void *)0);

    if (module->m_size > 0) {
        m->md_state = ((size_t)(module->m_size) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc((module->m_size) ? (module->m_size) : 1));
        if (!m->md_state) {
            PyErr_NoMemory();
            do { if ( --((PyObject*)(m))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(m)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(m)))); } while (0);
            return ((void *)0);
        }
        ((__builtin_object_size (m->md_state, 0) != (size_t) -1) ? __builtin___memset_chk (m->md_state, 0, module->m_size, __builtin_object_size (m->md_state, 0)) : __inline_memset_chk (m->md_state, 0, module->m_size));
    }

    d = PyModule_GetDict((PyObject*)m);
    if (module->m_methods != ((void *)0)) {
        n = PyUnicode_FromString(name);
        if (n == ((void *)0)) {
            do { if ( --((PyObject*)(m))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(m)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(m)))); } while (0);
            return ((void *)0);
        }
        for (ml = module->m_methods; ml->ml_name != ((void *)0); ml++) {
            if ((ml->ml_flags & 0x0010) ||
                (ml->ml_flags & 0x0020)) {
    ...
    if (module->m_doc != ((void *)0)) {
        v = PyUnicode_FromString(module->m_doc);
        if (v == ((void *)0) || PyDict_SetItemString(d, "__doc__", v) != 0) {
...
{
    PyObject *d;
    if (!((((PyObject*)(m))->ob_type) == (&PyModule_Type) || PyType_IsSubtype((((PyObject*)(m))->ob_type), (&PyModule_Type)))) {
        _PyErr_BadInternalCall("moduleobject.c", 178);
        return ((void *)0);
    }
...
PyModule_GetNameObject(PyObject *m)
{
    ...
    d = ((PyModuleObject *)m)->md_dict;
    if (d == ((void *)0) ||
        (name = PyDict_GetItemString(d, "__name__")) == ((void *)0) ||
...
PyModule_GetFilenameObject(PyObject *m)
{
    ...
    d = ((PyModuleObject *)m)->md_dict;
    if (d == ((void *)0) ||
        (fileobj = PyDict_GetItemString(d, "__file__")) == ((void *)0) ||
        !((((((PyObject*)(fileobj))->ob_type))->tp_flags & ((1L<<28))) != 0))
    {
        PyErr_SetString(PyExc_SystemError, "module filename missing");
        return ((void *)0);
    }
    ( ((PyObject*)(fileobj))->ob_refcnt++);
    return fileobj;
}
...
PyModule_GetFilename(PyObject *m)
{
    ...
    do { if ( --((PyObject*)(fileobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(fileobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(fileobj)))); } while (0);
    return utf8;
}
...
_PyModule_Clear(PyObject *m)
{
    ...
    while (PyDict_Next(d, &pos, &key, &value)) {
        if (value != (&_Py_NoneStruct) && ((((((PyObject*)(key))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
            if (((__builtin_expect(!(((((((PyObject*)(key))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_Check(key)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)key)->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_IS_READY(key)") : (void)0), (Py_UCS4) (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject *)((key)))->state.kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_Check((key))") : (void)0), (((PyASCIIObject*)((key)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject*)(key))->state.ascii) ? ((void*)((PyASCIIObject*)((key)) + 1)) : ((void*)((PyCompactUnicodeObject*)((key)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((key)))->data.any), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "((PyUnicodeObject*)((key)))->data.any") : (void)0), ((((PyUnicodeObject *)((key)))->data.any))))))[(0)] : (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject *)((key)))->state.kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_Check((key))") : (void)0), (((PyASCIIObject*)((key)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject*)(key))->state.ascii) ? ((void*)((PyASCIIObject*)((key)) + 1)) : ((void*)((PyCompactUnicodeObject*)((key)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((key)))->data.any), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "((PyUnicodeObject*)((key)))->data.any") : (void)0), ((((PyUnicodeObject *)((key)))->data.any))))))[(0)] : ((const Py_UCS4 *)(((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_Check((key))") : (void)0), (((PyASCIIObject*)((key)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject*)(key))->state.ascii) ? ((void*)((PyASCIIObject*)((key)) + 1)) : ((void*)((PyCompactUnicodeObject*)((key)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((key)))->data.any), 0) ? __assert_rtn(__func__, "moduleobject.c", 294, "((PyUnicodeObject*)((key)))->data.any") : (void)0), ((((PyUnicodeObject *)((key)))->data.any))))))[(0)] ) )) == '_' &&
                ((__builtin_expect(!(((((((PyObject*)(key))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_Check(key)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)key)->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_IS_READY(key)") : (void)0), (Py_UCS4) (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject *)((key)))->state.kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_Check((key))") : (void)0), (((PyASCIIObject*)((key)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject*)(key))->state.ascii) ? ((void*)((PyASCIIObject*)((key)) + 1)) : ((void*)((PyCompactUnicodeObject*)((key)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((key)))->data.any), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "((PyUnicodeObject*)((key)))->data.any") : (void)0), ((((PyUnicodeObject *)((key)))->data.any))))))[(1)] : (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject *)((key)))->state.kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_Check((key))") : (void)0), (((PyASCIIObject*)((key)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject*)(key))->state.ascii) ? ((void*)((PyASCIIObject*)((key)) + 1)) : ((void*)((PyCompactUnicodeObject*)((key)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((key)))->data.any), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "((PyUnicodeObject*)((key)))->data.any") : (void)0), ((((PyUnicodeObject *)((key)))->data.any))))))[(1)] : ((const Py_UCS4 *)(((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_Check((key))") : (void)0), (((PyASCIIObject*)((key)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject*)(key))->state.ascii) ? ((void*)((PyASCIIObject*)((key)) + 1)) : ((void*)((PyCompactUnicodeObject*)((key)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((key)))->data.any), 0) ? __assert_rtn(__func__, "moduleobject.c", 295, "((PyUnicodeObject*)((key)))->data.any") : (void)0), ((((PyUnicodeObject *)((key)))->data.any))))))[(1)] ) )) != '_') {
                if (Py_VerboseFlag > 1) {
                ...
                PyDict_SetItem(d, key, (&_Py_NoneStruct));
            }
        }
    }
    ...
    while (PyDict_Next(d, &pos, &key, &value)) {
        if (value != (&_Py_NoneStruct) && ((((((PyObject*)(key))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
            if (((__builtin_expect(!(((((((PyObject*)(key))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_Check(key)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)key)->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_IS_READY(key)") : (void)0), (Py_UCS4) (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject *)((key)))->state.kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_Check((key))") : (void)0), (((PyASCIIObject*)((key)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject*)(key))->state.ascii) ? ((void*)((PyASCIIObject*)((key)) + 1)) : ((void*)((PyCompactUnicodeObject*)((key)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((key)))->data.any), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "((PyUnicodeObject*)((key)))->data.any") : (void)0), ((((PyUnicodeObject *)((key)))->data.any))))))[(0)] : (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject *)((key)))->state.kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_Check((key))") : (void)0), (((PyASCIIObject*)((key)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject*)(key))->state.ascii) ? ((void*)((PyASCIIObject*)((key)) + 1)) : ((void*)((PyCompactUnicodeObject*)((key)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((key)))->data.any), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "((PyUnicodeObject*)((key)))->data.any") : (void)0), ((((PyUnicodeObject *)((key)))->data.any))))))[(0)] : ((const Py_UCS4 *)(((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_Check((key))") : (void)0), (((PyASCIIObject*)((key)))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)((key)))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_Check((key))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(key))->state.ready)), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "PyUnicode_IS_READY((key))") : (void)0), ((PyASCIIObject*)(key))->state.ascii) ? ((void*)((PyASCIIObject*)((key)) + 1)) : ((void*)((PyCompactUnicodeObject*)((key)) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)((key)))->data.any), 0) ? __assert_rtn(__func__, "moduleobject.c", 312, "((PyUnicodeObject*)((key)))->data.any") : (void)0), ((((PyUnicodeObject *)((key)))->data.any))))))[(0)] ) )) != '_' ||
...
{
    static char *kwlist[] = {"name", "doc", ((void *)0)};
    PyObject *dict, *name = (&_Py_NoneStruct), *doc = (&_Py_NoneStruct);
...
module_dealloc(PyModuleObject *m)
{
    ...
    if (m->md_dict != ((void *)0)) {
        _PyModule_Clear((PyObject *)m);
        do { if ( --((PyObject*)(m->md_dict))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(m->md_dict)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(m->md_dict)))); } while (0);
    }
    if (m->md_state != ((void *)0))
        free(m->md_state);
    (((PyObject*)(m))->ob_type)->tp_free((PyObject *)m);
}

static PyObject *
module_repr(PyModuleObject *m)
{
    PyObject *name, *filename, *repr, *loader = ((void *)0);
...
module_traverse(PyModuleObject *m, visitproc visit, void *arg)
{
    ...
    do { if (m->md_dict) { int vret = visit((PyObject *)(m->md_dict), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
module_clear(PyModuleObject *m)
{
    ...
    do { if (m->md_dict) { PyObject *_py_tmp = (PyObject *)(m->md_dict); (m->md_dict) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    return 0;
}
...
static PyMethodDef module_methods[] = {
    {"__dir__", module_dir, 0x0004,
     "__dir__() -> list\nspecialized dir() implementation"},
    {0}
};


static char module_doc[] = "module(name[, doc])\n\nCreate a module object.\nThe name must be a string; the optional doc argument can have any type.";
...
PyTypeObject PyModule_Type = {
    ...
    0,
    0,
    __builtin_offsetof (PyModuleObject, md_dict),
