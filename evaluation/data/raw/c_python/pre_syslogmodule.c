...
static PyObject *S_ident_o = ((void *)0);
...
syslog_get_argv(void)
{
    ...
    if (!((((((PyObject*)(scriptobj))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        return(((void *)0));
    }
    scriptlen = ((__builtin_expect(!(((((((PyObject*)(scriptobj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "syslogmodule.c", 93, "PyUnicode_Check(scriptobj)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)scriptobj)->state.ready)), 0) ? __assert_rtn(__func__, "syslogmodule.c", 93, "PyUnicode_IS_READY(scriptobj)") : (void)0), ((PyASCIIObject *)(scriptobj))->length);
    if (scriptlen == 0) {
        return(((void *)0));
    }

    slash = PyUnicode_FindChar(scriptobj, L'/', 0, scriptlen, -1);
    if (slash == -2)
        return ((void *)0);
    if (slash != -1) {
        return PyUnicode_Substring(scriptobj, slash, scriptlen);
    } else {
        ( ((PyObject*)(scriptobj))->ob_refcnt++);
        return(scriptobj);
    }
...
syslog_openlog(PyObject * self, PyObject * args, PyObject *kwds)
{
    ...
    if (new_S_ident_o) {
        ( ((PyObject*)(new_S_ident_o))->ob_refcnt++);
    }
    ...
    do { if ((S_ident_o) == ((void *)0)) ; else do { if ( --((PyObject*)(S_ident_o))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(S_ident_o)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(S_ident_o)))); } while (0); } while (0);
...
syslog_syslog(PyObject * self, PyObject * args)
{
    ...
    if (!S_log_open) {
        ...
        if ((openargs = PyTuple_New(0))) {
            PyObject *openlog_ret = syslog_openlog(self, openargs, ((void *)0));
            do { if ((openlog_ret) == ((void *)0)) ; else do { if ( --((PyObject*)(openlog_ret))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(openlog_ret)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(openlog_ret)))); } while (0); } while (0);
            do { if ( --((PyObject*)(openargs))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(openargs)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(openargs)))); } while (0);
        }
    }
...
static PyMethodDef syslog_methods[] = {
    {"openlog", (PyCFunction) syslog_openlog, 0x0001 | 0x0002},
    {"closelog", syslog_closelog, 0x0004},
    {"syslog", syslog_syslog, 0x0001},
    {"setlogmask", syslog_setlogmask, 0x0001},
    {"LOG_MASK", syslog_log_mask, 0x0001},
    {"LOG_UPTO", syslog_log_upto, 0x0001},
    {((void *)0), ((void *)0), 0}
};
...
PyInit_syslog(void)
{
    ...
    m = PyModule_Create2(&syslogmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    ...
    PyModule_AddIntConstant(m, "LOG_EMERG", 0);
    PyModule_AddIntConstant(m, "LOG_ALERT", 1);
    PyModule_AddIntConstant(m, "LOG_CRIT", 2);
    PyModule_AddIntConstant(m, "LOG_ERR", 3);
    PyModule_AddIntConstant(m, "LOG_WARNING", 4);
    PyModule_AddIntConstant(m, "LOG_NOTICE", 5);
    PyModule_AddIntConstant(m, "LOG_INFO", 6);
    PyModule_AddIntConstant(m, "LOG_DEBUG", 7);


    PyModule_AddIntConstant(m, "LOG_PID", 0x01);
    PyModule_AddIntConstant(m, "LOG_CONS", 0x02);
    PyModule_AddIntConstant(m, "LOG_NDELAY", 0x08);

    PyModule_AddIntConstant(m, "LOG_ODELAY", 0x04);


    PyModule_AddIntConstant(m, "LOG_NOWAIT", 0x10);


    PyModule_AddIntConstant(m, "LOG_PERROR", 0x20);



    PyModule_AddIntConstant(m, "LOG_KERN", (0<<3));
    PyModule_AddIntConstant(m, "LOG_USER", (1<<3));
    PyModule_AddIntConstant(m, "LOG_MAIL", (2<<3));
    PyModule_AddIntConstant(m, "LOG_DAEMON", (3<<3));
    PyModule_AddIntConstant(m, "LOG_AUTH", (4<<3));
    PyModule_AddIntConstant(m, "LOG_LPR", (6<<3));
    PyModule_AddIntConstant(m, "LOG_LOCAL0", (16<<3));
    PyModule_AddIntConstant(m, "LOG_LOCAL1", (17<<3));
    PyModule_AddIntConstant(m, "LOG_LOCAL2", (18<<3));
    PyModule_AddIntConstant(m, "LOG_LOCAL3", (19<<3));
    PyModule_AddIntConstant(m, "LOG_LOCAL4", (20<<3));
    PyModule_AddIntConstant(m, "LOG_LOCAL5", (21<<3));
    PyModule_AddIntConstant(m, "LOG_LOCAL6", (22<<3));
    PyModule_AddIntConstant(m, "LOG_LOCAL7", (23<<3));
# 333 "syslogmodule.c"
    PyModule_AddIntConstant(m, "LOG_SYSLOG", (5<<3));
    PyModule_AddIntConstant(m, "LOG_CRON", (9<<3));
    PyModule_AddIntConstant(m, "LOG_UUCP", (8<<3));
    PyModule_AddIntConstant(m, "LOG_NEWS", (7<<3));


    PyModule_AddIntConstant(m, "LOG_AUTHPRIV", (10<<3));
