...
{
    size_t size = ((__builtin_expect(!(((((((PyObject*)(*buf))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_lzmamodule.c", 129, "PyBytes_Check(*buf)") : (void)0),(((PyVarObject*)(*buf))->ob_size));
    return _PyBytes_Resize(buf, size + (size >> 3) + 6);
}
# 167 "_lzmamodule.c"
static int uint32_converter(PyObject *obj, void *ptr) { unsigned long long val; val = PyLong_AsUnsignedLongLong(obj); if (PyErr_Occurred()) return 0; if ((unsigned long long)(uint32_t)val != val) { PyErr_SetString(PyExc_OverflowError, "Value too large for " "uint32_t" " type"); return 0; } *(uint32_t *)ptr = (uint32_t)val; return 1; }
static int lzma_vli_converter(PyObject *obj, void *ptr) { unsigned long long val; val = PyLong_AsUnsignedLongLong(obj); if (PyErr_Occurred()) return 0; if ((unsigned long long)(lzma_vli)val != val) { PyErr_SetString(PyExc_OverflowError, "Value too large for " "lzma_vli" " type"); return 0; } *(lzma_vli *)ptr = (lzma_vli)val; return 1; }
static int lzma_mode_converter(PyObject *obj, void *ptr) { unsigned long long val; val = PyLong_AsUnsignedLongLong(obj); if (PyErr_Occurred()) return 0; if ((unsigned long long)(lzma_mode)val != val) { PyErr_SetString(PyExc_OverflowError, "Value too large for " "lzma_mode" " type"); return 0; } *(lzma_mode *)ptr = (lzma_mode)val; return 1; }
static int lzma_mf_converter(PyObject *obj, void *ptr) { unsigned long long val; val = PyLong_AsUnsignedLongLong(obj); if (PyErr_Occurred()) return 0; if ((unsigned long long)(lzma_match_finder)val != val) { PyErr_SetString(PyExc_OverflowError, "Value too large for " "lzma_match_finder" " type"); return 0; } *(lzma_match_finder *)ptr = (lzma_match_finder)val; return 1; }
# 180 "_lzmamodule.c"
static void *
parse_filter_spec_lzma(PyObject *spec)
{
    static char *optnames[] = {"id", "preset", "dict_size", "lc", "lp",
                               "pb", "mode", "nice_len", "mf", "depth", ((void *)0)};
    PyObject *id;
    PyObject *preset_obj;
    ...
    if (preset_obj == ((void *)0)) {
        ...
        do { if ( --((PyObject*)(preset_obj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(preset_obj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(preset_obj)))); } while (0);
        if (!ok)
            return ((void *)0);
    }
    ...
    ((__builtin_object_size (options, 0) != (size_t) -1) ? __builtin___memset_chk (options, 0, sizeof *options, __builtin_object_size (options, 0)) : __inline_memset_chk (options, 0, sizeof *options));
    ...
    if (!_PyArg_ParseTupleAndKeywords_SizeT(empty_tuple, spec,
...
{
    static char *optnames[] = {"id", "dist", ((void *)0)};
    PyObject *id;
    uint32_t dist = 1;
    lzma_options_delta *options;

    if (!_PyArg_ParseTupleAndKeywords_SizeT(empty_tuple, spec, "|OO&", optnames,
...
{
    static char *optnames[] = {"id", "start_offset", ((void *)0)};
    PyObject *id;
...
parse_filter_spec(lzma_filter *f, PyObject *spec)
{
    ...
    do { if ( --((PyObject*)(id_obj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(id_obj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(id_obj)))); } while (0);
    if (PyErr_Occurred())
        return ((void *)0);
...
parse_filter_chain_spec(lzma_filter filters[], PyObject *filterspecs)
{
    ...
    num_filters = PySequence_Size(filterspecs);
    if (num_filters == -1)
        return -1;
    ...
    for (i = 0; i < num_filters; i++) {
        ...
        if (spec == ((void *)0) || parse_filter_spec(&filters[i], spec) == ((void *)0))
            ok = 0;
        do { if ((spec) == ((void *)0)) ; else do { if ( --((PyObject*)(spec))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(spec)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(spec)))); } while (0); } while (0);
        if (!ok) {
...
spec_add_field(PyObject *spec, _Py_Identifier *key, unsigned long long value)
{
    ...
    if (value_object == ((void *)0))
        return -1;

    status = _PyDict_SetItemId(spec, key, value_object);
    do { if ( --((PyObject*)(value_object))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(value_object)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(value_object)))); } while (0);
    return status;
}
...
build_filter_spec(const lzma_filter *f)
{
    ...
    if (spec == ((void *)0))
        return ((void *)0);
# 404 "_lzmamodule.c"
    do { static _Py_Identifier PyId_id = { 0, "id", 0 }; if (spec_add_field(spec, &PyId_id, f->id) == -1) goto error; } while (0);
    ...
    switch (f->id) {
        ...
        case LZMA_FILTER_LZMA1: {
            ...
            do { static _Py_Identifier PyId_lc = { 0, "lc", 0 }; if (spec_add_field(spec, &PyId_lc, options->lc) == -1) goto error; } while (0);
            do { static _Py_Identifier PyId_lp = { 0, "lp", 0 }; if (spec_add_field(spec, &PyId_lp, options->lp) == -1) goto error; } while (0);
            do { static _Py_Identifier PyId_pb = { 0, "pb", 0 }; if (spec_add_field(spec, &PyId_pb, options->pb) == -1) goto error; } while (0);
            do { static _Py_Identifier PyId_dict_size = { 0, "dict_size", 0 }; if (spec_add_field(spec, &PyId_dict_size, options->dict_size) == -1) goto error; } while (0);
            break;
        }
        case LZMA_FILTER_LZMA2: {
            lzma_options_lzma *options = f->options;
        ...
        case LZMA_FILTER_DELTA: {
            ...
            do { static _Py_Identifier PyId_dist = { 0, "dist", 0 }; if (spec_add_field(spec, &PyId_dist, options->dist) == -1) goto error; } while (0);
            break;
        }
        case LZMA_FILTER_X86:
        case LZMA_FILTER_POWERPC:
        ...
        case LZMA_FILTER_SPARC: {
            ...
            do { static _Py_Identifier PyId_start_offset = { 0, "start_offset", 0 }; if (spec_add_field(spec, &PyId_start_offset, options->start_offset) == -1) goto error; } while (0);
            break;
        }
        default:
            PyErr_Format(PyExc_ValueError, "Invalid filter ID: %llu", f->id);
...
error:
    do { if ( --((PyObject*)(spec))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(spec)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(spec)))); } while (0);
    return ((void *)0);
}
...
compress(Compressor *c, uint8_t *data, size_t len, lzma_action action)
{
    ...
    result = PyBytes_FromStringAndSize(((void *)0), 8192);
    if (result == ((void *)0))
        return ((void *)0);
    c->lzs.next_in = data;
    c->lzs.avail_in = len;
    c->lzs.next_out = (uint8_t *)((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_lzmamodule.c", 466, "PyBytes_Check(result)") : (void)0), (((PyBytesObject *)(result))->ob_sval));
    c->lzs.avail_out = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_lzmamodule.c", 467, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size));
    for (;;) {
        lzma_ret lzret;

        { PyThreadState *_save; _save = PyEval_SaveThread();
        lzret = lzma_code(&c->lzs, action);
        data_size = (char *)c->lzs.next_out - ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_lzmamodule.c", 473, "PyBytes_Check(result)") : (void)0), (((PyBytesObject *)(result))->ob_sval));
        ...
        if ((action == LZMA_RUN && c->lzs.avail_in == 0) ||
            ...
            if (grow_buffer(&result) == -1)
                goto error;
            c->lzs.next_out = (uint8_t *)((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_lzmamodule.c", 483, "PyBytes_Check(result)") : (void)0), (((PyBytesObject *)(result))->ob_sval)) + data_size;
            c->lzs.avail_out = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_lzmamodule.c", 484, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size)) - data_size;
        }
    }
    if (data_size != ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_lzmamodule.c", 487, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size)))
...
Compressor_compress(Compressor *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "y*:compress", &buffer))
        return ((void *)0);

    do { if (!PyThread_acquire_lock((self)->lock, 0)) { { PyThreadState *_save; _save = PyEval_SaveThread(); PyThread_acquire_lock((self)->lock, 1); PyEval_RestoreThread(_save); } } } while (0);
    if (self->flushed)
...
Compressor_flush(Compressor *self, PyObject *noargs)
{
    ...
    if (self->flushed) {
        ...
        self->flushed = 1;
        result = compress(self, ((void *)0), 0, LZMA_FINISH);
    }
    PyThread_release_lock((self)->lock);
    return result;
}
...
{
    static char *arg_names[] = {"format", "check", "preset", "filters", ((void *)0)};
    int format = FORMAT_XZ;
    int check = -1;
    uint32_t preset = LZMA_PRESET_DEFAULT;
    PyObject *preset_obj = (&_Py_NoneStruct);
    PyObject *filterspecs = (&_Py_NoneStruct);
    ...
    if (preset_obj != (&_Py_NoneStruct) && filterspecs != (&_Py_NoneStruct)) {
        PyErr_SetString(PyExc_ValueError,
                        "Cannot specify both preset and filter chain");
        return -1;
    }

    if (preset_obj != (&_Py_NoneStruct))
...
decompress(Decompressor *d, uint8_t *data, size_t len)
{
    ...
    d->lzs.next_in = data;
    d->lzs.avail_in = len;
    d->lzs.next_out = (uint8_t *)((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_lzmamodule.c", 801, "PyBytes_Check(result)") : (void)0), (((PyBytesObject *)(result))->ob_sval));
    d->lzs.avail_out = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_lzmamodule.c", 802, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size));
    for (;;) {
        lzma_ret lzret;

        { PyThreadState *_save; _save = PyEval_SaveThread();
        lzret = lzma_code(&d->lzs, LZMA_RUN);
        data_size = (char *)d->lzs.next_out - ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_lzmamodule.c", 808, "PyBytes_Check(result)") : (void)0), (((PyBytesObject *)(result))->ob_sval));
        PyEval_RestoreThread(_save); }
        if (catch_lzma_error(lzret))
            goto error;
        ...
        if (lzret == LZMA_STREAM_END) {
            d->eof = 1;
            if (d->lzs.avail_in > 0) {
                do { if (d->unused_data) { PyObject *_py_tmp = (PyObject *)(d->unused_data); (d->unused_data) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
                d->unused_data = PyBytes_FromStringAndSize(
                        (char *)d->lzs.next_in, d->lzs.avail_in);
                if (d->unused_data == ((void *)0))
                    goto error;
            }
            break;
            ...
            if (grow_buffer(&result) == -1)
                goto error;
            d->lzs.next_out = (uint8_t *)((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_lzmamodule.c", 829, "PyBytes_Check(result)") : (void)0), (((PyBytesObject *)(result))->ob_sval)) + data_size;
            d->lzs.avail_out = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_lzmamodule.c", 830, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size)) - data_size;
        }
    }
    if (data_size != ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_lzmamodule.c", 833, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size)))
        if (_PyBytes_Resize(&result, data_size) == -1)
            goto error;
    return result;
...
Decompressor_decompress(Decompressor *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "y*:decompress", &buffer))
        return ((void *)0);
...
{
    static char *arg_names[] = {"format", "memlimit", "filters", ((void *)0)};
    const uint32_t decoder_flags = LZMA_TELL_ANY_CHECK | LZMA_TELL_NO_CHECK;
    int format = FORMAT_AUTO;
    uint64_t memlimit = 18446744073709551615ULL;
    PyObject *memlimit_obj = (&_Py_NoneStruct);
    PyObject *filterspecs = (&_Py_NoneStruct);
    lzma_ret lzret;
    ...
    if (memlimit_obj != (&_Py_NoneStruct)) {
    ...
    if (format == FORMAT_RAW && filterspecs == (&_Py_NoneStruct)) {
        PyErr_SetString(PyExc_ValueError,
                        "Must specify filters for FORMAT_RAW");
        return -1;
    } else if (format != FORMAT_RAW && filterspecs != (&_Py_NoneStruct)) {
        PyErr_SetString(PyExc_ValueError,
    ...
    self->check = (LZMA_CHECK_ID_MAX + 1);
    self->unused_data = PyBytes_FromStringAndSize(((void *)0), 0);
...
error:
    do { if (self->unused_data) { PyObject *_py_tmp = (PyObject *)(self->unused_data); (self->unused_data) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
...
static PyTypeObject Decompressor_type = {
    ...
    sizeof(Decompressor),
    0,
    (destructor)Decompressor_dealloc,
    0,
    0,
    0,
    0,
...
static char is_check_supported_doc[] = "is_check_supported(check_id) -> bool\n" "\n" "Test whether the given integrity check is supported.\n" "\n" "Always returns True for CHECK_NONE and CHECK_CRC32.\n";
...
is_check_supported(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "i:is_check_supported", &check_id))
        return ((void *)0);
...
_encode_filter_properties(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O:_encode_filter_properties", &filterspec))
        return ((void *)0);

    if (parse_filter_spec(&filter, filterspec) == ((void *)0))
        return ((void *)0);
    ...
    result = PyBytes_FromStringAndSize(((void *)0), encoded_size);
    if (result == ((void *)0))
        goto error;

    lzret = lzma_properties_encode(
            &filter, (uint8_t *)((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_lzmamodule.c", 1132, "PyBytes_Check(result)") : (void)0), (((PyBytesObject *)(result))->ob_sval)));
    if (catch_lzma_error(lzret))
        goto error;
...
_decode_filter_properties(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O&y*:_decode_filter_properties",
                          lzma_vli_converter, &filter.id, &encoded_props))
        return ((void *)0);

    lzret = lzma_properties_decode(
            &filter, ((void *)0), encoded_props.buf, encoded_props.len);
...
PyInit__lzma(void)
{
    ...
    m = PyModule_Create2(&_lzmamodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);

    if (PyModule_AddIntConstant(m, "FORMAT_AUTO", FORMAT_AUTO) == -1 ||
        PyModule_AddIntConstant(m, "FORMAT_XZ", FORMAT_XZ) == -1 ||
        PyModule_AddIntConstant(m, "FORMAT_ALONE", FORMAT_ALONE) == -1 ||
        PyModule_AddIntConstant(m, "FORMAT_RAW", FORMAT_RAW) == -1 ||
        module_add_int_constant(m, "CHECK_NONE", LZMA_CHECK_NONE) == -1 ||
        module_add_int_constant(m, "CHECK_CRC32", LZMA_CHECK_CRC32) == -1 ||
        module_add_int_constant(m, "CHECK_CRC64", LZMA_CHECK_CRC64) == -1 ||
        module_add_int_constant(m, "CHECK_SHA256", LZMA_CHECK_SHA256) == -1 ||
        module_add_int_constant(m, "CHECK_ID_MAX", LZMA_CHECK_ID_MAX) == -1 ||
        module_add_int_constant(m, "CHECK_UNKNOWN", (LZMA_CHECK_ID_MAX + 1)) == -1 ||
        module_add_int_constant(m, "FILTER_LZMA1", LZMA_FILTER_LZMA1) == -1 ||
        module_add_int_constant(m, "FILTER_LZMA2", LZMA_FILTER_LZMA2) == -1 ||
        module_add_int_constant(m, "FILTER_DELTA", LZMA_FILTER_DELTA) == -1 ||
        module_add_int_constant(m, "FILTER_X86", LZMA_FILTER_X86) == -1 ||
        module_add_int_constant(m, "FILTER_IA64", LZMA_FILTER_IA64) == -1 ||
        module_add_int_constant(m, "FILTER_ARM", LZMA_FILTER_ARM) == -1 ||
        module_add_int_constant(m, "FILTER_ARMTHUMB", LZMA_FILTER_ARMTHUMB) == -1 ||
        module_add_int_constant(m, "FILTER_SPARC", LZMA_FILTER_SPARC) == -1 ||
        module_add_int_constant(m, "FILTER_POWERPC", LZMA_FILTER_POWERPC) == -1 ||
        module_add_int_constant(m, "MF_HC3", LZMA_MF_HC3) == -1 ||
        module_add_int_constant(m, "MF_HC4", LZMA_MF_HC4) == -1 ||
        module_add_int_constant(m, "MF_BT2", LZMA_MF_BT2) == -1 ||
        module_add_int_constant(m, "MF_BT3", LZMA_MF_BT3) == -1 ||
        module_add_int_constant(m, "MF_BT4", LZMA_MF_BT4) == -1 ||
        module_add_int_constant(m, "MODE_FAST", LZMA_MODE_FAST) == -1 ||
        module_add_int_constant(m, "MODE_NORMAL", LZMA_MODE_NORMAL) == -1 ||
        module_add_int_constant(m, "PRESET_DEFAULT", LZMA_PRESET_DEFAULT) == -1 ||
        module_add_int_constant(m, "PRESET_EXTREME", LZMA_PRESET_EXTREME) == -1)
        return ((void *)0);

    Error = PyErr_NewExceptionWithDoc(
            "_lzma.LZMAError", "Call to liblzma failed.", ((void *)0), ((void *)0));
    if (Error == ((void *)0))
        return ((void *)0);
    ( ((PyObject*)(Error))->ob_refcnt++);
    if (PyModule_AddObject(m, "LZMAError", Error) == -1)
        return ((void *)0);

    if (PyType_Ready(&Compressor_type) == -1)
        return ((void *)0);
    ( ((PyObject*)(&Compressor_type))->ob_refcnt++);
    ...
    if (PyType_Ready(&Decompressor_type) == -1)
        return ((void *)0);
    ( ((PyObject*)(&Decompressor_type))->ob_refcnt++);
