...
PyThreadState *_Py_Finalizing = ((void *)0);
...
get_codec_name(const char *encoding)
{
    ...
    do { if (codec) { PyObject *_py_tmp = (PyObject *)(codec); (codec) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    if (!name)
        goto error;
...
error:
    do { if ((codec) == ((void *)0)) ; else do { if ( --((PyObject*)(codec))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(codec)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(codec)))); } while (0); } while (0);
...
import_init(PyInterpreterState *interp, PyObject *sysmod)
{
    ...
    ( ((PyObject*)(interp->importlib))->ob_refcnt++);
    ...
    do { if ( --((PyObject*)(impmod))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(impmod)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(impmod)))); } while (0);
...
_Py_InitializeEx_Private(int install_sigs, int install_importlib)
{
    ...
    if ((p = (Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONDEBUG"))) && *p != '\0')
        Py_DebugFlag = add_flag(Py_DebugFlag, p);
    if ((p = (Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONVERBOSE"))) && *p != '\0')
        Py_VerboseFlag = add_flag(Py_VerboseFlag, p);
    if ((p = (Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONOPTIMIZE"))) && *p != '\0')
        Py_OptimizeFlag = add_flag(Py_OptimizeFlag, p);
    if ((p = (Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONDONTWRITEBYTECODE"))) && *p != '\0')
        Py_DontWriteBytecodeFlag = add_flag(Py_DontWriteBytecodeFlag, p);


    if ((p = (Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONHASHSEED"))) && *p != '\0')
    ...
    if (interp->builtins == ((void *)0))
        Py_FatalError("Py_Initialize: can't initialize builtins dict");
    ( ((PyObject*)(interp->builtins))->ob_refcnt++);
    ...
    if (interp->sysdict == ((void *)0))
        Py_FatalError("Py_Initialize: can't initialize sys dict");
    ( ((PyObject*)(interp->sysdict))->ob_refcnt++);
    ...
    pstderr = PyFile_NewStdPrinter(fileno(__stderrp));
    if (pstderr == ((void *)0))
        Py_FatalError("Py_Initialize: can't set preliminary stderr");
    PySys_SetObject("stderr", pstderr);
    PySys_SetObject("__stderr__", pstderr);
    do { if ( --((PyObject*)(pstderr))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pstderr)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pstderr)))); } while (0);
    ...
    if (PySys_HasWarnOptions()) {
        ...
        if (warnings_module == ((void *)0)) {
            fprintf(__stderrp, "'import warnings' failed; traceback:\n");
            PyErr_Print();
        }
        do { if ((warnings_module) == ((void *)0)) ; else do { if ( --((PyObject*)(warnings_module))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(warnings_module)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(warnings_module)))); } while (0); } while (0);
    }
...
flush_std_files(void)
{
    ...
    if (fout != ((void *)0) && fout != (&_Py_NoneStruct) && !file_is_closed(fout)) {
    ...
    if (ferr != ((void *)0) && ferr != (&_Py_NoneStruct) && !file_is_closed(ferr)) {
...
# 585 "pythonrun.c"
    ...
    if (!Py_HasFileSystemDefaultEncoding && Py_FileSystemDefaultEncoding) {
        ...
        Py_FileSystemDefaultEncoding = ((void *)0);
    }
...
Py_EndInterpreter(PyThreadState *tstate)
{
    ...
    if (tstate != ((PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; })))
        Py_FatalError("Py_EndInterpreter: thread is not current");
    if (tstate->frame != ((void *)0))
        Py_FatalError("Py_EndInterpreter: thread still has a frame");
    if (tstate != interp->tstate_head || tstate->next != ((void *)0))
...
static wchar_t *default_home = ((void *)0);
static wchar_t env_home[1024 +1];
...
Py_GetPythonHome(void)
{
    ...
    if (home == ((void *)0) && !Py_IgnoreEnvironmentFlag) {
        char* chome = (Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONHOME"));
        if (chome) {
            size_t r = mbstowcs(env_home, chome, 1024 +1);
            if (r != (size_t)-1 && r <= 1024)
                home = env_home;
        }
...
initmain(PyInterpreterState *interp)
{
    ...
    if (PyDict_GetItemString(d, "__builtins__") == ((void *)0)) {
        ...
        do { if ( --((PyObject*)(bimod))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(bimod)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(bimod)))); } while (0);
    }
    ...
    if (PyDict_GetItemString(d, "__loader__") == ((void *)0)) {
        ...
        do { if ( --((PyObject*)(loader))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(loader)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(loader)))); } while (0);
    }
}
...
initfsencoding(PyInterpreterState *interp)
{
    ...
    if (Py_FileSystemDefaultEncoding == ((void *)0))
    {
    ...
    do { if ( --((PyObject*)(codec))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(codec)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(codec)))); } while (0);
    interp->fscodec_initialized = 1;
    return 0;
}
...
{
    PyObject *buf = ((void *)0), *stream = ((void *)0), *text = ((void *)0), *raw = ((void *)0), *res;
    const char* mode;
    const char* newline;
    PyObject *line_buffering;
    int buffering, isatty;
    static _Py_Identifier PyId_open = { 0, "open", 0 };
    static _Py_Identifier PyId_isatty = { 0, "isatty", 0 };
    static _Py_Identifier PyId_TextIOWrapper = { 0, "TextIOWrapper", 0 };
    static _Py_Identifier PyId_name = { 0, "name", 0 };
    static _Py_Identifier PyId_mode = { 0, "mode", 0 };
    ...
    buf = _PyObject_CallMethodId(io, &PyId_open, "isiOOOi",
                                 fd, mode, buffering,
                                 (&_Py_NoneStruct), (&_Py_NoneStruct), (&_Py_NoneStruct), 0);
    if (buf == ((void *)0))
        goto error;

    if (buffering) {
        static _Py_Identifier PyId_raw = { 0, "raw", 0 };
        ...
        raw = buf;
        ( ((PyObject*)(raw))->ob_refcnt++);
    }

    text = PyUnicode_FromString(name);
    if (text == ((void *)0) || _PyObject_SetAttrId(raw, &PyId_name, text) < 0)
        goto error;
    ...
    if (isatty || Py_UnbufferedStdioFlag)
        line_buffering = ((PyObject *) &_Py_TrueStruct);
    else
        line_buffering = ((PyObject *) &_Py_FalseStruct);

    do { if (raw) { PyObject *_py_tmp = (PyObject *)(raw); (raw) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (text) { PyObject *_py_tmp = (PyObject *)(text); (text) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
# 982 "pythonrun.c"
    newline = "\n";
    ...
    do { if (buf) { PyObject *_py_tmp = (PyObject *)(buf); (buf) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    if (stream == ((void *)0))
        goto error;
...
error:
    ...
    do { if ((stream) == ((void *)0)) ; else do { if ( --((PyObject*)(stream))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(stream)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(stream)))); } while (0); } while (0);
    do { if ((text) == ((void *)0)) ; else do { if ( --((PyObject*)(text))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(text)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(text)))); } while (0); } while (0);
    do { if ((raw) == ((void *)0)) ; else do { if ( --((PyObject*)(raw))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(raw)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(raw)))); } while (0); } while (0);
    return ((void *)0);
}
...
initstdio(void)
{
    PyObject *iomod = ((void *)0), *wrapper;
    PyObject *bimod = ((void *)0);
    PyObject *m;
    PyObject *std = ((void *)0);
    int status = 0, fd;
    PyObject * encoding_attr;
    char *encoding = ((void *)0), *errors;



    if ((m = PyImport_ImportModule("encodings.utf_8")) == ((void *)0)) {
        goto error;
    }
    do { if ( --((PyObject*)(m))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(m)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(m)))); } while (0);
    ...
    if (PyObject_SetAttrString(bimod, "open", wrapper) == -1) {
        do { if ( --((PyObject*)(wrapper))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(wrapper)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(wrapper)))); } while (0);
        goto error;
    }
    do { if ( --((PyObject*)(wrapper))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(wrapper)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(wrapper)))); } while (0);

    encoding = (Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONIOENCODING"));
    errors = ((void *)0);
    if (encoding) {
    ...
    do { if ( --((PyObject*)(std))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(std)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(std)))); } while (0);
    ...
    if (encoding_attr != ((void *)0)) {
        const char * encoding;
        encoding = PyUnicode_AsUTF8(encoding_attr);
        if (encoding != ((void *)0)) {
            PyObject *codec_info = _PyCodec_Lookup(encoding);
            do { if ((codec_info) == ((void *)0)) ; else do { if ( --((PyObject*)(codec_info))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(codec_info)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(codec_info)))); } while (0); } while (0);
        }
        do { if ( --((PyObject*)(encoding_attr))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(encoding_attr)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(encoding_attr)))); } while (0);
    }
    PyErr_Clear();
  ...
  error:
    ...
    if (encoding)
        free(encoding);
    do { if ((bimod) == ((void *)0)) ; else do { if ( --((PyObject*)(bimod))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(bimod)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(bimod)))); } while (0); } while (0);
    do { if ((iomod) == ((void *)0)) ; else do { if ( --((PyObject*)(iomod))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(iomod)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(iomod)))); } while (0); } while (0);
    return status;
}
...
static int PARSER_FLAGS(PyCompilerFlags *flags)
{
    ...
    if (!flags)
        return 0;
    if (flags->cf_flags & 0x0200)
        parser_flags |= 0x0002;
    if (flags->cf_flags & 0x0800)
        parser_flags |= 0x0010;
    if (flags->cf_flags & 0x40000)
        parser_flags |= 0x0020;
    return parser_flags;
}
# 1229 "pythonrun.c"
...
{
    PyObject *m, *d, *v, *w, *oenc = ((void *)0);
    mod_ty mod;
    PyArena *arena;
    char *ps1 = "", *ps2 = "", *enc = ((void *)0);
    int errcode = 0;
    ...
    if (w != ((void *)0)) {
        ...
        if (w == ((void *)0))
            PyErr_Clear();
        else if (((((((PyObject*)(w))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
    ...
    if (arena == ((void *)0)) {
        ...
        do { if ((oenc) == ((void *)0)) ; else do { if ( --((PyObject*)(oenc))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(oenc)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(oenc)))); } while (0); } while (0);
        return -1;
    }
...
static set_main_loader(PyObject *d, const char *filename, const char *loader_name)
{
    ...
    do { if ( --((PyObject*)(loader_type))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(loader_type)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(loader_type)))); } while (0);
    if (loader == ((void *)0)) {
        return -1;
    }
    if (PyDict_SetItemString(d, "__loader__", loader) < 0) {
                        ...
                        PyCompilerFlags *flags)
{
    ...
    d = PyModule_GetDict(m);
    if (PyDict_GetItemString(d, "__file__") == ((void *)0)) {
        PyObject *f;
        ...
        if (PyDict_SetItemString(d, "__cached__", (&_Py_NoneStruct)) < 0) {
            do { if ( --((PyObject*)(f))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(f)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(f)))); } while (0);
            goto done;
        }
        set_file_name = 1;
    ...
    if (maybe_pyc_file(fp, filename, ext, closeit)) {
        ...
        if (closeit)
            fclose(fp);
        if ((pyc_fp = fopen(filename, "rb")) == ((void *)0)) {
            fprintf(__stderrp, "python: Can't reopen .pyc file\n");
            goto done;
        }
        ...
        if (set_main_loader(d, filename, "SourcelessFileLoader") < 0) {
            fprintf(__stderrp, "python: failed to set __main__.__loader__\n");
            ret = -1;
            fclose(pyc_fp);
            goto done;
        }
        ...
        v = PyRun_FileExFlags(fp, filename, 257, d, d,
                              closeit, flags);
    }
    flush_io();
    if (v == ((void *)0)) {
                   ...
                   int *lineno, int *offset, const char **text)
{
    ...
    static _Py_Identifier PyId_filename = { 0, "filename", 0 };
    static _Py_Identifier PyId_lineno = { 0, "lineno", 0 };
    static _Py_Identifier PyId_offset = { 0, "offset", 0 };
    ...
    *lineno = (int)hold;
    ...
    do { if ((*message) == ((void *)0)) ; else do { if ( --((PyObject*)(*message))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(*message)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(*message)))); } while (0); } while (0);
    return 0;
}
...
handle_system_exit(void)
{
    ...
    fflush(__stdoutp);
    if (value == ((void *)0) || value == (&_Py_NoneStruct))
        goto done;
    if (((((value)->ob_type)->tp_flags & ((1L<<30))) != 0)) {

        static _Py_Identifier PyId_code = { 0, "code", 0 };
    ...
    if (((((((PyObject*)(value))->ob_type))->tp_flags & ((1L<<24))) != 0))
        ...
        if (sys_stderr != ((void *)0) && sys_stderr != (&_Py_NoneStruct)) {
            PyFile_WriteObject(value, sys_stderr, 1);
        } else {
            PyObject_Print(value, __stderrp, 1);
            fflush(__stderrp);
        }
        PySys_WriteStderr("\n");
        exitcode = 1;
...
PyErr_PrintEx(int set_sys_last_vars)
{
    ...
    if (hook) {
        ...
        PyObject *result = PyEval_CallObjectWithKeywords(hook, args, (PyObject *)((void *)0));
        if (result == ((void *)0)) {
            ...
            if (exception2 == ((void *)0)) {
                exception2 = (&_Py_NoneStruct);
                ( ((PyObject*)(exception2))->ob_refcnt++);
            }
            if (v2 == ((void *)0)) {
                v2 = (&_Py_NoneStruct);
                ( ((PyObject*)(v2))->ob_refcnt++);
            }
            fflush(__stdoutp);
            ...
            do { if ( --((PyObject*)(exception2))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(exception2)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(exception2)))); } while (0);
            do { if ( --((PyObject*)(v2))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(v2)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(v2)))); } while (0);
            do { if ((tb2) == ((void *)0)) ; else do { if ( --((PyObject*)(tb2))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tb2)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tb2)))); } while (0); } while (0);
        }
    ...
    do { if ((exception) == ((void *)0)) ; else do { if ( --((PyObject*)(exception))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(exception)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(exception)))); } while (0); } while (0);
    do { if ((v) == ((void *)0)) ; else do { if ( --((PyObject*)(v))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(v)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(v)))); } while (0); } while (0);
...
print_exception(PyObject *f, PyObject *value)
{
    int err = 0;
    PyObject *type, *tb;
    static _Py_Identifier PyId_print_file_and_line = { 0, "print_file_and_line", 0 };

    if (!((((value)->ob_type)->tp_flags & ((1L<<30))) != 0)) {
        PyFile_WriteString("TypeError: print_exception(): Exception expected for value, ", f);
        PyFile_WriteString((((PyObject*)(value))->ob_type)->tp_name, f);
    ...
    if (err) {
        ...
        (__builtin_expect(!((((((((PyObject*)((type)))->ob_type))->tp_flags & ((1L<<31))) != 0) && ((((PyTypeObject*)(type))->tp_flags & ((1L<<30))) != 0))), 0) ? __assert_rtn(__func__, "pythonrun.c", 1772, "PyExceptionClass_Check(type)") : (void)0);
        className = ((char *)(((PyTypeObject*)(type))->tp_name));
        if (className != ((void *)0)) {
        ...
        if (moduleName == ((void *)0) || !((((((PyObject*)(moduleName))->ob_type))->tp_flags & ((1L<<28))) != 0))
        {
            do { if ((moduleName) == ((void *)0)) ; else do { if ( --((PyObject*)(moduleName))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(moduleName)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(moduleName)))); } while (0); } while (0);
            err = PyFile_WriteString("<unknown>", f);
        }
        else {
            char* modstr = PyUnicode_AsUTF8(moduleName);
            if (modstr && strcmp(modstr, "builtins"))
            {
                err = PyFile_WriteString(modstr, f);
                err += PyFile_WriteString(".", f);
            }
            do { if ( --((PyObject*)(moduleName))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(moduleName)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(moduleName)))); } while (0);
        }
        if (err == 0) {
            if (className == ((void *)0))
                      err = PyFile_WriteString("<unknown>", f);
    ...
    if (err == 0 && (value != (&_Py_NoneStruct))) {
        ...
        if (s == ((void *)0))
            err = -1;
        else if (!((((((PyObject*)(s))->ob_type))->tp_flags & ((1L<<28))) != 0) ||
            PyUnicode_GetLength(s) != 0)
            err = PyFile_WriteString(": ", f);
        if (err == 0)
          err = PyFile_WriteObject(s, f, 1);
...
print_exception_recursive(PyObject *f, PyObject *value, PyObject *seen)
{
    ...
    if (seen != ((void *)0)) {
        ...
        if (PySet_Add(seen, value) == -1)
            PyErr_Clear();
        else if (((((value)->ob_type)->tp_flags & ((1L<<30))) != 0)) {
            ...
            do { if ((context) == ((void *)0)) ; else do { if ( --((PyObject*)(context))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(context)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(context)))); } while (0); } while (0);
...
PyErr_Display(PyObject *exception, PyObject *value, PyObject *tb)
{
    ...
    if (f == (&_Py_NoneStruct)) {
        ...
        fprintf(__stderrp, "lost sys.stderr\n");
    }
    else {



        seen = PySet_New(((void *)0));
        if (seen == ((void *)0))
            PyErr_Clear();
        print_exception_recursive(f, value, seen);
        do { if ((seen) == ((void *)0)) ; else do { if ( --((PyObject*)(seen))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(seen)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(seen)))); } while (0); } while (0);
    }
}
                  ...
                  PyObject *locals, int closeit, PyCompilerFlags *flags)
{
    ...
    mod = PyParser_ASTFromFile(fp, filename, ((void *)0), start, 0, 0,
                               flags, ((void *)0), arena);
    if (closeit)
        fclose(fp);
    if (mod == ((void *)0)) {
         ...
         PyCompilerFlags *flags, PyArena *arena)
{
    PyCodeObject *co;
    PyObject *v;
    co = PyAST_CompileEx(mod, filename, flags, -1, arena);
    if (co == ((void *)0))
        return ((void *)0);
             ...
             PyObject *locals, PyCompilerFlags *flags)
{
    ...
    if (v == ((void *)0) || !((((PyObject*)(v))->ob_type) == &PyCode_Type)) {
        do { if ((v) == ((void *)0)) ; else do { if ( --((PyObject*)(v))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(v)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(v)))); } while (0); } while (0);
        PyErr_SetString(PyExc_RuntimeError,
    ...
    v = PyEval_EvalCode((PyObject*)co, globals, locals);
    if (v && flags)
        flags->cf_flags |= (co->co_flags & (0x2000 | 0x4000 | 0x8000 | 0x10000 | 0x20000 | 0x40000));
    do { if ( --((PyObject*)(co))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(co)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(co)))); } while (0);
    return v;
}
                        ...
                        PyCompilerFlags *flags, int optimize)
{
    ...
    if (flags && (flags->cf_flags & 0x0400)) {
...
{
    return Py_CompileStringExFlags(str, filename, start, ((void *)0), -1);
}
                       ...
                       PyCompilerFlags *flags, PyArena *arena)
{
    ...
    if (n) {
        flags->cf_flags |= iflags & (0x2000 | 0x4000 | 0x8000 | 0x10000 | 0x20000 | 0x40000);
...
{
    perrdetail err;
    node *n = PyParser_ParseFileFlags(fp, filename, ((void *)0),
                                      &_PyParser_Grammar,
                                      start, ((void *)0), ((void *)0), &err, flags);
    if (n == ((void *)0))
        err_input(&err);
    err_free(&err);
...
{
    do { if (err->filename) { PyObject *_py_tmp = (PyObject *)(err->filename); (err->filename) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
}
...
err_input(perrdetail *err)
{
    ...
    do { if ((w) == ((void *)0)) ; else do { if ( --((PyObject*)(w))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(w)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(w)))); } while (0); } while (0);
cleanup:
    do { if ((msg_obj) == ((void *)0)) ; else do { if ( --((PyObject*)(msg_obj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(msg_obj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(msg_obj)))); } while (0); } while (0);
    if (err->text != ((void *)0)) {
...
{
    const int fd = fileno(__stderrp);
    PyThreadState *tstate;

    fprintf(__stderrp, "Fatal Python error: %s\n", msg);
    fflush(__stderrp);
    if (PyErr_Occurred()) {
        PyErr_PrintEx(0);
    }
    else {
        tstate = __extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; });
        if (tstate != ((void *)0)) {
            fputc('\n', __stderrp);
            fflush(__stderrp);
...
static void (*pyexitfunc)(void) = ((void *)0);
...
wait_for_thread_shutdown(void)
{
    ...
    static _Py_Identifier PyId__shutdown = { 0, "_shutdown", 0 };
    PyObject *result;
...
initsigs(void)
{
    ...
    PyOS_setsig(13, (void (*)(int))1);





    PyOS_setsig(25, (void (*)(int))1);
...
_Py_RestoreSignals(void)
{
    ...
    PyOS_setsig(13, (void (*)(int))0);





    PyOS_setsig(25, (void (*)(int))0);
...
PyOS_getsig(int sig)
{
    ...
    if (sigaction(sig, ((void *)0), &context) == -1)
        return ((void (*)(int))-1);
    return context.__sigaction_u.__sa_handler;
# 2578 "pythonrun.c"
}
...
PyOS_setsig(int sig, PyOS_sighandler_t handler)
{
    ...
    context.__sigaction_u.__sa_handler = handler;
    (*(&context.sa_mask) = 0, 0);
    context.sa_flags = 0;
    if (sigaction(sig, &context, &ocontext) == -1)
        return ((void (*)(int))-1);
    return ocontext.__sigaction_u.__sa_handler;
# 2608 "pythonrun.c"
}
...
{
    return PyRun_AnyFileExFlags(fp, name, 0, ((void *)0));
}
...
{
    return PyRun_AnyFileExFlags(fp, name, closeit, ((void *)0));
}
...
{
    return PyRun_FileExFlags(fp, p, s, g, l, 0, ((void *)0));
}
...
{
    return PyRun_FileExFlags(fp, p, s, g, l, c, ((void *)0));
}
...
{
    return PyRun_SimpleFileExFlags(f, p, 0, ((void *)0));
}
...
{
    return PyRun_SimpleFileExFlags(f, p, c, ((void *)0));
}
...
{
    return PyRun_StringFlags(str, s, g, l, ((void *)0));
}
...
{
    return PyRun_SimpleStringFlags(s, ((void *)0));
}
...
{
    return Py_CompileStringExFlags(str, p, s, ((void *)0), -1);
}
...
{
    return PyRun_InteractiveOneFlags(f, p, ((void *)0));
}
...
{
    return PyRun_InteractiveLoopFlags(f, p, ((void *)0));
}
