...
array_resize(arrayobject *self, Py_ssize_t newsize)
{
    ...
    if (self->ob_exports > 0 && newsize != (((PyVarObject*)(self))->ob_size)) {
    ...
    if (self->allocated >= newsize &&
        (((PyVarObject*)(self))->ob_size) < newsize + 16 &&
        self->ob_item != ((void *)0)) {
...
# 92 "arraymodule.c"
    _new_size = (newsize >> 4) + ((((PyVarObject*)(self))->ob_size) < 8 ? 3 : 7) + newsize;
    items = self->ob_item;


    if (_new_size <= ((~(size_t)0) / self->ob_descr->itemsize))
        ( (items) = ((size_t)((_new_size * self->ob_descr->itemsize)) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(char)) ? ((void *)0) : (char *) ((size_t)(((_new_size * self->ob_descr->itemsize)) * sizeof(char)) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : realloc(((items)), (((_new_size * self->ob_descr->itemsize)) * sizeof(char)) ? (((_new_size * self->ob_descr->itemsize)) * sizeof(char)) : 1)) );
    else
        items = ((void *)0);
    if (items == ((void *)0)) {
        PyErr_NoMemory();
...
b_setitem(arrayobject *ap, Py_ssize_t i, PyObject *v)
{
    ...
    if (!_PyArg_Parse_SizeT(v, "h;array item must be integer", &x))
        return -1;
    else if (x < -128) {
...
BB_setitem(arrayobject *ap, Py_ssize_t i, PyObject *v)
{
    ...
    if (!_PyArg_Parse_SizeT(v, "b;array item must be integer", &x))
        return -1;
    if (i >= 0)
        ((char *)ap->ob_item)[i] = x;
    return 0;
...
u_setitem(arrayobject *ap, Py_ssize_t i, PyObject *v)
{
    ...
    if (!_PyArg_Parse_SizeT(v, "u#;array item must be unicode character", &p, &len))
        return -1;
    if (len != 1) {
...
HH_setitem(arrayobject *ap, Py_ssize_t i, PyObject *v)
{
    ...
    if (!_PyArg_Parse_SizeT(v, "i;array item must be integer", &x))
        return -1;
    else if (x < 0) {
        PyErr_SetString(PyExc_OverflowError,
...
II_setitem(arrayobject *ap, Py_ssize_t i, PyObject *v)
{
    ...
    if (((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<24))) != 0)) {
        ...
        long y;
        if (!_PyArg_Parse_SizeT(v, "l;array item must be integer", &y))
            return -1;
        if (y < 0) {
            PyErr_SetString(PyExc_OverflowError,
...
{
    long x;
    if (!_PyArg_Parse_SizeT(v, "l;array item must be integer", &x))
        return -1;
    if (i >= 0)
                 ((long *)ap->ob_item)[i] = x;
    return 0;
...
LL_setitem(arrayobject *ap, Py_ssize_t i, PyObject *v)
{
    ...
    if (x > (9223372036854775807L * 2UL + 1UL)) {
        PyErr_SetString(PyExc_OverflowError,
...
{
    float x;
    if (!_PyArg_Parse_SizeT(v, "f;array item must be float", &x))
        return -1;
    if (i >= 0)
...
{
    double x;
    if (!_PyArg_Parse_SizeT(v, "d;array item must be float", &x))
        return -1;
    if (i >= 0)
...
newarrayobject(PyTypeObject *type, Py_ssize_t size, struct arraydescr *descr)
{
    ...
    if (size < 0) {
        _PyErr_BadInternalCall("arraymodule.c", 482);
        return ((void *)0);
    }


    if (size > ((Py_ssize_t)(((size_t)-1)>>1)) / descr->itemsize) {
    ...
    op->ob_descr = descr;
    op->allocated = size;
    op->weakreflist = ((void *)0);
    (((PyVarObject*)(op))->ob_size) = size;
    if (size <= 0) {
        op->ob_item = ((void *)0);
    }
    else {
        op->ob_item = ( ((size_t)(nbytes) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(char)) ? ((void *)0) : ( (char *) ((size_t)((nbytes) * sizeof(char)) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc(((nbytes) * sizeof(char)) ? ((nbytes) * sizeof(char)) : 1)) ) );
...
getarrayitem(PyObject *op, Py_ssize_t i)
{
    ...
    (__builtin_expect(!(((((PyObject*)(op))->ob_type) == (&Arraytype) || PyType_IsSubtype((((PyObject*)(op))->ob_type), (&Arraytype)))), 0) ? __assert_rtn(__func__, "arraymodule.c", 517, "array_Check(op)") : (void)0);
    ap = (arrayobject *)op;
    (__builtin_expect(!(i>=0 && i<(((PyVarObject*)(ap))->ob_size)), 0) ? __assert_rtn(__func__, "arraymodule.c", 519, "i>=0 && i<Py_SIZE(ap)") : (void)0);
...
ins1(arrayobject *self, Py_ssize_t where, PyObject *v)
{
    ...
    if (v == ((void *)0)) {
        _PyErr_BadInternalCall("arraymodule.c", 529);
        return -1;
    }
    ...
    if (where != n)
        ((__builtin_object_size (items + (where+1)*self->ob_descr->itemsize, 0) != (size_t) -1) ? __builtin___memmove_chk (items + (where+1)*self->ob_descr->itemsize, items + where*self->ob_descr->itemsize, (n-where)*self->ob_descr->itemsize, __builtin_object_size (items + (where+1)*self->ob_descr->itemsize, 0)) : __inline_memmove_chk (items + (where+1)*self->ob_descr->itemsize, items + where*self->ob_descr->itemsize, (n-where)*self->ob_descr->itemsize));
...
array_richcompare(PyObject *v, PyObject *w, int op)
{
    ...
    if (!((((PyObject*)(v))->ob_type) == (&Arraytype) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&Arraytype))) || !((((PyObject*)(w))->ob_type) == (&Arraytype) || PyType_IsSubtype((((PyObject*)(w))->ob_type), (&Arraytype))))
        return ( ((PyObject*)((&_Py_NotImplementedStruct)))->ob_refcnt++), (&_Py_NotImplementedStruct);

    va = (arrayobject *)v;
    wa = (arrayobject *)w;

    if ((((PyVarObject*)(va))->ob_size) != (((PyVarObject*)(wa))->ob_size) && (op == 2 || op == 3)) {
    ...
    k = 1;
    for (i = 0; i < (((PyVarObject*)(va))->ob_size) && i < (((PyVarObject*)(wa))->ob_size); i++) {
        vi = getarrayitem(v, i);
        wi = getarrayitem(w, i);
        if (vi == ((void *)0) || wi == ((void *)0)) {
            do { if ((vi) == ((void *)0)) ; else do { if ( --((PyObject*)(vi))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(vi)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(vi)))); } while (0); } while (0);
            do { if ((wi) == ((void *)0)) ; else do { if ( --((PyObject*)(wi))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(wi)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(wi)))); } while (0); } while (0);
            return ((void *)0);
        }
        k = PyObject_RichCompareBool(vi, wi, 2);
        if (k == 0)
            break;
        do { if ( --((PyObject*)(vi))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(vi)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(vi)))); } while (0);
        do { if ( --((PyObject*)(wi))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(wi)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(wi)))); } while (0);
        if (k < 0)
            return ((void *)0);
    }
    ...
    if (k) {
        ...
        Py_ssize_t vs = (((PyVarObject*)(va))->ob_size);
        Py_ssize_t ws = (((PyVarObject*)(wa))->ob_size);
        int cmp;
        switch (op) {
...
array_slice(arrayobject *a, Py_ssize_t ilow, Py_ssize_t ihigh)
{
    ...
    if (np == ((void *)0))
        return ((void *)0);
    ((__builtin_object_size (np->ob_item, 0) != (size_t) -1) ? __builtin___memcpy_chk (np->ob_item, a->ob_item + ilow * a->ob_descr->itemsize, (ihigh-ilow) * a->ob_descr->itemsize, __builtin_object_size (np->ob_item, 0)) : __inline_memcpy_chk (np->ob_item, a->ob_item + ilow * a->ob_descr->itemsize, (ihigh-ilow) * a->ob_descr->itemsize));
...
{
    return array_slice(a, 0, (((PyVarObject*)(a))->ob_size));
}

static char copy_doc[] = "copy(array)\n\n Return a copy of the array.";
...
array_concat(arrayobject *a, PyObject *bb)
{
    Py_ssize_t size;
    arrayobject *np;
    if (!((((PyObject*)(bb))->ob_type) == (&Arraytype) || PyType_IsSubtype((((PyObject*)(bb))->ob_type), (&Arraytype)))) {
        PyErr_Format(PyExc_TypeError,
             "can only append array (not \"%.200s\") to array",
                 (((PyObject*)(bb))->ob_type)->tp_name);
        return ((void *)0);
    }

    if (a->ob_descr != ((arrayobject *)bb)->ob_descr) {
        PyErr_BadArgument();
        return ((void *)0);
    }
    if ((((PyVarObject*)(a))->ob_size) > ((Py_ssize_t)(((size_t)-1)>>1)) - (((PyVarObject*)(((arrayobject *)bb)))->ob_size)) {
        return PyErr_NoMemory();
    }
    size = (((PyVarObject*)(a))->ob_size) + (((PyVarObject*)(((arrayobject *)bb)))->ob_size);
    np = (arrayobject *) newarrayobject(&Arraytype, size, a->ob_descr);
    if (np == ((void *)0)) {
        return ((void *)0);
    }
    ((__builtin_object_size (np->ob_item, 0) != (size_t) -1) ? __builtin___memcpy_chk (np->ob_item, a->ob_item, (((PyVarObject*)(a))->ob_size)*a->ob_descr->itemsize, __builtin_object_size (np->ob_item, 0)) : __inline_memcpy_chk (np->ob_item, a->ob_item, (((PyVarObject*)(a))->ob_size)*a->ob_descr->itemsize));
    ((__builtin_object_size (np->ob_item + (((PyVarObject*)(a))->ob_size)*a->ob_descr->itemsize, 0) != (size_t) -1) ? __builtin___memcpy_chk (np->ob_item + (((PyVarObject*)(a))->ob_size)*a->ob_descr->itemsize, ((arrayobject *)bb)->ob_item, (((PyVarObject*)(((arrayobject *)bb)))->ob_size)*((arrayobject *)bb)->ob_descr->itemsize, __builtin_object_size (np->ob_item + (((PyVarObject*)(a))->ob_size)*a->ob_descr->itemsize, 0)) : __inline_memcpy_chk (np->ob_item + (((PyVarObject*)(a))->ob_size)*a->ob_descr->itemsize, ((arrayobject *)bb)->ob_item, (((PyVarObject*)(((arrayobject *)bb)))->ob_size)*((arrayobject *)bb)->ob_descr->itemsize));
...
array_repeat(arrayobject *a, Py_ssize_t n)
{
    ...
    if (n < 0)
        n = 0;
    if (((((PyVarObject*)(a))->ob_size) != 0) && (n > ((Py_ssize_t)(((size_t)-1)>>1)) / (((PyVarObject*)(a))->ob_size))) {
        return PyErr_NoMemory();
    }
    ...
    if (n == 0)
        return (PyObject *)np;
    oldbytes = (((PyVarObject*)(a))->ob_size) * a->ob_descr->itemsize;
    newbytes = oldbytes * n;

    if (oldbytes == 1) {
        ((__builtin_object_size (np->ob_item, 0) != (size_t) -1) ? __builtin___memset_chk (np->ob_item, a->ob_item[0], newbytes, __builtin_object_size (np->ob_item, 0)) : __inline_memset_chk (np->ob_item, a->ob_item[0], newbytes));
    } else {
        Py_ssize_t done = oldbytes;
        ((__builtin_object_size (np->ob_item, 0) != (size_t) -1) ? __builtin___memcpy_chk (np->ob_item, a->ob_item, oldbytes, __builtin_object_size (np->ob_item, 0)) : __inline_memcpy_chk (np->ob_item, a->ob_item, oldbytes));
        while (done < newbytes) {
            Py_ssize_t ncopy = (done <= newbytes-done) ? done : newbytes-done;
            ((__builtin_object_size (np->ob_item+done, 0) != (size_t) -1) ? __builtin___memcpy_chk (np->ob_item+done, np->ob_item, ncopy, __builtin_object_size (np->ob_item+done, 0)) : __inline_memcpy_chk (np->ob_item+done, np->ob_item, ncopy));
            done += ncopy;
        }
    }
    return (PyObject *)np;
...
array_ass_slice(arrayobject *a, Py_ssize_t ilow, Py_ssize_t ihigh, PyObject *v)
{
    ...
    if (v == ((void *)0))
        n = 0;
    else if (((((PyObject*)(v))->ob_type) == (&Arraytype) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&Arraytype)))) {
        n = (((PyVarObject*)(((arrayobject *)v)))->ob_size);
        if (a == ((arrayobject *)v)) {

            int ret;
            v = array_slice(((arrayobject *)v), 0, n);
            if (!v)
                return -1;
        ...
        if (((arrayobject *)v)->ob_descr != a->ob_descr) {
            PyErr_BadArgument();
            return -1;
        }
    }
    ...
    if (d < 0) {
        ((__builtin_object_size (item + (ihigh+d)*a->ob_descr->itemsize, 0) != (size_t) -1) ? __builtin___memmove_chk (item + (ihigh+d)*a->ob_descr->itemsize, item + ihigh*a->ob_descr->itemsize, ((((PyVarObject*)(a))->ob_size)-ihigh)*a->ob_descr->itemsize, __builtin_object_size (item + (ihigh+d)*a->ob_descr->itemsize, 0)) : __inline_memmove_chk (item + (ihigh+d)*a->ob_descr->itemsize, item + ihigh*a->ob_descr->itemsize, ((((PyVarObject*)(a))->ob_size)-ihigh)*a->ob_descr->itemsize));


        if (array_resize(a, (((PyVarObject*)(a))->ob_size) + d) == -1)
            return -1;
    }
    else if (d > 0) {
        if (array_resize(a, (((PyVarObject*)(a))->ob_size) + d))
            return -1;
        ((__builtin_object_size (item + (ihigh+d)*a->ob_descr->itemsize, 0) != (size_t) -1) ? __builtin___memmove_chk (item + (ihigh+d)*a->ob_descr->itemsize, item + ihigh*a->ob_descr->itemsize, ((((PyVarObject*)(a))->ob_size)-ihigh)*a->ob_descr->itemsize, __builtin_object_size (item + (ihigh+d)*a->ob_descr->itemsize, 0)) : __inline_memmove_chk (item + (ihigh+d)*a->ob_descr->itemsize, item + ihigh*a->ob_descr->itemsize, ((((PyVarObject*)(a))->ob_size)-ihigh)*a->ob_descr->itemsize));
    ...
    if (n > 0)
        ((__builtin_object_size (item + ilow*a->ob_descr->itemsize, 0) != (size_t) -1) ? __builtin___memcpy_chk (item + ilow*a->ob_descr->itemsize, ((arrayobject *)v)->ob_item, n*((arrayobject *)v)->ob_descr->itemsize, __builtin_object_size (item + ilow*a->ob_descr->itemsize, 0)) : __inline_memcpy_chk (item + ilow*a->ob_descr->itemsize, ((arrayobject *)v)->ob_item, n*((arrayobject *)v)->ob_descr->itemsize));
...
{
    (__builtin_expect(!(((((PyObject*)(a))->ob_type) == (&Arraytype) || PyType_IsSubtype((((PyObject*)(a))->ob_type), (&Arraytype)))), 0) ? __assert_rtn(__func__, "arraymodule.c", 852, "array_Check(a)") : (void)0);
...
array_iter_extend(arrayobject *self, PyObject *bb)
{
    ...
    while ((v = PyIter_Next(it)) != ((void *)0)) {
        if (ins1(self, (((PyVarObject*)(self))->ob_size), v) != 0) {
            do { if ( --((PyObject*)(v))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(v)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(v)))); } while (0);
...
array_do_extend(arrayobject *self, PyObject *bb)
{
    ...
    if (self->ob_descr != ((arrayobject *)bb)->ob_descr) {
        PyErr_SetString(PyExc_TypeError,
                     "can only extend with array of same kind");
        return -1;
    }
    if (((((PyVarObject*)(self))->ob_size) > ((Py_ssize_t)(((size_t)-1)>>1)) - (((PyVarObject*)(((arrayobject *)bb)))->ob_size)) ||
        (((((PyVarObject*)(self))->ob_size) + (((PyVarObject*)(((arrayobject *)bb)))->ob_size)) > ((Py_ssize_t)(((size_t)-1)>>1)) / self->ob_descr->itemsize)) {
        PyErr_NoMemory();
        return -1;
    }
    oldsize = (((PyVarObject*)(self))->ob_size);

    bbsize = (((PyVarObject*)(bb))->ob_size);
    size = oldsize + (((PyVarObject*)(((arrayobject *)bb)))->ob_size);
    if (array_resize(self, size) == -1)
        return -1;
    ((__builtin_object_size (self->ob_item + oldsize * self->ob_descr->itemsize, 0) != (size_t) -1) ? __builtin___memcpy_chk (self->ob_item + oldsize * self->ob_descr->itemsize, ((arrayobject *)bb)->ob_item, bbsize * ((arrayobject *)bb)->ob_descr->itemsize, __builtin_object_size (self->ob_item + oldsize * self->ob_descr->itemsize, 0)) : __inline_memcpy_chk (self->ob_item + oldsize * self->ob_descr->itemsize, ((arrayobject *)bb)->ob_item, bbsize * ((arrayobject *)bb)->ob_descr->itemsize));
...
array_inplace_repeat(arrayobject *self, Py_ssize_t n)
{
    ...
    if ((((PyVarObject*)(self))->ob_size) > 0) {
        ...
        if ((self->ob_descr->itemsize != 0) &&
            ((((PyVarObject*)(self))->ob_size) > ((Py_ssize_t)(((size_t)-1)>>1)) / self->ob_descr->itemsize)) {
            return PyErr_NoMemory();
        }
        size = (((PyVarObject*)(self))->ob_size) * self->ob_descr->itemsize;
        if (n > 0 && size > ((Py_ssize_t)(((size_t)-1)>>1)) / n) {
            return PyErr_NoMemory();
        }
        if (array_resize(self, n * (((PyVarObject*)(self))->ob_size)) == -1)
            return ((void *)0);
        items = p = self->ob_item;
        for (i = 1; i < n; i++) {
            p += size;
            ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___memcpy_chk (p, items, size, __builtin_object_size (p, 0)) : __inline_memcpy_chk (p, items, size));
        }
    }
    ( ((PyObject*)(self))->ob_refcnt++);
    return (PyObject *)self;
...
array_count(arrayobject *self, PyObject *v)
{
    ...
    for (i = 0; i < (((PyVarObject*)(self))->ob_size); i++) {
        ...
        int cmp = PyObject_RichCompareBool(selfi, v, 2);
        do { if ( --((PyObject*)(selfi))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(selfi)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(selfi)))); } while (0);
        if (cmp > 0)
            count++;
        else if (cmp < 0)
            return ((void *)0);
...
array_contains(arrayobject *self, PyObject *v)
{
    ...
    for (i = 0, cmp = 0 ; cmp == 0 && i < (((PyVarObject*)(self))->ob_size); i++) {
        PyObject *selfi = getarrayitem((PyObject *)self, i);
        cmp = PyObject_RichCompareBool(selfi, v, 2);
        do { if ( --((PyObject*)(selfi))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(selfi)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(selfi)))); } while (0);
    }
    return cmp;
}
...
static char remove_doc[] = "remove(x)\n\nRemove the first occurrence of x in the array.";
...
array_pop(arrayobject *self, PyObject *args)
{
    Py_ssize_t i = -1;
    PyObject *v;
    if (!_PyArg_ParseTuple_SizeT(args, "|n:pop", &i))
        return ((void *)0);
    if ((((PyVarObject*)(self))->ob_size) == 0) {
    ...
    if (array_ass_slice(self, i, i+1, (PyObject *)((void *)0)) != 0) {
        do { if ( --((PyObject*)(v))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(v)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(v)))); } while (0);
        return ((void *)0);
    }
    return v;
...
static char extend_doc[] = "extend(array or iterable)\n\n Append items to the end of the array.";
...
array_insert(arrayobject *self, PyObject *args)
{
    Py_ssize_t i;
    PyObject *v;
    if (!_PyArg_ParseTuple_SizeT(args, "nO:insert", &i, &v))
        return ((void *)0);
    return ins(self, i, v);
}

static char insert_doc[] = "insert(i,x)\n\nInsert a new item x into the array before position i.";
...
array_buffer_info(arrayobject *self, PyObject *unused)
{
    ...
    (((PyTupleObject *)(retval))->ob_item[0] = PyLong_FromVoidPtr(self->ob_item));
    (((PyTupleObject *)(retval))->ob_item[1] = PyLong_FromLong((long)((((PyVarObject*)(self))->ob_size))));

    return retval;
}

static char buffer_info_doc[] = "buffer_info() -> (address, length)\n\nReturn a tuple (address, length) giving the current memory address and\nthe length in items of the buffer used to hold array's contents\nThe length should be multiplied by the itemsize attribute to calculate\nthe buffer length in bytes.";
# 1137 "arraymodule.c"
static PyObject *
array_append(arrayobject *self, PyObject *v)
{
    return ins(self, (((PyVarObject*)(self))->ob_size), v);
}

static char append_doc[] = "append(x)\n\nAppend new value x to the end of the array.";
...
array_byteswap(arrayobject *self, PyObject *unused)
{
    ...
    case 1:
        break;
    case 2:
        for (p = self->ob_item, i = (((PyVarObject*)(self))->ob_size); --i >= 0; p += 2) {
            char p0 = p[0];
            p[0] = p[1];
            p[1] = p0;
        }
        break;
    case 4:
        for (p = self->ob_item, i = (((PyVarObject*)(self))->ob_size); --i >= 0; p += 4) {
            char p0 = p[0];
            char p1 = p[1];
            p[0] = p[3];
            p[1] = p[2];
        ...
        break;
    case 8:
        for (p = self->ob_item, i = (((PyVarObject*)(self))->ob_size); --i >= 0; p += 8) {
            char p0 = p[0];
            char p1 = p[1];
            char p2 = p[2];
            char p3 = p[3];
...
static char byteswap_doc[] = "byteswap()\n\nByteswap all items of the array.  If the items in the array are not 1, 2,\n4, or 8 bytes in size, RuntimeError is raised.";
...
array_reverse(arrayobject *self, PyObject *unused)
{
    ...
    char tmp[256];
    (__builtin_expect(!((size_t)itemsize <= sizeof(tmp)), 0) ? __assert_rtn(__func__, "arraymodule.c", 1213, "(size_t)itemsize <= sizeof(tmp)") : (void)0);

    if ((((PyVarObject*)(self))->ob_size) > 1) {
        for (p = self->ob_item,
             q = self->ob_item + ((((PyVarObject*)(self))->ob_size) - 1)*itemsize;
             p < q;
             p += itemsize, q -= itemsize) {



            ((__builtin_object_size (tmp, 0) != (size_t) -1) ? __builtin___memcpy_chk (tmp, p, itemsize, __builtin_object_size (tmp, 0)) : __inline_memcpy_chk (tmp, p, itemsize));
            ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___memcpy_chk (p, q, itemsize, __builtin_object_size (p, 0)) : __inline_memcpy_chk (p, q, itemsize));
            ((__builtin_object_size (q, 0) != (size_t) -1) ? __builtin___memcpy_chk (q, tmp, itemsize, __builtin_object_size (q, 0)) : __inline_memcpy_chk (q, tmp, itemsize));
        }
    }
...
static char reverse_doc[] = "reverse()\n\nReverse the order of the items in the array.";
...
array_fromfile(arrayobject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "On:fromfile", &f, &n))
        return ((void *)0);
    ...
    if (n > ((Py_ssize_t)(((size_t)-1)>>1)) / itemsize) {
        PyErr_NoMemory();
        return ((void *)0);
    }
    nbytes = n * itemsize;

    b = _PyObject_CallMethodId_SizeT(f, &PyId_read, "n", nbytes);
    if (b == ((void *)0))
        return ((void *)0);

    if (!((((((PyObject*)(b))->ob_type))->tp_flags & ((1L<<27))) != 0)) {
        PyErr_SetString(PyExc_TypeError,
    ...
    not_enough_bytes = (((__builtin_expect(!(((((((PyObject*)(b))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "arraymodule.c", 1275, "PyBytes_Check(b)") : (void)0),(((PyVarObject*)(b))->ob_size)) != nbytes);

    args = _Py_BuildValue_SizeT("(O)", b);
    do { if ( --((PyObject*)(b))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(b)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(b)))); } while (0);
    if (args == ((void *)0))
        return ((void *)0);
...
static char fromfile_doc[] = "fromfile(f, n)\n\nRead n objects from the file object f and append them to the end of the\narray.";
...
{
    Py_ssize_t nbytes = (((PyVarObject*)(self))->ob_size) * self->ob_descr->itemsize;
    ...
    for (i = 0; i < nblocks; i++) {
        ...
        if (bytes == ((void *)0))
            return ((void *)0);
        res = _PyObject_CallMethodId_SizeT(f, &PyId_write, "O", bytes);
...
static char tofile_doc[] = "tofile(f)\n\nWrite all items (as machine values) to the file object f.";
...
array_fromlist(arrayobject *self, PyObject *list)
{
    ...
    if (n > 0) {
        ...
        old_size = (((PyVarObject*)(self))->ob_size);
        if (array_resize(self, old_size + n) == -1)
            return ((void *)0);
        for (i = 0; i < n; i++) {
            PyObject *v = PyList_GetItem(list, i);
            if ((*self->ob_descr->setitem)(self,
                            (((PyVarObject*)(self))->ob_size) - n + i, v) != 0) {
...
static char fromlist_doc[] = "fromlist(list)\n\nAppend items to array from list.";
...
{
    PyObject *list = PyList_New((((PyVarObject*)(self))->ob_size));
    Py_ssize_t i;
...
static char tolist_doc[] = "tolist() -> list\n\nConvert array to an ordinary list with the same items.";
...
frombytes(arrayobject *self, Py_buffer *buffer)
{
    ...
    n = n / itemsize;
    if (n > 0) {
        Py_ssize_t old_size = (((PyVarObject*)(self))->ob_size);
        if ((n > ((Py_ssize_t)(((size_t)-1)>>1)) - old_size) ||
            ((old_size + n) > ((Py_ssize_t)(((size_t)-1)>>1)) / itemsize)) {
                PyBuffer_Release(buffer);
                return PyErr_NoMemory();
        }
        if (array_resize(self, old_size + n) == -1) {
        ...
        ((__builtin_object_size (self->ob_item + old_size * itemsize, 0) != (size_t) -1) ? __builtin___memcpy_chk (self->ob_item + old_size * itemsize, buffer->buf, n * itemsize, __builtin_object_size (self->ob_item + old_size * itemsize, 0)) : __inline_memcpy_chk (self->ob_item + old_size * itemsize, buffer->buf, n * itemsize));
...
array_fromstring(arrayobject *self, PyObject *args)
{
    ...
    if (PyErr_WarnEx(PyExc_DeprecationWarning,
        ...
        return ((void *)0);
    if (!_PyArg_ParseTuple_SizeT(args, "s*:fromstring", &buffer))
        return ((void *)0);
    else
        return frombytes(self, &buffer);
}

static char fromstring_doc[] = "fromstring(string)\n\nAppends items from the string, interpreting it as an array of machine\nvalues, as if it had been read from a file using the fromfile() method).\n\nThis method is deprecated. Use frombytes instead.";
# 1462 "arraymodule.c"
static PyObject *
array_frombytes(arrayobject *self, PyObject *args)
{
    Py_buffer buffer;
    if (!_PyArg_ParseTuple_SizeT(args, "y*:frombytes", &buffer))
        return ((void *)0);
    else
        return frombytes(self, &buffer);
}

static char frombytes_doc[] = "frombytes(bytestring)\n\nAppends items from the string, interpreting it as an array of machine\nvalues, as if it had been read from a file using the fromfile() method).";
...
{
    if ((((PyVarObject*)(self))->ob_size) <= ((Py_ssize_t)(((size_t)-1)>>1)) / self->ob_descr->itemsize) {
        return PyBytes_FromStringAndSize(self->ob_item,
                            (((PyVarObject*)(self))->ob_size) * self->ob_descr->itemsize);
    } else {
        return PyErr_NoMemory();
    }
}

static char tobytes_doc[] = "tobytes() -> bytes\n\nConvert the array to an array of machine values and return the bytes\nrepresentation.";
...
static char tostring_doc[] = "tostring() -> bytes\n\nConvert the array to an array of machine values and return the bytes\nrepresentation.\n\nThis method is deprecated. Use tobytes instead.";
# 1515 "arraymodule.c"
static PyObject *
array_fromunicode(arrayobject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "u#:fromunicode", &ustr, &n))
        return ((void *)0);
    ...
    if (n > 0) {
        ...
        if (array_resize(self, old_size + n) == -1)
            return ((void *)0);
        ((__builtin_object_size (self->ob_item + old_size * sizeof(Py_UNICODE), 0) != (size_t) -1) ? __builtin___memcpy_chk (self->ob_item + old_size * sizeof(Py_UNICODE), ustr, n * sizeof(Py_UNICODE), __builtin_object_size (self->ob_item + old_size * sizeof(Py_UNICODE), 0)) : __inline_memcpy_chk (self->ob_item + old_size * sizeof(Py_UNICODE), ustr, n * sizeof(Py_UNICODE)));
...
static char fromunicode_doc[] = "fromunicode(ustr)\n\nExtends this array with data from the unicode string ustr.\nThe array must be a unicode type array; otherwise a ValueError\nis raised.  Use array.frombytes(ustr.encode(...)) to\nappend Unicode data to an array of some other type.";
# 1552 "arraymodule.c"
static PyObject *
array_tounicode(arrayobject *self, PyObject *unused)
{
    ...
    return PyUnicode_FromUnicode((Py_UNICODE *) self->ob_item, (((PyVarObject*)(self))->ob_size));
}
...
static char sizeof_doc[] = "__sizeof__() -> int\n\nSize of the array in memory, in bytes.";
...
make_array(PyTypeObject *arraytype, char typecode, PyObject *items)
{
    ...
    (__builtin_expect(!(arraytype != ((void *)0)), 0) ? __assert_rtn(__func__, "arraymodule.c", 1781, "arraytype != NULL") : (void)0);
    (__builtin_expect(!(items != ((void *)0)), 0) ? __assert_rtn(__func__, "arraymodule.c", 1782, "items != NULL") : (void)0);

    typecode_obj = PyUnicode_FromOrdinal(typecode);
    if (typecode_obj == ((void *)0))
        return ((void *)0);

    new_args = PyTuple_New(2);
    if (new_args == ((void *)0))
        return ((void *)0);
    ( ((PyObject*)(items))->ob_refcnt++);
    (((PyTupleObject *)(new_args))->ob_item[0] = typecode_obj);
    (((PyTupleObject *)(new_args))->ob_item[1] = items);

    array_obj = array_new(arraytype, new_args, ((void *)0));
    do { if ( --((PyObject*)(new_args))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(new_args)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(new_args)))); } while (0);
    if (array_obj == ((void *)0))
        return ((void *)0);
...
array_reconstructor(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "OCiO:array._array_reconstructor",
                    &arraytype, &typecode, &mformat_code, &items))
        return ((void *)0);

    if (!((((((PyObject*)(arraytype))->ob_type))->tp_flags & ((1L<<31))) != 0)) {
        PyErr_Format(PyExc_TypeError,
            "first argument must a type object, not %.200s",
            (((PyObject*)(arraytype))->ob_type)->tp_name);
        return ((void *)0);
    }
    ...
    if (!((((((PyObject*)(items))->ob_type))->tp_flags & ((1L<<27))) != 0)) {
        PyErr_Format(PyExc_TypeError,
    ...
    if ((((PyVarObject*)(items))->ob_size) % mformat_descriptors[mformat_code].size != 0) {
        PyErr_SetString(PyExc_ValueError,
                        "string length not a multiple of item size");
        return ((void *)0);
    }
    ...
    case IEEE_754_FLOAT_BE: {
        ...
        Py_ssize_t itemcount = (((PyVarObject*)(items))->ob_size) / 4;
        const unsigned char *memstr =
            (unsigned char *)((__builtin_expect(!(((((((PyObject*)(items))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "arraymodule.c", 1879, "PyBytes_Check(items)") : (void)0), (((PyBytesObject *)(items))->ob_sval));

        converted_items = PyList_New(itemcount);
        if (converted_items == ((void *)0))
            return ((void *)0);
        for (i = 0; i < itemcount; i++) {
            PyObject *pyfloat = PyFloat_FromDouble(
                _PyFloat_Unpack4(&memstr[i * 4], le));
            if (pyfloat == ((void *)0)) {
                do { if ( --((PyObject*)(converted_items))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(converted_items)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(converted_items)))); } while (0);
                return ((void *)0);
            }
            (((PyListObject *)(converted_items))->ob_item[i] = (pyfloat));
        }
        break;
    }
    ...
    case IEEE_754_DOUBLE_BE: {
        ...
        Py_ssize_t itemcount = (((PyVarObject*)(items))->ob_size) / 8;
        const unsigned char *memstr =
            (unsigned char *)((__builtin_expect(!(((((((PyObject*)(items))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "arraymodule.c", 1901, "PyBytes_Check(items)") : (void)0), (((PyBytesObject *)(items))->ob_sval));
    ...
    case UTF16_BE: {
        ...
        converted_items = PyUnicode_DecodeUTF16(
            ((__builtin_expect(!(((((((PyObject*)(items))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "arraymodule.c", 1921, "PyBytes_Check(items)") : (void)0), (((PyBytesObject *)(items))->ob_sval)), (((PyVarObject*)(items))->ob_size),
            "strict", &byteorder);
        if (converted_items == ((void *)0))
            return ((void *)0);
        break;
    ...
    case UTF32_BE: {
        ...
        converted_items = PyUnicode_DecodeUTF32(
            ((__builtin_expect(!(((((((PyObject*)(items))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "arraymodule.c", 1931, "PyBytes_Check(items)") : (void)0), (((PyBytesObject *)(items))->ob_sval)), (((PyVarObject*)(items))->ob_size),
            "strict", &byteorder);
        if (converted_items == ((void *)0))
            return ((void *)0);
        break;
    ...
    case SIGNED_INT64_BE: {
        ...
        Py_ssize_t itemcount = (((PyVarObject*)(items))->ob_size) / mf_descr.size;
        const unsigned char *memstr =
            (unsigned char *)((__builtin_expect(!(((((((PyObject*)(items))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "arraymodule.c", 1957, "PyBytes_Check(items)") : (void)0), (((PyBytesObject *)(items))->ob_sval));
        struct arraydescr *descr;
# 1970 "arraymodule.c"
        for (descr = descriptors; descr->typecode != '\0'; descr++) {
        ...
        for (i = 0; i < itemcount; i++) {
            ...
            (((PyListObject *)(converted_items))->ob_item[i] = (pylong));
        }
        break;
    }
    case UNKNOWN_FORMAT:
...
array_reduce_ex(arrayobject *array, PyObject *value)
{
    ...
    int mformat_code;
    static PyObject *array_reconstructor = ((void *)0);
    long protocol;
    static _Py_Identifier PyId__array_reconstructor = { 0, "_array_reconstructor", 0 };
    static _Py_Identifier PyId___dict__ = { 0, "__dict__", 0 };

    if (array_reconstructor == ((void *)0)) {
        PyObject *array_module = PyImport_ImportModule("array");
        if (array_module == ((void *)0))
            return ((void *)0);
        array_reconstructor = _PyObject_GetAttrId(
            array_module,
            &PyId__array_reconstructor);
        do { if ( --((PyObject*)(array_module))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(array_module)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(array_module)))); } while (0);
        if (array_reconstructor == ((void *)0))
            return ((void *)0);
    }

    if (!((((((PyObject*)(value))->ob_type))->tp_flags & ((1L<<24))) != 0)) {
        PyErr_SetString(PyExc_TypeError,
...
# 2066 "arraymodule.c"
        PyObject *list;
        list = array_tolist(array, ((void *)0));
        if (list == ((void *)0)) {
            do { if ( --((PyObject*)(dict))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(dict)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(dict)))); } while (0);
            return ((void *)0);
        }
        result = _Py_BuildValue_SizeT(
            "O(CO)O", (((PyObject*)(array))->ob_type), typecode, list, dict);
        do { if ( --((PyObject*)(list))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(list)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(list)))); } while (0);
        do { if ( --((PyObject*)(dict))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(dict)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(dict)))); } while (0);
        return result;
    }

    array_str = array_tobytes(array, ((void *)0));
    if (array_str == ((void *)0)) {
        do { if ( --((PyObject*)(dict))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(dict)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(dict)))); } while (0);
        return ((void *)0);
    }
    result = _Py_BuildValue_SizeT(
        "O(OCiN)O", array_reconstructor, (((PyObject*)(array))->ob_type), typecode,
...
static PyGetSetDef array_getsets [] = {
    {"typecode", (getter) array_get_typecode, ((void *)0),
     "the typecode character used to create the array"},
    {"itemsize", (getter) array_get_itemsize, ((void *)0),
     "the size, in bytes, of one array item"},
    {((void *)0)}
};

static PyMethodDef array_methods[] = {
    {"append", (PyCFunction)array_append, 0x0008,
     append_doc},
    {"buffer_info", (PyCFunction)array_buffer_info, 0x0004,
     buffer_info_doc},
    {"byteswap", (PyCFunction)array_byteswap, 0x0004,
     byteswap_doc},
    {"__copy__", (PyCFunction)array_copy, 0x0004,
     copy_doc},
    {"count", (PyCFunction)array_count, 0x0008,
     count_doc},
    {"__deepcopy__", (PyCFunction)array_copy, 0x0008,
     copy_doc},
    {"extend", (PyCFunction)array_extend, 0x0008,
     extend_doc},
    {"fromfile", (PyCFunction)array_fromfile, 0x0001,
     fromfile_doc},
    {"fromlist", (PyCFunction)array_fromlist, 0x0008,
     fromlist_doc},
    {"fromstring", (PyCFunction)array_fromstring, 0x0001,
     fromstring_doc},
    {"frombytes", (PyCFunction)array_frombytes, 0x0001,
     frombytes_doc},
    {"fromunicode", (PyCFunction)array_fromunicode, 0x0001,
     fromunicode_doc},
    {"index", (PyCFunction)array_index, 0x0008,
     index_doc},
    {"insert", (PyCFunction)array_insert, 0x0001,
     insert_doc},
    {"pop", (PyCFunction)array_pop, 0x0001,
     pop_doc},
    {"__reduce_ex__", (PyCFunction)array_reduce_ex, 0x0008,
     reduce_doc},
    {"remove", (PyCFunction)array_remove, 0x0008,
     remove_doc},
    {"reverse", (PyCFunction)array_reverse, 0x0004,
     reverse_doc},
    {"tofile", (PyCFunction)array_tofile, 0x0008,
     tofile_doc},
    {"tolist", (PyCFunction)array_tolist, 0x0004,
     tolist_doc},
    {"tostring", (PyCFunction)array_tostring, 0x0004,
     tostring_doc},
    {"tobytes", (PyCFunction)array_tobytes, 0x0004,
     tobytes_doc},
    {"tounicode", (PyCFunction)array_tounicode, 0x0004,
     tounicode_doc},
    {"__sizeof__", (PyCFunction)array_sizeof, 0x0004,
     sizeof_doc},
    {((void *)0), ((void *)0)}
};
...
array_repr(arrayobject *a)
{
    ...
    len = (((PyVarObject*)(a))->ob_size);
    typecode = a->ob_descr->typecode;
    if (len == 0) {
        return PyUnicode_FromFormat("array('%c')", (int)typecode);
    }
    if (typecode == 'u') {
        v = array_tounicode(a, ((void *)0));
    } else {
        v = array_tolist(a, ((void *)0));
    }
    if (v == ((void *)0))
        return ((void *)0);
...
array_subscr(arrayobject* self, PyObject* item)
{
    if (((item)->ob_type->tp_as_number != ((void *)0) && (item)->ob_type->tp_as_number->nb_index != ((void *)0))) {
        ...
        if (slicelength <= 0) {
            ...
            if (result == ((void *)0))
                return ((void *)0);
            ((__builtin_object_size (((arrayobject *)result)->ob_item, 0) != (size_t) -1) ? __builtin___memcpy_chk (((arrayobject *)result)->ob_item, self->ob_item + start * itemsize, slicelength * itemsize, __builtin_object_size (((arrayobject *)result)->ob_item, 0)) : __inline_memcpy_chk (((arrayobject *)result)->ob_item, self->ob_item + start * itemsize, slicelength * itemsize));
            ...
            for (cur = start, i = 0; i < slicelength;
                 cur += step, i++) {
                ((__builtin_object_size (ar->ob_item + i*itemsize, 0) != (size_t) -1) ? __builtin___memcpy_chk (ar->ob_item + i*itemsize, self->ob_item + cur*itemsize, itemsize, __builtin_object_size (ar->ob_item + i*itemsize, 0)) : __inline_memcpy_chk (ar->ob_item + i*itemsize, self->ob_item + cur*itemsize, itemsize));
...
array_ass_subscr(arrayobject* self, PyObject* item, PyObject* value)
{
    ...
    if (((item)->ob_type->tp_as_number != ((void *)0) && (item)->ob_type->tp_as_number->nb_index != ((void *)0))) {
        ...
        if (PySlice_GetIndicesEx(item,
                                 (((PyVarObject*)(self))->ob_size), &start, &stop,
                                 &step, &slicelength) < 0) {
            return -1;
        }
    }
    ...
    else if (((((PyObject*)(value))->ob_type) == (&Arraytype) || PyType_IsSubtype((((PyObject*)(value))->ob_type), (&Arraytype)))) {
        other = (arrayobject *)value;
        needed = (((PyVarObject*)(other))->ob_size);
        if (self == other) {
    ...
    if (step == 1) {
        if (slicelength > needed) {
            ((__builtin_object_size (self->ob_item + (start + needed) * itemsize, 0) != (size_t) -1) ? __builtin___memmove_chk (self->ob_item + (start + needed) * itemsize, self->ob_item + stop * itemsize, ((((PyVarObject*)(self))->ob_size) - stop) * itemsize, __builtin_object_size (self->ob_item + (start + needed) * itemsize, 0)) : __inline_memmove_chk (self->ob_item + (start + needed) * itemsize, self->ob_item + stop * itemsize, ((((PyVarObject*)(self))->ob_size) - stop) * itemsize));


            if (array_resize(self, (((PyVarObject*)(self))->ob_size) +
            ...
            if (array_resize(self, (((PyVarObject*)(self))->ob_size) +
                needed - slicelength) < 0)
                return -1;
            ((__builtin_object_size (self->ob_item + (start + needed) * itemsize, 0) != (size_t) -1) ? __builtin___memmove_chk (self->ob_item + (start + needed) * itemsize, self->ob_item + stop * itemsize, ((((PyVarObject*)(self))->ob_size) - start - needed) * itemsize, __builtin_object_size (self->ob_item + (start + needed) * itemsize, 0)) : __inline_memmove_chk (self->ob_item + (start + needed) * itemsize, self->ob_item + stop * itemsize, ((((PyVarObject*)(self))->ob_size) - start - needed) * itemsize));


        }
        if (needed > 0)
            ((__builtin_object_size (self->ob_item + start * itemsize, 0) != (size_t) -1) ? __builtin___memcpy_chk (self->ob_item + start * itemsize, other->ob_item, needed * itemsize, __builtin_object_size (self->ob_item + start * itemsize, 0)) : __inline_memcpy_chk (self->ob_item + start * itemsize, other->ob_item, needed * itemsize));
        ...
        for (cur = start, i = 0; i < slicelength;
            ...
            ((__builtin_object_size (self->ob_item + (cur - i) * itemsize, 0) != (size_t) -1) ? __builtin___memmove_chk (self->ob_item + (cur - i) * itemsize, self->ob_item + (cur + 1) * itemsize, lim * itemsize, __builtin_object_size (self->ob_item + (cur - i) * itemsize, 0)) : __inline_memmove_chk (self->ob_item + (cur - i) * itemsize, self->ob_item + (cur + 1) * itemsize, lim * itemsize));


        }
        cur = start + (size_t)slicelength * step;
        if (cur < (size_t)(((PyVarObject*)(self))->ob_size)) {
            ((__builtin_object_size (self->ob_item + (cur-slicelength) * itemsize, 0) != (size_t) -1) ? __builtin___memmove_chk (self->ob_item + (cur-slicelength) * itemsize, self->ob_item + cur * itemsize, ((((PyVarObject*)(self))->ob_size) - cur) * itemsize, __builtin_object_size (self->ob_item + (cur-slicelength) * itemsize, 0)) : __inline_memmove_chk (self->ob_item + (cur-slicelength) * itemsize, self->ob_item + cur * itemsize, ((((PyVarObject*)(self))->ob_size) - cur) * itemsize));


        }
        if (array_resize(self, (((PyVarObject*)(self))->ob_size) - slicelength) < 0)
            return -1;
        return 0;
    }
    else {
        ...
        for (cur = start, i = 0; i < slicelength;
             cur += step, i++) {
            ((__builtin_object_size (self->ob_item + cur * itemsize, 0) != (size_t) -1) ? __builtin___memcpy_chk (self->ob_item + cur * itemsize, other->ob_item + i * itemsize, itemsize, __builtin_object_size (self->ob_item + cur * itemsize, 0)) : __inline_memcpy_chk (self->ob_item + cur * itemsize, other->ob_item + i * itemsize, itemsize));
...
array_buffer_getbuf(arrayobject *self, Py_buffer *view, int flags)
{
    ...
    view->len = ((((PyVarObject*)(self))->ob_size)) * self->ob_descr->itemsize;
    view->readonly = 0;
    view->ndim = 1;
...
static PySequenceMethods array_as_sequence = {
    (lenfunc)array_length,
    (binaryfunc)array_concat,
    (ssizeargfunc)array_repeat,
    (ssizeargfunc)array_item,
    0,
    (ssizeobjargproc)array_ass_item,
    0,
    (objobjproc)array_contains,
    (binaryfunc)array_inplace_concat,
    (ssizeargfunc)array_inplace_repeat
};
...
{
    int c;
    PyObject *initial = ((void *)0), *it = ((void *)0);
    struct arraydescr *descr;

    if (type == &Arraytype && !_PyArg_NoKeywords("array.array()", kwds))
        return ((void *)0);

    if (!_PyArg_ParseTuple_SizeT(args, "C|O:array", &c, &initial))
        return ((void *)0);

    if (!(initial == ((void *)0) || ((((((PyObject*)(initial))->ob_type))->tp_flags & ((1L<<25))) != 0)
          || ((((PyObject*)(initial))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(initial))->ob_type), (&PyByteArray_Type)))
          || ((((((PyObject*)(initial))->ob_type))->tp_flags & ((1L<<27))) != 0)
          || ((((((PyObject*)(initial))->ob_type))->tp_flags & ((1L<<26))) != 0)
          || ((c=='u') && ((((((PyObject*)(initial))->ob_type))->tp_flags & ((1L<<28))) != 0))
          || (((((PyObject*)(initial))->ob_type) == (&Arraytype) || PyType_IsSubtype((((PyObject*)(initial))->ob_type), (&Arraytype)))
    ...
    for (descr = descriptors; descr->typecode != '\0'; descr++) {
        if (descr->typecode == c) {
            ...
            if (initial == ((void *)0))
                len = 0;
            else if (((((((PyObject*)(initial))->ob_type))->tp_flags & ((1L<<25))) != 0))
                len = (((PyVarObject*)(initial))->ob_size);
            else if (((((((PyObject*)(initial))->ob_type))->tp_flags & ((1L<<26))) != 0) || ((((PyObject*)(initial))->ob_type) == (&Arraytype) || PyType_IsSubtype((((PyObject*)(initial))->ob_type), (&Arraytype))))
                len = (((PyVarObject*)(initial))->ob_size);
            else
                len = 0;
            ...
            if (len > 0 && !((((PyObject*)(initial))->ob_type) == (&Arraytype) || PyType_IsSubtype((((PyObject*)(initial))->ob_type), (&Arraytype)))) {
                Py_ssize_t i;
                for (i = 0; i < len; i++) {
                    PyObject *v =
            ...
            else if (initial != ((void *)0) && (((((PyObject*)(initial))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(initial))->ob_type), (&PyByteArray_Type))) ||
                               ((((((PyObject*)(initial))->ob_type))->tp_flags & ((1L<<27))) != 0))) {
                ...
                v = array_frombytes((arrayobject *)a,
                                         t_initial);
                do { if ( --((PyObject*)(t_initial))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(t_initial)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(t_initial)))); } while (0);
                if (v == ((void *)0)) {
                    do { if ( --((PyObject*)(a))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(a)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(a)))); } while (0);
                    return ((void *)0);
                }
            ...
            else if (initial != ((void *)0) && ((((((PyObject*)(initial))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
                Py_UNICODE *ustr;
                Py_ssize_t n;
                ...
                n = (((__builtin_expect(!(((((((PyObject*)(initial))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "arraymodule.c", 2570, "PyUnicode_Check(initial)") : (void)0), (((PyASCIIObject *)(initial))->wstr) ? ((((PyASCIIObject*)initial)->state.ascii && (((PyASCIIObject*)(initial))->state.compact)) ? ((PyASCIIObject*)initial)->length : ((PyCompactUnicodeObject*)initial)->wstr_length) : ((void)PyUnicode_AsUnicode((PyObject *)(initial)), (__builtin_expect(!(((PyASCIIObject *)(initial))->wstr), 0) ? __assert_rtn(__func__, "arraymodule.c", 2570, "((PyASCIIObject *)(initial))->wstr") : (void)0), ((((PyASCIIObject*)initial)->state.ascii && (((PyASCIIObject*)(initial))->state.compact)) ? ((PyASCIIObject*)initial)->length : ((PyCompactUnicodeObject*)initial)->wstr_length))) * 4);
                if (n > 0) {
                    ...
                    self->ob_item = item;
                    (((PyVarObject*)(self))->ob_size) = n / sizeof(Py_UNICODE);
                    ((__builtin_object_size (item, 0) != (size_t) -1) ? __builtin___memcpy_chk (item, ustr, n, __builtin_object_size (item, 0)) : __inline_memcpy_chk (item, ustr, n));
                    self->allocated = (((PyVarObject*)(self))->ob_size);
                }
            }
            else if (initial != ((void *)0) && ((((PyObject*)(initial))->ob_type) == (&Arraytype) || PyType_IsSubtype((((PyObject*)(initial))->ob_type), (&Arraytype)))) {
                arrayobject *self = (arrayobject *)a;
                arrayobject *other = (arrayobject *)initial;
                ((__builtin_object_size (self->ob_item, 0) != (size_t) -1) ? __builtin___memcpy_chk (self->ob_item, other->ob_item, len * other->ob_descr->itemsize, __builtin_object_size (self->ob_item, 0)) : __inline_memcpy_chk (self->ob_item, other->ob_item, len * other->ob_descr->itemsize));
            }
            if (it != ((void *)0)) {
...
static PyTypeObject Arraytype = {
    ...
    0,
    array_richcompare,
    __builtin_offsetof (arrayobject, weakreflist),
...
array_iter(arrayobject *ao)
{
    ...
    if (!((((PyObject*)(ao))->ob_type) == (&Arraytype) || PyType_IsSubtype((((PyObject*)(ao))->ob_type), (&Arraytype)))) {
        _PyErr_BadInternalCall("arraymodule.c", 2746);
        return ((void *)0);
    }

    it = ( (arrayiterobject *) _PyObject_GC_New(&PyArrayIter_Type) );
    if (it == ((void *)0))
        return ((void *)0);
...
{
    (__builtin_expect(!(((((PyObject*)(it))->ob_type) == (&PyArrayIter_Type) || PyType_IsSubtype((((PyObject*)(it))->ob_type), (&PyArrayIter_Type)))), 0) ? __assert_rtn(__func__, "arraymodule.c", 2765, "PyArrayIter_Check(it)") : (void)0);
    if (it->index < (((PyVarObject*)(it->ao))->ob_size))
...
{
    do { if (it->ao) { int vret = visit((PyObject *)(it->ao), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
static PyMethodDef arrayiter_methods[] = {
    {"__reduce__", (PyCFunction)arrayiter_reduce, 0x0004,
     reduce_doc},
    {"__setstate__", (PyCFunction)arrayiter_setstate, 0x0008,
     setstate_doc},
    {((void *)0), ((void *)0)}
};
...
static PyTypeObject PyArrayIter_Type = {
    ...
    ( 0 | (1L<<18) | 0) | (1L<<14),
    0,
    (traverseproc)arrayiter_traverse,
    0,
    0,
    0,
    PyObject_SelfIter,
...
static PyMethodDef a_methods[] = {
    {"_array_reconstructor", array_reconstructor, 0x0001,
...
{
    PyObject *m;
    char buffer[(sizeof(descriptors) / sizeof((descriptors)[0]) + (sizeof(char [1 - 2*!(!__builtin_types_compatible_p(typeof(descriptors), typeof(&(descriptors)[0])))]) - 1))], *p;
    PyObject *typecodes;
    Py_ssize_t size = 0;
    struct arraydescr *descr;
    ...
    if (PyType_Ready(&Arraytype) < 0)
        return ((void *)0);
    (((PyObject*)(&PyArrayIter_Type))->ob_type) = &PyType_Type;
    m = PyModule_Create2(&arraymodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);

    ( ((PyObject*)((PyObject *)&Arraytype))->ob_refcnt++);
    ...
    typecodes = PyUnicode_DecodeASCII(buffer, p - buffer, ((void *)0));
