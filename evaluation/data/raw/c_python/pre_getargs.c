...
_PyArg_Parse_SizeT(PyObject *args, char *format, ...)
{
    ...
    __builtin_va_start(va,format);
    retval = vgetargs1(args, format, &va, 1|2);
    __builtin_va_end(va);
    return retval;
}
...
_PyArg_ParseTuple_SizeT(PyObject *args, char *format, ...)
{
    ...
    __builtin_va_start(va,format);
    retval = vgetargs1(args, format, &va, 2);
    __builtin_va_end(va);
    return retval;
}
...
PyArg_VaParse(PyObject *args, const char *format, va_list va)
{
    va_list lva;
        ...
        ((__builtin_object_size ((lva), 0) != (size_t) -1) ? __builtin___memcpy_chk ((lva), (va), sizeof(va_list), __builtin_object_size ((lva), 0)) : __inline_memcpy_chk ((lva), (va), sizeof(va_list)));
...
_PyArg_VaParse_SizeT(PyObject *args, char *format, va_list va)
{
    ...
    return vgetargs1(args, format, &lva, 2);
}
...
cleanreturn(int retval, freelist_t *freelist)
{
    ...
    if (retval == 0) {
      ...
      for (index = 0; index < freelist->first_available; ++index) {
          freelist->entries[index].destructor(((void *)0),
                                              freelist->entries[index].item);
      }
    }
    free(freelist->entries);
    return retval;
}
...
vgetargs1(PyObject *args, const char *format, va_list *p_va, int flags)
{
    ...
    Py_ssize_t i, len;
    char *msg;
    freelist_t freelist = {0, ((void *)0)};
    int compat = flags & 1;

    (__builtin_expect(!(compat || (args != (PyObject*)((void *)0))), 0) ? __assert_rtn(__func__, "getargs.c", 212, "compat || (args != (PyObject*)NULL)") : (void)0);
    flags = flags & ~1;
    ...
    while (endfmt == 0) {
        ...
        default:
            if (level == 0) {
                if (c == 'O')
                    max++;
                else if ((_Py_ctype_table[((unsigned char)((((unsigned char)((c) & 0xff))) & 0xff))] & (0x01|0x02))) {
                    if (c != 'e')
                        max++;
                } else if (c == '|')
                    min = max;
    ...
    freelist.entries = ( ((size_t)(max) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(freelistentry_t)) ? ((void *)0) : ( (freelistentry_t *) ((size_t)((max) * sizeof(freelistentry_t)) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc(((max) * sizeof(freelistentry_t)) ? ((max) * sizeof(freelistentry_t)) : 1)) ) );
    if (freelist.entries == ((void *)0)) {
        PyErr_NoMemory();
        return 0;
    }
    ...
    for (i = 0; i < len; i++) {
        if (*format == '|')
            format++;
        msg = convertitem((((PyTupleObject *)(args))->ob_item[i]), &format, p_va,
                          flags, levels, msgbuf,
    ...
    if (*format != '\0' && !(_Py_ctype_table[((unsigned char)((((unsigned char)((*format) & 0xff))) & 0xff))] & (0x01|0x02)) &&
        *format != '(' &&
             ...
             freelist_t *freelist)
{
    ...
    for (;;) {
        ...
        if (c == '(') {
            ...
            break;
        else if (level == 0 && (_Py_ctype_table[((unsigned char)((((unsigned char)((c) & 0xff))) & 0xff))] & (0x01|0x02)))
            n++;
    }

    if (!PySequence_Check(arg) || ((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<27))) != 0)) {
        levels[0] = 0;
        PyOS_snprintf(msgbuf, bufsize,
                      toplevel ? "expected %d arguments, not %.50s" :
                      "must be %d-item sequence, not %.50s",
                  n,
                  arg == (&_Py_NoneStruct) ? "None" : arg->ob_type->tp_name);
        return msgbuf;
    }
    ...
    for (i = 0; i < n; i++) {
        ...
        if (item == ((void *)0)) {
            ...
            levels[0] = i+1;
            levels[1] = 0;
            ((__builtin_object_size (msgbuf, 0) != (size_t) -1) ? __builtin___strncpy_chk (msgbuf, "is not retrievable", bufsize, __builtin_object_size (msgbuf, 2 > 1)) : __inline_strncpy_chk (msgbuf, "is not retrievable", bufsize));
            return msgbuf;
        }
...
{
    (__builtin_expect(!(expected != ((void *)0)), 0) ? __assert_rtn(__func__, "getargs.c", 516, "expected != NULL") : (void)0);
    (__builtin_expect(!(arg != ((void *)0)), 0) ? __assert_rtn(__func__, "getargs.c", 517, "arg != NULL") : (void)0);
    PyOS_snprintf(msgbuf, bufsize,
...
# 571 "getargs.c"
    ...
    case 'b': {
        char *p = __builtin_va_arg(*p_va,char *);
        long ival;
    ...
    case 'h': {
        short *p = __builtin_va_arg(*p_va,short *);
        long ival;
        if (float_argument_error(arg))
            return msgbuf;
        ival = PyLong_AsLong(arg);
    ...
    case 'H': {
        ...
        unsigned short *p = __builtin_va_arg(*p_va,unsigned short *);
        long ival;
        if (float_argument_error(arg))
            return msgbuf;
        ival = PyLong_AsUnsignedLongMask(arg);
    ...
    case 'i': {
        int *p = __builtin_va_arg(*p_va,int *);
        long ival;
        if (float_argument_error(arg))
            return msgbuf;
        ival = PyLong_AsLong(arg);
        if (ival == -1 && PyErr_Occurred())
            return msgbuf;
        else if (ival > 2147483647) {
            PyErr_SetString(PyExc_OverflowError,
                            "signed integer is greater than maximum");
            return msgbuf;
        }
        else if (ival < (-2147483647 - 1)) {
            PyErr_SetString(PyExc_OverflowError,
    ...
    case 'I': {
        ...
        unsigned int *p = __builtin_va_arg(*p_va,unsigned int *);
        unsigned int ival;
        if (float_argument_error(arg))
            return msgbuf;
    ...
    {
        PyObject *iobj;
        Py_ssize_t *p = __builtin_va_arg(*p_va,Py_ssize_t *);
        Py_ssize_t ival = -1;
        if (float_argument_error(arg))
            return msgbuf;
    ...
    case 'l': {
        long *p = __builtin_va_arg(*p_va,long *);
        long ival;
        if (float_argument_error(arg))
            return msgbuf;
        ival = PyLong_AsLong(arg);
    ...
    case 'k': {
        unsigned long *p = __builtin_va_arg(*p_va,unsigned long *);
        unsigned long ival;
    ...
    case 'L': {
        long long *p = __builtin_va_arg(*p_va,long long *);
        long long ival;
        if (float_argument_error(arg))
            return msgbuf;
    ...
    case 'K': {
        unsigned long long *p = __builtin_va_arg(*p_va,unsigned long long *);
    ...
    case 'f': {
        float *p = __builtin_va_arg(*p_va,float *);
    ...
    case 'd': {
        double *p = __builtin_va_arg(*p_va,double *);
        double dval = PyFloat_AsDouble(arg);
        if (PyErr_Occurred())
            return msgbuf;
        else
    ...
    case 'D': {
        Py_complex *p = __builtin_va_arg(*p_va,Py_complex *);
        Py_complex cval;
    ...
    case 'c': {
        char *p = __builtin_va_arg(*p_va,char *);
        if (((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<27))) != 0) && PyBytes_Size(arg) == 1)
            *p = ((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "getargs.c", 789, "PyBytes_Check(arg)") : (void)0), (((PyBytesObject *)(arg))->ob_sval))[0];
        else if (((((PyObject*)(arg))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(arg))->ob_type), (&PyByteArray_Type))) && PyByteArray_Size(arg) == 1)
            *p = ((__builtin_expect(!(((((PyObject*)(arg))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(arg))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "getargs.c", 791, "PyByteArray_Check(arg)") : (void)0), (((PyVarObject*)(arg))->ob_size) ? ((PyByteArrayObject *)(arg))->ob_bytes : _PyByteArray_empty_string)[0];
        else
    ...
    case 'C': {
        ...
        if (((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "getargs.c", 805, "PyUnicode_Check(arg)") : (void)0), ((((PyASCIIObject*)arg)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(arg)))))
            return msgbuf;

        if (((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "getargs.c", 808, "PyUnicode_Check(arg)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)arg)->state.ready)), 0) ? __assert_rtn(__func__, "getargs.c", 808, "PyUnicode_IS_READY(arg)") : (void)0), ((PyASCIIObject *)(arg))->length) != 1)
            return converterr("a unicode character", arg, msgbuf, bufsize);

        kind = ((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "getargs.c", 811, "PyUnicode_Check(arg)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)arg)->state.ready)), 0) ? __assert_rtn(__func__, "getargs.c", 811, "PyUnicode_IS_READY(arg)") : (void)0), ((PyASCIIObject *)(arg))->state.kind);
        data = ((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "getargs.c", 812, "PyUnicode_Check(arg)") : (void)0), (((PyASCIIObject*)(arg))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "getargs.c", 812, "PyUnicode_Check(arg)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)arg)->state.ready)), 0) ? __assert_rtn(__func__, "getargs.c", 812, "PyUnicode_IS_READY(arg)") : (void)0), ((PyASCIIObject*)arg)->state.ascii) ? ((void*)((PyASCIIObject*)(arg) + 1)) : ((void*)((PyCompactUnicodeObject*)(arg) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)(arg))->data.any), 0) ? __assert_rtn(__func__, "getargs.c", 812, "((PyUnicodeObject*)(arg))->data.any") : (void)0), ((((PyUnicodeObject *)(arg))->data.any))));
        *p = ((Py_UCS4) ((kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(data))[(0)] : ((kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(data))[(0)] : ((const Py_UCS4 *)(data))[(0)] ) ));
        break;
    }
    ...
    case 'y': {
        void **p = (void **)__builtin_va_arg(*p_va,char **);
        char *buf;
        Py_ssize_t count;
        if (*format == '*') {
        ...
        if (count < 0)
            return converterr(buf, arg, msgbuf, bufsize);
        if (*format == '#') {
            int *q=((void *)0);Py_ssize_t *q2=((void *)0); if (flags & 2) q2=__builtin_va_arg(*p_va,Py_ssize_t*); else q=__builtin_va_arg(*p_va,int*);;
            if (flags & 2) *q2=count; else { if (2147483647 < count) { PyErr_SetString(PyExc_OverflowError, "size does not fit in an int"); return converterr("", arg, msgbuf, bufsize); } *q=count; };
            format++;
        } else {
            if (strlen(*p) != count)
                return converterr(
    ...
    case 'z':
    {
        if (*format == '*') {
            ...
            Py_buffer *p = (Py_buffer *)__builtin_va_arg(*p_va,Py_buffer *);

            if (c == 'z' && arg == (&_Py_NoneStruct))
                PyBuffer_FillInfo(p, ((void *)0), ((void *)0), 0, 1, 0);
            else if (((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
                Py_ssize_t len;
                sarg = PyUnicode_AsUTF8AndSize(arg, &len);
                if (sarg == ((void *)0))
                    return converterr("(unicode conversion error)",
                                      arg, msgbuf, bufsize);
            ...
            if (c == 'z' && arg == (&_Py_NoneStruct)) {
                *p = ((void *)0);
                if (flags & 2) *q2=0; else { if (2147483647 < 0) { PyErr_SetString(PyExc_OverflowError, "size does not fit in an int"); return converterr("", arg, msgbuf, bufsize); } *q=0; };
            }
            else if (((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
                Py_ssize_t len;
                sarg = PyUnicode_AsUTF8AndSize(arg, &len);
                if (sarg == ((void *)0))
                    return converterr("(unicode conversion error)",
                                      arg, msgbuf, bufsize);
                *p = sarg;
                if (flags & 2) *q2=len; else { if (2147483647 < len) { PyErr_SetString(PyExc_OverflowError, "size does not fit in an int"); return converterr("", arg, msgbuf, bufsize); } *q=len; };
            }
            else {
            ...
            if (c == 'z' && arg == (&_Py_NoneStruct))
                ...
                *p = sarg;
                ...
                return converterr(c == 'z' ? "str or None" : "str",
                                  arg, msgbuf, bufsize);
            if (*p != ((void *)0) && sarg != ((void *)0) && (Py_ssize_t) strlen(*p) != len)
                return converterr(
    ...
    case 'Z':
    {
        Py_UNICODE **p = __builtin_va_arg(*p_va,Py_UNICODE **);
    ...
    case 'e': {
        ...
        encoding = (const char *)__builtin_va_arg(*p_va,const char *);
        if (encoding == ((void *)0))
        ...
        if (*format == 's')
            ...
            return converterr(
                ...
                arg, msgbuf, bufsize);
        buffer = (char **)__builtin_va_arg(*p_va,char **);
        format++;
        if (buffer == ((void *)0))
        ...
        if (!recode_strings &&
            (((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<27))) != 0) || ((((PyObject*)(arg))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(arg))->ob_type), (&PyByteArray_Type))))) {
            s = arg;
            ...
            size = ((__builtin_expect(!(((((((PyObject*)(s))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "getargs.c", 1052, "PyBytes_Check(s)") : (void)0),(((PyVarObject*)(s))->ob_size));
            ptr = ((__builtin_expect(!(((((((PyObject*)(s))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "getargs.c", 1053, "PyBytes_Check(s)") : (void)0), (((PyBytesObject *)(s))->ob_sval));
            if (ptr == ((void *)0))
                ptr = "";
        }
...
# 1081 "getargs.c"
            ...
            if (*buffer == ((void *)0)) {
                *buffer = ( ((size_t)(size + 1) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(char)) ? ((void *)0) : ( (char *) ((size_t)((size + 1) * sizeof(char)) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc(((size + 1) * sizeof(char)) ? ((size + 1) * sizeof(char)) : 1)) ) );
                if (*buffer == ((void *)0)) {
                    do { if ( --((PyObject*)(s))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(s)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(s)))); } while (0);
                    PyErr_NoMemory();
                    return msgbuf;
            ...
            ((__builtin_object_size (*buffer, 0) != (size_t) -1) ? __builtin___memcpy_chk (*buffer, ptr, size+1, __builtin_object_size (*buffer, 0)) : __inline_memcpy_chk (*buffer, ptr, size+1));
            if (flags & 2) *q2=size; else { if (2147483647 < size) { PyErr_SetString(PyExc_OverflowError, "size does not fit in an int"); return converterr("", arg, msgbuf, bufsize); } *q=size; };
        } else {
# 1127 "getargs.c"
    ...
    case 'S': {
        PyObject **p = __builtin_va_arg(*p_va,PyObject **);
    ...
    case 'Y': {
        PyObject **p = __builtin_va_arg(*p_va,PyObject **);
        if (((((PyObject*)(arg))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(arg))->ob_type), (&PyByteArray_Type))))
            *p = arg;
        else
    ...
    case 'U': {
        PyObject **p = __builtin_va_arg(*p_va,PyObject **);
        if (((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
            if (((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "getargs.c", 1171, "PyUnicode_Check(arg)") : (void)0), ((((PyASCIIObject*)arg)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(arg)))) == -1)
                return msgbuf;
            *p = arg;
        }
        else
    ...
    case 'O': {
        ...
        PyObject **p;
        if (*format == '!') {
            type = __builtin_va_arg(*p_va,PyTypeObject*);
            p = __builtin_va_arg(*p_va,PyObject **);
            format++;
            ...
            converter convert = __builtin_va_arg(*p_va,converter);
            void *addr = __builtin_va_arg(*p_va,void *);
            int res;
            format++;
    ...
    case 'w': {
        void **p = __builtin_va_arg(*p_va,void **);
        ...
        if (PyObject_GetBuffer(arg, (Py_buffer*)p, 0x0001) < 0) {
            PyErr_Clear();
...
{
    PyBufferProcs *pb = (((PyObject*)(arg))->ob_type)->tp_as_buffer;
    Py_ssize_t count;
    Py_buffer view;

    *errmsg = ((void *)0);
    *p = ((void *)0);
    if (pb != ((void *)0) && pb->bf_releasebuffer != ((void *)0)) {
                            ...
                            char **kwlist, ...)
{
    ...
    if ((args == ((void *)0) || !((((((PyObject*)(args))->ob_type))->tp_flags & ((1L<<26))) != 0)) ||
        ...
        kwlist == ((void *)0))
    {
        _PyErr_BadInternalCall("getargs.c", 1311);
        return 0;
    }
                                  ...
                                  char **kwlist, ...)
{
    ...
    if ((args == ((void *)0) || !((((((PyObject*)(args))->ob_type))->tp_flags & ((1L<<26))) != 0)) ||
        ...
        kwlist == ((void *)0))
    {
        _PyErr_BadInternalCall("getargs.c", 1335);
        return 0;
    }
                              ...
                              char **kwlist, va_list va)
{
    ...
    if ((args == ((void *)0) || !((((((PyObject*)(args))->ob_type))->tp_flags & ((1L<<26))) != 0)) ||
        ...
        kwlist == ((void *)0))
    {
        _PyErr_BadInternalCall("getargs.c", 1361);
        return 0;
    }
                                    ...
                                    char **kwlist, va_list va)
{
    ...
    if ((args == ((void *)0) || !((((((PyObject*)(args))->ob_type))->tp_flags & ((1L<<26))) != 0)) ||
        ...
        kwlist == ((void *)0))
    {
        _PyErr_BadInternalCall("getargs.c", 1385);
        return 0;
    }
...
{
    if (!((((((PyObject*)(kwargs))->ob_type))->tp_flags & ((1L<<29))) != 0)) {
        _PyErr_BadInternalCall("getargs.c", 1400);
        return 0;
    }
                 ...
                 char **kwlist, va_list *p_va, int flags)
{
    ...
    (__builtin_expect(!(args != ((void *)0) && ((((((PyObject*)(args))->ob_type))->tp_flags & ((1L<<26))) != 0)), 0) ? __assert_rtn(__func__, "getargs.c", 1426, "args != NULL && PyTuple_Check(args)") : (void)0);
    (__builtin_expect(!(keywords == ((void *)0) || ((((((PyObject*)(keywords))->ob_type))->tp_flags & ((1L<<29))) != 0)), 0) ? __assert_rtn(__func__, "getargs.c", 1427, "keywords == NULL || PyDict_Check(keywords)") : (void)0);
    (__builtin_expect(!(format != ((void *)0)), 0) ? __assert_rtn(__func__, "getargs.c", 1428, "format != NULL") : (void)0);
    (__builtin_expect(!(kwlist != ((void *)0)), 0) ? __assert_rtn(__func__, "getargs.c", 1429, "kwlist != NULL") : (void)0);
    (__builtin_expect(!(p_va != ((void *)0)), 0) ? __assert_rtn(__func__, "getargs.c", 1430, "p_va != NULL") : (void)0);
    ...
    freelist.entries = ( ((size_t)(len) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(freelistentry_t)) ? ((void *)0) : ( (freelistentry_t *) ((size_t)((len) * sizeof(freelistentry_t)) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc(((len) * sizeof(freelistentry_t)) ? ((len) * sizeof(freelistentry_t)) : 1)) ) );
    if (freelist.entries == ((void *)0)) {
        PyErr_NoMemory();
        return 0;
    }
    ...
    nkeywords = (keywords == ((void *)0)) ? 0 : PyDict_Size(keywords);
    ...
    for (i = 0; i < len; i++) {
        ...
        if (*format == '$') {
            ...
            if (max < nargs) {
                PyErr_Format(PyExc_TypeError,
                             ...
                             " (%d given)",
                             (min != 2147483647) ? "at most" : "exactly",
                             max, nargs);
                return cleanreturn(0, &freelist);
            }
        }
        ...
        if (current_arg) {
            ...
            current_arg = (((PyTupleObject *)(args))->ob_item[i]);
    ...
    if (!(*format == '\0' || *format == ';' || *format == ':') && (*format != '|') && (*format != '$')) {
        PyErr_Format(PyExc_RuntimeError,
...
skipitem(const char **p_format, va_list *p_va, int flags)
{
    ...
    case 'U':
        {
            (void) __builtin_va_arg(*p_va,void *);
            break;
        }
    ...
    case 'e':
        {
            (void) __builtin_va_arg(*p_va,const char *);
    ...
    case 'w':
        {
            (void) __builtin_va_arg(*p_va,char **);
            if (*format == '#') {
                if (flags & 2)
                    (void) __builtin_va_arg(*p_va,Py_ssize_t *);
                else
                    (void) __builtin_va_arg(*p_va,int *);
                format++;
    ...
    case 'O':
        {
            if (*format == '!') {
                format++;
                (void) __builtin_va_arg(*p_va,PyTypeObject*);
                (void) __builtin_va_arg(*p_va,PyObject **);
            }
            else if (*format == '&') {
                typedef int (*converter)(PyObject *, void *);
                (void) __builtin_va_arg(*p_va,converter);
                (void) __builtin_va_arg(*p_va,void *);
                format++;
            }
            else {
...
PyArg_UnpackTuple(PyObject *args, const char *name, Py_ssize_t min, Py_ssize_t max, ...)
{
    ...
    __builtin_va_start(vargs,max);




    (__builtin_expect(!(min >= 0), 0) ? __assert_rtn(__func__, "getargs.c", 1742, "min >= 0") : (void)0);
    (__builtin_expect(!(min <= max), 0) ? __assert_rtn(__func__, "getargs.c", 1743, "min <= max") : (void)0);
    if (!((((((PyObject*)(args))->ob_type))->tp_flags & ((1L<<26))) != 0)) {
    ...
    for (i = 0; i < l; i++) {
        o = __builtin_va_arg(vargs,PyObject **);
        *o = (((PyTupleObject *)(args))->ob_item[i]);
    }
    __builtin_va_end(vargs);
    return 1;
}
...
_PyArg_NoKeywords(const char *funcname, PyObject *kw)
{
    if (kw == ((void *)0))
        return 1;
    if (!((((PyObject*)(kw))->ob_type) == &PyDict_Type)) {
        _PyErr_BadInternalCall("getargs.c", 1801);
        return 0;
    }
    if (PyDict_Size(kw) == 0)
        return 1;
