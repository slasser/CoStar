...
_Py_wchar2char(const wchar_t *text, size_t *error_pos)
{
    ...
    len = ((__builtin_expect(!(((((((PyObject*)(bytes))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "fileutils.c", 404, "PyBytes_Check(bytes)") : (void)0),(((PyVarObject*)(bytes))->ob_size));
    ...
    ((__builtin_object_size (cpath, 0) != (size_t) -1) ? __builtin___memcpy_chk (cpath, PyBytes_AsString(bytes), len + 1, __builtin_object_size (cpath, 0)) : __inline_memcpy_chk (cpath, PyBytes_AsString(bytes), len + 1));
    do { if ( --((PyObject*)(bytes))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(bytes)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(bytes)))); } while (0);
    return cpath;
# 485 "fileutils.c"
}
...
_Py_wstat(const wchar_t* path, struct stat *buf)
{
    int err;
    char *fname;
    fname = _Py_wchar2char(path, ((void *)0));
    if (fname == ((void *)0)) {
        (*__error()) = 22;
        return -1;
    }
...
# 538 "fileutils.c"
    ...
    if (bytes == ((void *)0))
        return -2;
    ret = stat(((__builtin_expect(!(((((((PyObject*)(bytes))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "fileutils.c", 542, "PyBytes_Check(bytes)") : (void)0), (((PyBytesObject *)(bytes))->ob_sval)), statbuf);
    do { if ( --((PyObject*)(bytes))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(bytes)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(bytes)))); } while (0);
    return ret;
...
_Py_wfopen(const wchar_t *path, const wchar_t *mode)
{
    ...
    cpath = _Py_wchar2char(path, ((void *)0));
    if (cpath == ((void *)0))
        return ((void *)0);
    f = fopen(cpath, cmode);
    PyMem_Free(cpath);
...
# 607 "fileutils.c"
    ...
    if (!PyUnicode_FSConverter(path, &bytes))
        return ((void *)0);
    f = fopen(((__builtin_expect(!(((((((PyObject*)(bytes))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "fileutils.c", 611, "PyBytes_Check(bytes)") : (void)0), (((PyBytesObject *)(bytes))->ob_sval)), mode);
    do { if ( --((PyObject*)(bytes))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(bytes)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(bytes)))); } while (0);
    return f;
...
_Py_wreadlink(const wchar_t *path, wchar_t *buf, size_t bufsiz)
{
    ...
    res = (int)readlink(cpath, cbuf, 1024);
    PyMem_Free(cpath);
    if (res == -1)
        return -1;
    if (res == 1024) {
