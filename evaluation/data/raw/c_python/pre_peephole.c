                   ...
                   PyObject *consts, PyObject **objs)
{
    ...
    (__builtin_expect(!(((((PyObject*)(consts))->ob_type) == &PyList_Type)), 0) ? __assert_rtn(__func__, "peephole.c", 101, "PyList_CheckExact(consts)") : (void)0);


    newconst = PyTuple_New(n);
    if (newconst == ((void *)0))
        return 0;
    len_consts = (((PyVarObject*)(consts))->ob_size);
    for (i=0 ; i<n ; i++) {
        constant = objs[i];
        ( ((PyObject*)(constant))->ob_refcnt++);
        (((PyTupleObject *)(newconst))->ob_item[i] = constant);
    }
    ...
    if (PyList_Append(consts, newconst)) {
        do { if ( --((PyObject*)(newconst))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(newconst)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(newconst)))); } while (0);
        return 0;
    }
    do { if ( --((PyObject*)(newconst))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(newconst)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(newconst)))); } while (0);
    ...
    codestr[0] = 100;
    codestr[0 +2] = len_consts>>8; codestr[0 +1] = len_consts & 255;
    return 1;
}
# 148 "peephole.c"
static int
fold_binops_on_constants(unsigned char *codestr, PyObject *consts, PyObject **objs)
{
    ...
    (__builtin_expect(!(((((PyObject*)(consts))->ob_type) == &PyList_Type)), 0) ? __assert_rtn(__func__, "peephole.c", 156, "PyList_CheckExact(consts)") : (void)0);
    ...
    switch (opcode) {
        case 19:
            newconst = PyNumber_Power(v, w, (&_Py_NoneStruct));
            break;
        case 20:
    ...
    codestr[-2] = 100;
    codestr[-2 +2] = len_consts>>8; codestr[-2 +1] = len_consts & 255;
    return 1;
}
...
fold_unaryops_on_constants(unsigned char *codestr, PyObject *consts, PyObject *v)
{
    ...
    (__builtin_expect(!(((((PyObject*)(consts))->ob_type) == &PyList_Type)), 0) ? __assert_rtn(__func__, "peephole.c", 246, "PyList_CheckExact(consts)") : (void)0);
    (__builtin_expect(!(codestr[0] == 100), 0) ? __assert_rtn(__func__, "peephole.c", 247, "codestr[0] == LOAD_CONST") : (void)0);
    ...
    codestr[0] = 9;
    codestr[1] = 100;
    codestr[1 +2] = len_consts>>8; codestr[1 +1] = len_consts & 255;
    return 1;
}
...
markblocks(unsigned char *code, Py_ssize_t len)
{
    ...
    ((__builtin_object_size (blocks, 0) != (size_t) -1) ? __builtin___memset_chk (blocks, 0, len*sizeof(int), __builtin_object_size (blocks, 0)) : __inline_memset_chk (blocks, 0, len*sizeof(int)));


    for (i=0 ; i<len ; i+=(((opcode) >= 90) ? 3 : 1)) {
        opcode = code[i];
        switch (opcode) {
            case 93:
            case 110:
            ...
            case 122:
            case 143:
                j = (((int)((code[i+2]<<8) + code[i+1])) + ((code[i]==113 || code[i]==119 || code[i]==114 || code[i]==115 || code[i]==111 || code[i]==112) ? 0 : i+3));
                blocks[j] = 1;
                break;
        }
    }
...
load_global(unsigned char *codestr, Py_ssize_t i, char *name, PyObject *consts)
{
    ...
    if (strcmp(name, "None") == 0)
        ...
        obj = ((PyObject *) &_Py_TrueStruct);
    else if (strcmp(name, "False") == 0)
        obj = ((PyObject *) &_Py_FalseStruct);
    else
        return 0;
    for (j = 0; j < (((PyVarObject*)(consts))->ob_size); j++) {
        if ((((PyListObject *)(consts))->ob_item[j]) == obj)
            break;
    }
    if (j == (((PyVarObject*)(consts))->ob_size)) {
        if (PyList_Append(consts, obj) < 0)
            return -1;
    }
    (__builtin_expect(!((((PyListObject *)(consts))->ob_item[j]) == obj), 0) ? __assert_rtn(__func__, "peephole.c", 355, "PyList_GET_ITEM(consts, j) == obj") : (void)0);
    codestr[i] = 100;
    codestr[i+2] = j>>8; codestr[i+1] = j & 255;
    return 1;
}
# 378 "peephole.c"
PyObject *
                ...
                PyObject *lineno_obj)
{
    ...
    unsigned char *codestr = ((void *)0);
    unsigned char *lineno;
    int *addrmap = ((void *)0);
    int new_line, cum_orig_line, last_line, tabsiz;
    PyObject **const_stack = ((void *)0);
    Py_ssize_t *load_const_stack = ((void *)0);
    Py_ssize_t const_stack_top = -1;
    Py_ssize_t const_stack_size = 0;
    int in_consts = 0;
    unsigned int *blocks = ((void *)0);
    char *name;
    ...
    (__builtin_expect(!(((((((PyObject*)(lineno_obj))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "peephole.c", 402, "PyBytes_Check(lineno_obj)") : (void)0);
    lineno = (unsigned char*)((__builtin_expect(!(((((((PyObject*)(lineno_obj))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "peephole.c", 403, "PyBytes_Check(lineno_obj)") : (void)0), (((PyBytesObject *)(lineno_obj))->ob_sval));
    tabsiz = ((__builtin_expect(!(((((((PyObject*)(lineno_obj))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "peephole.c", 404, "PyBytes_Check(lineno_obj)") : (void)0),(((PyVarObject*)(lineno_obj))->ob_size));
    if (memchr(lineno, 255, tabsiz) != ((void *)0))
        goto exitUnchanged;


    (__builtin_expect(!(((((((PyObject*)(code))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "peephole.c", 409, "PyBytes_Check(code)") : (void)0);
    codelen = ((__builtin_expect(!(((((((PyObject*)(code))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "peephole.c", 410, "PyBytes_Check(code)") : (void)0),(((PyVarObject*)(code))->ob_size));
    if (codelen > 32700)
        goto exitUnchanged;
    ...
    if (codestr == ((void *)0))
        goto exitError;
    codestr = (unsigned char *)((__builtin_object_size (codestr, 0) != (size_t) -1) ? __builtin___memcpy_chk (codestr, ((__builtin_expect(!(((((((PyObject*)(code))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "peephole.c", 419, "PyBytes_Check(code)") : (void)0), (((PyBytesObject *)(code))->ob_sval)), codelen, __builtin_object_size (codestr, 0)) : __inline_memcpy_chk (codestr, ((__builtin_expect(!(((((((PyObject*)(code))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "peephole.c", 419, "PyBytes_Check(code)") : (void)0), (((PyBytesObject *)(code))->ob_sval)), codelen));
    ...
    if (blocks == ((void *)0))
        goto exitError;
    (__builtin_expect(!(((((((PyObject*)(consts))->ob_type))->tp_flags & ((1L<<25))) != 0)), 0) ? __assert_rtn(__func__, "peephole.c", 437, "PyList_Check(consts)") : (void)0);

    { const_stack_size = 256; const_stack = ( ((size_t)(const_stack_size) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(PyObject *)) ? ((void *)0) : ( (PyObject * *) PyMem_Malloc((const_stack_size) * sizeof(PyObject *)) ) ); load_const_stack = ( ((size_t)(const_stack_size) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(Py_ssize_t)) ? ((void *)0) : ( (Py_ssize_t *) PyMem_Malloc((const_stack_size) * sizeof(Py_ssize_t)) ) ); if (!const_stack || !load_const_stack) { PyErr_NoMemory(); goto exitError; } };

    for (i=0 ; i<codelen ; i += (((codestr[i]) >= 90) ? 3 : 1)) {
      reoptimize_current:
        opcode = codestr[i];

        if (!in_consts) {
            do { const_stack_top = -1; } while(0);
        }
        in_consts = 0;
        ...
        switch (opcode) {
            ...
            case 12:
                if (codestr[i+1] != 114
                    || !(blocks[i]==blocks[i+4 -1]))
                    continue;
                j = ((int)((codestr[i+1 +2]<<8) + codestr[i+1 +1]));
                codestr[i] = 115;
                codestr[i+2] = j>>8; codestr[i+1] = j & 255;
                codestr[i+3] = 9;
            ...
            case 107:
                j = ((int)((codestr[i+2]<<8) + codestr[i+1]));
                if (j < 6 || j > 9 ||
                    codestr[i+3] != 12 ||
                    !(blocks[i]==blocks[i+4 -1]))
                    continue;
                codestr[i+2] = (j^1)>>8; codestr[i+1] = (j^1) & 255;
                codestr[i+3] = 9;
                break;
            ...
            case 116:
                j = ((int)((codestr[i+2]<<8) + codestr[i+1]));
                name = PyUnicode_AsUTF8((((PyTupleObject *)(names))->ob_item[j]));
                h = load_global(codestr, i, name, consts);
                if (h < 0)
                    goto exitError;
                else if (h == 0)
                    continue;
                do { PyObject *_x; (__builtin_expect(!(codestr[i] == 100), 0) ? __assert_rtn(__func__, "peephole.c", 489, "codestr[i] == LOAD_CONST") : (void)0); (__builtin_expect(!((((PyVarObject*)(consts))->ob_size) > ((int)((codestr[i+2]<<8) + codestr[i+1]))), 0) ? __assert_rtn(__func__, "peephole.c", 489, "PyList_GET_SIZE(consts) > GETARG(codestr, i)") : (void)0); _x = (((PyListObject *)(consts))->ob_item[((int)((codestr[i+2]<<8) + codestr[i+1]))]); if (++const_stack_top >= const_stack_size) { const_stack_size *= 2; ( (const_stack) = ((size_t)(const_stack_size) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(PyObject *)) ? ((void *)0) : (PyObject * *) PyMem_Realloc((const_stack), (const_stack_size) * sizeof(PyObject *)) ); ( (load_const_stack) = ((size_t)(const_stack_size) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(Py_ssize_t)) ? ((void *)0) : (Py_ssize_t *) PyMem_Realloc((load_const_stack), (const_stack_size) * sizeof(Py_ssize_t)) ); if (!const_stack || !load_const_stack) { PyErr_NoMemory(); goto exitError; } } load_const_stack[const_stack_top] = i; const_stack[const_stack_top] = _x; in_consts = 1; } while(0);
                break;
            ...
            case 100:
                do { PyObject *_x; (__builtin_expect(!(codestr[i] == 100), 0) ? __assert_rtn(__func__, "peephole.c", 496, "codestr[i] == LOAD_CONST") : (void)0); (__builtin_expect(!((((PyVarObject*)(consts))->ob_size) > ((int)((codestr[i+2]<<8) + codestr[i+1]))), 0) ? __assert_rtn(__func__, "peephole.c", 496, "PyList_GET_SIZE(consts) > GETARG(codestr, i)") : (void)0); _x = (((PyListObject *)(consts))->ob_item[((int)((codestr[i+2]<<8) + codestr[i+1]))]); if (++const_stack_top >= const_stack_size) { const_stack_size *= 2; ( (const_stack) = ((size_t)(const_stack_size) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(PyObject *)) ? ((void *)0) : (PyObject * *) PyMem_Realloc((const_stack), (const_stack_size) * sizeof(PyObject *)) ); ( (load_const_stack) = ((size_t)(const_stack_size) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(Py_ssize_t)) ? ((void *)0) : (Py_ssize_t *) PyMem_Realloc((load_const_stack), (const_stack_size) * sizeof(Py_ssize_t)) ); if (!const_stack || !load_const_stack) { PyErr_NoMemory(); goto exitError; } } load_const_stack[const_stack_top] = i; const_stack[const_stack_top] = _x; in_consts = 1; } while(0);
                j = ((int)((codestr[i+2]<<8) + codestr[i+1]));
                if (codestr[i+3] != 114 ||
                    !(blocks[i]==blocks[i+6 -1]) ||
                    !PyObject_IsTrue((((PyListObject *)(consts))->ob_item[j])))
                    continue;
                ((__builtin_object_size (codestr+i, 0) != (size_t) -1) ? __builtin___memset_chk (codestr+i, 9, 6, __builtin_object_size (codestr+i, 0)) : __inline_memset_chk (codestr+i, 9, 6));
                do { const_stack_top = -1; } while(0);
                break;
            ...
            case 104:
                ...
                if (j == 0)
                    break;
                h = ((const_stack_top >= j - 1) ? load_const_stack[const_stack_top - j + 1] : -1);
                (__builtin_expect(!((h >= 0 || (const_stack_top + 1) < j)), 0) ? __assert_rtn(__func__, "peephole.c", 518, "(h >= 0 || CONST_STACK_LEN() < j)") : (void)0);
                if (h >= 0 && j > 0 && j <= (const_stack_top + 1) &&
                    ((opcode == 102 &&
                      (blocks[h]==blocks[h+i-h+3 -1])) ||
                     ((opcode == 103 || opcode == 104) &&
                      codestr[i+3]==107 &&
                      (blocks[h]==blocks[h+i-h+6 -1]) &&
                      (((int)((codestr[i+3 +2]<<8) + codestr[i+3 +1]))==6 ||
                       ((int)((codestr[i+3 +2]<<8) + codestr[i+3 +1]))==7))) &&
                    tuple_of_constants(&codestr[i], j, consts, &const_stack[const_stack_top - j + 1])) {
                    (__builtin_expect(!(codestr[i] == 100), 0) ? __assert_rtn(__func__, "peephole.c", 528, "codestr[i] == LOAD_CONST") : (void)0);
                    ((__builtin_object_size (&codestr[h], 0) != (size_t) -1) ? __builtin___memset_chk (&codestr[h], 9, i - h, __builtin_object_size (&codestr[h], 0)) : __inline_memset_chk (&codestr[h], 9, i - h));
                    do { (__builtin_expect(!(const_stack_top + 1 >= j), 0) ? __assert_rtn(__func__, "peephole.c", 530, "const_stack_top + 1 >= j") : (void)0); const_stack_top -= j; } while(0);
                    do { PyObject *_x; (__builtin_expect(!(codestr[i] == 100), 0) ? __assert_rtn(__func__, "peephole.c", 531, "codestr[i] == LOAD_CONST") : (void)0); (__builtin_expect(!((((PyVarObject*)(consts))->ob_size) > ((int)((codestr[i+2]<<8) + codestr[i+1]))), 0) ? __assert_rtn(__func__, "peephole.c", 531, "PyList_GET_SIZE(consts) > GETARG(codestr, i)") : (void)0); _x = (((PyListObject *)(consts))->ob_item[((int)((codestr[i+2]<<8) + codestr[i+1]))]); if (++const_stack_top >= const_stack_size) { const_stack_size *= 2; ( (const_stack) = ((size_t)(const_stack_size) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(PyObject *)) ? ((void *)0) : (PyObject * *) PyMem_Realloc((const_stack), (const_stack_size) * sizeof(PyObject *)) ); ( (load_const_stack) = ((size_t)(const_stack_size) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(Py_ssize_t)) ? ((void *)0) : (Py_ssize_t *) PyMem_Realloc((load_const_stack), (const_stack_size) * sizeof(Py_ssize_t)) ); if (!const_stack || !load_const_stack) { PyErr_NoMemory(); goto exitError; } } load_const_stack[const_stack_top] = i; const_stack[const_stack_top] = _x; in_consts = 1; } while(0);
                    break;
                }
                if (codestr[i+3] != 92 ||
                    !(blocks[i]==blocks[i+6 -1]) ||
                    j != ((int)((codestr[i+3 +2]<<8) + codestr[i+3 +1])) ||
                    opcode == 104)
                    continue;
                if (j == 1) {
                    ((__builtin_object_size (codestr+i, 0) != (size_t) -1) ? __builtin___memset_chk (codestr+i, 9, 6, __builtin_object_size (codestr+i, 0)) : __inline_memset_chk (codestr+i, 9, 6));
                    ...
                    codestr[i] = 2;
                    ((__builtin_object_size (codestr+i+1, 0) != (size_t) -1) ? __builtin___memset_chk (codestr+i+1, 9, 5, __builtin_object_size (codestr+i+1, 0)) : __inline_memset_chk (codestr+i+1, 9, 5));
                    do { const_stack_top = -1; } while(0);
                } else if (j == 3) {
                    codestr[i] = 3;
                    codestr[i+1] = 2;
                    ((__builtin_object_size (codestr+i+2, 0) != (size_t) -1) ? __builtin___memset_chk (codestr+i+2, 9, 4, __builtin_object_size (codestr+i+2, 0)) : __inline_memset_chk (codestr+i+2, 9, 4));
                    do { const_stack_top = -1; } while(0);
                }
                break;
            ...
            case 66:
                ...
                h = ((const_stack_top >= 2 - 1) ? load_const_stack[const_stack_top - 2 + 1] : -1);
                (__builtin_expect(!((h >= 0 || (const_stack_top + 1) < 2)), 0) ? __assert_rtn(__func__, "peephole.c", 571, "(h >= 0 || CONST_STACK_LEN() < 2)") : (void)0);
                if (h >= 0 &&
                    (blocks[h]==blocks[h+i-h+1 -1]) &&
                    fold_binops_on_constants(&codestr[i], consts, &const_stack[const_stack_top - 2 + 1])) {
                    i -= 2;
                    ((__builtin_object_size (&codestr[h], 0) != (size_t) -1) ? __builtin___memset_chk (&codestr[h], 9, i - h, __builtin_object_size (&codestr[h], 0)) : __inline_memset_chk (&codestr[h], 9, i - h));
                    (__builtin_expect(!(codestr[i] == 100), 0) ? __assert_rtn(__func__, "peephole.c", 577, "codestr[i] == LOAD_CONST") : (void)0);
                    do { (__builtin_expect(!(const_stack_top + 1 >= 2), 0) ? __assert_rtn(__func__, "peephole.c", 578, "const_stack_top + 1 >= 2") : (void)0); const_stack_top -= 2; } while(0);
                    do { PyObject *_x; (__builtin_expect(!(codestr[i] == 100), 0) ? __assert_rtn(__func__, "peephole.c", 579, "codestr[i] == LOAD_CONST") : (void)0); (__builtin_expect(!((((PyVarObject*)(consts))->ob_size) > ((int)((codestr[i+2]<<8) + codestr[i+1]))), 0) ? __assert_rtn(__func__, "peephole.c", 579, "PyList_GET_SIZE(consts) > GETARG(codestr, i)") : (void)0); _x = (((PyListObject *)(consts))->ob_item[((int)((codestr[i+2]<<8) + codestr[i+1]))]); if (++const_stack_top >= const_stack_size) { const_stack_size *= 2; ( (const_stack) = ((size_t)(const_stack_size) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(PyObject *)) ? ((void *)0) : (PyObject * *) PyMem_Realloc((const_stack), (const_stack_size) * sizeof(PyObject *)) ); ( (load_const_stack) = ((size_t)(const_stack_size) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(Py_ssize_t)) ? ((void *)0) : (Py_ssize_t *) PyMem_Realloc((load_const_stack), (const_stack_size) * sizeof(Py_ssize_t)) ); if (!const_stack || !load_const_stack) { PyErr_NoMemory(); goto exitError; } } load_const_stack[const_stack_top] = i; const_stack[const_stack_top] = _x; in_consts = 1; } while(0);
                }
                break;
            ...
            case 15:
            case 10:
                h = ((const_stack_top >= 1 - 1) ? load_const_stack[const_stack_top - 1 + 1] : -1);
                (__builtin_expect(!((h >= 0 || (const_stack_top + 1) < 1)), 0) ? __assert_rtn(__func__, "peephole.c", 589, "(h >= 0 || CONST_STACK_LEN() < 1)") : (void)0);
                if (h >= 0 &&
                    (blocks[h]==blocks[h+i-h+1 -1]) &&
                    fold_unaryops_on_constants(&codestr[i-3], consts, const_stack[const_stack_top])) {
                    i -= 2;
                    (__builtin_expect(!(codestr[i] == 100), 0) ? __assert_rtn(__func__, "peephole.c", 594, "codestr[i] == LOAD_CONST") : (void)0);
                    do { (__builtin_expect(!(const_stack_top + 1 >= 1), 0) ? __assert_rtn(__func__, "peephole.c", 595, "const_stack_top + 1 >= 1") : (void)0); const_stack_top -= 1; } while(0);
                    do { PyObject *_x; (__builtin_expect(!(codestr[i] == 100), 0) ? __assert_rtn(__func__, "peephole.c", 596, "codestr[i] == LOAD_CONST") : (void)0); (__builtin_expect(!((((PyVarObject*)(consts))->ob_size) > ((int)((codestr[i+2]<<8) + codestr[i+1]))), 0) ? __assert_rtn(__func__, "peephole.c", 596, "PyList_GET_SIZE(consts) > GETARG(codestr, i)") : (void)0); _x = (((PyListObject *)(consts))->ob_item[((int)((codestr[i+2]<<8) + codestr[i+1]))]); if (++const_stack_top >= const_stack_size) { const_stack_size *= 2; ( (const_stack) = ((size_t)(const_stack_size) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(PyObject *)) ? ((void *)0) : (PyObject * *) PyMem_Realloc((const_stack), (const_stack_size) * sizeof(PyObject *)) ); ( (load_const_stack) = ((size_t)(const_stack_size) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(Py_ssize_t)) ? ((void *)0) : (Py_ssize_t *) PyMem_Realloc((load_const_stack), (const_stack_size) * sizeof(Py_ssize_t)) ); if (!const_stack || !load_const_stack) { PyErr_NoMemory(); goto exitError; } } load_const_stack[const_stack_top] = i; const_stack[const_stack_top] = _x; in_consts = 1; } while(0);
                }
                break;
# 614 "peephole.c"
            case 111:
            case 112:
                tgt = (((int)((codestr[i+2]<<8) + codestr[i+1])) + ((codestr[i]==113 || codestr[i]==119 || codestr[i]==114 || codestr[i]==115 || codestr[i]==111 || codestr[i]==112) ? 0 : i+3));
                j = codestr[tgt];
                if ((j==114 || j==115 || j==111 || j==112)) {


                    if ((j==115 || j==112) == (opcode==115 || opcode==112)) {


                        tgttgt = (((int)((codestr[tgt+2]<<8) + codestr[tgt+1])) + ((codestr[tgt]==113 || codestr[tgt]==119 || codestr[tgt]==114 || codestr[tgt]==115 || codestr[tgt]==111 || codestr[tgt]==112) ? 0 : tgt+3));


                        codestr[i] = j;
                        codestr[i+2] = tgttgt>>8; codestr[i+1] = tgttgt & 255;
                        goto reoptimize_current;
                    } else {
                        ...
                        if ((opcode==115 || opcode==112))
                            codestr[i] = 115;
                        else
                            codestr[i] = 114;
                        codestr[i+2] = (tgt + 3)>>8; codestr[i+1] = (tgt + 3) & 255;
                        goto reoptimize_current;
                    }
                }
            ...
            case 143:
                ...
                if ((opcode==113 || opcode==110) &&
                    codestr[tgt] == 83) {
                    codestr[i] = 83;
                    ((__builtin_object_size (codestr+i+1, 0) != (size_t) -1) ? __builtin___memset_chk (codestr+i+1, 9, 2, __builtin_object_size (codestr+i+1, 0)) : __inline_memset_chk (codestr+i+1, 9, 2));
                    continue;
                }
                if (!(codestr[tgt]==113 || codestr[tgt]==110))
                    continue;
                tgttgt = (((int)((codestr[tgt+2]<<8) + codestr[tgt+1])) + ((codestr[tgt]==113 || codestr[tgt]==119 || codestr[tgt]==114 || codestr[tgt]==115 || codestr[tgt]==111 || codestr[tgt]==112) ? 0 : tgt+3));
                if (opcode == 110)
                    opcode = 113;
                if (!(opcode==113 || opcode==119 || opcode==114 || opcode==115 || opcode==111 || opcode==112))
                    tgttgt -= i + 3;
                if (tgttgt < 0)
                    continue;
                codestr[i] = opcode;
            ...
            case 83:
                if (i+4 >= codelen)
                    continue;
                if (codestr[i+4] == 83 &&
                    (blocks[i]==blocks[i+5 -1]))
                    ((__builtin_object_size (codestr+i+1, 0) != (size_t) -1) ? __builtin___memset_chk (codestr+i+1, 9, 4, __builtin_object_size (codestr+i+1, 0)) : __inline_memset_chk (codestr+i+1, 9, 4));
                else if ((codestr[i+1]==113 || codestr[i+1]==110) &&
                         (blocks[i]==blocks[i+4 -1]))
                    ((__builtin_object_size (codestr+i+1, 0) != (size_t) -1) ? __builtin___memset_chk (codestr+i+1, 9, 3, __builtin_object_size (codestr+i+1, 0)) : __inline_memset_chk (codestr+i+1, 9, 3));
                break;
        }
    }
    ...
    for (i=0 ; i < tabsiz ; i+=2) {
        ...
        (__builtin_expect(!(new_line - last_line < 255), 0) ? __assert_rtn(__func__, "peephole.c", 713, "new_line - last_line < 255") : (void)0);
    ...
    for (i=0, h=0 ; i<codelen ; ) {
        ...
        switch (opcode) {
            ...
            case 111:
            case 112:
                j = addrmap[((int)((codestr[i+2]<<8) + codestr[i+1]))];
                codestr[i+2] = j>>8; codestr[i+1] = j & 255;
                break;
            ...
            case 122:
            case 143:
                j = addrmap[((int)((codestr[i+2]<<8) + codestr[i+1])) + i + 3] - addrmap[i] - 3;
                codestr[i+2] = j>>8; codestr[i+1] = j & 255;
                break;
        }
        adj = (((opcode) >= 90) ? 3 : 1);
    ...
    (__builtin_expect(!(h + nops == codelen), 0) ? __assert_rtn(__func__, "peephole.c", 750, "h + nops == codelen") : (void)0);

    code = PyBytes_FromStringAndSize((char *)codestr, h);
    do { if (const_stack) PyMem_Free(const_stack); if (load_const_stack) PyMem_Free(load_const_stack); } while(0);
    PyMem_Free(addrmap);
    PyMem_Free(codestr);
    PyMem_Free(blocks);
    return code;
