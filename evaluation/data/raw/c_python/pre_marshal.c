...
w_more(int c, WFILE *p)
{
    ...
    if (_PyBytes_Resize(&p->str, newsize) != 0) {
        ...
        p->ptr = ((__builtin_expect(!(((((((PyObject*)((PyBytesObject *)p->str))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "marshal.c", 90, "PyBytes_Check((PyBytesObject *)p->str)") : (void)0), (((PyBytesObject *)((PyBytesObject *)p->str))->ob_sval)) + size;
        p->end =
            ((__builtin_expect(!(((((((PyObject*)((PyBytesObject *)p->str))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "marshal.c", 92, "PyBytes_Check((PyBytesObject *)p->str)") : (void)0), (((PyBytesObject *)((PyBytesObject *)p->str))->ob_sval)) + newsize;
        *p->ptr++ = (char)(c);
    }
}
...
w_string(char *s, Py_ssize_t n, WFILE *p)
{
    if (p->fp != ((void *)0)) {
        ...
        while (--n >= 0) {
            if (((p)->fp)) putc((*s), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = (*s); else w_more(*s, p);
            s++;
        }
    }
}
...
{
    if (((p)->fp)) putc(((char)( x & 0xff)), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ((char)( x & 0xff)); else w_more((char)( x & 0xff), p);
    if (((p)->fp)) putc(((char)((x>> 8) & 0xff)), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ((char)((x>> 8) & 0xff)); else w_more((char)((x>> 8) & 0xff), p);
}
...
w_long(long x, WFILE *p)
{
    if (((p)->fp)) putc(((char)( x & 0xff)), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ((char)( x & 0xff)); else w_more((char)( x & 0xff), p);
    if (((p)->fp)) putc(((char)((x>> 8) & 0xff)), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ((char)((x>> 8) & 0xff)); else w_more((char)((x>> 8) & 0xff), p);
    if (((p)->fp)) putc(((char)((x>>16) & 0xff)), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ((char)((x>>16) & 0xff)); else w_more((char)((x>>16) & 0xff), p);
    if (((p)->fp)) putc(((char)((x>>24) & 0xff)), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ((char)((x>>24) & 0xff)); else w_more((char)((x>>24) & 0xff), p);
}
# 154 "marshal.c"
static void
w_PyLong(const PyLongObject *ob, WFILE *p)
{
    ...
    if (((p)->fp)) putc(('l'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('l'); else w_more('l', p);
    if ((((PyVarObject*)(ob))->ob_size) == 0) {
        w_long((long)0, p);
        return;
    }


    n = (((((PyVarObject*)(ob))->ob_size)) < 0 ? -((((PyVarObject*)(ob))->ob_size)) : ((((PyVarObject*)(ob))->ob_size)));
    l = (n-1) * (30 / 15);
    d = ob->ob_digit[n-1];
    (__builtin_expect(!(d != 0), 0) ? __assert_rtn(__func__, "marshal.c", 170, "d != 0") : (void)0);
    do {
        d >>= 15;
        l++;
    } while (d != 0);
    ...
    w_long((long)((((PyVarObject*)(ob))->ob_size) > 0 ? l : -l), p);

    for (i=0; i < n-1; i++) {
        d = ob->ob_digit[i];
        for (j=0; j < (30 / 15); j++) {
            w_short(d & (((short)1 << 15) - 1), p);
            d >>= 15;
        }
        (__builtin_expect(!(d == 0), 0) ? __assert_rtn(__func__, "marshal.c", 188, "d == 0") : (void)0);
    }
    d = ob->ob_digit[n-1];
    do {
        w_short(d & (((short)1 << 15) - 1), p);
...
w_object(PyObject *v, WFILE *p)
{
    ...
    if (p->depth > 2000) {
        ...
        if (((p)->fp)) putc(('0'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('0'); else w_more('0', p);
    }
    else if (v == (&_Py_NoneStruct)) {
        if (((p)->fp)) putc(('N'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('N'); else w_more('N', p);
    }
    else if (v == PyExc_StopIteration) {
        if (((p)->fp)) putc(('S'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('S'); else w_more('S', p);
    }
    else if (v == (&_Py_EllipsisObject)) {
        if (((p)->fp)) putc(('.'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('.'); else w_more('.', p);
    }
    else if (v == ((PyObject *) &_Py_FalseStruct)) {
        if (((p)->fp)) putc(('F'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('F'); else w_more('F', p);
    }
    else if (v == ((PyObject *) &_Py_TrueStruct)) {
        if (((p)->fp)) putc(('T'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('T'); else w_more('T', p);
    }
    else if (((((PyObject*)(v))->ob_type) == &PyLong_Type)) {
        ...
        if ((x == -1) && PyErr_Occurred()) {
            ...
            {
                if (((p)->fp)) putc(('i'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('i'); else w_more('i', p);
                w_long(x, p);
            }
        }
    }
    else if (((((PyObject*)(v))->ob_type) == &PyFloat_Type)) {
        if (p->version > 1) {
            unsigned char buf[8];
            ...
            if (((p)->fp)) putc(('g'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('g'); else w_more('g', p);
            w_string((char*)buf, 8, p);
        }
        else {
            char *buf = PyOS_double_to_string((((PyFloatObject *)(v))->ob_fval),
                                              'g', 17, 0, ((void *)0));
            if (!buf) {
                p->error = 3;
                return;
            ...
            n = strlen(buf);
            if (((p)->fp)) putc(('f'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('f'); else w_more('f', p);
            if (((p)->fp)) putc(((int)n), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ((int)n); else w_more((int)n, p);
            w_string(buf, n, p);
            PyMem_Free(buf);
        }
    }
    else if (((((PyObject*)(v))->ob_type) == &PyComplex_Type)) {
        if (p->version > 1) {
            unsigned char buf[8];
            ...
            if (((p)->fp)) putc(('y'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('y'); else w_more('y', p);
            w_string((char*)buf, 8, p);
            ...
            char *buf;
            if (((p)->fp)) putc(('x'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('x'); else w_more('x', p);
    ...
    else if (((((PyObject*)(v))->ob_type) == &PyBytes_Type)) {
        if (((p)->fp)) putc(('s'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('s'); else w_more('s', p);
        n = ((__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "marshal.c", 316, "PyBytes_Check(v)") : (void)0),(((PyVarObject*)(v))->ob_size));
        do { if ((n) > 0x7FFFFFFF) { (p)->depth--; (p)->error = 1; return; } w_long((long)(n), p); } while(0);
        w_string(((__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "marshal.c", 318, "PyBytes_Check(v)") : (void)0), (((PyBytesObject *)(v))->ob_sval)), n, p);
    }
    else if (((((PyObject*)(v))->ob_type) == &PyUnicode_Type)) {
        PyObject *utf8;
        ...
        if (((p)->fp)) putc(('u'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('u'); else w_more('u', p);
        n = ((__builtin_expect(!(((((((PyObject*)(utf8))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "marshal.c", 329, "PyBytes_Check(utf8)") : (void)0),(((PyVarObject*)(utf8))->ob_size));
        do { if ((n) > 0x7FFFFFFF) { (p)->depth--; (p)->error = 1; return; } w_long((long)(n), p); } while(0);
        w_string(((__builtin_expect(!(((((((PyObject*)(utf8))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "marshal.c", 331, "PyBytes_Check(utf8)") : (void)0), (((PyBytesObject *)(utf8))->ob_sval)), n, p);
        do { if ( --((PyObject*)(utf8))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(utf8)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(utf8)))); } while (0);
    }
    else if (((((PyObject*)(v))->ob_type) == &PyTuple_Type)) {
        if (((p)->fp)) putc(('('), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('('); else w_more('(', p);
        n = PyTuple_Size(v);
        do { if ((n) > 0x7FFFFFFF) { (p)->depth--; (p)->error = 1; return; } w_long((long)(n), p); } while(0);
        for (i = 0; i < n; i++) {
            w_object((((PyTupleObject *)(v))->ob_item[i]), p);
        }
    }
        ...
        do { if ((n) > 0x7FFFFFFF) { (p)->depth--; (p)->error = 1; return; } w_long((long)(n), p); } while(0);
        for (i = 0; i < n; i++) {
            w_object((((PyListObject *)(v))->ob_item[i]), p);
        }
    }
    else if (((((PyObject*)(v))->ob_type) == &PyDict_Type)) {
        Py_ssize_t pos;
        PyObject *key, *value;
        if (((p)->fp)) putc(('{'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('{'); else w_more('{', p);
        ...
        w_object((PyObject *)((void *)0), p);
    }
    else if (((((PyObject*)(v))->ob_type) == &PySet_Type || (((PyObject*)(v))->ob_type) == &PyFrozenSet_Type)) {
        PyObject *value, *it;

        if (((((PyObject*)(v))->ob_type) == (&PySet_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PySet_Type))))
            if (((p)->fp)) putc(('<'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('<'); else w_more('<', p);
        else
            if (((p)->fp)) putc(('>'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('>'); else w_more('>', p);
        n = PyObject_Size(v);
        ...
        while ((value = PyIter_Next(it)) != ((void *)0)) {
            w_object(value, p);
    ...
    else if (((((PyObject*)(v))->ob_type) == &PyCode_Type)) {
        PyCodeObject *co = (PyCodeObject *)v;
        if (((p)->fp)) putc(('c'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('c'); else w_more('c', p);
        ...
        char *s;
        Py_buffer view;
        if (PyObject_GetBuffer(v, &view, 0) != 0) {
            if (((p)->fp)) putc(('?'), (p)->fp); else if ((p)->ptr != (p)->end) *(p)->ptr++ = ('?'); else w_more('?', p);
            p->depth--;
            p->error = 1;
            return;
...
r_string(char *s, Py_ssize_t n, RFILE *p)
{
    ...
    if (!p->readable) {
        if (p->fp != ((void *)0))
            ...
            left = p->end - p->ptr;
            read = (left < n) ? left : n;
            ((__builtin_object_size (s, 0) != (size_t) -1) ? __builtin___memcpy_chk (s, p->ptr, read, __builtin_object_size (s, 0)) : __inline_memcpy_chk (s, p->ptr, read));
            p->ptr += read;
        }
    }
    else {
        ...
        PyObject *data = _PyObject_CallMethodId_SizeT(p->readable, &PyId_read, "n", n);
        read = 0;
        if (data != ((void *)0)) {
            if (!((((((PyObject*)(data))->ob_type))->tp_flags & ((1L<<27))) != 0)) {
                ...
                read = ((__builtin_expect(!(((((((PyObject*)(data))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "marshal.c", 492, "PyBytes_Check(data)") : (void)0),(((PyVarObject*)(data))->ob_size));
                if (read > 0) {
                    ptr = ((__builtin_expect(!(((((((PyObject*)(data))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "marshal.c", 494, "PyBytes_Check(data)") : (void)0), (((PyBytesObject *)(data))->ob_sval));
                    ((__builtin_object_size (s, 0) != (size_t) -1) ? __builtin___memcpy_chk (s, ptr, read, __builtin_object_size (s, 0)) : __inline_memcpy_chk (s, ptr, read));
                }
            }
...
r_byte(RFILE *p)
{
    ...
    if (!p->readable)
        c = p->fp ? getc(p->fp) : (((p)->ptr < (p)->end) ? (unsigned char)*(p)->ptr++ : (-1));
    else {
...
r_PyLong(RFILE *p)
{
    ...
    size = 1 + (((n) < 0 ? -(n) : (n)) - 1) / (30 / 15);
    shorts_in_top_digit = 1 + (((n) < 0 ? -(n) : (n)) - 1) % (30 / 15);
    ob = _PyLong_New(size);
    if (ob == ((void *)0))
        return ((void *)0);
    (((PyVarObject*)(ob))->ob_size) = n > 0 ? size : -size;
...
r_object(RFILE *p)
{
    ...
    case 'N':
        ...
        retval = (&_Py_NoneStruct);
        break;

    case 'S':
        ( ((PyObject*)(PyExc_StopIteration))->ob_refcnt++);
        retval = PyExc_StopIteration;
        break;

    case '.':
        ( ((PyObject*)((&_Py_EllipsisObject)))->ob_refcnt++);
        retval = (&_Py_EllipsisObject);
        break;

    case 'F':
        ( ((PyObject*)(((PyObject *) &_Py_FalseStruct)))->ob_refcnt++);
        retval = ((PyObject *) &_Py_FalseStruct);
        break;

    case 'T':
        ( ((PyObject*)(((PyObject *) &_Py_TrueStruct)))->ob_refcnt++);
        retval = ((PyObject *) &_Py_TrueStruct);
        break;

    case 'i':
        n = r_long(p);
        retval = PyErr_Occurred() ? ((void *)0) : PyLong_FromLong(n);
        break;
    ...
    case 'f':
        {
            ...
            retval = ((void *)0);
            n = r_byte(p);
            if (n == (-1) || r_string(buf, n, p) != n) {
                PyErr_SetString(PyExc_EOFError,
                    "EOF read where object expected");
                break;
            }
            buf[n] = '\0';
            dx = PyOS_string_to_double(buf, ((void *)0), ((void *)0));
    ...
    case 'x':
        {
            ...
            buf[n] = '\0';
            c.real = PyOS_string_to_double(buf, ((void *)0), ((void *)0));
            ...
            buf[n] = '\0';
            c.imag = PyOS_string_to_double(buf, ((void *)0), ((void *)0));
    ...
    case 's':
        ...
        v = PyBytes_FromStringAndSize((char *)((void *)0), n);
        if (v == ((void *)0)) {
            retval = ((void *)0);
            break;
        }
        if (r_string(((__builtin_expect(!(((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "marshal.c", 844, "PyBytes_Check(v)") : (void)0), (((PyBytesObject *)(v))->ob_sval)), n, p) != n) {
    ...
    case 'u':
        ...
        buffer = ( ((size_t)(n) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(char)) ? ((void *)0) : ( (char *) ((size_t)((n) * sizeof(char)) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc(((n) * sizeof(char)) ? ((n) * sizeof(char)) : 1)) ) );
        if (buffer == ((void *)0)) {
    ...
    case '>':
        ...
        v = (type == '<') ? PySet_New(((void *)0)) : PyFrozenSet_New(((void *)0));
        if (v == ((void *)0)) {
            retval = ((void *)0);
            break;
        }
    ...
    case 'c':
        {
            ...
            if (filename == ((void *)0))
                goto code_error;
            if (((((PyObject*)(filename))->ob_type) == &PyUnicode_Type)) {
                if (p->current_filename != ((void *)0)) {
                    if (!PyUnicode_Compare(filename, p->current_filename)) {
                        ...
                        ( ((PyObject*)(p->current_filename))->ob_refcnt++);
          ...
          code_error:
            ...
            do { if ((lnotab) == ((void *)0)) ; else do { if ( --((PyObject*)(lnotab))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(lnotab)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(lnotab)))); } while (0); } while (0);
        }
        retval = v;
        break;
...
read_object(RFILE *p)
{
    PyObject *v;
    if (PyErr_Occurred()) {
        fprintf(__stderrp, "XXX readobject called with exception set\n");
        return ((void *)0);
    }
    v = r_object(p);
    if (v == ((void *)0) && !PyErr_Occurred())
...
{
    RFILE rf;
    (__builtin_expect(!(fp), 0) ? __assert_rtn(__func__, "marshal.c", 1138, "fp") : (void)0);
    rf.readable = ((void *)0);
    rf.fp = fp;
    rf.current_filename = ((void *)0);
    rf.end = rf.ptr = ((void *)0);
    return r_short(&rf);
}
...
PyMarshal_ReadLastObjectFromFile(FILE *fp)
{
    ...
    if (filesize > 0 && filesize <= (1L << 18)) {
        char* pBuf = (char *)((size_t)(filesize) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc((filesize) ? (filesize) : 1));
        if (pBuf != ((void *)0)) {
...
PyMarshal_WriteObjectToString(PyObject *x, int version)
{
    ...
    wf.fp = ((void *)0);
    wf.readable = ((void *)0);
    wf.str = PyBytes_FromStringAndSize((char *)((void *)0), 50);
    if (wf.str == ((void *)0))
        return ((void *)0);
    wf.ptr = ((__builtin_expect(!(((((((PyObject*)((PyBytesObject *)wf.str))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "marshal.c", 1242, "PyBytes_Check((PyBytesObject *)wf.str)") : (void)0), (((PyBytesObject *)((PyBytesObject *)wf.str))->ob_sval));
    ...
    w_object(x, &wf);
    if (wf.str != ((void *)0)) {
        char *base = ((__builtin_expect(!(((((((PyObject*)((PyBytesObject *)wf.str))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "marshal.c", 1249, "PyBytes_Check((PyBytesObject *)wf.str)") : (void)0), (((PyBytesObject *)((PyBytesObject *)wf.str))->ob_sval));
        if (wf.ptr - base > ((Py_ssize_t)(((size_t)-1)>>1))) {
            do { if ( --((PyObject*)(wf.str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(wf.str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(wf.str)))); } while (0);
    ...
    if (wf.error != 0) {
        do { if ((wf.str) == ((void *)0)) ; else do { if ( --((PyObject*)(wf.str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(wf.str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(wf.str)))); } while (0); } while (0);
        if (wf.error == 3)
            PyErr_NoMemory();
        else
            PyErr_SetString(PyExc_ValueError,
...
marshal_dump(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "OO|i:dump", &x, &f, &version))
        return ((void *)0);
    s = PyMarshal_WriteObjectToString(x, version);
    if (s == ((void *)0))
        return ((void *)0);
    res = _PyObject_CallMethodId_SizeT(f, &PyId_write, "O", s);
...
marshal_load(PyObject *self, PyObject *f)
{
    ...
    data = _PyObject_CallMethodId_SizeT(f, &PyId_read, "i", 0);
    if (data == ((void *)0))
        return ((void *)0);
    if (!((((((PyObject*)(data))->ob_type))->tp_flags & ((1L<<27))) != 0)) {
        PyErr_Format(PyExc_TypeError,
...
marshal_dumps(PyObject *self, PyObject *args)
{
    PyObject *x;
    int version = 2;
    if (!_PyArg_ParseTuple_SizeT(args, "O|i:dumps", &x, &version))
        return ((void *)0);
...
marshal_loads(PyObject *self, PyObject *args)
{
    ...
    Py_ssize_t n;
    PyObject* result;
    if (!_PyArg_ParseTuple_SizeT(args, "y*:loads", &p))
        return ((void *)0);
    s = p.buf;
    n = p.len;
    rf.fp = ((void *)0);
...
static char loads_doc[] = "loads(bytes)\n\nConvert the bytes object to a value. If no valid value is found, raise\nEOFError, ValueError or TypeError. Extra characters in the input are\nignored.";
...
static PyMethodDef marshal_methods[] = {
    {"dump", marshal_dump, 0x0001, dump_doc},
    {"load", marshal_load, 0x0008, load_doc},
    {"dumps", marshal_dumps, 0x0001, dumps_doc},
    {"loads", marshal_loads, 0x0001, loads_doc},
    {((void *)0), ((void *)0)}
};
...
PyMarshal_Init(void)
{
    PyObject *mod = PyModule_Create2(&marshalmodule, 1013);
    if (mod == ((void *)0))
        return ((void *)0);
    PyModule_AddIntConstant(mod, "version", 2);
    return mod;
}
