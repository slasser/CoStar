...
static PyFloatObject *free_list = ((void *)0);
...
static char floatinfo__doc__[] = "sys.float_info\n\nA structseq holding information about the float type. It contains low level\ninformation about the precision and internal representation. Please study\nyour system's :file:`float.h` for more information.";
...
PyFloat_GetInfo(void)
{
    ...
    (((PyTupleObject *)(floatinfo))->ob_item[pos++] = PyFloat_FromDouble(1.7976931348623157e+308));
    (((PyTupleObject *)(floatinfo))->ob_item[pos++] = PyLong_FromLong(1024));
    (((PyTupleObject *)(floatinfo))->ob_item[pos++] = PyLong_FromLong(308));
    (((PyTupleObject *)(floatinfo))->ob_item[pos++] = PyFloat_FromDouble(2.2250738585072014e-308));
    (((PyTupleObject *)(floatinfo))->ob_item[pos++] = PyLong_FromLong((-1021)));
    (((PyTupleObject *)(floatinfo))->ob_item[pos++] = PyLong_FromLong((-307)));
    (((PyTupleObject *)(floatinfo))->ob_item[pos++] = PyLong_FromLong(15));
    (((PyTupleObject *)(floatinfo))->ob_item[pos++] = PyLong_FromLong(53));
    (((PyTupleObject *)(floatinfo))->ob_item[pos++] = PyFloat_FromDouble(2.2204460492503131e-16));
    (((PyTupleObject *)(floatinfo))->ob_item[pos++] = PyLong_FromLong(2));
    (((PyTupleObject *)(floatinfo))->ob_item[pos++] = PyLong_FromLong((__builtin_flt_rounds ())));



    if (PyErr_Occurred()) {
        do { if (floatinfo) { PyObject *_py_tmp = (PyObject *)(floatinfo); (floatinfo) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
        return ((void *)0);
    }
    return floatinfo;
}
...
PyFloat_FromDouble(double fval)
{
    ...
    ( (((PyObject*)(op))->ob_type) = (&PyFloat_Type), ( (((PyObject*)((PyObject *)(op)))->ob_refcnt) = 1), (op) );
    op->ob_fval = fval;
    return (PyObject *) op;
}
...
PyFloat_FromString(PyObject *v)
{
    ...
    if (((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        ...
        if (s == ((void *)0)) {
            do { if ( --((PyObject*)(s_buffer))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(s_buffer)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(s_buffer)))); } while (0);
            return ((void *)0);
        }
    }
    ...
    while (s < last && (_Py_ctype_table[((unsigned char)((*s) & 0xff))] & 0x08))
        s++;
    while (s < last - 1 && (_Py_ctype_table[((unsigned char)((last[-1]) & 0xff))] & 0x08))
        last--;



    x = PyOS_string_to_double(s, (char **)&end, ((void *)0));
    if (end != last) {
    ...
    do { if ((s_buffer) == ((void *)0)) ; else do { if ( --((PyObject*)(s_buffer))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(s_buffer)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(s_buffer)))); } while (0); } while (0);
    return result;
}
...
{
    if (((((PyObject*)(op))->ob_type) == &PyFloat_Type)) {
        if (numfree >= 100) {
            PyObject_Free(op);
            return;
        }
        numfree++;
        (((PyObject*)(op))->ob_type) = (struct _typeobject *)free_list;
        free_list = op;
    }
    else
...
PyFloat_AsDouble(PyObject *op)
{
    ...
    if (op && ((((PyObject*)(op))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(op))->ob_type), (&PyFloat_Type))))
        return (((PyFloatObject *)((PyFloatObject*) op))->ob_fval);
    ...
    if ((nb = (((PyObject*)(op))->ob_type)->tp_as_number) == ((void *)0) || nb->nb_float == ((void *)0)) {
    ...
    if (fo == ((void *)0))
        return -1;
    if (!((((PyObject*)(fo))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(fo))->ob_type), (&PyFloat_Type)))) {
        PyErr_SetString(PyExc_TypeError,
                        "nb_float should return float object");
        return -1;
    }

    val = (((PyFloatObject *)(fo))->ob_fval);
    do { if ( --((PyObject*)(fo))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(fo)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(fo)))); } while (0);
...
float_repr(PyFloatObject *v)
{
    ...
    buf = PyOS_double_to_string((((PyFloatObject *)(v))->ob_fval),
                                'r', 0,
                                0x02,
                                ((void *)0));
    if (!buf)
...
float_richcompare(PyObject *v, PyObject *w, int op)
{
    ...
    (__builtin_expect(!(((((PyObject*)(v))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PyFloat_Type)))), 0) ? __assert_rtn(__func__, "floatobject.c", 304, "PyFloat_Check(v)") : (void)0);
    i = (((PyFloatObject *)(v))->ob_fval);




    if (((((PyObject*)(w))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(w))->ob_type), (&PyFloat_Type))))
        j = (((PyFloatObject *)(w))->ob_fval);

    else if (!( sizeof (i) == sizeof(float ) ? __inline_isfinitef((float)(i)) : sizeof (i) == sizeof(double) ? __inline_isfinited((double)(i)) : __inline_isfinite ((long double)(i)))) {
        if (((((((PyObject*)(w))->ob_type))->tp_flags & ((1L<<24))) != 0))
    ...
    else if (((((((PyObject*)(w))->ob_type))->tp_flags & ((1L<<24))) != 0)) {
        ...
        if (nbits == (size_t)-1 && PyErr_Occurred()) {
            ...
            PyErr_Clear();
            i = (double)vsign;
            (__builtin_expect(!(wsign != 0), 0) ? __assert_rtn(__func__, "floatobject.c", 350, "wsign != 0") : (void)0);
            j = wsign * 2.0;
            goto Compare;
        }
        if (nbits <= 48) {
            ...
            (__builtin_expect(!(j != -1.0 || ! PyErr_Occurred()), 0) ? __assert_rtn(__func__, "floatobject.c", 357, "j != -1.0 || ! PyErr_Occurred()") : (void)0);
            goto Compare;
        }
        (__builtin_expect(!(wsign != 0), 0) ? __assert_rtn(__func__, "floatobject.c", 360, "wsign != 0") : (void)0);
        (__builtin_expect(!(vsign != 0), 0) ? __assert_rtn(__func__, "floatobject.c", 361, "vsign != 0") : (void)0);
        ...
        (__builtin_expect(!(i > 0.0), 0) ? __assert_rtn(__func__, "floatobject.c", 372, "i > 0.0") : (void)0);
...

        {
            ...
            if (fracpart != 0.0) {
                ...
                if (temp == ((void *)0))
                    goto Error;
                do { if ( --((PyObject*)(ww))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ww)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ww)))); } while (0);
                ww = temp;
         ...
         Error:
            do { if ((vv) == ((void *)0)) ; else do { if ( --((PyObject*)(vv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(vv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(vv)))); } while (0); } while (0);
            do { if ((ww) == ((void *)0)) ; else do { if ( --((PyObject*)(ww))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ww)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ww)))); } while (0); } while (0);
...
{
    double a,b;
    if (((((PyObject*)(v))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PyFloat_Type)))) a = (((PyFloatObject *)(v))->ob_fval); else if (convert_to_double(&(v), &(a)) < 0) return v;;
    if (((((PyObject*)(w))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(w))->ob_type), (&PyFloat_Type)))) b = (((PyFloatObject *)(w))->ob_fval); else if (convert_to_double(&(w), &(b)) < 0) return w;;
...
float_rem(PyObject *v, PyObject *w)
{
    double vx, wx;
    double mod;
    if (((((PyObject*)(v))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PyFloat_Type)))) vx = (((PyFloatObject *)(v))->ob_fval); else if (convert_to_double(&(v), &(vx)) < 0) return v;;
    if (((((PyObject*)(w))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(w))->ob_type), (&PyFloat_Type)))) wx = (((PyFloatObject *)(w))->ob_fval); else if (convert_to_double(&(w), &(wx)) < 0) return w;;
    if (wx == 0.0) {
        PyErr_SetString(PyExc_ZeroDivisionError,
                        "float modulo");
        return ((void *)0);
...
float_floor_div(PyObject *v, PyObject *w)
{
    ...
    t = float_divmod(v, w);
    if (t == ((void *)0) || t == (&_Py_NotImplementedStruct))
        return t;
    (__builtin_expect(!(((((PyObject*)(t))->ob_type) == &PyTuple_Type)), 0) ? __assert_rtn(__func__, "floatobject.c", 629, "PyTuple_CheckExact(t)") : (void)0);
    r = (((PyTupleObject *)(t))->ob_item[0]);
...
float_pow(PyObject *v, PyObject *w, PyObject *z)
{
    ...
    if ((PyObject *)z != (&_Py_NoneStruct)) {
        PyErr_SetString(PyExc_TypeError, "pow() 3rd argument not "
            "allowed unless all arguments are integers");
        return ((void *)0);
    }

    if (((((PyObject*)(v))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PyFloat_Type)))) iv = (((PyFloatObject *)(v))->ob_fval); else if (convert_to_double(&(v), &(iv)) < 0) return v;;
    if (((((PyObject*)(w))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(w))->ob_type), (&PyFloat_Type)))) iw = (((PyFloatObject *)(w))->ob_fval); else if (convert_to_double(&(w), &(iw)) < 0) return w;;


    if (iw == 0) {
        return PyFloat_FromDouble(1.0);
    }
    if (( sizeof (iv) == sizeof(float ) ? __inline_isnanf((float)(iv)) : sizeof (iv) == sizeof(double) ? __inline_isnand((double)(iv)) : __inline_isnan ((long double)(iv)))) {
        return PyFloat_FromDouble(iv);
    }
    if (( sizeof (iw) == sizeof(float ) ? __inline_isnanf((float)(iw)) : sizeof (iw) == sizeof(double) ? __inline_isnand((double)(iw)) : __inline_isnan ((long double)(iw)))) {
        return PyFloat_FromDouble(iv == 1.0 ? 1.0 : iw);
    }
    if (( sizeof (iw) == sizeof(float ) ? __inline_isinff((float)(iw)) : sizeof (iw) == sizeof(double) ? __inline_isinfd((double)(iw)) : __inline_isinf ((long double)(iw)))) {
    ...
    if (( sizeof (iv) == sizeof(float ) ? __inline_isinff((float)(iv)) : sizeof (iv) == sizeof(double) ? __inline_isinfd((double)(iv)) : __inline_isinf ((long double)(iv)))) {




        int iw_is_odd = (fmod(fabs(iw), 2.0) == 1.0);
        if (iw > 0.0)
    ...
    if (iv < 0.0) {
        ...
        iv = -iv;
        negate_result = (fmod(fabs(iw), 2.0) == 1.0);
    }
...
# 736 "floatobject.c"
    ...
    do { if ((*__error()) == 0) { if ((ix) == __builtin_huge_val() || (ix) == -__builtin_huge_val()) (*__error()) = 34; } else if ((*__error()) == 34 && (ix) == 0.0) (*__error()) = 0; } while(0);
    if (negate_result)
        ix = -ix;
    ...
    if ((*__error()) != 0) {
        ...
        PyErr_SetFromErrno((*__error()) == 34 ? PyExc_OverflowError :
                             PyExc_ValueError);
        return ((void *)0);
    }
...
float_is_integer(PyObject *v)
{
    ...
    o = (floor(x) == x) ? ((PyObject *) &_Py_TrueStruct) : ((PyObject *) &_Py_FalseStruct);
...
# 853 "floatobject.c"
    if ((-9223372036854775807L - 1L) < wholepart && wholepart < 9223372036854775807L) {
...
double_round(double x, int ndigits) {
    ...
    (*__error()) = 0;
    ;
    rounded = _Py_dg_strtod(mybuf, ((void *)0));
    ;
    if ((*__error()) == 34 && fabs(rounded) >= 1.)
...
float_round(PyObject *v, PyObject *args)
{
    ...
    ndigits = PyNumber_AsSsize_t(o_ndigits, ((void *)0));
    ...
    if (ndigits > ((int)((53 -(-1021)) * 0.30103)))

        return PyFloat_FromDouble(x);
    else if (ndigits < (-(int)((1024 + 1) * 0.30103)))
...
{
    if (((((PyObject*)(v))->ob_type) == &PyFloat_Type))
...
char_from_hex(int x)
{
    (__builtin_expect(!(0 <= x && x < 16), 0) ? __assert_rtn(__func__, "floatobject.c", 1037, "0 <= x && x < 16") : (void)0);
...
float_hex(PyObject *v)
{
    ...
    char s[(53 + 3 - (53 +2)%4 -1)/4+3];

    if (((((PyObject*)(v))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PyFloat_Type)))) x = (((PyFloatObject *)(v))->ob_fval); else if (convert_to_double(&(v), &(x)) < 0) return v;;

    if (( sizeof (x) == sizeof(float ) ? __inline_isnanf((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isnand((double)(x)) : __inline_isnan ((long double)(x))) || ( sizeof (x) == sizeof(float ) ? __inline_isinff((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isinfd((double)(x)) : __inline_isinf ((long double)(x))))
...
static char float_hex_doc[] = "float.hex() -> string\n\nReturn a hexadecimal representation of a floating-point number.\n>>> (-0.1).hex()\n'-0x1.999999999999ap-4'\n>>> 3.14159.hex()\n'0x1.921f9f01b866ep+1'";
# 1176 "floatobject.c"
static PyObject *
...
# 1231 "floatobject.c"
    ...
    while ((_Py_ctype_table[((unsigned char)((*s) & 0xff))] & 0x08))
        s++;
    ...
    if (ndigits == 0)
        goto parse_error;
    if (ndigits > (((-1021) - 53 - (-9223372036854775807L - 1L)/2) < (9223372036854775807L/2 + 1 - 1024) ? ((-1021) - 53 - (-9223372036854775807L - 1L)/2) : (9223372036854775807L/2 + 1 - 1024))/4)
    ...
    if (*s == 'p' || *s == 'P') {
        ...
        while ('0' <= *s && *s <= '9')
            s++;
        exp = strtol(exp_start, ((void *)0), 10);
    }
    else
        exp = 0;
# 1318 "floatobject.c"
    while (ndigits > 0 && hex_from_char(*((ndigits-1) < fdigits ? coeff_end-(ndigits-1) : coeff_end-1-(ndigits-1))) == 0)
        ndigits--;
    if (ndigits == 0 || exp < (-9223372036854775807L - 1L)/2) {
        x = 0.0;
        goto finished;
    }
    if (exp > 9223372036854775807L/2)
        goto overflow_error;
    ...
    for (digit = hex_from_char(*((ndigits-1) < fdigits ? coeff_end-(ndigits-1) : coeff_end-1-(ndigits-1))); digit != 0; digit /= 2)
        top_exp++;
    ...
    lsb = ((top_exp) < ((long)(-1021)) ? ((long)(-1021)) : (top_exp)) - 53;

    x = 0.0;
    if (exp >= lsb) {

        for (i = ndigits-1; i >= 0; i--)
            x = 16.0*x + hex_from_char(*((i) < fdigits ? coeff_end-(i) : coeff_end-1-(i)));
        x = ldexp(x, (int)(exp));
        goto finished;
    }
    ...
    for (i = ndigits-1; i > key_digit; i--)
        x = 16.0*x + hex_from_char(*((i) < fdigits ? coeff_end-(i) : coeff_end-1-(i)));
    digit = hex_from_char(*((key_digit) < fdigits ? coeff_end-(key_digit) : coeff_end-1-(key_digit)));
    ...
    if ((digit & half_eps) != 0) {
        ...
        if ((digit & (3*half_eps-1)) != 0 ||
            (half_eps == 8 && (hex_from_char(*((key_digit+1) < fdigits ? coeff_end-(key_digit+1) : coeff_end-1-(key_digit+1))) & 1) != 0))
            round_up = 1;
        else
            for (i = key_digit-1; i >= 0; i--)
                if (hex_from_char(*((i) < fdigits ? coeff_end-(i) : coeff_end-1-(i))) != 0) {
                    round_up = 1;
                    break;
                }
        if (round_up) {
  ...
  finished:
    ...
    if (result_as_float == ((void *)0))
        return ((void *)0);
    result = PyObject_CallObject(cls, result_as_float);
    do { if ( --((PyObject*)(result_as_float))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(result_as_float)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(result_as_float)))); } while (0);
    return result;
...
static char float_fromhex_doc[] = "float.fromhex(string) -> float\n\nCreate a floating-point number from a hexadecimal string.\n>>> float.fromhex('0x1.ffffp10')\n2047.984375\n>>> float.fromhex('-0x1p-1074')\n-4.9406564584124654e-324";
# 1427 "floatobject.c"
static PyObject *
float_as_integer_ratio(PyObject *v, PyObject *unused)
{
    ...
    PyObject *prev;
    PyObject *py_exponent = ((void *)0);
    PyObject *numerator = ((void *)0);
    PyObject *denominator = ((void *)0);
    PyObject *result_pair = ((void *)0);
    ...
    if (((((PyObject*)(v))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PyFloat_Type)))) self = (((PyFloatObject *)(v))->ob_fval); else if (convert_to_double(&(v), &(self)) < 0) return v;;

    if (( sizeof (self) == sizeof(float ) ? __inline_isinff((float)(self)) : sizeof (self) == sizeof(double) ? __inline_isinfd((double)(self)) : __inline_isinf ((long double)(self)))) {
      PyErr_SetString(PyExc_OverflowError,
                      "Cannot pass infinity to float.as_integer_ratio.");
      return ((void *)0);
    }
    if (( sizeof (self) == sizeof(float ) ? __inline_isnanf((float)(self)) : sizeof (self) == sizeof(double) ? __inline_isnand((double)(self)) : __inline_isnan ((long double)(self)))) {
      PyErr_SetString(PyExc_ValueError,
    ...
    if (numerator == ((void *)0)) goto error;


    denominator = PyLong_FromLong(1);
    py_exponent = PyLong_FromLong(labs((long)exponent));
    if (py_exponent == ((void *)0)) goto error;
    prev = py_exponent; py_exponent = long_methods->nb_lshift(denominator, py_exponent); do { if ( --((PyObject*)(prev))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(prev)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(prev)))); } while (0);;

    if (py_exponent == ((void *)0)) goto error;
    if (exponent > 0) {
        prev = numerator; numerator = long_methods->nb_multiply(numerator, py_exponent); do { if ( --((PyObject*)(prev))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(prev)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(prev)))); } while (0);;

        if (numerator == ((void *)0)) goto error;
    }
    else {
        do { if ( --((PyObject*)(denominator))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(denominator)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(denominator)))); } while (0);
...
error:
    do { if ((py_exponent) == ((void *)0)) ; else do { if ( --((PyObject*)(py_exponent))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(py_exponent)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(py_exponent)))); } while (0); } while (0);
    do { if ((denominator) == ((void *)0)) ; else do { if ( --((PyObject*)(denominator))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(denominator)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(denominator)))); } while (0); } while (0);
    do { if ((numerator) == ((void *)0)) ; else do { if ( --((PyObject*)(numerator))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(numerator)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(numerator)))); } while (0); } while (0);
    return result_pair;
}

static char float_as_integer_ratio_doc[] = "float.as_integer_ratio() -> (int, int)\n" "\n" "Returns a pair of integers, whose ratio is exactly equal to the original\n" "float and with a positive denominator.\n" "Raises OverflowError on infinities and a ValueError on NaNs.\n" "\n" ">>> (10.0).as_integer_ratio()\n" "(10, 1)\n" ">>> (0.0).as_integer_ratio()\n" "(0, 1)\n" ">>> (-.25).as_integer_ratio()\n" "(-1, 4)";
# 1518 "floatobject.c"
static PyObject *
...
{
    PyObject *x = ((PyObject *) &_Py_FalseStruct);
    ...
    if (((((PyObject*)(x))->ob_type) == &PyUnicode_Type))
...
float_subtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    (__builtin_expect(!(PyType_IsSubtype(type, &PyFloat_Type)), 0) ? __assert_rtn(__func__, "floatobject.c", 1548, "PyType_IsSubtype(type, &PyFloat_Type)") : (void)0);
    tmp = float_new(&PyFloat_Type, args, kwds);
    if (tmp == ((void *)0))
        return ((void *)0);
    (__builtin_expect(!(((((PyObject*)(tmp))->ob_type) == &PyFloat_Type)), 0) ? __assert_rtn(__func__, "floatobject.c", 1552, "PyFloat_CheckExact(tmp)") : (void)0);
...
static char float_getformat_doc[] = "float.__getformat__(typestr) -> string\n" "\n" "You probably don't want to use this function.  It exists mainly to be\n" "used in Python's test suite.\n" "\n" "typestr must be 'double' or 'float'.  This function returns whichever of\n" "'unknown', 'IEEE, big-endian' or 'IEEE, little-endian' best describes the\n" "format of floating point numbers used by the C type named by typestr.";
# 1629 "floatobject.c"
static PyObject *
...
static char float_setformat_doc[] = "float.__setformat__(typestr, fmt) -> None\n" "\n" "You probably don't want to use this function.  It exists mainly to be\n" "used in Python's test suite.\n" "\n" "typestr must be 'double' or 'float'.  fmt must be one of 'unknown',\n" "'IEEE, big-endian' or 'IEEE, little-endian', and in addition can only be\n" "one of the latter two if it appears to match the underlying C reality.\n" "\n" "Overrides the automatic determination of C-level floating point type.\n" "This affects how floats are converted to and from binary strings.";
# 1698 "floatobject.c"
static PyObject *
...
float__format__(PyObject *self, PyObject *args)
{
    ...
    ret = _PyFloat_FormatAdvancedWriter(
        &writer,
        self,
        format_spec, 0, ((__builtin_expect(!(((((((PyObject*)(format_spec))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "floatobject.c", 1718, "PyUnicode_Check(format_spec)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)format_spec)->state.ready)), 0) ? __assert_rtn(__func__, "floatobject.c", 1718, "PyUnicode_IS_READY(format_spec)") : (void)0), ((PyASCIIObject *)(format_spec))->length));
    if (ret == -1) {
...
static char float__format__doc[] = "float.__format__(format_spec) -> string\n" "\n" "Formats the float according to format_spec.";
...
static PyMethodDef float_methods[] = {
    {"conjugate", (PyCFunction)float_float, 0x0004,
     "Returns self, the complex conjugate of any float."},
    {"__trunc__", (PyCFunction)float_trunc, 0x0004,
     "Returns the Integral closest to x between 0 and x."},
    {"__round__", (PyCFunction)float_round, 0x0001,
     "Returns the Integral closest to x, rounding half toward even.\n"
     "When an argument is passed, works like built-in round(x, ndigits)."},
    {"as_integer_ratio", (PyCFunction)float_as_integer_ratio, 0x0004,
     float_as_integer_ratio_doc},
    {"fromhex", (PyCFunction)float_fromhex,
     0x0008|0x0010, float_fromhex_doc},
    {"hex", (PyCFunction)float_hex,
     0x0004, float_hex_doc},
    {"is_integer", (PyCFunction)float_is_integer, 0x0004,
     "Returns True if the float is an integer."},
# 1756 "floatobject.c"
    {"__getnewargs__", (PyCFunction)float_getnewargs, 0x0004},
    {"__getformat__", (PyCFunction)float_getformat,
     0x0008|0x0010, float_getformat_doc},
    {"__setformat__", (PyCFunction)float_setformat,
     0x0001|0x0010, float_setformat_doc},
    {"__format__", (PyCFunction)float__format__,
     0x0001, float__format__doc},
    {((void *)0), ((void *)0)}
};

static PyGetSetDef float_getset[] = {
    {"real",
     (getter)float_float, (setter)((void *)0),
     "the real part of a complex number",
     ((void *)0)},
    {"imag",
     (getter)float_getzero, (setter)((void *)0),
     "the imaginary part of a complex number",
     ((void *)0)},
    {((void *)0)}
};

static char float_doc[] = "float(x) -> floating point number\n\nConvert a string or number to a floating point number, if possible.";
...
_PyFloat_Pack4(double x, unsigned char *p, int le)
{
    if (float_format == unknown_format) {
        ...
        (__builtin_expect(!(fbits <= 8388608), 0) ? __assert_rtn(__func__, "floatobject.c", 2000, "fbits <= 8388608") : (void)0);
        if (fbits >> 23) {
        ...
        *p = fbits & 0xFF;
        ...
        if (( sizeof (y) == sizeof(float ) ? __inline_isinff((float)(y)) : sizeof (y) == sizeof(double) ? __inline_isinfd((double)(y)) : __inline_isinf ((long double)(y))) && !( sizeof (x) == sizeof(float ) ? __inline_isinff((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isinfd((double)(x)) : __inline_isinf ((long double)(x))))
            goto Overflow;
...
_PyFloat_Pack8(double x, unsigned char *p, int le)
{
    if (double_format == unknown_format) {
        ...
        f *= 268435456.0;
        fhi = (unsigned int)f;
        (__builtin_expect(!(fhi < 268435456), 0) ? __assert_rtn(__func__, "floatobject.c", 2106, "fhi < 268435456") : (void)0);

        f -= (double)fhi;
        f *= 16777216.0;
        flo = (unsigned int)(f + 0.5);
        (__builtin_expect(!(flo <= 16777216), 0) ? __assert_rtn(__func__, "floatobject.c", 2111, "flo <= 16777216") : (void)0);
        if (flo >> 24) {
...
_PyFloat_Unpack4(const unsigned char *p, int le)
{
    if (float_format == unknown_format) {
        ...
        if ((float_format == ieee_little_endian_format && !le)
            ...
            ((__builtin_object_size (&x, 0) != (size_t) -1) ? __builtin___memcpy_chk (&x, buf, 4, __builtin_object_size (&x, 0)) : __inline_memcpy_chk (&x, buf, 4));
        }
        else {
            ((__builtin_object_size (&x, 0) != (size_t) -1) ? __builtin___memcpy_chk (&x, p, 4, __builtin_object_size (&x, 0)) : __inline_memcpy_chk (&x, p, 4));
        }
...
_PyFloat_Unpack8(const unsigned char *p, int le)
{
    if (double_format == unknown_format) {
        ...
        if ((double_format == ieee_little_endian_format && !le)
            ...
            ((__builtin_object_size (&x, 0) != (size_t) -1) ? __builtin___memcpy_chk (&x, buf, 8, __builtin_object_size (&x, 0)) : __inline_memcpy_chk (&x, buf, 8));
        }
        else {
            ((__builtin_object_size (&x, 0) != (size_t) -1) ? __builtin___memcpy_chk (&x, p, 8, __builtin_object_size (&x, 0)) : __inline_memcpy_chk (&x, p, 8));
        }
