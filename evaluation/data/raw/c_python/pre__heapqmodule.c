...
_siftdown(PyListObject *heap, Py_ssize_t startpos, Py_ssize_t pos)
{
    ...
    (__builtin_expect(!(((((((PyObject*)(heap))->ob_type))->tp_flags & ((1L<<25))) != 0)), 0) ? __assert_rtn(__func__, "_heapqmodule.c", 19, "PyList_Check(heap)") : (void)0);
    size = (((PyVarObject*)(heap))->ob_size);
    if (pos >= size) {
        PyErr_SetString(PyExc_IndexError, "index out of range");
        return -1;
    }

    newitem = (((PyListObject *)(heap))->ob_item[pos]);
    ( ((PyObject*)(newitem))->ob_refcnt++);


    while (pos > startpos){
        parentpos = (pos - 1) >> 1;
        parent = (((PyListObject *)(heap))->ob_item[parentpos]);
        cmp = PyObject_RichCompareBool(newitem, parent, 0);
        if (cmp == -1) {
            do { if ( --((PyObject*)(newitem))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(newitem)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(newitem)))); } while (0);
            return -1;
        }
        if (size != (((PyVarObject*)(heap))->ob_size)) {
            do { if ( --((PyObject*)(newitem))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(newitem)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(newitem)))); } while (0);
        ...
        olditem = (((PyListObject *)(heap))->ob_item[pos]);
        (((PyListObject *)(heap))->ob_item[pos] = (parent));
    ...
    do { if ( --((PyObject*)((((PyListObject *)(heap))->ob_item[pos])))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)((((PyListObject *)(heap))->ob_item[pos]))))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)((((PyListObject *)(heap))->ob_item[pos]))))); } while (0);
    (((PyListObject *)(heap))->ob_item[pos] = (newitem));
    return 0;
}
...
_siftup(PyListObject *heap, Py_ssize_t pos)
{
    ...
    (__builtin_expect(!(((((((PyObject*)(heap))->ob_type))->tp_flags & ((1L<<25))) != 0)), 0) ? __assert_rtn(__func__, "_heapqmodule.c", 70, "PyList_Check(heap)") : (void)0);
    size = (((PyVarObject*)(heap))->ob_size);
    endpos = size;
    startpos = pos;
    if (pos >= endpos) {
    ...
    while (childpos < endpos) {
        ...
        if (rightpos < endpos) {
            cmp = PyObject_RichCompareBool(
                (((PyListObject *)(heap))->ob_item[childpos]),
                (((PyListObject *)(heap))->ob_item[rightpos]),
                0);
            if (cmp == -1) {
                do { if ( --((PyObject*)(newitem))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(newitem)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(newitem)))); } while (0);
                return -1;
        ...
        tmp = (((PyListObject *)(heap))->ob_item[childpos]);
        ( ((PyObject*)(tmp))->ob_refcnt++);
        olditem = (((PyListObject *)(heap))->ob_item[pos]);
        (((PyListObject *)(heap))->ob_item[pos] = (tmp));
        do { if ( --((PyObject*)(olditem))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(olditem)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(olditem)))); } while (0);
        pos = childpos;
        childpos = 2*pos + 1;
        if (size != (((PyVarObject*)(heap))->ob_size)) {
...
heappush(PyObject *self, PyObject *args)
{
    ...
    if (!((((((PyObject*)(heap))->ob_type))->tp_flags & ((1L<<25))) != 0)) {
    ...
    if (_siftdown((PyListObject *)heap, 0, (((PyVarObject*)(heap))->ob_size)-1) == -1)
        return ((void *)0);
    ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++);
    return (&_Py_NoneStruct);
}

static char heappush_doc[] = "heappush(heap, item) -> None. Push item onto heap, maintaining the heap invariant.";
...
heappop(PyObject *self, PyObject *heap)
{
    ...
    n = (((PyVarObject*)(heap))->ob_size);
    if (n == 0) {
        PyErr_SetString(PyExc_IndexError, "index out of range");
        return ((void *)0);
    }

    lastelt = (((PyListObject *)(heap))->ob_item[n-1]) ;
    ( ((PyObject*)(lastelt))->ob_refcnt++);
    PyList_SetSlice(heap, n-1, n, ((void *)0));
    n--;

    if (!n)
        return lastelt;
    returnitem = (((PyListObject *)(heap))->ob_item[0]);
    (((PyListObject *)(heap))->ob_item[0] = (lastelt));
    if (_siftup((PyListObject *)heap, 0) == -1) {
        do { if ( --((PyObject*)(returnitem))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(returnitem)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(returnitem)))); } while (0);
        return ((void *)0);
    }
    return returnitem;
}

static char heappop_doc[] = "Pop the smallest item off the heap, maintaining the heap invariant.";
...
heapreplace(PyObject *self, PyObject *args)
{
    ...
    (((PyListObject *)(heap))->ob_item[0] = (item));
    if (_siftup((PyListObject *)heap, 0) == -1) {
        do { if ( --((PyObject*)(returnitem))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(returnitem)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(returnitem)))); } while (0);
        return ((void *)0);
    }
...
static char heapreplace_doc[] = "heapreplace(heap, item) -> value. Pop and return the current smallest value, and add the new item.\n\nThis is more efficient than heappop() followed by heappush(), and can be\nmore appropriate when using a fixed-size heap.  Note that the value\nreturned may be larger than item!  That constrains reasonable uses of\nthis routine unless written as part of a conditional replacement:\n\n    if item > heap[0]:\n        item = heapreplace(heap, item)\n";
# 226 "_heapqmodule.c"
static PyObject *
heappushpop(PyObject *self, PyObject *args)
{
    ...
    cmp = PyObject_RichCompareBool((((PyListObject *)(heap))->ob_item[0]), item, 0);
    if (cmp == -1)
        return ((void *)0);
    if (cmp == 0) {
        ( ((PyObject*)(item))->ob_refcnt++);
...
static char heappushpop_doc[] = "heappushpop(heap, item) -> value. Push item on the heap, then pop and return the smallest item\nfrom the heap. The combined action runs more efficiently than\nheappush() followed by a separate call to heappop().";
...
static char heapify_doc[] = "Transform list into a heap, in-place, in O(len(heap)) time.";


static PyObject *
nlargest(PyObject *self, PyObject *args)
{
    PyObject *heap=((void *)0), *elem, *iterable, *sol, *it, *oldelem;
    Py_ssize_t i, n;
    int cmp;
    ...
    sol = (((PyListObject *)(heap))->ob_item[0]);
    while (1) {
        elem = PyIter_Next(it);
        if (elem == ((void *)0)) {
            if (PyErr_Occurred())
        ...
        cmp = PyObject_RichCompareBool(sol, elem, 0);
        if (cmp == -1) {
            do { if ( --((PyObject*)(elem))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(elem)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(elem)))); } while (0);
            goto fail;
        }
        ...
        oldelem = (((PyListObject *)(heap))->ob_item[0]);
        (((PyListObject *)(heap))->ob_item[0] = (elem));
...
fail:
    do { if ( --((PyObject*)(it))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(it)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(it)))); } while (0);
    do { if ((heap) == ((void *)0)) ; else do { if ( --((PyObject*)(heap))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(heap)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(heap)))); } while (0); } while (0);
    return ((void *)0);
}

static char nlargest_doc[] = "Find the n largest elements in a dataset.\n\nEquivalent to:  sorted(iterable, reverse=True)[:n]\n";
...
_siftdownmax(PyListObject *heap, Py_ssize_t startpos, Py_ssize_t pos)
{
    ...
    (__builtin_expect(!(((((((PyObject*)(heap))->ob_type))->tp_flags & ((1L<<25))) != 0)), 0) ? __assert_rtn(__func__, "_heapqmodule.c", 386, "PyList_Check(heap)") : (void)0);
    if (pos >= (((PyVarObject*)(heap))->ob_size)) {
        PyErr_SetString(PyExc_IndexError, "index out of range");
        return -1;
    }
    ...
    while (pos > startpos){
        parentpos = (pos - 1) >> 1;
        parent = (((PyListObject *)(heap))->ob_item[parentpos]);
        cmp = PyObject_RichCompareBool(parent, newitem, 0);
        if (cmp == -1) {
            do { if ( --((PyObject*)(newitem))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(newitem)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(newitem)))); } while (0);
            return -1;
        }
...
_siftupmax(PyListObject *heap, Py_ssize_t pos)
{
    ...
    (__builtin_expect(!(((((((PyObject*)(heap))->ob_type))->tp_flags & ((1L<<25))) != 0)), 0) ? __assert_rtn(__func__, "_heapqmodule.c", 423, "PyList_Check(heap)") : (void)0);
    endpos = (((PyVarObject*)(heap))->ob_size);
    startpos = pos;
    if (pos >= endpos) {
        PyErr_SetString(PyExc_IndexError, "index out of range");
        return -1;
...
{
    PyObject *heap=((void *)0), *elem, *iterable, *los, *it, *oldelem;
    Py_ssize_t i, n;
    int cmp;
    ...
    los = (((PyListObject *)(heap))->ob_item[0]);
    while (1) {
        elem = PyIter_Next(it);
        if (elem == ((void *)0)) {
            if (PyErr_Occurred())
        ...
        cmp = PyObject_RichCompareBool(elem, los, 0);
        if (cmp == -1) {
            do { if ( --((PyObject*)(elem))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(elem)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(elem)))); } while (0);
            goto fail;
        }
...
static char nsmallest_doc[] = "Find the n smallest elements in a dataset.\n\nEquivalent to:  sorted(iterable)[:n]\n";
...
PyInit__heapq(void)
{
    ...
    m = PyModule_Create2(&_heapqmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    about = PyUnicode_DecodeUTF8(__about__, strlen(__about__), ((void *)0));
