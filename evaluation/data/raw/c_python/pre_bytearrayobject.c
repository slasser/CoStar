...
bytearray_getbuffer(PyByteArrayObject *obj, Py_buffer *view, int flags)
{
    ...
    ptr = (void *) ((__builtin_expect(!(((((PyObject*)(obj))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(obj))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 63, "PyByteArray_Check(obj)") : (void)0), (((PyVarObject*)(obj))->ob_size) ? ((PyByteArrayObject *)(obj))->ob_bytes : _PyByteArray_empty_string);
    ret = PyBuffer_FillInfo(view, (PyObject*)obj, ptr, (((PyVarObject*)(obj))->ob_size), 0, flags);
    if (ret >= 0) {
        obj->ob_exports++;
    }
    return ret;
...
PyByteArray_FromStringAndSize(const char *bytes, Py_ssize_t size)
{
    ...
    new = ( (PyByteArrayObject *) _PyObject_New(&PyByteArray_Type) );
    if (new == ((void *)0))
        return ((void *)0);
    ...
    if (size == 0) {
        ...
        if (new->ob_bytes == ((void *)0)) {
            do { if ( --((PyObject*)(new))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(new)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(new)))); } while (0);
            return PyErr_NoMemory();
        }
        if (bytes != ((void *)0) && size > 0)
            ((__builtin_object_size (new->ob_bytes, 0) != (size_t) -1) ? __builtin___memcpy_chk (new->ob_bytes, bytes, size, __builtin_object_size (new->ob_bytes, 0)) : __inline_memcpy_chk (new->ob_bytes, bytes, size));
        new->ob_bytes[size] = '\0';
    }
    (((PyVarObject*)(new))->ob_size) = size;
    new->ob_alloc = alloc;
    new->ob_exports = 0;
...
{
    (__builtin_expect(!(self != ((void *)0)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 161, "self != NULL") : (void)0);
    (__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 162, "PyByteArray_Check(self)") : (void)0);

    return ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 164, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size));
}

char *
PyByteArray_AsString(PyObject *self)
{
    (__builtin_expect(!(self != ((void *)0)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 170, "self != NULL") : (void)0);
    (__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 171, "PyByteArray_Check(self)") : (void)0);

    return ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 173, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string);
}
...
PyByteArray_Resize(PyObject *self, Py_ssize_t size)
{
    ...
    (__builtin_expect(!(self != ((void *)0)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 182, "self != NULL") : (void)0);
    (__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 183, "PyByteArray_Check(self)") : (void)0);
    (__builtin_expect(!(size >= 0), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 184, "size >= 0") : (void)0);

    if (size == (((PyVarObject*)(self))->ob_size)) {
        return 0;
    }
    ...
    if (size < alloc / 2) {
        ...
        ((PyByteArrayObject *)self)->ob_bytes[size] = '\0';
        return 0;
    }
...
PyByteArray_Concat(PyObject *a, PyObject *b)
{
    Py_ssize_t size;
    Py_buffer va, vb;
    PyByteArrayObject *result = ((void *)0);
    ...
    result = (PyByteArrayObject *) PyByteArray_FromStringAndSize(((void *)0), size);
    if (result != ((void *)0)) {
        ((__builtin_object_size (result->ob_bytes, 0) != (size_t) -1) ? __builtin___memcpy_chk (result->ob_bytes, va.buf, va.len, __builtin_object_size (result->ob_bytes, 0)) : __inline_memcpy_chk (result->ob_bytes, va.buf, va.len));
        ((__builtin_object_size (result->ob_bytes + va.len, 0) != (size_t) -1) ? __builtin___memcpy_chk (result->ob_bytes + va.len, vb.buf, vb.len, __builtin_object_size (result->ob_bytes + va.len, 0)) : __inline_memcpy_chk (result->ob_bytes + va.len, vb.buf, vb.len));
    }
...
{
    return (((PyVarObject*)(self))->ob_size);
}
...
bytearray_iconcat(PyByteArrayObject *self, PyObject *other)
{
    ...
    if (_getbuffer(other, &vo) < 0) {
        PyErr_Format(PyExc_TypeError, "can't concat %.100s to %.100s",
                     (((PyObject*)(other))->ob_type)->tp_name, (((PyObject*)(self))->ob_type)->tp_name);
        return ((void *)0);
    }
    ...
    if (size < self->ob_alloc) {
        (((PyVarObject*)(self))->ob_size) = size;
        self->ob_bytes[(((PyVarObject*)(self))->ob_size)] = '\0';
    }
    else if (PyByteArray_Resize((PyObject *)self, size) < 0) {
        PyBuffer_Release(&vo);
        return ((void *)0);
    }
    ((__builtin_object_size (self->ob_bytes + mysize, 0) != (size_t) -1) ? __builtin___memcpy_chk (self->ob_bytes + mysize, vo.buf, vo.len, __builtin_object_size (self->ob_bytes + mysize, 0)) : __inline_memcpy_chk (self->ob_bytes + mysize, vo.buf, vo.len));
    PyBuffer_Release(&vo);
...
bytearray_repeat(PyByteArrayObject *self, Py_ssize_t count)
{
    ...
    if (count < 0)
        count = 0;
    mysize = (((PyVarObject*)(self))->ob_size);
    if (count > 0 && mysize > ((Py_ssize_t)(((size_t)-1)>>1)) / count)
        return PyErr_NoMemory();
    size = mysize * count;
    result = (PyByteArrayObject *)PyByteArray_FromStringAndSize(((void *)0), size);
    if (result != ((void *)0) && size != 0) {
        if (mysize == 1)
            ((__builtin_object_size (result->ob_bytes, 0) != (size_t) -1) ? __builtin___memset_chk (result->ob_bytes, self->ob_bytes[0], size, __builtin_object_size (result->ob_bytes, 0)) : __inline_memset_chk (result->ob_bytes, self->ob_bytes[0], size));
        else {
            Py_ssize_t i;
            for (i = 0; i < count; i++)
                ((__builtin_object_size (result->ob_bytes + i*mysize, 0) != (size_t) -1) ? __builtin___memcpy_chk (result->ob_bytes + i*mysize, self->ob_bytes, mysize, __builtin_object_size (result->ob_bytes + i*mysize, 0)) : __inline_memcpy_chk (result->ob_bytes + i*mysize, self->ob_bytes, mysize));
        }
    }
    return (PyObject *)result;
}
...
bytearray_irepeat(PyByteArrayObject *self, Py_ssize_t count)
{
    ...
    if (mysize == 1)
        ((__builtin_object_size (self->ob_bytes, 0) != (size_t) -1) ? __builtin___memset_chk (self->ob_bytes, self->ob_bytes[0], size, __builtin_object_size (self->ob_bytes, 0)) : __inline_memset_chk (self->ob_bytes, self->ob_bytes[0], size));
    else {
        Py_ssize_t i;
        for (i = 1; i < count; i++)
            ((__builtin_object_size (self->ob_bytes + i*mysize, 0) != (size_t) -1) ? __builtin___memcpy_chk (self->ob_bytes + i*mysize, self->ob_bytes, mysize, __builtin_object_size (self->ob_bytes + i*mysize, 0)) : __inline_memcpy_chk (self->ob_bytes + i*mysize, self->ob_bytes, mysize));
    }
...
{
    if (((index)->ob_type->tp_as_number != ((void *)0) && (index)->ob_type->tp_as_number->nb_index != ((void *)0))) {
        ...
        if (i < 0)
            i += ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 382, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size));
    ...
    else if (((((PyObject*)(index))->ob_type) == &PySlice_Type)) {
        Py_ssize_t start, stop, step, slicelength, cur, i;
        if (PySlice_GetIndicesEx(index,
                                 ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 393, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)),
        ...
        if (slicelength <= 0)
            ...
            char *source_buf = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 405, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string);
            char *result_buf;
            PyObject *result;

            result = PyByteArray_FromStringAndSize(((void *)0), slicelength);
            if (result == ((void *)0))
                return ((void *)0);

            result_buf = ((__builtin_expect(!(((((PyObject*)(result))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(result))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 413, "PyByteArray_Check(result)") : (void)0), (((PyVarObject*)(result))->ob_size) ? ((PyByteArrayObject *)(result))->ob_bytes : _PyByteArray_empty_string);
               ...
               PyObject *values)
{
    ...
    if (values == (PyObject *)self) {
        ...
        do { if ( --((PyObject*)(values))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(values)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(values)))); } while (0);
        return err;
    }
    if (values == ((void *)0)) {
        ...
        needed = 0;
            ...
            if (_getbuffer(values, &vbytes) < 0) {
                    PyErr_Format(PyExc_TypeError,
                                 ...
                                 (((PyObject*)(values))->ob_type)->tp_name);
                    return -1;
            }
            needed = vbytes.len;
            bytes = vbytes.buf;
    ...
    if (hi < lo)
        hi = lo;
    if (hi > (((PyVarObject*)(self))->ob_size))
        hi = (((PyVarObject*)(self))->ob_size);
    ...
    if (avail != needed) {
        if (avail > needed) {
            ...
            ((__builtin_object_size (self->ob_bytes + lo + needed, 0) != (size_t) -1) ? __builtin___memmove_chk (self->ob_bytes + lo + needed, self->ob_bytes + hi, (((PyVarObject*)(self))->ob_size) - hi, __builtin_object_size (self->ob_bytes + lo + needed, 0)) : __inline_memmove_chk (self->ob_bytes + lo + needed, self->ob_bytes + hi, (((PyVarObject*)(self))->ob_size) - hi));

        }

        if (PyByteArray_Resize((PyObject *)self,
                           (((PyVarObject*)(self))->ob_size) + needed - avail) < 0) {
                res = -1;
                goto finish;
        }
        if (avail < needed) {
            ...
            ((__builtin_object_size (self->ob_bytes + lo + needed, 0) != (size_t) -1) ? __builtin___memmove_chk (self->ob_bytes + lo + needed, self->ob_bytes + hi, (((PyVarObject*)(self))->ob_size) - lo - needed, __builtin_object_size (self->ob_bytes + lo + needed, 0)) : __inline_memmove_chk (self->ob_bytes + lo + needed, self->ob_bytes + hi, (((PyVarObject*)(self))->ob_size) - lo - needed));

        }
    }

    if (needed > 0)
        ((__builtin_object_size (self->ob_bytes + lo, 0) != (size_t) -1) ? __builtin___memcpy_chk (self->ob_bytes + lo, bytes, needed, __builtin_object_size (self->ob_bytes + lo, 0)) : __inline_memcpy_chk (self->ob_bytes + lo, bytes, needed));
...
bytearray_setitem(PyByteArrayObject *self, Py_ssize_t i, PyObject *value)
{
    ...
    if (value == ((void *)0))
        return bytearray_setslice(self, i, i+1, ((void *)0));
...
bytearray_ass_subscript(PyByteArrayObject *self, PyObject *index, PyObject *values)
{
    ...
    if (((index)->ob_type->tp_as_number != ((void *)0) && (index)->ob_type->tp_as_number->nb_index != ((void *)0))) {
        ...
        if (i < 0)
            i += ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 553, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size));
        ...
        if (PySlice_GetIndicesEx(index,
                                 ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 577, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)),
    ...
    if (values == ((void *)0)) {
    ...
    else if (values == (PyObject *)self || !((((PyObject*)(values))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(values))->ob_type), (&PyByteArray_Type)))) {
        int err;
        if (PyNumber_Check(values) || ((((((PyObject*)(values))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        ...
        (__builtin_expect(!(((((PyObject*)(values))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(values))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 608, "PyByteArray_Check(values)") : (void)0);
    ...
    if (step == 1) {
        if (slicelen != needed) {
            ...
            if (slicelen > needed) {
                ...
                ((__builtin_object_size (self->ob_bytes + start + needed, 0) != (size_t) -1) ? __builtin___memmove_chk (self->ob_bytes + start + needed, self->ob_bytes + stop, (((PyVarObject*)(self))->ob_size) - stop, __builtin_object_size (self->ob_bytes + start + needed, 0)) : __inline_memmove_chk (self->ob_bytes + start + needed, self->ob_bytes + stop, (((PyVarObject*)(self))->ob_size) - stop));

            }
            if (PyByteArray_Resize((PyObject *)self,
                               (((PyVarObject*)(self))->ob_size) + needed - slicelen) < 0)
                return -1;
            if (slicelen < needed) {
        ...
        if (needed > 0)
            ((__builtin_object_size (self->ob_bytes + start, 0) != (size_t) -1) ? __builtin___memcpy_chk (self->ob_bytes + start, bytes, needed, __builtin_object_size (self->ob_bytes + start, 0)) : __inline_memcpy_chk (self->ob_bytes + start, bytes, needed));
        ...
        if (needed == 0) {
            ...
            for (cur = start, i = 0;
                ...
                if (cur + step >= (size_t)((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 672, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)))
                    lim = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 673, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)) - cur - 1;

                ((__builtin_object_size (self->ob_bytes + cur - i, 0) != (size_t) -1) ? __builtin___memmove_chk (self->ob_bytes + cur - i, self->ob_bytes + cur + 1, lim, __builtin_object_size (self->ob_bytes + cur - i, 0)) : __inline_memmove_chk (self->ob_bytes + cur - i, self->ob_bytes + cur + 1, lim));

            }

            cur = start + (size_t)slicelen*step;
            if (cur < (size_t)((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 680, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size))) {
                ((__builtin_object_size (self->ob_bytes + cur - slicelen, 0) != (size_t) -1) ? __builtin___memmove_chk (self->ob_bytes + cur - slicelen, self->ob_bytes + cur, ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 683, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)) - cur, __builtin_object_size (self->ob_bytes + cur - slicelen, 0)) : __inline_memmove_chk (self->ob_bytes + cur - slicelen, self->ob_bytes + cur, ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 683, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)) - cur));


            }
            if (PyByteArray_Resize((PyObject *)self,
                               ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 686, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)) - slicelen) < 0)
                return -1;
...
bytearray_init(PyByteArrayObject *self, PyObject *args, PyObject *kwds)
{
    ...
    if (!_PyArg_ParseTupleAndKeywords_SizeT(args, kwds, "|Oss:bytearray", kwlist,
                                     &arg, &encoding, &errors))
        return -1;
    ...
    if (((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        ...
        if (encoded == ((void *)0))
            return -1;
        (__builtin_expect(!(((((((PyObject*)(encoded))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 753, "PyBytes_Check(encoded)") : (void)0);
    ...
    if (count == -1 && PyErr_Occurred()) {
        ...
        if (count > 0) {
            if (PyByteArray_Resize((PyObject *)self, count))
                return -1;
            ((__builtin_object_size (self->ob_bytes, 0) != (size_t) -1) ? __builtin___memset_chk (self->ob_bytes, 0, count, __builtin_object_size (self->ob_bytes, 0)) : __inline_memset_chk (self->ob_bytes, 0, count));
        }
        return 0;
    }


    if ((((arg)->ob_type->tp_as_buffer != ((void *)0)) && ((arg)->ob_type->tp_as_buffer->bf_getbuffer != ((void *)0)))) {
        Py_ssize_t size;
        Py_buffer view;
        if (PyObject_GetBuffer(arg, &view, ((0x0100 | (0x0010 | 0x0008)) | 0x0004)) < 0)
            return -1;
        size = view.len;
    ...
    for (;;) {
        ...
        else if (PyByteArray_Resize((PyObject *)self, (((PyVarObject*)(self))->ob_size)+1) < 0)
            goto error;
        self->ob_bytes[(((PyVarObject*)(self))->ob_size)-1] = value;
    }
...
bytearray_repr(PyByteArrayObject *self)
{
    ...
    Py_ssize_t length = (((PyVarObject*)(self))->ob_size);
    ...
    if (length > (((Py_ssize_t)(((size_t)-1)>>1)) - 15) / 4) {
    ...
    quote = '\'';
    start = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 887, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string);
    ...
    *p++ = quote;
    ...
    for (i = 0; i < length; i++) {
        ...
        (__builtin_expect(!(newsize - (p - buffer) >= 5), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 905, "newsize - (p - buffer) >= 5") : (void)0);
        c = self->ob_bytes[i];
        if (c == '\'' || c == '\\')
            *p++ = '\\', *p++ = c;
        else if (c == '\t')
    ...
    (__builtin_expect(!(newsize - (p - buffer) >= 1), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 926, "newsize - (p - buffer) >= 1") : (void)0);
    *p++ = quote;
    while (*quote_postfix) {
       *p++ = *quote_postfix++;
    }

    v = PyUnicode_DecodeASCII(buffer, p - buffer, ((void *)0));
...
bytearray_richcompare(PyObject *self, PyObject *other, int op)
{
    ...
    if (self_size != other_size && (op == 2 || op == 3)) {
        ...
        switch (op) {
        case 0: cmp = cmp < 0; break;
        case 1: cmp = cmp <= 0; break;
        case 2: cmp = cmp == 0; break;
        case 3: cmp = cmp != 0; break;
        case 4: cmp = cmp > 0; break;
        case 5: cmp = cmp >= 0; break;
        }
    }

    res = cmp ? ((PyObject *) &_Py_TrueStruct) : ((PyObject *) &_Py_FalseStruct);
    PyBuffer_Release(&self_bytes);
                    ...
                    const char* sep, Py_ssize_t sep_len)
{
    ...
    if (pos < 0) {
        ...
        (((PyTupleObject *)(out))->ob_item[0] = PyByteArray_FromStringAndSize(str, str_len));
        (((PyTupleObject *)(out))->ob_item[1] = PyByteArray_FromStringAndSize(((void *)0), 0));
        (((PyTupleObject *)(out))->ob_item[2] = PyByteArray_FromStringAndSize(((void *)0), 0));
# 40 "stringlib/partition.h"
        return out;
    }

    (((PyTupleObject *)(out))->ob_item[0] = PyByteArray_FromStringAndSize(str, pos));
    ( ((PyObject*)(sep_obj))->ob_refcnt++);
    (((PyTupleObject *)(out))->ob_item[1] = sep_obj);
    pos += sep_len;
    (((PyTupleObject *)(out))->ob_item[2] = PyByteArray_FromStringAndSize(str + pos, str_len - pos));
                     ...
                     const char* sep, Py_ssize_t sep_len)
{
    ...
    if (pos < 0) {
        ...
        (((PyTupleObject *)(out))->ob_item[0] = PyByteArray_FromStringAndSize(((void *)0), 0));
        (((PyTupleObject *)(out))->ob_item[1] = PyByteArray_FromStringAndSize(((void *)0), 0));
        (((PyTupleObject *)(out))->ob_item[2] = PyByteArray_FromStringAndSize(str, str_len));
# 90 "stringlib/partition.h"
        return out;
    }
...
# 82 "stringlib/split.h"
    ...
    if (i < str_len) {
        ...
        while (i < str_len && (_Py_ctype_table[((unsigned char)((str[i]) & 0xff))] & 0x08))
            i++;
        if (i != str_len)
            { sub = PyByteArray_FromStringAndSize((str) + (i), (str_len) - (i)); if (sub == ((void *)0)) goto onError; if (count < 12) { (((PyListObject *)(list))->ob_item[count] = (sub)); } else { if (PyList_Append(list, sub)) { do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); goto onError; } else do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); } count++; };
    }
                     ...
                     Py_ssize_t maxcount)
{
    ...
    while ((j < str_len) && (maxcount-- > 0)) {
        for(; j < str_len; j++) {
            ...
            if (str[j] == ch) {
                { sub = PyByteArray_FromStringAndSize((str) + (i), (j) - (i)); if (sub == ((void *)0)) goto onError; if (count < 12) { (((PyListObject *)(list))->ob_item[count] = (sub)); } else { if (PyList_Append(list, sub)) { do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); goto onError; } else do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); } count++; };
                i = j = j + 1;
                break;
            }
        }
    }
# 133 "stringlib/split.h"
    if (i <= str_len) {
        { sub = PyByteArray_FromStringAndSize((str) + (i), (str_len) - (i)); if (sub == ((void *)0)) goto onError; if (count < 12) { (((PyListObject *)(list))->ob_item[count] = (sub)); } else { if (PyList_Append(list, sub)) { do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); goto onError; } else do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); } count++; };
    }
    (((PyVarObject*)(list))->ob_size) = count;
                            ...
                            Py_ssize_t maxcount)
{
    ...
    while (maxcount-- > 0) {
        ...
        while (i >= 0 && !(_Py_ctype_table[((unsigned char)((str[i]) & 0xff))] & 0x08))
            i--;
# 221 "stringlib/split.h"
        { sub = PyByteArray_FromStringAndSize((str) + (i + 1), (j + 1) - (i + 1)); if (sub == ((void *)0)) goto onError; if (count < 12) { (((PyListObject *)(list))->ob_item[count] = (sub)); } else { if (PyList_Append(list, sub)) { do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); goto onError; } else do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); } count++; };
    }
    ...
    if (i >= 0) {
        ...
        while (i >= 0 && (_Py_ctype_table[((unsigned char)((str[i]) & 0xff))] & 0x08))
            i--;
        if (i >= 0)
            { sub = PyByteArray_FromStringAndSize((str) + (0), (i + 1) - (0)); if (sub == ((void *)0)) goto onError; if (count < 12) { (((PyListObject *)(list))->ob_item[count] = (sub)); } else { if (PyList_Append(list, sub)) { do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); goto onError; } else do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); } count++; };
    }
    (((PyVarObject*)(list))->ob_size) = count;
...
# 273 "stringlib/split.h"
    if (j >= -1) {
        { sub = PyByteArray_FromStringAndSize((str) + (0), (j + 1) - (0)); if (sub == ((void *)0)) goto onError; if (count < 12) { (((PyListObject *)(list))->ob_item[count] = (sub)); } else { if (PyList_Append(list, sub)) { do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); goto onError; } else do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); } count++; };
    }
    (((PyVarObject*)(list))->ob_size) = count;
    if (PyList_Reverse(list) < 0)
        goto onError;
                 ...
                 Py_ssize_t maxcount)
{
    ...
    while (maxcount-- > 0) {
        ...
        if (pos < 0)
            break;
        { sub = PyByteArray_FromStringAndSize((str) + (pos + sep_len), (j) - (pos + sep_len)); if (sub == ((void *)0)) goto onError; if (count < 12) { (((PyListObject *)(list))->ob_item[count] = (sub)); } else { if (PyList_Append(list, sub)) { do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); goto onError; } else do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); } count++; };
        j = pos;
    }
# 322 "stringlib/split.h"
    {
        { sub = PyByteArray_FromStringAndSize((str) + (0), (j) - (0)); if (sub == ((void *)0)) goto onError; if (count < 12) { (((PyListObject *)(list))->ob_item[count] = (sub)); } else { if (PyList_Append(list, sub)) { do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); goto onError; } else do { if ( --((PyObject*)(sub))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sub)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sub)))); } while (0); } count++; };
    }
    (((PyVarObject*)(list))->ob_size) = count;
    if (PyList_Reverse(list) < 0)
        goto onError;
...
{
    return _Py_bytes_isspace(((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 9, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 9, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
}

static PyObject*
stringlib_isalpha(PyObject *self)
{
    return _Py_bytes_isalpha(((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 15, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 15, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
}

static PyObject*
stringlib_isalnum(PyObject *self)
{
    return _Py_bytes_isalnum(((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 21, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 21, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
}

static PyObject*
stringlib_isdigit(PyObject *self)
{
    return _Py_bytes_isdigit(((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 27, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 27, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
}

static PyObject*
stringlib_islower(PyObject *self)
{
    return _Py_bytes_islower(((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 33, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 33, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
}

static PyObject*
stringlib_isupper(PyObject *self)
{
    return _Py_bytes_isupper(((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 39, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 39, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
}

static PyObject*
stringlib_istitle(PyObject *self)
{
    return _Py_bytes_istitle(((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 45, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 45, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
}
...
{
    PyObject* newobj;
    newobj = PyByteArray_FromStringAndSize(((void *)0), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 55, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
    if (!newobj)
            return ((void *)0);
    _Py_bytes_lower(((__builtin_expect(!(((((PyObject*)(newobj))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(newobj))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 58, "PyByteArray_Check(newobj)") : (void)0), (((PyVarObject*)(newobj))->ob_size) ? ((PyByteArrayObject *)(newobj))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 58, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string),
                 ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 59, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
    return newobj;
}
...
{
    PyObject* newobj;
    newobj = PyByteArray_FromStringAndSize(((void *)0), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 67, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
    if (!newobj)
            return ((void *)0);
    _Py_bytes_upper(((__builtin_expect(!(((((PyObject*)(newobj))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(newobj))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 70, "PyByteArray_Check(newobj)") : (void)0), (((PyVarObject*)(newobj))->ob_size) ? ((PyByteArrayObject *)(newobj))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 70, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string),
                 ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 71, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
    return newobj;
}
...
{
    PyObject* newobj;
    newobj = PyByteArray_FromStringAndSize(((void *)0), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 79, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
    if (!newobj)
            return ((void *)0);
    _Py_bytes_title(((__builtin_expect(!(((((PyObject*)(newobj))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(newobj))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 82, "PyByteArray_Check(newobj)") : (void)0), (((PyVarObject*)(newobj))->ob_size) ? ((PyByteArrayObject *)(newobj))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 82, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string),
                 ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 83, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
    return newobj;
}
...
{
    PyObject* newobj;
    newobj = PyByteArray_FromStringAndSize(((void *)0), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 91, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
    if (!newobj)
            return ((void *)0);
    _Py_bytes_capitalize(((__builtin_expect(!(((((PyObject*)(newobj))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(newobj))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 94, "PyByteArray_Check(newobj)") : (void)0), (((PyVarObject*)(newobj))->ob_size) ? ((PyByteArrayObject *)(newobj))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 94, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string),
                      ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 95, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
    return newobj;
}
...
{
    PyObject* newobj;
    newobj = PyByteArray_FromStringAndSize(((void *)0), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 103, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
    if (!newobj)
            return ((void *)0);
    _Py_bytes_swapcase(((__builtin_expect(!(((((PyObject*)(newobj))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(newobj))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 106, "PyByteArray_Check(newobj)") : (void)0), (((PyVarObject*)(newobj))->ob_size) ? ((PyByteArrayObject *)(newobj))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 106, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string),
                    ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/ctype.h", 107, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
    return newobj;
}
# 1055 "bytearrayobject.c" 2
...
stringlib_expandtabs(PyObject *self, PyObject *args)
{
    ...
    i = j = 0;
    e = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 27, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string) + ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 27, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size));
    for (p = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 28, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string); p < e; p++)
        if (*p == '\t') {
            if (tabsize > 0) {
                j += tabsize - (j % tabsize);
    ...
    u = PyByteArray_FromStringAndSize(((void *)0), i + j);
    if (!u)
        return ((void *)0);

    j = 0;
    q = ((__builtin_expect(!(((((PyObject*)(u))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(u))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 63, "PyByteArray_Check(u)") : (void)0), (((PyVarObject*)(u))->ob_size) ? ((PyByteArrayObject *)(u))->ob_bytes : _PyByteArray_empty_string);

    for (p = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 65, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string); p < e; p++)
        if (*p == '\t') {
            if (tabsize > 0) {
                i = tabsize - (j % tabsize);
                j += i;
...
pad(PyObject *self, Py_ssize_t left, Py_ssize_t right, char fill)
{
    ...
    if (left == 0 && right == 0 && ((((PyObject*)(self))->ob_type) == &PyByteArray_Type)) {



        return PyByteArray_FromStringAndSize(((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 98, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 98, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
    ...
    u = PyByteArray_FromStringAndSize(((void *)0),
       left + ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 106, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)) + right);
    if (u) {
        if (left)
            ((__builtin_object_size (((__builtin_expect(!(((((PyObject*)(u))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(u))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 109, "PyByteArray_Check(u)") : (void)0), (((PyVarObject*)(u))->ob_size) ? ((PyByteArrayObject *)(u))->ob_bytes : _PyByteArray_empty_string), 0) != (size_t) -1) ? __builtin___memset_chk (((__builtin_expect(!(((((PyObject*)(u))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(u))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 109, "PyByteArray_Check(u)") : (void)0), (((PyVarObject*)(u))->ob_size) ? ((PyByteArrayObject *)(u))->ob_bytes : _PyByteArray_empty_string), fill, left, __builtin_object_size (((__builtin_expect(!(((((PyObject*)(u))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(u))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 109, "PyByteArray_Check(u)") : (void)0), (((PyVarObject*)(u))->ob_size) ? ((PyByteArrayObject *)(u))->ob_bytes : _PyByteArray_empty_string), 0)) : __inline_memset_chk (((__builtin_expect(!(((((PyObject*)(u))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(u))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 109, "PyByteArray_Check(u)") : (void)0), (((PyVarObject*)(u))->ob_size) ? ((PyByteArrayObject *)(u))->ob_bytes : _PyByteArray_empty_string), fill, left));
        ((__builtin_object_size (((__builtin_expect(!(((((PyObject*)(u))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(u))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 112, "PyByteArray_Check(u)") : (void)0), (((PyVarObject*)(u))->ob_size) ? ((PyByteArrayObject *)(u))->ob_bytes : _PyByteArray_empty_string) + left, 0) != (size_t) -1) ? __builtin___memcpy_chk (((__builtin_expect(!(((((PyObject*)(u))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(u))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 112, "PyByteArray_Check(u)") : (void)0), (((PyVarObject*)(u))->ob_size) ? ((PyByteArrayObject *)(u))->ob_bytes : _PyByteArray_empty_string) + left, ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 112, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 112, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)), __builtin_object_size (((__builtin_expect(!(((((PyObject*)(u))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(u))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 112, "PyByteArray_Check(u)") : (void)0), (((PyVarObject*)(u))->ob_size) ? ((PyByteArrayObject *)(u))->ob_bytes : _PyByteArray_empty_string) + left, 0)) : __inline_memcpy_chk (((__builtin_expect(!(((((PyObject*)(u))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(u))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 112, "PyByteArray_Check(u)") : (void)0), (((PyVarObject*)(u))->ob_size) ? ((PyByteArrayObject *)(u))->ob_bytes : _PyByteArray_empty_string) + left, ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 112, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 112, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size))));


        if (right)
            ((__builtin_object_size (((__builtin_expect(!(((((PyObject*)(u))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(u))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 115, "PyByteArray_Check(u)") : (void)0), (((PyVarObject*)(u))->ob_size) ? ((PyByteArrayObject *)(u))->ob_bytes : _PyByteArray_empty_string) + left + ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 115, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)), 0) != (size_t) -1) ? __builtin___memset_chk (((__builtin_expect(!(((((PyObject*)(u))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(u))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 115, "PyByteArray_Check(u)") : (void)0), (((PyVarObject*)(u))->ob_size) ? ((PyByteArrayObject *)(u))->ob_bytes : _PyByteArray_empty_string) + left + ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 115, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)), fill, right, __builtin_object_size (((__builtin_expect(!(((((PyObject*)(u))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(u))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 115, "PyByteArray_Check(u)") : (void)0), (((PyVarObject*)(u))->ob_size) ? ((PyByteArrayObject *)(u))->ob_bytes : _PyByteArray_empty_string) + left + ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 115, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)), 0)) : __inline_memset_chk (((__builtin_expect(!(((((PyObject*)(u))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(u))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 115, "PyByteArray_Check(u)") : (void)0), (((PyVarObject*)(u))->ob_size) ? ((PyByteArrayObject *)(u))->ob_bytes : _PyByteArray_empty_string) + left + ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 115, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)), fill, right));
...
stringlib_ljust(PyObject *self, PyObject *args)
{
    ...
    if (((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 136, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)) >= width && ((((PyObject*)(self))->ob_type) == &PyByteArray_Type)) {



        return PyByteArray_FromStringAndSize(((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 140, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 140, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
    ...
    return pad(self, 0, width - ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 147, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)), fillchar);
}
...
stringlib_rjust(PyObject *self, PyObject *args)
{
    ...
    if (((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 166, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)) >= width && ((((PyObject*)(self))->ob_type) == &PyByteArray_Type)) {



        return PyByteArray_FromStringAndSize(((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 170, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 170, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
    ...
    return pad(self, width - ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 177, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)), 0, fillchar);
}
...
stringlib_center(PyObject *self, PyObject *args)
{
    ...
    if (((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 197, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)) >= width && ((((PyObject*)(self))->ob_type) == &PyByteArray_Type)) {



        return PyByteArray_FromStringAndSize(((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 201, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 201, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
    ...
    marg = width - ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 208, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size));
...
stringlib_zfill(PyObject *self, PyObject *args)
{
    ...
    if (((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 231, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)) >= width) {
        if (((((PyObject*)(self))->ob_type) == &PyByteArray_Type)) {



            return PyByteArray_FromStringAndSize(((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 236, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 236, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
            ...
            return PyByteArray_FromStringAndSize(
                ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 244, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string),
                ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 245, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size))
            );
    }

    fill = width - ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 249, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size));
    ...
    p = ((__builtin_expect(!(((((PyObject*)(s))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(s))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "stringlib/transmogrify.h", 256, "PyByteArray_Check(s)") : (void)0), (((PyVarObject*)(s))->ob_size) ? ((PyByteArrayObject *)(s))->ob_bytes : _PyByteArray_empty_string);
    if (p[fill] == '+' || p[fill] == '-') {
...
# 1056 "bytearrayobject.c" 2
# 1076 "bytearrayobject.c"
static inline Py_ssize_t
bytearray_find_internal(PyByteArrayObject *self, PyObject *args, int dir)
{
    ...
    if (dir > 0)
        res = stringlib_find_slice(
            ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1105, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1105, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)),
            sub, sub_len, start, end);
    else
        res = stringlib_rfind_slice(
            ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1109, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1109, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)),
            sub, sub_len, start, end);
...
{
    PyObject *sub_obj;
    const char *str = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1147, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), *sub;
    Py_ssize_t sub_len;
    char byte;
    Py_ssize_t start = 0, end = ((Py_ssize_t)(((size_t)-1)>>1));
    ...
    if (end > ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1171, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size))) end = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1171, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)); else if (end < 0) { end += ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1171, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)); if (end < 0) end = 0; } if (start < 0) { start += ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1171, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)); if (start < 0) start = 0; };
...
static char clear__doc__[] = "B.clear() -> None\n\nRemove all items from B.";
...
static char copy__doc__[] = "B.copy() -> bytearray\n\nReturn a copy of B.";
...
{
    return PyByteArray_FromStringAndSize(((__builtin_expect(!(((((PyObject*)((PyObject *)self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)((PyObject *)self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1204, "PyByteArray_Check((PyObject *)self)") : (void)0), (((PyVarObject*)((PyObject *)self))->ob_size) ? ((PyByteArrayObject *)((PyObject *)self))->ob_bytes : _PyByteArray_empty_string),
                                         ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1205, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
}
...
bytearray_contains(PyObject *self, PyObject *arg)
{
    ...
    if (ival == -1 && PyErr_Occurred()) {
        ...
        if (_getbuffer(arg, &varg) < 0)
            return -1;
        pos = stringlib_find(((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1277, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), (((PyVarObject*)(self))->ob_size),
                             varg.buf, varg.len, 0);
    ...
    return memchr(((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1287, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), (int) ival, (((PyVarObject*)(self))->ob_size)) != ((void *)0);
}
...
{
    Py_ssize_t len = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1299, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size));
    const char* str;
    Py_buffer vsubstr;
    int rv = 0;

    str = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1304, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string);
...
bytearray_translate(PyByteArrayObject *self, PyObject *args)
{
    ...
    int trans_table[256];
    PyObject *tableobj = ((void *)0), *delobj = ((void *)0);
    ...
    inlen = ((__builtin_expect(!(((((PyObject*)(input_obj))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(input_obj))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1474, "PyByteArray_Check(input_obj)") : (void)0),(((PyVarObject*)(input_obj))->ob_size));
    result = PyByteArray_FromStringAndSize((char *)((void *)0), inlen);
    if (result == ((void *)0))
        goto done;
    output_start = output = PyByteArray_AsString(result);
    input = ((__builtin_expect(!(((((PyObject*)(input_obj))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(input_obj))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1479, "PyByteArray_Check(input_obj)") : (void)0), (((PyVarObject*)(input_obj))->ob_size) ? ((PyByteArrayObject *)(input_obj))->ob_bytes : _PyByteArray_empty_string);

    if (vdel.len == 0 && table != ((void *)0)) {
    ...
    for (i = 0; i < vdel.len; i++)
        trans_table[(int) ((unsigned char)((((unsigned char*)vdel.buf)[i]) & 0xff))] = -1;
...
# 1534 "bytearrayobject.c"
static PyByteArrayObject *
return_self(PyByteArrayObject *self)
{

    return (PyByteArrayObject *)PyByteArray_FromStringAndSize(
            ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1539, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string),
            ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1540, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)));
}
                   ...
                   Py_ssize_t maxcount)
{
    ...
    self_len = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1573, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size));
    ...
    (__builtin_expect(!(count > 0), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1585, "count > 0") : (void)0);
    ...
    if (! (result = (PyByteArrayObject *)
                     PyByteArray_FromStringAndSize(((void *)0), result_len)) )
        return ((void *)0);

    self_s = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1597, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string);
    result_s = ((__builtin_expect(!(((((PyObject*)(result))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(result))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1598, "PyByteArray_Check(result)") : (void)0), (((PyVarObject*)(result))->ob_size) ? ((PyByteArrayObject *)(result))->ob_bytes : _PyByteArray_empty_string);
                                ...
                                char from_c, Py_ssize_t maxcount)
{
    ...
    self_len = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1631, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size));
    self_s = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1632, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string);
    ...
    (__builtin_expect(!(result_len>=0), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1640, "result_len>=0") : (void)0);

    if ( (result = (PyByteArrayObject *)
                    PyByteArray_FromStringAndSize(((void *)0), result_len)) == ((void *)0))
        return ((void *)0);
    result_s = ((__builtin_expect(!(((((PyObject*)(result))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(result))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1645, "PyByteArray_Check(result)") : (void)0), (((PyVarObject*)(result))->ob_size) ? ((PyByteArrayObject *)(result))->ob_bytes : _PyByteArray_empty_string);
                         ...
                         Py_ssize_t maxcount)
{
    ...
    self_len = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1675, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size));
    self_s = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1676, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string);
    ...
    (__builtin_expect(!(result_len>=0), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1688, "result_len>=0") : (void)0);

    if ( (result = (PyByteArrayObject *)
        PyByteArray_FromStringAndSize(((void *)0), result_len)) == ((void *)0) )
            return ((void *)0);

    result_s = ((__builtin_expect(!(((((PyObject*)(result))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(result))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1694, "PyByteArray_Check(result)") : (void)0), (((PyVarObject*)(result))->ob_size) ? ((PyByteArrayObject *)(result))->ob_bytes : _PyByteArray_empty_string);
                                  ...
                                  Py_ssize_t maxcount)
{
    ...
    self_s = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1726, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string);
    self_len = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1727, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size));
    ...
    result = (PyByteArrayObject *) PyByteArray_FromStringAndSize(((void *)0), self_len);
    if (result == ((void *)0))
        return ((void *)0);
    result_s = ((__builtin_expect(!(((((PyObject*)(result))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(result))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1740, "PyByteArray_Check(result)") : (void)0), (((PyVarObject*)(result))->ob_size) ? ((PyByteArrayObject *)(result))->ob_bytes : _PyByteArray_empty_string);
                           ...
                           Py_ssize_t maxcount)
{
    ...
    self_s = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1774, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string);
    self_len = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1775, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size));
    ...
    if (result == ((void *)0))
        return ((void *)0);
    result_s = ((__builtin_expect(!(((((PyObject*)(result))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(result))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1789, "PyByteArray_Check(result)") : (void)0), (((PyVarObject*)(result))->ob_size) ? ((PyByteArrayObject *)(result))->ob_bytes : _PyByteArray_empty_string);
    ((__builtin_object_size (result_s, 0) != (size_t) -1) ? __builtin___memcpy_chk (result_s, self_s, self_len, __builtin_object_size (result_s, 0)) : __inline_memcpy_chk (result_s, self_s, self_len));
                         ...
                         Py_ssize_t maxcount)
{
    ...
    self_s = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1824, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string);
    self_len = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1825, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size));
    ...
    (__builtin_expect(!(count > 0), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1835, "count > 0") : (void)0);
    ...
    if ( (result = (PyByteArrayObject *)
          PyByteArray_FromStringAndSize(((void *)0), result_len)) == ((void *)0))
            return ((void *)0);
    result_s = ((__builtin_expect(!(((((PyObject*)(result))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(result))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1845, "PyByteArray_Check(result)") : (void)0), (((PyVarObject*)(result))->ob_size) ? ((PyByteArrayObject *)(result))->ob_bytes : _PyByteArray_empty_string);
                  ...
                  Py_ssize_t maxcount)
{
    ...
    self_s = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1887, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string);
    self_len = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1888, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size));
    ...
    (__builtin_expect(!(count > 0), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1901, "count > 0") : (void)0);
    ...
    if ( (result = (PyByteArrayObject *)
          PyByteArray_FromStringAndSize(((void *)0), result_len)) == ((void *)0))
        return ((void *)0);
    result_s = ((__builtin_expect(!(((((PyObject*)(result))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(result))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1911, "PyByteArray_Check(result)") : (void)0), (((PyVarObject*)(result))->ob_size) ? ((PyByteArrayObject *)(result))->ob_bytes : _PyByteArray_empty_string);
        ...
        Py_ssize_t maxcount)
{
    ...
    } else if (maxcount == 0 || ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1951, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)) == 0) {
    ...
    if (((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 1974, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)) == 0) {
        return return_self(self);
    }
...
static char split__doc__[] = "B.split(sep=None, maxsplit=-1) -> list of bytearrays\n\nReturn a list of the sections in B, using sep as the delimiter.\nIf sep is not given, B is split on ASCII whitespace characters\n(space, tab, return, newline, formfeed, vertical tab).\nIf maxsplit is given, at most maxsplit splits are done.";
...
bytearray_split(PyByteArrayObject *self, PyObject *args, PyObject *kwds)
{
    ...
    Py_ssize_t len = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2059, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)), n;
    Py_ssize_t maxsplit = -1;
    const char *s = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2061, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), *sub;
...
bytearray_partition(PyByteArrayObject *self, PyObject *sep_obj)
{
    ...
    result = stringlib_partition(
            (PyObject*) self,
            ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2104, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2104, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)),
            bytesep,
            ((__builtin_expect(!(((((PyObject*)(bytesep))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(bytesep))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2106, "PyByteArray_Check(bytesep)") : (void)0), (((PyVarObject*)(bytesep))->ob_size) ? ((PyByteArrayObject *)(bytesep))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(bytesep))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(bytesep))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2106, "PyByteArray_Check(bytesep)") : (void)0),(((PyVarObject*)(bytesep))->ob_size))
            );

    do { if ( --((PyObject*)(bytesep))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(bytesep)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(bytesep)))); } while (0);
    return result;
}
...
bytearray_rpartition(PyByteArrayObject *self, PyObject *sep_obj)
{
    ...
    result = stringlib_rpartition(
            (PyObject*) self,
            ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2132, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2132, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)),
            bytesep,
            ((__builtin_expect(!(((((PyObject*)(bytesep))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(bytesep))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2134, "PyByteArray_Check(bytesep)") : (void)0), (((PyVarObject*)(bytesep))->ob_size) ? ((PyByteArrayObject *)(bytesep))->ob_bytes : _PyByteArray_empty_string), ((__builtin_expect(!(((((PyObject*)(bytesep))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(bytesep))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2134, "PyByteArray_Check(bytesep)") : (void)0),(((PyVarObject*)(bytesep))->ob_size))
            );
...
static char rsplit__doc__[] = "B.rsplit(sep=None, maxsplit=-1) -> list of bytearrays\n\nReturn a list of the sections in B, using sep as the delimiter,\nstarting at the end of B and working to the front.\nIf sep is not given, B is split on ASCII whitespace characters\n(space, tab, return, newline, formfeed, vertical tab).\nIf maxsplit is given, at most maxsplit splits are done.";
# 2150 "bytearrayobject.c"
static PyObject *
bytearray_rsplit(PyByteArrayObject *self, PyObject *args, PyObject *kwds)
{
    static char *kwlist[] = {"sep", "maxsplit", 0};
    Py_ssize_t len = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2154, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)), n;
    Py_ssize_t maxsplit = -1;
    const char *s = ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2156, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string), *sub;
    PyObject *list, *subobj = (&_Py_NoneStruct);
    Py_buffer vsub;
...
{
    char swap, *head, *tail;
    Py_ssize_t i, j, n = (((PyVarObject*)(self))->ob_size);
...
bytearray_insert(PyByteArrayObject *self, PyObject *args)
{
    PyObject *value;
    int ival;
    Py_ssize_t where, n = (((PyVarObject*)(self))->ob_size);

    if (!_PyArg_ParseTuple_SizeT(args, "nO:insert", &where, &value))
        return ((void *)0);
    ...
    if (where > n)
        where = n;
    ((__builtin_object_size (self->ob_bytes + where + 1, 0) != (size_t) -1) ? __builtin___memmove_chk (self->ob_bytes + where + 1, self->ob_bytes + where, n - where, __builtin_object_size (self->ob_bytes + where + 1, 0)) : __inline_memmove_chk (self->ob_bytes + where + 1, self->ob_bytes + where, n - where));
...
bytearray_extend(PyByteArrayObject *self, PyObject *arg)
{
    ...
    if ((((arg)->ob_type->tp_as_buffer != ((void *)0)) && ((arg)->ob_type->tp_as_buffer->bf_getbuffer != ((void *)0)))) {
        if (bytearray_setslice(self, (((PyVarObject*)(self))->ob_size), (((PyVarObject*)(self))->ob_size), arg) == -1)
            return ((void *)0);
    ...
    bytearray_obj = PyByteArray_FromStringAndSize(((void *)0), buf_size);
    if (bytearray_obj == ((void *)0)) {
        do { if ( --((PyObject*)(it))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(it)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(it)))); } while (0);
        return ((void *)0);
    }
    buf = ((__builtin_expect(!(((((PyObject*)(bytearray_obj))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(bytearray_obj))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2302, "PyByteArray_Check(bytearray_obj)") : (void)0), (((PyVarObject*)(bytearray_obj))->ob_size) ? ((PyByteArrayObject *)(bytearray_obj))->ob_bytes : _PyByteArray_empty_string);

    while ((item = PyIter_Next(it)) != ((void *)0)) {
        if (! _getbytevalue(item, &value)) {
            do { if ( --((PyObject*)(item))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(item)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(item)))); } while (0);
            do { if ( --((PyObject*)(it))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(it)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(it)))); } while (0);
            do { if ( --((PyObject*)(bytearray_obj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(bytearray_obj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(bytearray_obj)))); } while (0);
            return ((void *)0);
        }
        buf[len++] = value;
        do { if ( --((PyObject*)(item))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(item)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(item)))); } while (0);
        ...
        if (len >= buf_size) {
            ...
            buf = ((__builtin_expect(!(((((PyObject*)(bytearray_obj))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(bytearray_obj))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2323, "PyByteArray_Check(bytearray_obj)") : (void)0), (((PyVarObject*)(bytearray_obj))->ob_size) ? ((PyByteArrayObject *)(bytearray_obj))->ob_bytes : _PyByteArray_empty_string);
        }
    }
    do { if ( --((PyObject*)(it))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(it)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(it)))); } while (0);
    ...
    if (bytearray_setslice(self, (((PyVarObject*)(self))->ob_size), (((PyVarObject*)(self))->ob_size), bytearray_obj) == -1) {
        do { if ( --((PyObject*)(bytearray_obj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(bytearray_obj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(bytearray_obj)))); } while (0);
        return ((void *)0);
    }
    do { if ( --((PyObject*)(bytearray_obj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(bytearray_obj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(bytearray_obj)))); } while (0);
...
{
    int value;
    Py_ssize_t where = -1, n = (((PyVarObject*)(self))->ob_size);

    if (!_PyArg_ParseTuple_SizeT(args, "|n:pop", &where))
        return ((void *)0);
    ...
    if (where < 0)
        where += (((PyVarObject*)(self))->ob_size);
    if (where < 0 || where >= (((PyVarObject*)(self))->ob_size)) {
    ...
    ((__builtin_object_size (self->ob_bytes + where, 0) != (size_t) -1) ? __builtin___memmove_chk (self->ob_bytes + where, self->ob_bytes + where + 1, n - where, __builtin_object_size (self->ob_bytes + where, 0)) : __inline_memmove_chk (self->ob_bytes + where, self->ob_bytes + where + 1, n - where));
    if (PyByteArray_Resize((PyObject *)self, n - 1) < 0)
        return ((void *)0);
...
bytearray_strip(PyByteArrayObject *self, PyObject *args)
{
    ...
    void *myptr, *argptr;
    PyObject *arg = (&_Py_NoneStruct);
    Py_buffer varg;
    if (!_PyArg_ParseTuple_SizeT(args, "|O:strip", &arg))
        return ((void *)0);
...
bytearray_lstrip(PyByteArrayObject *self, PyObject *args)
{
    ...
    PyObject *arg = (&_Py_NoneStruct);
    Py_buffer varg;
    if (!_PyArg_ParseTuple_SizeT(args, "|O:lstrip", &arg))
        return ((void *)0);
    if (arg == (&_Py_NoneStruct)) {
        argptr = "\t\n\r\f\v ";
        argsize = 6;
...
bytearray_rstrip(PyByteArrayObject *self, PyObject *args)
{
    ...
    PyObject *arg = (&_Py_NoneStruct);
    Py_buffer varg;
    if (!_PyArg_ParseTuple_SizeT(args, "|O:rstrip", &arg))
        return ((void *)0);
    if (arg == (&_Py_NoneStruct)) {
        argptr = "\t\n\r\f\v ";
        argsize = 6;
...
{
    PyObject *seq;
    Py_ssize_t mysize = (((PyVarObject*)(self))->ob_size);
    Py_ssize_t i;
    Py_ssize_t n;
    PyObject **items;
    ...
    if (seq == ((void *)0))
        return ((void *)0);
    n = (((((((PyObject*)(seq))->ob_type))->tp_flags & ((1L<<25))) != 0) ? (((PyVarObject*)(seq))->ob_size) : (((PyVarObject*)(seq))->ob_size));
    items = (((((((PyObject*)(seq))->ob_type))->tp_flags & ((1L<<25))) != 0) ? ((PyListObject *)(seq))->ob_item : ((PyTupleObject *)(seq))->ob_item);



    for (i = 0; i < n; i++) {
        PyObject *obj = items[i];
        if (!((((PyObject*)(obj))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(obj))->ob_type), (&PyByteArray_Type))) && !((((((PyObject*)(obj))->ob_type))->tp_flags & ((1L<<27))) != 0)) {
            PyErr_Format(PyExc_TypeError,
                         "can only join an iterable of bytes "
                         "(item %ld has type '%.100s')",

                         (long)i, (((PyObject*)(obj))->ob_type)->tp_name);
            goto error;
        }
        if (i > 0)
            totalsize += mysize;
        totalsize += (((PyVarObject*)(obj))->ob_size);
        if (totalsize < 0) {
            PyErr_NoMemory();
            goto error;
        }
    ...
    result = PyByteArray_FromStringAndSize(((void *)0), totalsize);
    if (result == ((void *)0))
        goto error;
    dest = ((__builtin_expect(!(((((PyObject*)(result))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(result))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2620, "PyByteArray_Check(result)") : (void)0), (((PyVarObject*)(result))->ob_size) ? ((PyByteArrayObject *)(result))->ob_bytes : _PyByteArray_empty_string);
    for (i = 0; i < n; i++) {
        PyObject *obj = items[i];
        Py_ssize_t size = (((PyVarObject*)(obj))->ob_size);
        char *buf;
        if (((((PyObject*)(obj))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(obj))->ob_type), (&PyByteArray_Type))))
           buf = ((__builtin_expect(!(((((PyObject*)(obj))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(obj))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2626, "PyByteArray_Check(obj)") : (void)0), (((PyVarObject*)(obj))->ob_size) ? ((PyByteArrayObject *)(obj))->ob_bytes : _PyByteArray_empty_string);
        else
           buf = ((__builtin_expect(!(((((((PyObject*)(obj))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2628, "PyBytes_Check(obj)") : (void)0), (((PyBytesObject *)(obj))->ob_sval));
        if (i) {
            ((__builtin_object_size (dest, 0) != (size_t) -1) ? __builtin___memcpy_chk (dest, self->ob_bytes, mysize, __builtin_object_size (dest, 0)) : __inline_memcpy_chk (dest, self->ob_bytes, mysize));
            dest += mysize;
        }
        ((__builtin_object_size (dest, 0) != (size_t) -1) ? __builtin___memcpy_chk (dest, buf, size, __builtin_object_size (dest, 0)) : __inline_memcpy_chk (dest, buf, size));
        dest += size;
    }
...
bytearray_splitlines(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    return stringlib_splitlines(
        (PyObject*) self, ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2665, "PyByteArray_Check(self)") : (void)0), (((PyVarObject*)(self))->ob_size) ? ((PyByteArrayObject *)(self))->ob_bytes : _PyByteArray_empty_string),
        ((__builtin_expect(!(((((PyObject*)(self))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2666, "PyByteArray_Check(self)") : (void)0),(((PyVarObject*)(self))->ob_size)), keepends
        );
}
...
bytearray_fromhex(PyObject *cls, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "U:fromhex", &hexobj))
        return ((void *)0);
    (__builtin_expect(!(((((((PyObject*)(hexobj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2705, "PyUnicode_Check(hexobj)") : (void)0);
    if (((__builtin_expect(!(((((((PyObject*)(hexobj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2706, "PyUnicode_Check(hexobj)") : (void)0), ((((PyASCIIObject*)hexobj)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(hexobj)))))
        return ((void *)0);
    kind = ((__builtin_expect(!(((((((PyObject*)(hexobj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2708, "PyUnicode_Check(hexobj)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)hexobj)->state.ready)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2708, "PyUnicode_IS_READY(hexobj)") : (void)0), ((PyASCIIObject *)(hexobj))->state.kind);
    data = ((__builtin_expect(!(((((((PyObject*)(hexobj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2709, "PyUnicode_Check(hexobj)") : (void)0), (((PyASCIIObject*)(hexobj))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)(hexobj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2709, "PyUnicode_Check(hexobj)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)hexobj)->state.ready)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2709, "PyUnicode_IS_READY(hexobj)") : (void)0), ((PyASCIIObject*)hexobj)->state.ascii) ? ((void*)((PyASCIIObject*)(hexobj) + 1)) : ((void*)((PyCompactUnicodeObject*)(hexobj) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)(hexobj))->data.any), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2709, "((PyUnicodeObject*)(hexobj))->data.any") : (void)0), ((((PyUnicodeObject *)(hexobj))->data.any))));
    hexlen = ((__builtin_expect(!(((((((PyObject*)(hexobj))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2710, "PyUnicode_Check(hexobj)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)hexobj)->state.ready)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2710, "PyUnicode_IS_READY(hexobj)") : (void)0), ((PyASCIIObject *)(hexobj))->length);

    byteslen = hexlen/2;
    newbytes = PyByteArray_FromStringAndSize(((void *)0), byteslen);
    if (!newbytes)
        return ((void *)0);
    buf = ((__builtin_expect(!(((((PyObject*)(newbytes))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(newbytes))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2716, "PyByteArray_Check(newbytes)") : (void)0), (((PyVarObject*)(newbytes))->ob_size) ? ((PyByteArrayObject *)(newbytes))->ob_bytes : _PyByteArray_empty_string);
  ...
  error:
    do { if ( --((PyObject*)(newbytes))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(newbytes)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(newbytes)))); } while (0);
    return ((void *)0);
}
...
_common_reduce(PyByteArrayObject *self, int proto)
{
    ...
    if (proto < 3) {
        ...
        PyObject *latin1;
        if (self->ob_bytes)
            latin1 = PyUnicode_DecodeLatin1(self->ob_bytes, (((PyVarObject*)(self))->ob_size), ((void *)0));
        else
            latin1 = PyUnicode_FromString("");
        return _Py_BuildValue_SizeT("(O(Ns)N)", (((PyObject*)(self))->ob_type), latin1, "latin-1", dict);
    }
    else {

        if (self->ob_bytes) {
            return _Py_BuildValue_SizeT("(O(y#)N)", (((PyObject*)(self))->ob_type), self->ob_bytes, (((PyVarObject*)(self))->ob_size), dict);
        }
        else {
            return _Py_BuildValue_SizeT("(O()N)", (((PyObject*)(self))->ob_type), dict);
        }
    }
}
...
static char reduce_ex_doc[] = "Return state information for pickling.";
...
bytearray_reduce_ex(PyByteArrayObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "|i:__reduce_ex__", &proto))
        return ((void *)0);
...
static PyMethodDef
bytearray_methods[] = {
    {"__alloc__", (PyCFunction)bytearray_alloc, 0x0004, alloc_doc},
    {"__reduce__", (PyCFunction)bytearray_reduce, 0x0004, reduce_doc},
    {"__reduce_ex__", (PyCFunction)bytearray_reduce_ex, 0x0001, reduce_ex_doc},
    {"__sizeof__", (PyCFunction)bytearray_sizeof, 0x0004, sizeof_doc},
    {"append", (PyCFunction)bytearray_append, 0x0008, append__doc__},
    {"capitalize", (PyCFunction)stringlib_capitalize, 0x0004,
     _Py_capitalize__doc__},
    {"center", (PyCFunction)stringlib_center, 0x0001, center__doc__},
    {"clear", (PyCFunction)bytearray_clear, 0x0004, clear__doc__},
    {"copy", (PyCFunction)bytearray_copy, 0x0004, copy__doc__},
    {"count", (PyCFunction)bytearray_count, 0x0001, count__doc__},
    {"decode", (PyCFunction)bytearray_decode, 0x0001 | 0x0002, decode_doc},
    {"endswith", (PyCFunction)bytearray_endswith, 0x0001, endswith__doc__},
    {"expandtabs", (PyCFunction)stringlib_expandtabs, 0x0001,
     expandtabs__doc__},
    {"extend", (PyCFunction)bytearray_extend, 0x0008, extend__doc__},
    {"find", (PyCFunction)bytearray_find, 0x0001, find__doc__},
    {"fromhex", (PyCFunction)bytearray_fromhex, 0x0001|0x0010,
     fromhex_doc},
    {"index", (PyCFunction)bytearray_index, 0x0001, index__doc__},
    {"insert", (PyCFunction)bytearray_insert, 0x0001, insert__doc__},
    ...
    {"isupper", (PyCFunction)stringlib_isupper, 0x0004,
     _Py_isupper__doc__},
    {"join", (PyCFunction)bytearray_join, 0x0008, join_doc},
    {"ljust", (PyCFunction)stringlib_ljust, 0x0001, ljust__doc__},
    {"lower", (PyCFunction)stringlib_lower, 0x0004, _Py_lower__doc__},
    {"lstrip", (PyCFunction)bytearray_lstrip, 0x0001, lstrip__doc__},
    {"maketrans", (PyCFunction)bytearray_maketrans, 0x0001|0x0020,
     _Py_maketrans__doc__},
    {"partition", (PyCFunction)bytearray_partition, 0x0008, partition__doc__},
    {"pop", (PyCFunction)bytearray_pop, 0x0001, pop__doc__},
    {"remove", (PyCFunction)bytearray_remove, 0x0008, remove__doc__},
    {"replace", (PyCFunction)bytearray_replace, 0x0001, replace__doc__},
    {"reverse", (PyCFunction)bytearray_reverse, 0x0004, reverse__doc__},
    {"rfind", (PyCFunction)bytearray_rfind, 0x0001, rfind__doc__},
    {"rindex", (PyCFunction)bytearray_rindex, 0x0001, rindex__doc__},
    {"rjust", (PyCFunction)stringlib_rjust, 0x0001, rjust__doc__},
    {"rpartition", (PyCFunction)bytearray_rpartition, 0x0008, rpartition__doc__},
    {"rsplit", (PyCFunction)bytearray_rsplit, 0x0001 | 0x0002, rsplit__doc__},
    {"rstrip", (PyCFunction)bytearray_rstrip, 0x0001, rstrip__doc__},
    {"split", (PyCFunction)bytearray_split, 0x0001 | 0x0002, split__doc__},
    {"splitlines", (PyCFunction)bytearray_splitlines,
     0x0001 | 0x0002, splitlines__doc__},
    {"startswith", (PyCFunction)bytearray_startswith, 0x0001 ,
     startswith__doc__},
    {"strip", (PyCFunction)bytearray_strip, 0x0001, strip__doc__},
    {"swapcase", (PyCFunction)stringlib_swapcase, 0x0004,
     _Py_swapcase__doc__},
    {"title", (PyCFunction)stringlib_title, 0x0004, _Py_title__doc__},
    {"translate", (PyCFunction)bytearray_translate, 0x0001,
     translate__doc__},
...
{
    do { PyGC_Head *g = ((PyGC_Head *)(it)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2974, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
...
bytearrayiter_next(bytesiterobject *it)
{
    ...
    (__builtin_expect(!(it != ((void *)0)), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2992, "it != NULL") : (void)0);
    seq = it->it_seq;
    if (seq == ((void *)0))
        return ((void *)0);
    (__builtin_expect(!(((((PyObject*)(seq))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(seq))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2996, "PyByteArray_Check(seq)") : (void)0);

    if (it->it_index < ((__builtin_expect(!(((((PyObject*)(seq))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(seq))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 2998, "PyByteArray_Check(seq)") : (void)0),(((PyVarObject*)(seq))->ob_size))) {
...
bytearrayiter_length_hint(bytesiterobject *it)
{
    Py_ssize_t len = 0;
    if (it->it_seq)
        len = ((__builtin_expect(!(((((PyObject*)(it->it_seq))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(it->it_seq))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "bytearrayobject.c", 3016, "PyByteArray_Check(it->it_seq)") : (void)0),(((PyVarObject*)(it->it_seq))->ob_size)) - it->it_index;
...
static PyMethodDef bytearrayiter_methods[] = {
    {"__length_hint__", (PyCFunction)bytearrayiter_length_hint, 0x0004,
     length_hint_doc},
     {"__reduce__", (PyCFunction)bytearrayiter_reduce, 0x0004,
     reduce_doc},
    {"__setstate__", (PyCFunction)bytearrayiter_setstate, 0x0008,
     setstate_doc},
    {((void *)0), ((void *)0)}
};
...
bytearray_iter(PyObject *seq)
{
    ...
    if (!((((PyObject*)(seq))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(seq))->ob_type), (&PyByteArray_Type)))) {
        _PyErr_BadInternalCall("bytearrayobject.c", 3100);
        return ((void *)0);
    }
    it = ( (bytesiterobject *) _PyObject_GC_New(&PyByteArrayIter_Type) );
    if (it == ((void *)0))
        return ((void *)0);
    it->it_index = 0;
