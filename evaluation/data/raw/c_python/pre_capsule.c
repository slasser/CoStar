...
{
    if (!capsule || !((((PyObject*)(capsule))->ob_type) == &PyCapsule_Type) || capsule->pointer == ((void *)0)) {
...
PyCapsule_New(void *pointer, const char *name, PyCapsule_Destructor destructor)
{
    ...
    capsule = ( (PyCapsule *) PyObject_Init( (PyObject *) PyObject_Malloc( ( (&PyCapsule_Type)->tp_basicsize ) ), (&PyCapsule_Type)) );
    if (capsule == ((void *)0)) {
        return ((void *)0);
    }
...
PyCapsule_IsValid(PyObject *o, const char *name)
{
    ...
    return (capsule != ((void *)0) &&
            ((((PyObject*)(capsule))->ob_type) == &PyCapsule_Type) &&
            capsule->pointer != ((void *)0) &&
...
PyCapsule_GetPointer(PyObject *o, const char *name)
{
    ...
    if (!(_is_legal_capsule(capsule, "PyCapsule_GetPointer" " called with invalid PyCapsule object"))) {
        return ((void *)0);
    }
...
PyCapsule_GetName(PyObject *o)
{
    ...
    if (!(_is_legal_capsule(capsule, "PyCapsule_GetName" " called with invalid PyCapsule object"))) {
        return ((void *)0);
    }
    return capsule->name;
}
...
PyCapsule_GetDestructor(PyObject *o)
{
    ...
    if (!(_is_legal_capsule(capsule, "PyCapsule_GetDestructor" " called with invalid PyCapsule object"))) {
        return ((void *)0);
    }
...
PyCapsule_GetContext(PyObject *o)
{
    ...
    if (!(_is_legal_capsule(capsule, "PyCapsule_GetContext" " called with invalid PyCapsule object"))) {
        return ((void *)0);
    }
...
PyCapsule_SetPointer(PyObject *o, void *pointer)
{
    ...
    if (!(_is_legal_capsule(capsule, "PyCapsule_SetPointer" " called with invalid PyCapsule object"))) {
        return -1;
    }
...
PyCapsule_SetName(PyObject *o, const char *name)
{
    ...
    if (!(_is_legal_capsule(capsule, "PyCapsule_SetName" " called with invalid PyCapsule object"))) {
        return -1;
    }
...
PyCapsule_SetDestructor(PyObject *o, PyCapsule_Destructor destructor)
{
    ...
    if (!(_is_legal_capsule(capsule, "PyCapsule_SetDestructor" " called with invalid PyCapsule object"))) {
        return -1;
    }
...
PyCapsule_SetContext(PyObject *o, void *context)
{
    ...
    if (!(_is_legal_capsule(capsule, "PyCapsule_SetContext" " called with invalid PyCapsule object"))) {
        return -1;
    }
...
{
    PyObject *object = ((void *)0);
    void *return_value = ((void *)0);
    char *trace;
    size_t name_length = (strlen(name) + 1) * sizeof(char);
    char *name_dup = (char *)((size_t)(name_length) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc((name_length) ? (name_length) : 1));

    if (!name_dup) {
        return ((void *)0);
    }

    ((__builtin_object_size (name_dup, 0) != (size_t) -1) ? __builtin___memcpy_chk (name_dup, name, name_length, __builtin_object_size (name_dup, 0)) : __inline_memcpy_chk (name_dup, name, name_length));
...
static char PyCapsule_Type__doc__[] = "Capsule objects let you wrap a C \"void *\" pointer in a Python\nobject.  They're a way of passing data through the Python interpreter\nwithout creating your own custom type.\n\nCapsules are used for communication between extension modules.\nThey provide a way for an extension module to export a C interface\nto other extension modules, so that extension modules can use the\nPython import mechanism to link to one another.\n";
# 299 "capsule.c"
