...
static char struct_passwd__doc__[] = "pwd.struct_passwd: Results from getpw*() routines.\n\nThis object may be accessed either as a tuple of\n  (pw_name,pw_passwd,pw_uid,pw_gid,pw_gecos,pw_dir,pw_shell)\nor via the object attributes as named in the above tuple.";
...
static char pwd__doc__[] = "This module provides access to the Unix password database.\nIt is available on all Unix versions.\n\nPassword database entries are reported as 7-tuples containing the following\nitems from the password database (see `<pwd.h>'), in order:\npw_name, pw_passwd, pw_uid, pw_gid, pw_gecos, pw_dir, pw_shell.\nThe uid and gid items are integers, all others are strings. An\nexception is raised if the entry asked for cannot be found.";
# 44 "pwdmodule.c"
...
sets(PyObject *v, int i, const char* val)
{
  if (val) {
      ...
      (((PyTupleObject *)(v))->ob_item[i] = o);
  }
  else {
      (((PyTupleObject *)(v))->ob_item[i] = (&_Py_NoneStruct));
...
mkpwent(struct passwd *p)
{
    ...
    sets(v, setIndex++, p->pw_name);



    sets(v, setIndex++, p->pw_passwd);

    (((PyTupleObject *)(v))->ob_item[setIndex++] = _PyLong_FromUid(p->pw_uid));
    (((PyTupleObject *)(v))->ob_item[setIndex++] = _PyLong_FromGid(p->pw_gid));



    sets(v, setIndex++, p->pw_gecos);

    sets(v, setIndex++, p->pw_dir);
    sets(v, setIndex++, p->pw_shell);
...
static char pwd_getpwuid__doc__[] = "getpwuid(uid) -> (pw_name,pw_passwd,pw_uid,\n                  pw_gid,pw_gecos,pw_dir,pw_shell)\nReturn the password database entry for the given numeric user ID.\nSee help(pwd) for more on password database entries.";
...
pwd_getpwuid(PyObject *self, PyObject *args)
{
    ...
    if ((p = getpwuid(uid)) == ((void *)0)) {
        PyObject *uid_obj = _PyLong_FromUid(uid);
        if (uid_obj == ((void *)0))
            return ((void *)0);
        PyErr_Format(PyExc_KeyError,
                     "getpwuid(): uid not found: %S", uid_obj);
        do { if ( --((PyObject*)(uid_obj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(uid_obj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(uid_obj)))); } while (0);
        return ((void *)0);
    }
    return mkpwent(p);
}

static char pwd_getpwnam__doc__[] = "getpwnam(name) -> (pw_name,pw_passwd,pw_uid,\n                    pw_gid,pw_gecos,pw_dir,pw_shell)\nReturn the password database entry for the given user name.\nSee help(pwd) for more on password database entries.";
...
pwd_getpwnam(PyObject *self, PyObject *args)
{
    char *name;
    struct passwd *p;
    PyObject *arg, *bytes, *retval = ((void *)0);

    if (!PyArg_ParseTuple(args, "U:getpwnam", &arg))
        return ((void *)0);
    if ((bytes = PyUnicode_EncodeFSDefault(arg)) == ((void *)0))
        return ((void *)0);
    if (PyBytes_AsStringAndSize(bytes, &name, ((void *)0)) == -1)
        goto out;
...
static char pwd_getpwall__doc__[] = "getpwall() -> list_of_entries\nReturn a list of all available password database entries, in arbitrary order.\nSee help(pwd) for more on password database entries.";
...
pwd_getpwall(PyObject *self)
{
    ...
    while ((p = getpwent()) != ((void *)0)) {
        ...
        if (v == ((void *)0) || PyList_Append(d, v) != 0) {
            do { if ((v) == ((void *)0)) ; else do { if ( --((PyObject*)(v))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(v)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(v)))); } while (0); } while (0);
...
static PyMethodDef pwd_methods[] = {
    {"getpwuid", pwd_getpwuid, 0x0001, pwd_getpwuid__doc__},
    {"getpwnam", pwd_getpwnam, 0x0001, pwd_getpwnam__doc__},

    {"getpwall", (PyCFunction)pwd_getpwall,
        0x0004, pwd_getpwall__doc__},
...
{
    PyObject *m;
    m = PyModule_Create2(&pwdmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    ...
    ( ((PyObject*)((PyObject *) &StructPwdType))->ob_refcnt++);
