...
# 2 "symtablemodule.c" 2

# 1 "/Users/parrt/tmp/Python-3.3.1/Include/code.h" 1
# 4 "symtablemodule.c" 2
...
static PyMethodDef symtable_methods[] = {
    {"symtable", symtable_symtable, 0x0001,
...
PyInit__symtable(void)
{
    ...
    m = PyModule_Create2(&symtablemodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    PyModule_AddIntConstant(m, "USE", 2<<3);
    PyModule_AddIntConstant(m, "DEF_GLOBAL", 1);
    PyModule_AddIntConstant(m, "DEF_LOCAL", 2);
    PyModule_AddIntConstant(m, "DEF_PARAM", 2<<1);
    PyModule_AddIntConstant(m, "DEF_FREE", 2<<4);
    PyModule_AddIntConstant(m, "DEF_FREE_CLASS", 2<<5);
    PyModule_AddIntConstant(m, "DEF_IMPORT", 2<<6);
    PyModule_AddIntConstant(m, "DEF_BOUND", (2 | 2<<1 | 2<<6));

    PyModule_AddIntConstant(m, "TYPE_FUNCTION", FunctionBlock);
    PyModule_AddIntConstant(m, "TYPE_CLASS", ClassBlock);
    PyModule_AddIntConstant(m, "TYPE_MODULE", ModuleBlock);

    PyModule_AddIntConstant(m, "OPT_IMPORT_STAR", 1);
    PyModule_AddIntConstant(m, "OPT_TOPLEVEL", 2);

    PyModule_AddIntConstant(m, "LOCAL", 1);
    PyModule_AddIntConstant(m, "GLOBAL_EXPLICIT", 2);
    PyModule_AddIntConstant(m, "GLOBAL_IMPLICIT", 3);
    PyModule_AddIntConstant(m, "FREE", 4);
    PyModule_AddIntConstant(m, "CELL", 5);

    PyModule_AddIntConstant(m, "SCOPE_OFF", 11);
    PyModule_AddIntConstant(m, "SCOPE_MASK", (1 | 2 | 2<<1 | 2<<2));
