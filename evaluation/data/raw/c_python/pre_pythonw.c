...
# 1 "/usr/include/sys/spawn.h" 1 3 4
# 35 "/usr/include/spawn.h" 2 3 4
# 62 "/usr/include/spawn.h" 3 4
...
int posix_spawn(pid_t * , const char * ,
  ...
  char *const __argv[ ],
  char *const __envp[ ]) __attribute__((visibility("default")));
int posix_spawnp(pid_t * , const char * ,
  const posix_spawn_file_actions_t *,
  const posix_spawnattr_t * ,
  char *const __argv[ ],
  char *const __envp[ ]) __attribute__((visibility("default")));
int posix_spawn_file_actions_addclose(posix_spawn_file_actions_t *, int) __attribute__((visibility("default")));
int posix_spawn_file_actions_adddup2(posix_spawn_file_actions_t *, int,
  int) __attribute__((visibility("default")));
int posix_spawn_file_actions_addopen(
  posix_spawn_file_actions_t * , int,
  const char * , int, mode_t) __attribute__((visibility("default")));
int posix_spawn_file_actions_destroy(posix_spawn_file_actions_t *) __attribute__((visibility("default")));
int posix_spawn_file_actions_init(posix_spawn_file_actions_t *) __attribute__((visibility("default")));
int posix_spawnattr_destroy(posix_spawnattr_t *) __attribute__((visibility("default")));
int posix_spawnattr_getsigdefault(const posix_spawnattr_t * ,
  sigset_t * ) __attribute__((visibility("default")));
int posix_spawnattr_getflags(const posix_spawnattr_t * ,
  short * ) __attribute__((visibility("default")));
int posix_spawnattr_getpgroup(const posix_spawnattr_t * ,
  pid_t * ) __attribute__((visibility("default")));
int posix_spawnattr_getsigmask(const posix_spawnattr_t * ,
  sigset_t * ) __attribute__((visibility("default")));
int posix_spawnattr_init(posix_spawnattr_t *) __attribute__((visibility("default")));
int posix_spawnattr_setsigdefault(posix_spawnattr_t * ,
  const sigset_t * ) __attribute__((visibility("default")));
int posix_spawnattr_setflags(posix_spawnattr_t *, short) __attribute__((visibility("default")));
int posix_spawnattr_setpgroup(posix_spawnattr_t *, pid_t) __attribute__((visibility("default")));
int posix_spawnattr_setsigmask(posix_spawnattr_t * ,
  const sigset_t * ) __attribute__((visibility("default")));
# 115 "/usr/include/spawn.h" 3 4
...
# 158 "/usr/include/mach/exception_types.h" 3 4
...
# 159 "/usr/include/mach/exception_types.h" 2 3 4
...
int posix_spawnattr_getbinpref_np(const posix_spawnattr_t * ,
  size_t, cpu_type_t *, size_t *) __attribute__((visibility("default")));
int posix_spawnattr_setauditsessionport_np(posix_spawnattr_t *,
  mach_port_t) __attribute__((visibility("default")));
...
int posix_spawnattr_setexceptionports_np(posix_spawnattr_t *,
  ...
  exception_behavior_t, thread_state_flavor_t) __attribute__((visibility("default")));
int posix_spawnattr_setspecialport_np(posix_spawnattr_t *,
  mach_port_t, int) __attribute__((visibility("default")));
...
void err_set_exit_b(void (^)(int)) __attribute__((visibility("default")));
...
# 41 "/usr/include/mach-o/loader.h" 3 4
...
static char* get_python_path(void)
{
    ...
    ((__builtin_object_size (g_path, 0) != (size_t) -1) ? __builtin___strcpy_chk (g_path, info.dli_fname, __builtin_object_size (g_path, 2 > 1)) : __inline_strcpy_chk (g_path, info.dli_fname));
    end = g_path + len - 1;
    ...
    ((__builtin_object_size (end, 0) != (size_t) -1) ? __builtin___strcpy_chk (end, "Resources/Python.app/Contents/MacOS/" "PYTHONFRAMEWORK", __builtin_object_size (end, 2 > 1)) : __inline_strcpy_chk (end, "Resources/Python.app/Contents/MacOS/" "PYTHONFRAMEWORK"));
...
setup_spawnattr(posix_spawnattr_t* spawnattr)
{
    ...
    if (((*__error()) = posix_spawnattr_init(spawnattr)) != 0) {
    ...
    count = 1;
# 118 "pythonw.c"
    cpu_types[0] = (((cpu_type_t) 7) | 0x01000000);
# 128 "pythonw.c"
    ...
    if (count != ocount) {
        fprintf(__stderrp, "posix_spawnattr_setbinpref failed to copy\n");
        exit(1);
    ...
    flags |= 0x0040;
    if (((*__error()) = posix_spawnattr_setflags(spawnattr, flags)) != 0) {
...
main(int argc, char **argv) {
    ...
    static char path[1024 * 2];
    static char real_path[1024 * 2];
    int status;
    uint32_t size = 1024 * 2;
...
# 171 "pythonw.c"
        ...
        if (slash) {
            ...
            replaced = slash[1];
            slash[1] = 0;
            if (realpath(path, real_path) == ((void *)0)) {
    ...
    if (posix_spawn != ((void *)0)) {
        posix_spawnattr_t spawnattr = ((void *)0);

        setup_spawnattr(&spawnattr);
        posix_spawn(((void *)0), exec_path, ((void *)0),
