...
# 3 "_collectionsmodule.c" 2
# 48 "_collectionsmodule.c"
...
newblock(block *leftlink, block *rightlink, Py_ssize_t len) {
    ...
    if (len >= ((Py_ssize_t)(((size_t)-1)>>1)) - 2*62) {
...
deque_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    b = newblock(((void *)0), ((void *)0), 0);
    if (b == ((void *)0)) {
        do { if ( --((PyObject*)(deque))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(deque)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(deque)))); } while (0);
        return ((void *)0);
    }

    (__builtin_expect(!(62 >= 2), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 146, "BLOCKLEN >= 2") : (void)0);
    deque->leftblock = b;
    deque->rightblock = b;
    deque->leftindex = ((62 - 1) / 2) + 1;
    deque->rightindex = ((62 - 1) / 2);
    deque->len = 0;
    deque->state = 0;
    deque->weakreflist = ((void *)0);
    deque->maxlen = -1;
...
deque_pop(dequeobject *deque, PyObject *unused)
{
    ...
    if (deque->rightindex == -1) {
        if (deque->len == 0) {
            (__builtin_expect(!(deque->leftblock == deque->rightblock), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 176, "deque->leftblock == deque->rightblock") : (void)0);
            (__builtin_expect(!(deque->leftindex == deque->rightindex+1), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 177, "deque->leftindex == deque->rightindex+1") : (void)0);

            deque->leftindex = ((62 - 1) / 2) + 1;
            deque->rightindex = ((62 - 1) / 2);
        } else {
            prevblock = deque->rightblock->leftlink;
            (__builtin_expect(!(deque->leftblock != deque->rightblock), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 183, "deque->leftblock != deque->rightblock") : (void)0);
            freeblock(deque->rightblock);
            prevblock->rightlink = ((void *)0);
            deque->rightblock = prevblock;
            deque->rightindex = 62 - 1;
        }
    }
    return item;
}

static char pop_doc[] = "Remove and return the rightmost element.";
...
deque_popleft(dequeobject *deque, PyObject *unused)
{
    ...
    (__builtin_expect(!(deque->leftblock != ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 205, "deque->leftblock != NULL") : (void)0);
    item = deque->leftblock->data[deque->leftindex];
    deque->leftindex++;
    deque->len--;
    deque->state++;

    if (deque->leftindex == 62) {
        if (deque->len == 0) {
            (__builtin_expect(!(deque->leftblock == deque->rightblock), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 213, "deque->leftblock == deque->rightblock") : (void)0);
            (__builtin_expect(!(deque->leftindex == deque->rightindex+1), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 214, "deque->leftindex == deque->rightindex+1") : (void)0);

            deque->leftindex = ((62 - 1) / 2) + 1;
            deque->rightindex = ((62 - 1) / 2);
        } else {
            (__builtin_expect(!(deque->leftblock != deque->rightblock), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 219, "deque->leftblock != deque->rightblock") : (void)0);
            prevblock = deque->leftblock->rightlink;
            freeblock(deque->leftblock);
            (__builtin_expect(!(prevblock != ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 222, "prevblock != NULL") : (void)0);
            prevblock->leftlink = ((void *)0);
...
static char popleft_doc[] = "Remove and return the leftmost element.";

static PyObject *
deque_append(dequeobject *deque, PyObject *item)
{
    deque->state++;
    if (deque->rightindex == 62 -1) {
        block *b = newblock(deque->rightblock, ((void *)0), deque->len);
        if (b == ((void *)0))
            return ((void *)0);
        (__builtin_expect(!(deque->rightblock->rightlink == ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 241, "deque->rightblock->rightlink == NULL") : (void)0);
    ...
    if (deque->maxlen != -1 && deque->len > deque->maxlen) { PyObject *rv = deque_popleft(deque, ((void *)0)); (__builtin_expect(!(rv != ((void *)0) && deque->len <= deque->maxlen), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 250, "rv != NULL && deque->len <= deque->maxlen") : (void)0); do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0); };
    return ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++), (&_Py_NoneStruct);
}

static char append_doc[] = "Add an element to the right side of the deque.";
...
deque_appendleft(dequeobject *deque, PyObject *item)
{
    ...
    if (deque->leftindex == 0) {
        block *b = newblock(((void *)0), deque->leftblock, deque->len);
        if (b == ((void *)0))
            return ((void *)0);
        (__builtin_expect(!(deque->leftblock->leftlink == ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 264, "deque->leftblock->leftlink == NULL") : (void)0);
    ...
    if (deque->maxlen != -1 && deque->len > deque->maxlen) { PyObject *rv = deque_pop(deque, ((void *)0)); (__builtin_expect(!(rv != ((void *)0) && deque->len <= deque->maxlen), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 273, "rv != NULL && deque->len <= deque->maxlen") : (void)0); do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0); };
    return ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++), (&_Py_NoneStruct);
}

static char appendleft_doc[] = "Add an element to the left side of the deque.";
...
deque_extend(dequeobject *deque, PyObject *iterable)
{
    ...
    while ((item = PyIter_Next(it)) != ((void *)0)) {
        deque->state++;
        if (deque->rightindex == 62 -1) {
            block *b = newblock(deque->rightblock, ((void *)0),
                                deque->len);
            if (b == ((void *)0)) {
                do { if ( --((PyObject*)(item))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(item)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(item)))); } while (0);
                do { if ( --((PyObject*)(it))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(it)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(it)))); } while (0);
            ...
            (__builtin_expect(!(deque->rightblock->rightlink == ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 329, "deque->rightblock->rightlink == NULL") : (void)0);
            deque->rightblock->rightlink = b;
            deque->rightblock = b;
            deque->rightindex = -1;
        }
        ...
        deque->rightindex++;
        deque->rightblock->data[deque->rightindex] = item;
        if (deque->maxlen != -1 && deque->len > deque->maxlen) { PyObject *rv = deque_popleft(deque, ((void *)0)); (__builtin_expect(!(rv != ((void *)0) && deque->len <= deque->maxlen), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 337, "rv != NULL && deque->len <= deque->maxlen") : (void)0); do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0); };
    }
    do { if ( --((PyObject*)(it))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(it)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(it)))); } while (0);
    if (PyErr_Occurred())
        return ((void *)0);
...
static char extend_doc[] = "Extend the right side of the deque with elements from the iterable";
...
deque_extendleft(dequeobject *deque, PyObject *iterable)
{
    ...
    while ((item = PyIter_Next(it)) != ((void *)0)) {
        deque->state++;
        if (deque->leftindex == 0) {
            block *b = newblock(((void *)0), deque->leftblock,
                                deque->len);
            if (b == ((void *)0)) {
                do { if ( --((PyObject*)(item))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(item)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(item)))); } while (0);
                do { if ( --((PyObject*)(it))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(it)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(it)))); } while (0);
            ...
            (__builtin_expect(!(deque->leftblock->leftlink == ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 381, "deque->leftblock->leftlink == NULL") : (void)0);
            deque->leftblock->leftlink = b;
            deque->leftblock = b;
            deque->leftindex = 62;
        }
        ...
        deque->leftindex--;
        deque->leftblock->data[deque->leftindex] = item;
        if (deque->maxlen != -1 && deque->len > deque->maxlen) { PyObject *rv = deque_pop(deque, ((void *)0)); (__builtin_expect(!(rv != ((void *)0) && deque->len <= deque->maxlen), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 389, "rv != NULL && deque->len <= deque->maxlen") : (void)0); do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0); };
    }
    do { if ( --((PyObject*)(it))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(it)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(it)))); } while (0);
    if (PyErr_Occurred())
        return ((void *)0);
...
static char extendleft_doc[] = "Extend the left side of the deque with elements from the iterable";
...
_deque_rotate(dequeobject *deque, Py_ssize_t n)
{
    ...
    (__builtin_expect(!(len > 1), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 427, "len > 1") : (void)0);
    (__builtin_expect(!(-halflen <= n && n <= halflen), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 428, "-halflen <= n && n <= halflen") : (void)0);

    deque->state++;
    while (n > 0) {
        if (deque->leftindex == 0) {
            block *b = newblock(((void *)0), deque->leftblock, len);
            if (b == ((void *)0))
                return -1;
            (__builtin_expect(!(deque->leftblock->leftlink == ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 436, "deque->leftblock->leftlink == NULL") : (void)0);
            deque->leftblock->leftlink = b;
            deque->leftblock = b;
            deque->leftindex = 62;
        }
        (__builtin_expect(!(deque->leftindex > 0), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 441, "deque->leftindex > 0") : (void)0);
        ...
        if (m > deque->leftindex)
            m = deque->leftindex;
        (__builtin_expect(!(m > 0 && m <= len), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 448, "m > 0 && m <= len") : (void)0);
        ((__builtin_object_size (&deque->leftblock->data[deque->leftindex - m], 0) != (size_t) -1) ? __builtin___memcpy_chk (&deque->leftblock->data[deque->leftindex - m], &deque->rightblock->data[deque->rightindex + 1 - m], m * sizeof(PyObject *), __builtin_object_size (&deque->leftblock->data[deque->leftindex - m], 0)) : __inline_memcpy_chk (&deque->leftblock->data[deque->leftindex - m], &deque->rightblock->data[deque->rightindex + 1 - m], m * sizeof(PyObject *)));
        ...
        if (deque->rightindex == -1) {
            ...
            (__builtin_expect(!(deque->rightblock != ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 458, "deque->rightblock != NULL") : (void)0);
            (__builtin_expect(!(deque->leftblock != deque->rightblock), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 459, "deque->leftblock != deque->rightblock") : (void)0);
            freeblock(deque->rightblock);
            prevblock->rightlink = ((void *)0);
            deque->rightblock = prevblock;
            deque->rightindex = 62 - 1;
    ...
    while (n < 0) {
        if (deque->rightindex == 62 - 1) {
            block *b = newblock(deque->rightblock, ((void *)0), len);
            if (b == ((void *)0))
                return -1;
            (__builtin_expect(!(deque->rightblock->rightlink == ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 471, "deque->rightblock->rightlink == NULL") : (void)0);
            deque->rightblock->rightlink = b;
            deque->rightblock = b;
            deque->rightindex = -1;
        }
        (__builtin_expect(!(deque->rightindex < 62 - 1), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 476, "deque->rightindex < BLOCKLEN - 1") : (void)0);

        m = -n;
        if (m > 62 - deque->leftindex)
            m = 62 - deque->leftindex;
        if (m > 62 - 1 - deque->rightindex)
            m = 62 - 1 - deque->rightindex;
        (__builtin_expect(!(m > 0 && m <= len), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 483, "m > 0 && m <= len") : (void)0);
        ((__builtin_object_size (&deque->rightblock->data[deque->rightindex + 1], 0) != (size_t) -1) ? __builtin___memcpy_chk (&deque->rightblock->data[deque->rightindex + 1], &deque->leftblock->data[deque->leftindex], m * sizeof(PyObject *), __builtin_object_size (&deque->rightblock->data[deque->rightindex + 1], 0)) : __inline_memcpy_chk (&deque->rightblock->data[deque->rightindex + 1], &deque->leftblock->data[deque->leftindex], m * sizeof(PyObject *)));
        ...
        if (deque->leftindex == 62) {
            ...
            (__builtin_expect(!(deque->leftblock != deque->rightblock), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 493, "deque->leftblock != deque->rightblock") : (void)0);
            freeblock(deque->leftblock);
            (__builtin_expect(!(nextblock != ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 495, "nextblock != NULL") : (void)0);
            nextblock->leftlink = ((void *)0);
...
static char rotate_doc[] = "Rotate the deque n steps to the right (default n=1).  If n is negative, rotates left.";
...
deque_reverse(dequeobject *deque, PyObject *unused)
{
    ...
    for (i=0 ; i<n ; i++) {
        ...
        (__builtin_expect(!(leftblock != rightblock || leftindex < rightindex), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 532, "leftblock != rightblock || leftindex < rightindex") : (void)0);
...
static char reverse_doc[] = "D.reverse() -- reverse *IN PLACE*";
...
deque_count(dequeobject *deque, PyObject *v)
{
    ...
    for (i=0 ; i<n ; i++) {
        ...
        cmp = PyObject_RichCompareBool(item, v, 2);
        if (cmp > 0)
            count++;
        else if (cmp < 0)
            return ((void *)0);
...
static char count_doc[] = "D.count(value) -> integer -- return number of occurrences of value";
...
deque_remove(dequeobject *deque, PyObject *value)
{
    ...
    for (i=0 ; i<n ; i++) {
        ...
        int cmp = PyObject_RichCompareBool(item, value, 2);
        ...
        if (cmp > 0) {
            PyObject *tgt = deque_popleft(deque, ((void *)0));
            (__builtin_expect(!(tgt != ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 626, "tgt != NULL") : (void)0);
            do { if ( --((PyObject*)(tgt))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tgt)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tgt)))); } while (0);
...
static char remove_doc[] = "D.remove(value) -- remove first occurrence of value.";
...
deque_clear(dequeobject *deque)
{
    ...
    while (deque->len) {
        item = deque_pop(deque, ((void *)0));
        (__builtin_expect(!(item != ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 652, "item != NULL") : (void)0);
        do { if ( --((PyObject*)(item))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(item)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(item)))); } while (0);
    }
    (__builtin_expect(!(deque->leftblock == deque->rightblock && deque->leftindex - 1 == deque->rightindex && deque->len == 0), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 657, "deque->leftblock == deque->rightblock && deque->leftindex - 1 == deque->rightindex && deque->len == 0") : (void)0);
...
deque_item(dequeobject *deque, Py_ssize_t i)
{
    ...
    if (i == 0) {
        ...
        if (index < (deque->len >> 1)) {
            ...
            n = (deque->leftindex + deque->len - 1) / 62 - n;
            b = deque->rightblock;
            while (n--)
                b = b->leftlink;
        }
...
# 706 "_collectionsmodule.c"
static int
deque_del_item(dequeobject *deque, Py_ssize_t i)
{
    PyObject *item;

    (__builtin_expect(!(i >= 0 && i < deque->len), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 711, "i >= 0 && i < deque->len") : (void)0);
    if (_deque_rotate(deque, -i) == -1)
        return -1;

    item = deque_popleft(deque, ((void *)0));
    (__builtin_expect(!(item != ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 716, "item != NULL") : (void)0);
    do { if ( --((PyObject*)(item))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(item)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(item)))); } while (0);
...
static char clear_doc[] = "Remove all elements from the deque.";

static void
deque_dealloc(dequeobject *deque)
{
    PyObject_GC_UnTrack(deque);
    if (deque->weakreflist != ((void *)0))
        PyObject_ClearWeakRefs((PyObject *) deque);
    if (deque->leftblock != ((void *)0)) {
        deque_clear(deque);
        (__builtin_expect(!(deque->leftblock != ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 774, "deque->leftblock != NULL") : (void)0);
        freeblock(deque->leftblock);
    }
    deque->leftblock = ((void *)0);
    deque->rightblock = ((void *)0);
    (((PyObject*)(deque))->ob_type)->tp_free(deque);
}
...
deque_traverse(dequeobject *deque, visitproc visit, void *arg)
{
    ...
    for (b = deque->leftblock; b != ((void *)0); b = b->rightlink) {
        ...
        for (index = indexlo; index <= indexhi; ++index) {
            item = b->data[index];
            do { if (item) { int vret = visit((PyObject *)(item), arg); if (vret) return vret; } } while (0);
        }
        indexlo = 0;
    }
    return 0;
...
deque_copy(PyObject *deque)
{
    if (((dequeobject *)deque)->maxlen == -1)
        return PyObject_CallFunction((PyObject *)((((PyObject*)(deque))->ob_type)), "O", deque, ((void *)0));
    else
        return PyObject_CallFunction((PyObject *)((((PyObject*)(deque))->ob_type)), "Oi",
            deque, ((dequeobject *)deque)->maxlen, ((void *)0));
}

static char copy_doc[] = "Return a shallow copy of a deque.";
...
deque_reduce(dequeobject *deque)
{
    ...
    if (dict == ((void *)0)) {
        if (deque->maxlen == -1)
            result = Py_BuildValue("O(O)", (((PyObject*)(deque))->ob_type), aslist);
        else
            result = Py_BuildValue("O(On)", (((PyObject*)(deque))->ob_type), aslist, deque->maxlen);
    } else {
        if (deque->maxlen == -1)
            result = Py_BuildValue("O(OO)O", (((PyObject*)(deque))->ob_type), aslist, (&_Py_NoneStruct), dict);
        else
            result = Py_BuildValue("O(On)O", (((PyObject*)(deque))->ob_type), aslist, deque->maxlen, dict);
    }
    do { if ((dict) == ((void *)0)) ; else do { if ( --((PyObject*)(dict))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(dict)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(dict)))); } while (0); } while (0);
    do { if ( --((PyObject*)(aslist))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(aslist)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(aslist)))); } while (0);
    return result;
}
...
{
    PyObject *it1=((void *)0), *it2=((void *)0), *x, *y;
    Py_ssize_t vs, ws;
    int b, cmp=-1;

    if (!((((PyObject*)(v))->ob_type) == (&deque_type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&deque_type))) ||
        !((((PyObject*)(w))->ob_type) == (&deque_type) || PyType_IsSubtype((((PyObject*)(w))->ob_type), (&deque_type)))) {
    ...
    for (;;) {
        ...
        if (x == ((void *)0) || y == ((void *)0))
            break;
        b = PyObject_RichCompareBool(x, y, 2);
        if (b == 0) {
            cmp = PyObject_RichCompareBool(x, y, op);
            do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0);
            do { if ( --((PyObject*)(y))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(y)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(y)))); } while (0);
            goto done;
        }
        do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0);
        do { if ( --((PyObject*)(y))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(y)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(y)))); } while (0);
    ...
    if (PyErr_Occurred())
        goto done;
    switch (op) {
    case 0: cmp = y != ((void *)0); break;
    case 1: cmp = x == ((void *)0); break;
    case 2: cmp = x == y; break;
    case 3: cmp = x != y; break;
    case 4: cmp = x != ((void *)0); break;
    case 5: cmp = y == ((void *)0); break;
    }

done:
    do { if ((it1) == ((void *)0)) ; else do { if ( --((PyObject*)(it1))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(it1)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(it1)))); } while (0); } while (0);
    do { if ((it2) == ((void *)0)) ; else do { if ( --((PyObject*)(it2))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(it2)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(it2)))); } while (0); } while (0);
    if (cmp == 1)
        return ( ((PyObject*)(((PyObject *) &_Py_TrueStruct)))->ob_refcnt++), ((PyObject *) &_Py_TrueStruct);
    if (cmp == 0)
        return ( ((PyObject*)(((PyObject *) &_Py_FalseStruct)))->ob_refcnt++), ((PyObject *) &_Py_FalseStruct);
...
deque_sizeof(dequeobject *deque, void *unused)
{
    ...
    blocks = (deque->leftindex + deque->len + 62 - 1) / 62;
    (__builtin_expect(!(deque->leftindex + deque->len - 1 == (blocks - 1) * 62 + deque->rightindex), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 994, "deque->leftindex + deque->len - 1 == (blocks - 1) * BLOCKLEN + deque->rightindex") : (void)0);

    res += blocks * sizeof(block);
    return PyLong_FromSsize_t(res);
}

static char sizeof_doc[] = "D.__sizeof__() -- size of D in memory, in bytes";
...
static PyGetSetDef deque_getset[] = {
    {"maxlen", (getter)deque_get_maxlen, (setter)((void *)0),
...
static PySequenceMethods deque_as_sequence = {
    ...
    0,
    0,
    (ssizeargfunc)deque_item,
    0,
    (ssizeobjargproc)deque_ass_item,
    0,
    0,
    (binaryfunc)deque_inplace_concat,
    0,
...
static char reversed_doc[] = "D.__reversed__() -- return a reverse iterator over the deque";
...
static PyTypeObject deque_type = {
    ...
    deque_doc,
    (traverseproc)deque_traverse,
    (inquiry)deque_clear,
    (richcmpfunc)deque_richcompare,
    __builtin_offsetof (dequeobject, weakreflist),
    (getiterfunc)deque_iter,
    0,
    deque_methods,
    0,
    deque_getset,
...
deque_iter(dequeobject *deque)
{
    ...
    it = ( (dequeiterobject *) _PyObject_GC_New(&dequeiter_type) );
    if (it == ((void *)0))
        return ((void *)0);
...
{
    do { if (dio->deque) { int vret = visit((PyObject *)(dio->deque), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
{
    do { if ((dio->deque) == ((void *)0)) ; else do { if ( --((PyObject*)(dio->deque))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(dio->deque)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(dio->deque)))); } while (0); } while (0);
    PyObject_GC_Del(dio);
}
...
dequeiter_next(dequeiterobject *it)
{
    ...
    if (it->counter == 0)
        return ((void *)0);
    (__builtin_expect(!(!(it->b == it->deque->rightblock && it->index > it->deque->rightindex)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 1179, "!(it->b == it->deque->rightblock && it->index > it->deque->rightindex)") : (void)0);


    item = it->b->data[it->index];
    it->index++;
    it->counter--;
    if (it->index == 62 && it->counter > 0) {
        (__builtin_expect(!(it->b->rightlink != ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 1185, "it->b->rightlink != NULL") : (void)0);
        it->b = it->b->rightlink;
        it->index = 0;
    }
    ( ((PyObject*)(item))->ob_refcnt++);
...
dequeiter_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    if (!PyArg_ParseTuple(args, "O!|n", &deque_type, &deque, &index))
        return ((void *)0);
    (__builtin_expect(!(type == &dequeiter_type), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 1201, "type == &dequeiter_type") : (void)0);
...
{
    return Py_BuildValue("O(On)", (((PyObject*)(it))->ob_type), it->deque, it->deque->len - it->counter);
}

static PyMethodDef dequeiter_methods[] = {
    {"__length_hint__", (PyCFunction)dequeiter_len, 0x0004, length_hint_doc},
    {"__reduce__", (PyCFunction)dequeiter_reduce, 0x0004, reduce_doc},
    {((void *)0), ((void *)0)}
};
...
static PyTypeObject dequeiter_type = {
    ...
    ( 0 | (1L<<18) | 0) | (1L<<14),
    0,
    (traverseproc)dequeiter_traverse,
    0,
    0,
    0,
    PyObject_SelfIter,
    (iternextfunc)dequeiter_next,
    dequeiter_methods,
    0,
    0,
    0,
...
deque_reviter(dequeobject *deque)
{
    ...
    it = ( (dequeiterobject *) _PyObject_GC_New(&dequereviter_type) );
    if (it == ((void *)0))
        return ((void *)0);
...
dequereviter_next(dequeiterobject *it)
{
    ...
    (__builtin_expect(!(!(it->b == it->deque->leftblock && it->index < it->deque->leftindex)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 1321, "!(it->b == it->deque->leftblock && it->index < it->deque->leftindex)") : (void)0);
    ...
    if (it->index == -1 && it->counter > 0) {
        (__builtin_expect(!(it->b->leftlink != ((void *)0)), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 1327, "it->b->leftlink != NULL") : (void)0);
        it->b = it->b->leftlink;
        it->index = 62 - 1;
    }
    ( ((PyObject*)(item))->ob_refcnt++);
...
dequereviter_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    if (!PyArg_ParseTuple(args, "O!|n", &deque_type, &deque, &index))
        return ((void *)0);
    (__builtin_expect(!(type == &dequereviter_type), 0) ? __assert_rtn(__func__, "_collectionsmodule.c", 1343, "type == &dequereviter_type") : (void)0);
...
static PyTypeObject dequereviter_type = {
    ...
    0,
    PyObject_SelfIter,
    (iternextfunc)dequereviter_next,
    dequeiter_methods,
    0,
    0,
    0,
...
defdict_missing(defdictobject *dd, PyObject *key)
{
    ...
    PyObject *value;
    if (factory == ((void *)0) || factory == (&_Py_NoneStruct)) {

        PyObject *tup;
        tup = PyTuple_Pack(1, key);
        if (!tup) return ((void *)0);
        PyErr_SetObject(PyExc_KeyError, tup);
        do { if ( --((PyObject*)(tup))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tup)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tup)))); } while (0);
        return ((void *)0);
    }
    value = PyEval_CallObjectWithKeywords(factory, ((void *)0), (PyObject *)((void *)0));
    if (value == ((void *)0))
        return value;
...
static char defdict_copy_doc[] = "D.copy() -> a shallow copy of D.";
...
defdict_copy(defdictobject *dd)
{
    ...
    if (dd->default_factory == ((void *)0))
        return PyObject_CallFunctionObjArgs((PyObject*)(((PyObject*)(dd))->ob_type), (&_Py_NoneStruct), dd, ((void *)0));
    return PyObject_CallFunctionObjArgs((PyObject*)(((PyObject*)(dd))->ob_type),
                                        dd->default_factory, dd, ((void *)0));
}

static PyObject *
defdict_reduce(defdictobject *dd)
{
# 1488 "_collectionsmodule.c"
    PyObject *args;
    PyObject *items;
    PyObject *iter;
    PyObject *result;
    ...
    if (dd->default_factory == ((void *)0) || dd->default_factory == (&_Py_NoneStruct))
        args = PyTuple_New(0);
    else
    ...
    result = PyTuple_Pack(5, (((PyObject*)(dd))->ob_type), args,
                          (&_Py_NoneStruct), (&_Py_NoneStruct), iter);
...
static PyMethodDef defdict_methods[] = {
    {"__missing__", (PyCFunction)defdict_missing, 0x0008,
     defdict_missing_doc},
    {"copy", (PyCFunction)defdict_copy, 0x0004,
     defdict_copy_doc},
    {"__copy__", (PyCFunction)defdict_copy, 0x0004,
     defdict_copy_doc},
    {"__reduce__", (PyCFunction)defdict_reduce, 0x0004,
     reduce_doc},
    {((void *)0)}
};
...
static PyMemberDef defdict_members[] = {
    {"default_factory", 6,
     __builtin_offsetof (defdictobject, default_factory), 0,
...
{
    do { if (dd->default_factory) { PyObject *_py_tmp = (PyObject *)(dd->default_factory); (dd->default_factory) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
...
defdict_repr(defdictobject *dd)
{
    ...
    else
    {
        ...
        if (status != 0) {
            if (status < 0) {
                do { if ( --((PyObject*)(baserepr))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(baserepr)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(baserepr)))); } while (0);
                return ((void *)0);
            }
    ...
    result = PyUnicode_FromFormat("defaultdict(%U, %U)",
                                  defrepr, baserepr);
    do { if ( --((PyObject*)(defrepr))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(defrepr)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(defrepr)))); } while (0);
    do { if ( --((PyObject*)(baserepr))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(baserepr)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(baserepr)))); } while (0);
    return result;
}
...
{
    do { if (((defdictobject *)self)->default_factory) { int vret = visit((PyObject *)(((defdictobject *)self)->default_factory), arg); if (vret) return vret; } } while (0);
...
defdict_init(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *newdefault = ((void *)0);
    PyObject *newargs;
    int result;
    if (args == ((void *)0) || !((((((PyObject*)(args))->ob_type))->tp_flags & ((1L<<26))) != 0))
        newargs = PyTuple_New(0);
    else {
        Py_ssize_t n = (((PyVarObject*)(args))->ob_size);
        if (n > 0) {
            newdefault = (((PyTupleObject *)(args))->ob_item[0]);
            if (!PyCallable_Check(newdefault) && newdefault != (&_Py_NoneStruct)) {
    ...
    if (newargs == ((void *)0))
        return -1;
    do { if ((newdefault) == ((void *)0)) ; else ( ((PyObject*)(newdefault))->ob_refcnt++); } while (0);
    ...
    do { if ((olddefault) == ((void *)0)) ; else do { if ( --((PyObject*)(olddefault))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(olddefault)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(olddefault)))); } while (0); } while (0);
    return result;
}

static char defdict_doc[] = "defaultdict(default_factory) --> dict with default factory\n\nThe default factory is called without arguments to produce\na new value when a key is not present, in __getitem__ only.\nA defaultdict compares equal to a dict with the same items.\n";
# 1638 "_collectionsmodule.c"
static PyTypeObject defdict_type = {
    { { 1, 0 }, 0 },
    "collections.defaultdict",
    sizeof(defdictobject),
    0,

    (destructor)defdict_dealloc,
    0,
    0,
    0,
    0,
    (reprfunc)defdict_repr,
    0,
    0,
    0,
    0,
...
_count_elements(PyObject *self, PyObject *args)
{
    ...
    if (((((PyObject*)(mapping))->ob_type) == &PyDict_Type)) {
        while (1) {
            key = PyIter_Next(it);
            if (key == ((void *)0))
                break;
            ...
            if (oldval == ((void *)0)) {
                ...
                if (PyDict_SetItem(mapping, key, newval) == -1)
                    break;
                do { if (newval) { PyObject *_py_tmp = (PyObject *)(newval); (newval) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
            }
        ...
        while (1) {
            ...
            if (oldval == ((void *)0)) {
                if (!PyErr_Occurred() || !PyErr_ExceptionMatches(PyExc_KeyError))
                    break;
                PyErr_Clear();
                ( ((PyObject*)(one))->ob_refcnt++);
                newval = one;
            } else {
                newval = PyNumber_Add(oldval, one);
                do { if ( --((PyObject*)(oldval))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(oldval)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(oldval)))); } while (0);
                if (newval == ((void *)0))
                    break;
            }
    ...
    do { if ((newval) == ((void *)0)) ; else do { if ( --((PyObject*)(newval))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(newval)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(newval)))); } while (0); } while (0);
...
static struct PyMethodDef module_functions[] = {
    {"_count_elements", _count_elements, 0x0001, _count_elements_doc},
    {((void *)0), ((void *)0)}
};
...
PyInit__collections(void)
{
    ...
    m = PyModule_Create2(&_collectionsmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);

    if (PyType_Ready(&deque_type) < 0)
        return ((void *)0);
    ( ((PyObject*)(&deque_type))->ob_refcnt++);
    PyModule_AddObject(m, "deque", (PyObject *)&deque_type);

    defdict_type.tp_base = &PyDict_Type;
    if (PyType_Ready(&defdict_type) < 0)
        return ((void *)0);
    ( ((PyObject*)(&defdict_type))->ob_refcnt++);
    PyModule_AddObject(m, "defaultdict", (PyObject *)&defdict_type);

    if (PyType_Ready(&dequeiter_type) < 0)
        return ((void *)0);
    ( ((PyObject*)(&dequeiter_type))->ob_refcnt++);
    PyModule_AddObject(m, "_deque_iterator", (PyObject *)&dequeiter_type);

    if (PyType_Ready(&dequereviter_type) < 0)
        return ((void *)0);
    ( ((PyObject*)(&dequereviter_type))->ob_refcnt++);
