...
# 66 "/usr/include/rpc/rpc.h" 3 4
# 1 "/usr/include/rpc/types.h" 1 3 4
# 95 "/usr/include/rpc/types.h" 3 4
typedef int rpc_int;
typedef unsigned int rpc_uint;
# 67 "/usr/include/rpc/rpc.h" 2 3 4
# 1 "/usr/include/netinet/in.h" 1 3 4
# 87 "/usr/include/netinet/in.h" 3 4
...
# 68 "/usr/include/rpc/rpc.h" 2 3 4


# 1 "/usr/include/rpc/xdr.h" 1 3 4
# 102 "/usr/include/rpc/xdr.h" 3 4
enum xdr_op {
 XDR_ENCODE=0,
 XDR_DECODE=1,
 XDR_FREE=2
};
# 121 "/usr/include/rpc/xdr.h" 3 4
typedef struct __rpc_xdr {
 enum xdr_op x_op;
 const struct xdr_ops {


  int (*x_getlong)(struct __rpc_xdr *, int *);

  int (*x_putlong)(struct __rpc_xdr *, const int *);
  ...
  int (*x_getbytes)(struct __rpc_xdr *, char *, unsigned int);

  int (*x_putbytes)(struct __rpc_xdr *, const char *, unsigned int);

  unsigned int (*x_getpostn)(struct __rpc_xdr *);

  int (*x_setpostn)(struct __rpc_xdr *, unsigned int);
...
# 169 "/usr/include/rpc/xdr.h" 3 4
typedef int (*xdrproc_t)(XDR *, ...);
# 193 "/usr/include/rpc/xdr.h" 3 4
static __inline int
...
# 295 "/usr/include/rpc/xdr.h" 3 4
struct xdr_discrim {
 int value;
 xdrproc_t proc;
};
# 347 "/usr/include/rpc/xdr.h" 3 4

extern int xdr_void(void);
extern int xdr_int(XDR *, int *);
extern int xdr_u_int(XDR *, unsigned int *);

extern int xdr_long(XDR *, int *);
extern int xdr_u_long(XDR *, unsigned int *);
...
extern int xdr_int16_t(XDR *, int16_t *);
extern int xdr_u_int16_t(XDR *, u_int16_t *);
extern int xdr_int32_t(XDR *, int32_t *);
extern int xdr_u_int32_t(XDR *, u_int32_t *);
extern int xdr_int64_t(XDR *, int64_t *);
extern int xdr_u_int64_t(XDR *, u_int64_t *);
extern int xdr_bool(XDR *, int *);
extern int xdr_enum(XDR *, int *);
extern int xdr_array(XDR *, char **, unsigned int *, unsigned int, unsigned int, xdrproc_t);
extern int xdr_bytes(XDR *, char **, unsigned int *, unsigned int);
extern int xdr_opaque(XDR *, char *, unsigned int);
extern int xdr_string(XDR *, char **, unsigned int);
extern int xdr_union(XDR *, int *, char *, const struct xdr_discrim *, xdrproc_t);
...
extern int xdr_quadruple(XDR *, long double *);
extern int xdr_reference(XDR *, char **, unsigned int, xdrproc_t);
extern int xdr_pointer(XDR *, char **, unsigned int, xdrproc_t);
extern int xdr_wrapstring(XDR *, char **);
extern void xdr_free(xdrproc_t, void *);
extern int xdr_hyper(XDR *, quad_t *);
extern int xdr_u_hyper(XDR *, u_quad_t *);
extern int xdr_longlong_t(XDR *, quad_t *);
extern int xdr_u_longlong_t(XDR *, u_quad_t *);
...
extern int xdr_netobj(XDR *, struct netobj *);
...
extern int xdrrec_skiprecord(XDR *);


extern int xdrrec_eof(XDR *);
extern unsigned int xdrrec_readbytes(XDR *, caddr_t, unsigned int);

# 71 "/usr/include/rpc/rpc.h" 2 3 4


# 1 "/usr/include/rpc/auth.h" 1 3 4
# 77 "/usr/include/rpc/auth.h" 3 4
enum auth_stat {
 AUTH_OK=0,
...
extern int xdr_des_block (XDR *, des_block *);
...
typedef struct {
 ...
 struct auth_ops {
# 139 "/usr/include/rpc/auth.h" 3 4
  void (*ah_nextverf)( );
  int (*ah_marshal)( );
  int (*ah_validate)( );
  int (*ah_refresh)( );
...
# 184 "/usr/include/rpc/auth.h" 3 4
extern struct opaque_auth _null_auth;
# 200 "/usr/include/rpc/auth.h" 3 4

extern AUTH *authunix_create (char *, int, int, int, int *);
extern AUTH *authunix_create_default (void);
extern AUTH *authnone_create (void);
extern AUTH *authdes_create (char *, unsigned int, struct sockaddr_in *, des_block *);



# 74 "/usr/include/rpc/rpc.h" 2 3 4


# 1 "/usr/include/rpc/clnt.h" 1 3 4
# 78 "/usr/include/rpc/clnt.h" 3 4
enum clnt_stat {
 RPC_SUCCESS=0,
...
struct CLIENT
{
 ...
 struct clnt_ops {
  ...
  enum clnt_stat (*cl_call)(CLIENT *, unsigned int, xdrproc_t, void *, xdrproc_t, void *, struct timeval);



  void (*cl_abort)(void);
  void (*cl_geterr)(CLIENT *, struct rpc_err *);
  int (*cl_freeres)(CLIENT *, xdrproc_t, void *);
  void (*cl_destroy)(CLIENT *);
  int (*cl_control)(CLIENT *, int, char *);
 } *cl_ops;
 caddr_t cl_private;
};
# 297 "/usr/include/rpc/clnt.h" 3 4


extern CLIENT *clntraw_create (unsigned int, unsigned int);




# 315 "/usr/include/rpc/clnt.h" 3 4


extern CLIENT *clnt_create (char *, unsigned int, unsigned int, char *);




# 335 "/usr/include/rpc/clnt.h" 3 4


extern CLIENT *clnttcp_create (struct sockaddr_in *, unsigned int, unsigned int, int *, unsigned int, unsigned int);
# 351 "/usr/include/rpc/clnt.h" 3 4

# 375 "/usr/include/rpc/clnt.h" 3 4


extern CLIENT *clntudp_create (struct sockaddr_in *, unsigned int, unsigned int, struct timeval, int *);




extern CLIENT *clntudp_bufcreate (struct sockaddr_in *, unsigned int, unsigned int, struct timeval, int *, unsigned int, unsigned int);
# 403 "/usr/include/rpc/clnt.h" 3 4
...
# 77 "/usr/include/rpc/rpc.h" 2 3 4


# 1 "/usr/include/rpc/rpc_msg.h" 1 3 4
# 80 "/usr/include/rpc/rpc_msg.h" 3 4
enum msg_type {
 CALL=0,
 REPLY=1
};
...
# 113 "/usr/include/rpc/rpc_msg.h" 3 4
...
extern int xdr_callmsg (XDR *, struct rpc_msg *);
...
extern int xdr_callhdr (XDR *, struct rpc_msg *);
...
extern int xdr_replymsg (XDR *, struct rpc_msg *);
...
# 80 "/usr/include/rpc/rpc.h" 2 3 4
# 1 "/usr/include/rpc/auth_unix.h" 1 3 4
# 80 "/usr/include/rpc/auth_unix.h" 3 4
...
extern int xdr_authunix_parms (XDR *, struct authunix_parms *);
...
# 81 "/usr/include/rpc/rpc.h" 2 3 4
...
# 173 "/usr/include/rpc/svc.h" 3 4
struct svc_req {

 unsigned int rq_prog;
 unsigned int rq_vers;
 unsigned int rq_proc;
...
extern int svc_register (SVCXPRT *, unsigned int, unsigned int, void (*)(), int);




# 214 "/usr/include/rpc/svc.h" 3 4


extern void svc_unregister (unsigned int, unsigned int);
...
# 271 "/usr/include/rpc/svc.h" 3 4

extern int svc_sendreply (SVCXPRT *, xdrproc_t, char *);
extern void svcerr_decode (SVCXPRT *);
extern void svcerr_weakauth (SVCXPRT *);
extern void svcerr_noproc (SVCXPRT *);

extern void svcerr_progvers (SVCXPRT *, unsigned int, unsigned int);
...
# 302 "/usr/include/rpc/svc.h" 3 4
extern fd_set svc_fdset;
# 312 "/usr/include/rpc/svc.h" 3 4
...
# 89 "/usr/include/rpc/rpc.h" 2 3 4
# 1 "/usr/include/rpc/svc_auth.h" 1 3 4
# 69 "/usr/include/rpc/svc_auth.h" 3 4

extern enum auth_stat _authenticate (struct svc_req *, struct rpc_msg *);

# 90 "/usr/include/rpc/rpc.h" 2 3 4
...
# 92 "/usr/include/rpc/rpc.h" 2 3 4
# 18 "nismodule.c" 2
# 1 "/usr/include/rpcsvc/yp_prot.h" 1 3 4
# 88 "/usr/include/rpcsvc/yp_prot.h" 3 4
typedef struct {
 char *dptr;
 int dsize;
} datum;
...
# 201 "/usr/include/rpcsvc/yp_prot.h" 3 4
struct dom_binding {
 struct dom_binding *dom_pnext;
 char dom_domain[((u_long)64) + 1];
...
# 236 "/usr/include/rpcsvc/yp_prot.h" 3 4
...
# 263 "/usr/include/rpcsvc/yp_prot.h" 3 4
struct ypbind_setdom {
 char ypsetdom_domain[((u_long)64) + 1];
 struct ypbind_binding ypsetdom_binding;
 u_int ypsetdom_vers;
};
# 290 "/usr/include/rpcsvc/yp_prot.h" 3 4
struct yppushresp_xfr {
 u_int transid;
 u_int status;
};
# 313 "/usr/include/rpcsvc/yp_prot.h" 3 4

int xdr_domainname (XDR *, char *);
int xdr_peername (XDR *, char *);
int xdr_datum (XDR *, datum *);
int xdr_mapname (XDR *, char *);
int xdr_ypreq_key (XDR *, struct ypreq_key *);
int xdr_ypreq_nokey (XDR *, struct ypreq_nokey *);
int xdr_yp_inaddr (XDR *, struct in_addr *);
int xdr_ypbind_binding (XDR *, struct ypbind_binding *);
int xdr_ypbind_resptype (XDR *, enum ypbind_resptype *);
int xdr_ypstat (XDR *, enum ypbind_resptype *);
int xdr_ypbind_resp (XDR *, struct ypbind_resp *);
int xdr_ypresp_val (XDR *, struct ypresp_val *);
int xdr_ypbind_setdom (XDR *, struct ypbind_setdom *);
int xdr_ypresp_key_val (XDR *, struct ypresp_key_val *);
int xdr_ypresp_all (XDR *, struct ypresp_all *);
int xdr_ypresp_all_seq (XDR *, unsigned long *);
int xdr_ypresp_master (XDR *, struct ypresp_master *);
int xdr_ypmaplist_str (XDR *, char *);
int xdr_ypmaplist (XDR *, struct ypmaplist *);
int xdr_ypresp_maplist (XDR *, struct ypresp_maplist *);
int xdr_ypresp_order (XDR *, struct ypresp_order *);

# 19 "nismodule.c" 2
# 1 "/usr/include/rpcsvc/ypclnt.h" 1 3 4
# 85 "/usr/include/rpcsvc/ypclnt.h" 3 4
...
nis_match (PyObject *self, PyObject *args, PyObject *kwdict)
{
    ...
    int fix;
    static char *kwlist[] = {"key", "map", "domain", ((void *)0)};

    if (!PyArg_ParseTupleAndKeywords(args, kwdict,
                                     "Us|s:match", kwlist,
                                     &ukey, &map, &domain))
        return ((void *)0);
    if ((bkey = PyUnicode_EncodeFSDefault(ukey)) == ((void *)0))
        return ((void *)0);
    if (PyBytes_AsStringAndSize(bkey, &key, &keylen) == -1) {
        do { if ( --((PyObject*)(bkey))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(bkey)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(bkey)))); } while (0);
        return ((void *)0);
    }
...
nis_cat (PyObject *self, PyObject *args, PyObject *kwdict)
{
    ...
    PyObject *dict;
    int err;
    static char *kwlist[] = {"map", "domain", ((void *)0)};
...
{
    if (!xdr_string(xdrs, objp, ((u_long)64))) {
        return ((0));
    }
    return ((1));
}
...
nisproc_maplist_2(domainname *argp, CLIENT *clnt)
{
    ...
    ((__builtin_object_size (&res, 0) != (size_t) -1) ? __builtin___memset_chk (&res, 0, sizeof(res), __builtin_object_size (&res, 0)) : __inline_memset_chk (&res, 0, sizeof(res)));
    if (((*(clnt)->cl_ops->cl_call)(clnt, ((u_long)11), (xdrproc_t)nis_xdr_domainname, (caddr_t)argp, (xdrproc_t)nis_xdr_ypresp_maplist, (caddr_t)&res, TIMEOUT)) != RPC_SUCCESS)
...
nis_maplist (char *dom)
{
    ...
    cl = clnt_create(server, ((u_long)100004), ((u_long)2), "tcp");
    if (cl == ((void *)0)) {
...
nis_maps (PyObject *self, PyObject *args, PyObject *kwdict)
{
    ...
    PyObject *list;
    int err;
    static char *kwlist[] = {"domain", ((void *)0)};
    ...
    if ((maps = nis_maplist (domain)) == ((void *)0))
        return ((void *)0);
...
{
    PyObject *m, *d;
    m = PyModule_Create2(&nismodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    d = PyModule_GetDict(m);
    NisError = PyErr_NewException("nis.error", ((void *)0), ((void *)0));
    if (NisError != ((void *)0))
