...
{
    PyObject *m, *d, *de;
    m = PyModule_Create2(&errnomodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    ...
    if (!d || !de || PyDict_SetItemString(d, "errorcode", de) < 0)
        return ((void *)0);
# 119 "errnomodule.c"
    _inscode(d, de, "ENODEV", 19);





    _inscode(d, de, "EHOSTUNREACH", 65);
    ...
    _inscode(d, de, "ENOMSG", 91);
# 144 "errnomodule.c"
    _inscode(d, de, "ENODATA", 96);


    _inscode(d, de, "ENOTBLK", 15);


    _inscode(d, de, "ENOSYS", 78);


    _inscode(d, de, "EPIPE", 32);


    _inscode(d, de, "EINVAL", 22);
    ...
    _inscode(d, de, "EOVERFLOW", 84);





    _inscode(d, de, "EINTR", 4);
    ...
    _inscode(d, de, "EPROTO", 100);


    _inscode(d, de, "EREMOTE", 71);
# 210 "errnomodule.c"
    _inscode(d, de, "ECHILD", 10);


    _inscode(d, de, "ELOOP", 62);
    ...
    _inscode(d, de, "EXDEV", 18);


    _inscode(d, de, "E2BIG", 7);


    _inscode(d, de, "ESRCH", 3);


    _inscode(d, de, "EMSGSIZE", 40);
    ...
    _inscode(d, de, "EAFNOSUPPORT", 47);
# 246 "errnomodule.c"
    _inscode(d, de, "EHOSTDOWN", 64);
    ...
    _inscode(d, de, "EBUSY", 16);


    _inscode(d, de, "EWOULDBLOCK", 35);
# 283 "errnomodule.c"
    _inscode(d, de, "EISCONN", 56);
# 293 "errnomodule.c"
    _inscode(d, de, "ESHUTDOWN", 58);
# 312 "errnomodule.c"
    _inscode(d, de, "EBADF", 9);
    ...
    _inscode(d, de, "ENOSPC", 28);


    _inscode(d, de, "ENOEXEC", 8);


    _inscode(d, de, "EALREADY", 37);
    ...
    _inscode(d, de, "ENETDOWN", 50);
# 358 "errnomodule.c"
    _inscode(d, de, "EACCES", 13);
# 368 "errnomodule.c"
    _inscode(d, de, "EILSEQ", 92);


    _inscode(d, de, "ENOTDIR", 20);





    _inscode(d, de, "EPERM", 1);


    _inscode(d, de, "EDOM", 33);





    _inscode(d, de, "ECONNREFUSED", 61);
    ...
    _inscode(d, de, "EISDIR", 21);


    _inscode(d, de, "EPROTONOSUPPORT", 43);
    ...
    _inscode(d, de, "EROFS", 30);


    _inscode(d, de, "EADDRNOTAVAIL", 49);
    ...
    _inscode(d, de, "EIDRM", 90);
# 428 "errnomodule.c"
    _inscode(d, de, "EBADMSG", 94);


    _inscode(d, de, "ENFILE", 23);





    _inscode(d, de, "ESPIPE", 29);


    _inscode(d, de, "ENOLINK", 97);


    _inscode(d, de, "ENETRESET", 52);
    ...
    _inscode(d, de, "ENOENT", 2);


    _inscode(d, de, "EEXIST", 17);


    _inscode(d, de, "EDQUOT", 69);
    ...
    _inscode(d, de, "ENOSTR", 99);
# 482 "errnomodule.c"
    _inscode(d, de, "EFAULT", 14);
    ...
    _inscode(d, de, "EFBIG", 27);


    _inscode(d, de, "EDEADLK", 11);


    _inscode(d, de, "ENOTCONN", 57);
    ...
    _inscode(d, de, "EDESTADDRREQ", 39);
# 512 "errnomodule.c"
    _inscode(d, de, "ENOLCK", 77);





    _inscode(d, de, "ECONNABORTED", 53);
    ...
    _inscode(d, de, "ENOSR", 98);


    _inscode(d, de, "ENOMEM", 12);


    _inscode(d, de, "ENOTSOCK", 38);
# 555 "errnomodule.c"
    _inscode(d, de, "EMLINK", 31);


    _inscode(d, de, "ERANGE", 34);
# 567 "errnomodule.c"
    _inscode(d, de, "ECONNRESET", 54);
    ...
    _inscode(d, de, "EOPNOTSUPP", 102);
# 591 "errnomodule.c"
    _inscode(d, de, "EAGAIN", 35);


    _inscode(d, de, "ENAMETOOLONG", 63);
    ...
    _inscode(d, de, "ENOTTY", 25);





    _inscode(d, de, "ESOCKTNOSUPPORT", 44);
    ...
    _inscode(d, de, "ETIME", 101);
# 623 "errnomodule.c"
    _inscode(d, de, "ETOOMANYREFS", 59);
    ...
    _inscode(d, de, "ETXTBSY", 26);


    _inscode(d, de, "EINPROGRESS", 36);
    ...
    _inscode(d, de, "ENXIO", 6);
# 836 "errnomodule.c"
    _inscode(d, de, "ECANCELED", 89);
# 851 "errnomodule.c"
    _inscode(d, de, "EOWNERDEAD", 105);


    _inscode(d, de, "ENOTRECOVERABLE", 104);
    ...
    _inscode(d, de, "ENOTRECOVERABLE", 104);
# 882 "errnomodule.c"
    _inscode(d, de, "EAUTH", 80);


    _inscode(d, de, "EBADARCH", 86);


    _inscode(d, de, "EBADEXEC", 85);


    _inscode(d, de, "EBADMACHO", 88);


    _inscode(d, de, "EBADRPC", 72);


    _inscode(d, de, "EDEVERR", 83);


    _inscode(d, de, "EFTYPE", 79);


    _inscode(d, de, "ENEEDAUTH", 81);


    _inscode(d, de, "ENOATTR", 93);


    _inscode(d, de, "ENOPOLICY", 103);


    _inscode(d, de, "EPROCLIM", 67);


    _inscode(d, de, "EPROCUNAVAIL", 76);


    _inscode(d, de, "EPROGMISMATCH", 75);


    _inscode(d, de, "EPROGUNAVAIL", 74);


    _inscode(d, de, "EPWROFF", 82);


    _inscode(d, de, "ERPCMISMATCH", 73);


    _inscode(d, de, "ESHLIBVERS", 87);


    do { if ( --((PyObject*)(de))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(de)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(de)))); } while (0);
    return m;
}
