...
all_name_chars(PyObject *o)
{
    ...
    static unsigned char *name_chars = (unsigned char *)"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz";
    PyUnicodeObject *u = (PyUnicodeObject *)o;
    const unsigned char *s;

    if (!((((((PyObject*)(o))->ob_type))->tp_flags & ((1L<<28))) != 0) || ((__builtin_expect(!(((((((PyObject*)(u))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "codeobject.c", 18, "PyUnicode_Check(u)") : (void)0), ((((PyASCIIObject*)u)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(u)))) == -1 ||
        ((__builtin_expect(!((((PyASCIIObject*)u)->state.ready)), 0) ? __assert_rtn(__func__, "codeobject.c", 19, "PyUnicode_IS_READY(u)") : (void)0), (((__builtin_expect(!(((((((PyObject*)(u))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "codeobject.c", 19, "PyUnicode_Check(u)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)u)->state.ready)), 0) ? __assert_rtn(__func__, "codeobject.c", 19, "PyUnicode_IS_READY(u)") : (void)0), ((PyASCIIObject*)u)->state.ascii) ? (0x7f) : (((__builtin_expect(!(((((((PyObject*)(u))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "codeobject.c", 19, "PyUnicode_Check(u)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)u)->state.ready)), 0) ? __assert_rtn(__func__, "codeobject.c", 19, "PyUnicode_IS_READY(u)") : (void)0), ((PyASCIIObject *)(u))->state.kind) == PyUnicode_1BYTE_KIND ? (0xffU) : (((__builtin_expect(!(((((((PyObject*)(u))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "codeobject.c", 19, "PyUnicode_Check(u)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)u)->state.ready)), 0) ? __assert_rtn(__func__, "codeobject.c", 19, "PyUnicode_IS_READY(u)") : (void)0), ((PyASCIIObject *)(u))->state.kind) == PyUnicode_2BYTE_KIND ? (0xffffU) : (0x10ffffU))))) >= 128)
        return 0;
    ...
    s = ((Py_UCS1*)((__builtin_expect(!(((((((PyObject*)(u))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "codeobject.c", 27, "PyUnicode_Check(u)") : (void)0), (((PyASCIIObject*)(u))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)(u))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "codeobject.c", 27, "PyUnicode_Check(u)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)u)->state.ready)), 0) ? __assert_rtn(__func__, "codeobject.c", 27, "PyUnicode_IS_READY(u)") : (void)0), ((PyASCIIObject*)u)->state.ascii) ? ((void*)((PyASCIIObject*)(u) + 1)) : ((void*)((PyCompactUnicodeObject*)(u) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)(u))->data.any), 0) ? __assert_rtn(__func__, "codeobject.c", 27, "((PyUnicodeObject*)(u))->data.any") : (void)0), ((((PyUnicodeObject *)(u))->data.any)))));
    while (*s) {
        if (ok_name_char[*s++] == 0)
            return 0;
    }
...
intern_strings(PyObject *tuple)
{
    ...
    for (i = (((PyVarObject*)(tuple))->ob_size); --i >= 0; ) {
        PyObject *v = (((PyTupleObject *)(tuple))->ob_item[i]);
        if (v == ((void *)0) || !((((PyObject*)(v))->ob_type) == &PyUnicode_Type)) {
            Py_FatalError("non-string found in code slot");
        }
        PyUnicode_InternInPlace(&(((PyTupleObject *)(tuple))->ob_item[i]));
    }
}
...
{
    PyCodeObject *co;
    unsigned char *cell2arg = ((void *)0);
    Py_ssize_t i, n_cellvars;


    if (argcount < 0 || kwonlyargcount < 0 || nlocals < 0 ||
        code == ((void *)0) ||
        consts == ((void *)0) || !((((((PyObject*)(consts))->ob_type))->tp_flags & ((1L<<26))) != 0) ||
        names == ((void *)0) || !((((((PyObject*)(names))->ob_type))->tp_flags & ((1L<<26))) != 0) ||
        varnames == ((void *)0) || !((((((PyObject*)(varnames))->ob_type))->tp_flags & ((1L<<26))) != 0) ||
        freevars == ((void *)0) || !((((((PyObject*)(freevars))->ob_type))->tp_flags & ((1L<<26))) != 0) ||
        cellvars == ((void *)0) || !((((((PyObject*)(cellvars))->ob_type))->tp_flags & ((1L<<26))) != 0) ||
        name == ((void *)0) || !((((((PyObject*)(name))->ob_type))->tp_flags & ((1L<<28))) != 0) ||
        filename == ((void *)0) || !((((((PyObject*)(filename))->ob_type))->tp_flags & ((1L<<28))) != 0) ||
        lnotab == ((void *)0) || !((((((PyObject*)(lnotab))->ob_type))->tp_flags & ((1L<<27))) != 0) ||
        !PyObject_CheckReadBuffer(code)) {
        _PyErr_BadInternalCall("codeobject.c", 74);
        return ((void *)0);
    }
    n_cellvars = (((PyVarObject*)(cellvars))->ob_size);
    intern_strings(names);
    intern_strings(varnames);
    intern_strings(freevars);
    intern_strings(cellvars);

    for (i = (((PyVarObject*)(consts))->ob_size); --i >= 0; ) {
        PyObject *v = PyTuple_GetItem(consts, i);
        if (!all_name_chars(v))
            continue;
        PyUnicode_InternInPlace(&(((PyTupleObject *)(consts))->ob_item[i]));
    }

    if (n_cellvars) {
        Py_ssize_t total_args = argcount + kwonlyargcount +
            ((flags & 0x0004) != 0) + ((flags & 0x0008) != 0);
        Py_ssize_t alloc_size = sizeof(unsigned char) * n_cellvars;
        int used_cell2arg = 0;
        cell2arg = ((size_t)(alloc_size) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc((alloc_size) ? (alloc_size) : 1));
        if (cell2arg == ((void *)0))
            return ((void *)0);
        ((__builtin_object_size (cell2arg, 0) != (size_t) -1) ? __builtin___memset_chk (cell2arg, 255, alloc_size, __builtin_object_size (cell2arg, 0)) : __inline_memset_chk (cell2arg, 255, alloc_size));

        for (i = 0; i < n_cellvars; i++) {
            Py_ssize_t j;
            PyObject *cell = (((PyTupleObject *)(cellvars))->ob_item[i]);
            for (j = 0; j < total_args; j++) {
                PyObject *arg = (((PyTupleObject *)(varnames))->ob_item[j]);
    ...
    co = ( (PyCodeObject *) PyObject_Init( (PyObject *) PyObject_Malloc( ( (&PyCode_Type)->tp_basicsize ) ), (&PyCode_Type)) );
    if (co == ((void *)0)) {
        if (cell2arg)
            free(cell2arg);
        return ((void *)0);
    ...
    co->co_code = code;
    ( ((PyObject*)(consts))->ob_refcnt++);
    co->co_consts = consts;
    ( ((PyObject*)(names))->ob_refcnt++);
    co->co_names = names;
    ( ((PyObject*)(varnames))->ob_refcnt++);
    co->co_varnames = varnames;
    ( ((PyObject*)(freevars))->ob_refcnt++);
    co->co_freevars = freevars;
    ( ((PyObject*)(cellvars))->ob_refcnt++);
    ...
    ( ((PyObject*)(lnotab))->ob_refcnt++);
    co->co_lnotab = lnotab;
    co->co_zombieframe = ((void *)0);
    co->co_weakreflist = ((void *)0);
    return co;
}
...
PyCode_NewEmpty(const char *filename, const char *funcname, int firstlineno)
{
    static PyObject *emptystring = ((void *)0);
    static PyObject *nulltuple = ((void *)0);
    PyObject *filename_ob = ((void *)0);
    PyObject *funcname_ob = ((void *)0);
    PyCodeObject *result = ((void *)0);
    if (emptystring == ((void *)0)) {
    ...
    if (funcname_ob == ((void *)0))
        goto failed;
    filename_ob = PyUnicode_DecodeFSDefault(filename);
    if (filename_ob == ((void *)0))
        goto failed;
...
failed:
    do { if ((funcname_ob) == ((void *)0)) ; else do { if ( --((PyObject*)(funcname_ob))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(funcname_ob)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(funcname_ob)))); } while (0); } while (0);
    do { if ((filename_ob) == ((void *)0)) ; else do { if ( --((PyObject*)(filename_ob))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(filename_ob)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(filename_ob)))); } while (0); } while (0);
    return result;
}
...
static PyMemberDef code_memberlist[] = {
    {"co_argcount", 1, __builtin_offsetof (PyCodeObject, co_argcount), 1},
    {"co_kwonlyargcount", 1, __builtin_offsetof (PyCodeObject, co_kwonlyargcount), 1},
    {"co_nlocals", 1, __builtin_offsetof (PyCodeObject, co_nlocals), 1},
    {"co_stacksize",1, __builtin_offsetof (PyCodeObject, co_stacksize), 1},
    {"co_flags", 1, __builtin_offsetof (PyCodeObject, co_flags), 1},
    {"co_code", 6, __builtin_offsetof (PyCodeObject, co_code), 1},
    {"co_consts", 6, __builtin_offsetof (PyCodeObject, co_consts), 1},
    {"co_names", 6, __builtin_offsetof (PyCodeObject, co_names), 1},
    {"co_varnames", 6, __builtin_offsetof (PyCodeObject, co_varnames), 1},
    {"co_freevars", 6, __builtin_offsetof (PyCodeObject, co_freevars), 1},
    {"co_cellvars", 6, __builtin_offsetof (PyCodeObject, co_cellvars), 1},
    {"co_filename", 6, __builtin_offsetof (PyCodeObject, co_filename), 1},
    {"co_name", 6, __builtin_offsetof (PyCodeObject, co_name), 1},
    {"co_firstlineno", 1, __builtin_offsetof (PyCodeObject, co_firstlineno), 1},
    {"co_lnotab", 6, __builtin_offsetof (PyCodeObject, co_lnotab), 1},
    {((void *)0)}
};
...
validate_and_copy_tuple(PyObject *tup)
{
    ...
    len = (((PyVarObject*)(tup))->ob_size);
    newtuple = PyTuple_New(len);
    if (newtuple == ((void *)0))
        return ((void *)0);

    for (i = 0; i < len; i++) {
        item = (((PyTupleObject *)(tup))->ob_item[i]);
        if (((((PyObject*)(item))->ob_type) == &PyUnicode_Type)) {
            ( ((PyObject*)(item))->ob_refcnt++);
        }
        else if (!((((((PyObject*)(item))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
            PyErr_Format(
                PyExc_TypeError,
                "name tuples must contain only "
                "strings, not '%.500s'",
                item->ob_type->tp_name);
            do { if ( --((PyObject*)(newtuple))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(newtuple)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(newtuple)))); } while (0);
            return ((void *)0);
        }
        else {
        ...
        (((PyTupleObject *)(newtuple))->ob_item[i] = item);
    }

    return newtuple;
}

static char code_doc[] = "code(argcount, kwonlyargcount, nlocals, stacksize, flags, codestring,\n      constants, names, varnames, filename, name, firstlineno,\n      lnotab[, freevars[, cellvars]])\n\nCreate a code object.  Not for the faint of heart.";
...
code_new(PyTypeObject *type, PyObject *args, PyObject *kw)
{
    ...
    PyObject *code;
    PyObject *consts;
    PyObject *names, *ournames = ((void *)0);
    PyObject *varnames, *ourvarnames = ((void *)0);
    PyObject *freevars = ((void *)0), *ourfreevars = ((void *)0);
    PyObject *cellvars = ((void *)0), *ourcellvars = ((void *)0);
    PyObject *filename;
    PyObject *name;
    int firstlineno;
    PyObject *lnotab;
    ...
    if (ourvarnames == ((void *)0))
        goto cleanup;
    if (freevars)
        ourfreevars = validate_and_copy_tuple(freevars);
    else
        ourfreevars = PyTuple_New(0);
    if (ourfreevars == ((void *)0))
        goto cleanup;
    if (cellvars)
        ourcellvars = validate_and_copy_tuple(cellvars);
    else
        ourcellvars = PyTuple_New(0);
    if (ourcellvars == ((void *)0))
        goto cleanup;
  ...
  cleanup:
    do { if ((ournames) == ((void *)0)) ; else do { if ( --((PyObject*)(ournames))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ournames)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ournames)))); } while (0); } while (0);
    do { if ((ourvarnames) == ((void *)0)) ; else do { if ( --((PyObject*)(ourvarnames))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ourvarnames)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ourvarnames)))); } while (0); } while (0);
    do { if ((ourfreevars) == ((void *)0)) ; else do { if ( --((PyObject*)(ourfreevars))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ourfreevars)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ourfreevars)))); } while (0); } while (0);
    do { if ((ourcellvars) == ((void *)0)) ; else do { if ( --((PyObject*)(ourcellvars))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ourcellvars)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ourcellvars)))); } while (0); } while (0);
    return co;
}
...
{
    do { if ((co->co_code) == ((void *)0)) ; else do { if ( --((PyObject*)(co->co_code))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(co->co_code)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(co->co_code)))); } while (0); } while (0);
    do { if ((co->co_consts) == ((void *)0)) ; else do { if ( --((PyObject*)(co->co_consts))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(co->co_consts)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(co->co_consts)))); } while (0); } while (0);
    do { if ((co->co_names) == ((void *)0)) ; else do { if ( --((PyObject*)(co->co_names))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(co->co_names)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(co->co_names)))); } while (0); } while (0);
    do { if ((co->co_varnames) == ((void *)0)) ; else do { if ( --((PyObject*)(co->co_varnames))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(co->co_varnames)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(co->co_varnames)))); } while (0); } while (0);
    do { if ((co->co_freevars) == ((void *)0)) ; else do { if ( --((PyObject*)(co->co_freevars))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(co->co_freevars)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(co->co_freevars)))); } while (0); } while (0);
    do { if ((co->co_cellvars) == ((void *)0)) ; else do { if ( --((PyObject*)(co->co_cellvars))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(co->co_cellvars)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(co->co_cellvars)))); } while (0); } while (0);
    do { if ((co->co_filename) == ((void *)0)) ; else do { if ( --((PyObject*)(co->co_filename))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(co->co_filename)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(co->co_filename)))); } while (0); } while (0);
    do { if ((co->co_name) == ((void *)0)) ; else do { if ( --((PyObject*)(co->co_name))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(co->co_name)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(co->co_name)))); } while (0); } while (0);
    do { if ((co->co_lnotab) == ((void *)0)) ; else do { if ( --((PyObject*)(co->co_lnotab))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(co->co_lnotab)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(co->co_lnotab)))); } while (0); } while (0);
    if (co->co_cell2arg != ((void *)0))
        free(co->co_cell2arg);
    if (co->co_zombieframe != ((void *)0))
        PyObject_GC_Del(co->co_zombieframe);
    if (co->co_weakreflist != ((void *)0))
...
code_sizeof(PyCodeObject *co, void *unused)
{
    ...
    if (co->co_cell2arg != ((void *)0) && co->co_cellvars != ((void *)0))
        res += (((PyVarObject*)(co->co_cellvars))->ob_size) * sizeof(unsigned char);
...
code_repr(PyCodeObject *co)
{
    ...
    if (co->co_firstlineno != 0)
        ...
        lineno = -1;
    if (co->co_filename && ((((((PyObject*)(co->co_filename))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
...
code_richcompare(PyObject *self, PyObject *other, int op)
{
    ...
    if ((op != 2 && op != 3) ||
        !((((PyObject*)(self))->ob_type) == &PyCode_Type) ||
        !((((PyObject*)(other))->ob_type) == &PyCode_Type)) {
    ...
    eq = PyObject_RichCompareBool(co->co_name, cp->co_name, 2);
    ...
    if (!eq) goto unequal;
    eq = PyObject_RichCompareBool(co->co_code, cp->co_code, 2);
    if (eq <= 0) goto unequal;
    eq = PyObject_RichCompareBool(co->co_consts, cp->co_consts, 2);
    if (eq <= 0) goto unequal;
    eq = PyObject_RichCompareBool(co->co_names, cp->co_names, 2);
    if (eq <= 0) goto unequal;
    eq = PyObject_RichCompareBool(co->co_varnames, cp->co_varnames, 2);
    if (eq <= 0) goto unequal;
    eq = PyObject_RichCompareBool(co->co_freevars, cp->co_freevars, 2);
    if (eq <= 0) goto unequal;
    eq = PyObject_RichCompareBool(co->co_cellvars, cp->co_cellvars, 2);
    if (eq <= 0) goto unequal;
...
static struct PyMethodDef code_methods[] = {
    {"__sizeof__", (PyCFunction)code_sizeof, 0x0004},
    {((void *)0), ((void *)0)}
};
...
PyTypeObject PyCode_Type = {
    ...
    0,
    code_richcompare,
    __builtin_offsetof (PyCodeObject, co_weakreflist),
    0,
    0,
    code_methods,
    code_memberlist,
...
_PyCode_CheckLineNumber(PyCodeObject* co, int lasti, PyAddrPair *bounds)
{
    ...
    p = (unsigned char*)((__builtin_expect(!(((((((PyObject*)(co->co_lnotab))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "codeobject.c", 569, "PyBytes_Check(co->co_lnotab)") : (void)0), (((PyBytesObject *)(co->co_lnotab))->ob_sval));
    size = ((__builtin_expect(!(((((((PyObject*)(co->co_lnotab))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "codeobject.c", 570, "PyBytes_Check(co->co_lnotab)") : (void)0),(((PyVarObject*)(co->co_lnotab))->ob_size)) / 2;

    addr = 0;
    line = co->co_firstlineno;
    (__builtin_expect(!(line > 0), 0) ? __assert_rtn(__func__, "codeobject.c", 574, "line > 0") : (void)0);
# 585 "codeobject.c"
    bounds->ap_lower = 0;
    while (size > 0) {
        if (addr + *p > lasti)
