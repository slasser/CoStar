...
# 17 "import.c" 2
# 33 "import.c"
static PyObject *extensions = ((void *)0);
...
static PyObject *initstr = ((void *)0);
...
_PyImportHooks_Init(void)
{
  ...
  error:
    ...
    do { if ( --((PyObject*)(path_hooks))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(path_hooks)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(path_hooks)))); } while (0);
}
...
_PyImportZip_Init(void)
{
    ...
    if (zimpimport == ((void *)0)) {
        PyErr_Clear();
        if (Py_VerboseFlag)
            PySys_WriteStderr("# can't import zipimport\n");
    }
    else {
        static _Py_Identifier PyId_zipimporter = { 0, "zipimporter", 0 };
        PyObject *zipimporter = _PyObject_GetAttrId(zimpimport,
                                                    &PyId_zipimporter);
        do { if ( --((PyObject*)(zimpimport))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(zimpimport)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(zimpimport)))); } while (0);
        if (zipimporter == ((void *)0)) {
            PyErr_Clear();
            if (Py_VerboseFlag)
                PySys_WriteStderr(
            ...
            do { if ( --((PyObject*)(zipimporter))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(zipimporter)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(zipimporter)))); } while (0);
            if (err < 0) {
                goto error;
            }
            if (Py_VerboseFlag)
...
_PyImport_AcquireLock(void)
{
    ...
    (__builtin_expect(!(import_lock_level == 0), 0) ? __assert_rtn(__func__, "import.c", 172, "import_lock_level == 0") : (void)0);
...
{
    long me = PyThread_get_thread_ident();
    if (me == -1 || import_lock == ((void *)0))
        return 0;
    if (import_lock_thread != me)
        return -1;
    import_lock_level--;
    (__builtin_expect(!(import_lock_level >= 0), 0) ? __assert_rtn(__func__, "import.c", 186, "import_lock_level >= 0") : (void)0);
...
_PyImport_Fini(void)
{
    do { if ((extensions) == ((void *)0)) ; else do { if ( --((PyObject*)(extensions))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(extensions)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(extensions)))); } while (0); } while (0);
    extensions = ((void *)0);
...
PyImport_Cleanup(void)
{
    ...
    if (value != ((void *)0) && ((((PyObject*)(value))->ob_type) == (&PyModule_Type) || PyType_IsSubtype((((PyObject*)(value))->ob_type), (&PyModule_Type)))) {
    ...
    if (value != ((void *)0) && ((((PyObject*)(value))->ob_type) == (&PyModule_Type) || PyType_IsSubtype((((PyObject*)(value))->ob_type), (&PyModule_Type)))) {
        ...
        PyObject *v;
        dict = PyModule_GetDict(value);
        for (p = sys_deletes; *p != ((void *)0); p++) {
            if (Py_VerboseFlag)
                PySys_WriteStderr("# clear sys.%s\n", *p);
            PyDict_SetItemString(dict, *p, (&_Py_NoneStruct));
        }
        for (p = sys_files; *p != ((void *)0); p+=2) {
            if (Py_VerboseFlag)
...
# 367 "import.c"
    do {
        ...
        while (PyDict_Next(modules, &pos, &key, &value)) {
            if (value->ob_refcnt != 1)
                continue;
            if (((((((PyObject*)(key))->ob_type))->tp_flags & ((1L<<28))) != 0) && ((((PyObject*)(value))->ob_type) == (&PyModule_Type) || PyType_IsSubtype((((PyObject*)(value))->ob_type), (&PyModule_Type)))) {
    ...
    interp->modules = ((void *)0);
    do { if ( --((PyObject*)(modules))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(modules)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(modules)))); } while (0);
}
...
PyImport_GetMagicNumber(void)
{
    ...
    do { if ( --((PyObject*)(pyc_magic))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pyc_magic)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pyc_magic)))); } while (0);
    return res;
}
                               ...
                               PyObject *filename)
{
    ...
    if (mod == ((void *)0) || !((((PyObject*)(mod))->ob_type) == (&PyModule_Type) || PyType_IsSubtype((((PyObject*)(mod))->ob_type), (&PyModule_Type)))) {
        _PyErr_BadInternalCall("import.c", 480);
        return -1;
    }
    def = PyModule_GetDef(mod);
    if (!def) {
        _PyErr_BadInternalCall("import.c", 485);
        return -1;
    }
    ...
    if (def->m_size == -1) {
        if (def->m_base.m_copy) {
            ...
            do { if ( --((PyObject*)(def->m_base.m_copy))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(def->m_base.m_copy)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(def->m_base.m_copy)))); } while (0);
            def->m_base.m_copy = ((void *)0);
        }
        dict = PyModule_GetDict(mod);
        if (dict == ((void *)0))
            return -1;
        def->m_base.m_copy = PyDict_Copy(dict);
        if (def->m_base.m_copy == ((void *)0))
            return -1;
    }
...
_PyImport_FixupBuiltin(PyObject *mod, char *name)
{
    ...
    do { if ( --((PyObject*)(nameobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(nameobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(nameobj)))); } while (0);
    return res;
}
...
PyImport_AddModuleObject(PyObject *name)
{
    ...
    if ((m = PyDict_GetItem(modules, name)) != ((void *)0) &&
        ((((PyObject*)(m))->ob_type) == (&PyModule_Type) || PyType_IsSubtype((((PyObject*)(m))->ob_type), (&PyModule_Type))))
        return m;
...
{
    PyObject *modules = PyImport_GetModuleDict();
    if (PyDict_GetItem(modules, name) == ((void *)0))
        return;
...
PyImport_ExecCodeModule(char *name, PyObject *co)
{
    return PyImport_ExecCodeModuleWithPathnames(
        name, co, (char *)((void *)0), (char *)((void *)0));
}
...
{
    PyObject *m = ((void *)0);
    PyObject *nameobj, *pathobj = ((void *)0), *cpathobj = ((void *)0);
    ...
    else if (cpathobj != ((void *)0)) {
        PyInterpreterState *interp = ((PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; }))->interp;
        static _Py_Identifier PyId__get_sourcefile = { 0, "_get_sourcefile", 0 };
...
error:
    do { if ( --((PyObject*)(nameobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(nameobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(nameobj)))); } while (0);
    do { if ((pathobj) == ((void *)0)) ; else do { if ( --((PyObject*)(pathobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pathobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pathobj)))); } while (0); } while (0);
    do { if ((cpathobj) == ((void *)0)) ; else do { if ( --((PyObject*)(cpathobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(cpathobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(cpathobj)))); } while (0); } while (0);
    return m;
}
                              ...
                              PyObject *cpathname)
{
    ...
    if (PyDict_GetItemString(d, "__builtins__") == ((void *)0)) {
...
update_code_filenames(PyCodeObject *co, PyObject *oldname, PyObject *newname)
{
    ...
    ( ((PyObject*)(co->co_filename))->ob_refcnt++);
    do { if ( --((PyObject*)(tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tmp)))); } while (0);

    constants = co->co_consts;
    n = (((PyVarObject*)(constants))->ob_size);
    for (i = 0; i < n; i++) {
        tmp = (((PyTupleObject *)(constants))->ob_item[i]);
        if (((((PyObject*)(tmp))->ob_type) == &PyCode_Type))
...
update_compiled_module(PyCodeObject *co, PyObject *newname)
{
    ...
    ( ((PyObject*)(oldname))->ob_refcnt++);
    update_code_filenames(co, oldname, newname);
    do { if ( --((PyObject*)(oldname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(oldname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(oldname)))); } while (0);
}
...
imp_fix_co_filename(PyObject *self, PyObject *args)
{
    ...
    if (!((((PyObject*)(co))->ob_type) == &PyCode_Type)) {
        PyErr_SetString(PyExc_TypeError,
                        "first argument must be a code object");
        return ((void *)0);
    }

    if (!((((((PyObject*)(file_path))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        PyErr_SetString(PyExc_TypeError,
...
is_builtin(PyObject *name)
{
    ...
    for (i = 0; PyImport_Inittab[i].name != ((void *)0); i++) {
        ...
        if (cmp == 0) {
            if (PyImport_Inittab[i].initfunc == ((void *)0))
                return -1;
            else
                return 1;
        }
                  ...
                  PyObject *p)
{
    ...
    (__builtin_expect(!(((((((PyObject*)(path_hooks))->ob_type))->tp_flags & ((1L<<25))) != 0)), 0) ? __assert_rtn(__func__, "import.c", 873, "PyList_Check(path_hooks)") : (void)0);
    (__builtin_expect(!(((((((PyObject*)(path_importer_cache))->ob_type))->tp_flags & ((1L<<29))) != 0)), 0) ? __assert_rtn(__func__, "import.c", 874, "PyDict_Check(path_importer_cache)") : (void)0);
    ...
    if (PyDict_SetItem(path_importer_cache, p, (&_Py_NoneStruct)) != 0)
        return ((void *)0);
    ...
    for (j = 0; j < nhooks; j++) {
        ...
        if (hook == ((void *)0))
            return ((void *)0);
        importer = PyObject_CallFunctionObjArgs(hook, p, ((void *)0));
        if (importer != ((void *)0))
            break;
    ...
    if (importer != ((void *)0)) {
        ...
        do { if ( --((PyObject*)(importer))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(importer)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(importer)))); } while (0);
        if (err != 0)
            return ((void *)0);
    }
    return importer;
...
PyImport_GetImporter(PyObject *path) {
    PyObject *importer=((void *)0), *path_importer_cache=((void *)0), *path_hooks=((void *)0);
    ...
    do { if ((importer) == ((void *)0)) ; else ( ((PyObject*)(importer))->ob_refcnt++); } while (0);
    return importer;
}


static int init_builtin(PyObject *);
...
init_builtin(PyObject *name)
{
    ...
    if (_PyImport_FindExtensionObject(name, name) != ((void *)0))
        return 1;

    for (p = PyImport_Inittab; p->name != ((void *)0); p++) {
        PyObject *mod;
        PyModuleDef *def;
        if (PyUnicode_CompareWithASCIIString(name, p->name) == 0) {
            if (p->initfunc == ((void *)0)) {
                PyErr_Format(PyExc_ImportError,
...
PyImport_ImportFrozenModuleObject(PyObject *name)
{
    ...
    if (path == ((void *)0))
        goto err_return;
    m = PyImport_ExecCodeModuleObject(name, co, path, ((void *)0));
...
PyImport_ImportModule(const char *name)
{
    ...
    do { if ( --((PyObject*)(pname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pname)))); } while (0);
    return result;
}
# 1145 "import.c"
PyObject *
...
remove_importlib_frames(void)
{
    ...
    PyObject **prev_link, **outer_link = ((void *)0);
    ...
    while (tb != ((void *)0)) {
        ...
        (__builtin_expect(!(((((PyObject*)(tb))->ob_type) == &PyTraceBack_Type)), 0) ? __assert_rtn(__func__, "import.c", 1184, "PyTraceBack_Check(tb)") : (void)0);
        ...
        if (in_importlib &&
            ...
            *outer_link = next;
            do { if ((next) == ((void *)0)) ; else ( ((PyObject*)(next))->ob_refcnt++); } while (0);
            do { if ( --((PyObject*)(tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tmp)))); } while (0);
                                 ...
                                 int level)
{
    ...
    static _Py_Identifier PyId___initializing__ = { 0, "__initializing__", 0 };
    static _Py_Identifier PyId___package__ = { 0, "__package__", 0 };
    static _Py_Identifier PyId___path__ = { 0, "__path__", 0 };
    static _Py_Identifier PyId___name__ = { 0, "__name__", 0 };
    static _Py_Identifier PyId__find_and_load = { 0, "_find_and_load", 0 };
    static _Py_Identifier PyId__handle_fromlist = { 0, "_handle_fromlist", 0 };
    static _Py_Identifier PyId__lock_unlock_module = { 0, "_lock_unlock_module", 0 };
    static _Py_Identifier single_dot = { 0, ".", 0 };
    PyObject *abs_name = ((void *)0);
    PyObject *builtins_import = ((void *)0);
    PyObject *final_mod = ((void *)0);
    PyObject *mod = ((void *)0);
    PyObject *package = ((void *)0);
    PyObject *globals = ((void *)0);
    PyObject *fromlist = ((void *)0);
    PyInterpreterState *interp = ((PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; }))->interp;




    if (given_globals == ((void *)0)) {
        globals = PyDict_New();
        if (globals == ((void *)0)) {
            goto error;
        }
        ...
        if (level > 0 && !((((((PyObject*)(given_globals))->ob_type))->tp_flags & ((1L<<29))) != 0)) {
            PyErr_SetString(PyExc_TypeError, "globals must be a dict");
            goto error;
        }
        globals = given_globals;
        ( ((PyObject*)(globals))->ob_refcnt++);
    }

    if (given_fromlist == ((void *)0)) {
    ...
    else if (((__builtin_expect(!(((((((PyObject*)(name))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "import.c", 1279, "PyUnicode_Check(name)") : (void)0), ((((PyASCIIObject*)name)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(name)))) < 0) {
        goto error;
    }
    if (level < 0) {
        ...
        if (package != ((void *)0) && package != (&_Py_NoneStruct)) {
            ( ((PyObject*)(package))->ob_refcnt++);
            if (!((((((PyObject*)(package))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
            ...
            else if (!((((((PyObject*)(package))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
                PyErr_SetString(PyExc_TypeError, "__name__ must be a string");
            }
            ( ((PyObject*)(package))->ob_refcnt++);

            if (_PyDict_GetItemId(globals, &PyId___path__) == ((void *)0)) {
                PyObject *partition = ((void *)0);
                PyObject *borrowed_dot = _PyUnicode_FromId(&single_dot);
                if (borrowed_dot == ((void *)0)) {
                    goto error;
                }
                partition = PyUnicode_RPartition(package, borrowed_dot);
                do { if ( --((PyObject*)(package))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(package)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(package)))); } while (0);
                if (partition == ((void *)0)) {
                    goto error;
                }
                package = (((PyTupleObject *)(partition))->ob_item[0]);
                ( ((PyObject*)(package))->ob_refcnt++);
                do { if ( --((PyObject*)(partition))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(partition)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(partition)))); } while (0);
            }
        }

        if (PyDict_GetItem(interp->modules, package) == ((void *)0)) {
        ...
        if (((__builtin_expect(!(((((((PyObject*)(name))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "import.c", 1331, "PyUnicode_Check(name)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)name)->state.ready)), 0) ? __assert_rtn(__func__, "import.c", 1331, "PyUnicode_IS_READY(name)") : (void)0), ((PyASCIIObject *)(name))->length) == 0) {
            PyErr_SetString(PyExc_ValueError, "Empty module name");
            goto error;
        }
        package = (&_Py_NoneStruct);
        ( ((PyObject*)(package))->ob_refcnt++);
    }

    if (level > 0) {
        Py_ssize_t last_dot = ((__builtin_expect(!(((((((PyObject*)(package))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "import.c", 1340, "PyUnicode_Check(package)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)package)->state.ready)), 0) ? __assert_rtn(__func__, "import.c", 1340, "PyUnicode_IS_READY(package)") : (void)0), ((PyASCIIObject *)(package))->length);
        ...
        if (((__builtin_expect(!(((((((PyObject*)(name))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "import.c", 1357, "PyUnicode_Check(name)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)name)->state.ready)), 0) ? __assert_rtn(__func__, "import.c", 1357, "PyUnicode_IS_READY(name)") : (void)0), ((PyASCIIObject *)(name))->length) > 0) {
            PyObject *borrowed_dot, *seq = ((void *)0);
            ...
            if (borrowed_dot == ((void *)0) || seq == ((void *)0)) {
                goto error;
            }
    ...
    if (builtins_import == ((void *)0)) {
        builtins_import = _PyDict_GetItemId(interp->builtins, &PyId___import__);
        if (builtins_import == ((void *)0)) {
            Py_FatalError("__import__ missing");
        }
    }
    ( ((PyObject*)(builtins_import))->ob_refcnt++);

    mod = PyDict_GetItem(interp->modules, abs_name);
    if (mod == (&_Py_NoneStruct)) {
        PyObject *msg = PyUnicode_FromFormat("import of %R halted; "
                                             "None in sys.modules", abs_name);
        if (msg != ((void *)0)) {
            PyErr_SetImportError(msg, abs_name, ((void *)0));
    ...
    if (PyObject_Not(fromlist)) {
        if (level == 0 || ((__builtin_expect(!(((((((PyObject*)(name))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "import.c", 1457, "PyUnicode_Check(name)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)name)->state.ready)), 0) ? __assert_rtn(__func__, "import.c", 1457, "PyUnicode_IS_READY(name)") : (void)0), ((PyASCIIObject *)(name))->length) > 0) {
            PyObject *front = ((void *)0);
            PyObject *partition = ((void *)0);
            PyObject *borrowed_dot = _PyUnicode_FromId(&single_dot);
            ...
            if (((__builtin_expect(!(((((((PyObject*)((((PyTupleObject *)(partition))->ob_item[1])))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "import.c", 1471, "PyUnicode_Check((((PyTupleObject *)(partition))->ob_item[1]))") : (void)0), (__builtin_expect(!((((PyASCIIObject*)(((PyTupleObject *)(partition))->ob_item[1]))->state.ready)), 0) ? __assert_rtn(__func__, "import.c", 1471, "PyUnicode_IS_READY((((PyTupleObject *)(partition))->ob_item[1]))") : (void)0), ((PyASCIIObject *)((((PyTupleObject *)(partition))->ob_item[1])))->length) == 0) {
            ...
            front = (((PyTupleObject *)(partition))->ob_item[0]);
            ( ((PyObject*)(front))->ob_refcnt++);
            do { if ( --((PyObject*)(partition))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(partition)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(partition)))); } while (0);

            if (level == 0) {
                final_mod = PyObject_CallFunctionObjArgs(builtins_import, front, ((void *)0));
                do { if ( --((PyObject*)(front))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(front)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(front)))); } while (0);
            }
            else {
                Py_ssize_t cut_off = ((__builtin_expect(!(((((((PyObject*)(name))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "import.c", 1488, "PyUnicode_Check(name)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)name)->state.ready)), 0) ? __assert_rtn(__func__, "import.c", 1488, "PyUnicode_IS_READY(name)") : (void)0), ((PyASCIIObject *)(name))->length) -
                                        ((__builtin_expect(!(((((((PyObject*)(front))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "import.c", 1489, "PyUnicode_Check(front)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)front)->state.ready)), 0) ? __assert_rtn(__func__, "import.c", 1489, "PyUnicode_IS_READY(front)") : (void)0), ((PyASCIIObject *)(front))->length);
                Py_ssize_t abs_name_len = ((__builtin_expect(!(((((((PyObject*)(abs_name))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "import.c", 1490, "PyUnicode_Check(abs_name)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)abs_name)->state.ready)), 0) ? __assert_rtn(__func__, "import.c", 1490, "PyUnicode_IS_READY(abs_name)") : (void)0), ((PyASCIIObject *)(abs_name))->length);
                ...
                if (final_mod == ((void *)0)) {
                    ...
                    ( ((PyObject*)(final_mod))->ob_refcnt++);
                }
                do { if ( --((PyObject*)(to_return))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(to_return)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(to_return)))); } while (0);
            }
        }
        else {
            final_mod = mod;
  ...
  error:
    do { if ((abs_name) == ((void *)0)) ; else do { if ( --((PyObject*)(abs_name))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(abs_name)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(abs_name)))); } while (0); } while (0);
    do { if ((builtins_import) == ((void *)0)) ; else do { if ( --((PyObject*)(builtins_import))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(builtins_import)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(builtins_import)))); } while (0); } while (0);
    ...
    do { if ((package) == ((void *)0)) ; else do { if ( --((PyObject*)(package))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(package)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(package)))); } while (0); } while (0);
    do { if ((globals) == ((void *)0)) ; else do { if ( --((PyObject*)(globals))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(globals)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(globals)))); } while (0); } while (0);
    do { if ((fromlist) == ((void *)0)) ; else do { if ( --((PyObject*)(fromlist))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(fromlist)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(fromlist)))); } while (0); } while (0);
    if (final_mod == ((void *)0))
...
{
    static _Py_Identifier PyId_reload = { 0, "reload", 0 };
    PyObject *reloaded_module = ((void *)0);
    PyObject *modules = PyImport_GetModuleDict();
    ...
    if (imp == ((void *)0)) {
        ...
        ( ((PyObject*)(imp))->ob_refcnt++);
    }

    reloaded_module = _PyObject_CallMethodId(imp, &PyId_reload, "O", m);
    do { if ( --((PyObject*)(imp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(imp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(imp)))); } while (0);
...
{
    static PyObject *silly_list = ((void *)0);
    static PyObject *builtins_str = ((void *)0);
    static PyObject *import_str = ((void *)0);
    PyObject *globals = ((void *)0);
    PyObject *import = ((void *)0);
    PyObject *builtins = ((void *)0);
    PyObject *modules = ((void *)0);
    PyObject *r = ((void *)0);


    if (silly_list == ((void *)0)) {
        import_str = PyUnicode_InternFromString("__import__");
        if (import_str == ((void *)0))
            return ((void *)0);
        builtins_str = PyUnicode_InternFromString("__builtins__");
        if (builtins_str == ((void *)0))
            return ((void *)0);
    ...
    if (((((((PyObject*)(builtins))->ob_type))->tp_flags & ((1L<<29))) != 0)) {
  ...
  err:
    do { if ((globals) == ((void *)0)) ; else do { if ( --((PyObject*)(globals))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(globals)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(globals)))); } while (0); } while (0);
    do { if ((builtins) == ((void *)0)) ; else do { if ( --((PyObject*)(builtins))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(builtins)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(builtins)))); } while (0); } while (0);
    do { if ((import) == ((void *)0)) ; else do { if ( --((PyObject*)(import))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(import)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(import)))); } while (0); } while (0);
...
imp_init_builtin(PyObject *self, PyObject *args)
{
    ...
    m = PyImport_AddModuleObject(name);
    do { if ((m) == ((void *)0)) ; else ( ((PyObject*)(m))->ob_refcnt++); } while (0);
    return m;
}
...
imp_is_frozen(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "U:is_frozen", &name))
        return ((void *)0);
    p = find_frozen(name);
    return PyBool_FromLong((long) (p == ((void *)0) ? 0 : p->size));
}
...
{
    PyObject *name, *pathname, *fob = ((void *)0), *mod;
    FILE *fp;
    ...
    if (fob != ((void *)0)) {
        ...
        if (fp == ((void *)0)) {
            do { if ( --((PyObject*)(pathname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pathname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pathname)))); } while (0);
            if (!PyErr_Occurred())
...
static char doc_imp[] = "(Extremely) low-level import machinery bits as used by importlib and imp.";


static char doc_extension_suffixes[] = "extension_suffixes() -> list of strings\nReturns the list of file suffixes used to identify extension modules.";
...
static PyMethodDef imp_methods[] = {
    {"extension_suffixes", imp_extension_suffixes, 0x0004,
        doc_extension_suffixes},
    {"lock_held", imp_lock_held, 0x0004, doc_lock_held},
    {"acquire_lock", imp_acquire_lock, 0x0004, doc_acquire_lock},
    {"release_lock", imp_release_lock, 0x0004, doc_release_lock},
    {"get_frozen_object", imp_get_frozen_object, 0x0001},
    {"is_frozen_package", imp_is_frozen_package, 0x0001},
    {"init_builtin", imp_init_builtin, 0x0001},
    {"init_frozen", imp_init_frozen, 0x0001},
    {"is_builtin", imp_is_builtin, 0x0001},
    {"is_frozen", imp_is_frozen, 0x0001},

    {"load_dynamic", imp_load_dynamic, 0x0001},

    {"_fix_co_filename", imp_fix_co_filename, 0x0001},
    {((void *)0), ((void *)0)}
};
...
PyInit_imp(void)
{
    ...
    m = PyModule_Create2(&impmodule, 1013);
    if (m == ((void *)0))
        goto failure;
    d = PyModule_GetDict(m);
    if (d == ((void *)0))
...
{
    static struct _inittab *our_copy = ((void *)0);
    struct _inittab *p;
    int i, n;


    for (n = 0; newtab[n].name != ((void *)0); n++)
        ;
    if (n == 0)
        return 0;
    for (i = 0; PyImport_Inittab[i].name != ((void *)0); i++)
    ...
    p = our_copy;
    ( (p) = ((size_t)(i+n+1) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(struct _inittab)) ? ((void *)0) : (struct _inittab *) ((size_t)((i+n+1) * sizeof(struct _inittab)) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : realloc(((p)), ((i+n+1) * sizeof(struct _inittab)) ? ((i+n+1) * sizeof(struct _inittab)) : 1)) );
    if (p == ((void *)0))
        return -1;


    if (our_copy != PyImport_Inittab)
        ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___memcpy_chk (p, PyImport_Inittab, (i+1) * sizeof(struct _inittab), __builtin_object_size (p, 0)) : __inline_memcpy_chk (p, PyImport_Inittab, (i+1) * sizeof(struct _inittab)));
    PyImport_Inittab = our_copy = p;
    ((__builtin_object_size (p+i, 0) != (size_t) -1) ? __builtin___memcpy_chk (p+i, newtab, (n+1) * sizeof(struct _inittab), __builtin_object_size (p+i, 0)) : __inline_memcpy_chk (p+i, newtab, (n+1) * sizeof(struct _inittab)));
...
PyImport_AppendInittab(const char *name, PyObject* (*initfunc)(void))
{
    ...
    ((__builtin_object_size (newtab, 0) != (size_t) -1) ? __builtin___memset_chk (newtab, '\0', sizeof newtab, __builtin_object_size (newtab, 0)) : __inline_memset_chk (newtab, '\0', sizeof newtab));
