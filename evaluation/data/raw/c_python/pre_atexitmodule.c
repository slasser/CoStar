...
{
    PyObject *exc_type = ((void *)0), *exc_value, *exc_tb, *r;
    atexit_callback *cb;
    PyObject *module;
    ...
    if (module == ((void *)0))
        return;
    modstate = ((atexitmodule_state*)PyModule_GetState(module));
...
atexit_delete_cb(PyObject *self, int i)
{
    ...
    cb = modstate->atexit_callbacks[i];
    modstate->atexit_callbacks[i] = ((void *)0);
    do { if ( --((PyObject*)(cb->func))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(cb->func)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(cb->func)))); } while (0);
    do { if ( --((PyObject*)(cb->args))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(cb->args)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(cb->args)))); } while (0);
    do { if ((cb->kwargs) == ((void *)0)) ; else do { if ( --((PyObject*)(cb->kwargs))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(cb->kwargs)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(cb->kwargs)))); } while (0); } while (0);
    PyMem_Free(cb);
}
...
{
    PyObject *r = atexit_clear(self, ((void *)0));
...
static char atexit_register__doc__[] = "register(func, *args, **kwargs) -> func\n\nRegister a function to be executed upon normal program termination\n\n    func - function to be called at exit\n    args - optional arguments to pass to func\n    kwargs - optional keyword arguments to pass to func\n\n    func is returned to facilitate usage as a decorator.";
# 123 "atexitmodule.c"
static PyObject *
atexit_register(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (new_callback == ((void *)0))
        return PyErr_NoMemory();

    new_callback->args = PyTuple_GetSlice(args, 1, (((PyVarObject*)(args))->ob_size));
    if (new_callback->args == ((void *)0)) {
    ...
    do { if ((kwargs) == ((void *)0)) ; else ( ((PyObject*)(kwargs))->ob_refcnt++); } while (0);
...
static char atexit_run_exitfuncs__doc__[] = "_run_exitfuncs() -> None\n\nRun all registered exit functions.";
...
static char atexit_clear__doc__[] = "_clear() -> None\n\nClear the list of previously registered exit functions.";
...
atexit_unregister(PyObject *self, PyObject *func)
{
    ...
    for (i = 0; i < modstate->ncallbacks; i++)
    {
        ...
        eq = PyObject_RichCompareBool(cb->func, func, 2);
        if (eq < 0)
            return ((void *)0);
        if (eq)
            atexit_delete_cb(self, i);
...
static PyMethodDef atexit_methods[] = {
    {"register", (PyCFunction) atexit_register, 0x0001|0x0002,
        atexit_register__doc__},
    {"_clear", (PyCFunction) atexit_clear, 0x0004,
        atexit_clear__doc__},
    {"unregister", (PyCFunction) atexit_unregister, 0x0008,
        atexit_unregister__doc__},
    {"_run_exitfuncs", (PyCFunction) atexit_run_exitfuncs, 0x0004,
...
static char atexit__doc__[] = "allow programmer to define multiple exit functions to be executedupon normal program termination.\n\nTwo public functions, register and unregister, are defined.\n";
...
PyInit_atexit(void)
{
    ...
    m = PyModule_Create2(&atexitmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    ...
    modstate->ncallbacks = 0;
    modstate->atexit_callbacks = ( ((size_t)(modstate->callback_len) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(atexit_callback*)) ? ((void *)0) : ( (atexit_callback* *) PyMem_Malloc((modstate->callback_len) * sizeof(atexit_callback*)) ) );

    if (modstate->atexit_callbacks == ((void *)0))
        return ((void *)0);
