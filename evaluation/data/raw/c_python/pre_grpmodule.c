...
static char struct_group__doc__[] = "grp.struct_group: Results from getgr*() routines.\n\nThis object may be accessed either as a tuple of\n  (gr_name,gr_passwd,gr_gid,gr_mem)\nor via the object attributes as named in the above tuple.\n";
...
mkgrent(struct group *p)
{
    ...
    (((PyTupleObject *)(v))->ob_item[setIndex++] = PyUnicode_DecodeFSDefault(p->gr_name));




    if (p->gr_passwd)
            (((PyTupleObject *)(v))->ob_item[setIndex++] = PyUnicode_DecodeFSDefault(p->gr_passwd));
    else {
            (((PyTupleObject *)(v))->ob_item[setIndex++] = (&_Py_NoneStruct));
            ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++);
    }

    (((PyTupleObject *)(v))->ob_item[setIndex++] = _PyLong_FromGid(p->gr_gid));
    (((PyTupleObject *)(v))->ob_item[setIndex++] = w);
...
grp_getgrgid(PyObject *self, PyObject *pyo_id)
{
    ...
    if (!_Py_Gid_Converter(py_int_id, &gid)) {
        do { if ( --((PyObject*)(py_int_id))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(py_int_id)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(py_int_id)))); } while (0);
        return ((void *)0);
    }
    do { if ( --((PyObject*)(py_int_id))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(py_int_id)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(py_int_id)))); } while (0);

    if ((p = getgrgid(gid)) == ((void *)0)) {
        PyObject *gid_obj = _PyLong_FromGid(gid);
        if (gid_obj == ((void *)0))
            return ((void *)0);
        PyErr_Format(PyExc_KeyError, "getgrgid(): gid not found: %S", gid_obj);
        do { if ( --((PyObject*)(gid_obj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(gid_obj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(gid_obj)))); } while (0);
        return ((void *)0);
    }
    return mkgrent(p);
}
...
static PyMethodDef grp_methods[] = {
    {"getgrgid", grp_getgrgid, 0x0008,
     "getgrgid(id) -> tuple\nReturn the group database entry for the given numeric group ID.  If\nid is not valid, raise KeyError."},


    {"getgrnam", grp_getgrnam, 0x0001,
     "getgrnam(name) -> tuple\nReturn the group database entry for the given group name.  If\nname is not valid, raise KeyError."},


    {"getgrall", grp_getgrall, 0x0004,
...
{
    PyObject *m, *d;
    m = PyModule_Create2(&grpmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
