...
# 64 "/usr/include/mach/machine.h" 3 4
...
# 65 "/usr/include/mach/machine.h" 2 3 4
...
# 66 "/usr/include/mach/machine.h" 2 3 4
...
# 147 "/usr/include/mach/i386/thread_status.h" 3 4
struct x86_state_hdr {
 int flavor;
 int count;
};
typedef struct x86_state_hdr x86_state_hdr_t;
# 165 "/usr/include/mach/i386/thread_status.h" 3 4
...
# 234 "/usr/include/mach/i386/thread_status.h" 3 4
...
# 302 "/usr/include/mach/i386/thread_status.h" 3 4
...
# 227 "/usr/include/mach-o/loader.h" 3 4
struct load_command {
 uint32_t cmd;
 uint32_t cmdsize;
};
# 302 "/usr/include/mach-o/loader.h" 3 4
union lc_str {
 uint32_t offset;
...
# 321 "/usr/include/mach-o/loader.h" 3 4
...
# 398 "/usr/include/mach-o/loader.h" 3 4
struct section {
 char sectname[16];
 char segname[16];
 uint32_t addr;
...
# 600 "/usr/include/mach-o/loader.h" 3 4
struct fvmlib {
 union lc_str name;
 uint32_t minor_version;
 uint32_t header_addr;
};
# 613 "/usr/include/mach-o/loader.h" 3 4
...
# 642 "/usr/include/mach-o/loader.h" 3 4
...
# 659 "/usr/include/mach-o/loader.h" 3 4
struct sub_framework_command {
 uint32_t cmd;
 uint32_t cmdsize;
 union lc_str umbrella;
};
# 674 "/usr/include/mach-o/loader.h" 3 4
struct sub_client_command {
 uint32_t cmd;
 uint32_t cmdsize;
 union lc_str client;
};
# 693 "/usr/include/mach-o/loader.h" 3 4
struct sub_umbrella_command {
 uint32_t cmd;
 uint32_t cmdsize;
 union lc_str sub_umbrella;
};
# 714 "/usr/include/mach-o/loader.h" 3 4
struct sub_library_command {
 uint32_t cmd;
 uint32_t cmdsize;
 union lc_str sub_library;
};
# 729 "/usr/include/mach-o/loader.h" 3 4
...
# 745 "/usr/include/mach-o/loader.h" 3 4
...
# 790 "/usr/include/mach-o/loader.h" 3 4
...
# 875 "/usr/include/mach-o/loader.h" 3 4
struct dysymtab_command {
    uint32_t cmd;
    uint32_t cmdsize;
# 894 "/usr/include/mach-o/loader.h" 3 4
    uint32_t ilocalsym;
    uint32_t nlocalsym;
    ...
    uint32_t iundefsym;
    uint32_t nundefsym;
# 911 "/usr/include/mach-o/loader.h" 3 4
    uint32_t tocoff;
    uint32_t ntoc;
# 923 "/usr/include/mach-o/loader.h" 3 4
    uint32_t modtaboff;
    uint32_t nmodtab;
# 935 "/usr/include/mach-o/loader.h" 3 4
    uint32_t extrefsymoff;
    uint32_t nextrefsyms;
# 948 "/usr/include/mach-o/loader.h" 3 4
    uint32_t indirectsymoff;
    uint32_t nindirectsyms;
# 978 "/usr/include/mach-o/loader.h" 3 4
    uint32_t extreloff;
    uint32_t nextrel;
...
# 1003 "/usr/include/mach-o/loader.h" 3 4
...
# 1072 "/usr/include/mach-o/loader.h" 3 4
...
# 1104 "/usr/include/mach-o/loader.h" 3 4
struct twolevel_hint {
    uint32_t
 isub_image:8,
 itoc:24;
};
# 1120 "/usr/include/mach-o/loader.h" 3 4
...
# 1191 "/usr/include/mach-o/loader.h" 3 4
struct dyld_info_command {
   uint32_t cmd;
   uint32_t cmdsize;
# 1206 "/usr/include/mach-o/loader.h" 3 4
    uint32_t rebase_off;
    uint32_t rebase_size;
# 1221 "/usr/include/mach-o/loader.h" 3 4
    uint32_t bind_off;
    uint32_t bind_size;
# 1239 "/usr/include/mach-o/loader.h" 3 4
    uint32_t weak_bind_off;
    uint32_t weak_bind_size;
# 1254 "/usr/include/mach-o/loader.h" 3 4
    uint32_t lazy_bind_off;
    uint32_t lazy_bind_size;
# 1285 "/usr/include/mach-o/loader.h" 3 4
    uint32_t export_off;
    uint32_t export_size;
};
# 1360 "/usr/include/mach-o/loader.h" 3 4
...
extern uint32_t _dyld_image_count(void) __attribute__((visibility("default")));
extern const struct mach_header* _dyld_get_image_header(uint32_t image_index) __attribute__((visibility("default")));
extern intptr_t _dyld_get_image_vmaddr_slide(uint32_t image_index) __attribute__((visibility("default")));
extern const char* _dyld_get_image_name(uint32_t image_index) __attribute__((visibility("default")));
# 61 "/usr/include/mach-o/dyld.h" 3 4
extern void _dyld_register_func_for_add_image(void (*func)(const struct mach_header* mh, intptr_t vmaddr_slide)) __attribute__((visibility("default")));
extern void _dyld_register_func_for_remove_image(void (*func)(const struct mach_header* mh, intptr_t vmaddr_slide)) __attribute__((visibility("default")));
...
extern int32_t NSVersionOfRunTimeLibrary(const char* libraryName) __attribute__((visibility("default")));
# 79 "/usr/include/mach-o/dyld.h" 3 4
extern int32_t NSVersionOfLinkTimeLibrary(const char* libraryName) __attribute__((visibility("default")));
# 92 "/usr/include/mach-o/dyld.h" 3 4
extern int _NSGetExecutablePath(char* buf, uint32_t* bufsize) __attribute__((visibility("default")));
...
extern void _dyld_moninit(void (*monaddition)(char *lowpc, char *highpc)) __attribute__((visibility("default")));
# 127 "/usr/include/mach-o/dyld.h" 3 4
...
extern NSObjectFileImageReturnCode NSCreateObjectFileImageFromFile(const char* pathName, NSObjectFileImage *objectFileImage) __attribute__((deprecated,visibility("default")));
extern NSObjectFileImageReturnCode NSCreateObjectFileImageFromMemory(const void *address, size_t size, NSObjectFileImage *objectFileImage) __attribute__((deprecated,visibility("default")));
extern _Bool NSDestroyObjectFileImage(NSObjectFileImage objectFileImage) __attribute__((deprecated,visibility("default")));

extern uint32_t NSSymbolDefinitionCountInObjectFileImage(NSObjectFileImage objectFileImage) __attribute__((deprecated,visibility("default")));
extern const char* NSSymbolDefinitionNameInObjectFileImage(NSObjectFileImage objectFileImage, uint32_t ordinal) __attribute__((deprecated,visibility("default")));
extern uint32_t NSSymbolReferenceCountInObjectFileImage(NSObjectFileImage objectFileImage) __attribute__((deprecated,visibility("default")));
extern const char* NSSymbolReferenceNameInObjectFileImage(NSObjectFileImage objectFileImage, uint32_t ordinal, _Bool *tentative_definition) __attribute__((deprecated,visibility("default")));
extern _Bool NSIsSymbolDefinedInObjectFileImage(NSObjectFileImage objectFileImage, const char* symbolName) __attribute__((deprecated,visibility("default")));
extern void* NSGetSectionDataInObjectFileImage(NSObjectFileImage objectFileImage, const char* segmentName, const char* sectionName, size_t *size) __attribute__((deprecated,visibility("default")));
extern _Bool NSHasModInitObjectFileImage(NSObjectFileImage objectFileImage) __attribute__((deprecated,visibility("default")));

typedef struct __NSModule* NSModule;
extern const char* NSNameOfModule(NSModule m) __attribute__((deprecated,visibility("default")));
extern const char* NSLibraryNameForModule(NSModule m) __attribute__((deprecated,visibility("default")));

extern NSModule NSLinkModule(NSObjectFileImage objectFileImage, const char* moduleName, uint32_t options) __attribute__((deprecated,visibility("default")));
...
extern _Bool NSUnLinkModule(NSModule module, uint32_t options) __attribute__((deprecated,visibility("default")));
...
extern _Bool NSIsSymbolNameDefined(const char* symbolName) __attribute__((deprecated,visibility("default")));
extern _Bool NSIsSymbolNameDefinedWithHint(const char* symbolName, const char* libraryNameHint) __attribute__((deprecated,visibility("default")));
extern _Bool NSIsSymbolNameDefinedInImage(const struct mach_header* image, const char* symbolName) __attribute__((deprecated,visibility("default")));
extern NSSymbol NSLookupAndBindSymbol(const char* symbolName) __attribute__((deprecated,visibility("default")));
extern NSSymbol NSLookupAndBindSymbolWithHint(const char* symbolName, const char* libraryNameHint) __attribute__((deprecated,visibility("default")));
extern NSSymbol NSLookupSymbolInModule(NSModule module, const char* symbolName) __attribute__((deprecated,visibility("default")));
extern NSSymbol NSLookupSymbolInImage(const struct mach_header* image, const char* symbolName, uint32_t options) __attribute__((deprecated,visibility("default")));




extern const char* NSNameOfSymbol(NSSymbol symbol) __attribute__((deprecated,visibility("default")));
extern void * NSAddressOfSymbol(NSSymbol symbol) __attribute__((deprecated,visibility("default")));
extern NSModule NSModuleForSymbol(NSSymbol symbol) __attribute__((deprecated,visibility("default")));
...
extern void NSLinkEditError(NSLinkEditErrors *c, int *errorNumber, const char** fileName, const char** errorString) __attribute__((deprecated,visibility("default")));
...
extern void NSInstallLinkEditErrorHandlers(const NSLinkEditErrorHandlers *handlers) __attribute__((deprecated,visibility("default")));

extern _Bool NSAddLibrary(const char* pathName) __attribute__((deprecated,visibility("default")));
extern _Bool NSAddLibraryWithSearching(const char* pathName) __attribute__((deprecated,visibility("default")));
extern const struct mach_header* NSAddImage(const char* image_name, uint32_t options) __attribute__((deprecated,visibility("default")));
...
extern _Bool _dyld_present(void) __attribute__((deprecated,visibility("default")));
extern _Bool _dyld_launched_prebound(void) __attribute__((deprecated,visibility("default")));
extern _Bool _dyld_all_twolevel_modules_prebound(void) __attribute__((deprecated,visibility("default")));
extern void _dyld_bind_objc_module(const void* objc_module) __attribute__((deprecated,visibility("default")));
extern _Bool _dyld_bind_fully_image_containing_address(const void* address) __attribute__((deprecated,visibility("default")));
extern _Bool _dyld_image_containing_address(const void* address) __attribute__((deprecated,visibility("default")));
extern void _dyld_lookup_and_bind(const char* symbol_name, void **address, NSModule* module) __attribute__((deprecated,visibility("default")));
extern void _dyld_lookup_and_bind_with_hint(const char* symbol_name, const char* library_name_hint, void** address, NSModule* module) __attribute__((deprecated,visibility("default")));
extern void _dyld_lookup_and_bind_fully(const char* symbol_name, void** address, NSModule* module) __attribute__((deprecated,visibility("default")));

extern const struct mach_header* _dyld_get_image_header_containing_address(const void* address) __attribute__((deprecated,visibility("default")));
# 11 "getpath.c" 2
# 133 "getpath.c"
static wchar_t prefix[1024 +1];
static wchar_t exec_prefix[1024 +1];
static wchar_t progpath[1024 +1];
static wchar_t *module_search_path = ((void *)0);
static int module_search_path_malloced = 0;
static wchar_t *lib_python = L"lib/python" "2.1";
...
absolutize(wchar_t *path)
{
    ...
    if (path[0] == L'/')
        return;
    copy_absolute(buffer, path, 1024 +1);
    wcscpy(path, buffer);
}
...
find_env_config_value(FILE * env_file, const wchar_t * key, wchar_t * value)
{
    ...
    fseek(env_file, 0, 0);
    while (!feof(env_file)) {
        char * p = fgets(buffer, 1024*2, env_file);
        wchar_t tmpbuffer[1024*2+1];
        PyObject * decoded;
        int n;
        ...
        if (decoded != ((void *)0)) {
            ...
            k = PyUnicode_AsWideChar(decoded,
                                     tmpbuffer, 1024 * 2);
            do { if ( --((PyObject*)(decoded))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(decoded)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(decoded)))); } while (0);
            if (k >= 0) {
                wchar_t * tok = wcstok(tmpbuffer, L" \t\r\n", &state);
                if ((tok != ((void *)0)) && !wcscmp(tok, key)) {
                    tok = wcstok(((void *)0), L" \t", &state);
                    if ((tok != ((void *)0)) && !wcscmp(tok, L"=")) {
                        tok = wcstok(((void *)0), L"\r\n", &state);
                        if (tok != ((void *)0)) {
                            wcsncpy(value, tok, 1024);
                            result = 1;
                            break;
                        }
                    }
...
search_for_prefix(wchar_t *argv0_path, wchar_t *home, wchar_t *_prefix)
{
    ...
    if (home) {
        wchar_t *delim;
        wcsncpy(prefix, home, 1024);
        delim = wcschr(prefix, L':');
        if (delim)
            *delim = L'\0';
        joinpath(prefix, lib_python);
        joinpath(prefix, L"os.py");
        return 1;
    }
    ...
    copy_absolute(prefix, argv0_path, 1024 +1);
    do {
        n = wcslen(prefix);
        joinpath(prefix, lib_python);
        joinpath(prefix, L"os.py");
...
search_for_exec_prefix(wchar_t *argv0_path, wchar_t *home, wchar_t *_exec_prefix)
{
    ...
    if (home) {
        ...
        delim = wcschr(home, L':');
        if (delim)
            wcsncpy(exec_prefix, delim+1, 1024);
        else
            wcsncpy(exec_prefix, home, 1024);
    ...
    if (isfile(exec_prefix)) {
        ...
        if (f == ((void *)0))
            ...
            char buf[1024 +1];
            PyObject *decoded;
            wchar_t rel_builddir_path[1024 +1];
    ...
    copy_absolute(exec_prefix, argv0_path, 1024 +1);
    do {
    ...
    wcsncpy(exec_prefix, _exec_prefix, 1024);
    joinpath(exec_prefix, lib_python);
    joinpath(exec_prefix, L"lib-dynload");
    if (isdir(exec_prefix))
        return 1;
...
calculate_path(void)
{
    ...
    static wchar_t delimiter[2] = {L':', '\0'};
    static wchar_t separator[2] = {L'/', '\0'};
    char *_rtpypath = (Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONPATH"));
    wchar_t *rtpypath = ((void *)0);
    wchar_t *home = Py_GetPythonHome();
    char *_path = getenv("PATH");
    wchar_t *path_buffer = ((void *)0);
    wchar_t *path = ((void *)0);
    wchar_t *prog = Py_GetProgramName();
    wchar_t argv0_path[1024 +1];
    wchar_t zip_path[1024 +1];
    int pfound, efound;
    wchar_t *buf;
    size_t bufsz;
    size_t prefixsz;
    ...
    _pythonpath = _Py_char2wchar("/usr/local" "/lib/python" "2.1" ":" "/usr/local" "/lib/python" "2.1" "/lib-dynload", ((void *)0));
    _prefix = _Py_char2wchar("/usr/local", ((void *)0));
    _exec_prefix = _Py_char2wchar("/usr/local", ((void *)0));
    ...
    if (_path) {
        path_buffer = _Py_char2wchar(_path, ((void *)0));
        path = path_buffer;
    }
    ...
    if (wcschr(prog, L'/'))
        wcsncpy(progpath, prog, 1024);
# 522 "getpath.c"
    else if(0 == _NSGetExecutablePath(execpath, &nsexeclength) && execpath[0] == L'/') {
        size_t r = mbstowcs(progpath, execpath, 1024 +1);
    ...
    if (progpath[0] != L'/' && progpath[0] != '\0')
        absolutize(progpath);
    wcsncpy(argv0_path, progpath, 1024);
    argv0_path[1024] = '\0';
# 605 "getpath.c"
    {
        wchar_t tmpbuffer[1024 +1];
        int linklen = _Py_wreadlink(progpath, tmpbuffer, 1024);
        while (linklen != -1) {
            if (tmpbuffer[0] == L'/')


                wcsncpy(argv0_path, tmpbuffer, 1024);
            else {

                reduce(argv0_path);
                joinpath(argv0_path, tmpbuffer);
            }
            linklen = _Py_wreadlink(argv0_path, tmpbuffer, 1024);
        }
    }
...
# 633 "getpath.c"
    ...
    if (pfound > 0) {
        ...
        wcsncpy(zip_path, _prefix, 1024);
    joinpath(zip_path, L"lib/python00.zip");
    bufsz = wcslen(zip_path);
    zip_path[bufsz - 6] = "2.1"[0];
    zip_path[bufsz - 5] = "2.1"[2];
    ...
    while (1) {
        wchar_t *delim = wcschr(defpath, L':');
    ...
    if (buf == ((void *)0)) {
        ...
        fprintf(__stderrp, "Not enough memory for dynamic PYTHONPATH.\n");
        fprintf(__stderrp, "Using default static PYTHONPATH.\n");
        module_search_path = L"" "/usr/local" "/lib/python" "2.1" ":" "/usr/local" "/lib/python" "2.1" "/lib-dynload";
    }
    else {
