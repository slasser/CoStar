...
# 5 "tokenizer.c" 2
# 1 "/Users/parrt/tmp/Python-3.3.1/Include/pgenheaders.h" 1
# 10 "/Users/parrt/tmp/Python-3.3.1/Include/pgenheaders.h"
# 1 "/Users/parrt/tmp/Python-3.3.1/Include/Python.h" 1
# 11 "/Users/parrt/tmp/Python-3.3.1/Include/pgenheaders.h" 2
...
tok_new(void)
{
    struct tok_state *tok = (struct tok_state *)((size_t)(sizeof(struct tok_state)) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc((sizeof(struct tok_state)) ? (sizeof(struct tok_state)) : 1));

    if (tok == ((void *)0))
        return ((void *)0);
    tok->buf = tok->cur = tok->end = tok->inp = tok->start = ((void *)0);
    tok->done = 10;
    tok->fp = ((void *)0);
    tok->input = ((void *)0);
    tok->tabsize = 8;
    ...
    tok->atbol = 1;
    tok->pendin = 0;
    tok->prompt = tok->nextprompt = ((void *)0);
    tok->lineno = 0;
    tok->level = 0;
    tok->altwarning = 1;
    tok->alterror = 1;
...
{
    char* result = (char *)((size_t)(len + 1) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc((len + 1) ? (len + 1) : 1));
    if (result != ((void *)0)) {
        ((__builtin_object_size (result, 0) != (size_t) -1) ? __builtin___memcpy_chk (result, s, len, __builtin_object_size (result, 0)) : __inline_memcpy_chk (result, s, len));
        result[len] = '\0';
    }
    return result;
}
...
error_ret(struct tok_state *tok)
{
    ...
    if (tok->fp != ((void *)0) && tok->buf != ((void *)0))
        free(tok->buf);
    tok->buf = ((void *)0);
    return ((void *)0);
}
...
get_coding_spec(const char *s, Py_ssize_t size)
{
    ...
    for (; i < size - 6; i++) {
        ...
        if (strncmp(t, "coding", 6) == 0) {
            ...
            begin = t;
            while ((_Py_ctype_table[((unsigned char)((t[0]) & 0xff))] & ((0x01|0x02)|0x04)) ||
                   t[0] == '-' || t[0] == '_' || t[0] == '.')
                t++;
                  ...
                  int set_readline(struct tok_state *, const char *))
{
    ...
    if (cs != ((void *)0)) {
        ...
        if (tok->encoding == ((void *)0)) {
            (__builtin_expect(!(tok->decoding_state == STATE_RAW), 0) ? __assert_rtn(__func__, "tokenizer.c", 285, "tok->decoding_state == STATE_RAW") : (void)0);
...
fp_readl(char *s, int size, struct tok_state *tok)
{
    ...
    (__builtin_expect(!(size > 0), 0) ? __assert_rtn(__func__, "tokenizer.c", 398, "size > 0") : (void)0);
    size--;

    if (tok->decoding_buffer) {
        bufobj = tok->decoding_buffer;
        ( ((PyObject*)(bufobj))->ob_refcnt++);
    }
    else
    {
        bufobj = PyObject_CallObject(tok->decoding_readline, ((void *)0));
        if (bufobj == ((void *)0))
            goto error;
    }
    if (((((PyObject*)(bufobj))->ob_type) == &PyUnicode_Type))
    {
    ...
    else
    {
        ...
        buflen = ((__builtin_expect(!(((((PyObject*)(bufobj))->ob_type) == (&PyByteArray_Type) || PyType_IsSubtype((((PyObject*)(bufobj))->ob_type), (&PyByteArray_Type)))), 0) ? __assert_rtn(__func__, "tokenizer.c", 424, "PyByteArray_Check(bufobj)") : (void)0),(((PyVarObject*)(bufobj))->ob_size));
    }

    do { if ((tok->decoding_buffer) == ((void *)0)) ; else do { if ( --((PyObject*)(tok->decoding_buffer))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tok->decoding_buffer)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tok->decoding_buffer)))); } while (0); } while (0);
    if (buflen > size) {

        tok->decoding_buffer = PyByteArray_FromStringAndSize(buf+size,
                                                         buflen-size);
        if (tok->decoding_buffer == ((void *)0))
            goto error;
        buflen = size;
    }
    else
    ...
    ((__builtin_object_size (s, 0) != (size_t) -1) ? __builtin___memcpy_chk (s, buf, buflen, __builtin_object_size (s, 0)) : __inline_memcpy_chk (s, buf, buflen));
    s[buflen] = '\0';
    if (buflen == 0)
        s = ((void *)0);
    do { if ( --((PyObject*)(bufobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(bufobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(bufobj)))); } while (0);
    return s;

error:
    do { if ((bufobj) == ((void *)0)) ; else do { if ( --((PyObject*)(bufobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(bufobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(bufobj)))); } while (0); } while (0);
...
{
    PyObject *readline = ((void *)0), *stream = ((void *)0), *io = ((void *)0);
    ...
    fd = fileno(tok->fp);
    if (lseek(fd, 0, 0) == (off_t)-1) {
        PyErr_SetFromErrnoWithFilename(PyExc_OSError, ((void *)0));
        goto cleanup;
    }

    stream = _PyObject_CallMethodId(io, &PyId_open, "isisOOO",
                    fd, "r", -1, enc, (&_Py_NoneStruct), (&_Py_NoneStruct), ((PyObject *) &_Py_FalseStruct));
    if (stream == ((void *)0))
        goto cleanup;

    do { if ((tok->decoding_readline) == ((void *)0)) ; else do { if ( --((PyObject*)(tok->decoding_readline))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tok->decoding_readline)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tok->decoding_readline)))); } while (0); } while (0);
  ...
  cleanup:
    ...
    do { if ((io) == ((void *)0)) ; else do { if ( --((PyObject*)(io))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(io)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(io)))); } while (0); } while (0);
    return readline != ((void *)0);
}
    ...
    for (;;) {
        if (tok->decoding_state == STATE_NORMAL) {
            ...
            if (!check_bom(fp_getc, fp_ungetc, fp_setreadl, tok))
                return error_ret(tok);
            (__builtin_expect(!(tok->decoding_state != STATE_INIT), 0) ? __assert_rtn(__func__, "tokenizer.c", 567, "tok->decoding_state != STATE_INIT") : (void)0);
        }
    }
    if (line != ((void *)0) && tok->lineno < 2 && !tok->read_coding_spec) {
...
decoding_feof(struct tok_state *tok)
{
    if (tok->decoding_state != STATE_NORMAL) {
        ...
        if (buf == ((void *)0)) {
            buf = PyObject_CallObject(tok->decoding_readline, ((void *)0));
            if (buf == ((void *)0)) {
                error_ret(tok);
                return 1;
            } else {
...
buf_getc(struct tok_state *tok) {
    return ((unsigned char)((*tok->str++) & 0xff));
}
...
buf_ungetc(int c, struct tok_state *tok) {
    tok->str--;
    (__builtin_expect(!(((unsigned char)((*tok->str) & 0xff)) == c), 0) ? __assert_rtn(__func__, "tokenizer.c", 634, "Py_CHARMASK(*tok->str) == c") : (void)0);
}
...
translate_into_utf8(const char* str, const char* enc) {
    PyObject *utf8;
    PyObject* buf = PyUnicode_Decode(str, strlen(str), enc, ((void *)0));
    if (buf == ((void *)0))
        return ((void *)0);
...
translate_newlines(const char *s, int exec_input, struct tok_state *tok) {
    ...
    char *buf, *current;
    char c = '\0';
    buf = ((size_t)(needed_length) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc((needed_length) ? (needed_length) : 1));
    if (buf == ((void *)0)) {
        tok->done = 15;
        return ((void *)0);
    }
    ...
    *current = '\0';
    ...
    if (final_length < needed_length && final_length)
        ...
        buf = ((size_t)(final_length) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : realloc((buf), (final_length) ? (final_length) : 1));
    return buf;
}
...
{
    PyObject* utf8 = ((void *)0);
    const char *str;
    const char *s;
    const char *newl[2] = {((void *)0), ((void *)0)};
    int lineno = 0;
    ...
    if (!check_bom(buf_getc, buf_ungetc, buf_setreadl, tok))
        return error_ret(tok);
    str = tok->str;
    (__builtin_expect(!(str), 0) ? __assert_rtn(__func__, "tokenizer.c", 721, "str") : (void)0);
    if (tok->enc != ((void *)0)) {
    ...
    for (s = str;; s++) {
        if (*s == '\0') break;
            ...
            (__builtin_expect(!(lineno < 2), 0) ? __assert_rtn(__func__, "tokenizer.c", 731, "lineno < 2") : (void)0);
            newl[lineno] = s;
            lineno++;
            if (lineno == 2) break;
        }
    ...
    if (tok->enc != ((void *)0)) {
        (__builtin_expect(!(utf8 == ((void *)0)), 0) ? __assert_rtn(__func__, "tokenizer.c", 750, "utf8 == NULL") : (void)0);
        utf8 = translate_into_utf8(str, tok->enc);
        if (utf8 == ((void *)0))
            return error_ret(tok);
        str = ((__builtin_expect(!(((((((PyObject*)(utf8))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "tokenizer.c", 754, "PyBytes_Check(utf8)") : (void)0), (((PyBytesObject *)(utf8))->ob_sval));
    }
    (__builtin_expect(!(tok->decoding_buffer == ((void *)0)), 0) ? __assert_rtn(__func__, "tokenizer.c", 756, "tok->decoding_buffer == NULL") : (void)0);
...
PyTokenizer_FromUTF8(const char *str, int exec_input)
{
    ...
    tok->enc = ((void *)0);
    tok->str = str;
    tok->encoding = (char *)((size_t)(6) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc((6) ? (6) : 1));
    if (!tok->encoding) {
        PyTokenizer_Free(tok);
        return ((void *)0);
    }
    ((__builtin_object_size (tok->encoding, 0) != (size_t) -1) ? __builtin___strcpy_chk (tok->encoding, "utf-8", __builtin_object_size (tok->encoding, 2 > 1)) : __inline_strcpy_chk (tok->encoding, "utf-8"));
...
PyTokenizer_FromFile(FILE *fp, char* enc, char *ps1, char *ps2)
{
    ...
    if (tok == ((void *)0))
        return ((void *)0);
    if ((tok->buf = (char *)((size_t)(1024) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc((1024) ? (1024) : 1))) == ((void *)0)) {
        PyTokenizer_Free(tok);
        return ((void *)0);
    }
    tok->cur = tok->inp = tok->buf;
    tok->end = tok->buf + 1024;
    tok->fp = fp;
    tok->prompt = ps1;
    tok->nextprompt = ps2;
    if (enc != ((void *)0)) {
        ...
        tok->encoding = ((size_t)(strlen(enc)+1) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc((strlen(enc)+1) ? (strlen(enc)+1) : 1));
        if (!tok->encoding) {
            PyTokenizer_Free(tok);
            return ((void *)0);
        }
        ((__builtin_object_size (tok->encoding, 0) != (size_t) -1) ? __builtin___strcpy_chk (tok->encoding, enc, __builtin_object_size (tok->encoding, 2 > 1)) : __inline_strcpy_chk (tok->encoding, enc));
        tok->decoding_state = STATE_NORMAL;
    }
    return tok;
}
...
PyTokenizer_Free(struct tok_state *tok)
{
    ...
    do { if ((tok->decoding_readline) == ((void *)0)) ; else do { if ( --((PyObject*)(tok->decoding_readline))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tok->decoding_readline)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tok->decoding_readline)))); } while (0); } while (0);
    do { if ((tok->decoding_buffer) == ((void *)0)) ; else do { if ( --((PyObject*)(tok->decoding_buffer))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tok->decoding_buffer)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tok->decoding_buffer)))); } while (0); } while (0);
    do { if ((tok->filename) == ((void *)0)) ; else do { if ( --((PyObject*)(tok->filename))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tok->filename)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tok->filename)))); } while (0); } while (0);
...
tok_nextc(register struct tok_state *tok)
{
    for (;;) {
        if (tok->cur != tok->inp) {
            return ((unsigned char)((*tok->cur++) & 0xff));
        }
        if (tok->done != 10)
            return (-1);
        if (tok->fp == ((void *)0)) {
        ...
        if (tok->prompt != ((void *)0)) {
            char *newtok = PyOS_Readline(__stdinp, __stdoutp, tok->prompt);
            ...
            if (tok->encoding && newtok && *newtok) {
                ...
                buflen = ((__builtin_expect(!(((((((PyObject*)(u))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "tokenizer.c", 911, "PyBytes_Check(u)") : (void)0),(((PyVarObject*)(u))->ob_size));
                buf = ((__builtin_expect(!(((((((PyObject*)(u))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "tokenizer.c", 912, "PyBytes_Check(u)") : (void)0), (((PyBytesObject *)(u))->ob_sval));
                if (!buf) {
                    do { if ( --((PyObject*)(u))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(u)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(u)))); } while (0);
                    tok->done = 22;
                    return (-1);
                }
                newtok = ((size_t)(buflen+1) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc((buflen+1) ? (buflen+1) : 1));
                ((__builtin_object_size (newtok, 0) != (size_t) -1) ? __builtin___strcpy_chk (newtok, buf, __builtin_object_size (newtok, 2 > 1)) : __inline_strcpy_chk (newtok, buf));
                do { if ( --((PyObject*)(u))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(u)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(u)))); } while (0);
            }

            if (tok->nextprompt != ((void *)0))
            ...
            if (newtok == ((void *)0))
            ...
            else if (tok->start != ((void *)0)) {
                size_t start = tok->start - tok->buf;
                size_t oldlen = tok->cur - tok->buf;
                size_t newlen = oldlen + strlen(newtok);
                char *buf = tok->buf;
                buf = (char *)((size_t)(newlen+1) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : realloc((buf), (newlen+1) ? (newlen+1) : 1));
                tok->lineno++;
                if (buf == ((void *)0)) {
                    free(tok->buf);
                    tok->buf = ((void *)0);
                ...
                tok->line_start = tok->cur;
                ((__builtin_object_size (tok->buf + oldlen, 0) != (size_t) -1) ? __builtin___strcpy_chk (tok->buf + oldlen, newtok, __builtin_object_size (tok->buf + oldlen, 2 > 1)) : __inline_strcpy_chk (tok->buf + oldlen, newtok));
                free(newtok);
            ...
            if (tok->start == ((void *)0)) {
                if (tok->buf == ((void *)0)) {
                    tok->buf = (char *)
                        ((size_t)(1024) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc((1024) ? (1024) : 1));
                    if (tok->buf == ((void *)0)) {
                        tok->done = 15;
                        return (-1);
                    }
            ...
            while (!done) {
                Py_ssize_t curstart = tok->start == ((void *)0) ? -1 :
                          tok->start - tok->buf;
                Py_ssize_t curvalid = tok->inp - tok->buf;
                Py_ssize_t newsize = curvalid + 1024;
                char *newbuf = tok->buf;
                newbuf = (char *)((size_t)(newsize) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : realloc((newbuf), (newsize) ? (newsize) : 1));
...
verify_identifier(struct tok_state *tok)
{
    PyObject *s;
    int result;
    s = PyUnicode_DecodeUTF8(tok->start, tok->cur - tok->start, ((void *)0));
    if (s == ((void *)0) || ((__builtin_expect(!(((((((PyObject*)(s))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "tokenizer.c", 1272, "PyUnicode_Check(s)") : (void)0), ((((PyASCIIObject*)s)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(s)))) == -1) {
...
tok_get(register struct tok_state *tok, char **p_start, char **p_end)
{
 ...
 again:
    ...
    if (( (c >= 'a' && c <= 'z') || (c >= 'A' && c <= 'Z') || c == '_' || (c >= 128))) {
        ...
        while (( (c >= 'a' && c <= 'z') || (c >= 'A' && c <= 'Z') || (c >= '0' && c <= '9') || c == '_' || (c >= 128))) {
            if (c >= 128)
                nonascii = 1;
            c = tok_nextc(tok);
        }
...
PyTokenizer_FindEncodingFilename(int fd, PyObject *filename)
{
    struct tok_state *tok;
    FILE *fp;
    char *p_start =((void *)0) , *p_end =((void *)0) , *encoding = ((void *)0);
    ...
    tok = PyTokenizer_FromFile(fp, ((void *)0), ((void *)0), ((void *)0));
    if (tok == ((void *)0)) {
        fclose(fp);
        return ((void *)0);
    }
    ...
    while (tok->lineno < 2 && tok->done == 10) {
        PyTokenizer_Get(tok, &p_start, &p_end);
    }
    fclose(fp);
    if (tok->encoding) {
        encoding = (char *)((size_t)(strlen(tok->encoding) + 1) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc((strlen(tok->encoding) + 1) ? (strlen(tok->encoding) + 1) : 1));
        if (encoding)
        ((__builtin_object_size (encoding, 0) != (size_t) -1) ? __builtin___strcpy_chk (encoding, tok->encoding, __builtin_object_size (encoding, 2 > 1)) : __inline_strcpy_chk (encoding, tok->encoding));
    }
    PyTokenizer_Free(tok);
    return encoding;
}
...
{
    return PyTokenizer_FindEncodingFilename(fd, ((void *)0));
}
