...
static unsigned long smallmax[] = {
    0,
    0,
    (9223372036854775807L * 2UL + 1UL) / 2,
    (9223372036854775807L * 2UL + 1UL) / 3,
    (9223372036854775807L * 2UL + 1UL) / 4,
    (9223372036854775807L * 2UL + 1UL) / 5,
    (9223372036854775807L * 2UL + 1UL) / 6,
    (9223372036854775807L * 2UL + 1UL) / 7,
    (9223372036854775807L * 2UL + 1UL) / 8,
    (9223372036854775807L * 2UL + 1UL) / 9,
    (9223372036854775807L * 2UL + 1UL) / 10,
    (9223372036854775807L * 2UL + 1UL) / 11,
    (9223372036854775807L * 2UL + 1UL) / 12,
    (9223372036854775807L * 2UL + 1UL) / 13,
    (9223372036854775807L * 2UL + 1UL) / 14,
    (9223372036854775807L * 2UL + 1UL) / 15,
    (9223372036854775807L * 2UL + 1UL) / 16,
    (9223372036854775807L * 2UL + 1UL) / 17,
    (9223372036854775807L * 2UL + 1UL) / 18,
    (9223372036854775807L * 2UL + 1UL) / 19,
    (9223372036854775807L * 2UL + 1UL) / 20,
    (9223372036854775807L * 2UL + 1UL) / 21,
    (9223372036854775807L * 2UL + 1UL) / 22,
    (9223372036854775807L * 2UL + 1UL) / 23,
    (9223372036854775807L * 2UL + 1UL) / 24,
    (9223372036854775807L * 2UL + 1UL) / 25,
    (9223372036854775807L * 2UL + 1UL) / 26,
    (9223372036854775807L * 2UL + 1UL) / 27,
    (9223372036854775807L * 2UL + 1UL) / 28,
    (9223372036854775807L * 2UL + 1UL) / 29,
    (9223372036854775807L * 2UL + 1UL) / 30,
    (9223372036854775807L * 2UL + 1UL) / 31,
    (9223372036854775807L * 2UL + 1UL) / 32,
    (9223372036854775807L * 2UL + 1UL) / 33,
    (9223372036854775807L * 2UL + 1UL) / 34,
    (9223372036854775807L * 2UL + 1UL) / 35,
    (9223372036854775807L * 2UL + 1UL) / 36,
};
# 72 "mystrtoul.c"
...
PyOS_strtoul(register char *str, char **ptr, int base)
{
    ...
    case 0:
        if (*str == '0') {
            ...
            if (*str == 'x' || *str == 'X') {
                ...
                if (_PyLong_DigitValue[((unsigned char)((str[1]) & 0xff))] >= 16) {
                    if (ptr)
                        *ptr = str;
                    return 0;
                }
                ...
                if (_PyLong_DigitValue[((unsigned char)((str[1]) & 0xff))] >= 8) {
                    if (ptr)
                        *ptr = str;
                    return 0;
                }
                ...
                if (_PyLong_DigitValue[((unsigned char)((str[1]) & 0xff))] >= 2) {
                    if (ptr)
                        *ptr = str;
                    return 0;
                }
                ...
                while (*str == '0')
                    ++str;
                while ((_Py_ctype_table[((unsigned char)((((unsigned char)((*str) & 0xff))) & 0xff))] & 0x08))
                    ++str;
                if (ptr)
                    *ptr = str;
                return 0;
    ...
    while ((c = _PyLong_DigitValue[((unsigned char)((*str) & 0xff))]) < base) {
        if (ovlimit > 0)
...
overflowed:
    if (ptr) {
        ...
        while (_PyLong_DigitValue[((unsigned char)((*str) & 0xff))] < base)
            ++str;
        *ptr = str;
    }
    (*__error()) = 34;
...
PyOS_strtol(char *str, char **ptr, int base)
{
    ...
    if (uresult <= (unsigned long)9223372036854775807L) {
        result = (long)uresult;
        if (sign == '-')
            result = -result;
    }
    else if (sign == '-' && uresult == (0-(unsigned long)(-9223372036854775807L - 1L))) {
