...
sinpi(double x)
{
    ...
    (__builtin_expect(!(( sizeof (x) == sizeof(float ) ? __inline_isfinitef((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isfinited((double)(x)) : __inline_isfinite ((long double)(x)))), 0) ? __assert_rtn(__func__, "mathmodule.c", 75, "Py_IS_FINITE(x)") : (void)0);
    y = fmod(fabs(x), 2.0);
    n = (int)round(2.0*y);
    (__builtin_expect(!(0 <= n && n <= 4), 0) ? __assert_rtn(__func__, "mathmodule.c", 78, "0 <= n && n <= 4") : (void)0);
    switch (n) {
    case 0:
        r = sin(pi*y);
        break;
    ...
    case 4:
        ...
        break;
    default:
        (__builtin_expect(!(0), 0) ? __assert_rtn(__func__, "mathmodule.c", 98, "0") : (void)0);
        r = -1.23e200;
    }
...
static const double lanczos_num_coeffs[13] = {
...
static const double lanczos_den_coeffs[13] = {
    0.0, 39916800.0, 120543840.0, 150917976.0, 105258076.0, 45995730.0,
    13339535.0, 2637558.0, 357423.0, 32670.0, 1925.0, 66.0, 1.0};



static const double gamma_integral[23] = {
...
lanczos_sum(double x)
{
    ...
    int i;
    (__builtin_expect(!(x > 0.0), 0) ? __assert_rtn(__func__, "mathmodule.c", 202, "x > 0.0") : (void)0);
# 211 "mathmodule.c"
    if (x < 5.0) {
        for (i = 13; --i >= 0; ) {
...
m_tgamma(double x)
{
    ...
    if (!( sizeof (x) == sizeof(float ) ? __inline_isfinitef((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isfinited((double)(x)) : __inline_isfinite ((long double)(x)))) {
        if (( sizeof (x) == sizeof(float ) ? __inline_isnanf((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isnand((double)(x)) : __inline_isnan ((long double)(x))) || x > 0.0)
            return x;
        else {
            (*__error()) = 33;
            return (__builtin_huge_val() * 0.);
        }
    }
    if (x == 0.0) {
        (*__error()) = 33;

        return copysign(__builtin_huge_val(), x);
    }
    ...
    if (absx < 1e-20) {
        r = 1.0/x;
        if (( sizeof (r) == sizeof(float ) ? __inline_isinff((float)(r)) : sizeof (r) == sizeof(double) ? __inline_isinfd((double)(r)) : __inline_isinf ((long double)(r))))
            (*__error()) = 34;
        return r;
    }
...
m_lgamma(double x)
{
    ...
    if (!( sizeof (x) == sizeof(float ) ? __inline_isfinitef((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isfinited((double)(x)) : __inline_isfinite ((long double)(x)))) {
        if (( sizeof (x) == sizeof(float ) ? __inline_isnanf((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isnand((double)(x)) : __inline_isnan ((long double)(x))))
            return x;
        else
            return __builtin_huge_val();
    }
...
{
    if (( sizeof (x) == sizeof(float ) ? __inline_isnanf((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isnand((double)(x)) : __inline_isnan ((long double)(x))) || ( sizeof (y) == sizeof(float ) ? __inline_isnanf((float)(y)) : sizeof (y) == sizeof(double) ? __inline_isnand((double)(y)) : __inline_isnan ((long double)(y))))
        return (__builtin_huge_val() * 0.);
    if (( sizeof (y) == sizeof(float ) ? __inline_isinff((float)(y)) : sizeof (y) == sizeof(double) ? __inline_isinfd((double)(y)) : __inline_isinf ((long double)(y)))) {
        if (( sizeof (x) == sizeof(float ) ? __inline_isinff((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isinfd((double)(x)) : __inline_isinf ((long double)(x)))) {
            if (copysign(1., x) == 1.)

                return copysign(0.25*3.14159265358979323846, y);
            else

                return copysign(0.75*3.14159265358979323846, y);
        }

        return copysign(0.5*3.14159265358979323846, y);
    }
    if (( sizeof (x) == sizeof(float ) ? __inline_isinff((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isinfd((double)(x)) : __inline_isinf ((long double)(x))) || y == 0.) {
        if (copysign(1., x) == 1.)

            return copysign(0., y);
        else

            return copysign(3.14159265358979323846, y);
    }
    return atan2(y, x);
}
# 559 "mathmodule.c"
...
m_log(double x)
{
    ...
    else if (( sizeof (x) == sizeof(float ) ? __inline_isnanf((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isnand((double)(x)) : __inline_isnan ((long double)(x))))
        return x;
    else if (x > 0.0)
        return x;
    else {
...
{
    int result = 1;
    (__builtin_expect(!((*__error())), 0) ? __assert_rtn(__func__, "mathmodule.c", 667, "errno") : (void)0);
    if ((*__error()) == 33)
                   ...
                   int can_overflow)
{
    ...
    r = (*func)(x);
    ;
    if (( sizeof (r) == sizeof(float ) ? __inline_isnanf((float)(r)) : sizeof (r) == sizeof(double) ? __inline_isnand((double)(r)) : __inline_isnan ((long double)(r))) && !( sizeof (x) == sizeof(float ) ? __inline_isnanf((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isnand((double)(x)) : __inline_isnan ((long double)(x)))) {
        PyErr_SetString(PyExc_ValueError,
                        "math domain error");
        return ((void *)0);
    }
    if (( sizeof (r) == sizeof(float ) ? __inline_isinff((float)(r)) : sizeof (r) == sizeof(double) ? __inline_isinfd((double)(r)) : __inline_isinf ((long double)(r))) && ( sizeof (x) == sizeof(float ) ? __inline_isfinitef((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isfinited((double)(x)) : __inline_isfinite ((long double)(x)))) {
        if (can_overflow)
            PyErr_SetString(PyExc_OverflowError,
                            "math range error");
        else
    ...
    if (( sizeof (r) == sizeof(float ) ? __inline_isfinitef((float)(r)) : sizeof (r) == sizeof(double) ? __inline_isfinited((double)(r)) : __inline_isfinite ((long double)(r))) && (*__error()) && is_error(r))
...
math_2(PyObject *args, double (*func) (double, double), char *funcname)
{
    ...
    r = (*func)(x, y);
    ;
    if (( sizeof (r) == sizeof(float ) ? __inline_isnanf((float)(r)) : sizeof (r) == sizeof(double) ? __inline_isnand((double)(r)) : __inline_isnan ((long double)(r)))) {
        if (!( sizeof (x) == sizeof(float ) ? __inline_isnanf((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isnand((double)(x)) : __inline_isnan ((long double)(x))) && !( sizeof (y) == sizeof(float ) ? __inline_isnanf((float)(y)) : sizeof (y) == sizeof(double) ? __inline_isnand((double)(y)) : __inline_isnan ((long double)(y))))
            (*__error()) = 33;
        else
            (*__error()) = 0;
    }
    else if (( sizeof (r) == sizeof(float ) ? __inline_isinff((float)(r)) : sizeof (r) == sizeof(double) ? __inline_isinfd((double)(r)) : __inline_isinf ((long double)(r)))) {
        if (( sizeof (x) == sizeof(float ) ? __inline_isfinitef((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isfinited((double)(x)) : __inline_isfinite ((long double)(x))) && ( sizeof (y) == sizeof(float ) ? __inline_isfinitef((float)(y)) : sizeof (y) == sizeof(double) ? __inline_isfinited((double)(y)) : __inline_isfinite ((long double)(y))))
            (*__error()) = 34;
        else
            (*__error()) = 0;
    }
...
# 873 "mathmodule.c"
static PyObject * math_acos(PyObject *self, PyObject *args) { return math_1(args, acos, 0); } static char math_acos_doc[] = "acos(x)\n\nReturn the arc cosine (measured in radians) of x.";

static PyObject * math_acosh(PyObject *self, PyObject *args) { return math_1(args, acosh, 0); } static char math_acosh_doc[] = "acosh(x)\n\nReturn the hyperbolic arc cosine (measured in radians) of x.";

static PyObject * math_asin(PyObject *self, PyObject *args) { return math_1(args, asin, 0); } static char math_asin_doc[] = "asin(x)\n\nReturn the arc sine (measured in radians) of x.";

static PyObject * math_asinh(PyObject *self, PyObject *args) { return math_1(args, asinh, 0); } static char math_asinh_doc[] = "asinh(x)\n\nReturn the hyperbolic arc sine (measured in radians) of x.";

static PyObject * math_atan(PyObject *self, PyObject *args) { return math_1(args, atan, 0); } static char math_atan_doc[] = "atan(x)\n\nReturn the arc tangent (measured in radians) of x.";
...
static PyObject * math_atanh(PyObject *self, PyObject *args) { return math_1(args, atanh, 0); } static char math_atanh_doc[] = "atanh(x)\n\nReturn the hyperbolic arc tangent (measured in radians) of x.";


static PyObject * math_ceil(PyObject *self, PyObject *number) {
    static _Py_Identifier PyId___ceil__ = { 0, "__ceil__", 0 };
    ...
    result = PyObject_CallFunctionObjArgs(method, ((void *)0));
...
static PyObject * math_copysign(PyObject *self, PyObject *args) { return math_2(args, copysign, "copysign"); } static char math_copysign_doc[] = "copysign(x, y)\n\nReturn x with the sign of y.";

static PyObject * math_cos(PyObject *self, PyObject *args) { return math_1(args, cos, 0); } static char math_cos_doc[] = "cos(x)\n\nReturn the cosine of x (measured in radians).";

static PyObject * math_cosh(PyObject *self, PyObject *args) { return math_1(args, cosh, 1); } static char math_cosh_doc[] = "cosh(x)\n\nReturn the hyperbolic cosine of x.";

static PyObject * math_erf(PyObject *self, PyObject *args) { return math_1a(args, m_erf); } static char math_erf_doc[] = "erf(x)\n\nError function at x.";

static PyObject * math_erfc(PyObject *self, PyObject *args) { return math_1a(args, m_erfc); } static char math_erfc_doc[] = "erfc(x)\n\nComplementary error function at x.";

static PyObject * math_exp(PyObject *self, PyObject *args) { return math_1(args, exp, 1); } static char math_exp_doc[] = "exp(x)\n\nReturn e raised to the power of x.";
...
static PyObject * math_fabs(PyObject *self, PyObject *args) { return math_1(args, fabs, 0); } static char math_fabs_doc[] = "fabs(x)\n\nReturn the absolute value of the float x.";


static PyObject * math_floor(PyObject *self, PyObject *number) {
    static _Py_Identifier PyId___floor__ = { 0, "__floor__", 0 };
    PyObject *method, *result;
...
static PyObject * math_gamma(PyObject *self, PyObject *args) { return math_1a(args, m_tgamma); } static char math_gamma_doc[] = "gamma(x)\n\nGamma function at x.";

static PyObject * math_lgamma(PyObject *self, PyObject *args) { return math_1a(args, m_lgamma); } static char math_lgamma_doc[] = "lgamma(x)\n\nNatural logarithm of absolute value of Gamma function at x.";

static PyObject * math_log1p(PyObject *self, PyObject *args) { return math_1(args, _Py_log1p, 0); } static char math_log1p_doc[] = "log1p(x)\n\nReturn the natural logarithm of 1+x (base e).\n" "The result is computed in a way which is accurate for x near zero.";


static PyObject * math_sin(PyObject *self, PyObject *args) { return math_1(args, sin, 0); } static char math_sin_doc[] = "sin(x)\n\nReturn the sine of x (measured in radians).";

static PyObject * math_sinh(PyObject *self, PyObject *args) { return math_1(args, sinh, 1); } static char math_sinh_doc[] = "sinh(x)\n\nReturn the hyperbolic sine of x.";

static PyObject * math_sqrt(PyObject *self, PyObject *args) { return math_1(args, sqrt, 0); } static char math_sqrt_doc[] = "sqrt(x)\n\nReturn the square root of x.";

static PyObject * math_tan(PyObject *self, PyObject *args) { return math_1(args, tan, 0); } static char math_tan_doc[] = "tan(x)\n\nReturn the tangent of x (measured in radians).";

static PyObject * math_tanh(PyObject *self, PyObject *args) { return math_1(args, tanh, 0); } static char math_tanh_doc[] = "tanh(x)\n\nReturn the hyperbolic tangent of x.";
# 1003 "mathmodule.c"
static int
             ...
             double *ps, Py_ssize_t *m_ptr)
{
    ...
    m += m;
    if (n < m && m < (((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(double))) {
        double *p = *p_ptr;
        if (p == ps) {
            v = PyMem_Malloc(sizeof(double) * m);
            if (v != ((void *)0))
                ((__builtin_object_size (v, 0) != (size_t) -1) ? __builtin___memcpy_chk (v, ps, sizeof(double) * n, __builtin_object_size (v, 0)) : __inline_memcpy_chk (v, ps, sizeof(double) * n));
        }
        else
...
{
    PyObject *item, *iter, *sum = ((void *)0);
    Py_ssize_t i, j, n = 0, m = 32;
    double x, y, t, ps[32], *p = ps;
    ...
    for(;;) {
        (__builtin_expect(!(0 <= n && n <= m), 0) ? __assert_rtn(__func__, "mathmodule.c", 1076, "0 <= n && n <= m") : (void)0);
        (__builtin_expect(!((m == 32 && p == ps) || (m > 32 && p != ((void *)0))), 0) ? __assert_rtn(__func__, "mathmodule.c", 1078, "(m == NUM_PARTIALS && p == ps) || (m > NUM_PARTIALS && p != NULL)") : (void)0);
        ...
        if (x != 0.0) {
            if (! ( sizeof (x) == sizeof(float ) ? __inline_isfinitef((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isfinited((double)(x)) : __inline_isfinite ((long double)(x)))) {
                ...
                if (( sizeof (xsave) == sizeof(float ) ? __inline_isfinitef((float)(xsave)) : sizeof (xsave) == sizeof(double) ? __inline_isfinited((double)(xsave)) : __inline_isfinite ((long double)(xsave)))) {
                    PyErr_SetString(PyExc_OverflowError,
                          "intermediate overflow in fsum");
                    goto _fsum_error;
                }
                if (( sizeof (xsave) == sizeof(float ) ? __inline_isinff((float)(xsave)) : sizeof (xsave) == sizeof(double) ? __inline_isinfd((double)(xsave)) : __inline_isinf ((long double)(xsave))))
                    inf_sum += xsave;
                special_sum += xsave;
    ...
    if (special_sum != 0.0) {
        if (( sizeof (inf_sum) == sizeof(float ) ? __inline_isnanf((float)(inf_sum)) : sizeof (inf_sum) == sizeof(double) ? __inline_isnand((double)(inf_sum)) : __inline_isnan ((long double)(inf_sum))))
            PyErr_SetString(PyExc_ValueError,
                            "-inf + inf in fsum");
        else
    ...
    if (n > 0) {
        ...
        while (n > 0) {
            x = hi;
            y = p[--n];
            (__builtin_expect(!(fabs(y) < fabs(x)), 0) ? __assert_rtn(__func__, "mathmodule.c", 1147, "fabs(y) < fabs(x)") : (void)0);
            hi = x + y;
            yr = hi - x;
            lo = y - yr;
            if (lo != 0.0)
                          ...
                          unsigned long max_bits)
{
    ...
    PyObject *left = ((void *)0), *right = ((void *)0), *result = ((void *)0);
# 1310 "mathmodule.c"
    num_operands = (stop - start) / 2;


    if (num_operands <= 8 * 8 &&
        num_operands * max_bits <= 8 * 8) {
  ...
  error:
    do { if ((left) == ((void *)0)) ; else do { if ( --((PyObject*)(left))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(left)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(left)))); } while (0); } while (0);
...
factorial_odd_part(unsigned long n)
{
    ...
    for (i = bit_length(n) - 2; i >= 0; i--) {
        ...
        do { if ( --((PyObject*)(partial))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(partial)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(partial)))); } while (0);
        if (tmp == ((void *)0))
            goto error;
        do { if ( --((PyObject*)(inner))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(inner)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(inner)))); } while (0);
        inner = tmp;
        ...
        if (tmp == ((void *)0))
            goto error;
        do { if ( --((PyObject*)(outer))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(outer)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(outer)))); } while (0);
        outer = tmp;
    }
    do { if ( --((PyObject*)(inner))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(inner)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(inner)))); } while (0);
    return outer;
...
math_factorial(PyObject *self, PyObject *arg)
{
    ...
    if (((((PyObject*)(arg))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(arg))->ob_type), (&PyFloat_Type)))) {
        PyObject *lx;
        double dx = (((PyFloatObject *)((PyFloatObject *)arg))->ob_fval);
        if (!(( sizeof (dx) == sizeof(float ) ? __inline_isfinitef((float)(dx)) : sizeof (dx) == sizeof(double) ? __inline_isfinited((double)(dx)) : __inline_isfinite ((long double)(dx))) && dx == floor(dx))) {
            PyErr_SetString(PyExc_ValueError,
        ...
        if (lx == ((void *)0))
            return ((void *)0);
        x = PyLong_AsLong(lx);
        do { if ( --((PyObject*)(lx))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(lx)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(lx)))); } while (0);
    }
    else
        x = PyLong_AsLong(arg);
    ...
    if (x < (long)(sizeof(SmallFactorials) / sizeof((SmallFactorials)[0]) + (sizeof(char [1 - 2*!(!__builtin_types_compatible_p(typeof(SmallFactorials), typeof(&(SmallFactorials)[0])))]) - 1)))
    ...
    if (two_valuation == ((void *)0)) {
        do { if ( --((PyObject*)(odd_part))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(odd_part)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(odd_part)))); } while (0);
        return ((void *)0);
    }
    result = PyNumber_Lshift(odd_part, two_valuation);
    do { if ( --((PyObject*)(two_valuation))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(two_valuation)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(two_valuation)))); } while (0);
    do { if ( --((PyObject*)(odd_part))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(odd_part)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(odd_part)))); } while (0);
    return result;
}
...
{
    static _Py_Identifier PyId___trunc__ = { 0, "__trunc__", 0 };
    ...
    result = PyObject_CallFunctionObjArgs(trunc, ((void *)0));
    do { if ( --((PyObject*)(trunc))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(trunc)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(trunc)))); } while (0);
    return result;
}
...
math_frexp(PyObject *self, PyObject *arg)
{
    ...
    if (( sizeof (x) == sizeof(float ) ? __inline_isnanf((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isnand((double)(x)) : __inline_isnan ((long double)(x))) || ( sizeof (x) == sizeof(float ) ? __inline_isinff((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isinfd((double)(x)) : __inline_isinf ((long double)(x))) || !x) {
        i = 0;
    }
    else {
        ;
...
math_ldexp(PyObject *self, PyObject *args)
{
    ...
    if (((((((PyObject*)(oexp))->ob_type))->tp_flags & ((1L<<24))) != 0)) {
        ...
        if (exp == -1 && PyErr_Occurred())
            return ((void *)0);
        if (overflow)
            exp = overflow < 0 ? (-9223372036854775807L - 1L) : 9223372036854775807L;
    }
    else {
    ...
    if (x == 0. || !( sizeof (x) == sizeof(float ) ? __inline_isfinitef((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isfinited((double)(x)) : __inline_isfinite ((long double)(x)))) {

        r = x;
        (*__error()) = 0;
    } else if (exp > 2147483647) {

        r = copysign(__builtin_huge_val(), x);
        (*__error()) = 34;
    } else if (exp < (-2147483647 - 1)) {
...
math_log(PyObject *self, PyObject *args)
{
    ...
    do { if ( --((PyObject*)(num))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(num)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(num)))); } while (0);
    do { if ( --((PyObject*)(den))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(den)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(den)))); } while (0);
    return ans;
}
...
static char math_log2_doc[] = "log2(x)\n\nReturn the base 2 logarithm of x.";
...
static char math_log10_doc[] = "log10(x)\n\nReturn the base 10 logarithm of x.";
...
math_fmod(PyObject *self, PyObject *args)
{
    ...
    if (( sizeof (y) == sizeof(float ) ? __inline_isinff((float)(y)) : sizeof (y) == sizeof(double) ? __inline_isinfd((double)(y)) : __inline_isinf ((long double)(y))) && ( sizeof (x) == sizeof(float ) ? __inline_isfinitef((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isfinited((double)(x)) : __inline_isfinite ((long double)(x))))
...
static char math_fmod_doc[] = "fmod(x, y)\n\nReturn fmod(x, y), according to platform C." "  x % y may differ.";
...
static char math_hypot_doc[] = "hypot(x, y)\n\nReturn the Euclidean distance, sqrt(x*x + y*y).";
# 1779 "mathmodule.c"
static PyObject *
math_pow(PyObject *self, PyObject *args)
{
    ...
    if (!( sizeof (x) == sizeof(float ) ? __inline_isfinitef((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isfinited((double)(x)) : __inline_isfinite ((long double)(x))) || !( sizeof (y) == sizeof(float ) ? __inline_isfinitef((float)(y)) : sizeof (y) == sizeof(double) ? __inline_isfinited((double)(y)) : __inline_isfinite ((long double)(y)))) {
        ...
        if (( sizeof (x) == sizeof(float ) ? __inline_isnanf((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isnand((double)(x)) : __inline_isnan ((long double)(x))))
            r = y == 0. ? 1. : x;
        else if (( sizeof (y) == sizeof(float ) ? __inline_isnanf((float)(y)) : sizeof (y) == sizeof(double) ? __inline_isnand((double)(y)) : __inline_isnan ((long double)(y))))
            r = x == 1. ? 1. : y;
        else if (( sizeof (x) == sizeof(float ) ? __inline_isinff((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isinfd((double)(x)) : __inline_isinf ((long double)(x)))) {
            odd_y = ( sizeof (y) == sizeof(float ) ? __inline_isfinitef((float)(y)) : sizeof (y) == sizeof(double) ? __inline_isfinited((double)(y)) : __inline_isfinite ((long double)(y))) && fmod(fabs(y), 2.0) == 1.0;
            if (y > 0.)
                r = odd_y ? x : fabs(x);
            else if (y == 0.)
                r = 1.;
        ...
        else if (( sizeof (y) == sizeof(float ) ? __inline_isinff((float)(y)) : sizeof (y) == sizeof(double) ? __inline_isinfd((double)(y)) : __inline_isinf ((long double)(y)))) {
            if (fabs(x) == 1.0)
                r = 1.;
        ...
        if (!( sizeof (r) == sizeof(float ) ? __inline_isfinitef((float)(r)) : sizeof (r) == sizeof(double) ? __inline_isfinited((double)(r)) : __inline_isfinite ((long double)(r)))) {
            if (( sizeof (r) == sizeof(float ) ? __inline_isnanf((float)(r)) : sizeof (r) == sizeof(double) ? __inline_isnand((double)(r)) : __inline_isnan ((long double)(r)))) {
                (*__error()) = 33;
            }
...
static char math_pow_doc[] = "pow(x, y)\n\nReturn x**y (x to the power of y).";
...
math_isfinite(PyObject *self, PyObject *arg)
{
    ...
    if (x == -1.0 && PyErr_Occurred())
        return ((void *)0);
    return PyBool_FromLong((long)( sizeof (x) == sizeof(float ) ? __inline_isfinitef((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isfinited((double)(x)) : __inline_isfinite ((long double)(x))));
}
...
math_isnan(PyObject *self, PyObject *arg)
{
    ...
    if (x == -1.0 && PyErr_Occurred())
        return ((void *)0);
    return PyBool_FromLong((long)( sizeof (x) == sizeof(float ) ? __inline_isnanf((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isnand((double)(x)) : __inline_isnan ((long double)(x))));
}
...
math_isinf(PyObject *self, PyObject *arg)
{
    ...
    if (x == -1.0 && PyErr_Occurred())
        return ((void *)0);
    return PyBool_FromLong((long)( sizeof (x) == sizeof(float ) ? __inline_isinff((float)(x)) : sizeof (x) == sizeof(double) ? __inline_isinfd((double)(x)) : __inline_isinf ((long double)(x))));
}
...
static PyMethodDef math_methods[] = {
    {"acos", math_acos, 0x0008, math_acos_doc},
    {"acosh", math_acosh, 0x0008, math_acosh_doc},
    {"asin", math_asin, 0x0008, math_asin_doc},
    {"asinh", math_asinh, 0x0008, math_asinh_doc},
    {"atan", math_atan, 0x0008, math_atan_doc},
    {"atan2", math_atan2, 0x0001, math_atan2_doc},
    {"atanh", math_atanh, 0x0008, math_atanh_doc},
    {"ceil", math_ceil, 0x0008, math_ceil_doc},
    {"copysign", math_copysign, 0x0001, math_copysign_doc},
    {"cos", math_cos, 0x0008, math_cos_doc},
    {"cosh", math_cosh, 0x0008, math_cosh_doc},
    {"degrees", math_degrees, 0x0008, math_degrees_doc},
    {"erf", math_erf, 0x0008, math_erf_doc},
    {"erfc", math_erfc, 0x0008, math_erfc_doc},
    {"exp", math_exp, 0x0008, math_exp_doc},
    {"expm1", math_expm1, 0x0008, math_expm1_doc},
    {"fabs", math_fabs, 0x0008, math_fabs_doc},
    {"factorial", math_factorial, 0x0008, math_factorial_doc},
    {"floor", math_floor, 0x0008, math_floor_doc},
    {"fmod", math_fmod, 0x0001, math_fmod_doc},
    {"frexp", math_frexp, 0x0008, math_frexp_doc},
    {"fsum", math_fsum, 0x0008, math_fsum_doc},
    {"gamma", math_gamma, 0x0008, math_gamma_doc},
    {"hypot", math_hypot, 0x0001, math_hypot_doc},
    {"isfinite", math_isfinite, 0x0008, math_isfinite_doc},
    {"isinf", math_isinf, 0x0008, math_isinf_doc},
    {"isnan", math_isnan, 0x0008, math_isnan_doc},
    {"ldexp", math_ldexp, 0x0001, math_ldexp_doc},
    {"lgamma", math_lgamma, 0x0008, math_lgamma_doc},
    {"log", math_log, 0x0001, math_log_doc},
    {"log1p", math_log1p, 0x0008, math_log1p_doc},
    {"log10", math_log10, 0x0008, math_log10_doc},
    {"log2", math_log2, 0x0008, math_log2_doc},
    {"modf", math_modf, 0x0008, math_modf_doc},
    {"pow", math_pow, 0x0001, math_pow_doc},
    {"radians", math_radians, 0x0008, math_radians_doc},
    {"sin", math_sin, 0x0008, math_sin_doc},
    {"sinh", math_sinh, 0x0008, math_sinh_doc},
    {"sqrt", math_sqrt, 0x0008, math_sqrt_doc},
    {"tan", math_tan, 0x0008, math_tan_doc},
    {"tanh", math_tanh, 0x0008, math_tanh_doc},
    {"trunc", math_trunc, 0x0008, math_trunc_doc},
    {((void *)0), ((void *)0)}
};
...
PyInit_math(void)
{
    ...
    m = PyModule_Create2(&mathmodule, 1013);
    if (m == ((void *)0))
        goto finally;

    PyModule_AddObject(m, "pi", PyFloat_FromDouble(3.14159265358979323846));
    PyModule_AddObject(m, "e", PyFloat_FromDouble(2.7182818284590452354));
