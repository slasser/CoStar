...
{
    do { if (((_curses_panelstate *)PyModule_GetState(m))->PyCursesError) { PyObject *_py_tmp = (PyObject *)(((_curses_panelstate *)PyModule_GetState(m))->PyCursesError); (((_curses_panelstate *)PyModule_GetState(m))->PyCursesError) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    return 0;
}
...
{
    do { if (((_curses_panelstate *)PyModule_GetState(m))->PyCursesError) { int vret = visit((PyObject *)(((_curses_panelstate *)PyModule_GetState(m))->PyCursesError), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
PyCursesCheckERR(int code, char *fname)
{
    if (code != (-1)) {
        ...
        if (fname == ((void *)0)) {
            PyErr_SetString(((_curses_panelstate *) PyModule_GetState(PyState_FindModule(&_curses_panelmodule)))->PyCursesError, catchall_ERR);
        } else {
            PyErr_Format(((_curses_panelstate *) PyModule_GetState(PyState_FindModule(&_curses_panelmodule)))->PyCursesError, "%s() returned ERR", fname);
        }
        return ((void *)0);
    }
}
...
insert_lop(PyCursesPanelObject *po)
{
    ...
    if ((new = (list_of_panels *)malloc(sizeof(list_of_panels))) == ((void *)0)) {
        PyErr_NoMemory();
        return -1;
    }
    new->po = po;
...
remove_lop(PyCursesPanelObject *po)
{
    ...
    while (temp->next == ((void *)0) || temp->next->po != po) {
        if (temp->next == ((void *)0)) {
...
find_po(PANEL *pan)
{
    ...
    for (temp = lop; temp->po->pan != pan; temp = temp->next)
        if (temp->next == ((void *)0)) return ((void *)0);
    return temp->po;
}
# 192 "_curses_panel.c"
static PyObject *PyCursesPanel_bottom_panel(PyCursesPanelObject *self) { return PyCursesCheckERR(bottom_panel(self->pan), "bottom_panel"); }
static PyObject *PyCursesPanel_hide_panel(PyCursesPanelObject *self) { return PyCursesCheckERR(hide_panel(self->pan), "hide_panel"); }
static PyObject *PyCursesPanel_show_panel(PyCursesPanelObject *self) { return PyCursesCheckERR(show_panel(self->pan), "show_panel"); }
static PyObject *PyCursesPanel_top_panel(PyCursesPanelObject *self) { return PyCursesCheckERR(top_panel(self->pan), "top_panel"); }
static PyObject *PyCursesPanel_panel_hidden(PyCursesPanelObject *self) { if (panel_hidden (self->pan) == 0) { ( ((PyObject*)(((PyObject *) &_Py_FalseStruct)))->ob_refcnt++); return ((PyObject *) &_Py_FalseStruct); } else { ( ((PyObject*)(((PyObject *) &_Py_TrueStruct)))->ob_refcnt++); return ((PyObject *) &_Py_TrueStruct); } }
static PyObject *PyCursesPanel_move_panel(PyCursesPanelObject *self, PyObject *args) { int arg1, arg2; if (!PyArg_ParseTuple(args, "ii;y,x", &arg1, &arg2)) return ((void *)0); return PyCursesCheckERR(move_panel(self->pan, arg1, arg2), "move_panel"); }
...
PyCursesPanel_New(PANEL *pan, PyCursesWindowObject *wo)
{
    ...
    po = ( (PyCursesPanelObject *) PyObject_Init( (PyObject *) PyObject_Malloc( ( ((PyTypeObject *)(((_curses_panelstate *) PyModule_GetState(PyState_FindModule(&_curses_panelmodule))))->PyCursesPanel_Type)->tp_basicsize ) ), ((PyTypeObject *)(((_curses_panelstate *) PyModule_GetState(PyState_FindModule(&_curses_panelmodule))))->PyCursesPanel_Type)) );

    if (po == ((void *)0)) return ((void *)0);
    po->pan = pan;
    if (insert_lop(po) < 0) {
        po->wo = ((void *)0);
        do { if ( --((PyObject*)(po))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(po)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(po)))); } while (0);
        return ((void *)0);
    }
    po->wo = wo;
    ( ((PyObject*)(wo))->ob_refcnt++);
    return (PyObject *)po;
}
...
PyCursesPanel_Dealloc(PyCursesPanelObject *po)
{
    ...
    if (po->wo != ((void *)0)) {
        do { if ( --((PyObject*)(po->wo))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(po->wo)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(po->wo)))); } while (0);
        remove_lop(po);
    }
    PyObject_Free(po);
}
...
PyCursesPanel_replace_panel(PyCursesPanelObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O!;window object",
                          &(*(PyTypeObject *) PyCurses_API[0]), &temp))
        return ((void *)0);
    ...
    if (rtn == (-1)) {
        PyErr_SetString(((_curses_panelstate *) PyModule_GetState(PyState_FindModule(&_curses_panelmodule)))->PyCursesError, "replace_panel() returned ERR");
        return ((void *)0);
    }
    do { if ( --((PyObject*)(po->wo))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(po->wo)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(po->wo)))); } while (0);
    po->wo = temp;
    ( ((PyObject*)(po->wo))->ob_refcnt++);
    ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++);
    return (&_Py_NoneStruct);
}
...
{
    PyObject *obj;
    {if (! ((int (*)(void))PyCurses_API[2]) () ) return ((void *)0);};
    obj = (PyObject *) panel_userptr(self->pan);
    if (obj == ((void *)0)) {
        PyErr_SetString(((_curses_panelstate *) PyModule_GetState(PyState_FindModule(&_curses_panelmodule)))->PyCursesError, "no userptr set");
        return ((void *)0);
    }
...
static PyMethodDef PyCursesPanel_Methods[] = {
    {"above", (PyCFunction)PyCursesPanel_above, 0x0004},
    {"below", (PyCFunction)PyCursesPanel_below, 0x0004},
    {"bottom", (PyCFunction)PyCursesPanel_bottom_panel, 0x0004},
    {"hidden", (PyCFunction)PyCursesPanel_panel_hidden, 0x0004},
    {"hide", (PyCFunction)PyCursesPanel_hide_panel, 0x0004},
    {"move", (PyCFunction)PyCursesPanel_move_panel, 0x0001},
    {"replace", (PyCFunction)PyCursesPanel_replace_panel, 0x0001},
    {"set_userptr", (PyCFunction)PyCursesPanel_set_panel_userptr, 0x0008},
    {"show", (PyCFunction)PyCursesPanel_show_panel, 0x0004},
    {"top", (PyCFunction)PyCursesPanel_top_panel, 0x0004},
    {"userptr", (PyCFunction)PyCursesPanel_userptr, 0x0004},
    {"window", (PyCFunction)PyCursesPanel_window, 0x0004},
    {((void *)0), ((void *)0)}
};
...
static PyType_Slot PyCursesPanel_Type_slots[] = {
    {52, PyCursesPanel_Dealloc},
    {64, PyCursesPanel_Methods},
    {0, 0},
};
...
PyCurses_new_panel(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O!", &(*(PyTypeObject *) PyCurses_API[0]), &win))
        return ((void *)0);
    pan = new_panel(win->win);
    if (pan == ((void *)0)) {
        PyErr_SetString(((_curses_panelstate *) PyModule_GetState(PyState_FindModule(&_curses_panelmodule)))->PyCursesError, catchall_NULL);
        return ((void *)0);
    }
...
static PyMethodDef PyCurses_methods[] = {
    {"bottom_panel", (PyCFunction)PyCurses_bottom_panel, 0x0004},
    {"new_panel", (PyCFunction)PyCurses_new_panel, 0x0001},
    {"top_panel", (PyCFunction)PyCurses_top_panel, 0x0004},
    {"update_panels", (PyCFunction)PyCurses_update_panels, 0x0004},
    {((void *)0), ((void *)0)}
};
...
PyInit__curses_panel(void)
{
    ...
    m = PyModule_Create2(&_curses_panelmodule, 1013);
    if (m == ((void *)0))
        goto fail;
    d = PyModule_GetDict(m);


    ((_curses_panelstate *)PyModule_GetState(m))->PyCursesPanel_Type = PyType_FromSpec(&PyCursesPanel_Type_spec);

    if (((_curses_panelstate *)PyModule_GetState(m))->PyCursesPanel_Type == ((void *)0))
        goto fail;

    PyCurses_API = (void **)PyCapsule_Import("_curses._C_API", 1);;


    ((_curses_panelstate *)PyModule_GetState(m))->PyCursesError = PyErr_NewException("_curses_panel.error", ((void *)0), ((void *)0));
    PyDict_SetItemString(d, "error", ((_curses_panelstate *)PyModule_GetState(m))->PyCursesError);
