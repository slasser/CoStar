...
static void
reap_obj(pylist fd2obj[1024 + 1])
{
    int i;
    for (i = 0; i < 1024 + 1 && fd2obj[i].sentinel >= 0; i++) {
        do { if ((fd2obj[i].obj) == ((void *)0)) ; else do { if ( --((PyObject*)(fd2obj[i].obj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(fd2obj[i].obj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(fd2obj[i].obj)))); } while (0); } while (0);
        fd2obj[i].obj = ((void *)0);
    }
    fd2obj[0].sentinel = -1;
}
...
static int
seq2set(PyObject *seq, fd_set *set, pylist fd2obj[1024 + 1])
{
    int max = -1;
    int index = 0;
    Py_ssize_t i;
    PyObject* fast_seq = ((void *)0);
    PyObject* o = ((void *)0);

    fd2obj[0].obj = (PyObject*)0;
    __builtin_bzero(set, sizeof(*(set)));

    fast_seq = PySequence_Fast(seq, "arguments 1-3 must be sequences");
    if (!fast_seq)
        return -1;

    for (i = 0; i < (((((((PyObject*)(fast_seq))->ob_type))->tp_flags & ((1L<<25))) != 0) ? (((PyVarObject*)(fast_seq))->ob_size) : (((PyVarObject*)(fast_seq))->ob_size)); i++) {
        int v;


        if (!(o = (((((((PyObject*)(fast_seq))->ob_type))->tp_flags & ((1L<<25))) != 0) ? (((PyListObject *)(fast_seq))->ob_item[i]) : (((PyTupleObject *)(fast_seq))->ob_item[i]))))
            goto finally;
        ...
        do { int __fd = (v); ((set)->fds_bits[__fd/(sizeof(__int32_t) * 8)] |= (1<<(__fd % (sizeof(__int32_t) * 8)))); } while(0);
    ...
    do { if ( --((PyObject*)(fast_seq))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(fast_seq)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(fast_seq)))); } while (0);
    return max+1;
...
static PyObject *
set2list(fd_set *set, pylist fd2obj[1024 + 1])
{
    int i, j, count=0;
    PyObject *list, *o;
    int fd;
    ...
    for (j = 0; fd2obj[j].sentinel >= 0; j++) {
        if (__darwin_fd_isset((fd2obj[j].fd), (set)))
            count++;
    }
...
{
# 199 "selectmodule.c"
    pylist rfd2obj[1024 + 1];
    pylist wfd2obj[1024 + 1];
    pylist efd2obj[1024 + 1];

    PyObject *ifdlist, *ofdlist, *efdlist;
    PyObject *ret = ((void *)0);
    PyObject *tout = (&_Py_NoneStruct);
...
# 268 "selectmodule.c"
    ...
    if (n < 0) {
        ...
        do { if ( --((PyObject*)(ifdlist))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ifdlist)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ifdlist)))); } while (0);
        do { if ( --((PyObject*)(ofdlist))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ofdlist)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ofdlist)))); } while (0);
        do { if ( --((PyObject*)(efdlist))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(efdlist)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(efdlist)))); } while (0);
    }
...
update_ufd_array(pollObject *self)
{
    ...
    ( (self->ufds) = ((size_t)(self->ufd_len) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(struct pollfd)) ? ((void *)0) : (struct pollfd *) ((size_t)((self->ufd_len) * sizeof(struct pollfd)) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : realloc(((self->ufds)), ((self->ufd_len) * sizeof(struct pollfd)) ? ((self->ufd_len) * sizeof(struct pollfd)) : 1)) );
    if (self->ufds == ((void *)0)) {
        self->ufds = old_ufds;
        PyErr_NoMemory();
        return 0;
    ...
    while (PyDict_Next(self->dict, &pos, &key, &value)) {
        (__builtin_expect(!(i < self->ufd_len), 0) ? __assert_rtn(__func__, "selectmodule.c", 360, "i < self->ufd_len") : (void)0);

        self->ufds[i].fd = (int)PyLong_AsLong(key);
        self->ufds[i].events = (short)PyLong_AsLong(value);
        i++;
    }
    (__builtin_expect(!(i == self->ufd_len), 0) ? __assert_rtn(__func__, "selectmodule.c", 366, "i == self->ufd_len") : (void)0);
    self->ufd_uptodate = 1;
    return 1;
}
...
poll_register(pollObject *self, PyObject *args)
{
    ...
    int fd;
    short events = 0x0001 | 0x0002 | 0x0004;
    int err;
...
poll_modify(pollObject *self, PyObject *args)
{
    ...
    if (key == ((void *)0))
        return ((void *)0);
    if (PyDict_GetItem(self->dict, key) == ((void *)0)) {
        (*__error()) = 2;
        PyErr_SetFromErrno(PyExc_OSError);
        do { if ( --((PyObject*)(key))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(key)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(key)))); } while (0);
        return ((void *)0);
...
{
    PyObject *result_list = ((void *)0), *tout = ((void *)0);
    int timeout = 0, poll_result, i, j;
    PyObject *value = ((void *)0), *num = ((void *)0);
    ...
    if (tout == ((void *)0) || tout == (&_Py_NoneStruct))
        timeout = -1;
    else if (!PyNumber_Check(tout)) {
        PyErr_SetString(PyExc_TypeError,
        ...
        do { if ( --((PyObject*)(tout))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tout)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tout)))); } while (0);
  ...
  error:
    do { if ( --((PyObject*)(result_list))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(result_list)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(result_list)))); } while (0);
    return ((void *)0);
}

static PyMethodDef poll_methods[] = {
    {"register", (PyCFunction)poll_register,
     0x0001, poll_register_doc},
    {"modify", (PyCFunction)poll_modify,
     0x0001, poll_modify_doc},
    {"unregister", (PyCFunction)poll_unregister,
     0x0008, poll_unregister_doc},
    {"poll", (PyCFunction)poll_poll,
     0x0001, poll_poll_doc},
    {((void *)0), ((void *)0)}
};
...
{
    pollObject *self;
    self = ( (pollObject *) _PyObject_New(&poll_Type) );
    if (self == ((void *)0))
        return ((void *)0);
...
poll_dealloc(pollObject *self)
{
    if (self->ufds != ((void *)0))
        free(self->ufds);
    do { if ((self->dict) == ((void *)0)) ; else do { if ( --((PyObject*)(self->dict))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(self->dict)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(self->dict)))); } while (0); } while (0);
    PyObject_Free(self);
}
...
static int select_have_broken_poll(void)
{
    ...
    struct pollfd poll_struct = { 0, 0x0001|0x0002|0x0004, 0 };
    ...
    if (poll_test < 0) {
        return 1;
    } else if (poll_test == 0 && poll_struct.revents != 0x0020) {
        return 1;
    }
    return 0;
}
...
# 79 "/usr/include/sys/event.h" 3 4
#pragma pack(4)
...
# 279 "/usr/include/sys/event.h" 3 4
# 1 "/usr/include/sys/queue.h" 1 3 4
# 280 "/usr/include/sys/event.h" 2 3 4
struct knote;
...
static struct PyMemberDef kqueue_event_members[] = {
    {"ident", 18, __builtin_offsetof (kqueue_event_Object, e.ident)},
    {"filter", 0, __builtin_offsetof (kqueue_event_Object, e.filter)},
    {"flags", 10, __builtin_offsetof (kqueue_event_Object, e.flags)},
    {"fflags", 11, __builtin_offsetof (kqueue_event_Object, e.fflags)},
    {"data", 17, __builtin_offsetof (kqueue_event_Object, e.data)},
    {"udata", 18, __builtin_offsetof (kqueue_event_Object, e.udata)},
    {((void *)0)}
};
...
kqueue_event_init(kqueue_event_Object *self, PyObject *args, PyObject *kwds)
{
    ...
    static char *kwlist[] = {"ident", "filter", "flags", "fflags",
                             "data", "udata", ((void *)0)};
    static char *fmt = "O|hhi" "L" "K" ":kevent";

    do { struct kevent *__kevp__ = (&(self->e)); __kevp__->ident = (0); __kevp__->filter = ((-1)); __kevp__->flags = (0x0001); __kevp__->fflags = (0); __kevp__->data = (0); __kevp__->udata = (0); } while(0);
    ...
    if (((((((PyObject*)(pfd))->ob_type))->tp_flags & ((1L<<24))) != 0)) {
        self->e.ident = PyLong_AsUnsignedLongLong(pfd);
    }
    else {
                         ...
                         int op)
{
    ...
    if (!(((((PyObject*)((o)))->ob_type) == (&kqueue_event_Type) || PyType_IsSubtype((((PyObject*)((o)))->ob_type), (&kqueue_event_Type))))) {
        if (op == 2 || op == 3) {
            PyObject *res = op == 2 ? ((PyObject *) &_Py_FalseStruct) : ((PyObject *) &_Py_TrueStruct);
            ( ((PyObject*)(res))->ob_refcnt++);
            return res;
        }
        PyErr_Format(PyExc_TypeError,
            "can't compare %.200s to %.200s",
            (((PyObject*)(s))->ob_type)->tp_name, (((PyObject*)(o))->ob_type)->tp_name);
        return ((void *)0);
    }
...
static PyObject *
newKqueue_Object(PyTypeObject *type, int fd)
{
    kqueue_queue_Object *self;
    (__builtin_expect(!(type != ((void *)0) && type->tp_alloc != ((void *)0)), 0) ? __assert_rtn(__func__, "selectmodule.c", 1751, "type != NULL && type->tp_alloc != NULL") : (void)0);
...
kqueue_queue_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    if ((args != ((void *)0) && PyObject_Size(args)) ||
                    (kwds != ((void *)0) && PyObject_Size(kwds))) {
        PyErr_SetString(PyExc_ValueError,
...
{
    (*__error()) = kqueue_queue_internal_close(self);
    if ((*__error()) < 0) {
        PyErr_SetFromErrno(PyExc_OSError);
        return ((void *)0);
    }
...
kqueue_queue_control(kqueue_queue_Object *self, PyObject *args)
{
    ...
    int nchanges = 0;
    int i = 0;
    PyObject *otimeout = ((void *)0);
    PyObject *ch = ((void *)0);
    PyObject *it = ((void *)0), *ei = ((void *)0);
    PyObject *result = ((void *)0);
    struct kevent *evl = ((void *)0);
    struct kevent *chl = ((void *)0);
    ...
    if (otimeout == (&_Py_NoneStruct) || otimeout == ((void *)0)) {
        ptimeoutspec = ((void *)0);
    }
        ...
        PyErr_Format(PyExc_TypeError,
            ...
            "or None, got %.200s",
            (((PyObject*)(otimeout))->ob_type)->tp_name);
        return ((void *)0);
    }

    if (ch != ((void *)0) && ch != (&_Py_NoneStruct)) {
        ...
        chl = ( ((size_t)(nchanges) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(struct kevent)) ? ((void *)0) : ( (struct kevent *) PyMem_Malloc((nchanges) * sizeof(struct kevent)) ) );
        if (chl == ((void *)0)) {
            PyErr_NoMemory();
            goto error;
        }
        i = 0;
        while ((ei = PyIter_Next(it)) != ((void *)0)) {
            if (!(((((PyObject*)((ei)))->ob_type) == (&kqueue_event_Type) || PyType_IsSubtype((((PyObject*)((ei)))->ob_type), (&kqueue_event_Type))))) {
                do { if ( --((PyObject*)(ei))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ei)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ei)))); } while (0);
                PyErr_SetString(PyExc_TypeError,
    ...
    if (nevents) {
        evl = ( ((size_t)(nevents) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(struct kevent)) ? ((void *)0) : ( (struct kevent *) PyMem_Malloc((nevents) * sizeof(struct kevent)) ) );
        if (evl == ((void *)0)) {
            PyErr_NoMemory();
            goto error;
        }
    ...
    for (i = 0; i < gotevents; i++) {
        ...
        ch = ( (kqueue_event_Object *) _PyObject_New(&kqueue_event_Type) );
        if (ch == ((void *)0)) {
            goto error;
        }
        ch->e = evl[i];
        (((PyListObject *)(result))->ob_item[i] = ((PyObject *)ch));
    }
    PyMem_Free(chl);
    PyMem_Free(evl);
    return result;
...
static PyMethodDef kqueue_queue_methods[] = {
    {"fromfd", (PyCFunction)kqueue_queue_fromfd,
     0x0001 | 0x0010, kqueue_queue_fromfd_doc},
    {"close", (PyCFunction)kqueue_queue_close, 0x0004,
     kqueue_queue_close_doc},
    {"fileno", (PyCFunction)kqueue_queue_fileno, 0x0004,
     kqueue_queue_fileno_doc},
    {"control", (PyCFunction)kqueue_queue_control,
     0x0001 , kqueue_queue_control_doc},
    {((void *)0), ((void *)0)},
};

static PyGetSetDef kqueue_queue_getsetlist[] = {
    {"closed", (getter)kqueue_queue_get_closed, ((void *)0),
...
static PyMethodDef select_methods[] = {
    {"select", select_select, 0x0001, select_doc},

    {"poll", select_poll, 0x0004, poll_doc},
...
PyInit_select(void)
{
    ...
    PyModule_AddIntConstant(m, "PIPE_BUF", 512);




    if (select_have_broken_poll()) {
        if (PyObject_SetAttrString((m),("poll"),((void *)0)) == -1) {
            PyErr_Clear();
        }
    } else {
        ...
        if (PyType_Ready(&poll_Type) < 0)
            return ((void *)0);
        PyModule_AddIntConstant(m, "POLLIN", 0x0001);
        PyModule_AddIntConstant(m, "POLLPRI", 0x0002);
        PyModule_AddIntConstant(m, "POLLOUT", 0x0004);
        PyModule_AddIntConstant(m, "POLLERR", 0x0008);
        PyModule_AddIntConstant(m, "POLLHUP", 0x0010);
        PyModule_AddIntConstant(m, "POLLNVAL", 0x0020);


        PyModule_AddIntConstant(m, "POLLRDNORM", 0x0040);


        PyModule_AddIntConstant(m, "POLLRDBAND", 0x0080);


        PyModule_AddIntConstant(m, "POLLWRNORM", 0x0004);


        PyModule_AddIntConstant(m, "POLLWRBAND", 0x0100);
...
# 2224 "selectmodule.c"
    ...
    (((PyObject*)(&kqueue_event_Type))->ob_type) = &PyType_Type;
    if(PyType_Ready(&kqueue_event_Type) < 0)
        return ((void *)0);

    ( ((PyObject*)(&kqueue_event_Type))->ob_refcnt++);
    PyModule_AddObject(m, "kevent", (PyObject *)&kqueue_event_Type);

    (((PyObject*)(&kqueue_queue_Type))->ob_type) = &PyType_Type;
    if(PyType_Ready(&kqueue_queue_Type) < 0)
        return ((void *)0);
    ( ((PyObject*)(&kqueue_queue_Type))->ob_refcnt++);
    PyModule_AddObject(m, "kqueue", (PyObject *)&kqueue_queue_Type);


    PyModule_AddIntConstant(m, "KQ_FILTER_READ", (-1));
    PyModule_AddIntConstant(m, "KQ_FILTER_WRITE", (-2));
    PyModule_AddIntConstant(m, "KQ_FILTER_AIO", (-3));
    PyModule_AddIntConstant(m, "KQ_FILTER_VNODE", (-4));
    PyModule_AddIntConstant(m, "KQ_FILTER_PROC", (-5));



    PyModule_AddIntConstant(m, "KQ_FILTER_SIGNAL", (-6));
    PyModule_AddIntConstant(m, "KQ_FILTER_TIMER", (-7));


    PyModule_AddIntConstant(m, "KQ_EV_ADD", 0x0001);
    PyModule_AddIntConstant(m, "KQ_EV_DELETE", 0x0002);
    PyModule_AddIntConstant(m, "KQ_EV_ENABLE", 0x0004);
    PyModule_AddIntConstant(m, "KQ_EV_DISABLE", 0x0008);
    PyModule_AddIntConstant(m, "KQ_EV_ONESHOT", 0x0010);
    PyModule_AddIntConstant(m, "KQ_EV_CLEAR", 0x0020);

    PyModule_AddIntConstant(m, "KQ_EV_SYSFLAGS", 0xF000);
    PyModule_AddIntConstant(m, "KQ_EV_FLAG1", 0x2000);

    PyModule_AddIntConstant(m, "KQ_EV_EOF", 0x8000);
    PyModule_AddIntConstant(m, "KQ_EV_ERROR", 0x4000);


    PyModule_AddIntConstant(m, "KQ_NOTE_LOWAT", 0x00000001);


    PyModule_AddIntConstant(m, "KQ_NOTE_DELETE", 0x00000001);
    PyModule_AddIntConstant(m, "KQ_NOTE_WRITE", 0x00000002);
    PyModule_AddIntConstant(m, "KQ_NOTE_EXTEND", 0x00000004);
    PyModule_AddIntConstant(m, "KQ_NOTE_ATTRIB", 0x00000008);
    PyModule_AddIntConstant(m, "KQ_NOTE_LINK", 0x00000010);
    PyModule_AddIntConstant(m, "KQ_NOTE_RENAME", 0x00000020);
    PyModule_AddIntConstant(m, "KQ_NOTE_REVOKE", 0x00000040);


    PyModule_AddIntConstant(m, "KQ_NOTE_EXIT", 0x80000000);
    PyModule_AddIntConstant(m, "KQ_NOTE_FORK", 0x40000000);
    PyModule_AddIntConstant(m, "KQ_NOTE_EXEC", 0x20000000);
    PyModule_AddIntConstant(m, "KQ_NOTE_PCTRLMASK", (~0x000fffff));
    PyModule_AddIntConstant(m, "KQ_NOTE_PDATAMASK", 0x000fffff);

    PyModule_AddIntConstant(m, "KQ_NOTE_TRACK", 0x00000001);
    PyModule_AddIntConstant(m, "KQ_NOTE_CHILD", 0x00000004);
    PyModule_AddIntConstant(m, "KQ_NOTE_TRACKERR", 0x00000002);
# 2295 "selectmodule.c"
    return m;
}
