...
# 31 "pystate.c" 2
static PyThread_type_lock head_mutex = ((void *)0);
...
static PyInterpreterState *autoInterpreterState = ((void *)0);
...
static PyInterpreterState *interp_head = ((void *)0);



_Py_atomic_address _PyThreadState_Current = {((void *)0)};
PyThreadFrameGetter _PyThreadState_GetFrame = ((void *)0);
...
PyInterpreterState_New(void)
{
    ...
    if (interp != ((void *)0)) {
        (void)(head_mutex || (head_mutex = PyThread_allocate_lock()));

        if (head_mutex == ((void *)0))
            Py_FatalError("Can't initialize threads for interpreter");

        interp->modules = ((void *)0);
        interp->modules_by_index = ((void *)0);
        interp->sysdict = ((void *)0);
        interp->builtins = ((void *)0);
        interp->tstate_head = ((void *)0);
        interp->codec_search_path = ((void *)0);
        interp->codec_search_cache = ((void *)0);
        interp->codec_error_registry = ((void *)0);
        interp->codecs_initialized = 0;
        interp->fscodec_initialized = 0;
        interp->importlib = ((void *)0);


        interp->dlopenflags = 0x2;
# 93 "pystate.c"
        PyThread_acquire_lock(head_mutex, 1);
        interp->next = interp_head;
        interp_head = interp;
        PyThread_release_lock(head_mutex);
    }
...
PyInterpreterState_Clear(PyInterpreterState *interp)
{
    PyThreadState *p;
    PyThread_acquire_lock(head_mutex, 1);
    for (p = interp->tstate_head; p != ((void *)0); p = p->next)
        PyThreadState_Clear(p);
    PyThread_release_lock(head_mutex);
    do { if (interp->codec_search_path) { PyObject *_py_tmp = (PyObject *)(interp->codec_search_path); (interp->codec_search_path) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (interp->codec_search_cache) { PyObject *_py_tmp = (PyObject *)(interp->codec_search_cache); (interp->codec_search_cache) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (interp->codec_error_registry) { PyObject *_py_tmp = (PyObject *)(interp->codec_error_registry); (interp->codec_error_registry) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (interp->modules) { PyObject *_py_tmp = (PyObject *)(interp->modules); (interp->modules) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (interp->modules_by_index) { PyObject *_py_tmp = (PyObject *)(interp->modules_by_index); (interp->modules_by_index) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (interp->sysdict) { PyObject *_py_tmp = (PyObject *)(interp->sysdict); (interp->sysdict) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (interp->builtins) { PyObject *_py_tmp = (PyObject *)(interp->builtins); (interp->builtins) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (interp->importlib) { PyObject *_py_tmp = (PyObject *)(interp->importlib); (interp->importlib) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
}
...
zapthreads(PyInterpreterState *interp)
{
    ...
    while ((p = interp->tstate_head) != ((void *)0)) {
...
PyInterpreterState_Delete(PyInterpreterState *interp)
{
    ...
    if (interp->tstate_head != ((void *)0))
        Py_FatalError("PyInterpreterState_Delete: remaining threads");
    *p = interp->next;
    PyThread_release_lock(head_mutex);
    free(interp);

    if (interp_head == ((void *)0) && head_mutex != ((void *)0)) {
...
new_threadstate(PyInterpreterState *interp, int init)
{
    ...
    if (_PyThreadState_GetFrame == ((void *)0))
    ...
    if (tstate != ((void *)0)) {
        ...
        tstate->curexc_type = ((void *)0);
        tstate->curexc_value = ((void *)0);
        tstate->curexc_traceback = ((void *)0);

        tstate->exc_type = ((void *)0);
        tstate->exc_value = ((void *)0);
        ...
        tstate->trash_delete_later = ((void *)0);
...
PyState_FindModule(struct PyModuleDef* module)
{
    ...
    PyInterpreterState *state = ((PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; }))->interp;
    PyObject *res;
    if (index == 0)
        return ((void *)0);
    if (state->modules_by_index == ((void *)0))
        return ((void *)0);
    if (index >= (((PyVarObject*)(state->modules_by_index))->ob_size))
        return ((void *)0);
    res = (((PyListObject *)(state->modules_by_index))->ob_item[index]);
    return res==(&_Py_NoneStruct) ? ((void *)0) : res;
}
...
_PyState_AddModule(PyObject* module, struct PyModuleDef* def)
{
    ...
    while((((PyVarObject*)(state->modules_by_index))->ob_size) <= def->m_base.m_index)
        if (PyList_Append(state->modules_by_index, (&_Py_NoneStruct)) < 0)
            return -1;
...
PyState_AddModule(PyObject* module, struct PyModuleDef* def)
{
    ...
    if (state->modules_by_index) {
        if((((PyVarObject*)(state->modules_by_index))->ob_size) >= index) {
            if(module == (((PyListObject *)(state->modules_by_index))->ob_item[index])) {
...
PyState_RemoveModule(struct PyModuleDef* def)
{
    ...
    return PyList_SetItem(state->modules_by_index, index, (&_Py_NoneStruct));
}

void
PyThreadState_Clear(PyThreadState *tstate)
{
    if (Py_VerboseFlag && tstate->frame != ((void *)0))
        fprintf(__stderrp,
          "PyThreadState_Clear: warning: thread still has a frame\n");

    do { if (tstate->frame) { PyObject *_py_tmp = (PyObject *)(tstate->frame); (tstate->frame) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);

    do { if (tstate->dict) { PyObject *_py_tmp = (PyObject *)(tstate->dict); (tstate->dict) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (tstate->async_exc) { PyObject *_py_tmp = (PyObject *)(tstate->async_exc); (tstate->async_exc) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);

    do { if (tstate->curexc_type) { PyObject *_py_tmp = (PyObject *)(tstate->curexc_type); (tstate->curexc_type) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (tstate->curexc_value) { PyObject *_py_tmp = (PyObject *)(tstate->curexc_value); (tstate->curexc_value) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (tstate->curexc_traceback) { PyObject *_py_tmp = (PyObject *)(tstate->curexc_traceback); (tstate->curexc_traceback) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);

    do { if (tstate->exc_type) { PyObject *_py_tmp = (PyObject *)(tstate->exc_type); (tstate->exc_type) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (tstate->exc_value) { PyObject *_py_tmp = (PyObject *)(tstate->exc_value); (tstate->exc_value) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (tstate->exc_traceback) { PyObject *_py_tmp = (PyObject *)(tstate->exc_traceback); (tstate->exc_traceback) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);

    tstate->c_profilefunc = ((void *)0);
    tstate->c_tracefunc = ((void *)0);
    do { if (tstate->c_profileobj) { PyObject *_py_tmp = (PyObject *)(tstate->c_profileobj); (tstate->c_profileobj) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (tstate->c_traceobj) { PyObject *_py_tmp = (PyObject *)(tstate->c_traceobj); (tstate->c_traceobj) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
}
...
{
    PyThreadState *oldts = (PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; });


    __extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) new_val = newts; volatile __typeof__(new_val) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: _Py_atomic_signal_fence(_Py_memory_order_release); case _Py_memory_order_relaxed: *volatile_data = new_val; break; case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: __asm__ volatile("xchg %0, %1" : "+r"(new_val) : "m"(atomic_val->_value) : "memory"); break; } ; });
# 452 "pystate.c"
    return oldts;
}
...
PyThreadState_SetAsyncExc(long id, PyObject *exc) {
    ...
    for (p = interp->tstate_head; p != ((void *)0); p = p->next) {
        if (p->thread_id == id) {
            ...
            do { if ((exc) == ((void *)0)) ; else ( ((PyObject*)(exc))->ob_refcnt++); } while (0);
            p->async_exc = exc;
            PyThread_release_lock(head_mutex);
            do { if ((old_exc) == ((void *)0)) ; else do { if ( --((PyObject*)(old_exc))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(old_exc)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(old_exc)))); } while (0); } while (0);
...
_PyThread_CurrentFrames(void)
{
    ...
    PyThread_acquire_lock(head_mutex, 1);
    for (i = interp_head; i != ((void *)0); i = i->next) {
        PyThreadState *t;
        for (t = i->tstate_head; t != ((void *)0); t = t->next) {
            PyObject *id;
            int stat;
...
PyThreadState_IsCurrent(PyThreadState *tstate)
{
    ...
    (__builtin_expect(!(PyGILState_GetThisThreadState()==tstate), 0) ? __assert_rtn(__func__, "pystate.c", 610, "PyGILState_GetThisThreadState()==tstate") : (void)0);
    return tstate == __extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; });
}
...
{
    (__builtin_expect(!(i && t), 0) ? __assert_rtn(__func__, "pystate.c", 620, "i && t") : (void)0);
    autoTLSkey = PyThread_create_key();
    if (autoTLSkey == -1)
        Py_FatalError("Could not allocate TLS entry");
    autoInterpreterState = i;
    (__builtin_expect(!(PyThread_get_key_value(autoTLSkey) == ((void *)0)), 0) ? __assert_rtn(__func__, "pystate.c", 625, "PyThread_get_key_value(autoTLSkey) == NULL") : (void)0);
    (__builtin_expect(!(t->gilstate_counter == 0), 0) ? __assert_rtn(__func__, "pystate.c", 626, "t->gilstate_counter == 0") : (void)0);
...
{
    if (autoInterpreterState == ((void *)0))
        return ((void *)0);
...
PyGILState_Ensure(void)
{
    ...
    (__builtin_expect(!(autoInterpreterState), 0) ? __assert_rtn(__func__, "pystate.c", 710, "autoInterpreterState") : (void)0);
...
PyGILState_Release(PyGILState_STATE oldstate)
{
    ...
    (__builtin_expect(!(PyThreadState_IsCurrent(tcur)), 0) ? __assert_rtn(__func__, "pystate.c", 750, "PyThreadState_IsCurrent(tcur)") : (void)0);
    --tcur->gilstate_counter;
    (__builtin_expect(!(tcur->gilstate_counter >= 0), 0) ? __assert_rtn(__func__, "pystate.c", 752, "tcur->gilstate_counter >= 0") : (void)0);
    ...
    if (tcur->gilstate_counter == 0) {
        ...
        (__builtin_expect(!(oldstate == PyGILState_UNLOCKED), 0) ? __assert_rtn(__func__, "pystate.c", 759, "oldstate == PyGILState_UNLOCKED") : (void)0);
