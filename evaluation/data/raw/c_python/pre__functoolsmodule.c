...
# 4 "_functoolsmodule.c" 2
# 14 "_functoolsmodule.c"
typedef struct {
    PyObject ob_base;
    PyObject *fn;
    PyObject *args;
...
partial_new(PyTypeObject *type, PyObject *args, PyObject *kw)
{
    ...
    pto->args = PyTuple_GetSlice(args, 1, ((Py_ssize_t)(((size_t)-1)>>1)));
    if (pto->args == ((void *)0)) {
        pto->kw = ((void *)0);
        do { if ( --((PyObject*)(pto))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pto)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pto)))); } while (0);
        return ((void *)0);
    }
    if (kw != ((void *)0)) {
        ...
        pto->kw = (&_Py_NoneStruct);
        ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++);
    }

    pto->weakreflist = ((void *)0);
    pto->dict = ((void *)0);
...
partial_dealloc(partialobject *pto)
{
    ...
    if (pto->weakreflist != ((void *)0))
        PyObject_ClearWeakRefs((PyObject *) pto);
    do { if ((pto->fn) == ((void *)0)) ; else do { if ( --((PyObject*)(pto->fn))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pto->fn)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pto->fn)))); } while (0); } while (0);
    do { if ((pto->args) == ((void *)0)) ; else do { if ( --((PyObject*)(pto->args))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pto->args)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pto->args)))); } while (0); } while (0);
    do { if ((pto->kw) == ((void *)0)) ; else do { if ( --((PyObject*)(pto->kw))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pto->kw)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pto->kw)))); } while (0); } while (0);
    do { if ((pto->dict) == ((void *)0)) ; else do { if ( --((PyObject*)(pto->dict))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pto->dict)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pto->dict)))); } while (0); } while (0);
    (((PyObject*)(pto))->ob_type)->tp_free(pto);
}
...
{
    PyObject *ret;
    PyObject *argappl = ((void *)0), *kwappl = ((void *)0);

    (__builtin_expect(!(PyCallable_Check(pto->fn)), 0) ? __assert_rtn(__func__, "_functoolsmodule.c", 93, "PyCallable_Check(pto->fn)") : (void)0);
    (__builtin_expect(!(((((((PyObject*)(pto->args))->ob_type))->tp_flags & ((1L<<26))) != 0)), 0) ? __assert_rtn(__func__, "_functoolsmodule.c", 94, "PyTuple_Check(pto->args)") : (void)0);
    (__builtin_expect(!(pto->kw == (&_Py_NoneStruct) || ((((((PyObject*)(pto->kw))->ob_type))->tp_flags & ((1L<<29))) != 0)), 0) ? __assert_rtn(__func__, "_functoolsmodule.c", 95, "pto->kw == Py_None || PyDict_Check(pto->kw)") : (void)0);

    if ((((PyVarObject*)(pto->args))->ob_size) == 0) {
        argappl = args;
        ( ((PyObject*)(args))->ob_refcnt++);
    } else if ((((PyVarObject*)(args))->ob_size) == 0) {
        argappl = pto->args;
        ( ((PyObject*)(pto->args))->ob_refcnt++);
    } else {
    ...
    if (pto->kw == (&_Py_NoneStruct)) {
        kwappl = kw;
        do { if ((kw) == ((void *)0)) ; else ( ((PyObject*)(kw))->ob_refcnt++); } while (0);
    } else {
        kwappl = PyDict_Copy(pto->kw);
        if (kwappl == ((void *)0)) {
            do { if ( --((PyObject*)(argappl))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(argappl)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(argappl)))); } while (0);
            return ((void *)0);
        }
        if (kw != ((void *)0)) {
            if (PyDict_Merge(kwappl, kw, 1) != 0) {
                do { if ( --((PyObject*)(argappl))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(argappl)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(argappl)))); } while (0);
                do { if ( --((PyObject*)(kwappl))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(kwappl)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(kwappl)))); } while (0);
                return ((void *)0);
            }
        }
    }
    ...
    do { if ( --((PyObject*)(argappl))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(argappl)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(argappl)))); } while (0);
    do { if ((kwappl) == ((void *)0)) ; else do { if ( --((PyObject*)(kwappl))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(kwappl)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(kwappl)))); } while (0); } while (0);
    return ret;
}
...
{
    do { if (pto->fn) { int vret = visit((PyObject *)(pto->fn), arg); if (vret) return vret; } } while (0);
    do { if (pto->args) { int vret = visit((PyObject *)(pto->args), arg); if (vret) return vret; } } while (0);
    do { if (pto->kw) { int vret = visit((PyObject *)(pto->kw), arg); if (vret) return vret; } } while (0);
    do { if (pto->dict) { int vret = visit((PyObject *)(pto->dict), arg); if (vret) return vret; } } while (0);
    return 0;
}

static char partial_doc[] = "partial(func, *args, **keywords) - new function with partial application\n    of the given arguments and keywords.\n";




static PyMemberDef partial_memberlist[] = {
    {"func", 6, __builtin_offsetof (partialobject, fn), 1,
     "function object to use in future partial calls"},
    {"args", 6, __builtin_offsetof (partialobject, args), 1,
     "tuple of arguments to future partial calls"},
    {"keywords", 6, __builtin_offsetof (partialobject, kw), 1,
...
partial_repr(partialobject *pto)
{
    ...
    (__builtin_expect(!(((((((PyObject*)(pto->args))->ob_type))->tp_flags & ((1L<<26))) != 0)), 0) ? __assert_rtn(__func__, "_functoolsmodule.c", 176, "PyTuple_Check(pto->args)") : (void)0);
    n = (((PyVarObject*)(pto->args))->ob_size);
    for (i = 0; i < n; i++) {
        tmp = PyUnicode_FromFormat("%U, %R", arglist,
                                   (((PyTupleObject *)(pto->args))->ob_item[i]));
    ...
    (__builtin_expect(!(pto->kw == (&_Py_NoneStruct) || ((((((PyObject*)(pto->kw))->ob_type))->tp_flags & ((1L<<29))) != 0)), 0) ? __assert_rtn(__func__, "_functoolsmodule.c", 187, "pto->kw == Py_None || PyDict_Check(pto->kw)") : (void)0);
    if (pto->kw != (&_Py_NoneStruct)) {
        PyObject *key, *value;
    ...
    result = PyUnicode_FromFormat("%s(%R%U)", (((PyObject*)(pto))->ob_type)->tp_name,
                                  pto->fn, arglist);
    do { if ( --((PyObject*)(arglist))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(arglist)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(arglist)))); } while (0);
    return result;
}
# 212 "_functoolsmodule.c"
static PyObject *
partial_reduce(partialobject *pto, PyObject *unused)
{
    return Py_BuildValue("O(O)(OOOO)", (((PyObject*)(pto))->ob_type), pto->fn, pto->fn,
                         pto->args, pto->kw,
                         pto->dict ? pto->dict : (&_Py_NoneStruct));
}
...
partial_setstate(partialobject *pto, PyObject *state)
{
    ...
    pto->args = fnargs;
    pto->kw = kw;
    if (dict != (&_Py_NoneStruct)) {
      pto->dict = dict;
      ( ((PyObject*)(dict))->ob_refcnt++);
    } else {
      pto->dict = ((void *)0);
    }
    ( ((PyObject*)(fn))->ob_refcnt++);
    ( ((PyObject*)(fnargs))->ob_refcnt++);
    ( ((PyObject*)(kw))->ob_refcnt++);
    return ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++), (&_Py_NoneStruct);
}

static PyMethodDef partial_methods[] = {
    {"__reduce__", (PyCFunction)partial_reduce, 0x0004},
    {"__setstate__", (PyCFunction)partial_setstate, 0x0008},
    {((void *)0), ((void *)0)}
};
...
static PyTypeObject partial_type = {
    ...
    0,
    0,
    __builtin_offsetof (partialobject, weakreflist),
    0,
    0,
    partial_methods,
    partial_memberlist,
    ...
    0,
    0,
    __builtin_offsetof (partialobject, dict),
    0,
    0,
    partial_new,
    PyObject_GC_Del,
...
{
    do { if ( --((PyObject*)(ko->cmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ko->cmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ko->cmp)))); } while (0);
    do { if ((ko->object) == ((void *)0)) ; else do { if ( --((PyObject*)(ko->object))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ko->object)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ko->object)))); } while (0); } while (0);
    PyObject_Free(ko);
}
...
{
    do { if (ko->cmp) { int vret = visit((PyObject *)(ko->cmp), arg); if (vret) return vret; } } while (0);
    if (ko->object)
        do { if (ko->object) { int vret = visit((PyObject *)(ko->object), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
{
    do { if (ko->cmp) { PyObject *_py_tmp = (PyObject *)(ko->cmp); (ko->cmp) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    if (ko->object)
        do { if (ko->object) { PyObject *_py_tmp = (PyObject *)(ko->object); (ko->object) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    return 0;
}

static PyMemberDef keyobject_members[] = {
    {"obj", 6,
     __builtin_offsetof (keyobject, object), 0,
...
static PyTypeObject keyobject_type = {
    ...
    ( 0 | (1L<<18) | 0),
    0,
    (traverseproc)keyobject_traverse,
    (inquiry)keyobject_clear,
...
keyobject_call(keyobject *ko, PyObject *args, PyObject *kwds)
{
    PyObject *object;
    keyobject *result;
    static char *kwargs[] = {"obj", ((void *)0)};

    if (!PyArg_ParseTupleAndKeywords(args, kwds, "O:K", kwargs, &object))
        return ((void *)0);
    result = ( (keyobject *) _PyObject_New(&keyobject_type) );
    if (!result)
        return ((void *)0);
    ( ((PyObject*)(ko->cmp))->ob_refcnt++);
    result->cmp = ko->cmp;
...
keyobject_richcompare(PyObject *ko, PyObject *other, int op)
{
    ...
    if ((((PyObject*)(other))->ob_type) != &keyobject_type){
        PyErr_Format(PyExc_TypeError, "other argument must be K instance");
        return ((void *)0);
    }
    compare = ((keyobject *) ko)->cmp;
    (__builtin_expect(!(compare != ((void *)0)), 0) ? __assert_rtn(__func__, "_functoolsmodule.c", 419, "compare != NULL") : (void)0);
    ...
    ( ((PyObject*)(y))->ob_refcnt++);
    (((PyTupleObject *)(args))->ob_item[0] = x);
    (((PyTupleObject *)(args))->ob_item[1] = y);
    res = PyObject_Call(compare, args, ((void *)0));
...
{
    PyObject *cmp;
    static char *kwargs[] = {"mycmp", ((void *)0)};
    keyobject *object;

    if (!PyArg_ParseTupleAndKeywords(args, kwds, "O:cmp_to_key", kwargs, &cmp))
        return ((void *)0);
    object = ( (keyobject *) _PyObject_New(&keyobject_type) );
    if (!object)
        return ((void *)0);
    ( ((PyObject*)(cmp))->ob_refcnt++);
    object->cmp = cmp;
    object->object = ((void *)0);
    return (PyObject *)object;
}

static char functools_cmp_to_key_doc[] = "Convert a cmp= function into a key= function.";
...
{
    PyObject *seq, *func, *result = ((void *)0), *it;
    ...
    for (;;) {
        ...
        if (result == ((void *)0))
            ...
            if ((result = PyEval_CallObjectWithKeywords(func, args, (PyObject *)((void *)0))) == ((void *)0))
                goto Fail;
        }
    }
...
static char functools_reduce_doc[] = "reduce(function, sequence[, initial]) -> value\n\nApply a function of two arguments cumulatively to the items of a sequence,\nfrom left to right, so as to reduce the sequence to a single value.\nFor example, reduce(lambda x, y: x+y, [1, 2, 3, 4, 5]) calculates\n((((1+2)+3)+4)+5).  If initial is present, it is placed before the items\nof the sequence in the calculation, and serves as a default when the\nsequence is empty.";
# 545 "_functoolsmodule.c"
static char module_doc[] = "Tools that operate on functions.";


static PyMethodDef module_methods[] = {
    {"reduce", functools_reduce, 0x0001, functools_reduce_doc},
    {"cmp_to_key", (PyCFunction)functools_cmp_to_key,
     0x0001 | 0x0002, functools_cmp_to_key_doc},
    {((void *)0), ((void *)0)}
};
...
PyInit__functools(void)
{
    ...
    m = PyModule_Create2(&_functoolsmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    ...
    for (i=0 ; typelist[i] != ((void *)0) ; i++) {
        ...
        (__builtin_expect(!(name != ((void *)0)), 0) ? __assert_rtn(__func__, "_functoolsmodule.c", 589, "name != NULL") : (void)0);
