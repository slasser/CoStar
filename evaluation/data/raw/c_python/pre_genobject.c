...
{
    do { if ((PyObject *)gen->gi_frame) { int vret = visit((PyObject *)((PyObject *)gen->gi_frame), arg); if (vret) return vret; } } while (0);
    do { if (gen->gi_code) { int vret = visit((PyObject *)(gen->gi_code), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
gen_dealloc(PyGenObject *gen)
{
    ...
    do { PyGC_Head *g = ((PyGC_Head *)(gen)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "genobject.c", 23, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;

    if (gen->gi_weakreflist != ((void *)0))
    ...
    if (gen->gi_frame != ((void *)0) && gen->gi_frame->f_stacktop != ((void *)0)) {

        (((PyObject*)(gen))->ob_type)->tp_del(self);
        if (self->ob_refcnt > 0)
            return;
    }

    do { PyGC_Head *g = ((PyGC_Head *)(self)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "genobject.c", 37, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
    do { if (gen->gi_frame) { PyObject *_py_tmp = (PyObject *)(gen->gi_frame); (gen->gi_frame) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    do { if (gen->gi_code) { PyObject *_py_tmp = (PyObject *)(gen->gi_code); (gen->gi_code) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    PyObject_GC_Del(gen);
}
...
gen_send_ex(PyGenObject *gen, PyObject *arg, int exc)
{
    ...
    if (f == ((void *)0) || f->f_stacktop == ((void *)0)) {
    ...
    do { if ((tstate->frame) == ((void *)0)) ; else ( ((PyObject*)(tstate->frame))->ob_refcnt++); } while (0);
    (__builtin_expect(!(f->f_back == ((void *)0)), 0) ? __assert_rtn(__func__, "genobject.c", 80, "f->f_back == NULL") : (void)0);
    ...
    (__builtin_expect(!(f->f_back == tstate->frame), 0) ? __assert_rtn(__func__, "genobject.c", 90, "f->f_back == tstate->frame") : (void)0);
    do { if (f->f_back) { PyObject *_py_tmp = (PyObject *)(f->f_back); (f->f_back) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);



    if (result && f->f_stacktop == ((void *)0)) {
        if (result == (&_Py_NoneStruct)) {

            PyErr_SetNone(PyExc_StopIteration);
        } else {
            PyObject *e = PyObject_CallFunctionObjArgs(
                               PyExc_StopIteration, result, ((void *)0));
            if (e != ((void *)0)) {
                PyErr_SetObject(PyExc_StopIteration, e);
                do { if ( --((PyObject*)(e))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(e)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(e)))); } while (0);
            }
        }
        do { if (result) { PyObject *_py_tmp = (PyObject *)(result); (result) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    }
    ...
    if (!result || f->f_stacktop == ((void *)0)) {
        ...
        do { if ((t) == ((void *)0)) ; else do { if ( --((PyObject*)(t))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(t)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(t)))); } while (0); } while (0);
...
static char send_doc[] = "send(arg) -> send 'arg' into generator,\nreturn next yielded value or raise StopIteration.";
...
static char close_doc[] = "close() -> raise GeneratorExit inside generator.";
...
gen_close_iter(PyObject *yf)
{
    ...
    if (((((PyObject*)(yf))->ob_type) == &PyGen_Type)) {
        retval = gen_close((PyGenObject *)yf, ((void *)0));
        if (retval == ((void *)0))
            return -1;
    } else {
...
gen_yf(PyGenObject *gen)
{
    ...
    if (f) {
        ...
        unsigned char *code = (unsigned char *)((__builtin_expect(!(((((((PyObject*)(bytecode))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "genobject.c", 183, "PyBytes_Check(bytecode)") : (void)0), (((PyBytesObject *)(bytecode))->ob_sval));

        if (code[f->f_lasti + 1] != 72)
            return ((void *)0);
        yf = f->f_stacktop[-1];
        ( ((PyObject*)(yf))->ob_refcnt++);
    }
...
gen_close(PyGenObject *gen, PyObject *args)
{
    ...
    if (yf) {
        ...
        gen->gi_running = 0;
        do { if ( --((PyObject*)(yf))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(yf)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(yf)))); } while (0);
    }
    if (err == 0)
        PyErr_SetNone(PyExc_GeneratorExit);
    retval = gen_send_ex(gen, (&_Py_NoneStruct), 1);
    if (retval) {
...
gen_del(PyObject *self)
{
    ...
    (__builtin_expect(!(self->ob_refcnt == 0), 0) ? __assert_rtn(__func__, "genobject.c", 237, "self->ob_refcnt == 0") : (void)0);
    self->ob_refcnt = 1;


    PyErr_Fetch(&error_type, &error_value, &error_traceback);

    res = gen_close(gen, ((void *)0));
    ...
    (__builtin_expect(!(self->ob_refcnt > 0), 0) ? __assert_rtn(__func__, "genobject.c", 256, "self->ob_refcnt > 0") : (void)0);
    if (--self->ob_refcnt == 0)
        return;
    ...
    (__builtin_expect(!((((((((PyObject*)(self))->ob_type)))->tp_flags & ((1L<<14))) != 0) && ((PyGC_Head *)(self)-1)->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "genobject.c", 269, "PyType_IS_GC(Py_TYPE(self)) && _Py_AS_GC(self)->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0);
...
static char throw_doc[] = "throw(typ[,val[,tb]]) -> raise exception in generator,\nreturn next yielded value or raise StopIteration.";
...
gen_throw(PyGenObject *gen, PyObject *args)
{
    ...
    PyObject *val = ((void *)0);
    PyObject *yf = gen_yf(gen);
    static _Py_Identifier PyId_throw = { 0, "throw", 0 };
    ...
    if (yf) {
        ...
        if (PyErr_GivenExceptionMatches(typ, PyExc_GeneratorExit)) {
            ...
            do { if ( --((PyObject*)(yf))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(yf)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(yf)))); } while (0);
            if (err < 0)
                return gen_send_ex(gen, (&_Py_NoneStruct), 1);
            goto throw_here;
        }
        if (((((PyObject*)(yf))->ob_type) == &PyGen_Type)) {
            gen->gi_running = 1;
        ...
        if (!ret) {
            ...
            (__builtin_expect(!(ret == yf), 0) ? __assert_rtn(__func__, "genobject.c", 341, "ret == yf") : (void)0);
            ...
            if (_PyGen_FetchStopIterationValue(&val) == 0) {
                ...
                ret = gen_send_ex(gen, (&_Py_NoneStruct), 1);
            }
        }
        return ret;
    }
...
throw_here:
    ...
    ( ((PyObject*)(typ))->ob_refcnt++);
    do { if ((val) == ((void *)0)) ; else ( ((PyObject*)(val))->ob_refcnt++); } while (0);
    do { if ((tb) == ((void *)0)) ; else ( ((PyObject*)(tb))->ob_refcnt++); } while (0);

    if ((((((((PyObject*)((typ)))->ob_type))->tp_flags & ((1L<<31))) != 0) && ((((PyTypeObject*)(typ))->tp_flags & ((1L<<30))) != 0)))
        PyErr_NormalizeException(&typ, &val, &tb);

    else if (((((typ)->ob_type)->tp_flags & ((1L<<30))) != 0)) {
...
failed_throw:
    ...
    do { if ( --((PyObject*)(typ))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(typ)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(typ)))); } while (0);
    do { if ((val) == ((void *)0)) ; else do { if ( --((PyObject*)(val))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(val)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(val)))); } while (0); } while (0);
    do { if ((tb) == ((void *)0)) ; else do { if ( --((PyObject*)(tb))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tb)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tb)))); } while (0); } while (0);
    return ((void *)0);
}
...
_PyGen_FetchStopIterationValue(PyObject **pvalue) {
    ...
    if (PyErr_ExceptionMatches(PyExc_StopIteration)) {
        ...
        do { if ((et) == ((void *)0)) ; else do { if ( --((PyObject*)(et))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(et)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(et)))); } while (0); } while (0);
        do { if ((tb) == ((void *)0)) ; else do { if ( --((PyObject*)(tb))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tb)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tb)))); } while (0); } while (0);
        if (ev) {
            value = ((PyStopIterationObject *)ev)->value;
            ( ((PyObject*)(value))->ob_refcnt++);
            do { if ( --((PyObject*)(ev))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ev)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ev)))); } while (0);
        }
...
static char gen__name__doc__[] = "Return the name of the generator's associated code object.";


static PyGetSetDef gen_getsetlist[] = {
    {"__name__", (getter)gen_get_name, ((void *)0), gen__name__doc__},
    {((void *)0)}
};


static PyMemberDef gen_memberlist[] = {
    {"gi_frame", 6, __builtin_offsetof (PyGenObject, gi_frame), 1},
    {"gi_running", 14, __builtin_offsetof (PyGenObject, gi_running), 1},
    {"gi_code", 6, __builtin_offsetof (PyGenObject, gi_code), 1},
    {((void *)0)}
};

static PyMethodDef gen_methods[] = {
    {"send",(PyCFunction)_PyGen_Send, 0x0008, send_doc},
    {"throw",(PyCFunction)gen_throw, 0x0001, throw_doc},
    {"close",(PyCFunction)gen_close, 0x0004, close_doc},
    {((void *)0), ((void *)0)}
};
...
PyTypeObject PyGen_Type = {
    ...
    0,
    0,
    __builtin_offsetof (PyGenObject, gi_weakreflist),
    PyObject_SelfIter,
...
{
    PyGenObject *gen = ( (PyGenObject *) _PyObject_GC_New(&PyGen_Type) );
    if (gen == ((void *)0)) {
        do { if ( --((PyObject*)(f))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(f)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(f)))); } while (0);
        return ((void *)0);
    }
    gen->gi_frame = f;
    ( ((PyObject*)(f->f_code))->ob_refcnt++);
    gen->gi_code = (PyObject *)(f->f_code);
    gen->gi_running = 0;
    gen->gi_weakreflist = ((void *)0);
    do { PyGC_Head *g = ((PyGC_Head *)(gen)-1); if (g->gc.gc_refs != (-2)) Py_FatalError("GC object already tracked"); g->gc.gc_refs = (-3); g->gc.gc_next = _PyGC_generation0; g->gc.gc_prev = _PyGC_generation0->gc.gc_prev; g->gc.gc_prev->gc.gc_next = g; _PyGC_generation0->gc.gc_prev = g; } while (0);;
    return (PyObject *)gen;
}
...
PyGen_NeedsFinalizing(PyGenObject *gen)
{
    ...
    for (i = 0; i < f->f_iblock; i++)
        if (f->f_blockstack[i].b_type != 120)
            return 1;
