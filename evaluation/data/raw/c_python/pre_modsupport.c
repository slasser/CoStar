...
char *_Py_PackageContext = ((void *)0);
...
do_mkvalue(const char **p_format, va_list *p_va, int flags)
{
    for (;;) {
        ...
        case 'h':
        case 'i':
            return PyLong_FromLong((long)__builtin_va_arg(*p_va,int));

        case 'H':
            return PyLong_FromLong((long)__builtin_va_arg(*p_va,unsigned int));

        case 'I':
        {
            unsigned int n;
            n = __builtin_va_arg(*p_va,unsigned int);
        ...
        case 'l':
            return PyLong_FromLong(__builtin_va_arg(*p_va,long));

        case 'k':
        {
            unsigned long n;
            n = __builtin_va_arg(*p_va,unsigned long);
            return PyLong_FromUnsignedLong(n);
        }


        case 'L':
            return PyLong_FromLongLong((long long)__builtin_va_arg(*p_va,long long));

        case 'K':
            return PyLong_FromUnsignedLongLong((long long)__builtin_va_arg(*p_va,unsigned long long));

        case 'u':
        {
            PyObject *v;
            Py_UNICODE *u = __builtin_va_arg(*p_va,Py_UNICODE *);
            Py_ssize_t n;
            if (**p_format == '#') {
                ++*p_format;
                if (flags & 1)
                    n = __builtin_va_arg(*p_va,Py_ssize_t);
                else
                    n = __builtin_va_arg(*p_va,int);
            }
            else
                n = -1;
            if (u == ((void *)0)) {
        ...
        case 'd':
            return PyFloat_FromDouble(
                (double)__builtin_va_arg(*p_va,va_double));

        case 'D':
            return PyComplex_FromCComplex(
                *((Py_complex *)__builtin_va_arg(*p_va,Py_complex *)));

        case 'c':
        {
            char p[1];
            p[0] = (char)__builtin_va_arg(*p_va,int);
            return PyBytes_FromStringAndSize(p, 1);
        }
        case 'C':
        {
            int i = __builtin_va_arg(*p_va,int);
        ...
        {
            PyObject *v;
            char *str = __builtin_va_arg(*p_va,char *);
            Py_ssize_t n;
            if (**p_format == '#') {
                ++*p_format;
                if (flags & 1)
        ...
        if (**p_format == '&') {
            ...
            converter func = __builtin_va_arg(*p_va,converter);
            void *arg = __builtin_va_arg(*p_va,void *);
            ++*p_format;
            return (*func)(arg);
        }
        else {
            PyObject *v;
            v = __builtin_va_arg(*p_va,PyObject *);
            if (v != ((void *)0)) {
                if (*(*p_format - 1) != 'N')
                    ( ((PyObject*)(v))->ob_refcnt++);
            }
...
_Py_BuildValue_SizeT(const char *format, ...)
{
    ...
    PyObject* retval;
    __builtin_va_start(va,format);
    retval = va_build_value(format, va, 1);
    __builtin_va_end(va);
    return retval;
}
...
{
    return va_build_value(format, va, 1);
}
...
PyEval_CallFunction(PyObject *obj, const char *format, ...)
{
    ...
    res = PyEval_CallObjectWithKeywords(obj, args, (PyObject *)((void *)0));
...
PyEval_CallMethod(PyObject *obj, const char *methodname, const char *format, ...)
{
    ...
    res = PyEval_CallObjectWithKeywords(meth, args, (PyObject *)((void *)0));
    do { if ( --((PyObject*)(meth))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(meth)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(meth)))); } while (0);
    do { if ( --((PyObject*)(args))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(args)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(args)))); } while (0);
