...
audioop_getsample(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#in:getsample", &cp, &len, &size, &i) )
        return 0;
...
audioop_max(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#i:max", &cp, &len, &size) )
        return 0;
    if (!audioop_check_parameters(len, size))
        return ((void *)0);
...
audioop_minmax(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "s#i:minmax", &cp, &len, &size))
        return ((void *)0);
    if (!audioop_check_parameters(len, size))
        return ((void *)0);
    for (i = 0; i < len; i += size) {
    ...
    return _Py_BuildValue_SizeT("(ii)", min, max);
}
...
audioop_avg(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#i:avg", &cp, &len, &size) )
        return 0;
    if (!audioop_check_parameters(len, size))
        return ((void *)0);
    for ( i=0; i<len; i+= size) {
...
audioop_rms(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#i:rms", &cp, &len, &size) )
        return 0;
    if (!audioop_check_parameters(len, size))
        return ((void *)0);
    for ( i=0; i<len; i+= size) {
...
audioop_findfit(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#s#:findfit",
    ...
    return _Py_BuildValue_SizeT("(nf)", best_j, factor);
}
...
audioop_findfactor(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#s#:findfactor",
                           (char**)&cp1, &len1, (char**)&cp2, &len2) )
        return 0;
    if ( len1 & 1 || len2 & 1 ) {
        PyErr_SetString(AudioopError, "Strings should be even-sized");
...
audioop_findmax(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#n:findmax",
                           (char**)&cp1, &len1, &len2) )
        return 0;
    if ( len1 & 1 ) {
        PyErr_SetString(AudioopError, "Strings should be even-sized");
...
audioop_avgpp(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#i:avgpp", &cp, &len, &size) )
        return 0;
    if (!audioop_check_parameters(len, size))
        return ((void *)0);
    if (len <= size)
...
audioop_maxpp(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#i:maxpp", &cp, &len, &size) )
        return 0;
    if (!audioop_check_parameters(len, size))
        return ((void *)0);
    if (len <= size)
...
audioop_cross(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#i:cross", &cp, &len, &size) )
        return 0;
    if (!audioop_check_parameters(len, size))
        return ((void *)0);
    ncross = -1;
...
audioop_mul(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#id:mul", &cp, &len, &size, &factor ) )
        return 0;
    if (!audioop_check_parameters(len, size))
        return ((void *)0);
    ...
    rv = PyBytes_FromStringAndSize(((void *)0), len);
    if ( rv == 0 )
        return 0;
...
audioop_tomono(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s*idd:tomono",
                           &pcp, &size, &fac1, &fac2 ) )
        return 0;
    cp = pcp.buf;
    len = pcp.len;
    ...
    rv = PyBytes_FromStringAndSize(((void *)0), len/2);
    if ( rv == 0 ) {
        PyBuffer_Release(&pcp);
        return 0;
    }
...
audioop_tostereo(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#idd:tostereo",
...
audioop_add(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#s#i:add",
    ...
    rv = PyBytes_FromStringAndSize(((void *)0), len1);
    if ( rv == 0 )
        return 0;
    ncp = (signed char *)PyBytes_AsString(rv);
...
audioop_bias(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#ii:bias",
                      &cp, &len, &size , &bias) )
        return 0;
    ...
    for ( i=0; i < len; i += size ) {
        if ( size == 1 ) val = (unsigned int)(unsigned char)*((signed char *)(cp+i));
        else if ( size == 2 ) val = (unsigned int)(unsigned short)*((short *)(cp+i));
        else if ( size == 4 ) val = (unsigned int)(Py_UInt32)*((Py_Int32 *)(cp+i));

        val += (unsigned int)bias;

        val &= mask;

        if ( size == 1 ) *((signed char *)(ncp+i)) = (signed char)(unsigned char)val;
        else if ( size == 2 ) *((short *)(ncp+i)) = (short)(unsigned short)val;
        else if ( size == 4 ) *((Py_Int32 *)(ncp+i)) = (Py_Int32)(Py_UInt32)val;
    }
    return rv;
}
...
audioop_reverse(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#i:reverse",
                      &cp, &len, &size) )
        return 0;
    ...
    for ( i=0; i < len; i += size ) {
        if ( size == 1 ) val = ((int)*((signed char *)(cp+i))) << 24;
        else if ( size == 2 ) val = ((int)*((short *)(cp+i))) << 16;
        else if ( size == 4 ) val = (int)*((Py_Int32 *)(cp+i));

        j = len - i - size;

        if ( size == 1 ) *((signed char *)(ncp+j)) = (signed char)(val >> 24);
        else if ( size == 2 ) *((short *)(ncp+j)) = (short)(val >> 16);
        else if ( size == 4 ) *((Py_Int32 *)(ncp+j)) = (Py_Int32)val;
    }
    return rv;
}
...
audioop_lin2lin(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#ii:lin2lin",
                      &cp, &len, &size, &size2) )
        return 0;
    ...
    if (len/size > ((Py_ssize_t)(((size_t)-1)>>1))/size2) {
        PyErr_SetString(PyExc_MemoryError,
                        "not enough memory for output buffer");
        return 0;
    }
    rv = PyBytes_FromStringAndSize(((void *)0), (len/size)*size2);
    if ( rv == 0 )
        return 0;
    ncp = (unsigned char *)PyBytes_AsString(rv);
    ...
    for ( i=0, j=0; i < len; i += size, j += size2 ) {
        ...
        if ( size2 == 1 ) *((signed char *)(ncp+j)) = (signed char)(val >> 24);
        else if ( size2 == 2 ) *((short *)(ncp+j)) = (short)(val >> 16);
        else if ( size2 == 4 ) *((Py_Int32 *)(ncp+j)) = (Py_Int32)val;
    }
    return rv;
}
...
audioop_ratecv(PyObject *self, PyObject *args)
{
    ...
    weightA = 1;
    weightB = 0;
    if (!_PyArg_ParseTuple_SizeT(args, "s#iiiiO|ii:ratecv", &cp, &len, &size,
    ...
    if ((size_t)nchannels > 18446744073709551615ULL/sizeof(int)) {
        PyErr_SetString(PyExc_MemoryError,
                        "not enough memory for output buffer");
        return 0;
    }
    ...
    if (state == (&_Py_NoneStruct)) {
        ...
        if (!_PyArg_ParseTuple_SizeT(state,
        ...
        for (chan = 0; chan < nchannels; chan++) {
            if (!_PyArg_ParseTuple_SizeT(PyTuple_GetItem(samps, chan),
    ...
    if (len == 0)
        str = PyBytes_FromStringAndSize(((void *)0), 0);
    else {
# 1184 "audioop.c"
        Py_ssize_t q = len > 0 ? 1 + (len - 1) / inrate : 0;
        if (outrate > ((Py_ssize_t)(((size_t)-1)>>1)) / q / bytes_per_frame)
            str = ((void *)0);
        else
            str = PyBytes_FromStringAndSize(((void *)0),
    ...
    for (;;) {
        while (d < 0) {
            if (len == 0) {
                ...
                if (str == ((void *)0))
                    goto exit;
                rv = _Py_BuildValue_SizeT("(O(iO))", str, d, samps);
                do { if ( --((PyObject*)(samps))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(samps)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(samps)))); } while (0);
                do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0);
                goto exit;
            }
            for (chan = 0; chan < nchannels; chan++) {
                ...
                if (size == 1)
                    cur_i[chan] = ((int)*((signed char *)(cp+0))) << 24;
                else if (size == 2)
                    cur_i[chan] = ((int)*((short *)(cp+0))) << 16;
                else if (size == 4)
                    cur_i[chan] = (int)*((Py_Int32 *)(cp+0));
                cp += size;
        ...
        while (d >= 0) {
            for (chan = 0; chan < nchannels; chan++) {
                cur_o = (int)(((double)prev_i[chan] * (double)d +
                    ...
                    (double)outrate);
                if (size == 1)
                    *((signed char *)(ncp+0)) = (signed char)(cur_o >> 24);
                else if (size == 2)
                    *((short *)(ncp+0)) = (short)(cur_o >> 16);
                else if (size == 4)
                    *((Py_Int32 *)(ncp+0)) = (Py_Int32)(cur_o);
                ncp += size;
            }
            d -= inrate;
        }
...
audioop_lin2ulaw(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#i:lin2ulaw",
                           &cp, &len, &size) )
        return 0 ;
    ...
    rv = PyBytes_FromStringAndSize(((void *)0), len/size);
    if ( rv == 0 )
        return 0;
    ncp = (unsigned char *)PyBytes_AsString(rv);
...
audioop_ulaw2lin(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#i:ulaw2lin",
                           &cp, &len, &size) )
        return 0;
    ...
    if (len > ((Py_ssize_t)(((size_t)-1)>>1))/size) {
        PyErr_SetString(PyExc_MemoryError,
                        "not enough memory for output buffer");
        return 0;
    }
...
audioop_lin2alaw(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#i:lin2alaw",
                           &cp, &len, &size) )
        return 0;
...
audioop_alaw2lin(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#i:alaw2lin",
                           &cp, &len, &size) )
        return 0;
...
audioop_lin2adpcm(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#iO:lin2adpcm",
                           &cp, &len, &size, &state) )
        return 0;
    ...
    str = PyBytes_FromStringAndSize(((void *)0), len/(size*2));
    if ( str == 0 )
        return 0;
    ...
    if ( state == (&_Py_NoneStruct) ) {
        ...
        valpred = 0;
        index = 0;
    } else if ( !_PyArg_ParseTuple_SizeT(state, "ii", &valpred, &index) )
        return 0;
...
# 1458 "audioop.c"
    ...
    rv = _Py_BuildValue_SizeT("(O(ii))", str, valpred, index);
    do { if ( --((PyObject*)(str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(str)))); } while (0);
    return rv;
}
...
audioop_adpcm2lin(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "s#iO:adpcm2lin",
                           &cp, &len, &size, &state) )
        return 0;
    ...
    if (len > (((Py_ssize_t)(((size_t)-1)>>1))/2)/size) {
        PyErr_SetString(PyExc_MemoryError,
                        "not enough memory for output buffer");
        return 0;
    }
...
{
    PyObject *m, *d;
    m = PyModule_Create2(&audioopmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
