...
# 13 "timemodule.c" 2
# 51 "timemodule.c"
# 1 "/usr/include/mach/mach_time.h" 1 3 4
# 32 "/usr/include/mach/mach_time.h" 3 4
...
struct vm_statistics64 {
 ...
 uint64_t purges;
 natural_t purgeable_count;
# 157 "/usr/include/mach/vm_statistics.h" 3 4
 natural_t speculative_count;
...
# 182 "/usr/include/mach/vm_statistics.h" 3 4
...
# 176 "/usr/include/mach/host_info.h" 3 4
...
# 217 "/usr/include/mach/host_info.h" 3 4
...
# 223 "/usr/include/mach/task_info.h" 3 4
...
# 139 "/usr/include/mach/vm_region.h" 3 4
...
# 197 "/usr/include/mach/vm_region.h" 3 4
...
# 292 "/usr/include/mach/vm_region.h" 3 4
...
# 218 "/usr/include/mach/mach_types.h" 3 4
...
# 230 "/usr/include/mach/mach_types.h" 2 3 4
# 33 "/usr/include/mach/mach_time.h" 2 3 4
...
{
    return floattime(((void *)0));
}

static char time_doc[] = "time() -> floating point number\n\nReturn the current time in seconds since the Epoch.\nFractions of a second may be present if the system clock provides them.";
# 84 "timemodule.c"
static PyObject *
floatclock(_Py_clock_info_t *info)
{
    ...
    if (info) {
        ...
        info->resolution = 1.0 / (double)1000000;
        info->monotonic = 1;
        info->adjustable = 0;
    }
    return PyFloat_FromDouble((double)value / 1000000);
}
# 144 "timemodule.c"
static PyObject*
...
{
    return pyclock(((void *)0));
}

static char clock_doc[] = "clock() -> floating point number\n\nReturn the CPU time or real time since the start of the process or since\nthe first call to clock().  This has as much precision as the system\nrecords.";
# 245 "timemodule.c"
static PyObject *
...
static char sleep_doc[] = "sleep(seconds)\n\nDelay execution for a given number of seconds.  The argument may be\na floating point number for subsecond precision.";
...
tmtotuple(struct tm *p)
{
    ...
    (((PyTupleObject *)(v))->ob_item[0] = PyLong_FromLong((long) p->tm_year + 1900));
    (((PyTupleObject *)(v))->ob_item[1] = PyLong_FromLong((long) p->tm_mon + 1));
    (((PyTupleObject *)(v))->ob_item[2] = PyLong_FromLong((long) p->tm_mday));
    (((PyTupleObject *)(v))->ob_item[3] = PyLong_FromLong((long) p->tm_hour));
    (((PyTupleObject *)(v))->ob_item[4] = PyLong_FromLong((long) p->tm_min));
    (((PyTupleObject *)(v))->ob_item[5] = PyLong_FromLong((long) p->tm_sec));
    (((PyTupleObject *)(v))->ob_item[6] = PyLong_FromLong((long) (p->tm_wday + 6) % 7));
    (((PyTupleObject *)(v))->ob_item[7] = PyLong_FromLong((long) p->tm_yday + 1));
    (((PyTupleObject *)(v))->ob_item[8] = PyLong_FromLong((long) p->tm_isdst));

    (((PyTupleObject *)(v))->ob_item[9] = PyUnicode_DecodeLocale(p->tm_zone, "surrogateescape"));

    (((PyTupleObject *)(v))->ob_item[10] = PyLong_FromLong((long) p->tm_gmtoff));
...
parse_time_t_args(PyObject *args, char *format, time_t *pwhen)
{
    ...
    if (!PyArg_ParseTuple(args, format, &ot))
        return 0;
    if (ot == ((void *)0) || ot == (&_Py_NoneStruct)) {
        whent = time(((void *)0));
    }
    else {
...
static char gmtime_doc[] = "gmtime([seconds]) -> (tm_year, tm_mon, tm_mday, tm_hour, tm_min,\n                       tm_sec, tm_wday, tm_yday, tm_isdst)\n\nConvert seconds since the Epoch to a time tuple expressing UTC (a.k.a.\nGMT).  When 'seconds' is not passed in, convert the current time instead.\n\nIf the platform supports the tm_gmtoff and tm_zone, they are available as\nattributes only.";
# 389 "timemodule.c"
static int
pylocaltime(time_t *timep, struct tm *result)
{
    ...
    (__builtin_expect(!(timep != ((void *)0)), 0) ? __assert_rtn(__func__, "timemodule.c", 394, "timep != NULL") : (void)0);
...
static char localtime_doc[] = "localtime([seconds]) -> (tm_year,tm_mon,tm_mday,tm_hour,tm_min,\n                          tm_sec,tm_wday,tm_yday,tm_isdst)\n\nConvert seconds since the Epoch to a time tuple expressing local time.\nWhen 'seconds' is not passed in, convert the current time instead.";
# 432 "timemodule.c"
static int
gettmarg(PyObject *args, struct tm *p)
{
    ...
    ((__builtin_object_size ((void *) p, 0) != (size_t) -1) ? __builtin___memset_chk ((void *) p, '\0', sizeof(struct tm), __builtin_object_size ((void *) p, 0)) : __inline_memset_chk ((void *) p, '\0', sizeof(struct tm)));
    ...
    if ((((PyObject*)(args))->ob_type) == &StructTimeType) {
        PyObject *item;
        item = (((PyTupleObject *)(args))->ob_item[9]);
        p->tm_zone = item == (&_Py_NoneStruct) ? ((void *)0) : PyUnicode_AsUTF8(item);
        item = (((PyTupleObject *)(args))->ob_item[10]);
        p->tm_gmtoff = item == (&_Py_NoneStruct) ? 0 : PyLong_AsLong(item);
        if (PyErr_Occurred())
            return 0;
    }
...
time_strftime(PyObject *self, PyObject *args)
{
    ...
    wchar_t *outbuf = ((void *)0);
    size_t i;
    PyObject *ret = ((void *)0);

    ((__builtin_object_size ((void *) &buf, 0) != (size_t) -1) ? __builtin___memset_chk ((void *) &buf, '\0', sizeof(buf), __builtin_object_size ((void *) &buf, 0)) : __inline_memset_chk ((void *) &buf, '\0', sizeof(buf)));
...
# 598 "timemodule.c"
    ...
    format = PyUnicode_AsWideCharString(format_arg, ((void *)0));
    if (format == ((void *)0))
        return ((void *)0);
    fmt = format;
# 634 "timemodule.c"
...
static char strftime_doc[] = "strftime(format[, tuple]) -> string\n\nConvert a time tuple to a string according to a format specification.\nSee the library reference manual for formatting codes. When the time tuple\nis not present, current time as returned by localtime() is used.";
...
time_strptime(PyObject *self, PyObject *args)
{
    ...
    static _Py_Identifier PyId__strptime_time = { 0, "_strptime_time", 0 };

    if (!strptime_module)
        return ((void *)0);
    strptime_result = _PyObject_CallMethodId(strptime_module,
                                             &PyId__strptime_time, "O", args);
    do { if ( --((PyObject*)(strptime_module))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(strptime_module)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(strptime_module)))); } while (0);
    return strptime_result;
}


static char strptime_doc[] = "strptime(string, format) -> struct_time\n\nParse a string to a time tuple according to a format specification.\nSee the library reference manual for formatting codes (same as strftime()).";
...
static char asctime_doc[] = "asctime([tuple]) -> string\n\nConvert a time tuple to a string, e.g. 'Sat Jun 06 16:26:11 1998'.\nWhen the time tuple is not present, current time as returned by localtime()\nis used.";
...
static char ctime_doc[] = "ctime(seconds) -> string\n\nConvert a time in seconds since the Epoch to a string in local time.\nThis is equivalent to asctime(localtime(seconds)). When the time tuple is\nnot present, current time as returned by localtime() is used.";
...
static char mktime_doc[] = "mktime(tuple) -> floating point number\n\nConvert a time tuple in local time to seconds since the Epoch.\nNote that mktime(gmtime(0)) will not generally return zero for most\ntime zones; instead the returned value will either be equal to that\nof the timezone or altzone attributes on the time module.";
# 812 "timemodule.c"
...
{
    return pymonotonic(((void *)0));
}

static char monotonic_doc[] = "monotonic() -> float\n\nMonotonic clock, cannot go backward.";
...
{
    return perf_counter(((void *)0));
}

static char perf_counter_doc[] = "perf_counter() -> float\n\nPerformance counter for benchmarking.";
...
{
    return py_process_time(((void *)0));
}

static char process_time_doc[] = "process_time() -> float\n\nProcess time for profiling: sum of the kernel and user-space CPU time.";
...
time_get_clock_info(PyObject *self, PyObject *args)
{
    ...
    (__builtin_expect(!(info.implementation != ((void *)0)), 0) ? __assert_rtn(__func__, "timemodule.c", 1196, "info.implementation != NULL") : (void)0);
    ...
    (__builtin_expect(!(info.monotonic != -1), 0) ? __assert_rtn(__func__, "timemodule.c", 1204, "info.monotonic != -1") : (void)0);
    ...
    (__builtin_expect(!(info.adjustable != -1), 0) ? __assert_rtn(__func__, "timemodule.c", 1212, "info.adjustable != -1") : (void)0);
    ...
    (__builtin_expect(!(info.resolution > 0.0), 0) ? __assert_rtn(__func__, "timemodule.c", 1220, "info.resolution > 0.0") : (void)0);
    (__builtin_expect(!(info.resolution <= 1.0), 0) ? __assert_rtn(__func__, "timemodule.c", 1221, "info.resolution <= 1.0") : (void)0);
...
static char get_clock_info_doc[] = "get_clock_info(name: str) -> dict\n\nGet information of the specified clock.";
...
# 1285 "timemodule.c"
    {
        ...
        t = (time((time_t *)0) / ((time_t)((365 * 24 + 6) * 3600))) * ((time_t)((365 * 24 + 6) * 3600));
        p = localtime(&t);
        janzone = -p->tm_gmtoff;
        ((__builtin_object_size (janname, 0) != (size_t) -1) ? __builtin___strncpy_chk (janname, p->tm_zone ? p->tm_zone : "   ", 9, __builtin_object_size (janname, 2 > 1)) : __inline_strncpy_chk (janname, p->tm_zone ? p->tm_zone : "   ", 9));
        janname[9] = '\0';
        t += ((time_t)((365 * 24 + 6) * 3600))/2;
        p = localtime(&t);
        julyzone = -p->tm_gmtoff;
        ((__builtin_object_size (julyname, 0) != (size_t) -1) ? __builtin___strncpy_chk (julyname, p->tm_zone ? p->tm_zone : "   ", 9, __builtin_object_size (julyname, 2 > 1)) : __inline_strncpy_chk (julyname, p->tm_zone ? p->tm_zone : "   ", 9));
        julyname[9] = '\0';
...
static PyMethodDef time_methods[] = {
    {"time", time_time, 0x0004, time_doc},

    {"clock", time_clock, 0x0004, clock_doc},
    ...
    {"sleep", time_sleep, 0x0001, sleep_doc},
    {"gmtime", time_gmtime, 0x0001, gmtime_doc},
    {"localtime", time_localtime, 0x0001, localtime_doc},
    {"asctime", time_asctime, 0x0001, asctime_doc},
    {"ctime", time_ctime, 0x0001, ctime_doc},

    {"mktime", time_mktime, 0x0008, mktime_doc},


    {"strftime", time_strftime, 0x0001, strftime_doc},

    {"strptime", time_strptime, 0x0001, strptime_doc},

    {"tzset", time_tzset, 0x0004, tzset_doc},


    {"monotonic", time_monotonic, 0x0004, monotonic_doc},

    {"process_time", time_process_time, 0x0004, process_time_doc},
    {"perf_counter", time_perf_counter, 0x0004, perf_counter_doc},
    {"get_clock_info", time_get_clock_info, 0x0001, get_clock_info_doc},
    {((void *)0), ((void *)0)}
};


static char module_doc[] = "This module provides various functions to manipulate time values.\n\nThere are two standard representations of time.  One is the number\nof seconds since the Epoch, in UTC (a.k.a. GMT).  It may be an integer\nor a floating point number (to represent fractions of seconds).\nThe Epoch is system-defined; on Unix, it is generally January 1st, 1970.\nThe actual value can be retrieved by calling gmtime(0).\n\nThe other representation is a tuple of 9 integers giving local time.\nThe tuple items are:\n  year (including century, e.g. 1998)\n  month (1-12)\n  day (1-31)\n  hours (0-23)\n  minutes (0-59)\n  seconds (0-59)\n  weekday (0-6, Monday is 0)\n  Julian day (day in the year, 1-366)\n  DST (Daylight Savings Time) flag (-1, 0 or 1)\nIf the DST flag is 0, the time is given in the regular time zone;\nif it is 1, the time is given in the DST time zone;\nif it is -1, mktime() should guess based on the date and time.\n\nVariables:\n\ntimezone -- difference in seconds between UTC and local standard time\naltzone -- difference in  seconds between UTC and local DST time\ndaylight -- whether local time should reflect DST\ntzname -- tuple of (standard time zone name, DST time zone name)\n\nFunctions:\n\ntime() -- return current time in seconds since the Epoch as a float\nclock() -- return CPU time since process start as a float\nsleep() -- delay for a number of seconds given as a float\ngmtime() -- convert seconds since Epoch to UTC tuple\nlocaltime() -- convert seconds since Epoch to local time tuple\nasctime() -- convert time tuple to string\nctime() -- convert time in seconds to string\nmktime() -- convert local time tuple to seconds since Epoch\nstrftime() -- convert time tuple to string according to format specification\nstrptime() -- parse string to time tuple according to format specification\ntzset() -- change the local timezone";
# 1436 "timemodule.c"
...
{
    PyObject *m;
    m = PyModule_Create2(&timemodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
...
# 1471 "timemodule.c"
    ...
    ( ((PyObject*)(&StructTimeType))->ob_refcnt++);
