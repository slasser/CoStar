...
PyMember_SetOne(char *addr, PyMemberDef *l, PyObject *v)
{
    ...
    switch (l->type) {
    case 14:{
        if (!((((PyObject*)(v))->ob_type) == &PyBool_Type)) {
            PyErr_SetString(PyExc_TypeError,
    ...
    case 8:{
        ...
        *(char*)addr = (char)long_val;
        ...
        if ((long_val > 127) || (long_val < (-127 - 1)))
            do { if (PyErr_WarnEx(PyExc_RuntimeWarning, "Truncation of value to char", 1) < 0) return -1; } while (0);
        break;
        }
    case 9:{
        long long_val = PyLong_AsLong(v);
        ...
        *(unsigned char*)addr = (unsigned char)long_val;
        if ((long_val > (127 * 2 + 1)) || (long_val < 0))
            do { if (PyErr_WarnEx(PyExc_RuntimeWarning, "Truncation of value to unsigned char", 1) < 0) return -1; } while (0);
        break;
        }
    case 0:{
        long long_val = PyLong_AsLong(v);
        ...
        *(short*)addr = (short)long_val;
        if ((long_val > 32767) || (long_val < (-32767 - 1)))
            do { if (PyErr_WarnEx(PyExc_RuntimeWarning, "Truncation of value to short", 1) < 0) return -1; } while (0);
        break;
        }
    case 10:{
        long long_val = PyLong_AsLong(v);
        ...
        *(unsigned short*)addr = (unsigned short)long_val;
        if ((long_val > (32767 * 2 + 1)) || (long_val < 0))
            do { if (PyErr_WarnEx(PyExc_RuntimeWarning, "Truncation of value to unsigned short", 1) < 0) return -1; } while (0);
        break;
        }
    case 1:{
        long long_val = PyLong_AsLong(v);
        ...
        *(int *)addr = (int)long_val;
        if ((long_val > 2147483647) || (long_val < (-2147483647 - 1)))
            do { if (PyErr_WarnEx(PyExc_RuntimeWarning, "Truncation of value to int", 1) < 0) return -1; } while (0);
        break;
        }
    case 11:{
        ...
        if ((ulong_val == (unsigned long)-1) && PyErr_Occurred()) {
            ...
            *(unsigned int *)addr = (unsigned int)ulong_val;
            do { if (PyErr_WarnEx(PyExc_RuntimeWarning, "Writing negative value into unsigned field", 1) < 0) return -1; } while (0);
        } else
            *(unsigned int *)addr = (unsigned int)ulong_val;
        if (ulong_val > (2147483647 * 2U + 1U))
            do { if (PyErr_WarnEx(PyExc_RuntimeWarning, "Truncation of value to unsigned int", 1) < 0) return -1; } while (0);
        break;
        }
    case 2:{
    ...
    case 16:
        ...
        oldv = *(PyObject **)addr;
        *(PyObject **)addr = v;
        do { if ((oldv) == ((void *)0)) ; else do { if ( --((PyObject*)(oldv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(oldv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(oldv)))); } while (0); } while (0);
        break;
    case 7: {
        char *string;
        Py_ssize_t len;
