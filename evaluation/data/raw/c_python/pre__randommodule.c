...
random_seed(RandomObject *self, PyObject *args)
{
    ...
    PyObject *masklower = ((void *)0);
    PyObject *thirtytwo = ((void *)0);
    PyObject *n = ((void *)0);
    unsigned long *new_key, *key = ((void *)0);
    ...
    if (arg == ((void *)0) || arg == (&_Py_NoneStruct)) {
        time_t now;
...
# 254 "_randommodule.c"
    ...
    while ((err=PyObject_IsTrue(n))) {
        ...
        do { if ( --((PyObject*)(pychunk))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pychunk)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pychunk)))); } while (0);
        ...
        if (keyused >= keymax) {
            ...
            if ((bigger >> 1) != keymax ||
                bigger > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(*key)) {
                PyErr_NoMemory();
                goto Done;
            }
        ...
        (__builtin_expect(!(keyused < keymax), 0) ? __assert_rtn(__func__, "_randommodule.c", 299, "keyused < keymax") : (void)0);
        key[keyused++] = chunk;
    }
...
Done:
    do { if ((masklower) == ((void *)0)) ; else do { if ( --((PyObject*)(masklower))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(masklower)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(masklower)))); } while (0); } while (0);
    do { if ((thirtytwo) == ((void *)0)) ; else do { if ( --((PyObject*)(thirtytwo))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(thirtytwo)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(thirtytwo)))); } while (0); } while (0);
    do { if ((n) == ((void *)0)) ; else do { if ( --((PyObject*)(n))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(n)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(n)))); } while (0); } while (0);
    PyMem_Free(key);
    return result;
}
...
random_getstate(RandomObject *self)
{
    ...
    for (i=0; i<624 ; i++) {
        ...
        if (element == ((void *)0))
            goto Fail;
        (((PyTupleObject *)(state))->ob_item[i] = element);
    }
...
random_setstate(RandomObject *self, PyObject *state)
{
    ...
    if (!((((((PyObject*)(state))->ob_type))->tp_flags & ((1L<<26))) != 0)) {
        PyErr_SetString(PyExc_TypeError,
            "state vector must be a tuple");
        return ((void *)0);
    }
    if (PyTuple_Size(state) != 624 +1) {
    ...
    for (i=0; i<624 ; i++) {
        element = PyLong_AsUnsignedLong((((PyTupleObject *)(state))->ob_item[i]));
        if (element == (unsigned long)-1 && PyErr_Occurred())
            return ((void *)0);
        self->state[i] = element & 0xffffffffUL;
    }

    index = PyLong_AsLong((((PyTupleObject *)(state))->ob_item[i]));
...
static PyMethodDef random_methods[] = {
    {"random", (PyCFunction)random_random, 0x0004,
        "random() -> x in the interval [0, 1)."},
    {"seed", (PyCFunction)random_seed, 0x0001,
        "seed([n]) -> None.  Defaults to current time."},
    {"getstate", (PyCFunction)random_getstate, 0x0004,
        "getstate() -> tuple containing the current state."},
    {"setstate", (PyCFunction)random_setstate, 0x0008,
        "setstate(state) -> None.  Restores generator state."},
    {"getrandbits", (PyCFunction)random_getrandbits, 0x0001,
        "getrandbits(k) -> x.  Generates a long int with " "k random bits."},

    {((void *)0), ((void *)0)}
};

static char random_doc[] = "Random() -> create a random number generator with its own internal state.";
...
static char module_doc[] = "Module implements the Mersenne Twister random number generator.";
...
PyInit__random(void)
{
    ...
    if (PyType_Ready(&Random_Type) < 0)
        return ((void *)0);
    m = PyModule_Create2(&_randommodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    ( ((PyObject*)(&Random_Type))->ob_refcnt++);
