...
PySeqIter_New(PyObject *seq)
{
    ...
    if (!PySequence_Check(seq)) {
        _PyErr_BadInternalCall("iterobject.c", 17);
        return ((void *)0);
    }
    it = ( (seqiterobject *) _PyObject_GC_New(&PySeqIter_Type) );
    if (it == ((void *)0))
        return ((void *)0);
    it->it_index = 0;
...
{
    do { PyGC_Head *g = ((PyGC_Head *)(it)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "iterobject.c", 33, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
...
iter_iternext(PyObject *iterator)
{
    ...
    (__builtin_expect(!(((((PyObject*)(iterator))->ob_type) == &PySeqIter_Type)), 0) ? __assert_rtn(__func__, "iterobject.c", 52, "PySeqIter_Check(iterator)") : (void)0);
...
static PyMethodDef seqiter_methods[] = {
    {"__length_hint__", (PyCFunction)iter_len, 0x0004, length_hint_doc},
    {"__reduce__", (PyCFunction)iter_reduce, 0x0004, reduce_doc},
    {"__setstate__", (PyCFunction)iter_setstate, 0x0008, setstate_doc},
    {((void *)0), ((void *)0)}
};
...
{
    calliterobject *it;
    it = ( (calliterobject *) _PyObject_GC_New(&PyCallIter_Type) );
    if (it == ((void *)0))
        return ((void *)0);
    ( ((PyObject*)(callable))->ob_refcnt++);
    it->it_callable = callable;
    ( ((PyObject*)(sentinel))->ob_refcnt++);
...
{
    do { PyGC_Head *g = ((PyGC_Head *)(it)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "iterobject.c", 184, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
    do { if ((it->it_callable) == ((void *)0)) ; else do { if ( --((PyObject*)(it->it_callable))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(it->it_callable)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(it->it_callable)))); } while (0); } while (0);
    do { if ((it->it_sentinel) == ((void *)0)) ; else do { if ( --((PyObject*)(it->it_sentinel))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(it->it_sentinel)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(it->it_sentinel)))); } while (0); } while (0);
    PyObject_GC_Del(it);
}
...
{
    do { if (it->it_callable) { int vret = visit((PyObject *)(it->it_callable), arg); if (vret) return vret; } } while (0);
    do { if (it->it_sentinel) { int vret = visit((PyObject *)(it->it_sentinel), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
{
    if (it->it_callable != ((void *)0)) {
        PyObject *args = PyTuple_New(0);
        PyObject *result;
        if (args == ((void *)0))
            return ((void *)0);
        result = PyObject_Call(it->it_callable, args, ((void *)0));
        do { if ( --((PyObject*)(args))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(args)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(args)))); } while (0);
        if (result != ((void *)0)) {
            int ok;
            ok = PyObject_RichCompareBool(it->it_sentinel, result, 2);
            if (ok == 0)
                return result;
            do { if ( --((PyObject*)(result))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(result)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(result)))); } while (0);
            if (ok > 0) {
                do { if (it->it_callable) { PyObject *_py_tmp = (PyObject *)(it->it_callable); (it->it_callable) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
                do { if (it->it_sentinel) { PyObject *_py_tmp = (PyObject *)(it->it_sentinel); (it->it_sentinel) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
            }
        }
...
{
    if (it->it_callable != ((void *)0) && it->it_sentinel != ((void *)0))
...
static PyMethodDef calliter_methods[] = {
    {"__reduce__", (PyCFunction)calliter_reduce, 0x0004, reduce_doc},
    {((void *)0), ((void *)0)}
};
