...
static char weakref_getweakrefcount__doc__[] = "getweakrefcount(object) -- return the number of weak references\n" "to 'object'.";
...
weakref_getweakrefcount(PyObject *self, PyObject *object)
{
    ...
    if ((((((PyObject*)(object))->ob_type))->tp_weaklistoffset > 0)) {
        PyWeakReference **list = ((PyWeakReference **) ((PyObject **) (((char *) (object)) + (((PyObject*)(object))->ob_type)->tp_weaklistoffset)));
...
static char weakref_getweakrefs__doc__[] = "getweakrefs(object) -- return a list of all weak reference objects\n" "that point to 'object'.";
...
weakref_getweakrefs(PyObject *self, PyObject *object)
{
    ...
    if ((((((PyObject*)(object))->ob_type))->tp_weaklistoffset > 0)) {
        ...
        if (result != ((void *)0)) {
            ...
            Py_ssize_t i;
            for (i = 0; i < count; ++i) {
                (((PyListObject *)(result))->ob_item[i] = ((PyObject *) current));
...
static char weakref_proxy__doc__[] = "proxy(object[, callback]) -- create a proxy object that weakly\n" "references 'object'.  'callback', if given, is called with a\n" "reference to the proxy when 'object' is about to be finalized.";
...
static PyMethodDef
weakref_functions[] = {
    {"getweakrefcount", weakref_getweakrefcount, 0x0008,
     weakref_getweakrefcount__doc__},
    {"getweakrefs", weakref_getweakrefs, 0x0008,
     weakref_getweakrefs__doc__},
    {"proxy", weakref_proxy, 0x0001,
...
PyInit__weakref(void)
{
    ...
    m = PyModule_Create2(&weakrefmodule, 1013);

    if (m != ((void *)0)) {
        ( ((PyObject*)(&_PyWeakref_RefType))->ob_refcnt++);
        PyModule_AddObject(m, "ref",
                           (PyObject *) &_PyWeakref_RefType);
        ( ((PyObject*)(&_PyWeakref_RefType))->ob_refcnt++);
        PyModule_AddObject(m, "ReferenceType",
                           (PyObject *) &_PyWeakref_RefType);
        ( ((PyObject*)(&_PyWeakref_ProxyType))->ob_refcnt++);
        PyModule_AddObject(m, "ProxyType",
                           (PyObject *) &_PyWeakref_ProxyType);
        ( ((PyObject*)(&_PyWeakref_CallableProxyType))->ob_refcnt++);
