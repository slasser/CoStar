...
static PyObject *false_str = ((void *)0);
static PyObject *true_str = ((void *)0);
...
{
    if (!((((PyObject*)(a))->ob_type) == &PyBool_Type) || !((((PyObject*)(b))->ob_type) == &PyBool_Type))
        return PyLong_Type.tp_as_number->nb_and(a, b);
    return PyBool_FromLong((a == ((PyObject *) &_Py_TrueStruct)) & (b == ((PyObject *) &_Py_TrueStruct)));
}
