...
static char xxsubtype__doc__[] = "xxsubtype is an example module showing how to subtype builtin types from C.\n" "test_descr.py in the standard test suite requires it in order to complete.\n" "If you don't care about the examples, and don't intend to run the Python\n" "test suite, you can recompile Python without Modules/xxsubtype.c.";
# 21 "xxsubtype.c"
typedef struct {
    PyListObject list;
    int state;
...
spamlist_specialmeth(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if (result != ((void *)0)) {
        ...
        (((PyTupleObject *)(result))->ob_item[0] = self);
        ( ((PyObject*)(args))->ob_refcnt++);
        (((PyTupleObject *)(result))->ob_item[1] = args);
        ( ((PyObject*)(kw))->ob_refcnt++);
        (((PyTupleObject *)(result))->ob_item[2] = kw);
    }
    return result;
}

static PyMethodDef spamlist_methods[] = {
    {"getstate", (PyCFunction)spamlist_getstate, 0x0001,
        "getstate() -> state"},
    {"setstate", (PyCFunction)spamlist_setstate, 0x0001,
        "setstate(state)"},
...
static PyGetSetDef spamlist_getsets[] = {
    {"state", (getter)spamlist_state_get, ((void *)0),
...
static PyMethodDef spamdict_methods[] = {
    {"getstate", (PyCFunction)spamdict_getstate, 0x0001,
        "getstate() -> state"},
    {"setstate", (PyCFunction)spamdict_setstate, 0x0001,
        "setstate(state)"},
    {((void *)0), ((void *)0)},
};
...
static PyMemberDef spamdict_members[] = {
    {"state", 1, __builtin_offsetof (spamdictobject, state), 1,
     "an int variable for demonstration purposes"},
    {0}
};
...
spam_bench(PyObject *self, PyObject *args)
{
    ...
    t1 = clock();
    return PyFloat_FromDouble((double)(t1-t0) / 1000000);
}

static PyMethodDef xxsubtype_functions[] = {
    {"bench", spam_bench, 0x0001},
    {((void *)0), ((void *)0)}
};
...
PyInit_xxsubtype(void)
{
    ...
    m = PyModule_Create2(&xxsubtypemodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    ...
    ( ((PyObject*)(&spamlist_type))->ob_refcnt++);
    if (PyModule_AddObject(m, "spamlist",
                           (PyObject *) &spamlist_type) < 0)
        return ((void *)0);

    ( ((PyObject*)(&spamdict_type))->ob_refcnt++);
