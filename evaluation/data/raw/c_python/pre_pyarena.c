...
block_new(size_t size)
{
    ...
    b->ab_mem = (void *)(b + 1);
    b->ab_next = ((void *)0);
    b->ab_offset = (char *)((void *)(((Py_uintptr_t)(b->ab_mem) + (Py_uintptr_t)((8) - 1)) & ~(Py_uintptr_t)((8) - 1))) -
            (char *)(b->ab_mem);
    return b;
}
...
{
    void *p;
    (__builtin_expect(!(b), 0) ? __assert_rtn(__func__, "pyarena.c", 104, "b") : (void)0);
    size = (((size_t)(size) + (size_t)((8) - 1)) & ~(size_t)((8) - 1));
    if (b->ab_offset + size > b->ab_size) {
        ...
        if (!newbl)
            return ((void *)0);
        (__builtin_expect(!(!b->ab_next), 0) ? __assert_rtn(__func__, "pyarena.c", 116, "!b->ab_next") : (void)0);
        b->ab_next = newbl;
        b = newbl;
    }

    (__builtin_expect(!(b->ab_offset + size <= b->ab_size), 0) ? __assert_rtn(__func__, "pyarena.c", 121, "b->ab_offset + size <= b->ab_size") : (void)0);
...
{
    (__builtin_expect(!(arena), 0) ? __assert_rtn(__func__, "pyarena.c", 159, "arena") : (void)0);
# 169 "pyarena.c"
    block_free(arena->a_head);
    ...
    do { if ( --((PyObject*)(arena->a_objects))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(arena->a_objects)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(arena->a_objects)))); } while (0);
    free(arena);
}
