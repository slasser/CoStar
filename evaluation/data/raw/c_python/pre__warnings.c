...
static char warnings__doc__[] = "_warnings" " provides basic warning filtering support.\n" "It is a helper module to speed up interpreter start-up.";
...
{
    PyObject *result;
    static _Py_Identifier PyId_match = { 0, "match", 0 };
    int rc;
...
{
    static PyObject *warnings_str = ((void *)0);
    PyObject *all_modules;
    PyObject *warnings_module;
    int result;

    if (warnings_str == ((void *)0)) {
...
get_once_registry(void)
{
    ...
    do { if ( --((PyObject*)(_once_registry))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_once_registry)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_once_registry)))); } while (0);
...
get_default_action(void)
{
    ...
    do { if ( --((PyObject*)(_default_action))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_default_action)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_default_action)))); } while (0);
           ...
           PyObject *module, PyObject **item)
{
    ...
    if (warnings_filters == ((void *)0)) {
        if (PyErr_Occurred())
            return ((void *)0);
    }
    else {
        do { if ( --((PyObject*)(_filters))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_filters)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_filters)))); } while (0);
        _filters = warnings_filters;
    }

    if (_filters == ((void *)0) || !((((((PyObject*)(_filters))->ob_type))->tp_flags & ((1L<<25))) != 0)) {
    ...
    for (i = 0; i < (((PyVarObject*)(_filters))->ob_size); i++) {
        PyObject *tmp_item, *action, *msg, *cat, *mod, *ln_obj;
        Py_ssize_t ln;
        int is_subclass, good_msg, good_mod;

        tmp_item = *item = (((PyListObject *)(_filters))->ob_item[i]);
        if (PyTuple_Size(tmp_item) != 5) {
            PyErr_Format(PyExc_ValueError,
                         "_warnings" ".filters item %zd isn't a 5-tuple", i);
            return ((void *)0);
        }


        action = (((PyTupleObject *)(tmp_item))->ob_item[0]);
        msg = (((PyTupleObject *)(tmp_item))->ob_item[1]);
        cat = (((PyTupleObject *)(tmp_item))->ob_item[2]);
        mod = (((PyTupleObject *)(tmp_item))->ob_item[3]);
        ln_obj = (((PyTupleObject *)(tmp_item))->ob_item[4]);
        ...
        if (good_msg && is_subclass && good_mod && (ln == 0 || lineno == ln))
            return PyUnicode_AsUTF8(action);
    }
...
already_warned(PyObject *registry, PyObject *key, int should_set)
{
    ...
    if (should_set)
        return PyDict_SetItem(registry, key, ((PyObject *) &_Py_TrueStruct));
    return 0;
}
...
normalize_module(PyObject *filename)
{
    ...
    mod_str = PyUnicode_AsUTF8(filename);
    if (mod_str == ((void *)0))
        return ((void *)0);
                ...
                int add_zero)
{
    ...
    do { if ((altkey) == ((void *)0)) ; else do { if ( --((PyObject*)(altkey))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(altkey)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(altkey)))); } while (0); } while (0);
    return rc;
}
                ...
                *category, PyObject *sourceline)
{
    ...
    PyFile_WriteObject(filename, f_stderr, 1);
    PyFile_WriteString(lineno_str, f_stderr);
    PyFile_WriteObject(name, f_stderr, 1);
    PyFile_WriteString(": ", f_stderr);
    PyFile_WriteObject(text, f_stderr, 1);
    PyFile_WriteString("\n", f_stderr);
    ...
    if (sourceline) {
        char *source_line_str = PyUnicode_AsUTF8(sourceline);
        if (source_line_str == ((void *)0))
                return;
...
{
    PyObject *key = ((void *)0), *text = ((void *)0), *result = ((void *)0), *lineno_obj = ((void *)0);
    PyObject *item = (&_Py_NoneStruct);
    const char *action;
    int rc;

    if (registry && !((((((PyObject*)(registry))->ob_type))->tp_flags & ((1L<<29))) != 0) && (registry != (&_Py_NoneStruct))) {
    ...
    if ((registry != ((void *)0)) && (registry != (&_Py_NoneStruct))) {
    ...
    if (strcmp(action, "always") != 0) {
        if (registry != ((void *)0) && registry != (&_Py_NoneStruct) &&
                PyDict_SetItem(registry, key, ((PyObject *) &_Py_TrueStruct)) < 0)
            goto cleanup;
            ...
            if (to_str != ((void *)0)) {
                err_str = PyUnicode_AsUTF8(to_str);
                if (err_str == ((void *)0))
                        goto cleanup;
            }
            PyErr_Format(PyExc_RuntimeError,
                        ...
                        action, err_str);
            do { if ((to_str) == ((void *)0)) ; else do { if ( --((PyObject*)(to_str))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(to_str)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(to_str)))); } while (0); } while (0);
            goto cleanup;
        }
    }
        ...
        if (show_fxn == ((void *)0)) {
            ...
            if (!PyCallable_Check(show_fxn)) {
                PyErr_SetString(PyExc_TypeError,
                                ...
                                "callable");
                do { if ( --((PyObject*)(show_fxn))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(show_fxn)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(show_fxn)))); } while (0);
                goto cleanup;
            }
 ...
 cleanup:
    ...
    do { if ((lineno_obj) == ((void *)0)) ; else do { if ( --((PyObject*)(lineno_obj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(lineno_obj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(lineno_obj)))); } while (0); } while (0);
              ...
              PyObject **module, PyObject **registry)
{
    ...
    *module = ((void *)0);
    ...
    (__builtin_expect(!(globals != ((void *)0)), 0) ? __assert_rtn(__func__, "_warnings.c", 472, "globals != NULL") : (void)0);
    (__builtin_expect(!(((((((PyObject*)(globals))->ob_type))->tp_flags & ((1L<<29))) != 0)), 0) ? __assert_rtn(__func__, "_warnings.c", 473, "PyDict_Check(globals)") : (void)0);
    ...
    *filename = PyDict_GetItemString(globals, "__file__");
    if (*filename != ((void *)0) && ((((((PyObject*)(*filename))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        Py_ssize_t len;
        int kind;
        void *data;

        if (((__builtin_expect(!(((((((PyObject*)(*filename))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_warnings.c", 506, "PyUnicode_Check(*filename)") : (void)0), ((((PyASCIIObject*)*filename)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(*filename)))))
            goto handle_error;

        len = PyUnicode_GetLength(*filename);
        kind = ((__builtin_expect(!(((((((PyObject*)(*filename))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_warnings.c", 510, "PyUnicode_Check(*filename)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)*filename)->state.ready)), 0) ? __assert_rtn(__func__, "_warnings.c", 510, "PyUnicode_IS_READY(*filename)") : (void)0), ((PyASCIIObject *)(*filename))->state.kind);
        data = ((__builtin_expect(!(((((((PyObject*)(*filename))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_warnings.c", 511, "PyUnicode_Check(*filename)") : (void)0), (((PyASCIIObject*)(*filename))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)(*filename))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_warnings.c", 511, "PyUnicode_Check(*filename)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)*filename)->state.ready)), 0) ? __assert_rtn(__func__, "_warnings.c", 511, "PyUnicode_IS_READY(*filename)") : (void)0), ((PyASCIIObject*)*filename)->state.ascii) ? ((void*)((PyASCIIObject*)(*filename) + 1)) : ((void*)((PyCompactUnicodeObject*)(*filename) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)(*filename))->data.any), 0) ? __assert_rtn(__func__, "_warnings.c", 511, "((PyUnicodeObject*)(*filename))->data.any") : (void)0), ((((PyUnicodeObject *)(*filename))->data.any))));



        if (len >= 4 &&
            ((Py_UCS4) ((kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(data))[(len-4)] : ((kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(data))[(len-4)] : ((const Py_UCS4 *)(data))[(len-4)] ) )) == '.' &&
            ((((Py_UCS4) ((kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(data))[(len-3)] : ((kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(data))[(len-3)] : ((const Py_UCS4 *)(data))[(len-3)] ) )) <= 127) ? (_Py_ctype_tolower[((unsigned char)((((Py_UCS4) ((kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(data))[(len-3)] : ((kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(data))[(len-3)] : ((const Py_UCS4 *)(data))[(len-3)] ) ))) & 0xff))]) : 0) == 'p' &&
            ((((Py_UCS4) ((kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(data))[(len-2)] : ((kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(data))[(len-2)] : ((const Py_UCS4 *)(data))[(len-2)] ) )) <= 127) ? (_Py_ctype_tolower[((unsigned char)((((Py_UCS4) ((kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(data))[(len-2)] : ((kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(data))[(len-2)] : ((const Py_UCS4 *)(data))[(len-2)] ) ))) & 0xff))]) : 0) == 'y' &&
            (((((Py_UCS4) ((kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(data))[(len-1)] : ((kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(data))[(len-1)] : ((const Py_UCS4 *)(data))[(len-1)] ) )) <= 127) ? (_Py_ctype_tolower[((unsigned char)((((Py_UCS4) ((kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(data))[(len-1)] : ((kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(data))[(len-1)] : ((const Py_UCS4 *)(data))[(len-1)] ) ))) & 0xff))]) : 0) == 'c' ||
                ((((Py_UCS4) ((kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(data))[(len-1)] : ((kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(data))[(len-1)] : ((const Py_UCS4 *)(data))[(len-1)] ) )) <= 127) ? (_Py_ctype_tolower[((unsigned char)((((Py_UCS4) ((kind) == PyUnicode_1BYTE_KIND ? ((const Py_UCS1 *)(data))[(len-1)] : ((kind) == PyUnicode_2BYTE_KIND ? ((const Py_UCS2 *)(data))[(len-1)] : ((const Py_UCS4 *)(data))[(len-1)] ) ))) & 0xff))]) : 0) == 'o'))
        {
            *filename = PyUnicode_Substring(*filename, 0,
                                            ((__builtin_expect(!(((((((PyObject*)(*filename))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "_warnings.c", 523, "PyUnicode_Check(*filename)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)*filename)->state.ready)), 0) ? __assert_rtn(__func__, "_warnings.c", 523, "PyUnicode_IS_READY(*filename)") : (void)0), ((PyASCIIObject *)(*filename))->length)-1);
            if (*filename == ((void *)0))
                goto handle_error;
        }
        else
        ...
        *filename = ((void *)0);
        ...
        if (strcmp(module_str, "__main__") == 0) {
            ...
            if (argv != ((void *)0) && PyList_Size(argv) > 0) {
                int is_true;
 ...
 handle_error:
    ...
    do { if ((*registry) == ((void *)0)) ; else do { if ( --((PyObject*)(*registry))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(*registry)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(*registry)))); } while (0); } while (0);
...
do_warn(PyObject *message, PyObject *category, Py_ssize_t stack_level)
{
    ...
    res = warn_explicit(category, message, filename, lineno, module, registry,
                        ((void *)0));
    do { if ( --((PyObject*)(filename))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(filename)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(filename)))); } while (0);
    do { if ( --((PyObject*)(registry))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(registry)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(registry)))); } while (0);
    do { if ( --((PyObject*)(module))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(module)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(module)))); } while (0);
    return res;
}
...
warnings_warn(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *message, *category = ((void *)0);
...
warnings_warn_explicit(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *registry = ((void *)0);
    PyObject *module_globals = ((void *)0);
    ...
    if (module_globals) {
        static _Py_Identifier PyId_get_source = { 0, "get_source", 0 };
        static _Py_Identifier PyId_splitlines = { 0, "splitlines", 0 };
        PyObject *tmp;
        PyObject *loader;
        ...
        if ((tmp = _PyUnicode_FromId(&PyId_get_source)) == ((void *)0))
            return ((void *)0);
        if ((tmp = _PyUnicode_FromId(&PyId_splitlines)) == ((void *)0))
            return ((void *)0);
        ...
        if (loader == ((void *)0) || module_name == ((void *)0))
            goto standard_call;
        ...
        if (!source_line) {
            do { if ( --((PyObject*)(source_list))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(source_list)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(source_list)))); } while (0);
            return ((void *)0);
        }
                   ...
                   const char *module_str, PyObject *registry)
{
    ...
    if (message == ((void *)0) || filename == ((void *)0))
        goto exit;
    if (module_str != ((void *)0)) {
...
static char warn_doc[] = "Issue a warning, or maybe ignore it or raise an exception.";


static char warn_explicit_doc[] = "Low-level inferface to warnings functionality.";


static PyMethodDef warnings_functions[] = {
    {"warn", (PyCFunction)warnings_warn, 0x0001 | 0x0002,
        warn_doc},
    {"warn_explicit", (PyCFunction)warnings_warn_explicit,
        0x0001 | 0x0002, warn_explicit_doc},
...
{
    static PyObject *ignore_str = ((void *)0);
    static PyObject *error_str = ((void *)0);
    static PyObject *default_str = ((void *)0);
    static PyObject *always_str = ((void *)0);
    PyObject *action_obj = ((void *)0);
    PyObject *lineno, *result;

    if (!strcmp(action, "ignore")) {
        if (ignore_str == ((void *)0)) {
    ...
    if (lineno == ((void *)0))
        return ((void *)0);
    result = PyTuple_Pack(5, action_obj, (&_Py_NoneStruct), category, (&_Py_NoneStruct), lineno);
    do { if ( --((PyObject*)(lineno))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(lineno)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(lineno)))); } while (0);
    return result;
}
...
init_filters(void)
{
    ...
    (((PyListObject *)(filters))->ob_item[pos++] = (create_filter(PyExc_DeprecationWarning, "ignore")));

    (((PyListObject *)(filters))->ob_item[pos++] = (create_filter(PyExc_PendingDeprecationWarning, "ignore")));

    (((PyListObject *)(filters))->ob_item[pos++] = (create_filter(PyExc_ImportWarning, "ignore")));
    ...
    if (Py_BytesWarningFlag > 1)
        ...
        bytes_action = "ignore";
    (((PyListObject *)(filters))->ob_item[pos++] = (create_filter(PyExc_BytesWarning, bytes_action)));
    ...
    (((PyListObject *)(filters))->ob_item[pos++] = (create_filter(PyExc_ResourceWarning, resource_action)));

    for (x = 0; x < pos; x += 1) {
        if ((((PyListObject *)(filters))->ob_item[x]) == ((void *)0)) {
            do { if ( --((PyObject*)(filters))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(filters)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(filters)))); } while (0);
            return ((void *)0);
        }
    }
...
_PyWarnings_Init(void)
{
    ...
    m = PyModule_Create2(&warningsmodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);
    ...
    ( ((PyObject*)(_filters))->ob_refcnt++);
    if (PyModule_AddObject(m, "filters", _filters) < 0)
        return ((void *)0);

    if (_once_registry == ((void *)0)) {
        _once_registry = PyDict_New();
        if (_once_registry == ((void *)0))
            return ((void *)0);
    }
    ( ((PyObject*)(_once_registry))->ob_refcnt++);
    if (PyModule_AddObject(m, "_onceregistry", _once_registry) < 0)
        return ((void *)0);

    if (_default_action == ((void *)0)) {
        _default_action = PyUnicode_FromString("default");
        if (_default_action == ((void *)0))
            return ((void *)0);
    }
    ( ((PyObject*)(_default_action))->ob_refcnt++);
