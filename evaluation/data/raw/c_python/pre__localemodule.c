...
# 17 "_localemodule.c" 2




# 1 "/usr/include/errno.h" 1 3 4
# 22 "_localemodule.c" 2
...
static char setlocale__doc__[] = "(integer,string=None) -> string. Activates/queries locale processing.";
...
{
    int i;
    PyObject *result, *val = ((void *)0);

    if (s[0] == '\0')

        return PyList_New(0);

    for (i = 0; s[i] != '\0' && s[i] != 127; i++)
        ;
...
{
    int category;
    char *locale = ((void *)0), *result;
    PyObject *result_object;

    if (!_PyArg_ParseTuple_SizeT(args, "i|z:setlocale", &category, &locale))
        return ((void *)0);
# 107 "_localemodule.c"
    if (locale) {
        ...
        result_object = PyUnicode_DecodeLocale(result, ((void *)0));
        if (!result_object)
            return ((void *)0);
    } else {

        result = setlocale(category, ((void *)0));
        if (!result) {
...
static char localeconv__doc__[] = "() -> dict. Returns numeric and monetary locale-specific parameters.";
...
PyLocale_localeconv(PyObject* self)
{
    ...
    l = localeconv();
# 163 "_localemodule.c"
    x = PyUnicode_DecodeLocale(l->decimal_point, ((void *)0)); if (!x) goto failed; PyDict_SetItemString(result, "decimal_point", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = PyUnicode_DecodeLocale(l->thousands_sep, ((void *)0)); if (!x) goto failed; PyDict_SetItemString(result, "thousands_sep", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    ...
    x = PyUnicode_DecodeLocale(l->int_curr_symbol, ((void *)0)); if (!x) goto failed; PyDict_SetItemString(result, "int_curr_symbol", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = PyUnicode_DecodeLocale(l->currency_symbol, ((void *)0)); if (!x) goto failed; PyDict_SetItemString(result, "currency_symbol", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = PyUnicode_DecodeLocale(l->mon_decimal_point, ((void *)0)); if (!x) goto failed; PyDict_SetItemString(result, "mon_decimal_point", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = PyUnicode_DecodeLocale(l->mon_thousands_sep, ((void *)0)); if (!x) goto failed; PyDict_SetItemString(result, "mon_thousands_sep", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = copy_grouping(l->mon_grouping);
    if (!x)
        goto failed;
    PyDict_SetItemString(result, "mon_grouping", x);
    do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = PyUnicode_DecodeLocale(l->positive_sign, ((void *)0)); if (!x) goto failed; PyDict_SetItemString(result, "positive_sign", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = PyUnicode_DecodeLocale(l->negative_sign, ((void *)0)); if (!x) goto failed; PyDict_SetItemString(result, "negative_sign", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = PyLong_FromLong(l->int_frac_digits); if (!x) goto failed; PyDict_SetItemString(result, "int_frac_digits", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = PyLong_FromLong(l->frac_digits); if (!x) goto failed; PyDict_SetItemString(result, "frac_digits", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = PyLong_FromLong(l->p_cs_precedes); if (!x) goto failed; PyDict_SetItemString(result, "p_cs_precedes", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = PyLong_FromLong(l->p_sep_by_space); if (!x) goto failed; PyDict_SetItemString(result, "p_sep_by_space", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = PyLong_FromLong(l->n_cs_precedes); if (!x) goto failed; PyDict_SetItemString(result, "n_cs_precedes", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = PyLong_FromLong(l->n_sep_by_space); if (!x) goto failed; PyDict_SetItemString(result, "n_sep_by_space", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = PyLong_FromLong(l->p_sign_posn); if (!x) goto failed; PyDict_SetItemString(result, "p_sign_posn", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    x = PyLong_FromLong(l->n_sign_posn); if (!x) goto failed; PyDict_SetItemString(result, "n_sign_posn", x); do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);
    return result;
...
static char strcoll__doc__[] = "string,string -> int. Compares two strings according to the locale.";


static PyObject*
PyLocale_strcoll(PyObject* self, PyObject* args)
{
    PyObject *os1, *os2, *result = ((void *)0);
    wchar_t *ws1 = ((void *)0), *ws2 = ((void *)0);

    if (!_PyArg_ParseTuple_SizeT(args, "UU:strcoll", &os1, &os2))
        return ((void *)0);

    ws1 = PyUnicode_AsWideCharString(os1, ((void *)0));
    if (ws1 == ((void *)0))
        goto done;
    ws2 = PyUnicode_AsWideCharString(os2, ((void *)0));
    if (ws2 == ((void *)0))
        goto done;
...
static char strxfrm__doc__[] = "strxfrm(string) -> string.\n\nReturn a string that can be used as a key for locale-aware comparisons.";
...
PyLocale_strxfrm(PyObject* self, PyObject* args)
{
    PyObject *str;
    Py_ssize_t n1;
    wchar_t *s = ((void *)0), *buf = ((void *)0);
    size_t n2;
    PyObject *result = ((void *)0);

    if (!_PyArg_ParseTuple_SizeT(args, "U:strxfrm", &str))
        return ((void *)0);
...
static char nl_langinfo__doc__[] = "nl_langinfo(key) -> string\n" "Return the value for the locale information associated with key.";
...
{
    int item, i;
    if (!_PyArg_ParseTuple_SizeT(args, "i:nl_langinfo", &item))
        return ((void *)0);
    ...
    for (i = 0; langinfo_constants[i].name; i++)
        if (langinfo_constants[i].value == item) {
            ...
            return PyUnicode_DecodeLocale(result, ((void *)0));
        }
...
static struct PyMethodDef PyLocale_Methods[] = {
  {"setlocale", (PyCFunction) PyLocale_setlocale,
   0x0001, setlocale__doc__},
  {"localeconv", (PyCFunction) PyLocale_localeconv,
   0x0004, localeconv__doc__},

  {"strcoll", (PyCFunction) PyLocale_strcoll,
   0x0001, strcoll__doc__},


  {"strxfrm", (PyCFunction) PyLocale_strxfrm,
   0x0001, strxfrm__doc__},
...
PyInit__locale(void)
{
    ...
    m = PyModule_Create2(&_localemodule, 1013);
    if (m == ((void *)0))
    return ((void *)0);
    ...
    x = PyLong_FromLong(127);
    PyDict_SetItemString(d, "CHAR_MAX", x);
    do { if ((x) == ((void *)0)) ; else do { if ( --((PyObject*)(x))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(x)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(x)))); } while (0); } while (0);

    Error = PyErr_NewException("locale.Error", ((void *)0), ((void *)0));
