...
PyErr_Restore(PyObject *type, PyObject *value, PyObject *traceback)
{
    ...
    if (traceback != ((void *)0) && !((((PyObject*)(traceback))->ob_type) == &PyTraceBack_Type)) {


        do { if ( --((PyObject*)(traceback))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(traceback)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(traceback)))); } while (0);
        traceback = ((void *)0);
    }
    ...
    do { if ((oldtype) == ((void *)0)) ; else do { if ( --((PyObject*)(oldtype))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(oldtype)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(oldtype)))); } while (0); } while (0);
    do { if ((oldvalue) == ((void *)0)) ; else do { if ( --((PyObject*)(oldvalue))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(oldvalue)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(oldvalue)))); } while (0); } while (0);
    do { if ((oldtraceback) == ((void *)0)) ; else do { if ( --((PyObject*)(oldtraceback))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(oldtraceback)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(oldtraceback)))); } while (0); } while (0);
}
...
PyErr_SetObject(PyObject *exception, PyObject *value)
{
    ...
    if (exception != ((void *)0) &&
        !(((((((PyObject*)((exception)))->ob_type))->tp_flags & ((1L<<31))) != 0) && ((((PyTypeObject*)(exception))->tp_flags & ((1L<<30))) != 0))) {
    ...
    if (exc_value != ((void *)0) && exc_value != (&_Py_NoneStruct)) {

        ( ((PyObject*)(exc_value))->ob_refcnt++);
        if (value == ((void *)0) || !((((value)->ob_type)->tp_flags & ((1L<<30))) != 0)) {
            ...
            fixed_value = args ?
                PyEval_CallObjectWithKeywords(exception, args, (PyObject *)((void *)0)) : ((void *)0);
        ...
        if (exc_value != value) {
            ...
            while ((context = PyException_GetContext(o))) {
                do { if ( --((PyObject*)(context))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(context)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(context)))); } while (0);
                if (context == value) {
                    PyException_SetContext(o, ((void *)0));
                    break;
                }
                o = context;
            }
            ...
            do { if ( --((PyObject*)(exc_value))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(exc_value)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(exc_value)))); } while (0);
        }
    }
    if (value != ((void *)0) && ((((value)->ob_type)->tp_flags & ((1L<<30))) != 0))
        tb = PyException_GetTraceback(value);
    do { if ((exception) == ((void *)0)) ; else ( ((PyObject*)(exception))->ob_refcnt++); } while (0);
...
{
    PyErr_SetObject(exception, (PyObject *)((void *)0));
}
...
PyErr_Occurred(void)
{
    ...
    return tstate == ((void *)0) ? ((void *)0) : tstate->curexc_type;
}
...
{
    if (err == ((void *)0) || exc == ((void *)0)) {

        return 0;
    }
    if (((((((PyObject*)(exc))->ob_type))->tp_flags & ((1L<<26))) != 0)) {
        Py_ssize_t i, n;
        n = PyTuple_Size(exc);
        for (i = 0; i < n; i++) {

             if (PyErr_GivenExceptionMatches(
                 err, (((PyTupleObject *)(exc))->ob_item[i])))
             {
                 return 1;
             }
        }
    ...
    if (((((err)->ob_type)->tp_flags & ((1L<<30))) != 0))
        err = ((PyObject*)((err)->ob_type));

    if ((((((((PyObject*)((err)))->ob_type))->tp_flags & ((1L<<31))) != 0) && ((((PyTypeObject*)(err))->tp_flags & ((1L<<30))) != 0)) && (((((((PyObject*)((exc)))->ob_type))->tp_flags & ((1L<<31))) != 0) && ((((PyTypeObject*)(exc))->tp_flags & ((1L<<30))) != 0))) {
        int res = 0;
...
PyErr_NormalizeException(PyObject **exc, PyObject **val, PyObject **tb)
{
    PyObject *type = *exc;
    PyObject *value = *val;
    PyObject *inclass = ((void *)0);
    PyObject *initial_tb = ((void *)0);
    PyThreadState *tstate = ((void *)0);
    ...
    if ((((((((PyObject*)((type)))->ob_type))->tp_flags & ((1L<<31))) != 0) && ((((PyTypeObject*)(type))->tp_flags & ((1L<<30))) != 0))) {
        ...
        if (!inclass || !PyObject_IsSubclass(inclass, type)) {
            ...
            if (args == ((void *)0))
                goto finally;
            res = PyEval_CallObjectWithKeywords(type, args, (PyObject *)((void *)0));
    ...
    *val = value;
    ...
    if (initial_tb != ((void *)0)) {
        if (*tb == ((void *)0))
            *tb = initial_tb;
        else
            do { if ( --((PyObject*)(initial_tb))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(initial_tb)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(initial_tb)))); } while (0);
    }
...
PyErr_Clear(void)
{
    PyErr_Restore(((void *)0), ((void *)0), ((void *)0));
}
...
PyErr_GetExcInfo(PyObject **p_type, PyObject **p_value, PyObject **p_traceback)
{
    ...
    *p_traceback = tstate->exc_traceback;
    ...
    do { if ((*p_type) == ((void *)0)) ; else ( ((PyObject*)(*p_type))->ob_refcnt++); } while (0);
    do { if ((*p_value) == ((void *)0)) ; else ( ((PyObject*)(*p_value))->ob_refcnt++); } while (0);
    do { if ((*p_traceback) == ((void *)0)) ; else ( ((PyObject*)(*p_traceback))->ob_refcnt++); } while (0);
}
...
# 438 "errors.c"
    ...
    if (args != ((void *)0)) {
        v = PyObject_Call(exc, args, ((void *)0));
        do { if ( --((PyObject*)(args))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(args)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(args)))); } while (0);
        if (v != ((void *)0)) {
            PyErr_SetObject((PyObject *) (((PyObject*)(v))->ob_type), v);
...
{
    PyObject *name = filename ? PyUnicode_DecodeFSDefault(filename) : ((void *)0);
...
{
    return PyErr_SetFromErrnoWithFilenameObject(exc, ((void *)0));
}
# 621 "errors.c"
PyObject *
PyErr_SetImportError(PyObject *msg, PyObject *name, PyObject *path)
{
    ...
    ( ((PyObject*)(msg))->ob_refcnt++);
    (((PyTupleObject *)(args))->ob_item[0] = msg);
    PyDict_SetItemString(kwargs, "name", name);
    PyDict_SetItemString(kwargs, "path", path);

    error = PyObject_Call(PyExc_ImportError, args, kwargs);
    if (error != ((void *)0)) {
        PyErr_SetObject((PyObject *)(((PyObject*)(error))->ob_type), error);
        do { if ( --((PyObject*)(error))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(error)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(error)))); } while (0);
    }

    do { if ( --((PyObject*)(args))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(args)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(args)))); } while (0);
    do { if ( --((PyObject*)(kwargs))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(kwargs)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(kwargs)))); } while (0);
...
PyErr_Format(PyObject *exception, const char *format, ...)
{
    ...
    do { if ((string) == ((void *)0)) ; else do { if ( --((PyObject*)(string))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(string)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(string)))); } while (0); } while (0);
...
{
    const char *dot;
    PyObject *modulename = ((void *)0);
    PyObject *classname = ((void *)0);
    PyObject *mydict = ((void *)0);
    ...
    if (PyDict_GetItemString(dict, "__module__") == ((void *)0)) {
    ...
    if (((((((PyObject*)(base))->ob_type))->tp_flags & ((1L<<26))) != 0)) {
        bases = base;
  ...
  failure:
    ...
    do { if ((mydict) == ((void *)0)) ; else do { if ( --((PyObject*)(mydict))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(mydict)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(mydict)))); } while (0); } while (0);
    do { if ((classname) == ((void *)0)) ; else do { if ( --((PyObject*)(classname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(classname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(classname)))); } while (0); } while (0);
                          ...
                          PyObject *base, PyObject *dict)
{
    ...
    if (doc != ((void *)0)) {
        ...
        do { if ( --((PyObject*)(docobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(docobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(docobj)))); } while (0);
        if (result < 0)
            goto failure;
    }
...
PyErr_WriteUnraisable(PyObject *obj)
{
    ...
    if (f != ((void *)0) && f != (&_Py_NoneStruct)) {
        PyFile_WriteString("Exception ", f);
        if (t) {
            PyObject* moduleName;
            char* className;
            (__builtin_expect(!((((((((PyObject*)((t)))->ob_type))->tp_flags & ((1L<<31))) != 0) && ((((PyTypeObject*)(t))->tp_flags & ((1L<<30))) != 0))), 0) ? __assert_rtn(__func__, "errors.c", 805, "PyExceptionClass_Check(t)") : (void)0);
            className = ((char *)(((PyTypeObject*)(t))->tp_name));
            if (className != ((void *)0)) {
...
PyErr_SyntaxLocationEx(const char *filename, int lineno, int col_offset)
{
    ...
    if (_PyObject_SetAttrId(v, &PyId_offset, (&_Py_NoneStruct))) {
        PyErr_Clear();
    }
...
PyErr_ProgramText(const char *filename, int lineno)
{
    ...
    if (filename == ((void *)0) || *filename == '\0' || lineno <= 0)
        return ((void *)0);
