...
{
    do { if ((o) == ((void *)0)) ; else ( ((PyObject*)(o))->ob_refcnt++); } while (0);
}
...
{
    PyObject *op;
    op = (PyObject *) PyObject_Malloc(( (tp)->tp_basicsize ));
    if (op == ((void *)0))
        return PyErr_NoMemory();
    return ( (((PyObject*)(op))->ob_type) = (tp), ( (((PyObject*)((PyObject *)(op)))->ob_refcnt) = 1), (op) );
}
...
_PyObject_NewVar(PyTypeObject *tp, Py_ssize_t nitems)
{
    ...
    if (op == ((void *)0))
        return (PyVarObject *)PyErr_NoMemory();
    return ( (((PyVarObject*)(op))->ob_size) = (nitems), ( (((PyObject*)((op)))->ob_type) = ((tp)), ( (((PyObject*)((PyObject *)((op))))->ob_refcnt) = 1), ((op)) ) );
}
...
PyObject_Print(PyObject *op, FILE *fp, int flags)
{
    ...
    if (op == ((void *)0)) {
        ...
        if (op->ob_refcnt <= 0)
            ...
            if (s == ((void *)0))
                ret = -1;
            else if (((((((PyObject*)(s))->ob_type))->tp_flags & ((1L<<27))) != 0)) {
                fwrite(((__builtin_expect(!(((((((PyObject*)(s))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "object.c", 293, "PyBytes_Check(s)") : (void)0), (((PyBytesObject *)(s))->ob_sval)), 1,
                       ((__builtin_expect(!(((((((PyObject*)(s))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "object.c", 294, "PyBytes_Check(s)") : (void)0),(((PyVarObject*)(s))->ob_size)), fp);
            }
                ...
                if (t == ((void *)0))
                    ...
                    fwrite(((__builtin_expect(!(((((((PyObject*)(t))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "object.c", 302, "PyBytes_Check(t)") : (void)0), (((PyBytesObject *)(t))->ob_sval)), 1,
                           ((__builtin_expect(!(((((((PyObject*)(t))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "object.c", 303, "PyBytes_Check(t)") : (void)0),(((PyVarObject*)(t))->ob_size)), fp);
...
{
    if (op == ((void *)0))
        fprintf(__stderrp, "NULL\n");
    else {

        PyGILState_STATE gil;

        fprintf(__stderrp, "object  : ");

        gil = PyGILState_Ensure();

        (void)PyObject_Print(op, __stderrp, 0);
        ...
        fprintf(__stderrp, "\n"
            ...
            "refcount: %ld\n"
            "address : %p\n",
            (((PyObject*)(op))->ob_type)==((void *)0) ? "NULL" : (((PyObject*)(op))->ob_type)->tp_name,
            (long)op->ob_refcnt,
            op);
    }
}
...
PyObject_Repr(PyObject *v)
{
    ...
    if ((((PyObject*)(v))->ob_type)->tp_repr == ((void *)0))
        return PyUnicode_FromFormat("<%s object at %p>",
                                    v->ob_type->tp_name, v);
    res = (*v->ob_type->tp_repr)(v);
    if (res == ((void *)0))
        return ((void *)0);
    if (!((((((PyObject*)(res))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        PyErr_Format(PyExc_TypeError,
    ...
    if (((__builtin_expect(!(((((((PyObject*)(res))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "object.c", 391, "PyUnicode_Check(res)") : (void)0), ((((PyASCIIObject*)res)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(res)))) < 0)
        return ((void *)0);
...
PyObject_Str(PyObject *v)
{
    ...
    if (((__builtin_expect(!(((((((PyObject*)(res))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "object.c", 438, "PyUnicode_Check(res)") : (void)0), ((((PyASCIIObject*)res)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(res)))) < 0)
        return ((void *)0);

    (__builtin_expect(!(_PyUnicode_CheckConsistency(res, 1)), 0) ? __assert_rtn(__func__, "object.c", 441, "_PyUnicode_CheckConsistency(res, 1)") : (void)0);
    return res;
}
...
PyObject_ASCII(PyObject *v)
{
    ...
    res = PyUnicode_DecodeASCII(
        ((__builtin_expect(!(((((((PyObject*)(ascii))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "object.c", 461, "PyBytes_Check(ascii)") : (void)0), (((PyBytesObject *)(ascii))->ob_sval)),
        ((__builtin_expect(!(((((((PyObject*)(ascii))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "object.c", 462, "PyBytes_Check(ascii)") : (void)0),(((PyVarObject*)(ascii))->ob_size)),
        ((void *)0));
...
PyObject_Bytes(PyObject *v)
{
    ...
    if (((((PyObject*)(v))->ob_type) == &PyBytes_Type)) {
        ( ((PyObject*)(v))->ob_refcnt++);
        return v;
    }
    ...
    if (func != ((void *)0)) {
        result = PyObject_CallFunctionObjArgs(func, ((void *)0));
...
do_richcompare(PyObject *v, PyObject *w, int op)
{
    ...
    if (v->ob_type != w->ob_type &&
        ...
        (f = w->ob_type->tp_richcompare) != ((void *)0)) {
        checked_reverse_op = 1;
        res = (*f)(w, v, _Py_SwappedOp[op]);
        if (res != (&_Py_NotImplementedStruct))
            return res;
        do { if ( --((PyObject*)(res))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(res)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(res)))); } while (0);
    }
    if ((f = v->ob_type->tp_richcompare) != ((void *)0)) {
        res = (*f)(v, w, op);
        if (res != (&_Py_NotImplementedStruct))
            return res;
        do { if ( --((PyObject*)(res))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(res)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(res)))); } while (0);
    }
    if (!checked_reverse_op && (f = w->ob_type->tp_richcompare) != ((void *)0)) {
        res = (*f)(w, v, _Py_SwappedOp[op]);
        if (res != (&_Py_NotImplementedStruct))
            return res;
        do { if ( --((PyObject*)(res))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(res)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(res)))); } while (0);
    ...
    switch (op) {
    case 2:
        res = (v == w) ? ((PyObject *) &_Py_TrueStruct) : ((PyObject *) &_Py_FalseStruct);
        break;
    case 3:
        res = (v != w) ? ((PyObject *) &_Py_TrueStruct) : ((PyObject *) &_Py_FalseStruct);
        break;
...
PyObject_RichCompare(PyObject *v, PyObject *w, int op)
{
    ...
    (__builtin_expect(!(0 <= op && op <= 5), 0) ? __assert_rtn(__func__, "object.c", 598, "Py_LT <= op && op <= Py_GE") : (void)0);
    if (v == ((void *)0) || w == ((void *)0)) {
        if (!PyErr_Occurred())
            _PyErr_BadInternalCall("object.c", 601);
        return ((void *)0);
    }
    if (((++(((PyThreadState*)__extension__ ({ __typeof__(&_PyThreadState_Current) atomic_val = &_PyThreadState_Current; __typeof__(atomic_val->_value) result; volatile __typeof__(result) *volatile_data = &atomic_val->_value; _Py_memory_order order = _Py_memory_order_relaxed; _Py_ANNOTATE_MEMORY_ORDER(atomic_val, order); ; switch(order) { case _Py_memory_order_release: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_thread_fence(_Py_memory_order_release); break; default: break; } result = *volatile_data; switch(order) { case _Py_memory_order_acquire: case _Py_memory_order_acq_rel: case _Py_memory_order_seq_cst: _Py_atomic_signal_fence(_Py_memory_order_acquire); break; default: break; } ; result; }))->recursion_depth) > _Py_CheckRecursionLimit) && _Py_CheckRecursiveCall(" in comparison")))
        return ((void *)0);
...
PyObject_RichCompareBool(PyObject *v, PyObject *w, int op)
{
    ...
    if (res == ((void *)0))
        return -1;
    if (((((PyObject*)(res))->ob_type) == &PyBool_Type))
        ok = (res == ((PyObject *) &_Py_TrueStruct));
    else
...
_Py_HashDouble(double v)
{
    ...
    if (!( sizeof (v) == sizeof(float ) ? __inline_isfinitef((float)(v)) : sizeof (v) == sizeof(double) ? __inline_isfinited((double)(v)) : __inline_isfinite ((long double)(v)))) {
        if (( sizeof (v) == sizeof(float ) ? __inline_isinff((float)(v)) : sizeof (v) == sizeof(double) ? __inline_isinfd((double)(v)) : __inline_isinf ((long double)(v))))
...
{
    PyTypeObject *tp = (((PyObject*)(v))->ob_type);
    if (tp->tp_hash != ((void *)0))
        return (*tp->tp_hash)(v);
...
PyObject_GetAttrString(PyObject *v, const char *name)
{
    ...
    if ((((PyObject*)(v))->ob_type)->tp_getattr != ((void *)0))
        return (*(((PyObject*)(v))->ob_type)->tp_getattr)(v, (char*)name);
...
PyObject_SetAttrString(PyObject *v, const char *name, PyObject *w)
{
    ...
    if ((((PyObject*)(v))->ob_type)->tp_setattr != ((void *)0))
        return (*(((PyObject*)(v))->ob_type)->tp_setattr)(v, (char*)name, w);
...
_PyObject_IsAbstract(PyObject *obj)
{
    int res;
    PyObject* isabstract;
    static _Py_Identifier PyId___isabstractmethod__ = { 0, "__isabstractmethod__", 0 };

    if (obj == ((void *)0))
        return 0;

    isabstract = _PyObject_GetAttrId(obj, &PyId___isabstractmethod__);
    if (isabstract == ((void *)0)) {
    ...
    do { if ( --((PyObject*)(isabstract))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(isabstract)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(isabstract)))); } while (0);
    return res;
}
...
PyObject_GetAttr(PyObject *v, PyObject *name)
{
    ...
    if (tp->tp_getattro != ((void *)0))
        return (*tp->tp_getattro)(v, name);
    if (tp->tp_getattr != ((void *)0)) {
...
PyObject_SetAttr(PyObject *v, PyObject *name, PyObject *value)
{
    ...
    do { if ( --((PyObject*)(name))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(name)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(name)))); } while (0);
    (__builtin_expect(!(name->ob_refcnt >= 1), 0) ? __assert_rtn(__func__, "object.c", 979, "name->ob_refcnt >= 1") : (void)0);
    if (tp->tp_getattr == ((void *)0) && tp->tp_getattro == ((void *)0))
        PyErr_Format(PyExc_TypeError,
                     "'%.100s' object has no attributes "
                     "(%s .%U)",
                     tp->tp_name,
                     value==((void *)0) ? "del" : "assign to",
                     name);
    else
        PyErr_Format(PyExc_TypeError,
...
_PyObject_GetDictPtr(PyObject *obj)
{
    ...
    if (dictoffset < 0) {
        ...
        if (tsize < 0)
            tsize = -tsize;
        size = (((size_t)((tp)->tp_basicsize + (tsize)*(tp)->tp_itemsize) + (size_t)((8) - 1)) & ~(size_t)((8) - 1));

        dictoffset += (long)size;
        (__builtin_expect(!(dictoffset > 0), 0) ? __assert_rtn(__func__, "object.c", 1018, "dictoffset > 0") : (void)0);
        (__builtin_expect(!(dictoffset % 8 == 0), 0) ? __assert_rtn(__func__, "object.c", 1019, "dictoffset % SIZEOF_VOID_P == 0") : (void)0);
    }
...
_PyObject_GenericGetAttrWithDict(PyObject *obj, PyObject *name, PyObject *dict)
{
    ...
    do { if ((descr) == ((void *)0)) ; else ( ((PyObject*)(descr))->ob_refcnt++); } while (0);

    f = ((void *)0);
    if (descr != ((void *)0)) {
        f = descr->ob_type->tp_descr_get;
        if (f != ((void *)0) && ((((PyObject*)(descr))->ob_type)->tp_descr_set != ((void *)0))) {
    ...
    if (dict == ((void *)0)) {
        ...
        if (dictoffset != 0) {
            if (dictoffset < 0) {
                ...
                dictoffset += (long)size;
                (__builtin_expect(!(dictoffset > 0), 0) ? __assert_rtn(__func__, "object.c", 1110, "dictoffset > 0") : (void)0);
                (__builtin_expect(!(dictoffset % 8 == 0), 0) ? __assert_rtn(__func__, "object.c", 1111, "dictoffset % SIZEOF_VOID_P == 0") : (void)0);
            }
    ...
    if (f != ((void *)0)) {
        res = f(descr, obj, (PyObject *)(((PyObject*)(obj))->ob_type));
        goto done;
    }
...
{
    return _PyObject_GenericGetAttrWithDict(obj, name, ((void *)0));
}
                                 ...
                                 PyObject *value, PyObject *dict)
{
    ...
    if (tp->tp_dict == ((void *)0) && PyType_Ready(tp) < 0)
        return -1;
    ...
    if (dict == ((void *)0)) {
        ...
        if (dictptr != ((void *)0)) {
            res = _PyObjectDict_SetItem((((PyObject*)(obj))->ob_type), dictptr, name, value);
...
{
    return _PyObject_GenericSetAttrWithDict(obj, name, value, ((void *)0));
}
...
{
    Py_ssize_t res;
    if (v == ((PyObject *) &_Py_TrueStruct))
        return 1;
    if (v == ((PyObject *) &_Py_FalseStruct))
        return 0;
    if (v == (&_Py_NoneStruct))
        return 0;
    else if (v->ob_type->tp_as_number != ((void *)0) &&
             v->ob_type->tp_as_number->nb_bool != ((void *)0))
        res = (*v->ob_type->tp_as_number->nb_bool)(v);
    else if (v->ob_type->tp_as_mapping != ((void *)0) &&
             v->ob_type->tp_as_mapping->mp_length != ((void *)0))
        res = (*v->ob_type->tp_as_mapping->mp_length)(v);
    else if (v->ob_type->tp_as_sequence != ((void *)0) &&
             v->ob_type->tp_as_sequence->sq_length != ((void *)0))
...
PyCallable_Check(PyObject *x)
{
    if (x == ((void *)0))
        return 0;
    return x->ob_type->tp_call != ((void *)0);
}
...
_dir_locals(void)
{
    ...
    if (!names)
        return ((void *)0);
    if (!((((((PyObject*)(names))->ob_type))->tp_flags & ((1L<<25))) != 0)) {
        PyErr_Format(PyExc_TypeError,
            "dir(): expected keys() of locals to be a list, "
            "not '%.200s'", (((PyObject*)(names))->ob_type)->tp_name);
...
_dir_object(PyObject *obj)
{
    ...
    static _Py_Identifier PyId___dir__ = { 0, "__dir__", 0 };
    PyObject *dirfunc = _PyObject_LookupSpecial(obj, &PyId___dir__);

    (__builtin_expect(!(obj), 0) ? __assert_rtn(__func__, "object.c", 1353, "obj") : (void)0);
    if (dirfunc == ((void *)0)) {
        if (!PyErr_Occurred())
    ...
    result = PyObject_CallFunctionObjArgs(dirfunc, ((void *)0));
    do { if ( --((PyObject*)(dirfunc))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(dirfunc)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(dirfunc)))); } while (0);
    if (result == ((void *)0))
        return ((void *)0);
    ...
    if (PyList_Sort(sorted)) {
        do { if ( --((PyObject*)(sorted))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sorted)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sorted)))); } while (0);
        return ((void *)0);
    }
    return sorted;
}
...
{
    return (obj == ((void *)0)) ? _dir_locals() : _dir_object(obj);
}
# 1393 "object.c"
static PyObject *
...
{
    if ((((PyVarObject*)(args))->ob_size) || (kwargs && PyDict_Size(kwargs))) {
...
{
    return ((size_t)(nbytes) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc((nbytes) ? (nbytes) : 1));
}

void *
PyMem_Realloc(void *p, size_t nbytes)
{
    return ((size_t)(nbytes) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : realloc((p), (nbytes) ? (nbytes) : 1));
}
...
Py_ReprEnter(PyObject *obj)
{
    ...
    if (list == ((void *)0)) {
        ...
        if (list == ((void *)0))
            return -1;
        if (PyDict_SetItemString(dict, "Py_Repr", list) < 0)
            return -1;
    ...
    while (--i >= 0) {
        if ((((PyListObject *)(list))->ob_item[i]) == obj)
            return 1;
    }
...
Py_ReprLeave(PyObject *obj)
{
    ...
    if (dict == ((void *)0))
        return;
    list = PyDict_GetItemString(dict, "Py_Repr");
    if (list == ((void *)0) || !((((((PyObject*)(list))->ob_type))->tp_flags & ((1L<<25))) != 0))
        return;
    i = (((PyVarObject*)(list))->ob_size);

    while (--i >= 0) {
        if ((((PyListObject *)(list))->ob_item[i]) == obj) {
            PyList_SetSlice(list, i, i + 1, ((void *)0));
            break;
        }
    }
}
...
PyObject *_PyTrash_delete_later = ((void *)0);
...
{
    (__builtin_expect(!(((((((((PyObject*)(op))->ob_type)))->tp_flags & ((1L<<14))) != 0) && ((((PyObject*)(op))->ob_type)->tp_is_gc == ((void *)0) || (((PyObject*)(op))->ob_type)->tp_is_gc(op)))), 0) ? __assert_rtn(__func__, "object.c", 1974, "PyObject_IS_GC(op)") : (void)0);
    (__builtin_expect(!(((PyGC_Head *)(op)-1)->gc.gc_refs == (-2)), 0) ? __assert_rtn(__func__, "object.c", 1975, "_Py_AS_GC(op)->gc.gc_refs == _PyGC_REFS_UNTRACKED") : (void)0);
    (__builtin_expect(!(op->ob_refcnt == 0), 0) ? __assert_rtn(__func__, "object.c", 1976, "op->ob_refcnt == 0") : (void)0);
    ((PyGC_Head *)(op)-1)->gc.gc_prev = (PyGC_Head *)_PyTrash_delete_later;
...
_PyTrash_thread_deposit_object(PyObject *op)
{
    ...
    (__builtin_expect(!(((((((((PyObject*)(op))->ob_type)))->tp_flags & ((1L<<14))) != 0) && ((((PyObject*)(op))->ob_type)->tp_is_gc == ((void *)0) || (((PyObject*)(op))->ob_type)->tp_is_gc(op)))), 0) ? __assert_rtn(__func__, "object.c", 1986, "PyObject_IS_GC(op)") : (void)0);
    (__builtin_expect(!(((PyGC_Head *)(op)-1)->gc.gc_refs == (-2)), 0) ? __assert_rtn(__func__, "object.c", 1987, "_Py_AS_GC(op)->gc.gc_refs == _PyGC_REFS_UNTRACKED") : (void)0);
    (__builtin_expect(!(op->ob_refcnt == 0), 0) ? __assert_rtn(__func__, "object.c", 1988, "op->ob_refcnt == 0") : (void)0);
    ((PyGC_Head *)(op)-1)->gc.gc_prev = (PyGC_Head *) tstate->trash_delete_later;
...
_PyTrash_destroy_chain(void)
{
    while (_PyTrash_delete_later) {
        ...
        _PyTrash_delete_later =
            (PyObject*) ((PyGC_Head *)(op)-1)->gc.gc_prev;
        ...
        (__builtin_expect(!(op->ob_refcnt == 0), 0) ? __assert_rtn(__func__, "object.c", 2012, "op->ob_refcnt == 0") : (void)0);
...
_PyTrash_thread_destroy_chain(void)
{
    ...
    while (tstate->trash_delete_later) {
        ...
        (__builtin_expect(!(op->ob_refcnt == 0), 0) ? __assert_rtn(__func__, "object.c", 2037, "op->ob_refcnt == 0") : (void)0);
