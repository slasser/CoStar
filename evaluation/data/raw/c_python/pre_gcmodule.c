...
PyGC_Head *_PyGC_generation0 = (&generations[0].head);
...
static PyObject *garbage = ((void *)0);


static PyObject *gc_str = ((void *)0);


static PyObject *callbacks = ((void *)0);
...
{
    PyGC_Head *tail;
    (__builtin_expect(!(from != to), 0) ? __assert_rtn(__func__, "gcmodule.c", 280, "from != to") : (void)0);
...
append_objects(PyObject *py_list, PyGC_Head *gc_list)
{
    ...
    for (gc = gc_list->gc.gc_next; gc != gc_list; gc = gc->gc.gc_next) {
        PyObject *op = ((PyObject *)(((PyGC_Head *)gc)+1));
        if (op != py_list) {
...
update_refs(PyGC_Head *containers)
{
    ...
    for (; gc != containers; gc = gc->gc.gc_next) {
        (__builtin_expect(!(gc->gc.gc_refs == (-3)), 0) ? __assert_rtn(__func__, "gcmodule.c", 332, "gc->gc.gc_refs == GC_REACHABLE") : (void)0);
        gc->gc.gc_refs = (((PyObject*)(((PyObject *)(((PyGC_Head *)gc)+1))))->ob_refcnt);
# 352 "gcmodule.c"
        (__builtin_expect(!(gc->gc.gc_refs != 0), 0) ? __assert_rtn(__func__, "gcmodule.c", 352, "gc->gc.gc_refs != 0") : (void)0);
    }
}
...
{
    (__builtin_expect(!(op != ((void *)0)), 0) ? __assert_rtn(__func__, "gcmodule.c", 360, "op != NULL") : (void)0);
    if (((((((((PyObject*)(op))->ob_type)))->tp_flags & ((1L<<14))) != 0) && ((((PyObject*)(op))->ob_type)->tp_is_gc == ((void *)0) || (((PyObject*)(op))->ob_type)->tp_is_gc(op)))) {
        PyGC_Head *gc = ((PyGC_Head *)(op)-1);




        (__builtin_expect(!(gc->gc.gc_refs != 0), 0) ? __assert_rtn(__func__, "gcmodule.c", 367, "gc->gc.gc_refs != 0") : (void)0);
        if (gc->gc.gc_refs > 0)
            gc->gc.gc_refs--;
    }
    return 0;
...
subtract_refs(PyGC_Head *containers)
{
    ...
    PyGC_Head *gc = containers->gc.gc_next;
    for (; gc != containers; gc=gc->gc.gc_next) {
        traverse = (((PyObject*)(((PyObject *)(((PyGC_Head *)gc)+1))))->ob_type)->tp_traverse;
        (void) traverse(((PyObject *)(((PyGC_Head *)gc)+1)),
...
# 426 "gcmodule.c"
            ...
            (__builtin_expect(!(gc_refs > 0 || gc_refs == (-3) || gc_refs == (-2)), 0) ? __assert_rtn(__func__, "gcmodule.c", 429, "gc_refs > 0 || gc_refs == GC_REACHABLE || gc_refs == GC_UNTRACKED") : (void)0);
...
# 469 "gcmodule.c"
            PyObject *op = ((PyObject *)(((PyGC_Head *)gc)+1));
            traverseproc traverse = (((PyObject*)(op))->ob_type)->tp_traverse;
            (__builtin_expect(!(gc->gc.gc_refs > 0), 0) ? __assert_rtn(__func__, "gcmodule.c", 471, "gc->gc.gc_refs > 0") : (void)0);
            gc->gc.gc_refs = (-3);
            (void) traverse(op,
                            (visitproc)visit_reachable,
                            (void *)young);
            next = gc->gc.gc_next;
            if (((((PyObject*)(op))->ob_type) == &PyTuple_Type)) {
...
{
    if (((((PyObject*)(op))->ob_type) == &PyGen_Type))
        return PyGen_NeedsFinalizing((PyGenObject *)op);
    else
        return op->ob_type->tp_del != ((void *)0);
}
...
move_finalizers(PyGC_Head *unreachable, PyGC_Head *finalizers)
{
    ...
    for (gc = unreachable->gc.gc_next; gc != unreachable; gc = next) {
        ...
        (__builtin_expect(!(( (((PyGC_Head *)(op)-1))->gc.gc_refs == (-4))), 0) ? __assert_rtn(__func__, "gcmodule.c", 537, "IS_TENTATIVELY_UNREACHABLE(op)") : (void)0);
        next = gc->gc.gc_next;
...
{
    if (((((((((PyObject*)(op))->ob_type)))->tp_flags & ((1L<<14))) != 0) && ((((PyObject*)(op))->ob_type)->tp_is_gc == ((void *)0) || (((PyObject*)(op))->ob_type)->tp_is_gc(op)))) {
        if (( (((PyGC_Head *)(op)-1))->gc.gc_refs == (-4))) {
            PyGC_Head *gc = ((PyGC_Head *)(op)-1);
...
# 609 "gcmodule.c"
    for (gc = unreachable->gc.gc_next; gc != unreachable; gc = next) {
        ...
        op = ((PyObject *)(((PyGC_Head *)gc)+1));
        (__builtin_expect(!(( (((PyGC_Head *)(op)-1))->gc.gc_refs == (-4))), 0) ? __assert_rtn(__func__, "gcmodule.c", 613, "IS_TENTATIVELY_UNREACHABLE(op)") : (void)0);
        next = gc->gc.gc_next;

        if (! (((((PyObject*)(op))->ob_type))->tp_weaklistoffset > 0))
            continue;


        wrlist = (PyWeakReference **)
                                ((PyObject **) (((char *) (op)) + (((PyObject*)(op))->ob_type)->tp_weaklistoffset));





        for (wr = *wrlist; wr != ((void *)0); wr = *wrlist) {
            PyGC_Head *wrasgc;
            ...
            (__builtin_expect(!(wr->wr_object == op), 0) ? __assert_rtn(__func__, "gcmodule.c", 634, "wr->wr_object == op") : (void)0);
            _PyWeakref_ClearRef(wr);
            (__builtin_expect(!(wr->wr_object == (&_Py_NoneStruct)), 0) ? __assert_rtn(__func__, "gcmodule.c", 636, "wr->wr_object == Py_None") : (void)0);
            if (wr->wr_callback == ((void *)0))
                continue;
# 668 "gcmodule.c"
            if (( (((PyGC_Head *)(wr)-1))->gc.gc_refs == (-4)))
                continue;
            (__builtin_expect(!(((((PyGC_Head *)(wr)-1))->gc.gc_refs == (-3))), 0) ? __assert_rtn(__func__, "gcmodule.c", 670, "IS_REACHABLE(wr)") : (void)0);




            ( ((PyObject*)(wr))->ob_refcnt++);


            wrasgc = ((PyGC_Head *)(wr)-1);
            (__builtin_expect(!(wrasgc != next), 0) ? __assert_rtn(__func__, "gcmodule.c", 679, "wrasgc != next") : (void)0);
    ...
    while (! gc_list_is_empty(&wrcb_to_call)) {
        ...
        op = ((PyObject *)(((PyGC_Head *)gc)+1));
        (__builtin_expect(!(((((PyGC_Head *)(op)-1))->gc.gc_refs == (-3))), 0) ? __assert_rtn(__func__, "gcmodule.c", 695, "IS_REACHABLE(op)") : (void)0);
        (__builtin_expect(!((((((PyObject*)(op))->ob_type) == (&_PyWeakref_RefType) || PyType_IsSubtype((((PyObject*)(op))->ob_type), (&_PyWeakref_RefType))) || (((((PyObject*)(op))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(op))->ob_type) == &_PyWeakref_CallableProxyType)))), 0) ? __assert_rtn(__func__, "gcmodule.c", 696, "PyWeakref_Check(op)") : (void)0);
        wr = (PyWeakReference *)op;
        callback = wr->wr_callback;
        (__builtin_expect(!(callback != ((void *)0)), 0) ? __assert_rtn(__func__, "gcmodule.c", 699, "callback != NULL") : (void)0);


        temp = PyObject_CallFunctionObjArgs(callback, wr, ((void *)0));
        if (temp == ((void *)0))
...
debug_cycle(char *msg, PyObject *op)
{
    PySys_FormatStderr("gc: %s <%s %p>\n",
                       msg, (((PyObject*)(op))->ob_type)->tp_name, op);
}
# 747 "gcmodule.c"
static int
...
delete_garbage(PyGC_Head *collectable, PyGC_Head *old)
{
    ...
    while (!gc_list_is_empty(collectable)) {
        ...
        (__builtin_expect(!(( (((PyGC_Head *)(op)-1))->gc.gc_refs == (-4))), 0) ? __assert_rtn(__func__, "gcmodule.c", 783, "IS_TENTATIVELY_UNREACHABLE(op)") : (void)0);
        if (debug & (1<<5)) {
            PyList_Append(garbage, op);
        }
        else {
            if ((clear = (((PyObject*)(op))->ob_type)->tp_clear) != ((void *)0)) {
...
get_time(void)
{
    ...
    if (tmod != ((void *)0)) {
        ...
        PyObject *f = _PyObject_CallMethodId(tmod, &PyId_time, ((void *)0));
        if (f == ((void *)0)) {
            PyErr_Clear();
        }
        else {
            if (((((PyObject*)(f))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(f))->ob_type), (&PyFloat_Type))))
...
collect(int generation, Py_ssize_t *n_collected, Py_ssize_t *n_uncollectable)
{
    ...
    if (debug & (1<<0)) {
        ...
        for (i = 0; i < 3; i++)
            PySys_WriteStderr(" %" "l" "d",
                              gc_list_size((&generations[i].head)));
        t1 = get_time();
        PySys_WriteStderr("\n");
    }
    ...
    for (i = 0; i < generation; i++) {
        gc_list_merge((&generations[i].head), (&generations[generation].head));
    }


    young = (&generations[generation].head);
    if (generation < 3 -1)
        old = (&generations[generation+1].head);
    else
        old = young;
...
# 924 "gcmodule.c"
    ...
    for (gc = unreachable.gc.gc_next; gc != &unreachable;
        ...
        m++;
        if (debug & (1<<1)) {
            debug_cycle("collectable", ((PyObject *)(((PyGC_Head *)gc)+1)));
        }
    }
    ...
    for (gc = finalizers.gc.gc_next;
        ...
        n++;
        if (debug & (1<<2))
            debug_cycle("uncollectable", ((PyObject *)(((PyGC_Head *)gc)+1)));
    }
    if (debug & (1<<0)) {
        double t2 = get_time();
        if (m == 0 && n == 0)
                   ...
                   Py_ssize_t collected, Py_ssize_t uncollectable)
{
    ...
    (__builtin_expect(!(callbacks != ((void *)0) && ((((PyObject*)(callbacks))->ob_type) == &PyList_Type)), 0) ? __assert_rtn(__func__, "gcmodule.c", 1017, "callbacks != NULL && PyList_CheckExact(callbacks)") : (void)0);
    if ((((PyVarObject*)(callbacks))->ob_size) != 0) {
    ...
    for (i=0; i<(((PyVarObject*)(callbacks))->ob_size); i++) {
        PyObject *r, *cb = (((PyListObject *)(callbacks))->ob_item[i]);
        ( ((PyObject*)(cb))->ob_refcnt++);
        ...
        do { if ( --((PyObject*)(cb))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(cb)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(cb)))); } while (0);
    }
    do { if ((info) == ((void *)0)) ; else do { if ( --((PyObject*)(info))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(info)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(info)))); } while (0); } while (0);
}
...
static char gc_enable__doc__[] = "enable() -> None\n" "\n" "Enable automatic garbage collection.\n";
...
static char gc_disable__doc__[] = "disable() -> None\n" "\n" "Disable automatic garbage collection.\n";
...
static char gc_isenabled__doc__[] = "isenabled() -> status\n" "\n" "Returns true if automatic garbage collection is enabled.\n";
...
static char gc_collect__doc__[] = "collect([generation]) -> n\n" "\n" "With no arguments, run a full collection.  The optional argument\n" "may be an integer specifying which generation to collect.  A ValueError\n" "is raised if the generation number is invalid.\n\n" "The number of unreachable objects is returned.\n";
...
{
    static char *keywords[] = {"generation", ((void *)0)};
    int genarg = 3 - 1;
    Py_ssize_t n;
...
static char gc_get_debug__doc__[] = "get_debug() -> flags\n" "\n" "Get the garbage collection debugging flags.\n";
...
static char gc_set_thresh__doc__[] = "set_threshold(threshold0, [threshold1, threshold2]) -> None\n" "\n" "Sets the collection thresholds.  Setting threshold0 to zero disables\n" "collection.\n";
...
static char gc_get_thresh__doc__[] = "get_threshold() -> (threshold0, threshold1, threshold2)\n" "\n" "Return the current collection thresholds\n";
...
static char gc_get_count__doc__[] = "get_count() -> (count0, count1, count2)\n" "\n" "Return the current collection counts\n";
...
{
    Py_ssize_t i;
    for (i = 0; i < (((PyVarObject*)(objs))->ob_size); i++)
        if ((((PyTupleObject *)(objs))->ob_item[i]) == obj)
            return 1;
    return 0;
}
...
gc_referrers_for(PyObject *objs, PyGC_Head *list, PyObject *resultlist)
{
    ...
    traverseproc traverse;
    for (gc = list->gc.gc_next; gc != list; gc = gc->gc.gc_next) {
        obj = ((PyObject *)(((PyGC_Head *)gc)+1));
        traverse = (((PyObject*)(obj))->ob_type)->tp_traverse;
...
static char gc_get_referrers__doc__[] = "get_referrers(*objs) -> list\nReturn the list of objects that directly refer to any of objs.";
...
gc_get_referrers(PyObject *self, PyObject *args)
{
    ...
    for (i = 0; i < 3; i++) {
        if (!(gc_referrers_for(args, (&generations[i].head), result))) {
...
static char gc_get_referents__doc__[] = "get_referents(*objs) -> list\nReturn the list of objects that are directly referred to by objs.";
...
gc_get_referents(PyObject *self, PyObject *args)
{
    ...
    for (i = 0; i < (((PyVarObject*)(args))->ob_size); i++) {
        ...
        if (! ((((((((PyObject*)(obj))->ob_type)))->tp_flags & ((1L<<14))) != 0) && ((((PyObject*)(obj))->ob_type)->tp_is_gc == ((void *)0) || (((PyObject*)(obj))->ob_type)->tp_is_gc(obj))))
            continue;
        traverse = (((PyObject*)(obj))->ob_type)->tp_traverse;
        if (! traverse)
            continue;
...
static char gc_get_objects__doc__[] = "get_objects() -> [...]\n" "\n" "Return a list of objects tracked by the collector (excluding the list\n" "returned).\n";
...
gc_get_objects(PyObject *self, PyObject *noargs)
{
    ...
    if (result == ((void *)0))
        return ((void *)0);
    for (i = 0; i < 3; i++) {
        if (append_objects(result, (&generations[i].head))) {
            do { if ( --((PyObject*)(result))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(result)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(result)))); } while (0);
            return ((void *)0);
        }
    }
...
static char gc_is_tracked__doc__[] = "is_tracked(obj) -> bool\n" "\n" "Returns true if the object is tracked by the garbage collector.\n" "Simple atomic objects will return false.\n";
...
gc_is_tracked(PyObject *self, PyObject *obj)
{
    ...
    if (((((((((PyObject*)(obj))->ob_type)))->tp_flags & ((1L<<14))) != 0) && ((((PyObject*)(obj))->ob_type)->tp_is_gc == ((void *)0) || (((PyObject*)(obj))->ob_type)->tp_is_gc(obj))) && ((((PyGC_Head *)(obj)-1))->gc.gc_refs != (-2)))
...
static char gc__doc__[] = "This module provides access to the garbage collector for reference cycles.\n" "\n" "enable() -- Enable automatic garbage collection.\n" "disable() -- Disable automatic garbage collection.\n" "isenabled() -- Returns true if automatic collection is enabled.\n" "collect() -- Do a full collection right now.\n" "get_count() -- Return the current collection counts.\n" "set_debug() -- Set debugging flags.\n" "get_debug() -- Get debugging flags.\n" "set_threshold() -- Set the collection thresholds.\n" "get_threshold() -- Return the current the collection thresholds.\n" "get_objects() -- Return a list of all objects tracked by the collector.\n" "is_tracked() -- Returns true if a given object is tracked.\n" "get_referrers() -- Return the list of objects that refer to an object.\n" "get_referents() -- Return the list of objects that an object refers to.\n";
# 1384 "gcmodule.c"
static PyMethodDef GcMethods[] = {
    {"enable", gc_enable, 0x0004, gc_enable__doc__},
    {"disable", gc_disable, 0x0004, gc_disable__doc__},
    {"isenabled", gc_isenabled, 0x0004, gc_isenabled__doc__},
    {"set_debug", gc_set_debug, 0x0001, gc_set_debug__doc__},
    {"get_debug", gc_get_debug, 0x0004, gc_get_debug__doc__},
    {"get_count", gc_get_count, 0x0004, gc_get_count__doc__},
    {"set_threshold", gc_set_thresh, 0x0001, gc_set_thresh__doc__},
    {"get_threshold", gc_get_thresh, 0x0004, gc_get_thresh__doc__},
    {"collect", (PyCFunction)gc_collect,
        0x0001 | 0x0002, gc_collect__doc__},
    {"get_objects", gc_get_objects,0x0004, gc_get_objects__doc__},
    {"is_tracked", gc_is_tracked, 0x0008, gc_is_tracked__doc__},
    {"get_referrers", gc_get_referrers, 0x0001,
        gc_get_referrers__doc__},
    {"get_referents", gc_get_referents, 0x0001,
...
PyInit_gc(void)
{
    ...
    m = PyModule_Create2(&gcmodule, 1013);
    ...
    if (PyModule_AddIntConstant(m, "DEBUG_STATS", (1<<0)) < 0) return ((void *)0);
    if (PyModule_AddIntConstant(m, "DEBUG_COLLECTABLE", (1<<1)) < 0) return ((void *)0);
    if (PyModule_AddIntConstant(m, "DEBUG_UNCOLLECTABLE", (1<<2)) < 0) return ((void *)0);
    if (PyModule_AddIntConstant(m, "DEBUG_SAVEALL", (1<<5)) < 0) return ((void *)0);
    if (PyModule_AddIntConstant(m, "DEBUG_LEAK", (1<<1) | (1<<2) | (1<<5)) < 0) return ((void *)0);
...
{
    if (!(debug & (1<<5))
        && garbage != ((void *)0) && (((PyVarObject*)(garbage))->ob_size) > 0) {
        char *message;
        if (debug & (1<<2))
            message = "gc: %zd uncollectable objects at " "shutdown";

        else
            message = "gc: %zd uncollectable objects at " "shutdown; use gc.set_debug(gc.DEBUG_UNCOLLECTABLE) to list them";

        if (PyErr_WarnFormat(PyExc_ResourceWarning, 0, message,
                             (((PyVarObject*)(garbage))->ob_size)) < 0)
            PyErr_WriteUnraisable(((void *)0));
        if (debug & (1<<2)) {
            PyObject *repr = ((void *)0), *bytes = ((void *)0);
            ...
            if (!repr || !(bytes = PyUnicode_EncodeFSDefault(repr)))
                ...
                PySys_WriteStderr(
                    "    %s\n",
                    ((__builtin_expect(!(((((((PyObject*)(bytes))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "gcmodule.c", 1506, "PyBytes_Check(bytes)") : (void)0), (((PyBytesObject *)(bytes))->ob_sval))
                    );
            }
    ...
    do { if (callbacks) { PyObject *_py_tmp = (PyObject *)(callbacks); (callbacks) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
}
...
{
    _PyObject_Dump(((PyObject *)(((PyGC_Head *)g)+1)));
}
# 1531 "gcmodule.c"
void
...
PyObject_GC_UnTrack(void *op)
{
    ...
    if (((((PyGC_Head *)(op)-1))->gc.gc_refs != (-2)))
        do { PyGC_Head *g = ((PyGC_Head *)(op)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "gcmodule.c", 1551, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
}
...
_PyObject_GC_Malloc(size_t basicsize)
{
    PyObject *op;
    PyGC_Head *g;
    if (basicsize > ((Py_ssize_t)(((size_t)-1)>>1)) - sizeof(PyGC_Head))
...
{
    PyObject *op = _PyObject_GC_Malloc(( (tp)->tp_basicsize ));
    if (op != ((void *)0))
        op = ( (((PyObject*)(op))->ob_type) = (tp), ( (((PyObject*)((PyObject *)(op)))->ob_refcnt) = 1), (op) );
    return op;
}
...
{
    const size_t size = (((size_t)((tp)->tp_basicsize + (nitems)*(tp)->tp_itemsize) + (size_t)((8) - 1)) & ~(size_t)((8) - 1));
    PyVarObject *op = (PyVarObject *) _PyObject_GC_Malloc(size);
    if (op != ((void *)0))
        op = ( (((PyVarObject*)(op))->ob_size) = (nitems), ( (((PyObject*)((op)))->ob_type) = ((tp)), ( (((PyObject*)((PyObject *)((op))))->ob_refcnt) = 1), ((op)) ) );
    return op;
}
...
{
    const size_t basicsize = (((size_t)(((((PyObject*)(op))->ob_type))->tp_basicsize + (nitems)*((((PyObject*)(op))->ob_type))->tp_itemsize) + (size_t)((8) - 1)) & ~(size_t)((8) - 1));
    PyGC_Head *g = ((PyGC_Head *)(op)-1);
    if (basicsize > ((Py_ssize_t)(((size_t)-1)>>1)) - sizeof(PyGC_Head))
        return (PyVarObject *)PyErr_NoMemory();
    g = (PyGC_Head *)PyObject_Realloc(g, sizeof(PyGC_Head) + basicsize);
    if (g == ((void *)0))
        return (PyVarObject *)PyErr_NoMemory();
    op = (PyVarObject *) ((PyObject *)(((PyGC_Head *)g)+1));
    (((PyVarObject*)(op))->ob_size) = nitems;
    return op;
}
