...
static PyMemberDef namespace_members[] = {
    {"__dict__", 6, __builtin_offsetof (_PyNamespaceObject, ns_dict), 1},
    {((void *)0)}
};
...
namespace_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    (__builtin_expect(!(type != ((void *)0) && type->tp_alloc != ((void *)0)), 0) ? __assert_rtn(__func__, "namespaceobject.c", 26, "type != NULL && type->tp_alloc != NULL") : (void)0);
    self = type->tp_alloc(type, 0);
    if (self != ((void *)0)) {
        _PyNamespaceObject *ns = (_PyNamespaceObject *)self;
        ns->ns_dict = PyDict_New();
        if (ns->ns_dict == ((void *)0)) {
...
namespace_dealloc(_PyNamespaceObject *ns)
{
    ...
    do { if (ns->ns_dict) { PyObject *_py_tmp = (PyObject *)(ns->ns_dict); (ns->ns_dict) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    (((PyObject*)(ns))->ob_type)->tp_free((PyObject *)ns);
}
...
{
    int i, loop_error = 0;
    PyObject *pairs = ((void *)0), *d = ((void *)0), *keys = ((void *)0), *keys_iter = ((void *)0);
    PyObject *key;
    PyObject *separator, *pairsrepr, *repr = ((void *)0);

    i = Py_ReprEnter((PyObject *)ns);
    if (i != 0) {
        return i > 0 ? PyUnicode_FromString("namespace(...)") : ((void *)0);
    }
    ...
    (__builtin_expect(!(d != ((void *)0)), 0) ? __assert_rtn(__func__, "namespaceobject.c", 86, "d != NULL") : (void)0);
    ...
    while ((key = PyIter_Next(keys_iter)) != ((void *)0)) {
        if (((((((PyObject*)(key))->ob_type))->tp_flags & ((1L<<28))) != 0) && ((__builtin_expect(!(((((((PyObject*)(key))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "namespaceobject.c", 100, "PyUnicode_Check(key)") : (void)0), (((PyASCIIObject *)(key))->wstr) ? ((((PyASCIIObject*)key)->state.ascii && (((PyASCIIObject*)(key))->state.compact)) ? ((PyASCIIObject*)key)->length : ((PyCompactUnicodeObject*)key)->wstr_length) : ((void)PyUnicode_AsUnicode((PyObject *)(key)), (__builtin_expect(!(((PyASCIIObject *)(key))->wstr), 0) ? __assert_rtn(__func__, "namespaceobject.c", 100, "((PyASCIIObject *)(key))->wstr") : (void)0), ((((PyASCIIObject*)key)->state.ascii && (((PyASCIIObject*)(key))->state.compact)) ? ((PyASCIIObject*)key)->length : ((PyCompactUnicodeObject*)key)->wstr_length))) > 0) {
            PyObject *value, *item;

            value = PyDict_GetItem(d, key);
            (__builtin_expect(!(value != ((void *)0)), 0) ? __assert_rtn(__func__, "namespaceobject.c", 104, "value != NULL") : (void)0);
    ...
    do { if ( --((PyObject*)(separator))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(separator)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(separator)))); } while (0);
    if (pairsrepr == ((void *)0))
        goto error;

    repr = PyUnicode_FromFormat("%s(%S)",
                                ((PyObject *)ns)->ob_type->tp_name, pairsrepr);
    do { if ( --((PyObject*)(pairsrepr))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pairsrepr)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pairsrepr)))); } while (0);

error:
    do { if ((pairs) == ((void *)0)) ; else do { if ( --((PyObject*)(pairs))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pairs)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pairs)))); } while (0); } while (0);
    do { if ((d) == ((void *)0)) ; else do { if ( --((PyObject*)(d))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(d)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(d)))); } while (0); } while (0);
    ...
    do { if ((keys_iter) == ((void *)0)) ; else do { if ( --((PyObject*)(keys_iter))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(keys_iter)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(keys_iter)))); } while (0); } while (0);
...
{
    do { if (ns->ns_dict) { int vret = visit((PyObject *)(ns->ns_dict), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
static char namespace_doc[] = "A simple attribute-based namespace.\n\nnamespace(**kwargs)";
...
PyTypeObject _PyNamespace_Type = {
    { { 1, &PyType_Type }, 0 },
    "namespace",
    sizeof(_PyNamespaceObject),
    0,
    (destructor)namespace_dealloc,
    0,
    0,
    0,
    0,
    (reprfunc)namespace_repr,
    0,
    0,
    0,
    0,
    ...
    ( 0 | (1L<<18) | 0) | (1L<<14) |
        (1L<<10),
    namespace_doc,
    (traverseproc)namespace_traverse,
    (inquiry)namespace_clear,
    0,
    0,
    0,
    0,
    ...
    0,
    0,
    __builtin_offsetof (_PyNamespaceObject, ns_dict),
    (initproc)namespace_init,
    PyType_GenericAlloc,
    (newfunc)namespace_new,
    PyObject_GC_Del,
};
...
{
    PyObject *ns = namespace_new(&_PyNamespace_Type, ((void *)0), ((void *)0));
    if (ns == ((void *)0))
        return ((void *)0);
