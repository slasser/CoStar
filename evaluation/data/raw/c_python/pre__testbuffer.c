...
PyObject *structmodule = ((void *)0);
PyObject *Struct = ((void *)0);
PyObject *calcsize = ((void *)0);


static const char *simple_fmt = "B";
PyObject *simple_format = ((void *)0);
# 26 "_testbuffer.c"
...
ndbuf_free(ndbuf_t *ndbuf)
{
    ...
    do { if (ndbuf->data) PyMem_Free(ndbuf->data); } while (0);
    do { if (base->format) PyMem_Free(base->format); } while (0);
    do { if (base->shape) PyMem_Free(base->shape); } while (0);
    do { if (base->strides) PyMem_Free(base->strides); } while (0);
    do { if (base->suboffsets) PyMem_Free(base->suboffsets); } while (0);
...
ndarray_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    nd = ( (NDArrayObject *) _PyObject_New(&NDArray_Type) );
    if (nd == ((void *)0))
        return ((void *)0);
...
{
    if (self->head) {
        if ((((NDArrayObject *)self)->head == &((NDArrayObject *)self)->staticbuf)) {
            Py_buffer *base = &self->head->base;
            if (self->head->flags & 0x200) {
                do { if (base->shape) PyMem_Free(base->shape); } while (0);
                do { if (base->strides) PyMem_Free(base->strides); } while (0);
                do { if (base->suboffsets) PyMem_Free(base->suboffsets); } while (0);
            }
...
ndarray_init_staticbuf(PyObject *exporter, NDArrayObject *nd, int flags)
{
    ...
    nd->head->flags = base->readonly ? 0 : 0x002;
    nd->head->exports = 0;
               ...
               Py_ssize_t itemsize)
{
    ...
    (__builtin_expect(!((((obj)->ob_type->tp_as_buffer != ((void *)0)) && ((obj)->ob_type->tp_as_buffer->bf_getbuffer != ((void *)0)))), 0) ? __assert_rtn(__func__, "_testbuffer.c", 312, "PyObject_CheckBuffer(obj)") : (void)0);
    (__builtin_expect(!(((((((PyObject*)(items))->ob_type))->tp_flags & ((1L<<25))) != 0) || ((((((PyObject*)(items))->ob_type))->tp_flags & ((1L<<26))) != 0)), 0) ? __assert_rtn(__func__, "_testbuffer.c", 313, "PyList_Check(items) || PyTuple_Check(items)") : (void)0);

    structobj = PyObject_CallFunctionObjArgs(Struct, format, ((void *)0));
    if (structobj == ((void *)0))
        return -1;

    nitems = (((((((PyObject*)(items))->ob_type))->tp_flags & ((1L<<25))) != 0) ? (((PyVarObject*)(items))->ob_size) : (((PyVarObject*)(items))->ob_size));
    nmemb = get_nmemb(structobj);
    (__builtin_expect(!(nmemb >= 1), 0) ? __assert_rtn(__func__, "_testbuffer.c", 321, "nmemb >= 1") : (void)0);

    pack_into = PyObject_GetAttrString(structobj, "pack_into");
    if (pack_into == ((void *)0)) {
        do { if ( --((PyObject*)(structobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(structobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(structobj)))); } while (0);
        return -1;
    }
    ...
    if (args == ((void *)0)) {
        do { if ( --((PyObject*)(pack_into))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pack_into)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pack_into)))); } while (0);
        do { if ( --((PyObject*)(structobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(structobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(structobj)))); } while (0);
        return -1;
    }
    ...
    for (i = 0; i < nitems; i++) {
        ...
        for (j = 1; j < 2+nmemb; j++)
            (((PyTupleObject *)(args))->ob_item[j] = ((void *)0));

        do { if ((offset) == ((void *)0)) ; else do { if ( --((PyObject*)(offset))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(offset)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(offset)))); } while (0); } while (0);
        offset = PyLong_FromSsize_t(i*itemsize);
        if (offset == ((void *)0)) {
            ret = -1;
            break;
        }
        (((PyTupleObject *)(args))->ob_item[1] = offset);

        item = (((((((PyObject*)(items))->ob_type))->tp_flags & ((1L<<25))) != 0) ? (((PyListObject *)(items))->ob_item[i]) : (((PyTupleObject *)(items))->ob_item[i]));
        if ((((((((PyObject*)(item))->ob_type))->tp_flags & ((1L<<27))) != 0) || ((((((PyObject*)(item))->ob_type))->tp_flags & ((1L<<24))) != 0) ||
             ((((PyObject*)(item))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(item))->ob_type), (&PyFloat_Type)))) && nmemb == 1) {
            (((PyTupleObject *)(args))->ob_item[2] = item);
        }
        else if ((((((((PyObject*)(item))->ob_type))->tp_flags & ((1L<<25))) != 0) || ((((((PyObject*)(item))->ob_type))->tp_flags & ((1L<<26))) != 0)) &&
                 PySequence_Size(item) == nmemb) {
            for (j = 0; j < nmemb; j++) {
                tmp = (((((((PyObject*)(item))->ob_type))->tp_flags & ((1L<<25))) != 0) ? (((PyListObject *)(item))->ob_item[j]) : (((PyTupleObject *)(item))->ob_item[j]));
                (((PyTupleObject *)(args))->ob_item[2+j] = tmp);
            }
        }
        else {
            PyErr_SetString(PyExc_ValueError,
    ...
    for (i = 2; i < 2+nmemb; i++) {
        tmp = (((PyTupleObject *)(args))->ob_item[i]);
...
{
    PyObject *structobj = ((void *)0), *pack_into = ((void *)0), *args = ((void *)0);
    PyObject *format = ((void *)0), *mview = ((void *)0), *zero = ((void *)0);
    Py_ssize_t i, nmemb;
    int ret = -1;
    PyObject *x;
    ...
    nmemb = get_nmemb(structobj);
    (__builtin_expect(!(nmemb >= 1), 0) ? __assert_rtn(__func__, "_testbuffer.c", 414, "nmemb >= 1") : (void)0);

    mview = PyMemoryView_FromMemory(ptr, itemsize, 0x200);
    if (mview == ((void *)0))
        goto out;
    ...
    (((PyTupleObject *)(args))->ob_item[0] = mview);
    (((PyTupleObject *)(args))->ob_item[1] = zero);
    ...
    if ((((((((PyObject*)(item))->ob_type))->tp_flags & ((1L<<27))) != 0) || ((((((PyObject*)(item))->ob_type))->tp_flags & ((1L<<24))) != 0) ||
         ...
         (((PyTupleObject *)(args))->ob_item[2] = item);
             ...
             PySequence_Size(item) == nmemb) {
        for (i = 0; i < nmemb; i++) {
            x = (((((((PyObject*)(item))->ob_type))->tp_flags & ((1L<<25))) != 0) ? (((PyListObject *)(item))->ob_item[i]) : (((PyTupleObject *)(item))->ob_item[i]));
            (((PyTupleObject *)(args))->ob_item[2+i] = x);
        }
    }
    else {
        PyErr_SetString(PyExc_ValueError,
...
args_out:
    for (i = 0; i < 2+nmemb; i++)
        do { if (((((PyTupleObject *)(args))->ob_item[i])) == ((void *)0)) ; else ( ((PyObject*)((((PyTupleObject *)(args))->ob_item[i])))->ob_refcnt++); } while (0);
...
out:
    do { if ((pack_into) == ((void *)0)) ; else do { if ( --((PyObject*)(pack_into))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(pack_into)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(pack_into)))); } while (0); } while (0);
    do { if ((zero) == ((void *)0)) ; else do { if ( --((PyObject*)(zero))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(zero)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(zero)))); } while (0); } while (0);
    do { if ((mview) == ((void *)0)) ; else do { if ( --((PyObject*)(mview))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(mview)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(mview)))); } while (0); } while (0);
         ...
         char *mem)
{
    ...
    (__builtin_expect(!(ndim >= 1), 0) ? __assert_rtn(__func__, "_testbuffer.c", 480, "ndim >= 1") : (void)0);

    if (ndim == 1) {
        if (!(dsuboffsets && dsuboffsets[0] >= 0) && !(ssuboffsets && ssuboffsets[0] >= 0) &&
            dstrides[0] == itemsize && sstrides[0] == itemsize) {
            ((__builtin_object_size (dptr, 0) != (size_t) -1) ? __builtin___memmove_chk (dptr, sptr, shape[0] * itemsize, __builtin_object_size (dptr, 0)) : __inline_memmove_chk (dptr, sptr, shape[0] * itemsize));
        }
        else {
            char *p;
            (__builtin_expect(!(mem != ((void *)0)), 0) ? __assert_rtn(__func__, "_testbuffer.c", 489, "mem != NULL") : (void)0);
...
cmp_structure(Py_buffer *dest, Py_buffer *src)
{
    ...
    if (strcmp((dest->format == ((void *)0) ? "B" : dest->format), (src->format == ((void *)0) ? "B" : src->format)) != 0 ||
...
copy_buffer(Py_buffer *dest, Py_buffer *src)
{
    ...
    (__builtin_expect(!(dest->ndim > 0), 0) ? __assert_rtn(__func__, "_testbuffer.c", 541, "dest->ndim > 0") : (void)0);
    ...
    do { if (mem) PyMem_Free(mem); } while (0);
    return 0;
}
...
unpack_single(char *ptr, const char *fmt, Py_ssize_t itemsize)
{
    ...
    if (unpack_from == ((void *)0))
        return ((void *)0);

    mview = PyMemoryView_FromMemory(ptr, itemsize, 0x100);
    if (mview == ((void *)0)) {
        do { if ( --((PyObject*)(unpack_from))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(unpack_from)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(unpack_from)))); } while (0);
        return ((void *)0);
    }

    x = _PyObject_CallFunction_SizeT(unpack_from, "sO", fmt, mview);
    do { if ( --((PyObject*)(unpack_from))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(unpack_from)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(unpack_from)))); } while (0);
    do { if ( --((PyObject*)(mview))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(mview)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(mview)))); } while (0);
    if (x == ((void *)0))
        return ((void *)0);

    if ((((PyVarObject*)(x))->ob_size) == 1) {
        PyObject *tmp = (((PyTupleObject *)(x))->ob_item[0]);
           ...
           const Py_ssize_t *suboffsets, Py_ssize_t ndim, Py_ssize_t itemsize)
{
    ...
    (__builtin_expect(!(ndim >= 0), 0) ? __assert_rtn(__func__, "_testbuffer.c", 617, "ndim >= 0") : (void)0);
    (__builtin_expect(!(shape != ((void *)0)), 0) ? __assert_rtn(__func__, "_testbuffer.c", 618, "shape != NULL") : (void)0);
    (__builtin_expect(!(strides != ((void *)0)), 0) ? __assert_rtn(__func__, "_testbuffer.c", 619, "strides != NULL") : (void)0);

    if (ndim == 0) {
        ((__builtin_object_size (item, 0) != (size_t) -1) ? __builtin___memcpy_chk (item, ptr, itemsize, __builtin_object_size (item, 0)) : __inline_memcpy_chk (item, ptr, itemsize));
        x = PyObject_CallFunctionObjArgs(unpack_from, mview, ((void *)0));
        if (x == ((void *)0))
            return ((void *)0);
        if ((((PyVarObject*)(x))->ob_size) == 1) {
            PyObject *tmp = (((PyTupleObject *)(x))->ob_item[0]);
    ...
    for (i = 0; i < shape[0]; ptr+=strides[0], i++) {
        char *nextptr = ((suboffsets && suboffsets[0] >= 0) ? *((char**)ptr) + suboffsets[0] : ptr);

        x = unpack_rec(unpack_from, nextptr, mview, item,
                       shape+1, strides+1, suboffsets ? suboffsets+1 : ((void *)0),
                       ndim-1, itemsize);
        if (x == ((void *)0)) {
...
{
    PyObject *structobj = ((void *)0), *unpack_from = ((void *)0);
    PyObject *lst = ((void *)0), *mview = ((void *)0);
    ...
    if (shape == ((void *)0)) {
        (__builtin_expect(!((!!(nd->head->flags&(0x008|0x100)))), 0) ? __assert_rtn(__func__, "_testbuffer.c", 680, "ND_C_CONTIGUOUS(nd->head->flags)") : (void)0);
        (__builtin_expect(!(base->strides == ((void *)0)), 0) ? __assert_rtn(__func__, "_testbuffer.c", 681, "base->strides == NULL") : (void)0);
        (__builtin_expect(!(base->ndim <= 1), 0) ? __assert_rtn(__func__, "_testbuffer.c", 682, "base->ndim <= 1") : (void)0);
        shape = simple_shape;
        shape[0] = base->len;
        strides = simple_strides;
        strides[0] = base->itemsize;
    }
    else if (strides == ((void *)0)) {
        (__builtin_expect(!((!!(nd->head->flags&(0x008|0x100)))), 0) ? __assert_rtn(__func__, "_testbuffer.c", 689, "ND_C_CONTIGUOUS(nd->head->flags)") : (void)0);
    ...
    mview = PyMemoryView_FromMemory(item, base->itemsize, 0x200);
    if (mview == ((void *)0))
        goto out;
...
out:
    do { if ((mview) == ((void *)0)) ; else do { if ( --((PyObject*)(mview))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(mview)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(mview)))); } while (0); } while (0);
    do { if (item) PyMem_Free(item); } while (0);
    do { if ((unpack_from) == ((void *)0)) ; else do { if ( --((PyObject*)(unpack_from))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(unpack_from)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(unpack_from)))); } while (0); } while (0);
    do { if ((structobj) == ((void *)0)) ; else do { if ( --((PyObject*)(structobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(structobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(structobj)))); } while (0); } while (0);
    if (strides != base->strides && strides != simple_strides)
        do { if (strides) PyMem_Free(strides); } while (0);
...
get_itemsize(PyObject *format)
{
    ...
    tmp = PyObject_CallFunctionObjArgs(calcsize, format, ((void *)0));
    if (tmp == ((void *)0))
        return -1;
...
get_format(PyObject *format)
{
    ...
    if (tmp == ((void *)0))
        return ((void *)0);
    fmt = PyMem_Malloc(((__builtin_expect(!(((((((PyObject*)(tmp))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_testbuffer.c", 809, "PyBytes_Check(tmp)") : (void)0),(((PyVarObject*)(tmp))->ob_size))+1);
    if (fmt == ((void *)0)) {
        PyErr_NoMemory();
        do { if ( --((PyObject*)(tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tmp)))); } while (0);
        return ((void *)0);
    }
    ((__builtin_object_size (fmt, 0) != (size_t) -1) ? __builtin___strcpy_chk (fmt, ((__builtin_expect(!(((((((PyObject*)(tmp))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_testbuffer.c", 815, "PyBytes_Check(tmp)") : (void)0), (((PyBytesObject *)(tmp))->ob_sval)), __builtin_object_size (fmt, 2 > 1)) : __inline_strcpy_chk (fmt, ((__builtin_expect(!(((((((PyObject*)(tmp))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_testbuffer.c", 815, "PyBytes_Check(tmp)") : (void)0), (((PyBytesObject *)(tmp))->ob_sval))));
    do { if ( --((PyObject*)(tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tmp)))); } while (0);
            ...
            Py_ssize_t itemsize)
{
    ...
    base->readonly = !(ndbuf->flags & 0x002);
    base->itemsize = itemsize;
    base->format = get_format(format);
    if (base->format == ((void *)0))
        return -1;
                 ...
                 Py_ssize_t ndim)
{
    ...
    (__builtin_expect(!(ndim >= 0), 0) ? __assert_rtn(__func__, "_testbuffer.c", 935, "ndim >= 0") : (void)0);
...
init_suboffsets(ndbuf_t *ndbuf)
{
    ...
    (__builtin_expect(!(base->ndim > 0), 0) ? __assert_rtn(__func__, "_testbuffer.c", 1038, "base->ndim > 0") : (void)0);
    (__builtin_expect(!(base->suboffsets == ((void *)0)), 0) ? __assert_rtn(__func__, "_testbuffer.c", 1039, "base->suboffsets == NULL") : (void)0);
    ...
    ((__builtin_object_size (data + addsize, 0) != (size_t) -1) ? __builtin___memcpy_chk (data + addsize, ndbuf->data, ndbuf->len, __builtin_object_size (data + addsize, 0)) : __inline_memcpy_chk (data + addsize, ndbuf->data, ndbuf->len));
           ...
           Py_ssize_t offset, PyObject *format, int flags)
{
    ...
    if (ndim > (2 * 64)) {
        PyErr_Format(PyExc_ValueError,
            "ndim must not exceed %d", (2 * 64));
        return ((void *)0);
    }


    if (strides) {
        if (!((((((PyObject*)(strides))->ob_type))->tp_flags & ((1L<<25))) != 0) && !((((((PyObject*)(strides))->ob_type))->tp_flags & ((1L<<26))) != 0)) { PyErr_SetString(PyExc_TypeError, "strides" " must be a list or a tuple"); return ((void *)0); }
        if ((((((((PyObject*)(strides))->ob_type))->tp_flags & ((1L<<25))) != 0) ? (((PyVarObject*)(strides))->ob_size) : (((PyVarObject*)(strides))->ob_size)) == 0)
            strides = ((void *)0);
        else if (flags & 0x004) {
            PyErr_SetString(PyExc_TypeError,
        ...
        else if ((((((((PyObject*)(strides))->ob_type))->tp_flags & ((1L<<25))) != 0) ? (((PyVarObject*)(strides))->ob_size) : (((PyVarObject*)(strides))->ob_size)) != ndim) {
            PyErr_SetString(PyExc_ValueError,
    ...
    if (ndim == 0) {
        items = _Py_BuildValue_SizeT("(O)", items);
        if (items == ((void *)0))
            return ((void *)0);
    }
    else {
        if (!((((((PyObject*)(items))->ob_type))->tp_flags & ((1L<<25))) != 0) && !((((((PyObject*)(items))->ob_type))->tp_flags & ((1L<<26))) != 0)) { PyErr_SetString(PyExc_TypeError, "items" " must be a list or a tuple"); return ((void *)0); }
...
ndarray_init(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    static char *kwlist[] = {
        "obj", "shape", "strides", "offset", "format", "flags", "getbuf", ((void *)0)
    };
    PyObject *v = ((void *)0);
    PyObject *shape = ((void *)0);
    PyObject *strides = ((void *)0);
    Py_ssize_t offset = 0;
    PyObject *format = simple_format;
    int flags = 0x000;

    int getbuf = 0x10000;


    if (!_PyArg_ParseTupleAndKeywords_SizeT(args, kwds, "O|OOnOii", kwlist,
            &v, &shape, &strides, &offset, &format, &flags, &getbuf))
        return -1;


    if ((((v)->ob_type->tp_as_buffer != ((void *)0)) && ((v)->ob_type->tp_as_buffer->bf_getbuffer != ((void *)0))) && shape == ((void *)0)) {
        if (strides || offset || format != simple_format ||
            !(flags == 0x000 || flags == 0x020)) {
            PyErr_SetString(PyExc_TypeError,
        ...
        getbuf = (getbuf == 0x10000) ? ((0x0100 | (0x0010 | 0x0008)) | 0x0004) : getbuf;
...
ndarray_push(PyObject *self, PyObject *args, PyObject *kwds)
{
    NDArrayObject *nd = (NDArrayObject *)self;
    static char *kwlist[] = {
        "items", "shape", "strides", "offset", "format", "flags", ((void *)0)
    };
    PyObject *items = ((void *)0);
    PyObject *shape = ((void *)0);
    PyObject *strides = ((void *)0);
    PyObject *format = simple_format;
    Py_ssize_t offset = 0;
    ...
    if (!_PyArg_ParseTupleAndKeywords_SizeT(args, kwds, "OO|OnOi", kwlist,
    ...
    if ((((NDArrayObject *)nd)->head == &((NDArrayObject *)nd)->staticbuf)) {
        PyErr_SetString(PyExc_BufferError,
            "structure of re-exporting object is immutable");
        return ((void *)0);
    }
    if (!(nd->flags&0x001) && nd->head->exports > 0) {
...
ndarray_getbuf(NDArrayObject *self, Py_buffer *view, int flags)
{
    ...
    if (base->obj != ((void *)0) && (baseflags&0x020)) {
    ...
    *view = *base;
    ...
    if (base->ndim != 0 &&
        ((((flags&0x0008) == 0x0008) && base->shape == ((void *)0)) ||
         (((flags&(0x0010 | 0x0008)) == (0x0010 | 0x0008)) && base->strides == ((void *)0)))) {
    ...
    if (((flags&(0x0020 | (0x0010 | 0x0008))) == (0x0020 | (0x0010 | 0x0008))) && !(!!(baseflags&(0x008|0x100)))) {
        PyErr_SetString(PyExc_BufferError,
    ...
    if (((flags&(0x0080 | (0x0010 | 0x0008))) == (0x0080 | (0x0010 | 0x0008))) && !(!!(baseflags&(0x008|0x100|0x004)))) {
        PyErr_SetString(PyExc_BufferError,
...
static PyBufferProcs ndarray_as_buffer = {
    (getbufferproc)ndarray_getbuf,
    (releasebufferproc)ndarray_releasebuf
};
...
ptr_from_index(Py_buffer *base, Py_ssize_t index)
{
    ...
    if (base->shape)
        ...
        (__builtin_expect(!(base->ndim == 1 && (base->format == ((void *)0) || strcmp(base->format, "B") == 0)), 0) ? __assert_rtn(__func__, "_testbuffer.c", 1551, "base->ndim == 1 && SIMPLE_FORMAT(base->format)") : (void)0);
        nitems = base->len;
    }
    ...
    ptr = ((base->suboffsets && base->suboffsets[0] >= 0) ? *((char**)ptr) + base->suboffsets[0] : ptr);
...
ndarray_item(NDArrayObject *self, Py_ssize_t index)
{
    ...
    if (base->ndim == 1) {
        ...
        nd = (NDArrayObject *)ndarray_new(&NDArray_Type, ((void *)0), ((void *)0));
        if (nd == ((void *)0))
            return ((void *)0);

        if (ndarray_init_staticbuf((PyObject *)self, nd, ((0x0100 | (0x0010 | 0x0008)) | 0x0004)) < 0) {
            do { if ( --((PyObject*)(nd))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(nd)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(nd)))); } while (0);
            return ((void *)0);
        }
...
err_nomem:
    PyErr_NoMemory();
    do { if (shape) PyMem_Free(shape); } while (0);
    do { if (strides) PyMem_Free(strides); } while (0);
    do { if (suboffsets) PyMem_Free(suboffsets); } while (0);
    return -1;
}
...
ndarray_subscript(NDArrayObject *self, PyObject *key)
{
    ...
    if (((((PyObject*)(key))->ob_type) == &PySlice_Type)) {

        if (init_slice(base, key, 0) < 0)
            goto err_occurred;
    }
    else if ((((((PyObject*)(key))->ob_type))->tp_flags & ((1L<<26))) != 0) {
        ...
        for (i = 0; i < n; i++) {
            key = (((PyTupleObject *)(tuple))->ob_item[i]);
            if (!((((PyObject*)(key))->ob_type) == &PySlice_Type))
                goto type_error;
...
ndarray_ass_subscript(NDArrayObject *self, PyObject *key, PyObject *value)
{
    ...
    if (dest->ndim == 1 && ((key)->ob_type->tp_as_number != ((void *)0) && (key)->ob_type->tp_as_number->nb_index != ((void *)0))) {
    ...
    if (PyObject_GetBuffer(value, &src, ((0x0100 | (0x0010 | 0x0008)) | 0x0004)) == -1)
        return -1;
...
slice_indices(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "On", &key, &len)) {
        return ((void *)0);
    }
    if (!((((PyObject*)(key))->ob_type) == &PySlice_Type)) {
        PyErr_SetString(PyExc_TypeError,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (tmp == ((void *)0))
            goto error;
        (((PyTupleObject *)(ret))->ob_item[i] = tmp);
    }
...
static PyMappingMethods ndarray_as_mapping = {
    ((void *)0),
    (binaryfunc)ndarray_subscript,
    (objobjargproc)ndarray_ass_subscript
};
...
ssize_array_as_tuple(Py_ssize_t *array, Py_ssize_t len)
{
    ...
    for (i = 0; i < len; i++) {
        ...
        (((PyTupleObject *)(tuple))->ob_item[i] = x);
    }
...
ndarray_c_contig(PyObject *self, PyObject *dummy)
{
    ...
    if (ret != (!!(nd->head->flags&(0x008|0x100)))) {
...
ndarray_fortran_contig(PyObject *self, PyObject *dummy)
{
    ...
    if (ret != (!!(nd->head->flags&(0x008|0x004)))) {
        PyErr_SetString(PyExc_RuntimeError,
            "results from PyBuffer_IsContiguous() and flags differ");
        return ((void *)0);
    }
...
ndarray_contig(PyObject *self, PyObject *dummy)
{
    ...
    if (ret != (!!(nd->head->flags&(0x008|0x100|0x004)))) {
        PyErr_SetString(PyExc_RuntimeError,
            "results from PyBuffer_IsContiguous() and flags differ");
        return ((void *)0);
    }
...
static PyGetSetDef ndarray_getset [] =
{
  ...
  { "flags", (getter)ndarray_get_flags, ((void *)0), ((void *)0), ((void *)0)},
  { "offset", (getter)ndarray_get_offset, ((void *)0), ((void *)0), ((void *)0)},

  { "obj", (getter)ndarray_get_obj, ((void *)0), ((void *)0), ((void *)0)},
  { "nbytes", (getter)ndarray_get_nbytes, ((void *)0), ((void *)0), ((void *)0)},
  { "readonly", (getter)ndarray_get_readonly, ((void *)0), ((void *)0), ((void *)0)},
  { "itemsize", (getter)ndarray_get_itemsize, ((void *)0), ((void *)0), ((void *)0)},
  { "format", (getter)ndarray_get_format, ((void *)0), ((void *)0), ((void *)0)},
  { "ndim", (getter)ndarray_get_ndim, ((void *)0), ((void *)0), ((void *)0)},
  { "shape", (getter)ndarray_get_shape, ((void *)0), ((void *)0), ((void *)0)},
  { "strides", (getter)ndarray_get_strides, ((void *)0), ((void *)0), ((void *)0)},
  { "suboffsets", (getter)ndarray_get_suboffsets, ((void *)0), ((void *)0), ((void *)0)},
  { "c_contiguous", (getter)ndarray_c_contig, ((void *)0), ((void *)0), ((void *)0)},
  { "f_contiguous", (getter)ndarray_fortran_contig, ((void *)0), ((void *)0), ((void *)0)},
  { "contiguous", (getter)ndarray_contig, ((void *)0), ((void *)0), ((void *)0)},
  {((void *)0)}
};
...
ndarray_tobytes(PyObject *self, PyObject *dummy)
{
    ...
    if ((!!(ndbuf->flags&(0x008|0x100))))
        return PyBytes_FromStringAndSize(src->buf, src->len);

    (__builtin_expect(!(src->shape != ((void *)0)), 0) ? __assert_rtn(__func__, "_testbuffer.c", 2154, "src->shape != NULL") : (void)0);
    (__builtin_expect(!(src->strides != ((void *)0)), 0) ? __assert_rtn(__func__, "_testbuffer.c", 2155, "src->strides != NULL") : (void)0);
    (__builtin_expect(!(src->ndim > 0), 0) ? __assert_rtn(__func__, "_testbuffer.c", 2156, "src->ndim > 0") : (void)0);
...
out:
    do { if (dest.strides) PyMem_Free(dest.strides); } while (0);
    PyMem_Free(mem);
    return ret;
}
...
ndarray_memoryview_from_buffer(PyObject *self, PyObject *dummy)
{
    ...
    const ndbuf_t *ndbuf;
    static char format[(2 * 64)+1];
    static Py_ssize_t shape[(2 * 64)];
    static Py_ssize_t strides[(2 * 64)];
    static Py_ssize_t suboffsets[(2 * 64)];
    static Py_buffer info;
    char *p;

    if (!(((NDArrayObject *)nd)->head == &((NDArrayObject *)nd)->staticbuf))
        ndbuf = nd->head;
    else if (((((PyObject*)(view->obj))->ob_type) == &NDArray_Type) && !(((NDArrayObject *)view->obj)->head == &((NDArrayObject *)view->obj)->staticbuf))
    ...
    ((__builtin_object_size (infobuf, 0) != (size_t) -1) ? __builtin___memcpy_chk (infobuf, ndbuf->data, ndbuf->len, __builtin_object_size (infobuf, 0)) : __inline_memcpy_chk (infobuf, ndbuf->data, ndbuf->len));
    info.buf = infobuf + ((char *)view->buf - ndbuf->data);

    if (view->format) {
        if (strlen(view->format) > (2 * 64)) {
            PyErr_Format(PyExc_TypeError,
                "memoryview_from_buffer: format is limited to %d characters",
                (2 * 64));
                return ((void *)0);
        }
        ((__builtin_object_size (format, 0) != (size_t) -1) ? __builtin___strcpy_chk (format, view->format, __builtin_object_size (format, 2 > 1)) : __inline_strcpy_chk (format, view->format));
        info.format = format;
    }
    if (view->ndim > (2 * 64)) {
        PyErr_Format(PyExc_TypeError,
            "memoryview_from_buffer: ndim is limited to %d", (2 * 64));
            return ((void *)0);
    }
    if (view->shape) {
        ((__builtin_object_size (shape, 0) != (size_t) -1) ? __builtin___memcpy_chk (shape, view->shape, view->ndim * sizeof(Py_ssize_t), __builtin_object_size (shape, 0)) : __inline_memcpy_chk (shape, view->shape, view->ndim * sizeof(Py_ssize_t)));
        info.shape = shape;
    }
    if (view->strides) {
        ((__builtin_object_size (strides, 0) != (size_t) -1) ? __builtin___memcpy_chk (strides, view->strides, view->ndim * sizeof(Py_ssize_t), __builtin_object_size (strides, 0)) : __inline_memcpy_chk (strides, view->strides, view->ndim * sizeof(Py_ssize_t)));
        info.strides = strides;
    }
    if (view->suboffsets) {
        ((__builtin_object_size (suboffsets, 0) != (size_t) -1) ? __builtin___memcpy_chk (suboffsets, view->suboffsets, view->ndim * sizeof(Py_ssize_t), __builtin_object_size (suboffsets, 0)) : __inline_memcpy_chk (suboffsets, view->suboffsets, view->ndim * sizeof(Py_ssize_t)));
...
{
    PyObject *ret = ((void *)0), *bufobj, *seq;
    Py_buffer view;
    Py_ssize_t indices[(2 * 64)];
    Py_ssize_t i;
    void *ptr;

    if (!_PyArg_ParseTuple_SizeT(args, "OO", &bufobj, &seq)) {
        return ((void *)0);
    }

    if (!((((((PyObject*)(seq))->ob_type))->tp_flags & ((1L<<25))) != 0) && !((((((PyObject*)(seq))->ob_type))->tp_flags & ((1L<<26))) != 0)) { PyErr_SetString(PyExc_TypeError, "seq" " must be a list or a tuple"); return ((void *)0); };
    if (PyObject_GetBuffer(bufobj, &view, ((0x0100 | (0x0010 | 0x0008)) | 0x0004)) < 0)
        return ((void *)0);

    if (view.ndim > (2 * 64)) {
        PyErr_Format(PyExc_ValueError,
            "get_pointer(): ndim > %d", (2 * 64));
        goto out;
    }
    if ((((((((PyObject*)(seq))->ob_type))->tp_flags & ((1L<<25))) != 0) ? (((PyVarObject*)(seq))->ob_size) : (((PyVarObject*)(seq))->ob_size)) != view.ndim) {
        PyErr_SetString(PyExc_ValueError,
    ...
    for (i = 0; i < view.ndim; i++) {
        PyObject *x = (((((((PyObject*)(seq))->ob_type))->tp_flags & ((1L<<25))) != 0) ? (((PyListObject *)(seq))->ob_item[i]) : (((PyTupleObject *)(seq))->ob_item[i]));
...
get_ascii_order(PyObject *order)
{
    ...
    if (!((((((PyObject*)(order))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        PyErr_SetString(PyExc_TypeError,
    ...
    if (ascii_order == ((void *)0)) {
        return 127;
    }

    ord = ((__builtin_expect(!(((((((PyObject*)(ascii_order))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_testbuffer.c", 2362, "PyBytes_Check(ascii_order)") : (void)0), (((PyBytesObject *)(ascii_order))->ob_sval))[0];
    do { if ( --((PyObject*)(ascii_order))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(ascii_order)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(ascii_order)))); } while (0);
...
get_contiguous(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "OOO", &obj, &buffertype, &order)) {
        return ((void *)0);
    }

    if (!((((((PyObject*)(buffertype))->ob_type))->tp_flags & ((1L<<24))) != 0)) {
        PyErr_SetString(PyExc_TypeError,
...
py_buffer_to_contiguous(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "OOi", &obj, &order, &flags)) {
        return ((void *)0);
    }
...
out:
    PyBuffer_Release(&view);
    do { if (buf) PyMem_Free(buf); } while (0);
    return ret;
}
...
{
    if (fmt1 == ((void *)0)) {
        return fmt2 == ((void *)0) || strcmp(fmt2, "B") == 0;
    }
    if (fmt2 == ((void *)0)) {
        return fmt1 == ((void *)0) || strcmp(fmt1, "B") == 0;
    }
...
cmp_contig(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "OO", &b1, &b2)) {
        return ((void *)0);
    }

    if (PyObject_GetBuffer(b1, &v1, ((0x0100 | (0x0010 | 0x0008)) | 0x0004)) < 0) {
        PyErr_SetString(PyExc_TypeError,
            "cmp_contig: first argument does not implement the buffer "
            "protocol");
        return ((void *)0);
    }
    if (PyObject_GetBuffer(b2, &v2, ((0x0100 | (0x0010 | 0x0008)) | 0x0004)) < 0) {
        PyErr_SetString(PyExc_TypeError,
    ...
    if ((v1.shape && !arraycmp(v1.shape, v2.shape, ((void *)0), v1.ndim)) ||
        (v1.strides && !arraycmp(v1.strides, v2.strides, v1.shape, v1.ndim)) ||
        (v1.suboffsets && !arraycmp(v1.suboffsets, v2.suboffsets, ((void *)0),
                                    v1.ndim))) {
        goto result;
    }
...
result:
    ...
    ret = equal ? ((PyObject *) &_Py_TrueStruct) : ((PyObject *) &_Py_FalseStruct);
...
is_contiguous(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "OO", &obj, &order)) {
        return ((void *)0);
    }

    if (PyObject_GetBuffer(obj, &view, ((0x0100 | (0x0010 | 0x0008)) | 0x0004)) < 0) {
        PyErr_SetString(PyExc_TypeError,
    ...
    ret = PyBuffer_IsContiguous(&view, ord) ? ((PyObject *) &_Py_TrueStruct) : ((PyObject *) &_Py_FalseStruct);
    ( ((PyObject*)(ret))->ob_refcnt++);
...
ndarray_hash(PyObject *self)
{
    ...
    bytes = ndarray_tobytes(self, ((void *)0));
    if (bytes == ((void *)0)) {
        return -1;
    }
...
{
    { "tolist", ndarray_tolist, 0x0004, ((void *)0) },
    { "tobytes", ndarray_tobytes, 0x0004, ((void *)0) },
    { "push", (PyCFunction)ndarray_push, 0x0001|0x0002, ((void *)0) },
    { "pop", ndarray_pop, 0x0004, ((void *)0) },
    { "add_suboffsets", ndarray_add_suboffsets, 0x0004, ((void *)0) },
    { "memoryview_from_buffer", ndarray_memoryview_from_buffer, 0x0004, ((void *)0) },
    {((void *)0)}
};
...
static PyTypeObject NDArray_Type = {
    { { 1, ((void *)0) }, 0 },
    "ndarray",
    sizeof(NDArrayObject),
    0,
    (destructor)ndarray_dealloc,
    0,
    0,
    0,
    0,
...
{
    return (PyObject *)( (StaticArrayObject *) _PyObject_New(&StaticArray_Type) );
}
...
staticarray_init(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *legacy_mode = ((PyObject *) &_Py_FalseStruct);

    if (!_PyArg_ParseTupleAndKeywords_SizeT(args, kwds, "|O", kwlist, &legacy_mode))
        return -1;

    a->legacy_mode = (legacy_mode != ((PyObject *) &_Py_FalseStruct));
    return 0;
}
...
static PyBufferProcs staticarray_as_buffer = {
    (getbufferproc)staticarray_getbuf,
    ((void *)0),
};
...
static PyTypeObject StaticArray_Type = {
    { { 1, ((void *)0) }, 0 },
    "staticarray",
    sizeof(StaticArrayObject),
    0,
    (destructor)staticarray_dealloc,
    0,
    0,
    0,
    0,
...
static struct PyMethodDef _testbuffer_functions[] = {
    {"slice_indices", slice_indices, 0x0001, ((void *)0)},
    {"get_pointer", get_pointer, 0x0001, ((void *)0)},
    {"get_sizeof_void_p", (PyCFunction)get_sizeof_void_p, 0x0004, ((void *)0)},
    {"get_contiguous", get_contiguous, 0x0001, ((void *)0)},
    {"py_buffer_to_contiguous", py_buffer_to_contiguous, 0x0001, ((void *)0)},
    {"is_contiguous", is_contiguous, 0x0001, ((void *)0)},
    {"cmp_contig", cmp_contig, 0x0001, ((void *)0)},
    {((void *)0), ((void *)0)}
};
...
PyInit__testbuffer(void)
{
    ...
    m = PyModule_Create2(&_testbuffermodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);

    (((PyObject*)(&NDArray_Type))->ob_type) = &PyType_Type;
    ( ((PyObject*)(&NDArray_Type))->ob_refcnt++);
    PyModule_AddObject(m, "ndarray", (PyObject *)&NDArray_Type);

    (((PyObject*)(&StaticArray_Type))->ob_type) = &PyType_Type;
    ( ((PyObject*)(&StaticArray_Type))->ob_refcnt++);
    ...
    if (Struct == ((void *)0) || calcsize == ((void *)0))
        return ((void *)0);

    simple_format = PyUnicode_FromString(simple_fmt);
    if (simple_format == ((void *)0))
        return ((void *)0);

    PyModule_AddIntConstant(m, "ND_MAX_NDIM", (2 * 64));
    PyModule_AddIntConstant(m, "ND_VAREXPORT", 0x001);
    PyModule_AddIntConstant(m, "ND_WRITABLE", 0x002);
    PyModule_AddIntConstant(m, "ND_FORTRAN", 0x004);
    PyModule_AddIntConstant(m, "ND_SCALAR", 0x008);
    PyModule_AddIntConstant(m, "ND_PIL", 0x010);
    PyModule_AddIntConstant(m, "ND_GETBUF_FAIL", 0x040);
    PyModule_AddIntConstant(m, "ND_GETBUF_UNDEFINED", 0x080);
    PyModule_AddIntConstant(m, "ND_REDIRECT", 0x020);

    PyModule_AddIntConstant(m, "PyBUF_SIMPLE", 0);
    PyModule_AddIntConstant(m, "PyBUF_WRITABLE", 0x0001);
    PyModule_AddIntConstant(m, "PyBUF_FORMAT", 0x0004);
    PyModule_AddIntConstant(m, "PyBUF_ND", 0x0008);
    PyModule_AddIntConstant(m, "PyBUF_STRIDES", (0x0010 | 0x0008));
    PyModule_AddIntConstant(m, "PyBUF_INDIRECT", (0x0100 | (0x0010 | 0x0008)));
    PyModule_AddIntConstant(m, "PyBUF_C_CONTIGUOUS", (0x0020 | (0x0010 | 0x0008)));
    PyModule_AddIntConstant(m, "PyBUF_F_CONTIGUOUS", (0x0040 | (0x0010 | 0x0008)));
    PyModule_AddIntConstant(m, "PyBUF_ANY_CONTIGUOUS", (0x0080 | (0x0010 | 0x0008)));
    PyModule_AddIntConstant(m, "PyBUF_FULL", ((0x0100 | (0x0010 | 0x0008)) | 0x0001 | 0x0004));
    PyModule_AddIntConstant(m, "PyBUF_FULL_RO", ((0x0100 | (0x0010 | 0x0008)) | 0x0004));
    PyModule_AddIntConstant(m, "PyBUF_RECORDS", ((0x0010 | 0x0008) | 0x0001 | 0x0004));
    PyModule_AddIntConstant(m, "PyBUF_RECORDS_RO", ((0x0010 | 0x0008) | 0x0004));
    PyModule_AddIntConstant(m, "PyBUF_STRIDED", ((0x0010 | 0x0008) | 0x0001));
    PyModule_AddIntConstant(m, "PyBUF_STRIDED_RO", ((0x0010 | 0x0008)));
    PyModule_AddIntConstant(m, "PyBUF_CONTIG", (0x0008 | 0x0001));
    PyModule_AddIntConstant(m, "PyBUF_CONTIG_RO", (0x0008));

    PyModule_AddIntConstant(m, "PyBUF_READ", 0x100);
    PyModule_AddIntConstant(m, "PyBUF_WRITE", 0x200);
