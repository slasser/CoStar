...
PyCell_New(PyObject *obj)
{
    ...
    op = (PyCellObject *)( (PyCellObject *) _PyObject_GC_New(&PyCell_Type) );
    if (op == ((void *)0))
        return ((void *)0);
    op->ob_ref = obj;
...
{
    if (!((((PyObject*)(op))->ob_type) == &PyCell_Type)) {
        _PyErr_BadInternalCall("cellobject.c", 24);
        return ((void *)0);
    }
    do { if ((((PyCellObject*)op)->ob_ref) == ((void *)0)) ; else ( ((PyObject*)(((PyCellObject*)op)->ob_ref))->ob_refcnt++); } while (0);
...
PyCell_Set(PyObject *op, PyObject *obj)
{
    PyObject* oldobj;
    if (!((((PyObject*)(op))->ob_type) == &PyCell_Type)) {
        _PyErr_BadInternalCall("cellobject.c", 36);
        return -1;
    }
    oldobj = (((PyCellObject *)(op))->ob_ref);
    do { if ((obj) == ((void *)0)) ; else ( ((PyObject*)(obj))->ob_refcnt++); } while (0);
    (((PyCellObject *)(op))->ob_ref = obj);
    do { if ((oldobj) == ((void *)0)) ; else do { if ( --((PyObject*)(oldobj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(oldobj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(oldobj)))); } while (0); } while (0);
    return 0;
}
...
{
    do { PyGC_Head *g = ((PyGC_Head *)(op)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "cellobject.c", 49, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
    do { if ((op->ob_ref) == ((void *)0)) ; else do { if ( --((PyObject*)(op->ob_ref))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(op->ob_ref)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(op->ob_ref)))); } while (0); } while (0);
    PyObject_GC_Del(op);
}
...
cell_richcompare(PyObject *a, PyObject *b, int op)
{
    ...
    (__builtin_expect(!(a != ((void *)0) && b != ((void *)0)), 0) ? __assert_rtn(__func__, "cellobject.c", 63, "a != NULL && b != NULL") : (void)0);


    if (!((((PyObject*)(a))->ob_type) == &PyCell_Type) || !((((PyObject*)(b))->ob_type) == &PyCell_Type)) {
...
{
    do { if (op->ob_ref) { int vret = visit((PyObject *)(op->ob_ref), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
{
    do { if (op->ob_ref) { PyObject *_py_tmp = (PyObject *)(op->ob_ref); (op->ob_ref) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    return 0;
}
...
cell_get_contents(PyCellObject *op, void *closure)
{
    ...
    ( ((PyObject*)(op->ob_ref))->ob_refcnt++);
    return op->ob_ref;
}

static PyGetSetDef cell_getsetlist[] = {
    {"cell_contents", (getter)cell_get_contents, ((void *)0)},
    {((void *)0)}
};
