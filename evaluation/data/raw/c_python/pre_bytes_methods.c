...
const char _Py_isspace__doc__[] = "B.isspace() -> bool\n\nReturn True if all characters in B are whitespace\nand there is at least one character in B, False otherwise.";
...
_Py_bytes_isspace(const char *cptr, Py_ssize_t len)
{
    ...
    if (len == 1 && (_Py_ctype_table[((unsigned char)((*p) & 0xff))] & 0x08))
    ...
    e = p + len;
    for (; p < e; p++) {
        if (!(_Py_ctype_table[((unsigned char)((*p) & 0xff))] & 0x08))
            return ( ((PyObject*)(((PyObject *) &_Py_FalseStruct)))->ob_refcnt++), ((PyObject *) &_Py_FalseStruct);
    }
    return ( ((PyObject*)(((PyObject *) &_Py_TrueStruct)))->ob_refcnt++), ((PyObject *) &_Py_TrueStruct);
}
...
const char _Py_isalpha__doc__[] = "B.isalpha() -> bool\n\nReturn True if all characters in B are alphabetic\nand there is at least one character in B, False otherwise.";
...
_Py_bytes_isalpha(const char *cptr, Py_ssize_t len)
{
    ...
    if (len == 1 && (_Py_ctype_table[((unsigned char)((*p) & 0xff))] & (0x01|0x02)))
        return ( ((PyObject*)(((PyObject *) &_Py_TrueStruct)))->ob_refcnt++), ((PyObject *) &_Py_TrueStruct);
    ...
    e = p + len;
    for (; p < e; p++) {
        if (!(_Py_ctype_table[((unsigned char)((*p) & 0xff))] & (0x01|0x02)))
            return ( ((PyObject*)(((PyObject *) &_Py_FalseStruct)))->ob_refcnt++), ((PyObject *) &_Py_FalseStruct);
    }
    return ( ((PyObject*)(((PyObject *) &_Py_TrueStruct)))->ob_refcnt++), ((PyObject *) &_Py_TrueStruct);
}
...
const char _Py_isalnum__doc__[] = "B.isalnum() -> bool\n\nReturn True if all characters in B are alphanumeric\nand there is at least one character in B, False otherwise.";
...
_Py_bytes_isalnum(const char *cptr, Py_ssize_t len)
{
    ...
    if (len == 1 && (_Py_ctype_table[((unsigned char)((*p) & 0xff))] & ((0x01|0x02)|0x04)))
        return ( ((PyObject*)(((PyObject *) &_Py_TrueStruct)))->ob_refcnt++), ((PyObject *) &_Py_TrueStruct);
    ...
    e = p + len;
    for (; p < e; p++) {
        if (!(_Py_ctype_table[((unsigned char)((*p) & 0xff))] & ((0x01|0x02)|0x04)))
            return ( ((PyObject*)(((PyObject *) &_Py_FalseStruct)))->ob_refcnt++), ((PyObject *) &_Py_FalseStruct);
    }
    return ( ((PyObject*)(((PyObject *) &_Py_TrueStruct)))->ob_refcnt++), ((PyObject *) &_Py_TrueStruct);
}
...
const char _Py_isdigit__doc__[] = "B.isdigit() -> bool\n\nReturn True if all characters in B are digits\nand there is at least one character in B, False otherwise.";
...
_Py_bytes_isdigit(const char *cptr, Py_ssize_t len)
{
    ...
    if (len == 1 && (_Py_ctype_table[((unsigned char)((*p) & 0xff))] & 0x04))
        return ( ((PyObject*)(((PyObject *) &_Py_TrueStruct)))->ob_refcnt++), ((PyObject *) &_Py_TrueStruct);
    ...
    e = p + len;
    for (; p < e; p++) {
        if (!(_Py_ctype_table[((unsigned char)((*p) & 0xff))] & 0x04))
            return ( ((PyObject*)(((PyObject *) &_Py_FalseStruct)))->ob_refcnt++), ((PyObject *) &_Py_FalseStruct);
    }
    return ( ((PyObject*)(((PyObject *) &_Py_TrueStruct)))->ob_refcnt++), ((PyObject *) &_Py_TrueStruct);
}
...
const char _Py_islower__doc__[] = "B.islower() -> bool\n\nReturn True if all cased characters in B are lowercase and there is\nat least one cased character in B, False otherwise.";
...
_Py_bytes_islower(const char *cptr, Py_ssize_t len)
{
    ...
    if (len == 1)
        return PyBool_FromLong((_Py_ctype_table[((unsigned char)((*p) & 0xff))] & 0x01));
    ...
    cased = 0;
    for (; p < e; p++) {
        if ((_Py_ctype_table[((unsigned char)((*p) & 0xff))] & 0x02))
            return ( ((PyObject*)(((PyObject *) &_Py_FalseStruct)))->ob_refcnt++), ((PyObject *) &_Py_FalseStruct);
        else if (!cased && (_Py_ctype_table[((unsigned char)((*p) & 0xff))] & 0x01))
            cased = 1;
    }
...
const char _Py_isupper__doc__[] = "B.isupper() -> bool\n\nReturn True if all cased characters in B are uppercase and there is\nat least one cased character in B, False otherwise.";
...
_Py_bytes_isupper(const char *cptr, Py_ssize_t len)
{
    ...
    if (len == 1)
        return PyBool_FromLong((_Py_ctype_table[((unsigned char)((*p) & 0xff))] & 0x02));
    ...
    cased = 0;
    for (; p < e; p++) {
        if ((_Py_ctype_table[((unsigned char)((*p) & 0xff))] & 0x01))
            return ( ((PyObject*)(((PyObject *) &_Py_FalseStruct)))->ob_refcnt++), ((PyObject *) &_Py_FalseStruct);
        else if (!cased && (_Py_ctype_table[((unsigned char)((*p) & 0xff))] & 0x02))
            cased = 1;
    }
    return PyBool_FromLong(cased);
}
...
const char _Py_istitle__doc__[] = "B.istitle() -> bool\n\nReturn True if B is a titlecased string and there is at least one\ncharacter in B, i.e. uppercase characters may only follow uncased\ncharacters and lowercase characters only cased ones. Return False\notherwise.";
...
_Py_bytes_istitle(const char *cptr, Py_ssize_t len)
{
    ...
    for (; p < e; p++) {
        ...
        if ((_Py_ctype_table[((unsigned char)((ch) & 0xff))] & 0x02)) {
            if (previous_is_cased)
                return ( ((PyObject*)(((PyObject *) &_Py_FalseStruct)))->ob_refcnt++), ((PyObject *) &_Py_FalseStruct);
            previous_is_cased = 1;
            cased = 1;
        }
        else if ((_Py_ctype_table[((unsigned char)((ch) & 0xff))] & 0x01)) {
            if (!previous_is_cased)
                return ( ((PyObject*)(((PyObject *) &_Py_FalseStruct)))->ob_refcnt++), ((PyObject *) &_Py_FalseStruct);
            previous_is_cased = 1;
            cased = 1;
...
const char _Py_lower__doc__[] = "B.lower() -> copy of B\n\nReturn a copy of B with all ASCII characters converted to lowercase.";
...
_Py_bytes_lower(char *result, const char *cptr, Py_ssize_t len)
{
    ...
    for (i = 0; i < len; i++) {
        result[i] = (_Py_ctype_tolower[((unsigned char)(((unsigned char) cptr[i]) & 0xff))]);
    }
}


const char _Py_upper__doc__[] = "B.upper() -> copy of B\n\nReturn a copy of B with all ASCII characters converted to uppercase.";
...
_Py_bytes_upper(char *result, const char *cptr, Py_ssize_t len)
{
    ...
    for (i = 0; i < len; i++) {
        result[i] = (_Py_ctype_toupper[((unsigned char)(((unsigned char) cptr[i]) & 0xff))]);
    }
}


const char _Py_title__doc__[] = "B.title() -> copy of B\n\nReturn a titlecased version of B, i.e. ASCII words start with uppercase\ncharacters, all remaining cased characters have lowercase.";
...
_Py_bytes_title(char *result, char *s, Py_ssize_t len)
{
    ...
    for (i = 0; i < len; i++) {
        int c = ((unsigned char)((*s++) & 0xff));
        if ((_Py_ctype_table[((unsigned char)((c) & 0xff))] & 0x01)) {
            if (!previous_is_cased)
                c = (_Py_ctype_toupper[((unsigned char)((c) & 0xff))]);
            previous_is_cased = 1;
        } else if ((_Py_ctype_table[((unsigned char)((c) & 0xff))] & 0x02)) {
            if (previous_is_cased)
...
const char _Py_capitalize__doc__[] = "B.capitalize() -> copy of B\n\nReturn a copy of B with only its first character capitalized (ASCII)\nand the rest lower-cased.";
...
_Py_bytes_capitalize(char *result, char *s, Py_ssize_t len)
{
    ...
    if (0 < len) {
        int c = ((unsigned char)((*s++) & 0xff));
        if ((_Py_ctype_table[((unsigned char)((c) & 0xff))] & 0x01))
            *result = (_Py_ctype_toupper[((unsigned char)((c) & 0xff))]);
        else
            *result = c;
        result++;
    }
    for (i = 1; i < len; i++) {
        ...
        if ((_Py_ctype_table[((unsigned char)((c) & 0xff))] & 0x02))
            *result = (_Py_ctype_tolower[((unsigned char)((c) & 0xff))]);
        else
            *result = c;
        result++;
    }
...
const char _Py_swapcase__doc__[] = "B.swapcase() -> copy of B\n\nReturn a copy of B with uppercase ASCII characters converted\nto lowercase ASCII and vice versa.";
...
const char _Py_maketrans__doc__[] = "B.maketrans(frm, to) -> translation table\n\nReturn a translation table (a bytes object of length 256) suitable\nfor use in the bytes or bytearray translate method where each byte\nin frm is mapped to the byte at the same position in to.\nThe bytes objects frm and to must be of the same length.";
...
_Py_bytes_maketrans(PyObject *args)
{
    ...
    res = PyBytes_FromStringAndSize(((void *)0), 256);
    if (!res) {
        goto done;
    }
    p = ((__builtin_expect(!(((((((PyObject*)(res))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "bytes_methods.c", 410, "PyBytes_Check(res)") : (void)0), (((PyBytesObject *)(res))->ob_sval));
    for (i = 0; i < 256; i++)
        p[i] = (char) i;
