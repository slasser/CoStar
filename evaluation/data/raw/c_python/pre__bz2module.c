...
grow_buffer(PyObject **buf)
{
    ...
    size_t size = ((__builtin_expect(!(((((((PyObject*)(*buf))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_bz2module.c", 125, "PyBytes_Check(*buf)") : (void)0),(((PyVarObject*)(*buf))->ob_size));
...
compress(BZ2Compressor *c, char *data, size_t len, int action)
{
    ...
    c->bzs.next_in = data;
    c->bzs.avail_in = 0;
    c->bzs.next_out = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_bz2module.c", 151, "PyBytes_Check(result)") : (void)0), (((PyBytesObject *)(result))->ob_sval));
    c->bzs.avail_out = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_bz2module.c", 152, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size));
    for (;;) {
        char *this_out;
        int bzerror;
        ...
        if (c->bzs.avail_in == 0 && len > 0) {
            c->bzs.avail_in = (((len) < ((2147483647 * 2U + 1U))) ? (len) : ((2147483647 * 2U + 1U)));
            len -= c->bzs.avail_in;
        }


        if (action == 0 && c->bzs.avail_in == 0)
            break;

        if (c->bzs.avail_out == 0) {
            size_t buffer_left = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_bz2module.c", 169, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size)) - data_size;
            if (buffer_left == 0) {
                if (grow_buffer(&result) < 0)
                    goto error;
                c->bzs.next_out = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_bz2module.c", 173, "PyBytes_Check(result)") : (void)0), (((PyBytesObject *)(result))->ob_sval)) + data_size;
                buffer_left = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_bz2module.c", 174, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size)) - data_size;
            }
            c->bzs.avail_out = (((buffer_left) < ((2147483647 * 2U + 1U))) ? (buffer_left) : ((2147483647 * 2U + 1U)));
        }
        ...
        if (action == 2 && bzerror == 4)
            break;
    }
    if (data_size != ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_bz2module.c", 191, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size)))
...
static char BZ2Compressor_compress__doc__[] = "compress(data) -> bytes\n" "\n" "Provide data to the compressor object. Returns a chunk of\n" "compressed data if possible, or b'' otherwise.\n" "\n" "When you have finished providing data to the compressor, call the\n" "flush() method to finish the compression process.\n";
# 210 "_bz2module.c"
static PyObject *
BZ2Compressor_compress(BZ2Compressor *self, PyObject *args)
{
    ...
    if (self->flushed)
        ...
        result = compress(self, buffer.buf, buffer.len, 0);
    PyThread_release_lock((self)->lock);
    PyBuffer_Release(&buffer);
    return result;
}

static char BZ2Compressor_flush__doc__[] = "flush() -> bytes\n" "\n" "Finish the compression process. Returns the compressed data left\n" "in internal buffers.\n" "\n" "The compressor object may not be used after this method is called.\n";
...
BZ2Compressor_flush(BZ2Compressor *self, PyObject *noargs)
{
    ...
    if (self->flushed)
        ...
        self->flushed = 1;
        result = compress(self, ((void *)0), 0, 2);
    }
    PyThread_release_lock((self)->lock);
    return result;
}
...
BZ2Compressor_init(BZ2Compressor *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "|i:BZ2Compressor", &compresslevel))
        return -1;
...
static PyMethodDef BZ2Compressor_methods[] = {
    {"compress", (PyCFunction)BZ2Compressor_compress, 0x0001,
     BZ2Compressor_compress__doc__},
    {"flush", (PyCFunction)BZ2Compressor_flush, 0x0004,
     BZ2Compressor_flush__doc__},
    {((void *)0)}
};

static char BZ2Compressor__doc__[] = "BZ2Compressor(compresslevel=9)\n" "\n" "Create a compressor object for compressing data incrementally.\n" "\n" "compresslevel, if given, must be a number between 1 and 9.\n" "\n" "For one-shot compression, use the compress() function instead.\n";
# 317 "_bz2module.c"
static PyTypeObject BZ2Compressor_Type = {
    ...
    0,
    (destructor)BZ2Compressor_dealloc,
    0,
    0,
    0,
    0,
...
decompress(BZ2Decompressor *d, char *data, size_t len)
{
    ...
    d->bzs.avail_in = (((len) < ((2147483647 * 2U + 1U))) ? (len) : ((2147483647 * 2U + 1U)));
    len -= d->bzs.avail_in;
    d->bzs.next_out = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_bz2module.c", 375, "PyBytes_Check(result)") : (void)0), (((PyBytesObject *)(result))->ob_sval));
    d->bzs.avail_out = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_bz2module.c", 376, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size));
    for (;;) {
        char *this_out;
        int bzerror;
        ...
        if (d->bzs.avail_out == 0) {
            size_t buffer_left = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_bz2module.c", 406, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size)) - data_size;
            if (buffer_left == 0) {
                if (grow_buffer(&result) < 0)
                    goto error;
                d->bzs.next_out = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_bz2module.c", 410, "PyBytes_Check(result)") : (void)0), (((PyBytesObject *)(result))->ob_sval)) + data_size;
                buffer_left = ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_bz2module.c", 411, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size)) - data_size;
            }
            d->bzs.avail_out = (((buffer_left) < ((2147483647 * 2U + 1U))) ? (buffer_left) : ((2147483647 * 2U + 1U)));
        }
    }
    if (data_size != ((__builtin_expect(!(((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "_bz2module.c", 416, "PyBytes_Check(result)") : (void)0),(((PyVarObject*)(result))->ob_size)))
        if (_PyBytes_Resize(&result, data_size) < 0)
            goto error;
    return result;
...
static char BZ2Decompressor_decompress__doc__[] = "decompress(data) -> bytes\n" "\n" "Provide data to the decompressor object. Returns a chunk of\n" "decompressed data if possible, or b'' otherwise.\n" "\n" "Attempting to decompress data after the end of stream is reached\n" "raises an EOFError. Any data found after the end of the stream\n" "is ignored and saved in the unused_data attribute.\n";
# 436 "_bz2module.c"
static PyObject *
...
BZ2Decompressor_init(BZ2Decompressor *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, ":BZ2Decompressor"))
        return -1;
...
static PyMethodDef BZ2Decompressor_methods[] = {
    {"decompress", (PyCFunction)BZ2Decompressor_decompress, 0x0001,
     BZ2Decompressor_decompress__doc__},
    {((void *)0)}
};

static char BZ2Decompressor_eof__doc__[] = "True if the end-of-stream marker has been reached.";


static char BZ2Decompressor_unused_data__doc__[] = "Data found after the end of the compressed stream.";


static PyMemberDef BZ2Decompressor_members[] = {
    {"eof", 14, __builtin_offsetof (BZ2Decompressor, eof),
     1, BZ2Decompressor_eof__doc__},
    {"unused_data", 16, __builtin_offsetof (BZ2Decompressor, unused_data),
     1, BZ2Decompressor_unused_data__doc__},
    {((void *)0)}
};

static char BZ2Decompressor__doc__[] = "BZ2Decompressor()\n" "\n" "Create a decompressor object for decompressing data incrementally.\n" "\n" "For one-shot decompression, use the decompress() function instead.\n";
...
static PyTypeObject BZ2Decompressor_Type = {
    ...
    0,
    (destructor)BZ2Decompressor_dealloc,
    0,
    0,
    0,
    0,
...
PyInit__bz2(void)
{
    ...
    m = PyModule_Create2(&_bz2module, 1013);
    if (m == ((void *)0))
        return ((void *)0);

    ( ((PyObject*)(&BZ2Compressor_Type))->ob_refcnt++);
    PyModule_AddObject(m, "BZ2Compressor", (PyObject *)&BZ2Compressor_Type);

    ( ((PyObject*)(&BZ2Decompressor_Type))->ob_refcnt++);
