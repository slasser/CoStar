...
init_weakref(PyWeakReference *self, PyObject *ob, PyObject *callback)
{
    self->hash = -1;
    self->wr_object = ob;
    do { if ((callback) == ((void *)0)) ; else ( ((PyObject*)(callback))->ob_refcnt++); } while (0);
...
new_weakref(PyObject *ob, PyObject *callback)
{
    ...
    result = ( (PyWeakReference *) _PyObject_GC_New(&_PyWeakref_RefType) );
    if (result) {
...
clear_weakref(PyWeakReference *self)
{
    ...
    if (self->wr_object != (&_Py_NoneStruct)) {
        PyWeakReference **list = ((PyWeakReference **) ((PyObject **) (((char *) (self->wr_object)) + (((PyObject*)(self->wr_object))->ob_type)->tp_weaklistoffset)));
        ...
        if (*list == self)
            ...
            *list = self->wr_next;
        self->wr_object = (&_Py_NoneStruct);
        if (self->wr_prev != ((void *)0))
            self->wr_prev->wr_next = self->wr_next;
        if (self->wr_next != ((void *)0))
            self->wr_next->wr_prev = self->wr_prev;
        self->wr_prev = ((void *)0);
        self->wr_next = ((void *)0);
    }
    if (callback != ((void *)0)) {
        do { if ( --((PyObject*)(callback))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(callback)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(callback)))); } while (0);
        self->wr_callback = ((void *)0);
    }
}
# 88 "weakrefobject.c"
void
_PyWeakref_ClearRef(PyWeakReference *self)
{
    ...
    (__builtin_expect(!(self != ((void *)0)), 0) ? __assert_rtn(__func__, "weakrefobject.c", 93, "self != NULL") : (void)0);
    (__builtin_expect(!((((((PyObject*)(self))->ob_type) == (&_PyWeakref_RefType) || PyType_IsSubtype((((PyObject*)(self))->ob_type), (&_PyWeakref_RefType))) || (((((PyObject*)(self))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(self))->ob_type) == &_PyWeakref_CallableProxyType)))), 0) ? __assert_rtn(__func__, "weakrefobject.c", 94, "PyWeakref_Check(self)") : (void)0);
...
{
    do { if (self->wr_callback) { int vret = visit((PyObject *)(self->wr_callback), arg); if (vret) return vret; } } while (0);
    return 0;
}
...
weakref_call(PyWeakReference *self, PyObject *args, PyObject *kw)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kw, ":__call__", kwlist)) {
        PyObject *object = ((((PyObject*)(((PyWeakReference *)(self))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(self))->wr_object : (&_Py_NoneStruct));
...
weakref_hash(PyWeakReference *self)
{
    if (self->hash != -1)
        return self->hash;
    if (((((PyObject*)(((PyWeakReference *)(self))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(self))->wr_object : (&_Py_NoneStruct)) == (&_Py_NoneStruct)) {
        PyErr_SetString(PyExc_TypeError, "weak object has gone away");
        return -1;
    }
    self->hash = PyObject_Hash(((((PyObject*)(((PyWeakReference *)(self))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(self))->wr_object : (&_Py_NoneStruct)));
    return self->hash;
}
...
weakref_repr(PyWeakReference *self)
{
    ...
    name = _PyObject_GetAttrId(((((PyObject*)(((PyWeakReference *)(self))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(self))->wr_object : (&_Py_NoneStruct)), &PyId___name__);
    if (name == ((void *)0) || !((((((PyObject*)(name))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        if (name == ((void *)0))
            PyErr_Clear();
        repr = PyUnicode_FromFormat(
            "<weakref at %p; to '%s' at %p>",
            self,
            (((PyObject*)(((((PyObject*)(((PyWeakReference *)(self))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(self))->wr_object : (&_Py_NoneStruct))))->ob_type)->tp_name,
            ((((PyObject*)(((PyWeakReference *)(self))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(self))->wr_object : (&_Py_NoneStruct)));
    }
    else {
        repr = PyUnicode_FromFormat(
...
weakref_richcompare(PyWeakReference* self, PyWeakReference* other, int op)
{
    if ((op != 2 && op != 3) ||
        ...
        !(((((PyObject*)(other))->ob_type) == (&_PyWeakref_RefType) || PyType_IsSubtype((((PyObject*)(other))->ob_type), (&_PyWeakref_RefType))) || (((((PyObject*)(other))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(other))->ob_type) == &_PyWeakref_CallableProxyType)))) {
        return ( ((PyObject*)((&_Py_NotImplementedStruct)))->ob_refcnt++), (&_Py_NotImplementedStruct);
    }
    if (((((PyObject*)(((PyWeakReference *)(self))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(self))->wr_object : (&_Py_NoneStruct)) == (&_Py_NoneStruct)
        || ((((PyObject*)(((PyWeakReference *)(other))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(other))->wr_object : (&_Py_NoneStruct)) == (&_Py_NoneStruct)) {
        int res = (self == other);
        if (op == 3)
            res = !res;
        if (res)
    ...
    return PyObject_RichCompare(((((PyObject*)(((PyWeakReference *)(self))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(self))->wr_object : (&_Py_NoneStruct)),
                                ((((PyObject*)(((PyWeakReference *)(other))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(other))->wr_object : (&_Py_NoneStruct)), op);
}
               ...
               PyWeakReference **refp, PyWeakReference **proxyp)
{
    ...
    *proxyp = ((void *)0);
    ...
    if (head != ((void *)0) && head->wr_callback == ((void *)0)) {



        if (((((PyObject*)(head))->ob_type) == &_PyWeakref_RefType)) {
            *refp = head;
            head = head->wr_next;
        }
        if (head != ((void *)0)
            && head->wr_callback == ((void *)0)
            && (((((PyObject*)(head))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(head))->ob_type) == &_PyWeakref_CallableProxyType))) {
            *proxyp = head;
...
{
    PyWeakReference *self = ((void *)0);
    PyObject *ob, *callback = ((void *)0);

    if (parse_weakref_init_args("__new__", args, kwargs, &ob, &callback)) {
        PyWeakReference *ref, *proxy;
        PyWeakReference **list;

        if (!(((((PyObject*)(ob))->ob_type))->tp_weaklistoffset > 0)) {
            PyErr_Format(PyExc_TypeError,
                         "cannot create weak reference to '%s' object",
                         (((PyObject*)(ob))->ob_type)->tp_name);
            return ((void *)0);
        }
        if (callback == (&_Py_NoneStruct))
            callback = ((void *)0);
        list = ((PyWeakReference **) ((PyObject **) (((char *) (ob)) + (((PyObject*)(ob))->ob_type)->tp_weaklistoffset)));
        get_basic_refs(*list, &ref, &proxy);
        if (callback == ((void *)0) && type == &_PyWeakref_RefType) {
            if (ref != ((void *)0)) {
...
{
    if (((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)) == (&_Py_NoneStruct)) {
...
# 455 "weakrefobject.c"
static PyObject * proxy_getattr(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyObject_GetAttr(x, y); }
static PyObject * proxy_str(PyObject *proxy) { if ((((((PyObject*)(proxy))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(proxy))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)proxy)) return ((void *)0); proxy = ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)); }; return PyObject_Str(proxy); }
static PyObject * proxy_call(PyObject *proxy, PyObject *v, PyObject *w) { if ((((((PyObject*)(proxy))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(proxy))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)proxy)) return ((void *)0); proxy = ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(v))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(v))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)v)) return ((void *)0); v = ((((PyObject*)(((PyWeakReference *)(v))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(v))->wr_object : (&_Py_NoneStruct)); }; if (w != ((void *)0)) if ((((((PyObject*)(w))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(w))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)w)) return ((void *)0); w = ((((PyObject*)(((PyWeakReference *)(w))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(w))->wr_object : (&_Py_NoneStruct)); }; return PyEval_CallObjectWithKeywords(proxy, v, w); }
...
proxy_repr(PyWeakReference *proxy)
{
    return PyUnicode_FromFormat(
        ...
        proxy,
        (((PyObject*)(((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct))))->ob_type)->tp_name,
        ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)));
}
...
proxy_setattr(PyWeakReference *proxy, PyObject *name, PyObject *value)
{
    if (!proxy_checkref(proxy))
        return -1;
    return PyObject_SetAttr(((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)), name, value);
}

static PyObject *
proxy_richcompare(PyObject *proxy, PyObject *v, int op)
{
    if ((((((PyObject*)(proxy))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(proxy))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)proxy)) return ((void *)0); proxy = ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)); };
    if ((((((PyObject*)(v))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(v))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)v)) return ((void *)0); v = ((((PyObject*)(((PyWeakReference *)(v))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(v))->wr_object : (&_Py_NoneStruct)); };
    return PyObject_RichCompare(proxy, v, op);
}


static PyObject * proxy_add(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Add(x, y); }
static PyObject * proxy_sub(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Subtract(x, y); }
static PyObject * proxy_mul(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Multiply(x, y); }
static PyObject * proxy_floor_div(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_FloorDivide(x, y); }
static PyObject * proxy_true_div(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_TrueDivide(x, y); }
static PyObject * proxy_mod(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Remainder(x, y); }
static PyObject * proxy_divmod(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Divmod(x, y); }
static PyObject * proxy_pow(PyObject *proxy, PyObject *v, PyObject *w) { if ((((((PyObject*)(proxy))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(proxy))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)proxy)) return ((void *)0); proxy = ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(v))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(v))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)v)) return ((void *)0); v = ((((PyObject*)(((PyWeakReference *)(v))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(v))->wr_object : (&_Py_NoneStruct)); }; if (w != ((void *)0)) if ((((((PyObject*)(w))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(w))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)w)) return ((void *)0); w = ((((PyObject*)(((PyWeakReference *)(w))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(w))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Power(proxy, v, w); }
static PyObject * proxy_neg(PyObject *proxy) { if ((((((PyObject*)(proxy))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(proxy))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)proxy)) return ((void *)0); proxy = ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Negative(proxy); }
static PyObject * proxy_pos(PyObject *proxy) { if ((((((PyObject*)(proxy))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(proxy))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)proxy)) return ((void *)0); proxy = ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Positive(proxy); }
static PyObject * proxy_abs(PyObject *proxy) { if ((((((PyObject*)(proxy))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(proxy))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)proxy)) return ((void *)0); proxy = ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Absolute(proxy); }
static PyObject * proxy_invert(PyObject *proxy) { if ((((((PyObject*)(proxy))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(proxy))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)proxy)) return ((void *)0); proxy = ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Invert(proxy); }
static PyObject * proxy_lshift(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Lshift(x, y); }
static PyObject * proxy_rshift(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Rshift(x, y); }
static PyObject * proxy_and(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_And(x, y); }
static PyObject * proxy_xor(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Xor(x, y); }
static PyObject * proxy_or(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Or(x, y); }
static PyObject * proxy_int(PyObject *proxy) { if ((((((PyObject*)(proxy))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(proxy))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)proxy)) return ((void *)0); proxy = ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Long(proxy); }
static PyObject * proxy_float(PyObject *proxy) { if ((((((PyObject*)(proxy))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(proxy))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)proxy)) return ((void *)0); proxy = ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Float(proxy); }
static PyObject * proxy_iadd(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_InPlaceAdd(x, y); }
static PyObject * proxy_isub(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_InPlaceSubtract(x, y); }
static PyObject * proxy_imul(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_InPlaceMultiply(x, y); }
static PyObject * proxy_ifloor_div(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_InPlaceFloorDivide(x, y); }
static PyObject * proxy_itrue_div(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_InPlaceTrueDivide(x, y); }
static PyObject * proxy_imod(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_InPlaceRemainder(x, y); }
static PyObject * proxy_ipow(PyObject *proxy, PyObject *v, PyObject *w) { if ((((((PyObject*)(proxy))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(proxy))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)proxy)) return ((void *)0); proxy = ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(v))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(v))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)v)) return ((void *)0); v = ((((PyObject*)(((PyWeakReference *)(v))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(v))->wr_object : (&_Py_NoneStruct)); }; if (w != ((void *)0)) if ((((((PyObject*)(w))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(w))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)w)) return ((void *)0); w = ((((PyObject*)(((PyWeakReference *)(w))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(w))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_InPlacePower(proxy, v, w); }
static PyObject * proxy_ilshift(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_InPlaceLshift(x, y); }
static PyObject * proxy_irshift(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_InPlaceRshift(x, y); }
static PyObject * proxy_iand(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_InPlaceAnd(x, y); }
static PyObject * proxy_ixor(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_InPlaceXor(x, y); }
static PyObject * proxy_ior(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_InPlaceOr(x, y); }
static PyObject * proxy_index(PyObject *proxy) { if ((((((PyObject*)(proxy))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(proxy))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)proxy)) return ((void *)0); proxy = ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)); }; return PyNumber_Index(proxy); }

static int
proxy_bool(PyWeakReference *proxy)
{
    PyObject *o = ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct));
    if (!proxy_checkref(proxy))
        return -1;
...
proxy_contains(PyWeakReference *proxy, PyObject *value)
{
    if (!proxy_checkref(proxy))
        return -1;
    return PySequence_Contains(((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)), value);
}
...
proxy_length(PyWeakReference *proxy)
{
    if (!proxy_checkref(proxy))
        return -1;
    return PyObject_Size(((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)));
}

static PyObject * proxy_getitem(PyObject *x, PyObject *y) { if ((((((PyObject*)(x))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(x))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)x)) return ((void *)0); x = ((((PyObject*)(((PyWeakReference *)(x))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(x))->wr_object : (&_Py_NoneStruct)); }; if ((((((PyObject*)(y))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(y))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)y)) return ((void *)0); y = ((((PyObject*)(((PyWeakReference *)(y))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(y))->wr_object : (&_Py_NoneStruct)); }; return PyObject_GetItem(x, y); }
...
proxy_setitem(PyWeakReference *proxy, PyObject *key, PyObject *value)
{
    ...
    if (value == ((void *)0))
        return PyObject_DelItem(((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)), key);
    else
        return PyObject_SetItem(((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)), key, value);
}
...
proxy_iter(PyWeakReference *proxy)
{
    if (!proxy_checkref(proxy))
        return ((void *)0);
    return PyObject_GetIter(((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)));
}
...
proxy_iternext(PyWeakReference *proxy)
{
    if (!proxy_checkref(proxy))
        return ((void *)0);
    return PyIter_Next(((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)));
}


static PyObject * proxy_bytes(PyObject *proxy) { static _Py_Identifier PyId___bytes__ = { 0, "__bytes__", 0 }; if ((((((PyObject*)(proxy))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(proxy))->ob_type) == &_PyWeakref_CallableProxyType))) { if (!proxy_checkref((PyWeakReference *)proxy)) return ((void *)0); proxy = ((((PyObject*)(((PyWeakReference *)(proxy))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(proxy))->wr_object : (&_Py_NoneStruct)); }; return _PyObject_CallMethodId(proxy, &PyId___bytes__, ""); }


static PyMethodDef proxy_methods[] = {
        {"__bytes__", (PyCFunction)proxy_bytes, 0x0004},
        {((void *)0), ((void *)0)}
};
    ...
    if (result != ((void *)0))
        ...
        if (result != ((void *)0)) {
            ...
            if (PyCallable_Check(ob))
                (((PyObject*)(result))->ob_type) = &_PyWeakref_CallableProxyType;
            else
                (((PyObject*)(result))->ob_type) = &_PyWeakref_ProxyType;
            get_basic_refs(*list, &ref, &proxy);
            if (callback == ((void *)0)) {
                if (proxy != ((void *)0)) {
                    ...
                    do { if ( --((PyObject*)(result))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(result)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(result)))); } while (0);
                    ( ((PyObject*)(result = proxy))->ob_refcnt++);
                    goto skip_insert;
                }
                prev = ref;
            }
...
{
    if (ref == ((void *)0) || !(((((PyObject*)(ref))->ob_type) == (&_PyWeakref_RefType) || PyType_IsSubtype((((PyObject*)(ref))->ob_type), (&_PyWeakref_RefType))) || (((((PyObject*)(ref))->ob_type) == &_PyWeakref_ProxyType) || ((((PyObject*)(ref))->ob_type) == &_PyWeakref_CallableProxyType)))) {
        _PyErr_BadInternalCall("weakrefobject.c", 851);
        return ((void *)0);
    }
    return ((((PyObject*)(((PyWeakReference *)(ref))->wr_object))->ob_refcnt) > 0 ? ((PyWeakReference *)(ref))->wr_object : (&_Py_NoneStruct));
}
...
{
    PyObject *cbresult = PyObject_CallFunctionObjArgs(callback, ref, ((void *)0));

    if (cbresult == ((void *)0))
        PyErr_WriteUnraisable(callback);
    else
        do { if ( --((PyObject*)(cbresult))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(cbresult)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(cbresult)))); } while (0);
}
...
PyObject_ClearWeakRefs(PyObject *object)
{
    ...
    if (object == ((void *)0)
        || !(((((PyObject*)(object))->ob_type))->tp_weaklistoffset > 0)
        || object->ob_refcnt != 0) {
        _PyErr_BadInternalCall("weakrefobject.c", 885);
        return;
    }
    list = ((PyWeakReference **) ((PyObject **) (((char *) (object)) + (((PyObject*)(object))->ob_type)->tp_weaklistoffset)));

    if (*list != ((void *)0) && (*list)->wr_callback == ((void *)0)) {
        clear_weakref(*list);
        if (*list != ((void *)0) && (*list)->wr_callback == ((void *)0))
            clear_weakref(*list);
    }
    if (*list != ((void *)0)) {
        ...
        if (count == 1) {
            ...
            for (i = 0; i < count; ++i) {
                ...
                if (((PyObject *)current)->ob_refcnt > 0)
                {
                    ( ((PyObject*)(current))->ob_refcnt++);
                    (((PyTupleObject *)(tuple))->ob_item[i * 2] = (PyObject *) current);
                    (((PyTupleObject *)(tuple))->ob_item[i * 2 + 1] = current->wr_callback);
                }
                else {
                    do { if ( --((PyObject*)(current->wr_callback))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(current->wr_callback)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(current->wr_callback)))); } while (0);
                }
                current->wr_callback = ((void *)0);
                clear_weakref(current);
                current = next;
            ...
            for (i = 0; i < count; ++i) {
                PyObject *callback = (((PyTupleObject *)(tuple))->ob_item[i * 2 + 1]);


                if (callback != ((void *)0)) {
                    PyObject *item = (((PyTupleObject *)(tuple))->ob_item[i * 2]);
