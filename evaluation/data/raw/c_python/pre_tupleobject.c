...
# 6 "tupleobject.c" 2
# 19 "tupleobject.c"
static PyTupleObject *free_list[20];
static int numfree[20];
# 49 "tupleobject.c"
void
_PyTuple_DebugMallocStats(FILE *out)
{
    ...
    for (i = 1; i < 20; i++) {
        ...
        _PyDebugAllocatorStats(out,
                               buf,
                               numfree[i], (((size_t)((&PyTuple_Type)->tp_basicsize + (i)*(&PyTuple_Type)->tp_itemsize) + (size_t)((8) - 1)) & ~(size_t)((8) - 1)));
    }
...
PyTuple_New(register Py_ssize_t size)
{
    ...
    Py_ssize_t i;
    if (size < 0) {
        _PyErr_BadInternalCall("tupleobject.c", 71);
        return ((void *)0);
    }
    ...
    if (size < 20 && (op = free_list[size]) != ((void *)0)) {
...
# 94 "tupleobject.c"
...

    {
        ...
        if (size > (((Py_ssize_t)(((size_t)-1)>>1)) - sizeof(PyTupleObject) -
                    sizeof(PyObject *)) / sizeof(PyObject *)) {
            return PyErr_NoMemory();
        }
        op = ( (PyTupleObject *) _PyObject_GC_NewVar((&PyTuple_Type), (size)) );
        if (op == ((void *)0))
            return ((void *)0);
    }
    for (i=0; i < size; i++)
...
PyTuple_Size(register PyObject *op)
{
    if (!((((((PyObject*)(op))->ob_type))->tp_flags & ((1L<<26))) != 0)) {
        _PyErr_BadInternalCall("tupleobject.c", 128);
        return -1;
    }
    else
...
{
    if (!((((((PyObject*)(op))->ob_type))->tp_flags & ((1L<<26))) != 0)) {
        _PyErr_BadInternalCall("tupleobject.c", 139);
        return ((void *)0);
    }
...
PyTuple_SetItem(register PyObject *op, register Py_ssize_t i, PyObject *newitem)
{
    ...
    register PyObject **p;
    if (!((((((PyObject*)(op))->ob_type))->tp_flags & ((1L<<26))) != 0) || op->ob_refcnt != 1) {
        ...
        _PyErr_BadInternalCall("tupleobject.c", 156);
        return -1;
    }
    if (i < 0 || i >= (((PyVarObject*)(op))->ob_size)) {
        do { if ((newitem) == ((void *)0)) ; else do { if ( --((PyObject*)(newitem))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(newitem)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(newitem)))); } while (0); } while (0);
...
_PyTuple_MaybeUntrack(PyObject *op)
{
    ...
    if (!((((PyObject*)(op))->ob_type) == &PyTuple_Type) || !((((PyGC_Head *)(op)-1))->gc.gc_refs != (-2)))
        return;
    t = (PyTupleObject *) op;
    n = (((PyVarObject*)(t))->ob_size);
    for (i = 0; i < n; i++) {
        PyObject *elt = (((PyTupleObject *)(t))->ob_item[i]);



        if (!elt ||
            (((((((((PyObject*)(elt))->ob_type)))->tp_flags & ((1L<<14))) != 0) && ((((PyObject*)(elt))->ob_type)->tp_is_gc == ((void *)0) || (((PyObject*)(elt))->ob_type)->tp_is_gc(elt))) && (!((((PyObject*)(elt))->ob_type) == &PyTuple_Type) || ((((PyGC_Head *)(elt)-1))->gc.gc_refs != (-2)))))
            return;
    }
    ...
    do { PyGC_Head *g = ((PyGC_Head *)(op)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "tupleobject.c", 195, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
}
...
tupledealloc(register PyTupleObject *op)
{
    ...
    register Py_ssize_t len = (((PyVarObject*)(op))->ob_size);
    ...
    if (len > 0) {
        ...
        if (len < 20 &&
            numfree[len] < 2000 &&
            (((PyObject*)(op))->ob_type) == &PyTuple_Type)
        {
...
tuplehash(PyTupleObject *v)
{
    ...
    register Py_ssize_t len = (((PyVarObject*)(v))->ob_size);
    register PyObject **p;
    Py_uhash_t mult = 1000003UL;
    x = 0x345678UL;
    p = v->ob_item;
    while (--len >= 0) {
        y = PyObject_Hash(*p++);
...
tuplecontains(PyTupleObject *a, PyObject *el)
{
    ...
    for (i = 0, cmp = 0 ; cmp == 0 && i < (((PyVarObject*)(a))->ob_size); ++i)
        cmp = PyObject_RichCompareBool(el, (((PyTupleObject *)(a))->ob_item[i]),
                                           2);
    return cmp;
}
           ...
           register Py_ssize_t ihigh)
{
    ...
    if (ilow < 0)
        ilow = 0;
    if (ihigh > (((PyVarObject*)(a))->ob_size))
        ihigh = (((PyVarObject*)(a))->ob_size);
    if (ihigh < ilow)
        ihigh = ilow;
    if (ilow == 0 && ihigh == (((PyVarObject*)(a))->ob_size) && ((((PyObject*)(a))->ob_type) == &PyTuple_Type)) {
...
{
    if (op == ((void *)0) || !((((((PyObject*)(op))->ob_type))->tp_flags & ((1L<<26))) != 0)) {
        _PyErr_BadInternalCall("tupleobject.c", 416);
        return ((void *)0);
    }
...
tupleconcat(register PyTupleObject *a, register PyObject *bb)
{
    ...
    PyObject **src, **dest;
    PyTupleObject *np;
    if (!((((((PyObject*)(bb))->ob_type))->tp_flags & ((1L<<26))) != 0)) {
    ...
    size = (((PyVarObject*)(a))->ob_size) + (((PyVarObject*)(((PyTupleObject *)bb)))->ob_size);
    if (size < 0)
        return PyErr_NoMemory();
    ...
    src = ((PyTupleObject *)bb)->ob_item;
    dest = np->ob_item + (((PyVarObject*)(a))->ob_size);
    for (i = 0; i < (((PyVarObject*)(((PyTupleObject *)bb)))->ob_size); i++) {
        PyObject *v = src[i];
        ( ((PyObject*)(v))->ob_refcnt++);
        dest[i] = v;
    }
...
tuplerepeat(PyTupleObject *a, Py_ssize_t n)
{
    ...
    if (n < 0)
        n = 0;
    if ((((PyVarObject*)(a))->ob_size) == 0 || n == 1) {
        if (((((PyObject*)(a))->ob_type) == &PyTuple_Type)) {
    ...
    if (n > ((Py_ssize_t)(((size_t)-1)>>1)) / (((PyVarObject*)(a))->ob_size))
        return PyErr_NoMemory();
...
tuplerichcompare(PyObject *v, PyObject *w, int op)
{
    ...
    if (!((((((PyObject*)(v))->ob_type))->tp_flags & ((1L<<26))) != 0) || !((((((PyObject*)(w))->ob_type))->tp_flags & ((1L<<26))) != 0))
        return ( ((PyObject*)((&_Py_NotImplementedStruct)))->ob_refcnt++), (&_Py_NotImplementedStruct);

    vt = (PyTupleObject *)v;
    wt = (PyTupleObject *)w;

    vlen = (((PyVarObject*)(vt))->ob_size);
    wlen = (((PyVarObject*)(wt))->ob_size);
# 582 "tupleobject.c"
    ...
    if (i >= vlen || i >= wlen) {
        ...
        PyObject *res;
        switch (op) {
        case 0: cmp = vlen < wlen; break;
        case 1: cmp = vlen <= wlen; break;
        case 2: cmp = vlen == wlen; break;
        case 3: cmp = vlen != wlen; break;
        case 4: cmp = vlen > wlen; break;
        case 5: cmp = vlen >= wlen; break;
...
tuple_subtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    (__builtin_expect(!(PyType_IsSubtype(type, &PyTuple_Type)), 0) ? __assert_rtn(__func__, "tupleobject.c", 652, "PyType_IsSubtype(type, &PyTuple_Type)") : (void)0);
    tmp = tuple_new(&PyTuple_Type, args, kwds);
    if (tmp == ((void *)0))
        return ((void *)0);
    (__builtin_expect(!(((((((PyObject*)(tmp))->ob_type))->tp_flags & ((1L<<26))) != 0)), 0) ? __assert_rtn(__func__, "tupleobject.c", 656, "PyTuple_Check(tmp)") : (void)0);
    newobj = type->tp_alloc(type, n = (((PyVarObject*)(tmp))->ob_size));
    if (newobj == ((void *)0))
        return ((void *)0);
    for (i = 0; i < n; i++) {
        item = (((PyTupleObject *)(tmp))->ob_item[i]);
        ( ((PyObject*)(item))->ob_refcnt++);
        (((PyTupleObject *)(newobj))->ob_item[i] = item);
    }
    do { if ( --((PyObject*)(tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(tmp)))); } while (0);
    return newobj;
}

static char tuple_doc[] = "tuple() -> empty tuple\ntuple(iterable) -> tuple initialized from iterable's items\n\nIf the argument is a tuple, the return value is the same object.";
    ...
    if (((item)->ob_type->tp_as_number != ((void *)0) && (item)->ob_type->tp_as_number->nb_index != ((void *)0))) {
        ...
        if (slicelength <= 0) {
            return PyTuple_New(0);
                 ...
                 slicelength == (((PyVarObject*)(self))->ob_size) &&
                 ((((PyObject*)(self))->ob_type) == &PyTuple_Type)) {
...
{
    return Py_BuildValue("(N)", tupleslice(v, 0, (((PyVarObject*)(v))->ob_size)));
...
tuple_sizeof(PyTupleObject *self)
{
    ...
    res = PyTuple_Type.tp_basicsize + (((PyVarObject*)(self))->ob_size) * sizeof(PyObject *);
    return PyLong_FromSsize_t(res);
}

static char index_doc[] = "T.index(value, [start, [stop]]) -> integer -- return first index of value.\n" "Raises ValueError if the value is not present.";



static char count_doc[] = "T.count(value) -> integer -- return number of occurrences of value";

static char sizeof_doc[] = "T.__sizeof__() -- size of T in memory, in bytes";


static PyMethodDef tuple_methods[] = {
    {"__getnewargs__", (PyCFunction)tuple_getnewargs, 0x0004},
    {"__sizeof__", (PyCFunction)tuple_sizeof, 0x0004, sizeof_doc},
    {"index", (PyCFunction)tupleindex, 0x0001, index_doc},
    {"count", (PyCFunction)tuplecount, 0x0008, count_doc},
    {((void *)0), ((void *)0)}
};
...
_PyTuple_Resize(PyObject **pv, Py_ssize_t newsize)
{
    ...
    v = (PyTupleObject *) *pv;
    if (v == ((void *)0) || (((PyObject*)(v))->ob_type) != &PyTuple_Type ||
        ((((PyVarObject*)(v))->ob_size) != 0 && (((PyObject*)(v))->ob_refcnt) != 1)) {
        *pv = 0;
        ...
        _PyErr_BadInternalCall("tupleobject.c", 846);
        return -1;
    }
    oldsize = (((PyVarObject*)(v))->ob_size);
    if (oldsize == newsize)
        return 0;
    ...
    if (oldsize == 0) {
        ...
        *pv = PyTuple_New(newsize);
        return *pv == ((void *)0) ? -1 : 0;
    }


    ;
    if (((((PyGC_Head *)(v)-1))->gc.gc_refs != (-2)))
        do { PyGC_Head *g = ((PyGC_Head *)(v)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "tupleobject.c", 865, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
    ;

    for (i = newsize; i < oldsize; i++) {
        do { if ((v->ob_item[i]) == ((void *)0)) ; else do { if ( --((PyObject*)(v->ob_item[i]))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(v->ob_item[i])))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(v->ob_item[i])))); } while (0); } while (0);
        v->ob_item[i] = ((void *)0);
    }
    sv = ( (PyTupleObject *) _PyObject_GC_Resize((PyVarObject *)(v), (newsize)) );
    if (sv == ((void *)0)) {
        *pv = ((void *)0);
        PyObject_GC_Del(v);
        return -1;
    }
    ( (((PyObject*)((PyObject *) sv))->ob_refcnt) = 1);

    if (newsize > oldsize)
        ((__builtin_object_size (&sv->ob_item[oldsize], 0) != (size_t) -1) ? __builtin___memset_chk (&sv->ob_item[oldsize], 0, sizeof(*sv->ob_item) * (newsize - oldsize), __builtin_object_size (&sv->ob_item[oldsize], 0)) : __inline_memset_chk (&sv->ob_item[oldsize], 0, sizeof(*sv->ob_item) * (newsize - oldsize)));

    *pv = (PyObject *) sv;
    do { PyGC_Head *g = ((PyGC_Head *)(sv)-1); if (g->gc.gc_refs != (-2)) Py_FatalError("GC object already tracked"); g->gc.gc_refs = (-3); g->gc.gc_next = _PyGC_generation0; g->gc.gc_prev = _PyGC_generation0->gc.gc_prev; g->gc.gc_prev->gc.gc_next = g; _PyGC_generation0->gc.gc_prev = g; } while (0);;
    return 0;
}
...
PyTuple_Fini(void)
{
    ...
    do { if ((free_list[0]) == ((void *)0)) ; else do { if ( --((PyObject*)(free_list[0]))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(free_list[0])))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(free_list[0])))); } while (0); } while (0);
    free_list[0] = ((void *)0);
...
{
    do { PyGC_Head *g = ((PyGC_Head *)(it)-1); (__builtin_expect(!(g->gc.gc_refs != (-2)), 0) ? __assert_rtn(__func__, "tupleobject.c", 937, "g->gc.gc_refs != _PyGC_REFS_UNTRACKED") : (void)0); g->gc.gc_refs = (-2); g->gc.gc_prev->gc.gc_next = g->gc.gc_next; g->gc.gc_next->gc.gc_prev = g->gc.gc_prev; g->gc.gc_next = ((void *)0); } while (0);;
...
tupleiter_next(tupleiterobject *it)
{
    ...
    (__builtin_expect(!(it != ((void *)0)), 0) ? __assert_rtn(__func__, "tupleobject.c", 955, "it != NULL") : (void)0);
    seq = it->it_seq;
    if (seq == ((void *)0))
        return ((void *)0);
    (__builtin_expect(!(((((((PyObject*)(seq))->ob_type))->tp_flags & ((1L<<26))) != 0)), 0) ? __assert_rtn(__func__, "tupleobject.c", 959, "PyTuple_Check(seq)") : (void)0);

    if (it->it_index < (((PyVarObject*)(seq))->ob_size)) {
        item = (((PyTupleObject *)(seq))->ob_item[it->it_index]);
        ++it->it_index;
        ( ((PyObject*)(item))->ob_refcnt++);
        return item;
    }
...
tupleiter_setstate(tupleiterobject *it, PyObject *state)
{
    ...
    if (it->it_seq != ((void *)0)) {
        if (index < 0)
            index = 0;
        else if (it->it_seq != ((void *)0) && index > (((PyVarObject*)(it->it_seq))->ob_size))
            index = (((PyVarObject*)(it->it_seq))->ob_size);
        it->it_index = index;
    }
...
static PyMethodDef tupleiter_methods[] = {
    {"__length_hint__", (PyCFunction)tupleiter_len, 0x0004, length_hint_doc},
    {"__reduce__", (PyCFunction)tupleiter_reduce, 0x0004, reduce_doc},
    {"__setstate__", (PyCFunction)tupleiter_setstate, 0x0008, setstate_doc},
    {((void *)0), ((void *)0)}
};
...
tuple_iter(PyObject *seq)
{
    ...
    if (!((((((PyObject*)(seq))->ob_type))->tp_flags & ((1L<<26))) != 0)) {
        _PyErr_BadInternalCall("tupleobject.c", 1059);
        return ((void *)0);
    }
    it = ( (tupleiterobject *) _PyObject_GC_New(&PyTupleIter_Type) );
    if (it == ((void *)0))
        return ((void *)0);
    it->it_index = 0;
