...
internal_bisect_right(PyObject *list, PyObject *item, Py_ssize_t lo, Py_ssize_t hi)
{
    ...
    while (lo < hi) {
        ...
        do { if ( --((PyObject*)(litem))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(litem)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(litem)))); } while (0);
        if (res < 0)
            return -1;
        if (res)
            hi = mid;
...
bisect_right(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    Py_ssize_t hi = -1;
    Py_ssize_t index;
    static char *keywords[] = {"a", "x", "lo", "hi", ((void *)0)};

    if (!_PyArg_ParseTupleAndKeywords_SizeT(args, kw, "OO|nn:bisect_right",
...
insort_right(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if (!_PyArg_ParseTupleAndKeywords_SizeT(args, kw, "OO|nn:insort_right",
        keywords, &list, &item, &lo, &hi))
        return ((void *)0);
    index = internal_bisect_right(list, item, lo, hi);
    if (index < 0)
        return ((void *)0);
    if (((((PyObject*)(list))->ob_type) == &PyList_Type)) {
        if (PyList_Insert(list, index, item) < 0)
            return ((void *)0);
    } else {
        static _Py_Identifier PyId_insert = { 0, "insert", 0 };

        result = _PyObject_CallMethodId_SizeT(list, &PyId_insert, "nO", index, item);
        if (result == ((void *)0))
            return ((void *)0);
...
static char insort_right_doc[] = "insort_right(a, x[, lo[, hi]])\n\nInsert item x in list a, and keep it sorted assuming a is sorted.\n\nIf x is already in a, insert it to the right of the rightmost x.\n\nOptional args lo (default 0) and hi (default len(a)) bound the\nslice of a to be searched.\n";
# 114 "_bisectmodule.c"
static Py_ssize_t
internal_bisect_left(PyObject *list, PyObject *item, Py_ssize_t lo, Py_ssize_t hi)
{
    ...
    while (lo < hi) {
        ...
        if (litem == ((void *)0))
            return -1;
        res = PyObject_RichCompareBool(litem, item, 0);
        do { if ( --((PyObject*)(litem))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(litem)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(litem)))); } while (0);
        if (res < 0)
            return -1;
        if (res)
...
bisect_left(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if (!_PyArg_ParseTupleAndKeywords_SizeT(args, kw, "OO|nn:bisect_left",
        keywords, &list, &item, &lo, &hi))
        return ((void *)0);
...
static char bisect_left_doc[] = "bisect_left(a, x[, lo[, hi]]) -> index\n\nReturn the index where to insert item x in list a, assuming a is sorted.\n\nThe return value i is such that all e in a[:i] have e < x, and all e in\na[i:] have e >= x.  So if x already appears in the list, i points just\nbefore the leftmost x already there.\n\nOptional args lo (default 0) and hi (default len(a)) bound the\nslice of a to be searched.\n";
# 179 "_bisectmodule.c"
static PyObject *
insort_left(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if (!_PyArg_ParseTupleAndKeywords_SizeT(args, kw, "OO|nn:insort_left",
        keywords, &list, &item, &lo, &hi))
        return ((void *)0);
    index = internal_bisect_left(list, item, lo, hi);
    if (index < 0)
...
static char insort_left_doc[] = "insort_left(a, x[, lo[, hi]])\n\nInsert item x in list a, and keep it sorted assuming a is sorted.\n\nIf x is already in a, insert it to the left of the leftmost x.\n\nOptional args lo (default 0) and hi (default len(a)) bound the\nslice of a to be searched.\n";
# 218 "_bisectmodule.c"
static char bisect_doc[] = "Alias for bisect_right().\n";
static char insort_doc[] = "Alias for insort_right().\n";

static PyMethodDef bisect_methods[] = {
    {"bisect_right", (PyCFunction)bisect_right,
        0x0001|0x0002, bisect_right_doc},
    {"bisect", (PyCFunction)bisect_right,
        0x0001|0x0002, bisect_doc},
    {"insort_right", (PyCFunction)insort_right,
        0x0001|0x0002, insort_right_doc},
    {"insort", (PyCFunction)insort_right,
        0x0001|0x0002, insort_doc},
    {"bisect_left", (PyCFunction)bisect_left,
        0x0001|0x0002, bisect_left_doc},
    {"insort_left", (PyCFunction)insort_left,
        0x0001|0x0002, insort_left_doc},
    {((void *)0), ((void *)0)}
};

static char module_doc[] = "Bisection algorithms.\n\nThis module provides support for maintaining a list in sorted order without\nhaving to sort the list after each insertion. For long lists of items with\nexpensive comparison operations, this can be an improvement over the more\ncommon approach.\n";
# 246 "_bisectmodule.c"
...
PyInit__bisect(void)
{
    return PyModule_Create2(&_bisectmodule, 1013);
}
