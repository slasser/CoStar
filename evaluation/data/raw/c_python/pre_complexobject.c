...
# 77 "complexobject.c"
     ...
     if (abs_breal >= abs_bimag) {
        ...
        (__builtin_expect(!(b.imag != 0.0), 0) ? __assert_rtn(__func__, "complexobject.c", 98, "b.imag != 0.0") : (void)0);
...
_Py_c_abs(Py_complex z)
{
    ...
    if (!( sizeof (z.real) == sizeof(float ) ? __inline_isfinitef((float)(z.real)) : sizeof (z.real) == sizeof(double) ? __inline_isfinited((double)(z.real)) : __inline_isfinite ((long double)(z.real))) || !( sizeof (z.imag) == sizeof(float ) ? __inline_isfinitef((float)(z.imag)) : sizeof (z.imag) == sizeof(double) ? __inline_isfinited((double)(z.imag)) : __inline_isfinite ((long double)(z.imag)))) {



        if (( sizeof (z.real) == sizeof(float ) ? __inline_isinff((float)(z.real)) : sizeof (z.real) == sizeof(double) ? __inline_isinfd((double)(z.real)) : __inline_isinf ((long double)(z.real)))) {
            result = fabs(z.real);
            (*__error()) = 0;
            return result;
        }
        if (( sizeof (z.imag) == sizeof(float ) ? __inline_isinff((float)(z.imag)) : sizeof (z.imag) == sizeof(double) ? __inline_isinfd((double)(z.imag)) : __inline_isinf ((long double)(z.imag)))) {
            result = fabs(z.imag);
            (*__error()) = 0;
            return result;
        }
    ...
    if (!( sizeof (result) == sizeof(float ) ? __inline_isfinitef((float)(result)) : sizeof (result) == sizeof(double) ? __inline_isfinited((double)(result)) : __inline_isfinite ((long double)(result))))
        (*__error()) = 34;
    else
        (*__error()) = 0;
    return result;
...
PyComplex_FromCComplex(Py_complex cval)
{
    ...
    ( (((PyObject*)(op))->ob_type) = (&PyComplex_Type), ( (((PyObject*)((PyObject *)(op)))->ob_refcnt) = 1), (op) );
    op->cval = cval;
    return (PyObject *) op;
}
...
{
    if (((((PyObject*)(op))->ob_type) == (&PyComplex_Type) || PyType_IsSubtype((((PyObject*)(op))->ob_type), (&PyComplex_Type)))) {
...
try_complex_special_method(PyObject *op) {
    PyObject *f;
    static _Py_Identifier PyId___complex__ = { 0, "__complex__", 0 };

    f = _PyObject_LookupSpecial(op, &PyId___complex__);
    if (f) {
        PyObject *res = PyObject_CallFunctionObjArgs(f, ((void *)0));
...
{
    Py_complex cv;
    PyObject *newop = ((void *)0);

    (__builtin_expect(!(op), 0) ? __assert_rtn(__func__, "complexobject.c", 285, "op") : (void)0);
    ...
    if (newop) {
        if (!((((PyObject*)(newop))->ob_type) == (&PyComplex_Type) || PyType_IsSubtype((((PyObject*)(newop))->ob_type), (&PyComplex_Type)))) {
            PyErr_SetString(PyExc_TypeError,
                "__complex__ should return a complex object");
            do { if ( --((PyObject*)(newop))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(newop)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(newop)))); } while (0);
            return cv;
        }
...
complex_add(PyObject *v, PyObject *w)
{
    Py_complex result;
    Py_complex a, b;
    if (((((PyObject*)(v))->ob_type) == (&PyComplex_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PyComplex_Type)))) a = ((PyComplexObject *)(v))->cval; else if (to_complex(&(v), &(a)) < 0) return (v);
    if (((((PyObject*)(w))->ob_type) == (&PyComplex_Type) || PyType_IsSubtype((((PyObject*)(w))->ob_type), (&PyComplex_Type)))) b = ((PyComplexObject *)(w))->cval; else if (to_complex(&(w), &(b)) < 0) return (w);
...
complex_pow(PyObject *v, PyObject *w, PyObject *z)
{
    ...
    do { if ((p.real) == __builtin_huge_val() || (p.real) == -__builtin_huge_val() || (p.imag) == __builtin_huge_val() || (p.imag) == -__builtin_huge_val()) { if ((*__error()) == 0) (*__error()) = 34; } else if ((*__error()) == 34) (*__error()) = 0; } while(0);
    if ((*__error()) == 33) {
...
{
    if (((((PyObject*)(v))->ob_type) == &PyComplex_Type)) {
...
complex_richcompare(PyObject *v, PyObject *w, int op)
{
    ...
    (__builtin_expect(!(((((PyObject*)(v))->ob_type) == (&PyComplex_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PyComplex_Type)))), 0) ? __assert_rtn(__func__, "complexobject.c", 610, "PyComplex_Check(v)") : (void)0);
    if (((((PyObject*)(v))->ob_type) == (&PyComplex_Type) || PyType_IsSubtype((((PyObject*)(v))->ob_type), (&PyComplex_Type)))) i = ((PyComplexObject *)(v))->cval; else if (to_complex(&(v), &(i)) < 0) return (v);
    ...
    else if (((((PyObject*)(w))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(w))->ob_type), (&PyFloat_Type)))) {
        equal = (i.real == PyFloat_AsDouble(w) && i.imag == 0.0);
    }
    else if (((((PyObject*)(w))->ob_type) == (&PyComplex_Type) || PyType_IsSubtype((((PyObject*)(w))->ob_type), (&PyComplex_Type)))) {
        Py_complex j;

        if (((((PyObject*)(w))->ob_type) == (&PyComplex_Type) || PyType_IsSubtype((((PyObject*)(w))->ob_type), (&PyComplex_Type)))) j = ((PyComplexObject *)(w))->cval; else if (to_complex(&(w), &(j)) < 0) return (w);
...
static char complex_conjugate_doc[] = "complex.conjugate() -> complex\n" "\n" "Returns the complex conjugate of its argument. (3-4j).conjugate() == 3+4j.";
...
static char complex__format__doc[] = "complex.__format__() -> str\n" "\n" "Converts to a string according to format_spec.";
...
complex__format__(PyObject* self, PyObject* args)
{
    ...
    ret = _PyComplex_FormatAdvancedWriter(
        &writer,
        self,
        format_spec, 0, ((__builtin_expect(!(((((((PyObject*)(format_spec))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "complexobject.c", 712, "PyUnicode_Check(format_spec)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)format_spec)->state.ready)), 0) ? __assert_rtn(__func__, "complexobject.c", 712, "PyUnicode_IS_READY(format_spec)") : (void)0), ((PyASCIIObject *)(format_spec))->length));
    if (ret == -1) {
...
static PyMethodDef complex_methods[] = {
    {"conjugate", (PyCFunction)complex_conjugate, 0x0004,
     complex_conjugate_doc},




    {"__getnewargs__", (PyCFunction)complex_getnewargs, 0x0004},
    {"__format__", (PyCFunction)complex__format__,
                                       0x0001, complex__format__doc},
    {((void *)0), ((void *)0)}
};

static PyMemberDef complex_members[] = {
    {"real", 4, __builtin_offsetof (PyComplexObject, cval.real), 1,
     "the real part of a complex number"},
    {"imag", 4, __builtin_offsetof (PyComplexObject, cval.imag), 1,
...
# 815 "complexobject.c"
    z = PyOS_string_to_double(s, &end, ((void *)0));
    ...
    if (end != s) {
        ...
        if (*s == '+' || *s == '-') {
            ...
            x = z;
            y = PyOS_string_to_double(s, &end, ((void *)0));
...
{
    PyObject *r, *i, *tmp;
    PyNumberMethods *nbr, *nbi = ((void *)0);
    Py_complex cr, ci;
    int own_r = 0;
    int cr_is_complex = 0;
    int ci_is_complex = 0;
    ...
    if (((((PyObject*)(r))->ob_type) == &PyComplex_Type) && i == ((void *)0) &&
        type == &PyComplex_Type) {
    ...
    if (((((((PyObject*)(r))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        if (i != ((void *)0)) {
            PyErr_SetString(PyExc_TypeError,
    ...
    if (i != ((void *)0) && ((((((PyObject*)(i))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        PyErr_SetString(PyExc_TypeError,
    ...
    if (nbr == ((void *)0) || nbr->nb_float == ((void *)0) ||
        ((i != ((void *)0)) && (nbi == ((void *)0) || nbi->nb_float == ((void *)0)))) {
        PyErr_SetString(PyExc_TypeError,
                   "complex() argument must be a string or a number");
        if (own_r) {
...
# 971 "complexobject.c"
    if (((((PyObject*)(r))->ob_type) == (&PyComplex_Type) || PyType_IsSubtype((((PyObject*)(r))->ob_type), (&PyComplex_Type)))) {
        ...
        if (tmp == ((void *)0))
            return ((void *)0);
        if (!((((PyObject*)(tmp))->ob_type) == (&PyFloat_Type) || PyType_IsSubtype((((PyObject*)(tmp))->ob_type), (&PyFloat_Type)))) {
            PyErr_SetString(PyExc_TypeError,
    ...
    else if (((((PyObject*)(i))->ob_type) == (&PyComplex_Type) || PyType_IsSubtype((((PyObject*)(i))->ob_type), (&PyComplex_Type)))) {
...
static char complex_doc[] = "complex(real[, imag]) -> complex number\n" "\n" "Create a complex number from a real part and an optional imaginary part.\n" "This is equivalent to (real + imag*1j) where imag defaults to 0.";
...
static PyNumberMethods complex_as_number = {
    ...
    (binaryfunc)complex_remainder,
    (binaryfunc)complex_divmod,
