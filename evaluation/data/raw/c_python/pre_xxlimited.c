...
{
    XxoObject *self;
    self = ( (XxoObject *) _PyObject_New((PyTypeObject*)Xxo_Type) );
    if (self == ((void *)0))
        return ((void *)0);
    self->x_attr = ((void *)0);
    return self;
...
{
    do { if ((self->x_attr) == ((void *)0)) ; else do { if ( --((PyObject*)(self->x_attr))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(self->x_attr)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(self->x_attr)))); } while (0); } while (0);
    PyObject_Free(self);
}
...
Xxo_demo(XxoObject *self, PyObject *args)
{
    ...
    if (o != ((void *)0) && ((((((PyObject*)(o))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
...
static PyMethodDef Xxo_methods[] = {
    {"demo", (PyCFunction)Xxo_demo, 0x0001,
        "demo() -> None"},
    {((void *)0), ((void *)0)}
};
...
static char xx_foo_doc[] = "foo(i,j)\n\nReturn the sum of i and j.";
...
static char module_doc[] = "This is a template module just for instruction.";
...
PyInit_xxlimited(void)
{
    ...
    m = PyModule_Create2(&xxmodule, 1013);
    if (m == ((void *)0))
        goto fail;


    if (ErrorObject == ((void *)0)) {
        ErrorObject = PyErr_NewException("xxlimited.error", ((void *)0), ((void *)0));
        if (ErrorObject == ((void *)0))
            goto fail;
    }
