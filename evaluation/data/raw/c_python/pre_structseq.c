...
PyStructSequence_New(PyTypeObject *type)
{
    ...
    Py_ssize_t size = PyLong_AsLong( PyDict_GetItemString((type)->tp_dict, real_length_key)), i;

    obj = ( (PyStructSequence *) _PyObject_GC_NewVar((type), (size)) );
    if (obj == ((void *)0))
        return ((void *)0);


    (((PyVarObject*)(obj))->ob_size) = PyLong_AsLong( PyDict_GetItemString((type)->tp_dict, visible_length_key));
    for (i = 0; i < size; i++)
        obj->ob_item[i] = ((void *)0);
...
structseq_dealloc(PyStructSequence *obj)
{
    ...
    size = PyLong_AsLong( PyDict_GetItemString(((((PyObject*)(obj))->ob_type))->tp_dict, real_length_key));
    for (i = 0; i < size; ++i) {
        do { if ((obj->ob_item[i]) == ((void *)0)) ; else do { if ( --((PyObject*)(obj->ob_item[i]))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(obj->ob_item[i])))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(obj->ob_item[i])))); } while (0); } while (0);
    }
    PyObject_GC_Del(obj);
}
...
structseq_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    if (dict && !((((((PyObject*)(dict))->ob_type))->tp_flags & ((1L<<29))) != 0)) {
    ...
    len = (((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<25))) != 0) ? (((PyVarObject*)(arg))->ob_size) : (((PyVarObject*)(arg))->ob_size));
    min_len = PyLong_AsLong( PyDict_GetItemString((type)->tp_dict, visible_length_key));
    max_len = PyLong_AsLong( PyDict_GetItemString((type)->tp_dict, real_length_key));
    n_unnamed_fields = PyLong_AsLong( PyDict_GetItemString((type)->tp_dict, unnamed_fields_key));
    ...
    for (i = 0; i < len; ++i) {
        PyObject *v = (((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<25))) != 0) ? (((PyListObject *)(arg))->ob_item[i]) : (((PyTupleObject *)(arg))->ob_item[i]));
...
structseq_repr(PyStructSequence *obj)
{
    ...
    PyTypeObject *typ = (((PyObject*)(obj))->ob_type);
    int i, removelast = 0;
    Py_ssize_t len;
    char buf[512];
    ...
    len = strlen(typ->tp_name) > 100 ? 100 :
                            strlen(typ->tp_name);
    ((__builtin_object_size (pbuf, 0) != (size_t) -1) ? __builtin___strncpy_chk (pbuf, typ->tp_name, len, __builtin_object_size (pbuf, 2 > 1)) : __inline_strncpy_chk (pbuf, typ->tp_name, len));
    pbuf += len;
    *pbuf++ = '(';
    ...
    for (i=0; i < (((PyVarObject*)(obj))->ob_size); i++) {
        ...
        val = (((PyTupleObject *)(obj))->ob_item[i]);
        ...
        if ((pbuf+len) <= endofbuf) {
            ((__builtin_object_size (pbuf, 0) != (size_t) -1) ? __builtin___strcpy_chk (pbuf, cname, __builtin_object_size (pbuf, 2 > 1)) : __inline_strcpy_chk (pbuf, cname));
            pbuf += strlen(cname);
            *pbuf++ = '=';
            ((__builtin_object_size (pbuf, 0) != (size_t) -1) ? __builtin___strcpy_chk (pbuf, crepr, __builtin_object_size (pbuf, 2 > 1)) : __inline_strcpy_chk (pbuf, crepr));
            pbuf += strlen(crepr);
            *pbuf++ = ',';
            *pbuf++ = ' ';
            removelast = 1;
            ...
            ((__builtin_object_size (pbuf, 0) != (size_t) -1) ? __builtin___strcpy_chk (pbuf, "...", __builtin_object_size (pbuf, 2 > 1)) : __inline_strcpy_chk (pbuf, "..."));
            pbuf += 3;
            removelast = 0;
            do { if ( --((PyObject*)(repr))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(repr)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(repr)))); } while (0);
            break;
...
structseq_reduce(PyStructSequence* self)
{
    ...
    n_fields = PyLong_AsLong( PyDict_GetItemString(((((PyObject*)(self))->ob_type))->tp_dict, real_length_key));
    n_visible_fields = (((PyVarObject*)(self))->ob_size);
    n_unnamed_fields = PyLong_AsLong( PyDict_GetItemString(((((PyObject*)(self))->ob_type))->tp_dict, unnamed_fields_key));
    ...
    for (i = 0; i < n_visible_fields; i++) {
        ( ((PyObject*)(self->ob_item[i]))->ob_refcnt++);
        (((PyTupleObject *)(tup))->ob_item[i] = self->ob_item[i]);
    }

    for (; i < n_fields; i++) {
        char *n = (((PyObject*)(self))->ob_type)->tp_members[i-n_unnamed_fields].name;
        PyDict_SetItemString(dict, n,
                             self->ob_item[i]);
    }

    result = Py_BuildValue("(O(OO))", (((PyObject*)(self))->ob_type), tup, dict);
...
static PyMethodDef structseq_methods[] = {
    {"__reduce__", (PyCFunction)structseq_reduce, 0x0004, ((void *)0)},
    {((void *)0), ((void *)0)}
};
...
static PyTypeObject _struct_sequence_template = {
    { { 1, &PyType_Type }, 0 },
    ((void *)0),
    sizeof(PyStructSequence) - sizeof(PyObject *),
    sizeof(PyObject *),
...
# 333 "structseq.c"
    n_unnamed_members = 0;
    for (i = 0; desc->fields[i].name != ((void *)0); ++i)
        if (desc->fields[i].name == PyStructSequence_UnnamedField)
            n_unnamed_members++;
    n_members = i;

    ((__builtin_object_size (type, 0) != (size_t) -1) ? __builtin___memcpy_chk (type, &_struct_sequence_template, sizeof(PyTypeObject), __builtin_object_size (type, 0)) : __inline_memcpy_chk (type, &_struct_sequence_template, sizeof(PyTypeObject)));
    type->tp_base = &PyTuple_Type;
    type->tp_name = desc->name;
    type->tp_doc = desc->doc;

    members = ( ((size_t)(n_members-n_unnamed_members+1) > ((Py_ssize_t)(((size_t)-1)>>1)) / sizeof(PyMemberDef)) ? ((void *)0) : ( (PyMemberDef *) ((size_t)((n_members-n_unnamed_members+1) * sizeof(PyMemberDef)) > (size_t)((Py_ssize_t)(((size_t)-1)>>1)) ? ((void *)0) : malloc(((n_members-n_unnamed_members+1) * sizeof(PyMemberDef)) ? ((n_members-n_unnamed_members+1) * sizeof(PyMemberDef)) : 1)) ) );
    if (members == ((void *)0))
        return;
    ...
    for (i = k = 0; i < n_members; ++i) {
        ...
        members[k].type = 6;
        members[k].offset = __builtin_offsetof (PyStructSequence, ob_item)
          + i * sizeof(PyObject*);
        members[k].flags = 1;
        members[k].doc = desc->fields[i].doc;
        k++;
    }
    members[k].name = ((void *)0);
    ...
    dict = type->tp_dict;
# 377 "structseq.c"
    do { PyObject *v = PyLong_FromLong((long) desc->n_in_sequence); if (v != ((void *)0)) { PyDict_SetItemString(dict, visible_length_key, v); do { if ( --((PyObject*)(v))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(v)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(v)))); } while (0); } } while (0);
    do { PyObject *v = PyLong_FromLong((long) n_members); if (v != ((void *)0)) { PyDict_SetItemString(dict, real_length_key, v); do { if ( --((PyObject*)(v))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(v)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(v)))); } while (0); } } while (0);
    do { PyObject *v = PyLong_FromLong((long) n_unnamed_members); if (v != ((void *)0)) { PyDict_SetItemString(dict, unnamed_fields_key, v); do { if ( --((PyObject*)(v))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(v)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(v)))); } while (0); } } while (0);
}
