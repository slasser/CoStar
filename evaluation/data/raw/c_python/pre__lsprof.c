...
{
    long long result;
    PyObject *o = PyObject_Call(pObj->externalTimer, empty_tuple, ((void *)0));
    if (o == ((void *)0)) {
    ...
    if (pObj->externalTimerUnit > 0.0) {
        ...
        result = (long long) (val * 4294967296.0);
    }
...
normalizeUserObj(PyObject *obj)
{
    ...
    if (fn->m_self == ((void *)0)) {
        ...
        PyObject *modname = ((void *)0);
        if (mod != ((void *)0)) {
            if (((((((PyObject*)(mod))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
                modname = mod;
                ( ((PyObject*)(modname))->ob_refcnt++);
            }
            else if (((((PyObject*)(mod))->ob_type) == (&PyModule_Type) || PyType_IsSubtype((((PyObject*)(mod))->ob_type), (&PyModule_Type)))) {
        ...
        if (modname != ((void *)0)) {
            if (PyUnicode_CompareWithASCIIString(modname, "builtins") != 0) {
                ...
                result = PyUnicode_FromFormat("<%U.%s>", modname,
                                              fn->m_ml->ml_name);
                do { if ( --((PyObject*)(modname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(modname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(modname)))); } while (0);
                return result;
            }
            do { if ( --((PyObject*)(modname))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(modname)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(modname)))); } while (0);
        }
        ...
        if (name != ((void *)0)) {
            PyObject *mo = _PyType_Lookup((((PyObject*)(self))->ob_type), name);
            do { if ((mo) == ((void *)0)) ; else ( ((PyObject*)(mo))->ob_refcnt++); } while (0);
            do { if ( --((PyObject*)(name))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(name)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(name)))); } while (0);
            if (mo != ((void *)0)) {
                PyObject *res = PyObject_Repr(mo);
                do { if ( --((PyObject*)(mo))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(mo)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(mo)))); } while (0);
                if (res != ((void *)0))
                    return res;
            }
        }
...
newProfilerEntry(ProfilerObject *pObj, void *key, PyObject *userObj)
{
    ...
    self->calls = ((rotating_node_t *)((void *)0));
...
static int freeEntry(rotating_node_t *header, void *arg)
{
    ...
    RotatingTree_Enum(entry->calls, freeSubEntry, ((void *)0));
    do { if ( --((PyObject*)(entry->userObj))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(entry->userObj)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(entry->userObj)))); } while (0);
    free(entry);
    return 0;
}
...
{
    RotatingTree_Enum(pObj->profilerEntries, freeEntry, ((void *)0));
    pObj->profilerEntries = ((rotating_node_t *)((void *)0));

    if (pObj->currentProfilerContext) {
        free(pObj->currentProfilerContext);
        pObj->currentProfilerContext = ((void *)0);
    }
    ...
    pObj->freelistProfilerContext = ((void *)0);
}
...
initContext(ProfilerObject *pObj, ProfilerContext *self, ProfilerEntry *entry)
{
    ...
    if ((pObj->flags & 0x002) && self->previous) {
    ...
    self->t0 = ((pObj)->externalTimer ? CallExternalTimer(pObj) : hpTimer());
}

static void
Stop(ProfilerObject *pObj, ProfilerContext *self, ProfilerEntry *entry)
{
    long long tt = ((pObj)->externalTimer ? CallExternalTimer(pObj) : hpTimer()) - self->t0;
...
# 461 "_lsprof.c"
    case 4:
        if ((((ProfilerObject *)self)->flags & 0x004)
            && ((((PyObject*)(arg))->ob_type) == &PyCFunction_Type)) {
...
static int statsForSubEntry(rotating_node_t *node, void *arg)
{
    ...
    do { if ( --((PyObject*)(sinfo))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(sinfo)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(sinfo)))); } while (0);
    return err;
}
...
static int statsForEntry(rotating_node_t *node, void *arg)
{
    ...
    if (entry->calls != ((rotating_node_t *)((void *)0))) {
        collect->sublist = PyList_New(0);
        if (collect->sublist == ((void *)0))
            return -1;
        if (RotatingTree_Enum(entry->calls,
                              statsForSubEntry, collect) != 0) {
            do { if ( --((PyObject*)(collect->sublist))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(collect->sublist)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(collect->sublist)))); } while (0);
            return -1;
        }
    }
    else {
        ( ((PyObject*)((&_Py_NoneStruct)))->ob_refcnt++);
        collect->sublist = (&_Py_NoneStruct);
    }
...
static char getstats_doc[] = "getstats() -> list of profiler_entry objects\n\nReturn all information collected by the profiler.\nEach profiler_entry is a tuple-like object with the\nfollowing attributes:\n\n    code          code object\n    callcount     how many times this was called\n    reccallcount  how many times called recursively\n    totaltime     total time in this entry\n    inlinetime    inline time in this entry (not in subcalls)\n    calls         details of the calls\n\nThe calls attribute is either None or a list of\nprofiler_subentry objects:\n\n    code          called code object\n    callcount     how many times this is called\n    reccallcount  how many times this is called recursively\n    totaltime     total time spent in this call\n    inlinetime    inline time (not in further subcalls)\n";
# 631 "_lsprof.c"
static PyObject*
profiler_getstats(ProfilerObject *pObj, PyObject* noarg)
{
    ...
    if (!pObj->externalTimer)
        ...
        collect.factor = 1.0 / 4294967296.0;
    collect.list = PyList_New(0);
    if (collect.list == ((void *)0))
        return ((void *)0);
    if (RotatingTree_Enum(pObj->profilerEntries, statsForEntry, &collect)
        != 0) {
        do { if ( --((PyObject*)(collect.list))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(collect.list)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(collect.list)))); } while (0);
        return ((void *)0);
    }
    return collect.list;
}
...
static char enable_doc[] = "enable(subcalls=True, builtins=True)\n\nStart collecting profiling information.\nIf 'subcalls' is True, also records for each function\nstatistics separated according to its current caller.\nIf 'builtins' is True, records the time spent in\nbuilt-in functions separately from their caller.\n";
# 691 "_lsprof.c"
static PyObject*
...
static char disable_doc[] = "disable()\n\nStop collecting profiling information.\n";
...
profiler_dealloc(ProfilerObject *op)
{
    ...
    flush_unmatched(op);
    clearEntries(op);
    do { if ((op->externalTimer) == ((void *)0)) ; else do { if ( --((PyObject*)(op->externalTimer))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(op->externalTimer)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(op->externalTimer)))); } while (0); } while (0);
...
profiler_init(ProfilerObject *pObj, PyObject *args, PyObject *kw)
{
    ...
    do { if ((timer) == ((void *)0)) ; else ( ((PyObject*)(timer))->ob_refcnt++); } while (0);
...
static char profiler_doc[] = "Profiler(custom_timer=None, time_unit=None, subcalls=True, builtins=True)\n\n    Builds a profiler object using the specified timer function.\n    The default timer is a fast built-in one based on real time.\n    For custom timer functions returning integers, time_unit can\n    be a float specifying a scale (i.e. how long each integer unit\n    is, in seconds).\n";
# 819 "_lsprof.c"
static PyTypeObject PyProfiler_Type = {
    { { 1, ((void *)0) }, 0 },
    "_lsprof.Profiler",
    sizeof(ProfilerObject),
    0,
...
{
    PyObject *module, *d;
    module = PyModule_Create2(&_lsprofmodule, 1013);
    if (module == ((void *)0))
        return ((void *)0);
    ...
    ( ((PyObject*)((PyObject*) &StatsEntryType))->ob_refcnt++);
    ( ((PyObject*)((PyObject*) &StatsSubEntryType))->ob_refcnt++);
