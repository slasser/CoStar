...
{
    while(*t && (_Py_ctype_tolower[((unsigned char)((*s) & 0xff))]) == *t) {
        s++;
        t++;
    }
    return *t ? 0 : 1;
...
_PyOS_ascii_strtod(const char *nptr, char **endptr)
{
    ...
    (__builtin_expect(!(nptr != ((void *)0)), 0) ? __assert_rtn(__func__, "pystrtod.c", 136, "nptr != NULL") : (void)0);
                      ...
                      PyObject *overflow_exception)
{
    ...
    if ((*__error()) == 12) {
        ...
        PyErr_Format(PyExc_ValueError,
                      "could not convert string to float: "
                      "%.200s", s);
    else if ((*__error()) == 34 && fabs(x) >= 1.0 && overflow_exception)
                   ...
                   int use_alt_formatting, char **float_strings, int *type)
{
    ...
    (__builtin_expect(!(digits_end != ((void *)0) && digits_end >= digits), 0) ? __assert_rtn(__func__, "pystrtod.c", 951, "digits_end != NULL && digits_end >= digits") : (void)0);
    digits_len = digits_end - digits;

    if (digits_len && !(_Py_ctype_table[((unsigned char)((digits[0]) & 0xff))] & 0x04)) {
        ...
        if (digits[0] == 'i' || digits[0] == 'I') {
            ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___strncpy_chk (p, float_strings[0], 3, __builtin_object_size (p, 2 > 1)) : __inline_strncpy_chk (p, float_strings[0], 3));
            p += 3;
            ...
            ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___strncpy_chk (p, float_strings[1], 3, __builtin_object_size (p, 2 > 1)) : __inline_strncpy_chk (p, float_strings[1], 3));
            p += 3;
            ...
            ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___strncpy_chk (p, "ERR", 3, __builtin_object_size (p, 2 > 1)) : __inline_strncpy_chk (p, "ERR", 3));

            (__builtin_expect(!(0), 0) ? __assert_rtn(__func__, "pystrtod.c", 997, "0") : (void)0);
        }
        goto exit;
    }
...
# 1029 "pystrtod.c"
    ...
    case 'r':
        ...
        break;
    default:
        _PyErr_BadInternalCall("pystrtod.c", 1055);
        goto exit;
    }
    ...
    (__builtin_expect(!(vdigits_start <= 0 && 0 <= digits_len && digits_len <= vdigits_end), 0) ? __assert_rtn(__func__, "pystrtod.c", 1076, "vdigits_start <= 0 && 0 <= digits_len && digits_len <= vdigits_end") : (void)0);



    (__builtin_expect(!(vdigits_start < decpt && decpt <= vdigits_end), 0) ? __assert_rtn(__func__, "pystrtod.c", 1078, "vdigits_start < decpt && decpt <= vdigits_end") : (void)0);
    ...
    if (decpt <= 0) {
        ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___memset_chk (p, '0', decpt-vdigits_start, __builtin_object_size (p, 0)) : __inline_memset_chk (p, '0', decpt-vdigits_start));
        p += decpt - vdigits_start;
        *p++ = '.';
        ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___memset_chk (p, '0', 0-decpt, __builtin_object_size (p, 0)) : __inline_memset_chk (p, '0', 0-decpt));
        p += 0-decpt;
    }
    else {
        ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___memset_chk (p, '0', 0-vdigits_start, __builtin_object_size (p, 0)) : __inline_memset_chk (p, '0', 0-vdigits_start));
        p += 0 - vdigits_start;
    }


    if (0 < decpt && decpt <= digits_len) {
        ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___strncpy_chk (p, digits, decpt-0, __builtin_object_size (p, 2 > 1)) : __inline_strncpy_chk (p, digits, decpt-0));
        p += decpt-0;
        *p++ = '.';
        ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___strncpy_chk (p, digits+decpt, digits_len-decpt, __builtin_object_size (p, 2 > 1)) : __inline_strncpy_chk (p, digits+decpt, digits_len-decpt));
        p += digits_len-decpt;
    }
    else {
        ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___strncpy_chk (p, digits, digits_len, __builtin_object_size (p, 2 > 1)) : __inline_strncpy_chk (p, digits, digits_len));
        p += digits_len;
    }


    if (digits_len < decpt) {
        ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___memset_chk (p, '0', decpt-digits_len, __builtin_object_size (p, 0)) : __inline_memset_chk (p, '0', decpt-digits_len));
        p += decpt-digits_len;
        *p++ = '.';
        ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___memset_chk (p, '0', vdigits_end-decpt, __builtin_object_size (p, 0)) : __inline_memset_chk (p, '0', vdigits_end-decpt));
        p += vdigits_end-decpt;
    }
    else {
        ((__builtin_object_size (p, 0) != (size_t) -1) ? __builtin___memset_chk (p, '0', vdigits_end-digits_len, __builtin_object_size (p, 0)) : __inline_memset_chk (p, '0', vdigits_end-digits_len));
    ...
    if (use_exp) {
        *p++ = float_strings[2][0];
        exp_len = __builtin___sprintf_chk (p, 0, __builtin_object_size (p, 2 > 1), "%+.02d", exp);
        p += exp_len;
    }
  exit:
    if (buf) {
        *p = '\0';
        ...
        (__builtin_expect(!(p-buf < bufsize), 0) ? __assert_rtn(__func__, "pystrtod.c", 1164, "p-buf < bufsize") : (void)0);
    }
    if (digits)
                                         ...
                                         int *type)
{
    ...
    case 'r':
        ...
        if (precision != 0) {
            _PyErr_BadInternalCall("pystrtod.c", 1221);
            return ((void *)0);
        }
        break;

    default:
        _PyErr_BadInternalCall("pystrtod.c", 1227);
        return ((void *)0);
    }
