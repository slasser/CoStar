...
static fault_handler_t faulthandler_handlers[] = {
    ...
    {4, 0, "Illegal instruction", },

    {8, 0, "Floating point exception", },
    {6, 0, "Aborted", },


    {11, 0, "Segmentation fault", }
};
static const unsigned char faulthandler_nsignals = (sizeof(faulthandler_handlers) / sizeof((faulthandler_handlers)[0]) + (sizeof(char [1 - 2*!(!__builtin_types_compatible_p(typeof(faulthandler_handlers), typeof(&(faulthandler_handlers)[0])))]) - 1));
...
faulthandler_get_fileno(PyObject *file, int *p_fd)
{
    ...
    fd = -1;
    if (((((((PyObject*)(result))->ob_type))->tp_flags & ((1L<<24))) != 0)) {
        fd_long = PyLong_AsLong(result);
        if (0 <= fd_long && fd_long < 2147483647)
            fd = (int)fd_long;
    }
...
{
    static char *kwlist[] = {"file", "all_threads", ((void *)0)};
...
faulthandler_fatal_error(int signum)
{
    ...
    unsigned int i;
    fault_handler_t *handler = ((void *)0);
    PyThreadState *tstate;
    int save_errno = (*__error());
    ...
    (void)sigaction(signum, &handler->previous, ((void *)0));



    handler->enabled = 0;

    write(fd, "Fatal Python error: ", strlen("Fatal Python error: "));
    write(fd, handler->name, strlen(handler->name));
    write(fd, "\n\n", strlen("\n\n"));
# 284 "faulthandler.c"
...
faulthandler_enable(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    do { if ((fatal_error.file) == ((void *)0)) ; else do { if ( --((PyObject*)(fatal_error.file))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(fatal_error.file)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(fatal_error.file)))); } while (0); } while (0);
    ...
    if (!fatal_error.enabled) {
        ...
        for (i=0; i < faulthandler_nsignals; i++) {
            ...
            action.__sigaction_u.__sa_handler = faulthandler_fatal_error;
            (*(&action.sa_mask) = 0, 0);


            action.sa_flags = 0x0010;

            if (stack.ss_sp != ((void *)0)) {


                action.sa_flags |= 0x0001;
            }
...
faulthandler_disable(void)
{
    ...
    if (fatal_error.enabled) {
        ...
        for (i=0; i < faulthandler_nsignals; i++) {
            ...
            (void)sigaction(handler->signum, &handler->previous, ((void *)0));
    ...
    do { if (fatal_error.file) { PyObject *_py_tmp = (PyObject *)(fatal_error.file); (fatal_error.file) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
}
...
cancel_dump_traceback_later(void)
{
    ...
    do { if (thread.file) { PyObject *_py_tmp = (PyObject *)(thread.file); (thread.file) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    if (thread.header) {
        free(thread.header);
        thread.header = ((void *)0);
    }
}
...
faulthandler_dump_traceback_later(PyObject *self,
                                   PyObject *args, PyObject *kwargs)
{
    static char *kwlist[] = {"timeout", "repeat", "file", "exit", ((void *)0)};
    double timeout;
    long long timeout_us;
    int repeat = 0;
    PyObject *file = ((void *)0);
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs,
        ...
        return ((void *)0);
    if ((timeout * 1e6) >= (double) 0x7fffffffffffffffLL) {
        PyErr_SetString(PyExc_OverflowError, "timeout value is too large");
        return ((void *)0);
    }
    timeout_us = (long long)(timeout * 1e6);
    if (timeout_us <= 0) {
    ...
    do { if ((thread.file) == ((void *)0)) ; else do { if ( --((PyObject*)(thread.file))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(thread.file)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(thread.file)))); } while (0); } while (0);
    ( ((PyObject*)(file))->ob_refcnt++);
    thread.file = file;
    thread.fd = fd;
    ...
    if (PyThread_start_new_thread(faulthandler_thread, ((void *)0)) == -1) {
        PyThread_release_lock(thread.running);
        do { if (thread.file) { PyObject *_py_tmp = (PyObject *)(thread.file); (thread.file) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
        free(header);
        thread.header = ((void *)0);
...
faulthandler_register(int signum, int chain, _Py_sighandler_t *p_previous)
{
    ...
    struct sigaction action;
    action.__sigaction_u.__sa_handler = faulthandler_user;
    (*(&action.sa_mask) = 0, 0);
...
faulthandler_user(int signum)
{
    ...
    if (user->chain) {
        (void)sigaction(signum, &user->previous, ((void *)0));
        (*__error()) = save_errno;
        ...
        save_errno = (*__error());
        (void)faulthandler_register(signum, user->chain, ((void *)0));
        (*__error()) = save_errno;
    }
...
faulthandler_register_py(PyObject *self,
                         PyObject *args, PyObject *kwargs)
{
    static char *kwlist[] = {"signum", "file", "all_threads", "chain", ((void *)0)};
    int signum;
    PyObject *file = ((void *)0);
    int all_threads = 1;
    int chain = 0;
    ...
    if (user_signals == ((void *)0)) {
        user_signals = calloc(32, sizeof(user_signal_t));
        if (user_signals == ((void *)0))
            return PyErr_NoMemory();
    }
    user = &user_signals[signum];
    ...
    do { if ((user->file) == ((void *)0)) ; else do { if ( --((PyObject*)(user->file))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(user->file)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(user->file)))); } while (0); } while (0);
    ( ((PyObject*)(file))->ob_refcnt++);
    user->file = file;
    user->fd = fd;
...
faulthandler_unregister(user_signal_t *user, int signum)
{
    ...
    do { if (user->file) { PyObject *_py_tmp = (PyObject *)(user->file); (user->file) = ((void *)0); do { if ( --((PyObject*)(_py_tmp))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(_py_tmp)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(_py_tmp)))); } while (0); } } while (0);
    user->fd = -1;
    return 1;
}
...
faulthandler_stack_overflow(PyObject *self)
{
    ...
    depth = 0;
    stop = stack_overflow(sp - (100*1024*1024),
                          sp + (100*1024*1024),
                          &depth);
    if (sp < stop)
        size = stop - sp;
...
faulthandler_traverse(PyObject *module, visitproc visit, void *arg)
{
    ...
    do { if (thread.file) { int vret = visit((PyObject *)(thread.file), arg); if (vret) return vret; } } while (0);


    if (user_signals != ((void *)0)) {
        for (signum=0; signum < 32; signum++)
            do { if (user_signals[signum].file) { int vret = visit((PyObject *)(user_signals[signum].file), arg); if (vret) return vret; } } while (0);
    }

    do { if (fatal_error.file) { int vret = visit((PyObject *)(fatal_error.file), arg); if (vret) return vret; } } while (0);
    return 0;
}

static char module_doc[] = "faulthandler module.";


static PyMethodDef module_methods[] = {
    {"enable",
     (PyCFunction)faulthandler_enable, 0x0001|0x0002,
     "enable(file=sys.stderr, all_threads=True): " "enable the fault handler"},

    {"disable", (PyCFunction)faulthandler_disable_py, 0x0004,
     "disable(): disable the fault handler"},
    {"is_enabled", (PyCFunction)faulthandler_is_enabled, 0x0004,
     "is_enabled()->bool: check if the handler is enabled"},
    {"dump_traceback",
     (PyCFunction)faulthandler_dump_traceback_py, 0x0001|0x0002,
    ...
    {"dump_traceback_later",
     (PyCFunction)faulthandler_dump_traceback_later, 0x0001|0x0002,
    ...
    {"cancel_dump_traceback_later",
     (PyCFunction)faulthandler_cancel_dump_traceback_later_py, 0x0004,
    ...
    {"register",
     (PyCFunction)faulthandler_register_py, 0x0001|0x0002,
    ...
    {"unregister",
     faulthandler_unregister_py, 0x0001|0x0002,
     "unregister(signum): unregister the handler of the signal " "'signum' registered by register()"},



    {"_read_null", faulthandler_read_null, 0x0001,
     "_read_null(release_gil=False): read from NULL, raise " "a SIGSEGV or SIGBUS signal depending on the platform"},

    {"_sigsegv", faulthandler_sigsegv, 0x0001,
     "_sigsegv(): raise a SIGSEGV signal"},
    {"_sigabrt", faulthandler_sigabrt, 0x0001,
     "_sigabrt(): raise a SIGABRT signal"},
    {"_sigfpe", (PyCFunction)faulthandler_sigfpe, 0x0004,
     "_sigfpe(): raise a SIGFPE signal"},

    {"_sigbus", (PyCFunction)faulthandler_sigbus, 0x0004,
     "_sigbus(): raise a SIGBUS signal"},


    {"_sigill", (PyCFunction)faulthandler_sigill, 0x0004,
     "_sigill(): raise a SIGILL signal"},

    {"_fatal_error", faulthandler_fatal_error_py, 0x0001,
     "_fatal_error(message): call Py_FatalError(message)"},

    {"_stack_overflow", (PyCFunction)faulthandler_stack_overflow, 0x0004,
...
faulthandler_env_options(void)
{
    ...
    if (!(Py_IgnoreEnvironmentFlag ? ((void *)0) : getenv("PYTHONFAULTHANDLER"))) {
        int has_key;
...
int _PyFaulthandler_Init(void)
{
    ...
    stack.ss_flags = 0;
    stack.ss_size = 131072;
    stack.ss_sp = PyMem_Malloc(stack.ss_size);
    if (stack.ss_sp != ((void *)0)) {
        err = sigaltstack(&stack, ((void *)0));
        if (err) {
...
void _PyFaulthandler_Fini(void)
{
    ...
    if (thread.cancel_event) {
        ...
        thread.cancel_event = ((void *)0);
    }
    if (thread.running) {
        PyThread_free_lock(thread.running);
        thread.running = ((void *)0);
    }
