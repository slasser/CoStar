...
bitset _Py_newbitset(int nbits);
void _Py_delbitset(bitset bs);

int _Py_addbit(bitset bs, int ibit);
int _Py_samebitset(bitset bs1, bitset bs2, int nbits);
void _Py_mergebitset(bitset bs1, bitset bs2, int nbits);
...
grammar *_Py_newgrammar(int start);
dfa *_Py_adddfa(grammar *g, int type, char *name);
int _Py_addstate(dfa *d);
void _Py_addarc(dfa *d, int from, int to, int lbl);
dfa *PyGrammar_FindDFA(grammar *g, int type);

int _Py_addlabel(labellist *ll, int type, char *str);
int _Py_findlabel(labellist *ll, int type, char *str);
char *PyGrammar_LabelRepr(label *lb);
void _Py_translatelabels(grammar *g);

void _Py_addfirstsets(grammar *g);

void PyGrammar_AddAccelerators(grammar *g);
void PyGrammar_RemoveAccelerators(grammar *);

void _Py_printgrammar(grammar *g, FILE *fp);
void _Py_printnonterminals(grammar *g, FILE *fp);
# 10 "pgen.c" 2
# 1 "/Users/parrt/tmp/Python-3.3.1/Include/metagrammar.h" 1
# 11 "pgen.c" 2
# 1 "/Users/parrt/tmp/Python-3.3.1/Include/pgen.h" 1
# 10 "/Users/parrt/tmp/Python-3.3.1/Include/pgen.h"
extern grammar *_Py_meta_grammar(void);

struct _node;
extern grammar *_Py_pgen(struct _node *);
# 12 "pgen.c" 2
...
newnfagrammar(void)
{
    ...
    gr->gr_ll.ll_label = ((void *)0);
    _Py_addlabel(&gr->gr_ll, 0, "EMPTY");
    return gr;
}
...
addnfa(nfagrammar *gr, char *name)
{
    ...
    _Py_addlabel(&gr->gr_ll, 1, nf->nf_name);
    return nf;
}
# 149 "pgen.c"
static nfagrammar *
metacompile(node *n)
{
    ...
    gr = newnfagrammar();
    (__builtin_expect(!(((n)->n_type) == (256)), 0) ? __assert_rtn(__func__, "pgen.c", 158, "TYPE(n) == (256)") : (void)0);
    i = n->n_nchildren - 1;
    n = n->n_child;
    for (; --i >= 0; n++) {
        if (n->n_type != 4)
...
compile_rule(nfagrammar *gr, node *n)
{
    ...
    (__builtin_expect(!(((n)->n_type) == (257)), 0) ? __assert_rtn(__func__, "pgen.c", 173, "TYPE(n) == (257)") : (void)0);
    ;
    n = n->n_child;
    (__builtin_expect(!(((n)->n_type) == (1)), 0) ? __assert_rtn(__func__, "pgen.c", 176, "TYPE(n) == (1)") : (void)0);
    nf = addnfa(gr, n->n_str);
    n++;
    (__builtin_expect(!(((n)->n_type) == (11)), 0) ? __assert_rtn(__func__, "pgen.c", 179, "TYPE(n) == (11)") : (void)0);
    n++;
    (__builtin_expect(!(((n)->n_type) == (258)), 0) ? __assert_rtn(__func__, "pgen.c", 181, "TYPE(n) == (258)") : (void)0);
    compile_rhs(&gr->gr_ll, nf, n, &nf->nf_start, &nf->nf_finish);
    n++;
    (__builtin_expect(!(((n)->n_type) == (4)), 0) ? __assert_rtn(__func__, "pgen.c", 184, "TYPE(n) == (4)") : (void)0);
}
...
compile_rhs(labellist *ll, nfa *nf, node *n, int *pa, int *pb)
{
    ...
    (__builtin_expect(!(((n)->n_type) == (258)), 0) ? __assert_rtn(__func__, "pgen.c", 193, "TYPE(n) == (258)") : (void)0);
    i = n->n_nchildren;
    ;
    n = n->n_child;
    (__builtin_expect(!(((n)->n_type) == (259)), 0) ? __assert_rtn(__func__, "pgen.c", 197, "TYPE(n) == (259)") : (void)0);
    ...
    *pb = addnfastate(nf);
    ...
    addnfaarc(nf, b, *pb, 0);
    for (; --i >= 0; n++) {
        (__builtin_expect(!(((n)->n_type) == (18)), 0) ? __assert_rtn(__func__, "pgen.c", 209, "TYPE(n) == (18)") : (void)0);
        ;
        --i;
        n++;
        (__builtin_expect(!(((n)->n_type) == (259)), 0) ? __assert_rtn(__func__, "pgen.c", 213, "TYPE(n) == (259)") : (void)0);
...
compile_alt(labellist *ll, nfa *nf, node *n, int *pa, int *pb)
{
    ...
    (__builtin_expect(!(((n)->n_type) == (259)), 0) ? __assert_rtn(__func__, "pgen.c", 226, "TYPE(n) == (259)") : (void)0);
    i = n->n_nchildren;
    ;
    n = n->n_child;
    (__builtin_expect(!(((n)->n_type) == (260)), 0) ? __assert_rtn(__func__, "pgen.c", 230, "TYPE(n) == (260)") : (void)0);
    compile_item(ll, nf, n, pa, pb);
    --i;
    n++;
    for (; --i >= 0; n++) {
        (__builtin_expect(!(((n)->n_type) == (260)), 0) ? __assert_rtn(__func__, "pgen.c", 235, "TYPE(n) == (260)") : (void)0);
...
compile_item(labellist *ll, nfa *nf, node *n, int *pa, int *pb)
{
    ...
    (__builtin_expect(!(((n)->n_type) == (260)), 0) ? __assert_rtn(__func__, "pgen.c", 248, "TYPE(n) == (260)") : (void)0);
    i = n->n_nchildren;
    ;
    n = n->n_child;
    if (n->n_type == 9) {
        ;
        n++;
        (__builtin_expect(!(((n)->n_type) == (258)), 0) ? __assert_rtn(__func__, "pgen.c", 255, "TYPE(n) == (258)") : (void)0);
        *pa = addnfastate(nf);
        *pb = addnfastate(nf);
        addnfaarc(nf, *pa, *pb, 0);
        compile_rhs(ll, nf, n, &a, &b);
        addnfaarc(nf, *pa, a, 0);
        addnfaarc(nf, b, *pb, 0);
        ;
        n++;
        (__builtin_expect(!(((n)->n_type) == (10)), 0) ? __assert_rtn(__func__, "pgen.c", 264, "TYPE(n) == (10)") : (void)0);
    }
    else {
        ...
        if (--i <= 0)
            return;
        n++;
        addnfaarc(nf, *pb, *pa, 0);
        if (n->n_type == 16)
            *pb = *pa;
        else
            (__builtin_expect(!(((n)->n_type) == (14)), 0) ? __assert_rtn(__func__, "pgen.c", 275, "TYPE(n) == (14)") : (void)0);
    }
}
...
compile_atom(labellist *ll, nfa *nf, node *n, int *pa, int *pb)
{
    ...
    (__builtin_expect(!(((n)->n_type) == (261)), 0) ? __assert_rtn(__func__, "pgen.c", 284, "TYPE(n) == (261)") : (void)0);
    i = n->n_nchildren;
    ;
    n = n->n_child;
    if (n->n_type == 7) {
        ;
        n++;
        (__builtin_expect(!(((n)->n_type) == (258)), 0) ? __assert_rtn(__func__, "pgen.c", 291, "TYPE(n) == (258)") : (void)0);
        compile_rhs(ll, nf, n, pa, pb);
        n++;
        (__builtin_expect(!(((n)->n_type) == (8)), 0) ? __assert_rtn(__func__, "pgen.c", 294, "TYPE(n) == (8)") : (void)0);
    }
    else if (n->n_type == 1 || n->n_type == 3) {
        *pa = addnfastate(nf);
        *pb = addnfastate(nf);
        addnfaarc(nf, *pa, *pb, _Py_addlabel(ll, n->n_type, n->n_str));
    }
    else
        (__builtin_expect(!(((n)->n_type) == (1)), 0) ? __assert_rtn(__func__, "pgen.c", 302, "TYPE(n) == (1)") : (void)0);
}
...
makedfa(nfagrammar *gr, nfa *nf, dfa *d)
{
    ...
    yy->ss_arc = ((void *)0);
    yy->ss_deleted = 0;
    yy->ss_finish = (((ss)[((nf->nf_finish) / (8*sizeof(char)))] & (1 << ((nf->nf_finish) % (8*sizeof(char))))) != 0);
    if (yy->ss_finish)
    ...
    for (istate = 0; istate < xx_nstates; ++istate) {
        ...
        for (ibit = 0; ibit < nf->nf_nstates; ++ibit) {
            if (!(((ss)[((ibit) / (8*sizeof(char)))] & (1 << ((ibit) % (8*sizeof(char))))) != 0))
                continue;
            st = &nf->nf_state[ibit];
            ...
            for (iarc = 0; iarc < st->st_narcs; iarc++) {
                ...
                zz->sa_bitset = _Py_newbitset(nbits);
                zz->sa_arrow = -1;
             found: ;
        ...
        for (jarc = 0; jarc < xx_state[istate].ss_narcs; jarc++) {
            ...
            for (jstate = 0; jstate < xx_nstates; jstate++) {
                if (_Py_samebitset(zz->sa_bitset,
            ...
            yy->ss_arc = ((void *)0);
            yy->ss_deleted = 0;
            yy->ss_finish = (((yy->ss_ss)[((nf->nf_finish) / (8*sizeof(char)))] & (1 << ((nf->nf_finish) % (8*sizeof(char))))) != 0);
         done: ;
        }
    }
           ...
           labellist *ll, char *msg)
{
    ...
    for (i = 0; i < xx_nstates; i++) {
        ...
        for (ibit = 0; ibit < nbits; ibit++) {
            if ((((yy->ss_ss)[((ibit) / (8*sizeof(char)))] & (1 << ((ibit) % (8*sizeof(char))))) != 0))
                printf("%d ", ibit);
        }
        printf("}\n");
...
convert(dfa *d, int xx_nstates, ss_state *xx_state)
{
    ...
    for (i = 0; i < xx_nstates; i++) {
        ...
        for (j = 0; j < yy->ss_narcs; j++) {
            zz = &yy->ss_arc[j];
            _Py_addarc(d, yy->ss_rename,
                xx_state[zz->sa_arrow].ss_rename,
                zz->sa_label);
        }
        if (yy->ss_finish)
            _Py_addarc(d, yy->ss_rename, yy->ss_rename, 0);
    }
...
maketables(nfagrammar *gr)
{
    ...
    if (gr->gr_nnfas == 0)
        return ((void *)0);
    g = _Py_newgrammar(gr->gr_nfa[0]->nf_type);
    ...
    for (i = 0; i < gr->gr_nnfas; i++) {
        ...
        d = _Py_adddfa(g, nf->nf_type, nf->nf_name);
