...
static unsigned char table_a2b_hqx[256] = {
        ...
        0x7D, 0x7D, 0x7E, 0x7D, 0x7D, 0x7E, 0x7D, 0x7D,
        ...
        0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x7D, 0x7D,

        0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x7D,

        0x14, 0x15, 0x7F, 0x7D, 0x7D, 0x7D, 0x7D, 0x7D,

        0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D,

        0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x7D,

        0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B, 0x7D,

        0x2C, 0x2D, 0x2E, 0x2F, 0x7D, 0x7D, 0x7D, 0x7D,

        0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x7D,

        0x37, 0x38, 0x39, 0x3A, 0x3B, 0x3C, 0x7D, 0x7D,

        0x3D, 0x3E, 0x3F, 0x7D, 0x7D, 0x7D, 0x7D, 0x7D,
...
ascii_buffer_converter(PyObject *arg, Py_buffer *buf)
{
    ...
    if (((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)) {
        if (((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 194, "PyUnicode_Check(arg)") : (void)0), ((((PyASCIIObject*)arg)->state.ready) ? 0 : _PyUnicode_Ready((PyObject *)(arg)))) < 0)
            return 0;
        if (!((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 196, "PyUnicode_Check(arg)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)arg)->state.ready)), 0) ? __assert_rtn(__func__, "binascii.c", 196, "PyUnicode_IS_READY(arg)") : (void)0), ((PyASCIIObject*)arg)->state.ascii)) {
            PyErr_SetString(PyExc_ValueError,
                            "string argument should contain only ASCII characters");
            return 0;
        }
        (__builtin_expect(!(((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 201, "PyUnicode_Check(arg)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)arg)->state.ready)), 0) ? __assert_rtn(__func__, "binascii.c", 201, "PyUnicode_IS_READY(arg)") : (void)0), ((PyASCIIObject *)(arg))->state.kind) == PyUnicode_1BYTE_KIND), 0) ? __assert_rtn(__func__, "binascii.c", 201, "PyUnicode_KIND(arg) == PyUnicode_1BYTE_KIND") : (void)0);
        buf->buf = (void *) ((Py_UCS1*)((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 202, "PyUnicode_Check(arg)") : (void)0), (((PyASCIIObject*)(arg))->state.compact) ? (((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 202, "PyUnicode_Check(arg)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)arg)->state.ready)), 0) ? __assert_rtn(__func__, "binascii.c", 202, "PyUnicode_IS_READY(arg)") : (void)0), ((PyASCIIObject*)arg)->state.ascii) ? ((void*)((PyASCIIObject*)(arg) + 1)) : ((void*)((PyCompactUnicodeObject*)(arg) + 1))) : ((__builtin_expect(!(((PyUnicodeObject*)(arg))->data.any), 0) ? __assert_rtn(__func__, "binascii.c", 202, "((PyUnicodeObject*)(arg))->data.any") : (void)0), ((((PyUnicodeObject *)(arg))->data.any)))));
        buf->len = ((__builtin_expect(!(((((((PyObject*)(arg))->ob_type))->tp_flags & ((1L<<28))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 203, "PyUnicode_Check(arg)") : (void)0), (__builtin_expect(!((((PyASCIIObject*)arg)->state.ready)), 0) ? __assert_rtn(__func__, "binascii.c", 203, "PyUnicode_IS_READY(arg)") : (void)0), ((PyASCIIObject *)(arg))->length);
        buf->obj = ((void *)0);
        return 1;
    }
    if (PyObject_GetBuffer(arg, buf, 0) != 0) {
        PyErr_Format(PyExc_TypeError,
                     "argument should be bytes, buffer or ASCII string, "
                     "not %R", (((PyObject*)(arg))->ob_type));
        return 0;
    }
...
binascii_a2b_uu(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "O&:a2b_uu", ascii_buffer_converter, &pascii) )
        return ((void *)0);
    ascii_data = pascii.buf;
    ascii_len = pascii.len;

    (__builtin_expect(!(ascii_len >= 0), 0) ? __assert_rtn(__func__, "binascii.c", 242, "ascii_len >= 0") : (void)0);
    ...
    if ( (rv=PyBytes_FromStringAndSize(((void *)0), bin_len)) == ((void *)0) ) {
        PyBuffer_Release(&pascii);
        return ((void *)0);
    }
    bin_data = (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 253, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval));
...
binascii_b2a_uu(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "y*:b2a_uu", &pbin) )
        return ((void *)0);
    bin_data = pbin.buf;
    bin_len = pbin.len;
    if ( bin_len > 45 ) {
    ...
    if ( (rv=PyBytes_FromStringAndSize(((void *)0), 2 + (bin_len+2)/3*4)) == ((void *)0) ) {
        PyBuffer_Release(&pbin);
        return ((void *)0);
    }
    ascii_data = (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 339, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval));
    ...
    *ascii_data++ = '\n';
    ...
    if (_PyBytes_Resize(&rv,
                       (ascii_data -
                        (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 363, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval)))) < 0) {
        do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0);
        rv = ((void *)0);
    }
    PyBuffer_Release(&pbin);
...
binascii_a2b_base64(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "O&:a2b_base64", ascii_buffer_converter, &pascii) )
        return ((void *)0);
    ascii_data = pascii.buf;
    ascii_len = pascii.len;

    (__builtin_expect(!(ascii_len >= 0), 0) ? __assert_rtn(__func__, "binascii.c", 416, "ascii_len >= 0") : (void)0);

    if (ascii_len > ((Py_ssize_t)(((size_t)-1)>>1)) - 3) {
        PyBuffer_Release(&pascii);
        return PyErr_NoMemory();
    }

    bin_len = ((ascii_len+3)/4)*3;
    ...
    bin_data = (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 430, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval));
    bin_len = 0;
...
binascii_b2a_base64(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "y*:b2a_base64", &pbuf) )
        return ((void *)0);
    bin_data = pbuf.buf;
    bin_len = pbuf.len;

    (__builtin_expect(!(bin_len >= 0), 0) ? __assert_rtn(__func__, "binascii.c", 524, "bin_len >= 0") : (void)0);

    if ( bin_len > ((((Py_ssize_t)(((size_t)-1)>>1)) - 3) / 2) ) {
    ...
    if ( (rv=PyBytes_FromStringAndSize(((void *)0), bin_len*2 + 3)) == ((void *)0) ) {
        PyBuffer_Release(&pbuf);
        return ((void *)0);
    }
    ascii_data = (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 539, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval));
    ...
    *ascii_data++ = '\n';
    ...
    if (_PyBytes_Resize(&rv,
                       (ascii_data -
                        (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 565, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval)))) < 0) {
        do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0);
        rv = ((void *)0);
    }
    PyBuffer_Release(&pbuf);
...
binascii_a2b_hqx(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "O&:a2b_hqx", ascii_buffer_converter, &pascii) )
        return ((void *)0);
    ascii_data = pascii.buf;
    len = pascii.len;

    (__builtin_expect(!(len >= 0), 0) ? __assert_rtn(__func__, "binascii.c", 592, "len >= 0") : (void)0);
    ...
    if ( (rv=PyBytes_FromStringAndSize(((void *)0), len+2)) == ((void *)0) ) {
        PyBuffer_Release(&pascii);
        return ((void *)0);
    }
    bin_data = (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 606, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval));
    ...
    if (_PyBytes_Resize(&rv,
                       (bin_data -
                        (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 644, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval)))) < 0) {
        do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0);
        rv = ((void *)0);
    }
    if (rv) {
        PyObject *rrv = _Py_BuildValue_SizeT("Oi", rv, done);
        PyBuffer_Release(&pascii);
        do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0);
        return rrv;
    }
...
binascii_rlecode_hqx(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "y*:rlecode_hqx", &pbuf) )
        return ((void *)0);
    in_data = pbuf.buf;
    len = pbuf.len;

    (__builtin_expect(!(len >= 0), 0) ? __assert_rtn(__func__, "binascii.c", 675, "len >= 0") : (void)0);

    if (len > ((Py_ssize_t)(((size_t)-1)>>1)) / 2 - 2) {
        PyBuffer_Release(&pbuf);
        return PyErr_NoMemory();
    }


    if ( (rv=PyBytes_FromStringAndSize(((void *)0), len*2+2)) == ((void *)0) ) {
        PyBuffer_Release(&pbuf);
        return ((void *)0);
    }
    out_data = (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 687, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval));
    ...
    if (_PyBytes_Resize(&rv,
                       (out_data -
                        (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 715, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval)))) < 0) {
        do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0);
        rv = ((void *)0);
    }
    PyBuffer_Release(&pbuf);
...
binascii_b2a_hqx(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "y*:b2a_hqx", &pbin) )
        return ((void *)0);
    bin_data = pbin.buf;
    len = pbin.len;

    (__builtin_expect(!(len >= 0), 0) ? __assert_rtn(__func__, "binascii.c", 741, "len >= 0") : (void)0);
    ...
    ascii_data = (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 753, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval));
    ...
    if (_PyBytes_Resize(&rv,
                       (ascii_data -
                        (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 772, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval)))) < 0) {
        do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0);
        rv = ((void *)0);
    }
    PyBuffer_Release(&pbin);
...
binascii_rledecode_hqx(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "y*:rledecode_hqx", &pin) )
        return ((void *)0);
    in_data = pin.buf;
    in_len = pin.len;

    (__builtin_expect(!(in_len >= 0), 0) ? __assert_rtn(__func__, "binascii.c", 796, "in_len >= 0") : (void)0);
    ...
    else if (in_len > ((Py_ssize_t)(((size_t)-1)>>1)) / 2) {
        PyBuffer_Release(&pin);
        return PyErr_NoMemory();
    }
    ...
    out_len = in_len*2;
    if ( (rv=PyBytes_FromStringAndSize(((void *)0), out_len)) == ((void *)0) ) {
        PyBuffer_Release(&pin);
        return ((void *)0);
    }
    out_len_left = out_len;
    out_data = (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 815, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval));
# 850 "binascii.c"
        do { if ( --in_len < 0 ) { PyErr_SetString(Incomplete, ""); do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0); PyBuffer_Release(&pin); return ((void *)0); } in_byte = *in_data++; } while(0);

    if (in_byte == 0x90) {
        do { if ( --in_len < 0 ) { PyErr_SetString(Incomplete, ""); do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0); PyBuffer_Release(&pin); return ((void *)0); } in_repeat = *in_data++; } while(0);
        if (in_repeat != 0) {
        ...
        do { if ( --out_len_left < 0 ) { if ( out_len > ((Py_ssize_t)(((size_t)-1)>>1)) / 2) return PyErr_NoMemory(); if (_PyBytes_Resize(&rv, 2*out_len) < 0) { do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0); PyBuffer_Release(&pin); return ((void *)0); } out_data = (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 863, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval)) + out_len; out_len_left = out_len-1; out_len = out_len * 2; } *out_data++ = 0x90; } while(0);
    } else {
        do { if ( --out_len_left < 0 ) { if ( out_len > ((Py_ssize_t)(((size_t)-1)>>1)) / 2) return PyErr_NoMemory(); if (_PyBytes_Resize(&rv, 2*out_len) < 0) { do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0); PyBuffer_Release(&pin); return ((void *)0); } out_data = (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 865, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval)) + out_len; out_len_left = out_len-1; out_len = out_len * 2; } *out_data++ = in_byte; } while(0);
    }
    ...
    while( in_len > 0 ) {
        ...
        if (in_byte == 0x90) {
            ...
            if ( in_repeat == 0 ) {
                ...
                do { if ( --out_len_left < 0 ) { if ( out_len > ((Py_ssize_t)(((size_t)-1)>>1)) / 2) return PyErr_NoMemory(); if (_PyBytes_Resize(&rv, 2*out_len) < 0) { do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0); PyBuffer_Release(&pin); return ((void *)0); } out_data = (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 875, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval)) + out_len; out_len_left = out_len-1; out_len = out_len * 2; } *out_data++ = 0x90; } while(0);
            } else {

                in_byte = out_data[-1];
                while ( --in_repeat > 0 )
                    do { if ( --out_len_left < 0 ) { if ( out_len > ((Py_ssize_t)(((size_t)-1)>>1)) / 2) return PyErr_NoMemory(); if (_PyBytes_Resize(&rv, 2*out_len) < 0) { do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0); PyBuffer_Release(&pin); return ((void *)0); } out_data = (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 880, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval)) + out_len; out_len_left = out_len-1; out_len = out_len * 2; } *out_data++ = in_byte; } while(0);
            }
        } else {

            do { if ( --out_len_left < 0 ) { if ( out_len > ((Py_ssize_t)(((size_t)-1)>>1)) / 2) return PyErr_NoMemory(); if (_PyBytes_Resize(&rv, 2*out_len) < 0) { do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0); PyBuffer_Release(&pin); return ((void *)0); } out_data = (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 884, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval)) + out_len; out_len_left = out_len-1; out_len = out_len * 2; } *out_data++ = in_byte; } while(0);
        }
    }
    if (_PyBytes_Resize(&rv,
                       (out_data -
                        (unsigned char *)((__builtin_expect(!(((((((PyObject*)(rv))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 889, "PyBytes_Check(rv)") : (void)0), (((PyBytesObject *)(rv))->ob_sval)))) < 0) {
        do { if ( --((PyObject*)(rv))->ob_refcnt != 0) ; else ( (*(((PyObject*)((PyObject *)(rv)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(rv)))); } while (0);
        rv = ((void *)0);
    }
    PyBuffer_Release(&pin);
...
binascii_crc_hqx(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "y*i:crc_hqx", &pin, &crc) )
        return ((void *)0);
    bin_data = pin.buf;
    len = pin.len;
    ...
    PyBuffer_Release(&pin);
    return _Py_BuildValue_SizeT("i", crc);
}

static char doc_crc32[] = "(data, oldcrc = 0) -> newcrc. Compute CRC-32 incrementally";
# 1007 "binascii.c"
...
binascii_crc32(PyObject *self, PyObject *args)
{
    ...
    if ( !_PyArg_ParseTuple_SizeT(args, "y*|I:crc32", &pbin, &crc) )
        return ((void *)0);
    bin_data = pbin.buf;
    len = pbin.len;
...
binascii_hexlify(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "y*:b2a_hex", &parg))
        return ((void *)0);
    argbuf = parg.buf;
    arglen = parg.len;

    (__builtin_expect(!(arglen >= 0), 0) ? __assert_rtn(__func__, "binascii.c", 1104, "arglen >= 0") : (void)0);
    if (arglen > ((Py_ssize_t)(((size_t)-1)>>1)) / 2) {
        PyBuffer_Release(&parg);
        return PyErr_NoMemory();
    }

    retval = PyBytes_FromStringAndSize(((void *)0), arglen*2);
    if (!retval) {
        PyBuffer_Release(&parg);
        return ((void *)0);
    }
    retbuf = ((__builtin_expect(!(((((((PyObject*)(retval))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 1115, "PyBytes_Check(retval)") : (void)0), (((PyBytesObject *)(retval))->ob_sval));
...
static char doc_hexlify[] = "b2a_hex(data) -> s; Hexadecimal representation of binary data.\n\nThis function is also available as \"hexlify()\".";
...
binascii_unhexlify(PyObject *self, PyObject *args)
{
    ...
    if (!_PyArg_ParseTuple_SizeT(args, "O&:a2b_hex", ascii_buffer_converter, &parg))
        return ((void *)0);
    argbuf = parg.buf;
    arglen = parg.len;

    (__builtin_expect(!(arglen >= 0), 0) ? __assert_rtn(__func__, "binascii.c", 1165, "arglen >= 0") : (void)0);
    ...
    retbuf = ((__builtin_expect(!(((((((PyObject*)(retval))->ob_type))->tp_flags & ((1L<<27))) != 0)), 0) ? __assert_rtn(__func__, "binascii.c", 1182, "PyBytes_Check(retval)") : (void)0), (((PyBytesObject *)(retval))->ob_sval));

    for (i=j=0; i < arglen; i += 2) {
        int top = to_int(((unsigned char)((argbuf[i]) & 0xff)));
        int bot = to_int(((unsigned char)((argbuf[i+1]) & 0xff)));
        if (top == -1 || bot == -1) {
...
static char doc_unhexlify[] = "a2b_hex(hexstr) -> s; Binary data of hexadecimal representation.\n\nhexstr must contain an even number of hex digits (upper or lower case).\nThis function is also available as \"unhexlify()\"";
...
binascii_a2b_qp(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    PyObject *rv;
    static char *kwlist[] = {"data", "header", ((void *)0)};
    int header = 0;

    if (!_PyArg_ParseTupleAndKeywords_SizeT(args, kwargs, "O&|i:a2b_qp", kwlist,
    ...
    ((__builtin_object_size (odata, 0) != (size_t) -1) ? __builtin___memset_chk (odata, 0, datalen, __builtin_object_size (odata, 0)) : __inline_memset_chk (odata, 0, datalen));
    ...
    while (in < datalen) {
        if (data[in] == '=') {
            ...
            if ((data[in] == '\n') || (data[in] == '\r')) {
                ...
                ch = table_hex[(unsigned int)(data[in])] << 4;
                in++;
                ch |= table_hex[(unsigned int)(data[in])];
                in++;
                odata[out++] = ch;
            }
            else {
    ...
    if ((rv = PyBytes_FromStringAndSize((char *)odata, out)) == ((void *)0)) {
        PyBuffer_Release(&pdata);
        PyMem_Free(odata);
        return ((void *)0);
    }
...
static char doc_b2a_qp[] = "b2a_qp(data, quotetabs=0, istext=1, header=0) -> s; \n Encode a string using quoted-printable encoding. \n\nOn encoding, when istext is set, newlines are not encoded, and white \nspace at end of lines is.  When istext is not set, \\r and \\n (CR/LF) are \nboth encoded.  When quotetabs is set, space and tabs are encoded.";
# 1332 "binascii.c"
static PyObject*
binascii_b2a_qp (PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!_PyArg_ParseTupleAndKeywords_SizeT(args, kwargs, "y*|iii", kwlist, &pdata,
    ...
    ((__builtin_object_size (odata, 0) != (size_t) -1) ? __builtin___memset_chk (odata, 0, odatalen, __builtin_object_size (odata, 0)) : __inline_memset_chk (odata, 0, odatalen));
...
static struct PyMethodDef binascii_module_methods[] = {
    {"a2b_uu", binascii_a2b_uu, 0x0001, doc_a2b_uu},
    {"b2a_uu", binascii_b2a_uu, 0x0001, doc_b2a_uu},
    {"a2b_base64", binascii_a2b_base64, 0x0001, doc_a2b_base64},
    {"b2a_base64", binascii_b2a_base64, 0x0001, doc_b2a_base64},
    {"a2b_hqx", binascii_a2b_hqx, 0x0001, doc_a2b_hqx},
    {"b2a_hqx", binascii_b2a_hqx, 0x0001, doc_b2a_hqx},
    {"b2a_hex", binascii_hexlify, 0x0001, doc_hexlify},
    {"a2b_hex", binascii_unhexlify, 0x0001, doc_unhexlify},
    {"hexlify", binascii_hexlify, 0x0001, doc_hexlify},
    {"unhexlify", binascii_unhexlify, 0x0001, doc_unhexlify},
    {"rlecode_hqx", binascii_rlecode_hqx, 0x0001, doc_rlecode_hqx},
    {"rledecode_hqx", binascii_rledecode_hqx, 0x0001,
     doc_rledecode_hqx},
    {"crc_hqx", binascii_crc_hqx, 0x0001, doc_crc_hqx},
    {"crc32", binascii_crc32, 0x0001, doc_crc32},
    {"a2b_qp", (PyCFunction)binascii_a2b_qp, 0x0001 | 0x0002,
      doc_a2b_qp},
    {"b2a_qp", (PyCFunction)binascii_b2a_qp, 0x0001 | 0x0002,
      doc_b2a_qp},
    {((void *)0), ((void *)0)}
};
...
PyInit_binascii(void)
{
    ...
    m = PyModule_Create2(&binasciimodule, 1013);
    if (m == ((void *)0))
        return ((void *)0);

    d = PyModule_GetDict(m);

    Error = PyErr_NewException("binascii.Error", PyExc_ValueError, ((void *)0));
    PyDict_SetItemString(d, "Error", Error);
    Incomplete = PyErr_NewException("binascii.Incomplete", ((void *)0), ((void *)0));
